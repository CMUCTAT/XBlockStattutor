...
a[6].e||"America/Campo_Grande"===d.name&&14136912E5===a[6].s&&13925196E5===a[6].e)return 0}else if("America/Montevideo"===b){if("America/Sao_Paulo"===d.name&&14136876E5===a[6].s&&1392516E6===a[6].e)return 0}else if("Pacific/Auckland"===b&&"Pacific/Fiji"===d.name&&14142456E5===a[6].s&&13961016E5===a[6].e)return 0;return c},g=function(b,d){for(var g={},e=jstz.olson.dst_rules.zones,h=e.length,u=a[d],n=0;n<h;n++){var f=e[n],m;m=e[n];for(var r=0,z=0;z<b.length;z++)if(m.rules[z]&&b[z]){if(b[z].s>=m.rules[z].s&&
b[z].e<=m.rules[z].e)r=0,r+=Math.abs(b[z].s-m.rules[z].s),r+=Math.abs(m.rules[z].e-b[z].e);else{r="N/A";break}if(864E6<r){r="N/A";break}}m=r=c(b,d,r,m);"N/A"!==m&&(g[f.name]=m)}for(var D in g)if(g.hasOwnProperty(D)&&-1!=u.indexOf(D))return D;return d},h=function(a){var b=function(){for(var a=[],b=0;b<jstz.olson.dst_rules.years.length;b++){var c;c=jstz.olson.dst_rules.years[b];var g=(new Date(c,0,1,0,0,1,0)).getTime();c=(new Date(c,12,31,23,59,59)).getTime();for(var e=(new Date(g)).getTimezoneOffset(),
...
CTATLanguagePack[b]),CTATLanguagePack[b]}else a.ctatdebug("No custom language pack defined, using default...");return"undefined"!==typeof CTATDefaultLangagePack&&CTATDefaultLangagePack[b]?(a.ctatdebug("Found tag in default language pack, returning: "+CTATDefaultLangagePack[b]),CTATDefaultLangagePack[b]):b}};CTATLanguageManager.prototype=Object.create(CTATBase.prototype);CTATLanguageManager.prototype.constructor=CTATLanguageManager;CTATLanguageManager.theSingleton=new CTATLanguageManager;var scrimIsUp=!1,errorScrim=!1,waitScrim=!0,warnScrim=!1,connectionScrim=!1,authorTimeSet=!0,inAuthorTime=!0,CTATScrim=function(){function a(){warnScrim=!1;n.scrimDown()}function b(a){"google"!=CTATConfig.platform&&(1==scrimIsUp&&n.scrimDownForced(),n.ctatdebug("errScrimUp ("+a+")"),1==errorScrim?1==g&&(g=!1,getSafeElementById(ctatcontainer).removeChild(q)):1==warnScrim&&(g=!0),n.scrimUp(a))}function e(a,b){n.ctatdebug("makeHTMLButton ()");var c=document.createElement("input");c.type="button";c.value=
b;null!=a?(n.ctatdebug("clickHandle!=null"),c.onclick=a):(n.ctatdebug("clickHandle==null"),c.onclick=n.defaultClickHandler);c.id=b;c.setAttribute("class","scrimButton");return c}CTATBase.call(this,"CTATScrim","__undefined__");var f="",d=!1,c=!1,g=!1,h=null,l=null,m=new CTATCanvasComponent("CTAT Scrim"),r=[],p=null,x=null,q=null,u=null,n=this;this.scrimUp=function(b){if("google"!=CTATConfig.platform)if(n.ctatdebug("scrimUp ()"),b=CTATGlobals.languageManager.filterString(b),n.ctatdebug("Message: "+
b),1==scrimIsUp?(f=1==waitScrim?b:f+(" \n "+b),m.removeComponent(),n.removeHTMLElements()):(f=b,scrimIsUp=!0),n.ctatdebug("scrimUp() to call drawScrim() scrimIsUp "+scrimIsUp),n.ctatdebug("drawScrim ()"),"google"==CTATConfig.platform)n.ctatdebug("This is not available for now when we're in this environment");else if($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"),$("#scrim").css("z-index",1E3),"google"!=CTATConfig.platform&&($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>'+
f+"<br><br></div></div></div>"),!0===g&&(q=e(a,"close"),$(q).appendTo("#scrimpanel")),!0===d&&(p=e(h,"yes"),$(p).appendTo("#scrimpanel")),!0===c&&(x=e(l,"no"),$(x).appendTo("#scrimpanel")),1==waitScrim)){n.ctatdebug("Adding spinner ...");$("#scrimpanel").append("<br>");b=$('<div id="scrim_spin">');b.css("width","100%");b.css("position","relative");$("#scrimpanel").append(b);try{var u=(new Spinner({className:"scrim_spinner"})).spin();$("#scrim_spin").append(u.el)}catch(A){(A instanceof ReferenceError||
A instanceof TypeError)&&n.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.',A,typeof A)}}};this.waitScrimUp=function(){console.log("waitScrimUp () CTATConfig.platform "+CTATConfig.platform+", scrimIsUp "+scrimIsUp);"google"!=CTATConfig.platform&&(1==scrimIsUp&&n.scrimDownForced(),waitScrim=!0,n.scrimUp(CTATGlobals.languageManager.getString("LOADING")),n.ctatdebug("return from waitScrimUp(): scrimIsUp "+
scrimIsUp))};this.nextProblemScrimUp=function(){"google"!=CTATConfig.platform&&(1==scrimIsUp&&n.scrimDownForced(),n.ctatdebug("nextProblemScrimUp ()"),n.scrimUp(CTATGlobals.languageManager.getString("NEXTPROBLEM")))};this.OKScrimUp=function(a,b){"google"!=CTATConfig.platform&&(1==scrimIsUp&&n.scrimDownForced(),n.ctatdebug("OKScrimUp ("+a+","+b+")"),c=d=g=warnScrim=errorScrim=!1,n.scrimUp(a),u=e(b,"OK"),$(u).appendTo("#scrimpanel"))};this.confirmScrimUp=function(a,b,g){"google"!=CTATConfig.platform&&
(1==scrimIsUp&&n.scrimDownForced(),n.ctatdebug("confirmScrimUp ("+a+","+b+","+g+")"),c=d=!0,l=g,h=b,n.scrimUp(a))};this.errorScrimUp=function(a){"google"!=CTATConfig.platform&&(1==scrimIsUp&&n.scrimDownForced(),0==authorTimeSet?(n.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"),r.push("ERROR: "+a),errorScrim=!0):0==inAuthorTime?n.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes"):(errorScrim=!0,b("ERROR: "+
a)))};this.warningScrimUp=function(a){"google"!=CTATConfig.platform&&(1==scrimIsUp&&n.scrimDownForced(),0==authorTimeSet?(n.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"),r.push("WARNING: "+a),warnScrim=!0):0==inAuthorTime?n.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes"):(warnScrim=!0,b("WARNING: "+a)))};this.handleTSDisconnect=function(){connectionScrim=!0;n.scrimUp(CTATGlobals.languageManager.getString("TUTORDISCONNECTED"))};
this.removeHTMLElements=function(){};this.scrimDown=function(){"google"!=CTATConfig.platform&&(0==scrimIsUp?n.ctatdebug("The scrim isn't up, returning"):1==errorScrim?n.ctatdebug("The scrim is up to describe errors to the user, leave it up!"):1==warnScrim?n.ctatdebug("The scrim is up to display warnings to the user, leave it up!"):1==connectionScrim?n.ctatdebug("The scrim is up for a connection issue leave it up!"):n.scrimDownForced())};this.scrimDownForced=function(){n.ctatdebug("enter scrimDownForced() scrimIsUp "+
...
decodeURIComponent(g[x].replace(/\+/g," "));ctatdebug("Decoded args: "+e[decodeURIComponent(g[0])])}null!==e&&(ctatdebug("tutorPrep(): Assigning parsed arguments ..."),f=e);e=!1;for(var q in f)if(f.hasOwnProperty(q))switch(ctatdebug("Processing external FlashVar "+q+"("+f[q]+")"),q){case "GENERATED":"on"==f[q]&&(c.session_id=CTATGuid.guid(),e=!0);break;case "BRD":c.question_file=f[q];break;case "BRMODE":c.BehaviorRecorderMode=f[q];break;case "PROBLEM":c.problem_name=f[q];break;case "DATASET":c.dataset_name=
f[q];break;case "LEVEL1":c.dataset_level_name1=f[q];break;case "TYPE1":c.dataset_level_type1=f[q];break;case "LEVEL2":c.dataset_level_name2=f[q];break;case "TYPE2":c.dataset_level_type2=f[q];break;case "LEVEL3":c.dataset_level_name3=f[q];break;case "TYPE3":c.dataset_level_type3=f[q];break;case "LEVEL4":c.dataset_level_name4=f[q];break;case "TYPE4":c.dataset_level_type4=f[q];break;case "USER":c.user_guid=f[q];break;case "SESSION":!1===e&&(c.session_id=f[q]);break;case "SOURCE":c.source_id=f[q];break;
case "LOGTYPE":c.Logging=f[q];break;case "PORT":c.remoteSocketPort=f[q];break;case "REMOTEURL":c.remoteSocketURL=f[q];break;case "DISKDIR":c.log_to_disk_directory=f[q];break;case "log_service_url":c.log_service_url=f[q];break;case "URL":c.log_service_url=f[q];break;case "LOGURL":c.log_service_url=f[q];break;case "CONNECTION":c.tutoring_service_communication=f[q];break;case "SUI":c.sui=f[q];break;case "VAR1":c.var1=f[q];break;case "VAL1":c.val1=f[q];break;case "VAR2":c.var2=f[q];break;case "VAL2":c.val2=
f[q];break;case "VAR3":c.var3=f[q];break;case "VAL3":c.val3=f[q];break;case "VAR4":c.var4=f[q];break;case "VAL4":c.val4=f[q];break;case "SLOG":case "SessionLog":c.SessionLog=f[q];break;case "KEYBOARDGROUP":"Disabled"==f[q]&&(c.keyboard="disabled");"Auto"==f[q]&&(c.keyboard="auto");"On"==f[q]&&(c.keyboard="on");break;default:c[q]=f[q]}}return c};this.getCustomFields=function(){return b};this.setTimeZone=function(b){a.ctatdebug("setTimeZone ("+b+")");null==b||""==b||void 0==b?(b=jstz.determine(),a.ctatdebug("Assigning detected timezone: "+
...
var c;if("websocket"==m.getSocketType())return c=this.findWSConnection(b),c||(c=new CTATWSConnection(a),c.setID(f),c.setURL(b),c.assignReceiveFunction(this.processWSReply),c.assignCloseFunction(this.processWSClose),d.push(c),f++),c;c=new CTATConnection(a);c.setID(f);c.setURL(b);c.assignReceiveFunction(this.processReply);d.push(c);f++;return c};this.findWSConnection=function(a){ctatdebug("findWSConnection( "+a+" )");for(var b=0;b<d.length;b++){var c=d[b];ctatdebug("checking: socketType = "+c.getSocketType()+
" URL = "+c.getURL());if("ws"==c.getSocketType()&&c.getURL()==a)return c}return null};this.startBundle=function(){m.ctatdebug("startBundle ()");!1===useBundling?this.ctatdebug("Not using bundling, bump"):(bundleFormatter='<?xml version="1.0" encoding="UTF-8"?><message><verb/><properties><MessageType>MessageBundle</MessageType><messages>',inBundle=!0)};this.endBundle=function(){m.ctatdebug("endBundle ()");!1===useBundling?m.ctatdebug("Not using bundling, bump"):(inBundle=!1,bundleFormatter+="</messages></properties></message>",
m.sendXML(bundleFormatter))};this.setFixedURL=function(a){e=a};this.getURL=function(){m.ctatdebug("getURL ()");if(""!==e)return m.ctatdebug("Returning fixedURL: "+e),e;var a=flashVars.getRawFlashVars(),b="http://";"https"==m.getSocketType()&&(b="https://");b=b+a.remoteSocketURL+":"+a.remoteSocketPort;-1!=a.remoteSocketURL.indexOf("http")&&(b=a.remoteSocketURL+":"+a.remoteSocketPort);return b};this.sendXML=function(a){m.ctatdebug("Sending: "+a);m.ctatdebug("sendXML ("+a+")");if(!0===useBundling&&!0===
inBundle)m.ctatdebug("Bundling ..."),bundleFormatter+=a;else{bundleFormatter=a;flashVars.getRawFlashVars();a=this.getURL();var b=bundleFormatter;-1==bundleFormatter.indexOf("<?xml")&&(b='<?xml version="1.0" encoding="UTF-8"?>'+bundleFormatter);!0===this.getUseCommSettings()?"javascript"==m.getSocketType()?CTAT.ToolTutor.sendToTutor(b):this.send_post(a,b):this.send_post(a,b)}};this.sendXMLNoBundle=function(a){m.ctatdebug("sendXMLNoBundle ("+a+")");bundleFormatter=a;var b=this.getURL(),c=a;-1==a.indexOf("<?xml")&&
(c='<?xml version="1.0" encoding="UTF-8"?>'+a);flashVars.getRawFlashVars();!0===this.getUseCommSettings()?"javascript"==m.getSocketType()?CTAT.ToolTutor.sendToTutor(c):this.send_post(b,c):this.send_post(b,c)};this.sendXMLURL=function(a,b){ctatdebug("sendXMLURL ("+b+")");var c=a;-1==a.indexOf("<?xml")&&(c='<?xml version="1.0" encoding="UTF-8"?>'+a);flashVars.getRawFlashVars();m.ctatdebug("Sending: "+c);!0===this.getUseCommSettings()?"javascript"==m.getSocketType()?CTAT.ToolTutor.sendToTutor(c):this.send_post(b,
...
else{ctatdebug("Outoing on wire: "+b);c=flashVars.getRawFlashVars();var d=a;if("websocket"==m.getSocketType()){ctatdebug("opening websocket connection: url "+a);d=a.replace("http:","ws:");ctatdebug("opening websocket connection to "+d);if("https:"===window.top.location.protocol){ctatdebug("We're embedded in an https window, using wss...");var d=d.replace("ws:","wss:"),e=CTATConfiguration.get("remoteSocketSecurePort"),d=d.replace(/(wss:\/\/[^:]{1,}:)\d{1,}/,"$1"+e);ctatdebug("url after replace: "+
d)}c=m.createConnection(c,d);c.setData(b);m.ctatdebug(b)}else c=m.createConnection(c,d),c.setData(b);null!==l&&l.processOutgoing(b);c.send()}};this.processReply=function(a){m.ctatdebug("processReply ("+d.length+","+a+")");var b=0,e;a=[];var f;for(f=0;f<d.length;f++){var h=d[f],q=h.getHTTPObject();m.ctatdebug("Testing connection entry "+f+", readyState: "+q.readyState+", consumed: "+h.getConsumed()+", status: "+q.status);4==q.readyState&&!1===h.getConsumed()?(m.ctatdebug("Investigating request response: "+
b+" -> "+q.status+", for: "+h.getURL()),e=!1,0===q.status&&(e=!0,m.ctatdebug("Received message (status 0): ("+q.responseText+"), status: "+q.status),g&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(p))),408==q.status&&(e=!0,m.ctatdebug("Received message (status 408): "+q.responseText),g&&CTATScrim.scrim.scrimDown()),502==q.status&&(e=!0,m.ctatdebug("Received message (status 502): "+q.responseText),g&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(ERROR_502))),
200==q.status?(e=!0,m.ctatdebug("Processing 200 response ..."),null!==c?(a.push(q.responseText),null!==l&&l.processIncoming(q.responseText)):m.ctatdebug("Error: httphandler is null, can't process response!")):c&&c.processError&&(e=!0,m.ctatdebug("Processing non-200 response, status "+q.status),c.processError(q.status,q.responseText)),!1===e&&m.ctatdebug("Error: status not handled for: "+q.status),m.ctatdebug("Marking connection as consumed ..."),h.setConsumed(!0)):(0===q.readyState&&m.ctatdebug("Received message (status 0, request not initialized)"),
1===q.readyState&&m.ctatdebug("Received message (status 1, server connection established)"),2===q.readyState&&m.ctatdebug("Received message (status 2, request received)"),3===q.readyState&&m.ctatdebug("Received message (status 3, processing request)"));b++}m.cleanup();for(b=0;b<a.length;b++)m.ctatdebug("Processing incoming message: "+b),e=a[b],-1!=e.indexOf("status=success")?m.ctatdebug("Info: logging success message received, not propagating to message handler"):(m.ctatdebug("Processing incoming message: "+
e),c.processMessage(e))};this.processWSReply=function(a){m.ctatdebug("processWSReply() length "+(null===a?null:a.toString().length));"string"==typeof a&&(null!==l&&l.processIncoming(a),-1!=a.indexOf("status=success")?m.ctatdebug("processWSReply() logging success message received, not propagating to message handler: "+a):(m.ctatdebug("Processing incoming message: "+a),c.processMessage(a)))};this.processWSClose=function(a){m.ctatdebug("processWSClose("+a+")");a instanceof CloseEvent&&m.ctatdebug("CloseEvent: code "+
a.code+", reason "+a.reason+", wasClean "+a.wasClean);CTATLMS.is.Authoring()?CTATScrim.scrim.scrimUp(CTATGlobals.languageManager.filterString("AUTHORPLEASECLOSE")):CTATScrim.scrim.handleTSDisconnect()};this.cleanup=function(){m.ctatdebug("cleanup ()");for(var a=0,b,c=!1;!1===c;)b=this.checkEntries(),!1===b?c=!0:a++;m.ctatdebug("Removed "+a+" entries")};this.checkEntries=function(){m.ctatdebug("checkEntries ("+d.length+")");var a=0,b;for(b=0;b<d.length;b++){var c=d[b];if(!0===c.getConsumed())return m.ctatdebug("Removing : "+
c.getID()),d.splice(a,1),!0;var e=c.getHTTPObject();m.ctatdebug("Check, readyState: "+e.readyState+", consumed: "+c.getConsumed());a++}return!1};this.retrieveXMLFile=function(a,b,c){m.ctatdebug("retrieveXMLFile ("+a+")");if(location.href){if(m.ctatdebug("Location: "),-1!=location.href.toLowerCase().indexOf("file://")){a=(new CTATTutorMessageBuilder).createErrorMessage("","You have loaded your tutor directly from the file system, please do not load a tutor using file://. Please use the CTAT Authoring Tools to launch the html file.");
m.ctatdebug("onerror GET for xmlFile "+a);CTAT.ToolTutor.sendToInterface(a,!0);return}}else m.ctatdebug("We can't check location.href in the current configuration");if(-1!=a.toLowerCase().indexOf("file://"))a=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+a+" - You are trying to use the file:// protocol, which is not allowed in this browser."),m.ctatdebug("onerror GET for xmlFile "+a),CTAT.ToolTutor.sendToInterface(a,!0);else{x=a;var d=(new CTATConnection).getHTTPObject();
d.onreadystatechange=function(){m.ctatdebug("onready... GET for xmlFile xmlhttp.readyState "+d.readyState+", .status "+d.status+", parser "+b);if(4==d.readyState){if(200==d.status){var a;d.responseXML?(m.ctatdebug("parsing brd xml using something else"),a=d.responseXML.documentElement):(m.ctatdebug("parsing brd xml using node"),a=(b=new CTATXML).parseXML(d.responseText));if(null===a){a=(new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile "+x);m.ctatdebug("Error parsing xmlFile "+
x+": "+a);CTAT.ToolTutor.sendToInterface(a,!0);return}c.processXML(a)}404==d.status&&(a=(new CTATTutorMessageBuilder).createErrorMessage("Unable to download file","("+x+") not found"),m.ctatdebug("Error loading xmlFile "+x+": "+a),CTAT.ToolTutor.sendToInterface(a,!0))}};d.onerror=function(){var a=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+x+" - Either you are trying to use the  file:// protocol, there is a firewall between the tutor and BRD, or the BRD is on a different domain and permission to retrieve data from that server is denied.");
...
(a=CTATLogMessageBuilder.commLogMessageBuilder.wrapForOLI('<?xml version="1.0" encoding="UTF-8"?><tutor_related_message_sequence version_number="4">'+a+"</tutor_related_message_sequence>"));b.ctatdebug("Encoded log message: "+a);CTATLMS.logEvent(a);CTATConfiguration.get("log_service_url")&&z.sendXMLNoBundle(a)}}else b.ctatdebug("Use internal: "+f)};this.startProblem=function(){b.ctatdebug("startProblem ()");b.initCheck();b.logSessionStart();b.sendMessage(CTATLogMessageBuilder.commLogMessageBuilder.createContextMessage(!0))};
...
A=c;var n=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(g,h);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tool_event_time",CTATLogMessageBuilder.commLogMessageBuilder.formatTimeStamp(n)+" UTC");a=CTATLogMessageBuilder.commLogMessageBuilder.createSemanticEventToolMessage(c,a,d,e,!0,f);this.sendMessage(a)};this.logTutorResponse=function(a,c,d,e,g,h,f,n,l){b.ctatdebug("logTutorResponse ()");b.initCheck();
A=c;var u=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(n,l);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tutor_event_time",CTATLogMessageBuilder.commLogMessageBuilder.formatTimeStamp(u)+" UTC");b.ctatdebug("Formatting feedback ...");void 0!=h&&null!=h?h="<![CDATA["+CTATGlobals.languageManager.filterString(h)+"]]\x3e":(b.ctatdebug("No feedback provided, using empty string"),h="");b.ctatdebug("Creating tutor message ...");
a=CTATLogMessageBuilder.commLogMessageBuilder.createTutorMessage(c,a,d,g,h,e,f,!0);this.sendMessage(a)};this.processMessage=function(a){b.ctatdebug("processMessage ()");b.ctatdebug("Response from log server: "+a)};this.start=function(){b.ctatdebug("start ()");var a=b.generateSession();b.startProblem();return a};this.logInterfaceAttempt=function(a,c,d,e){b.ctatdebug("logInterfaceAttempt ()");e=CTATGuid.guid();a=new CTATSAI(a,c,d);a.setInput(d);A=a;this.logSemanticEvent(e,a,"ATTEMPT","");return e};
this.logInterfaceAttemptSAI=function(a,c){b.ctatdebug("logInterfaceAttemptSAI ()");A=a;var d=CTATGuid.guid();this.logSemanticEvent(d,a,"ATTEMPT","");return d};this.logResponse=function(a,c,d,e,g,h,f,n){b.ctatdebug("logResponse ()");c=new CTATSAI(c,d,e);c.setInput(e);e=new CTATActionEvaluationData("");e.setEvaluation(h);void 0==n?this.logTutorResponse(a,c,g,"",e,f):this.logTutorResponse(a,c,g,"",e,f,null,n.getCustomElementNames(),n.getCustomElementTypes())};this.logResponseSAI=function(a,c,d,e,g,h){b.ctatdebug("logResponse ()");
...
a.propagateShellEvent("GetURL",h));"InterfaceReboot"==q&&(c++,ctatdebug("Found: InterfaceReboot #"+c+" -- href "+(location?location.href:"(no location)")),1<c&&!CTAT.ToolTutor.reboot("InterfaceReboot from CTATMessageHandler")&&(q=("https:"===window.top.location.protocol?"wss://":"ws://")+CTATConfiguration.get("remoteSocketURL")+":"+CTATConfiguration.get("remoteSocketPort"),ctatdebug("closing connection w/ url: "+q),a.closeWSConnection(q,function(){var a=window.frameElement.getAttribute("id");"function"==
typeof CustomEvent&&(a=new CustomEvent("refreshIframe",{detail:a}),window.parent.document.dispatchEvent(a))},"interfaceReboot")))}}}}};this.processStateGraph=function(a){e.ctatdebug("processStateGraph ()");if(void 0===a||null===a)e.ctatdebug("Error: state graph property list is undefined");else if(e.ctatdebug("Processing node: "+a.nodeName),null===d.getElementChildren(a))e.ctatdebug("Error: state graph property list is undefined");else{a=d.getElementChildren(a);for(var c=0;c<a.length;c++){var g=a[c];
e.ctatdebug("State graph attribute: "+d.getElementName(g));"caseInsensitive"==d.getElementName(g)&&(caseInsensitive="false"==d.getNodeTextValue(g)?!1:!0);"unordered"==d.getElementName(g)&&(unordered="false"==d.getNodeTextValue(g)?!1:!0);"lockWidget"==d.getElementName(g)&&(lockWidget="false"==d.getNodeTextValue(g)?!1:!0);"suppressStudentFeedback"==d.getElementName(g)&&("false"==d.getNodeTextValue(g)?CTATGlobals.suppressStudentFeedback=!1:CTATGlobals.suppressStudentFeedback=!0);"highlightRightSelection"==
d.getElementName(g)&&(highlightRightSelection="false"==d.getNodeTextValue(g)?!1:!0);"confirmDone"==d.getElementName(g)&&(e.ctatdebug("Confirm done: "+d.getNodeTextValue(g)),"true"==d.getNodeTextValue(g)?CTATGlobals.confirmDone=!0:CTATGlobals.confirmDone=!1);"Skills"==d.getElementName(g)&&(null===CTATSkillSet.skills&&(CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(g),b.updateSkillWindow())}}};this.processStartProblem=function(a){e.ctatdebug("processStartProblem ()");b.processStartProblem()};
this.processInterfaceIdentification=function(a){};this.processInterfaceDescription=function(a){e.ctatdebug("processInterfaceDescription ("+a.length+")");for(var b="Unknown",c="Unknown",g=null,h=0;h<a.length;h++){var f=a[h];e.ctatdebug("Inspecting element: "+d.getElementName(f));"WidgetType"==d.getElementName(f)&&(e.ctatdebug("Widget type: "+d.getNodeTextValue(f)),b=d.getNodeTextValue(f));"CommName"==d.getElementName(f)&&(e.ctatdebug("Instance name: "+d.getNodeTextValue(f)),c=d.getNodeTextValue(f));
if("serialized"==d.getElementName(f)){e.ctatdebug("Prepareing to de-serialize component ...");for(var q=d.getElementChildren(f),u=0;u<q.length;u++){var n=q[u];-1!=d.getElementName(n).indexOf("CTAT")&&(g=n)}}"interface"==d.getElementName(f)&&(e.ctatdebug("Storing interface for post start-state reconstruction ..."),CTATGlobals.interfaceElement=f);"script"==d.getElementName(f)&&(e.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."),scriptElement=d.getNodeTextValue(f))}null!==
...
d.getElementAttr(c,"x"),h=d.getElementAttr(c,"y"),f=d.getElementAttr(c,"width"),l=d.getElementAttr(c,"height"),m=d.getElementAttr(c,"tabIndex"),n=d.getElementAttr(c,"zIndex");null===m&&(m=-1);null===n&&(n=0);var B=new CTATComponentDescription;B.type=a;B.name=b;B.x=Math.floor(g);B.y=Math.floor(h);B.tabIndex=m;B.zIndex=n;B.width=Math.floor(f);B.height=Math.floor(l);CTATShellTools.registerComponentDescription(B);c=d.getElementChildren(c);for(g=0;g<c.length;g++){h=c[g];d.getElementName(h);if("Parameters"==
d.getElementName(h))for(this.ctatdebug("Processing component parameters ..."),f=d.getElementChildren(h)[0],f=d.getElementChildren(f),l=0;l<f.length;l++){var v=f[l];if("CTATComponentParameter"==d.getElementName(v)){this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");for(var n=m=void 0,v=d.getElementChildren(v),A=0;A<v.length;A++){var z=v[A];"name"==d.getElementName(z)&&(this.ctatdebug("Found parameter name: "+d.getNodeTextValue(z)),m=d.getNodeTextValue(z));"value"==d.getElementName(z)&&
(this.ctatdebug("Found parameter value: "+d.getNodeTextValue(z)),n=d.getNodeTextValue(z).trim())}this.ctatdebug("Parameter name: "+m+", value: "+n);void 0!==m&&(B.params[m]=n,"group"==m&&(B.groupName=n))}}if("Styles"==d.getElementName(h))for(this.ctatdebug("Processing component styles ..."),h=d.getElementChildren(h)[0],h=d.getElementChildren(h),f=0;f<h.length;f++)if(n=h[f],"CTATStyleProperty"==d.getElementName(n)){this.ctatdebug("Processing style property (CTATStyleProperty) ...");m=l="";n=d.getElementChildren(n);
for(v=0;v<n.length;v++)A=n[v],"name"==d.getElementName(A)&&(l=d.getNodeTextValue(A)),"value"==d.getElementName(A)&&(m=d.getNodeTextValue(A).trim());this.ctatdebug("Style (name: "+l+", value: "+m+")");""!==l&&(B.styles[l]=m)}}e.ctatdebug("deserializeComponent ("+a+","+b+") done")}};this.processStartStateActions=function(){e.ctatdebug("processStartStateActions ("+f.length+")");if(0===f.length)e.ctatdebug("No start state messages, bump");else if(0<CTATMessageHandler.startStateHandlers.length)for(var a=
0;a<CTATMessageHandler.startStateHandlers.length;a++)CTATMessageHandler.startStateHandlers[a].processStartStateActions(f);else{for(a=0;a<f.length;a++){var c=f[a];e.ctatdebug("Processing startstate message type: "+c.getMessageType());"InterfaceAction"==c.getMessageType()&&b.processInterfaceAction(c);"CorrectAction"==c.getMessageType()&&b.processCorrectAction(c);"InCorrectAction"==c.getMessageType()&&b.processInCorrectAction(c);this.sleep(1E3)}if(""!==CTATMessageHandler.scriptElement)try{eval(CTATMessageHandler.scriptElement)}catch(m){alert("Error executing script from BRD: "+
m.message)}}};this.sleep=function(a){e.ctatdebug("sleep ("+a+")")}};CTATMessageHandler.prototype=Object.create(CTATBase.prototype);CTATMessageHandler.prototype.constructor=CTATMessageHandler;CTATMessageHandler.startStateHandlers=[];CTATMessageHandler.inStartState=!1;CTATMessageHandler.scriptElement="";var CTATNameTranslator=function(){CTATBase.call(this,"CTATNameTranslator","translator");var a=!1,b=this;this.setPassthrough=function(b){a=CTATGlobalFunctions.toBoolean(b)};this.getPassthrough=function(){return a};this.manufactorJSON=function(a,f){b.ctatdebug("manufactorJSON ("+a+","+f+")");var d=a.split(":");if(1==d.length)return b.ctatdebug("No range in aRange, returning basic JSON ..."),"";var c=this.getA1Row(d[0]),e=this.getA1Col(d[0]),h=this.getA1Row(d[1]),l=this.getA1Col(d[1]);b.ctatdebug("Manufacturing json from: ["+
...
l.push(b.getProperty("StepID"));var m=b.getCustomFields(),n;for(n in m)f.push(n),l.push(m[n]);n=b.getSkillsObject();d.updateSkillWindow(n);ctatdebug("Sending log message ...");null!=commLoggingLibrary?q&&commLoggingLibrary.logTutorResponse(b.getTransactionID(),logHintSAI,c,"",h,g,n,f,l):this.ctatdebug("Info: no logging library available!");"done"==logHintSAI.getSelection()&&"Correct"==b.getIndicator()&&(b=e.createProblemSummaryRequestMessage(),a.sendXML(b))}else d.updateSkillWindow(null);d.ctatdebug("processAssociatedRules() done")};
...
try{document.close()}catch(n){alert("Error closing document: "+n.message)}try{document.write(b)}catch(n){alert("Error writing document: "+n.message)}}};this.updateSkillWindow=function(a){d.ctatdebug("updateSkillWindow()");CTATSkillSet.skills.untouchSkills();var b=CTATShellTools.findComponentByClass("CTATSkillWindow");null!==b?null!=a?b.updateSkillSet(a):b.drawComponent():d.ctatdebug("Info: no skill window available")};this.processComponentFocus=function(a){d.ctatdebug("processComponentFocus("+a.getName()+
...
a};this.assignDoneProcessor=function(a){c=a};this.addEventListener=function(a,b){};this.addGlobalEventListener=function(a){d.ctatdebug("addGlobalEventListener()");x.push(a)};this.closeWSConnection=function(b,c,d){(b=a.findWSConnection(b))?b.close(d,c):console.warn("connection not found")}};CTATCommShell.prototype=Object.create(CTATBase.prototype);CTATCommShell.prototype.constructor=CTATCommShell;CTATCommShell.commShell=null;CTATCommShell.detailedFeedback=!0;
function enableDetailedFeedback(a){CTATCommShell.detailedFeedback=a};var CTATComponentReference=function(a,b){var e=a,f=b;this.setElement=function(a){e=a};this.getElement=function(){return e};this.setDiv=function(a){f=a};this.getDiv=function(){return f}};CTATComponentReference.components={};CTATComponentReference.list=function(){for(var a in CTATComponentReference.components){var b=CTATComponentReference.components[a];ctatdebug("Component: "+b.getElement().getName()+", with div: "+b.getDiv().id)}};
CTATComponentReference.getComponentFromID=function(a){var b=CTATComponentReference.components;return b.hasOwnProperty(a)?(a=b[a],a.getElement()?a.getElement():null):null};CTATComponentReference.add=function(a,b){var e=new CTATComponentReference(a,b);return CTATComponentReference.components[e.getDiv().getAttribute("id")]=e};var CTATCompBase=function(a,b,e,f,d,c){CTATBase.call(this,a,b);var g=e||0,h=f||0,l=d||-2,m=c||-2,r=50,p=25,x=!1,q=!1,u="",n=!1,B=!0,v=null,A="",z=null;this.isTabIndexable=!0;var D=0,H=null,w=this,E=null,t="hidden",C=CTATGlobalFunctions.gensym.z_index(),G=CTATGlobalFunctions.gensym.div_id(),y=CTATGlobalFunctions.gensym.z_index(),I=CTATGlobalFunctions.gensym.div_id();this.setIsAbstractComponent=function(a){x=a};this.isAbstractComponent=function(){return x};this.setIsFeedbackComponent=function(a){q=
a};this.isFeedbackComponent=function(){return q};this.setTabIndex=function(a){!0===this.isTabIndexable?(z=a,0>z?(z=CTATGlobals.Tab.Tracker,CTATGlobals.Tab.Tracker++):CTATGlobals.Tab.Tracker=z):z=-1};this.getTabIndex=function(){return z||this.getComponent().getAttribute("tabindex")};this.setStyles=function(){};this.setTabOrder=function(a){ctatdebug("setTabIndex( "+a+" )");this.getComponent()&&(ctatdebug("found comp"),isNaN(a)||(ctatdebug("is a number"),this.getComponent().setAttribute("tabindex",a)))};
this.setZIndex=function(a){w.ctatdebug("Setting z index to: "+a);D=a;null!==v&&(v.style.zIndex=a)};this.getZIndex=function(){return D};this.setDefaultWidth=function(a){r=a};this.getDefaultWidth=function(){return r};this.setDefaultHeight=function(a){p=a};this.getDefaultHeight=function(){return p};this.processCommShellEvent=function(a,b){w.ctatdebug("processCommShellEvent ("+a+")")};this.makeDivWrapper=function(a){v=document.createElement("div");v.id=this.getName();v.setAttribute("onkeypress","return noenter(event)");
v.setAttribute("data-ctat-component",this.getClassName());v.style.position="absolute";v.style.left=g+"px";v.style.top=h+"px";v.style.zIndex=C;v.style.width=w.getWidth()+"px";v.style.height=w.getHeight()+"px";$(v).data("CTATComponent",this);a.appendChild(v)};this.setDivWrapper=function(a){v=a;v.setAttribute("data-ctat-component",this.getClassName())};var F=this.setClassName;this.setClassName=function(a){F(a);v&&v.setAttribute("data-ctat-component",this.getClassName())};this.wrapComponent=function(a){w.ctatdebug("wrapComponent ()");
w.makeDivWrapper(a);w.ctatdebug("wrapComponent () done")};this.createCanvas=function(){w.ctatdebug("createCanvas ()");E=document.createElement("canvas");E.setAttribute("id",I);E.setAttribute("onkeypress","return noenter(event)");E.setAttribute("width",l+canvasCalibrate+"px");E.setAttribute("height",m+canvasCalibrate+"px");E.setAttribute("style","border: 1px "+this.borderColor+" solid; "+("hidden"==t?"visibility: hidden; ":"")+"z-index:"+y+";");v.firstChild?v.insertBefore(E,v.firstChild):v.appendChild(E);
return E};this.redraw=function(){var a=v.style.display;v.style.display="none";v.style.display=a};this.setCanvasVisibility=function(a){t=a};this.getSubCanvasCtx=function(){if(E)return E.getContext("2d")};this.getSubCanvas=function(){return E};this.getX=function(){return g};this.getY=function(){return h};this.getWidth=function(){if(0>=l){var a;H?a=window.getComputedStyle(H):v&&(a=window.getComputedStyle(v));if(a)return parseFloat(a.width)}return l};this.getHeight=function(){if(0>=m&&v){var a=window.getComputedStyle(v);
return parseFloat(a.getPropertyValue("height"))}return m};this.getText=function(){return u};this.getEnabled=function(){return B};this.assignEnabled=function(a){B=a;v.setAttribute("data-ctat-enabled",B)};this.setEnabled=function(a){w.ctatdebug("setEnabled ("+a+")");w.assignEnabled(a);H?H.disabled=!B:w.ctatdebug("Error: component pointer is null")};this.lock=this.setEnabled.bind(w,!1);this.unlock=this.setEnabled.bind(w,!0);this.getDivWrap=function(){return v};this.getComponent=function(){return H};
this.component=null;Object.defineProperty(this,"component",{get:function(){return H}});this.getCanvasZIndex=function(){return y};this.getComponentGroup=function(){return A};this.setComponent=function(a){H=a;this.setEnabled(this.getEnabled())};this.getTopDivZIndex=function(){return C};this.getTopDivID=function(){return G};this.setComponentGroup=function(a){A=a;H&&(H.name=a)};this.assignText=function(a){u=a};this.init=function(){w.ctatdebug("THIS IS THE BASE INIT METHOD")};this.initialize=function(){w.ctatdebug("initialize ()");
w.configFromDescription();w.init();w.processSerialization();w.render();w.processTabOrder();w.ctatdebug("initialize () done")};this.getInitialized=function(){return n};this.setInitialized=function(a){w.ctatdebug("setInitialized ("+a+")");n=a;!0!==n||v?w.ctatdebug("Not wrapping, initialized="+n+", divWrapper = "+v):(w.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."),(a=findPointOfAttachment(this.getName()))?(w.ctatdebug("Attaching component to existing MovieClip ..."),
w.wrapComponent(a.getDivWrapper())):(w.ctatdebug("Attaching component to main div ..."),0<$("#"+ctatcontainer).length&&w.wrapComponent(getSafeElementById(ctatcontainer))));w.getDivWrap().classList.add("CTATComponent");w.ctatdebug("setInitialized () done")};this.addSafeEventListener=function(a,b,c){w.ctatdebug("addSafeEventListener ("+a+")");w.ctatdebug("Adding event listener to: "+c);c?c.addEventListener(a,b):(H?(w.ctatdebug("Adding eventlistener to component instead of target"),H.addEventListener(a,
...
w.ctatdebug("implement in child class")};this.move=function(a,b){g=Number(a);h=Number(b);if(void 0===b||null===b||isNaN(h))if(0<=a.indexOf(",")){var c=a.split(",");g=Number(c[0]);h=Number(c[1])}else h=0;g=isNaN(g)?0:g;h=isNaN(h)?0:h;v&&(v.style.left=g+"px",v.style.top=h+"px")};this.setSize=function(a,b){var c=Number(a),d=Number(b);(void 0===b||null===b||isNaN(d))&&0<=a.indexOf(",")&&(d=a.split(","),c=Number(d[0]),d=Number(d[1]));w.ctatdebug("setSize ("+c+","+d+")");isNaN(c)||w.setWidth(c);isNaN(d)||
w.setHeight(d)};this.SetVisible=this.setVisible=function(a){a=CTATGlobalFunctions.toBoolean(a);t=!0===a?"block":"hidden";E&&E.setAttribute("style","border: 0px; position: absolute; "+(a?"":"visibility:hidden; ")+"; left:"+g+"px; top:"+h+"px; z-index:"+y+";");v.style.visibility=!0===a?null:"hidden"};this.FadeIn=function(a){w.SetVisible(!0)};this.FadeOut=function(a){w.SetVisible(!1)};this.reset=function(){};this.setX=function(a){this.x=a;v.style.left=this.x+"px";!0===n&&this.render()};this.setY=function(a){this.y=
a;v.style.top=this.y+"px";!0===n&&this.render()};this.setWidth=function(a){w.ctatdebug("setWidth ("+a+")");l=a;v?v.style.width=l+"px":w.ctatdebug("Internal error: no div wrapper available to set width")};this.setHeight=function(a){w.ctatdebug("setHeight ("+a+")");m=a;v?v.style.height=m+"px":w.ctatdebug("Internal error: no div wrapper available to set height")};this.setText=function(a){u=a;return this};this.getValue=function(){return H?H.value:""};this.backgrade=!1;this.unHighlightAll=function(){$(".CTAT--hint").each(function(){for(var a=
...
g.classList.add("CTAT-combobox");r&&!h&&g.setAttribute("size",r);if(!h){var a=this.getDivWrap().innerHTML;this.getDivWrap().innerHTML="";a.trim()&&(g.innerHTML=a)}m&&this.addLabels(m,l);!0===c.getEnabled()?g.disabled=!1:g.disabled=!0;c.addComponentReference(c,g);c.setComponent(g);c.getDivWrap().appendChild(g);this.component=g;c.setStyles();g.addEventListener("focus",c.processFocus)};this.getConfigurationActions=function(){var a=[];if(m){var b=new CTATSAI;b.setSelection(this.getName());b.setInput(m);
...
if(E(b))return C.bind(this,this.change_numerator,this.set_numerator);if(w(b))return C.bind(this,this.change_number_pieces,this.set_number_pieces)}return null}.bind(this);document.addEventListener(CTAT.Component.Base.Tutorable.EventType.action,function(a){var b=a.detail.sai;a=t(a.detail.component);b&&null!==a&&a(b)},!1);var C=function(a,b,c){var d=parseInt(c.getInput());if(!isNaN(d)){switch(c.getAction()){case "ButtonPressed":a.call(this,d);break;case "Update":case "UpdateTextField":case "UpdateTextArea":b.call(this,
...
this.render()};var m=new a(this,new c(0),25,"CTATNumberLine--denominator-tickmark","CTATNumberLine--denominator-tickmark-label");this.setParameterHandler("DenominatorTickmarkSize",function(a){m.setSize(a);this.render();return this});this.setParameterHandler("DenominatorTickmarkStep",function(a){m.setStep((new c(a)).reciprocal())});this.data_ctat_handlers.denominator=function(a){a=new c(a);m.setStep(a.reciprocal())};this.setColor=function(a){};this.getColor=function(){};this.X_Axis=new function(a,
...
Object.defineProperty(this,"Minimum",{get:function(){return this.X_Axis.min},set:function(a){this.X_Axis.min=new c(a)}});this.setMinimum=function(a){this.Minimum=a};this.setParameterHandler("Minimum",this.setMinimum);this.data_ctat_handlers.minimum=this.setMinimum;var r=1;Object.defineProperty(this,"Max_Points",{get:function(){return r},set:function(a){a=parseInt(a);isNaN(a)||(r=a)}});this.setMaxPoints=function(a){this.Max_Points=a};this.setParameterHandler("Max_Points",this.setMaxPoints);this.data_ctat_handlers["max-points"]=
this.setMaxPoints;var p=7;this.setPointSize=function(a){p=Number(a);n&&(n.setAttributeNS(null,"r",p),$(this._point_group).find("circle").each(function(){$(this).attr("r",p)}))};this.setStyleHandler("PointSize",this.setPointSize);this.data_ctat_handlers["point-size"]=this.setPointSize;var x=!1;this.setSnapToTickMark=function(a){x=CTATGlobalFunctions.toBoolean(a)};this.setParameterHandler("SnapToTickmark",this.setSnapToTickMark);this.data_ctat_handlers.snap=this.setSnapToTickMark;this.theta=0;Object.defineProperty(this,
...
f.setAttributeNS(null,"text-anchor","middle");d.appendChild(f);if(null===b||void 0===b)if(1==a.denominator)f.appendChild(document.createTextNode(String(a.numerator.toPrecision(R)))),f.setAttributeNS(null,"x",c.x),f.setAttributeNS(null,"y",c.y);else{b=""+String(a.numerator);h=""+String(a.denominator);f.style.fontSize="0.6em";f.setAttributeNS(null,"text-align","center");var l=document.createElementNS(g,"tspan"),m=document.createElementNS(g,"tspan");l.appendChild(document.createTextNode(b));m.appendChild(document.createTextNode(h));
...
c.y);if(0<Math.abs(CTAT.Math.round(q))){var q=new DOMPoint(a.left,(n-e*a.left)/f),u=new DOMPoint(a.right,(n-e*a.right)/f);if(a.contains(q)||a.contains(u))d.distance(q)<d.distance(u)?(b=u,c=q):(b=q,c=u)}0<Math.abs(CTAT.Math.round(p))&&(p=new DOMPoint((n-f*a.top)/e,a.top),e=new DOMPoint((n-f*a.bottom)/e,a.bottom),a.contains(p)||a.contains(e))&&(d.distance(p)<d.distance(e)?(b=e,c=p):(b=p,c=e));if(this.X_Axis.start.x!=b.x||this.X_Axis.start.y!=b.y||this.X_Axis.end.x!=c.x||this.X_Axis.end.y!=c.y)this.X_Axis.start=
...
e=new DOMPoint(a.cx.baseVal.value,a.cy.baseVal.value),1<d.distance(e)&&(a.cx.baseVal.value=d.x,a.cy.baseVal.value=d.y)}}.bind(this),u=0,n=null,B=new DOMPoint(-30,-30),v=!1,A=function(a){B.x=a.clientX;B.y=a.clientY},z=function(a){cancelAnimationFrame(u);n.style.visibility="hidden";v=!1},D=function(a){if(!0===this.getEnabled()&&0<r){this.setHintHighlight(!1);var b;x?(a=t(a.clientX,a.clientY),b=a.location,a=a.data):(a=w(a.clientX,a.clientY),b=this.X_Axis.getProjectedPoint(a),a=this.X_Axis.getAxisValue(a));
...
this.setActionInput("AddPoint",a.toString());this.processAction()}}.bind(this);this.init=function(){this.initSVG();this.component.classList.add("CTATNumberLine--container");this._axis_line_group=document.createElementNS(g,"g");this._axis_line_group.classList.add("CTATNumberLine--axis");this._tick_mark_group=document.createElementNS(g,"g");this._tick_mark_group.classList.add("CTATNumberLine--tickmark");this._point_group=document.createElementNS(g,"g");n=document.createElementNS(g,"circle");n.setAttributeNS(null,
"r",p);n.classList.add("CTATNumberLine--cursor");n.setAttributeNS(null,"transform","translate(-30,-30)");this.component.appendChild(this._axis_line_group);this.component.appendChild(this._tick_mark_group);this.component.appendChild(this._point_group);this.component.appendChild(n);this.X_Axis.svg_group=this._axis_line_group;q();this.addComponentReference(this,this.getDivWrap());this.component.addEventListener("mousemove",A);this.component.addEventListener("mouseleave",z);var a=this.getEnabled;this.component.addEventListener("mouseenter",
function(){!0===a()&&0<r&&(v=!0,n.style.visibility=null,u=requestAnimationFrame(C))});this.component.addEventListener("click",D);this.component.addEventListener("focus",this.processFocus)};this.getConfigurationActions=function(){var a=[],b,c=$(this.getDivWrap());c.attr("data-ctat-minimum")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_minimum"),b.setInput(c.attr("data-ctat-minimum")),a.push(b));c.attr("data-ctat-maximum")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_maximum"),
...
b.setInput(c.attr("data-ctat-small-tick-step")),a.push(b));c.attr("data-ctat-denominator")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_denominator"),b.setInput(c.attr("data-ctat-denominator")),a.push(b));return a};var H=-1<navigator.userAgent.toLowerCase().indexOf("firefox"),w=function(a,b){this.svgPoint=this.svgPoint?this.svgPoint:this.component.createSVGPoint();this.svgPoint.x=a;this.svgPoint.y=b;var c=this._axis_line_group.getScreenCTM().inverse();this.svgPoint=this.svgPoint.matrixTransform(c);
c=new DOMPoint(this.svgPoint.x,this.svgPoint.y);if(H){var d=$(this.component),e=parseInt(d.css("borderLeftWidth"))+parseInt(d.css("paddingLeft"))+parseInt(d.css("marginLeft")),d=parseInt(d.css("borderTopWidth"))+parseInt(d.css("paddingTop"))+parseInt(d.css("marginTop"));c.x-=e;c.y-=d}return c}.bind(this),E=function(a,b){return this.getProjectedPoint(w(a,b))}.bind(this.X_Axis),t=function(a,b){for(var c=E(a,b),d=null,e=Number.POSITIVE_INFINITY,g,f,h=0;h<this._tickmarks.length;h++)g=this._tickmarks[h],
f=c.distance(g.location),f<e&&(d=g,e=f);return d}.bind(this),C=function(){if(v&&!0===this.getEnabled()){if(x){var a=t(B.x,B.y);n.setAttributeNS(null,"transform","translate"+CTAT.Geom.Point.to2DString(a.location,!0))}else n.setAttributeNS(null,"transform","translate"+CTAT.Geom.Point.to2DString(E(B.x,B.y),!0));u=requestAnimationFrame(C)}}.bind(this);this.render=function(){q()};this.calcXCoordinate=function(a){a=new c(a);var b=this.getWidth()-30,b=Math.abs(b-30),d=max.subtract(min);return 30+a.subtract(min).divide(d)/
b};this.calcNum=function(a){var b=this.getWidth()-30,b=Math.abs(b-30);a=max.subtract(min).multiply((a-30)/b);return min.add(a)};var G=function(a,b){switch(b.getClassName()){case "CTATMessage":b=b.getSAI()}var c=b.clone();c.setAction(a.getSAI().getAction());c.setSelection(a.getName());return c};this.showCorrect=function(a){a.getInput();var b=a.getAction(),c=function(b){b.setCorrect(G(b,a))};switch(b){case "AddPoint":0<this._point_group.children.length&&(b=[].slice.call(this._point_group.children),
c=b[b.length-1],c.classList.remove("CTAT--incorrect"),c.classList.remove("CTAT--hint"),c.classList.add("CTAT--correct"),this.getDisableOnCorrect()&&(b.length>=this.Max_Points&&b.every(function(a){return a.classList.contains("CTAT--correct")})?this.setEnabled(!1):this.setEnabled(!0)));break;case "Points":b=this._point_group.children;for(c=0;c<b.length;c++){var d=b[c];d.classList.remove("CTAT--incorrect");d.classList.remove("CTAT--hint");d.classList.add("CTAT--correct")}break;case "set_minimum":P(O()).forEach(c);
break;case "set_maximum":P(N()).forEach(c);break;case "set_large_step":P(K()).forEach(c);break;case "set_small_step":P(S()).forEach(c);break;case "set_denominator":P(T()).forEach(c);break;default:console.log("Unhandled Action in",this.getName(),b)}};this.showInCorrect=function(a){a.getInput();var b=a.getAction(),c=function(b){b.setIncorrect(G(b,a))};switch(b){case "AddPoint":0<this._point_group.children.length&&(b=[].slice.call(this._point_group.children),b=b[b.length-1],b.classList.remove("CTAT--correct"),
b.classList.remove("CTAT--hint"),b.classList.add("CTAT--incorrect"));break;case "Points":b=this._point_group.children;for(c=0;c<b.length;c++){var d=b[c];d.classList.remove("CTAT--correct");d.classList.remove("CTAT--hint");d.classList.add("CTAT--incorrect")}break;case "set_minimum":P(O()).forEach(c);break;case "set_maximum":P(N()).forEach(c);break;case "set_large_step":P(K()).forEach(c);break;case "set_small_step":P(S()).forEach(c);break;case "set_denominator":P(T()).forEach(c);break;default:console.log("Unhandled Action in",
this.getName(),b)}};var y=this.setEnabled;this.setEnabled=function(a){y(a);n&&v&&(n.style.visibility=this.getEnabled()?null:"hidden")};this.set_minimum=function(a){this.Minimum=a;this.render()};this.change_minimum=function(a){a=new c(a);0!==a.valueOf()&&(this.Minimum=this.Minimum.add(a),this.render())};var I=function(){this.setActionInput("set_minimum",this.Minimum)}.bind(this);this.set_maximum=function(a){this.Maximum=a;this.render()};this.change_maximum=function(a){a=new c(a);0!==a.valueOf()&&(this.Maximum=
this.Maximum.add(a),this.render())};var F=function(){this.setActionInput("set_maximum",this.Maximum)}.bind(this);this.set_max_user_entries=function(a){this.setMaxPoints(parseInt(a))};a=function(a,b){a.setStep(b);this.render()};this.set_large_step=a.bind(this,h);var J=function(){this.setActionInput("set_large_step",h.step.toString())}.bind(this);this.set_small_step=a.bind(this,l);var M=function(){this.setActionInput("set_small_step",l.step.toString())}.bind(this);this.set_denominator=function(a){0===
parseInt(a)?m.setStep(0):m.setStep((new c(a)).reciprocal());this.render()};var L=function(){var a=0===m.step.valueOf()?0:m.step.reciprocal();this.setActionInput("set_denominator",a.toString())}.bind(this);a=function(a,b){if(0!==(new c(b)).valueOf()){var d=a.step.add(b);0>d.valueOf()&&d.set(0,1);a.setStep(d);this.render()}};this.change_large_step=a.bind(this,h);this.change_small_step=a.bind(this,l);this.change_denominator=function(a){a=new c(a);0!==a.valueOf()&&(a=a.add(m.step.denominator),m.setStep(a.reciprocal()))};
var R=void 0;this.set_precision=function(a){R=parseInt(a);this.render()};this.AddPoint=function(a,b){var d=new c(a),e=this.X_Axis.getPosition(d),f=document.createElementNS(g,"circle");f.classList.add("CTATNumberLine--point");f.setAttributeNS(null,"cx",e.x);f.setAttributeNS(null,"cy",e.y);f.setAttributeNS(null,"r",p);f.value=d;[].slice.call(this._point_group.children).some(function(a){return d.equals(a.value)})||this._point_group.appendChild(f)};this.Points=function(a,b){this._point_group.innerHTML=
"";var c=a.split(";"),d;for(d in c)this.AddPoint(c[d],b)};var Q=function(a,b,c,d){switch(d.getAction()){case "ButtonPressed":a.call(this,d.getInput());break;case "Update":case "UpdateTextField":case "UpdateTextArea":b.call(this,d.getInput())}c.call();this.processAction(!1,!0)};a=function(a){return(a=$(this.getDivWrap()).attr(a))?a.split(/\s*;\s*/).map(function(a){return a.trim()}):[]};var N=a.bind(this,"data-ctat-ctrl-max"),O=a.bind(this,"data-ctat-ctrl-min"),K=a.bind(this,"data-ctat-ctrl-large-tick"),
...
this.change_denominator,this.set_denominator,L);if(V(b))return Q.bind(this,this.change_small_step,this.set_small_step,M);if(W(b))return Q.bind(this,this.change_large_step,this.set_large_step,J);if(X(b))return Q.bind(this,this.change_minimum,this.set_minimum,I);if(Y(b))return Q.bind(this,this.change_maximum,this.set_maximum,F)}return null}.bind(this);document.addEventListener(CTAT.Component.Base.Tutorable.EventType.action,function(a){var b=a.detail.sai;a=Z(a.detail.component);b&&null!==a&&a(b)},!1);
...
function(a){$(this.getDivWrap()).attr("data-ctat-ctrl-small-tick",a)};this.setParameterHandler("SmallTickmarkControllers",this.setSmallTickControllers);this.setDenominatorControllers=function(a){$(this.getDivWrap()).attr("data-ctat-ctrl-denominator",a)};this.setParameterHandler("DenominatorTickmarkControllers",this.setDenominatorControllers);a=function(a,b){return 0<=a().indexOf(b)};var Y=a.bind(null,N),X=a.bind(null,O),W=a.bind(null,K),V=a.bind(null,S),U=a.bind(null,T);this.grade=function(a){a=a.getDivWrap().id;
Y(a)?(this.setAction("set_maximum"),this.setInput(this.Maximum.toString())):X(a)?(this.setAction("set_minimum"),this.setInput(this.Minimum.toString())):W(a)?(this.setAction("set_large_step"),this.setInput(h.step.toString())):V(a)?(this.setAction("set_small_step"),this.setInput(l.step.toString())):U(a)?(this.setAction("set_denominator"),this.setInput(m.step.reciprocal().toString())):this.updateSAI();this.processAction(!0)};this.updateSAI=function(){for(var a=this._point_group.children,b=[],c=0;c<a.length;c++)b.push(a[c].value);
...
d);q+=" L "+m(l);q+=" A "+m(p)+" 0 "+(.5<b.valueOf()?1:0)+",1 "+m(n);g.setAttributeNS(null,"d",q+" Z");h.addPieceElem(g,b,b.selected)}return a.add(b)},new CTAT.Math.Fraction);this.baseGroup.innerHTML="";this.baseGroup.appendChild(f);this.setColor(this.color);this.setDeselectedColor(this.deselectedColor);this.setDeselectedColorAlpha(this.deselectedColorAlpha)}};this.getExplode=function(){return c};this.getDropShadowDistance=function(){return g};this.setExplode=function(a){a=Number(a);if(!isNaN(a)){var b=
a!==c;c=a;b&&this.drawPieces()}return this};this.setStyleHandler("explode",this.setExplode);this.data_ctat_handlers.explode=function(a){this.setExplode(a)};this.setDropShadowDistance=function(a){g=parseInt(a);g=isNaN(g)?0:g;p&&(p.setAttributeNS(null,"dx",g),p.setAttributeNS(null,"dy",g),0>=g&&this.baseGroup?this.baseGroup.removeAttributeNS(null,"filter"):this.baseGroup.hasAttributeNS(null,"filter")||this.baseGroup.setAttributeNS(null,"filter",r))};this.data_ctat_handlers["shadow-distance"]=function(a){this.setDropShadowDistance(a)}};
...
a.push(b)}return a};this.setFontColor=function(a){m=a;$(l).css("color",a)};this.getFontColor=function(){return m};this.resize=function(){var a=$(this.getDivWrap()).height();$(l).css("font-size",a-5+"px");$(this.getComponent()).css("height",a-10+"px");$(this.getComponent()).css("width",a-10+"px")};var r=this.setText;this.setText=function(a){r(a);null!==l&&(l.innerHTML=this.getText())};this.setStyleHandler("buttonLabel",this.setText);var p=this.setEnabled;this.setEnabled=function(a){p(a);null!==h&&
...
x.appendChild(q)}g.innerHTML="";g.appendChild(b)}}}};CTATSkillWindow.prototype=Object.create(CTAT.Component.Base.Graphical.prototype);CTATSkillWindow.prototype.constructor=CTATSkillWindow;CTAT.ComponentRegistry.addComponentType("CTATSkillWindow",CTATSkillWindow);var CTATSubmitButton=function(a,b,e,f,d){CTATButton.call(this,a,b,e,f,d);this.setClassName("CTATSubmitButton");CTATConfiguration.get("previewMode");var c=this;this.setParameterHandler("target_components",function(a){this.getDivWrap().setAttribute("data-ctat-target",a);return this});var g=this.init;this.init=function(){g();this.setParameter("tutorComponent",CTAT.Component.Base.Tutorable.Options.DO_NOT_TUTOR);this.component.addEventListener("focus",this.processFocus);this.setStyles()};var h=function(a){var b=
...
break;case 13:return p?(h.component.blur(),CTATGlobals.Tab.Focus=null,h.processAction(),!1):!0;case 0:h.component.blur();CTATGlobals.Tab.Focus=null;h.processAction();break;default:h.ctatdebug('Key pressed! "'+a.which+'"')}};this.updateSAI=function(){h.ctatdebug("updateSAI ()");this.setInput(this.getValue());var a=this.getSAI();h.ctatdebug("SAI: "+a.toTSxmlString())};this.addDblClickListener=function(){var a=document.createElement("div");a.style.position="absolute";a.style.top="0";a.style.left="0";
a.style.bottom="0";a.style.right="0";a.addEventListener("dblclick",function(){setTimeout(function(){var a=h.getDivWrap().getAttribute("data-ctat-enabled");h.setEnabled(!0);var b=h.getComponent();b.hasEditListeners||(b.addEventListener("blur",function(){h.setEnabled(!1);h.getDivWrap().setAttribute("data-ctat-enabled",a);h.getDivWrap().setAttribute("value",b.value)}),"CTATTextArea"===h.getClassName()&&b.addEventListener("keydown",function(a){13==(a.keyCode||a.charCode)&&(a.preventDefault(),this.value+=
...
f.type=a.getClassName();f.name=a.getName();f.setComponentPointer(a);CTATShellTools.registerComponentDescription(f)}$(this).data("CTATComponent",a);CTATConfiguration.get("previewMode")&&((f=ctatEnabledInPreview[a.getClassName()])||(f=!1),a.setEnabled(f),a.getDivWrap().setAttribute("data-ctat-enabled","true"))}})}CTATShellTools.listComponents();ctatdebug("initializeHTMLComponents () done")};
CTATTutor.callComponentFunction=function(a,b,e){var f=CTATShellTools.findComponent(a.id);if(f&&0<f.length)return a=f[0],f=null,b&&(f=b(a,e)),f;ctatdebug("Couldn't find CTATComponent registered to div "+a.id)};function assignNameTranslator(a){nameTranslator=a}CTATTutor.drawTutor=function(){if(!0!==this.drawing){this.drawing=!0;for(var a in CTATShellTools.component_descriptions){var b=CTATShellTools.component_descriptions[a].getComponentPointer();null!==b&&b.drawComponent()}this.drawing=!1}};
...
CTATTutor.runTutor=function(a){ctatdebug("runTutor ()");!0===CTATGlobals.tutorRunning?ctatdebug("The tutor is already running"):(null==CTATSkillSet.skills&&(CTATSkillSet.skills=new CTATSkillSet),window.onerror=function(a,e,f){var b=new CTATHTMLManager;ctatdebug(b.htmlEncode(a)+" in "+e+", line "+f);ctatdebug(b.htmlEncode(a)+" in "+e+", line "+f)},centerTutorContainer(),CTATTutor.initialize(),CTATGlobals.tutorRunning=!0,ctatdebug("runTutor () ... all set"))};
...
Object.defineProperty(CTATMsgType,"GO_TO_STATE",{enumerable:!1,configurable:!1,writable:!1,value:"GoToState"});Object.defineProperty(CTATMsgType,"INTERFACE_REBOOT",{enumerable:!1,configurable:!1,writable:!1,value:"InterfaceReboot"});Object.defineProperty(CTATMsgType,"CompletionValue",{enumerable:!1,configurable:!1,writable:!1,value:["incomplete","complete"]});CTATMsgType.prototype=Object.create(CTATBase.prototype);CTATMsgType.prototype.constructor=CTATMsgType;
...
d.call(arguments,0):[];return a.apply(b,c)}}(CTATFormulaActions[b],CTATFormulaActions))}a.prototype.evaluate=function(a,g,m,r){var h,l,q,u,n,B,v,A,z,D,H,w;try{A="undefined"!==typeof window&&null!==window?window:global;h=function(){var a;a=[];for(u in A)a.push(u);return a}().concat(["selection","action","input"]);z=a.split(f);l=0;for(n=z.length;l<n;l++)for(v=z[l],H=null!=(D=v.match(b))?D:[],q=0,B=H.length;q<B;q++)u=H[q],0>c.call(e,u)&&0>c.call(h,u)&&0>c.call(this.keys,u)&&CTATFormulaFunctions.assign(u,
void 0);for(u in w=this.variableTable.getTable())A[u]=w[u];return function(a,b,c){c.prototype=a.prototype;c=new c;a=a.apply(c,b);return Object(a)===a?a:c}(Function,["selection","action","input"].concat(d.call(this.keys),["return "+a.trim()]),function(){}).apply(A,[g,m,r].concat(d.call(this.values)))}catch(E){return console.log(E),null}finally{for(u in A)null!=u&&0>c.call(h,u)&&(w[u]=A[u],delete A[u])}};a.prototype.interpolateSplitPattern=/<%=|%>/;a.prototype.interpolate=function(a,b,c,d){var e,f,
...
function(a){q=a};this.setMinTraversalsStr=function(a){if(null===a||"undefined"===typeof a||1>a.length)m=1;else try{m=parseInt(a.trim()),isNaN(m)&&(m=1)}catch(z){m=1}};this.setMaxTraversalsStr=function(a){if(null===a||"undefined"===typeof a||1>a.length)l=m;else try{l=parseInt(a.trim()),isNaN(l)&&(l=1)}catch(z){l=m}};this.setUniqueID=function(a){f=a};this.addSkillName=function(a){v.ctatdebug("ETLink["+f+"].addSkillName("+a+")");if("unnamed"!==a){if(null===B||"undefined"===typeof B)B=[];-1<B.indexOf(a)||
...
a+")");null!==H&&"undefined"!==typeof H&&(H.length=0);null!==a&&"undefined"!==typeof a&&(H=a.slice(0));w.ctatdebug("CTATExampleTracerEvent --\x3e out of setInterpolatedHints")};this.setWantReportableHints=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setWantReportableHints("+a+")");z=a};this.getSuccessOrBuggyMsg=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning "+v);return v};this.getReportableHints=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning "+
A);return A};this.getReportableLink=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning "+r);return r};this.getReportableVariableTable=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning "+B);return B};this.getReportableInterpretation=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning "+p);return p};this.getStepID=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning "+
...
-1;b.getInLinks().forEach(function(a){-1===a.getDepth()&&n(a);a.getDepth()>c&&(c=a.getDepth())});a.setDepth(c+1)}}CTATBase.call(this,"CTATExampleTracerGraph","visualdata");var B=null,v=null,A=null,z=null,D=null,H=null,w=new Set,E=new Set,t=null,C=null,G=CTATMsgType.SHOW_ALL_FEEDBACK,y=this;this.getFeedbackPolicy=function(){return G};this.setFeedbackPolicy=function(a){y.ctatdebug("Graph.setFeedbackPolicy("+a+") old policy "+G);G="false"===a?CTATMsgType.SHOW_ALL_FEEDBACK:"true"===a?CTATMsgType.HIDE_ALL_FEEDBACK:
...
return!0};this.getNode=function(a){y.ctatdebug("CTATExampleTracerGraph --\x3e in getNode("+a+") returning "+z[a]);return z[a]};this.findNode=function(a){if(a){a=a.toLowerCase();for(var b in z)if(z[b].getNodeName().toLowerCase()==a)return y.getNode(b)}return null};this.findPathsFromNode=function(a){y.ctatdebug("CTATExampleTracerGraph --\x3e in findPathsFromNode outlinks "+a.getOutLinks().size);var b=new Set;if(!a||0===a.getOutLinks().size)return b.add(new CTATExampleTracerPath(null)),b;y.ctatdebug("CTATExampleTracerGraph --\x3e before forEach ");
...
a+")");D=a};this.getStudentStartsHereNode=function(){y.ctatdebug("CTATExampleTracerGraph --\x3e getStudentStartsHereNode() returns "+H);return H};this.setStudentStartsHereNode=function(a){y.ctatdebug("CTATExampleTracerGraph --\x3e in setStudentStartsHereNode("+a+")");H=a};this.getExampleTracer=function(){y.ctatdebug("CTATExampleTracerGraph --\x3e in getExampleTracer() returning "+B);return B};this.forDebugging=function(){y.ctatdebug("CTATExampleTracerGraph --\x3e in forDebugging");y.ctatdebug("Nodes in the graph -- ids");
v.forEach(function(a){y.ctatdebug(a.getNodeID())});y.ctatdebug("Links in the graph -- ids, from, to");A.forEach(function(a){y.ctatdebug(a)})};this.getSmallestContainingGroup=function(a){return C.getLowestLevelGroupOfLink(a)};this.redoLinkDepths=function(){q();y.getLinks().forEach(function(a){a.setDepth(-1)});y.getLinks().forEach(function(a){-1===a.getDepth()&&n(a)})};this.getGroupModel=function(){return C};this.setVisualData=function(a){y.ctatdebug("CTATExampleTracerGraph --\x3e in setVisualData");
t=a};this.getVisualData=function(){y.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning "+t);return t};this.getDoneLinks=function(){return E};(function(a,b){y.ctatdebug("CTATExampleTracerGraph --\x3e in initGraph ("+a+" , "+b);A=[];v=[];z={};if(null===C||"undefined"===typeof C)C=new CTATDefaultGroupModel,y.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");C.clear();C.setDefaultReenterable(!b);C.setGroupOrdered(C.getTopLevelGroup(),a);C.setGroupName(C.getTopLevelGroup(),
CTATExampleTracerGraph.TOP_LEVEL);B=new CTATExampleTracerTracer(y,e);y.ctatdebug("CTATExampleTracerGraph --\x3e out of initGraph")})(!a,b)};Object.defineProperty(CTATExampleTracerGraph,"TOP_LEVEL",{enumerable:!1,configurable:!1,writable:!1,value:"Top Level"});CTATExampleTracerGraph.prototype=Object.create(CTATBase.prototype);CTATExampleTracerGraph.prototype.constructor=CTATExampleTracerGraph;"undefined"!==typeof module&&(module.exports=CTATExampleTracerGraph);var CTATGraphParser=function(){function a(a){ctatdebug("processEdge()");for(var d=new CTATExampleTracerLink(null,null,null),e=g.getElementChildren(a),f,h,l,m,q,p=a=-1,w=CTATMsgType.DEFAULT_ACTOR,x=!1,t=0;t<e.length;t++){"sourceID"===g.getElementName(e[t])&&(a=parseInt(g.getNodeTextValue(e[t])),d.setPrevNode(a));"destID"===g.getElementName(e[t])&&(p=parseInt(g.getNodeTextValue(e[t])),d.setNextNode(p));if("rule"===g.getElementName(e[t]))for(var C=g.getElementChildren(e[t]),G=0;G<C.length;G++)"text"===
g.getElementName(C[G])&&d.addSkillName(g.getNodeTextValue(C[G]).toString());if("actionLabel"===g.getElementName(e[t]))for(d.setIsPreferredLink("false"!=g.getElementAttr(e[t],"preferPathMark")),d.setMinTraversalsStr(g.getElementAttr(e[t],"minTraversals")),d.setMaxTraversalsStr(g.getElementAttr(e[t],"maxTraversals")),C=g.getElementChildren(e[t]),G=0;G<C.length;G++){"uniqueID"===g.getElementName(C[G])&&(q=g.getNodeTextValue(C[G]),d.setUniqueID(parseInt(g.getNodeTextValue(C[G]))));"message"===g.getElementName(C[G])&&
...
null),y.setParameter(J?J:""));y.setReplacementFormula(f);w=[[l],[w],[y],M];f=w[0];h=w[1];l=w[2];w=w[3]}}}c.getStartNode()&&p==c.getStartNode().getNodeID()&&console.log("***WARNING*** edge "+q+" destination is graph startNode "+c.getStartNode());q=new CTATVectorMatcher(f,h,l,w);q.setDefaultSAI(m.getSAI());q.setCaseInsensitive(r);q.setLinkTriggered(x);d.setMatcher(q);ctatdebug("GraphParser.processEdge() "+a+"->"+p+", edge "+d);c.getNode(a).addOutLink(d);c.checkForDoneState(d);return d}function b(a,
b){f.ctatdebug("processMatchers()");for(var c=g.getElementChildren(a),d=[],e=0;e<c.length;e++)if("matcher"===g.getElementName(c[e])){for(var h=null,l=g.getElementAttr(c[e],"replacementFormula"),m=g.getElementChildren(c[e]),q=0;q<m.length;q++){if("matcherType"===g.getElementName(m[q]))switch(h=g.getNodeTextValue(m[q]),f.ctatdebug("CTATGraphParser.processMatchers() matcherType["+q+"] = "+h),h){case "ExactMatcher":h=new CTATExactMatcher(b,null);break;case "RegexMatcher":h=new CTATRegexMatcher(b,null);
break;case "AnyMatcher":h=new CTATAnyMatcher(b,null);break;case "RangeMatcher":h=new CTATRangeMatcher(b,null);break;case "WildcardMatcher":h=new CTATWildcardMatcher(b,null);break;case "ExpressionMatcher":h=new CTATExpressionMatcher(b,null);break;default:console.log("CTATGraphParser.processMatchers() unknown matcherType["+q+"] = "+h+"; using CTATExactMatcher"),h=new CTATExactMatcher(b,null)}if("matcherParameter"===g.getElementName(m[q])){var p=g.getElementAttr(m[q],"name");"single"===p?h.setParameter(g.getNodeTextValue(m[q])):
"minimum"===p?h.setParameter(g.getNodeTextValue(m[q]),"minimum"):"maximum"===p?h.setParameter(g.getNodeTextValue(m[q]),"maximum"):h.setParameter(m[q],p,g)}}h&&h.setReplacementFormula(l);d.push(h)}return d}function e(a,b){var c=new Set;if("group"!==g.getElementName(a))return c;var d=g.getElementAttr(a,"name");ctatdebug("readGroupFromXML group name: "+d);var f="true"===g.getElementAttr(a,"ordered"),h="true"===g.getElementAttr(a,"reenterable");ctatdebug("readGroupFromXML group isOrdered typeof: "+typeof f);
ctatdebug("readGroupFromXML group isOrdered: "+f);for(var l=function(a){c.add(a)},q=g.getElementChildren(a),p=0;p<q.length;p++){if("link"===g.getElementName(q[p])){var r=Number(g.getElementAttr(q[p],"id")),u=b[r];if(null!==u||void 0!==u)ctatdebug("Added link ID : "+r),c.add(u)}"group"===g.getElementName(q[p])&&(ctatdebug("encountered a subgroup"),e(q[p],b).forEach(l))}m.addGroup(d,f,c);m.setGroupReenterable(m.getGroupByName(d),h);return c}CTATBase.call(this,"CTATGraphParser","__undefined__");var f=
this,d,c,g=new CTATXML,h=null,l=[];new XMLSerializer;var m,r=!0,p=!0,x=[];this.getLockWidget=function(){return p};this.parseGraph=function(b,f){ctatdebug("parseBRD()");var n=0,q=g.getElementAttr(b,"startStateNodeName"),u="true"===g.getElementAttr(b,"unordered");r="false"!=String(g.getElementAttr(b,"caseInsensitive")).toLowerCase();p=g.getElementAttr(b,"lockWidget");var A=new CTATVariableTable;c=new CTATExampleTracerGraph(u,!1,A);var z=g.getElementChildren(b),A=g.getElementAttr(b,"suppressStudentFeedback");
if(null===A||void 0===A)A=CTATMsgType.SHOW_ALL_FEEDBACK;c.setFeedbackPolicy(A);f.setFeedbackSuppressed(A);A=g.getElementAttr(b,"highlightRightSelection");f.setHighlightRightSelection("false"!=A);var D=g.getElementAttr(b,"confirmDone");"true"!==D&&"false"!==D&&(D=c.getFeedbackPolicy()===CTATMsgType.HIDE_ALL_FEEDBACK?"true":"false");f.setHintPolicy(g.getElementAttr(b,"hintPolicy"));f.setOutOfOrderMessage(g.getElementAttr(b,"outOfOrderMessage"));for(var H=null,w=0;w<z.length;w++)switch(g.getElementName(z[w])){case "startNodeMessages":l=
g.getElementChildren(z[w]);break;case "node":n++;var E;E=z[w];ctatdebug("processNode("+E+")");var t=g.getElementChildren(E),C=-1;E="";for(var G=0;G<t.length;G++)switch(g.getElementName(t[G])){case "uniqueID":C=parseInt(g.getNodeTextValue(t[G]));break;case "text":E=g.getNodeTextValue(t[G])}t=new CTATExampleTracerNode(C,new Set);""!==E&&t.setNodeName(E);E=t;c.addNode(E);1==n&&(c.setStartNode(E),c.setStudentStartsHereNode(E));E.getNodeName()==q&&c.setStudentStartsHereNode(E);break;case "edge":c.addLink(a(z[w]));
break;case "EdgesGroups":H=z[w];break;case "productionRule":var y=z[w];ctatdebug("processSkill()");for(var t=E="",G=C=null,y=g.getElementChildren(y),I=0;I<y.length;I++){var F=g.getElementName(y[I]);"ruleName"==F&&(E=g.getNodeTextValue(y[I]),ctatdebug("ruleName="+E));"productionSet"==F&&(t=g.getNodeTextValue(y[I]),ctatdebug("productionSet="+t));"label"==F&&(C=g.getNodeTextValue(y[I]),ctatdebug("label="+C));"description"==F&&(G=g.getNodeTextValue(y[I]),ctatdebug("description="+G))}E&&(y=new CTATExampleTracerSkill(t,
...
typeof n);ctatdebug("parseGraph()typeof isUnordered: "+typeof u);q=H;z=n;ctatdebug("processGroup()");m=c.getGroupModel();n=m.createIdToLinkMap();m.setGroupOrdered(m.getTopLevelGroup(),z);ctatdebug("processGroup() name of group: "+m.getGroupName(m.getTopLevelGroup()));ctatdebug("processGroup() group isOrdered?: "+m.isGroupOrdered(m.getTopLevelGroup()));ctatdebug("processGroup() order of group: isOrdered= "+z);ctatdebug("processGroup() order of group: isOrdered typeof= "+typeof z);q=g.getElementChildren(q);
for(z=0;z<q.length;z++)switch(g.getElementName(q[z])){case "group":e(q[z],n);break;case "outOfOrderMessage":m.getTopLevelGroup().setDefaultBuggyMsg(g.getNodeTextValue(q[z]))}}n=f.getSkillBarVector(!1,!0);if(!n||1>n.length)ctatdebug("No existing skills. Add skills from BRD."),f.addGraphSkills(x),n=f.getSkillBarVector();h=(new CTATTutorMessageBuilder).createStateGraphMessage(r,u,p,f.isSourceFlash()?c.exitOnIncorrectDone():f.isFeedbackSuppressed(),A,D,n);c.redoLinkDepths();d=c.getExampleTracer();d.resetTracer();
...
g.length+", transaction_id "+r);for(var m=[],q=[],u=0;u<g.length;++u){var A=g[u];if(A.msg){var z=A.msgType,D=A.evt;p.ctatdebug("entering processInterfaceVariables() msgType "+z+", evt "+D);z&&(p.ctatdebug("entering processInterfaceVariables() et "+c+", tracer "+(c?c.getTracer():null)),z=z.toLowerCase(),0!==z.indexOf("correct")&&0!==z.indexOf("interfaceaction")||c.getTracer().addInterfaceVariablesFromEvent(D));if(!(z=f(A)))if(z=A,D=q,CTATConfiguration.usingFlash()){var H=void 0,w=void 0;if(!(z&&z.sai&&
(H=z.sai.getAction())&&(w=x.exec(H)))||3>w.length||1>=w[2])z=!1;else{var E=D.length-1,E=0>E?null:D[E];z.msg=z.msg.replace(H,w[1]);E&&E.timeout==w[2]?E.msgTuples.push(z):D.push({timeout:Number(w[2]),msgTuples:[z]});z=!0}}else z=!1;z||m.push(A.msg)}}p.ctatdebug("flushMessageTank(): msgBundle.length "+m.length+", delayedMsgsBundle.length "+q.length);for(u=0;u<q.length;++u)A=q[u],p.ctatdebug("processDelayedMsgs() delayedMsgs.timeout "+A.timeout+", .msgTuples.length "+A.msgTuples.length),setTimeout(d,
...
c.getProblemStateSaver().saveAsYouGo(a))),p.ctatdebug("Exiting flushMessageTank() #CorrectAction "+h.CorrectAction+", #InterfaceAction "+h.InterfaceAction+", #UntutoredAction "+h.UntutoredAction));h=g=r=null}};this.flushDelayedFeedback=function(){p.ctatdebug("Entering flushDelayedFeedback()");var a=c.getDelayedFeedback(),b;for(b in a)a.hasOwnProperty(b)&&CTAT.ToolTutor.sendToInterface(a[b]);c.clearDelayedFeedback()};this.suppressFeedback=function(a,b){p.ctatdebug("CTATMessageTank.suppressFeedback("+
...
"undefined"!==typeof module&&(module.exports=CTATStep);var CTATProblemSummary=function(a,b,e){CTATBase.call(this,"CTATProblemSummary","");if(null===a||"undefined"===typeof a||1>a.length)throw new CTATExampleTracerException("problemName null or empty");var f=!0,d=Number.MAX_VALUE,c=b,g=e,h=0,l=new Date,m={},r=0,p=0,x=0,q=0,u=0,n=0,B=0,v=CTATMsgType.CompletionValue[0],A=this;this.getCountOnlyLastResults=function(){return g};this.setCountOnlyLastResults=function(a){g=a};this.getTimeElapsed=function(){return h};this.getUniqueErrors=function(){if(!A.getCountOnlyLastResults())return B;
...
b&&"undefined"!==typeof b?(1>b.getNCorrect()&&1>b.getNErrors()&&++B,b.incrementErrors()):(b=new CTATStep(a,CTATStep.StepResult[1]),m[a]=b,B++);x++;b.setLastResult(CTATStep.StepResult[1]);A.ctatdebug("exiting addError() error count "+x+", trial "+b)};this.addCorrect=function(a){var b=m[a];A.ctatdebug("entering addCorrect("+a+") trial "+b);b?(1>b.getNCorrect()&&1>b.getNErrors()&&(++u,1>b.getNFirstHints()&&n++),b.incrementNCorrect()):(A.ctatdebug("to call CTATStep("+a+", StepResult "+CTATStep.StepResult[3]),
b=new CTATStep(a,CTATStep.StepResult[3]),m[a]=b,u++,n++);r++;b.setLastResult(CTATStep.StepResult[3]);A.ctatdebug("exiting addCorrect() correct count "+r+", trial "+b)};this.setShowCounts=function(a){f=a};this.setCompletionStatus=function(a,b){A.ctatdebug("setCompletionStatus("+a+", "+b+")");if(CTATMsgType.CompletionValue[1]!=v||b)v=a};this.getCompletionStatus=function(){return v}};CTATProblemSummary.prototype=Object.create(CTATBase.prototype);CTATProblemSummary.prototype.constructor=CTATProblemSummary;
...
d;if(b=z.getDefaultBuggyMsg())return d.tutorAdvice=b,d.msg=c.createBuggyMessage(a.getTransactionID,d.tutorAdvice),d.msgType="BuggyMessage",n.ctatdebug("createBuggyMessage() default buggy msg: "+d),d;n.ctatdebug("createBuggyMessage() no buggy msg: "+d);return d}function m(a,b,c,d){n.ctatdebug("checkForTutorAction("+a+", "+b+", "+c+", "+d+")");var e=[];e[0]=r(z.getNode(a),!0);e[1]=r(z.getNode(b),!1);n.ctatdebug("checkForTutorAction() links[0] "+e[0]+", links[1] "+e[1]+";");a=0;if(e[0]===e[1])e[1]=null;
...
new CTATMessageTank(n,null),b.push(p(a[d],a[d].getDefaultSAI(),a[d].getActor(),!1,null)),n.ctatdebug("traceLinks["+d+"] result "+b[d]));return b};this.enqueueForRestore=function(a){n.ctatdebug("enqueueForRestore: got "+a.length+" message elements");M=M.concat(a);a=(new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null);M.push(a);n.startWorking(1)};this.startWorking=function(b){a(b,!1)};this.stopWorking=function(b){a(b,!0)};this.goToStartState=function(){return n.goToState("start")};
this.goToState=function(a){a=(a=z.findNode(a))?a.getNodeID():-1;Number.isSafeInteger(a)&&0<a&&n.receiveFromInterface("<message><verb>NotePropertySet</verb><properties><MessageType>"+CTATMsgType.GO_TO_STATE+"</MessageType><nodeID>"+a+"</nodeID></properties></message>")};this.processXML=function(a){n.ctatdebug("processXML ()");if(null!=a){n.ctatdebug("No of children"+D.getElementChildren(a).length);var c=new CTATGraphParser,d=c.parseGraph(a,n);z=d.gr;v=d.tracer;a=d.ssm;d=d.sgMsg;n.ctatdebug("sendStartStateMessages() nMsgs "+
a.length+", outputStatus "+J);for(var e=[],f=new XMLSerializer,g=null,h=0;h<a.length;h++)if("message"==D.getElementName(a[h])){var l=f.serializeToString(a[h]),p=CTATMsgType.getMessageType(l);CTATMsgType.UNTUTORED_ACTION!=p&&CTATMsgType.INTERFACE_ACTION!=p||n.setVariablesFromSAI(a[h],D);CTATMsgType.START_STATE_END==p?(g=e,z.getFeedbackPolicy()!=CTATMsgType.SHOW_ALL_FEEDBACK&&(p=new CTATSAI("hint","SetVisible","false"),p=(new CTATTutoringServiceMessageBuilder).createInterfaceActionMessage("dummyTransactionID",
p),g.push(p)),g=l,e.push((new CTATTutoringServiceMessageBuilder).createInterfaceConfigurationEnd()),e.push((new CTATTutorMessageBuilder).createLockWidgetMsg(c.getLockWidget()))):e.push(l)}e.unshift(d);e.unshift(b());n.ctatdebug("sendStartStateMessages(): "+a.length+" elts, "+e.length+" strings, "+J);n.sendBundle(e);c=g;a:{a=[];d=z.getStartNode();e=CTATMsgType.START_STATE_END;f=d.getNodeID();h=O;O=-1;l=null;h==f?J.transition(e,null):0<h&&(l=z.getNode(h));n.ctatdebug("CTATET.resetGoToState("+e+", null, "+
f+") returns "+l);J.transition(CTATMsgType.END_GO_TO_STATE,null);(e=l)||z.getStudentStartsHereNode();if(null!==d&&null!==e&&d.getNodeID()!=e.getNodeID()){a=z.getBestSubpath(d,e);n.ctatdebug("advanceToStudentStartsHere() path "+a);if(!a)break a;a=a.getSortedLinks();a=n.traceLinks(a);n.ctatdebug("advanceToStudentStartsHere() results "+a)}e=d=null;0<a.length&&(e=a[a.length-1],a=e.getReportableLink(),null!==a&&(d=a.getNextNode()));n.ctatdebug("advanceToStudentStartsHere() to check for TPA "+d+", "+e);
m(d,v.findCurrentState(!1,!1),null,e)}a=[];c&&a.push(c);J.canRestore()||a.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null));0<a.length&&n.sendBundle(a);Q=!0}n.startWorking(0)};this.addGraphSkills=function(a){n.ctatdebug("adding graph skills: "+a.length);0<a.length&&(a=new CTATSkills(a),a.setExternallyDefined(!1),n.getProblemSummary().setSkills(a))};this.sendBundle=function(a){n.ctatdebug("sending bundle #msgs = "+a.length+", outputStatus "+J);for(var b=0,c=0;c<
a.length;c++){n.ctatdebug("Sending message #"+c);var d=a[c];0>=c&&(d='<?xml version="1.0" encoding="UTF-8"?>'+d);I.forwardToInterface(d,c>=a.length-1,J)&&++b}return 0<b};this.setHintPolicy=function(a){w=CTATHintPolicyEnum.lookup(a)};this.isHighlightRightSelection=function(){return E};this.setHighlightRightSelection=function(a){E=a};this.updateSkills=function(a,b,c){var d=[];n.ctatdebug("in updateSkills("+b+") with step ID = "+c+", transaction result = "+a);var e=n.getProblemSummary().getSkills();
...
C.setRequiredSteps(a.countStepsForScore(z));return C};this.getProblemName=function(){return G};this.getSourceID=function(){return y};this.isSourceFlash=function(){return"string"==typeof y&&y.match(/flash/i)};this.isFeedbackSuppressed=function(){return t};this.setFeedbackSuppressed=function(a){t="false"===a?!1:"true"===a?!0:a===CTATMsgType.SHOW_ALL_FEEDBACK?!1:a===CTATMsgType.HIDE_ALL_FEEDBACK?!0:a===CTATMsgType.HIDE_BUT_ENFORCE?!0:a===CTATMsgType.HIDE_BUT_COMPLETE?!0:!1;n.ctatdebug("setFeedbackSuppressed("+
a+"): "+t);C&&C.setCountOnlyLastResults(t)};this.getSkillBarVector=function(a,b){var c=n.getProblemSummary().getSkills();return null===c||"undefined"===typeof c?null:"Student"!=x(b)?null:"undefined"!=typeof a&&a?c.getSkillBarVector(!1,!1):c.getSkillBarVector(!0,!0)};this.startSkillTransaction=function(){var a=n.getProblemSummary().getSkills();a&&a.startTransaction()};this.getProblemStateSaver=function(){return I};this.isSendingSavedMsgsForRestore=function(){return n.getOutputStatus().isSendingSavedMsgsForRestore()};
this.getOutputStatus=function(){return J};this.setOutputStatus=function(a){var b=J.getStatus();n.ctatdebug("setOutputStatus() old "+b+", new "+a);CTATProblemStateStatus[a]?J.setStatus(CTATProblemStateStatus[a]):(console.error("CTATExampleTracer.setOutputStatus() unexpected argument "+a),J.setStatus(CTATProblemStateStatus.empty))};this.getFeedbackPolicy=function(){return z?z.getFeedbackPolicy():CTATMsgType.SHOW_ALL_FEEDBACK};this.getGraph=function(){return z};this.getTracer=function(){return v};this.getOutOfOrderMessage=
function(){return A?A:CTATMsgType.DEFAULT_OUT_OF_ORDER_MESSAGE};this.setOutOfOrderMessage=function(a){A=a};this.getDelayedFeedback=function(){null==K&&(K={});return K};this.clearDelayedFeedback=function(){K=null};this.getQuestionFile=function(a){if(!B||a)return B;a=B.split("/");return a[a.length-1]}};CTATExampleTracer.prototype=Object.create(CTATBase.prototype);CTATExampleTracer.prototype.constructor=CTATExampleTracer;"undefined"!==typeof module&&(module.exports=CTATExampleTracer);
