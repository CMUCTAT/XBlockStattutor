  ...
  var b = function() {
    ...
    "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, e = function(a) {
      ...
      for (var e = {}, g = b.olson.dst_rules.zones, l = g.length, k = a[f], x = 0;x < l;x++) {
        var B = g[x], E;
        E = g[x];
        for (var y = 0, z = 0;z < d.length;z++) {
          if (E.rules[z] && d[z]) {
            if (d[z].s >= E.rules[z].s && d[z].e <= E.rules[z].e) {
              y = 0, y += Math.abs(d[z].s - E.rules[z].s), y += Math.abs(E.rules[z].e - d[z].e);
            } else {
              y = "N/A";
              break;
            }
      ...
      for (var t in e) {
        if (e.hasOwnProperty(t) && -1 != k.indexOf(t)) {
          return t;
        }
      }
      return f;
...
(function(a, b) {
  ...
  function k() {
    ...
    h.prototype.lines = function(a, e) {
      ...
      function l(a, k, m) {
        b(r, b(g(c(), {rotation:360 / e.lines * a + "deg", left:~~k}), b(g(d("roundrect", {arcsize:e.corners}), {width:h, height:e.scale * e.width, left:e.scale * e.radius, top:-e.scale * e.width >> 1, filter:m}), d("fill", {color:f(e.color, a), opacity:e.opacity}), d("stroke", {opacity:0}))));
      }
      var h = e.scale * (e.length + e.width), k = 2 * e.scale * h, m = -(e.width + e.length) * e.scale * 2 + "px", r = g(c(), {position:"absolute", top:m, left:m});
      if (e.shadow) {
        for (m = 1;m <= e.lines;m++) {
  ...
  var l = ["webkit", "Moz", "ms", "O"], m = {}, n, q, u = {lines:12, length:7, width:5, radius:10, scale:1, corners:1, color:"#000", opacity:.25, rotate:0, direction:1, speed:1, trail:100, fps:20, zIndex:2E9, className:"spinner", top:"50%", left:"50%", shadow:!1, hwaccel:!1, position:"absolute"};
  h.defaults = {};
  d(h.prototype, {spin:function(b) {
    ...
    d.lines(e, d.opts);
    if (!n) {
      var c = 0, l = (f.lines - 1) * (1 - f.direction) / 2, h, k = f.fps, m = k / f.speed, r = (1 - f.opacity) / (m * f.trail / 100), u = m / f.lines;
      (function A() {
        c++;
        for (var a = 0;a < f.lines;a++) {
          h = Math.max(1 - (c + (f.lines - a) * u) % m * r, f.opacity), d.opacity(e, a * f.direction + l, h, f);
        }
        d.timeout = d.el && setTimeout(A, ~~(1E3 / k));
      })();
    }
    return d;
  }, stop:function() {
  ...
  if ("undefined" !== typeof document) {
    ...
    !e(r, "transform") && r.adj ? k() : n = e(r, "animation");
  }
  return h;
});
...
;var CTATShape = function(a, b, c, e, g, d) {
  ...
  var h = [], k = [], l = g, m = d, n = b, q = void 0, u = "black", r = "black", v = "Arial", w = 12, x = [], B = 1, E = 5, y = document.createElement("canvas");
  y.id = n;
  y.width = l;
  y.height = m;
  var z = new CTATCSS;
  ...
  y.setAttribute("style", z.toCSSString());
  getSafeElementById(a).appendChild(y);
  var t = new CTATGraphicsTools(y.getContext("2d"));
  t.setGraphicBorderWidth(B);
  t.setLineColor(u);
  t.setFillColor(r);
  ...
  this.setYPoints = function(a) {
    k = a;
    z.modifyCSSAttribute("top", k[0] + "px");
    y.setAttribute("style", z.toCSSString());
  };
  ...
  this.shapeMagicTrigFunctionX = function(a) {
    t.magicTrigFunctionX(a);
  };
  this.shapeMagicTrigFunctionY = function(a) {
    t.magicTrigFunctionY(a);
  };
  this.drawLine = function() {
    t.drawLine(h[0] + B, k[0] + B, h[1], k[1], u, B);
  };
  this.drawCircle = function() {
    t.drawCircle(h[0] + E, k[0] + E, E);
  };
  this.drawCircleFilled = function() {
    t.drawCircleFilled(h[0] + E, k[0] + E, E - 1);
  };
  this.drawRectangle = function(a, b, d, e) {
    t.drawRectangle(a[0] + B, b[0] + B, l - B, m - B);
  };
  this.drawRectangleFilled = function() {
    t.drawRectangleFilled(h[0], k[0], l, m);
  };
  this.drawRoundedRect = function() {
    t.drawRoundedRect(h[0] + B, k[0] + B, l - E - B, m - E - B, E);
  };
  this.drawRoundedRectFilled = function() {
    t.drawRoundedRectFilled(h[0] + B, k[0] + B, l - E - B, m - E - B, E);
  };
  this.drawText = function() {
    t.drawText(w / 2, w / 2, q);
  };
  this.drawTriangle = function() {
    t.drawTriangle(h[0] + B, k[0] + B, h[1], k[1], h[2], k[2]);
  };
  this.drawTriangleFilled = function() {
    t.drawTriangleFilled(h[0], k[0], h[1], k[1], h[2], k[2]);
  };
  this.save = function() {
    t.save();
  };
...
var CTATConnection = function(a) {
  ...
  this.init = function() {
    ...
    if (null !== c) {
      ...
      try {
        c.setRequestHeader("Content-type", d), c.setRequestHeader("ctatsession", b);
      } catch (e) {
...
var CTATCompBase = function(a, b, c, e, g, d) {
  ...
  var f = c || 0, h = e || 0, k = g || -2, l = d || -2, m = 50, n = 25, q = !1, u = "", r = !1, v = !0, w = null, x = "", B = -1;
  this.isTabIndexable = !0;
  var E = 0, y = null, z = null, t = this, C = null, p = "hidden", D = CTATGlobalFunctions.gensym.z_index(), F = CTATGlobalFunctions.gensym.div_id(), A = CTATGlobalFunctions.gensym.z_index(), J = CTATGlobalFunctions.gensym.div_id();
  ...
  this.setZIndex = function(a) {
    t.ctatdebug("Setting z index to: " + a);
    E = a;
  ...
  this.processCommShellEvent = function(a, b) {
    t.ctatdebug("processCommShellEvent (" + a + ")");
  };
  this.makeDivWrapper = function(a) {
    ...
    w.style.top = h + "px";
    w.style.zIndex = D;
    w.style.width = t.getWidth() + "px";
    w.style.height = t.getHeight() + "px";
  ...
  var G = this.setClassName;
  this.setClassName = function(a) {
    G(a);
    w && w.setAttribute("data-ctat-component", this.getClassName());
  };
  this.wrapComponent = function(a) {
    t.ctatdebug("wrapComponent ()");
    t.makeDivWrapper(a);
    t.ctatdebug("wrapComponent () done");
  };
  this.createCanvas = function() {
    t.ctatdebug("createCanvas ()");
    ...
    C.setAttribute("style", "border: 1px " + this.borderColor + " solid; " + ("hidden" == p ? "visibility: hidden; " : "") + "z-index:" + A + ";");
  ...
  this.setEnabled = function(a) {
    ...
    t.assignEnabled(a);
    y ? y.disabled = !v : t.ctatdebug("Error: component pointer is null");
  };
  this.lock = this.setEnabled.bind(t, !1);
  this.unlock = this.setEnabled.bind(t, !0);
  ...
  this.init = function() {
    t.ctatdebug("THIS IS THE BASE INIT METHOD");
  };
  this.initialize = function() {
    t.ctatdebug("initialize ()");
    t.configFromDescription();
    t.init();
    t.processSerialization();
    t.render();
    t.processTabOrder();
    t.ctatdebug("initialize () done");
  };
  this.getInitialized = function() {
    return r;
  };
  this.setInitialized = function(a) {
    t.ctatdebug("setInitialized (" + a + ")");
    r = a;
    !0 !== r || w ? t.ctatdebug("Not wrapping, initialized=" + r + ", divWrapper = " + w) : (t.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."), (a = findPointOfAttachment(this.getName())) ? (t.ctatdebug("Attaching component to existing MovieClip ..."), t.wrapComponent(a.getDivWrapper())) : (t.ctatdebug("Attaching component to main div ..."), $("#" + ctatcontainer).first() && t.wrapComponent(getSafeElementById(ctatcontainer))));
    t.ctatdebug("setInitialized () done");
  };
  this.addSafeEventListener = function(a, b, d) {
    t.ctatdebug("addSafeEventListener (" + a + ")");
    t.ctatdebug("Adding event listener to: " + d);
    d ? d.addEventListener(a, b) : (y ? (t.ctatdebug("Adding eventlistener to component instead of target"), y.addEventListener(a, b)) : t.ctatdebug("Error: pointer to component is null, can't add event listener"), t.ctatdebug("addSafeEventListener () done"));
  };
  this.drawComponent = function() {
  };
  this.addComponentReference = function(a, b) {
    t.ctatdebug("addComponentReference (" + a.getName() + " -> " + b.getAttribute("id") + ")");
    a.tabIndex = this.getTabIndex();
    CTATComponentReference.add(a, b);
    t.ctatdebug("addComponentReference ()");
  };
  this.getComponentFromID = function(a) {
    return CTATComponentReference.getComponentFromID(a);
  };
  this.processSerialization = function() {
    t.ctatdebug("processSerialization()");
    t.ctatdebug("implement in child class");
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    p = !0 === a ? "block" : "hidden";
    C && C.setAttribute("style", "border: 0px; position: absolute; " + (a ? "" : "visibility:hidden; ") + "; left:" + f + "px; top:" + h + "px; z-index:" + A + ";");
  ...
  this.processOnFocus = function() {
    t.ctatdebug("processOnFocus (" + t.getName() + ")");
    ...
    CTATGlobals.Tab.Focus != t ? (t.ctatdebug("CTATGlobals.Tab.Focus!=pointer, updating CTATGlobals.Tab.Focus ..."), CTATGlobals.Tab.Focus = t) : t.ctatdebug("CTATGlobals.Tab.Focus==pointer");
    t.ctatdebug("processOnFocus () done");
  };
  this.processFocus = function(a) {
    t.ctatdebug("processFocus ()");
    a.currentTarget.getAttribute("id");
    if (t) {
      mobileAPI && !0 === mobileAPI.getEnabled() && t.hideKeyboard();
      commShell && commShell.processComponentFocus(t);
      if (CTATGlobals.Tab.Focus) {
        t.ctatdebug("old focus: " + CTATGlobals.Tab.Focus.getName() + ", new focus:" + t.getName());
        if (CTATGlobals.Tab.Focus == t) {
          t.ctatdebug("We're already there!");
          return;
        }
        CTATGlobals.Tab.Focus.backgrade && CTATGlobals.Tab.Focus.processAction();
      } else {
        t.ctatdebug("No previously focused component yet, can't grade");
      }
      "hint" == t.getClassName() || "CTATHintButton" == t.getClassName() ? t.ctatdebug("Info: focus moved to hint, bump") : (CTATGlobals.Tab.previousFocus = CTATGlobals.Tab.Focus, CTATGlobals.Tab.Focus = t, t.ctatdebug("processFocus () done"));
    } else {
      t.ctatdebug("Error: component reference is null");
    }
  };
  this.processTabOrder = function() {
    t.ctatdebug("processTabOrder (" + B + ")");
    !0 === q ? t.ctatdebug("Component is an abstract component, bump") : y ? (t.ctatdebug("We have a component, actually assigning to html component ..."), y.tabIndex = B, y.onfocus = t.processOnFocus) : t.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
  this.hideKeyboard = function() {
    document.activeElement.blur();
    $("input").blur();
...
CTAT.Component.Base.Graphical = function(a, b, c, e, g, d, f) {
  ...
  var k = CTATGlobals.Visual.BackgroundColor, l = "white", m = 1, n = CTATGlobals.Visual.BorderColor, q = !1, u = "solid", r = 0, v = "1px", w = 0, x = CTATGlobals.Font.color, B = "black", E = CTATGlobals.Font.family, y = CTATGlobals.Font.size, z = !1, t = !1, C = !1;
  ...
  this.setShowBorder = function(a) {
    ...
    this.component && this.getShowBorder() !== q && (q ? (this.setBorderStyle(u), this.setBorderWidth(v)) : this.setBorderStyle("none"));
    return this;
  };
  ...
  this.getItalicized = function() {
    return this.component ? "italic" === window.getComputedStyle(this.component).getPropertyValue("font-style") : t;
  };
  this.setItalicized = function(a) {
    t = CTATGlobalFunctions.toBoolean(a);
    this.component && this.getItalicized() !== t && (this.component.style.fontStyle = t ? "italic" : null);
    return this;
  };
  var p = this;
  a = function(a) {
    ...
    return {setHandler:function(a, d) {
      ...
      if (b.hasOwnProperty(a)) {
        if (b[a]) {
          ...
          return b[a].apply(p, d);
        }
        p.ctatdebug("Error: NULL handler for " + a);
      } else {
        p.ctatdebug("Error: No handler set for " + a);
      }
    }};
  };
...
var CTATSAI = function(a, b, c, e) {
  ...
  var d = "undefined", f = "undefined", h = new CTATStringUtil, k = [], l = [], m = [], n = [], q = [], u = [], r, v = this;
  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("internalArguments" == r.getElementName(f) || "value" == r.getElementName(f) || "Input" == r.getElementName(f)) {
        var b = r.getElementChildren(f), l = null;
        k = [];
        ...
        for (var h = 0;h < b.length;h++) {
          var m = b[h];
          "value" == r.getElementName(m) && (l = r.getElementChildren(m), null !== l ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + l.length), 1 === l.length ? (l = c.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + l), e.setValue(l)) : (l = c.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + l), e.setValue(l), e.setName(m.attributes.getNamedItem("name").value), e.setType(m.attributes.getNamedItem("type").value), 
          e.setFormat(m.attributes.getNamedItem("format").value), g++), 1 > h ? this.setInputArray(l) : this.appendToInputArray(l)) : (m = c.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), e.setValue(m), 1 > h ? this.setInputArray(m) : this.appendToInputArray(m)));
        }
      }
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("internalArguments" == r.getElementName(f) || "Input" == r.getElementName(f)) {
        ...
        k.push(e);
        for (var h = 0;h < b.length;h++) {
          if (l = b[h], "value" == r.getElementName(l)) {
            var m = r.getElementChildren(l);
            null !== m ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + m.length), 1 === m.length ? (l = c.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), e.setValue(l)) : (l = c.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), e.setValue(l), e.setName(r.getElementAttr("name")), e.setType(r.getElementAttr("type")), e.setFormat(r.getElementAttr("format")), g++)) : (l = c.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + 
            l), e.setValue(l));
...
var CTATMessage = function(a) {
  ...
  var g = "ungraded", d = !1, f = !1, h = new CTATSkillSet, k = "", l = "", m = "", n = "", q = "", u = null, r = !1;
  ...
  this.parseSAI = function() {
    ...
    if ("tool_message" == k) {
      ...
      for (c = 0;c < a.length;c++) {
        if (g = a[c], "tool_message" == e.getElementName(g)) {
          for (g = e.getElementChildren(g), l = 0;l < g.length;l++) {
            r = g[l], "event_descriptor" == e.getElementName(r) && (u = new CTATSAI, u.fromXMLInternal(r));
          }
        }
      }
      f = !0;
      ...
      if (d) {
        ...
        for (var t = e.getElementChildren(b), C = 0;C < t.length;C++) {
          var p = t[C];
          if ("event_descriptor" == e.getElementName(p)) {
            for (var p = e.getElementChildren(p), D = 0;D < p.length;D++) {
              var F = p[D];
              "selection" == e.getElementName(F) && (a = e.getNodeTextValue(F), r.push(F));
              "action" == e.getElementName(F) && (c = e.getNodeTextValue(F), y.push(F));
              "input" == e.getElementName(F) && (g = e.getNodeTextValue(F), z.push(F));
              "prompt" == e.getElementName(F) && (l = e.getNodeTextValue(F));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), t = e.getElementChildren(b), C = 0;C < t.length;C++) {
          if (p = t[C], "properties" == e.getElementName(p)) {
            for (p = e.getElementChildren(p), D = 0;D < p.length;D++) {
              F = p[D], this.ctatdebug("Nodename: " + e.getElementName(F)), "Skills" == e.getElementName(F) && h.parseByValue(F), "SuccessMsg" == e.getElementName(F) && (m = a = e.getNodeTextValue(F)), "BuggyMsg" == e.getElementName(F) && (n = e.getNodeTextValue(F)), "Selection" == e.getElementName(F) && (a = e.getNodeTextValue(F), r.push(F)), "Action" == e.getElementName(F) && (c = e.getNodeTextValue(F), y.push(F)), "Input" == e.getElementName(F) && (g = e.getNodeTextValue(F), z.push(F)), "prompt" == 
              e.getElementName(F) && (l = e.getNodeTextValue(F)), "HighlightMsgText" == e.getElementName(F) && (q = e.getNodeTextValue(F));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + c + "," + g);
      "" !== a && null !== a ? (u = new CTATSAI(a, c, g, l), u.setArrayFromElements(r), u.setArrayFromElements(y), u.setArrayFromElements(z), f = !0) : (this.ctatdebug("No SAI found"), f = !1);
...
CTAT.Component.Base.Tutorable = function(a, b, c, e, g, d, f) {
  ...
  var h = !0, k = !0, l = !0, m = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, n = !0, q = this, u = !1;
...
var CTATImageButtonComponent = function(a, b, c, e, g, d, f) {
  ...
  var h = "", k = "", l = "", m = "", n = !1, q = "Image to Component", u = this;
  ...
  this.assignActiveImage = function(a) {
    if (null !== u.getComponent() && (u.getComponent().src = a, u.getComponent().style.opacity = this.getTransparencyValue(), "Component to Image" == q)) {
      var b = new Image;
      b.src = a;
      u.setWidth(b.width);
...
CTAT.Component.Base.UnitDisplay = function(a, b, c, e, g, d, f) {
  ...
  var k = "#FF00FF", l = 1, m = "#FF00FF", n = .2, q = "black", u = 1;
  ...
  this.set_denominator = function(a) {
    ...
    if (!isNaN(b) && (b = z(b), this.get_denominator() != a)) {
      ...
      b.equals(0) || (a.push(E(b, !0)), a.push(E(f.subtract(b), !1)), e--);
      for (b = 0;b < e;b++) {
        a.push(E(f, !1));
      }
    ...
    if (0 !== Object.keys(C).length) {
      if (a instanceof CTAT.Component.Base.Tutorable) {
        ...
        if (a instanceof CTATSAI) {
          if (a.getSelection() != v.getName() && C.hasOwnProperty(a.getSelection())) {
            return C[a.getSelection()];
          }
        } else {
          if (a instanceof String) {
            if (a != v.getName() && C.hasOwnProperty(a)) {
              return C[a];
            }
          } else {
            if (a instanceof Element && a != v.getComponent() && C.hasOwnProperty(a.id)) {
              return C[a.id];
            }
          }
        }
  ...
  var p = {numerator:{items:[], callback:a.bind(this, this.change_numerator, this.set_numerator)}, denominator:{items:[], callback:a.bind(this, this.change_denominator, this.set_denominator)}, partition:{items:[], callback:a.bind(this, this.change_number_pieces, this.set_number_pieces)}, value:{items:[], callback:function(a) {
    switch(a.getAction()) {
      case "SetPieces":
      ;
      case "UpdateTextField":
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      for (var a = this.parseValue(), b = 0, c = document.createDocumentFragment(), e = 0;e < a.length;e++) {
        var g = a[e], n = 100 * g, q = document.createElementNS(d, "rect");
        q.classList.add("CTAT-fraction-bar--piece");
        q.setAttributeNS(null, "height", "100%");
        q.setAttributeNS(null, "width", n + "%");
        q.setAttributeNS(null, "y", 0);
        q.setAttributeNS(null, "x", b + "%");
        this.addPieceElem(q, g, g.selected);
        b += n;
        c.appendChild(q);
      }
  ...
  this.init_items = function(a) {
    if (n) {
      ...
      for (var d = a.length, f = 0;f < d;f++) {
        ...
        c.addEventListener("dragend", E, !1);
        b.appendChild(c);
        B.push(c);
      }
      n.innerHTML = "";
...
var CTATNumberLine = function(a, b, c, e, g) {
  ...
  var u = function() {
    if (null != this.X_Axis && null != this.X_Axis.svg_group) {
      var a = this.getBoundingBox(), b = window.getComputedStyle(this._axis_line_group), b = parseInt(b.getPropertyValue("stroke-width")), a = CTAT.Geom.Rectangle.inflate(a, -b, -b), d = new DOMPoint(a.width / 2, a.height / 2), c = d.add(CTAT.Geom.Point.polar(Math.min(40, a.height, a.width) / 4, this.theta)), e = Math.sin(this.theta), g = -Math.cos(this.theta), m = e * d.x + g * d.y, r = -a.height * g, u = -e * a.width, b = new DOMPoint(a.left, d.y), d = new DOMPoint(a.right, d.y);
      if (0 < Math.abs(CTAT.Math.round(r))) {
        var r = new DOMPoint(a.left, (m - e * a.left) / g), n = new DOMPoint(a.right, (m - e * a.right) / g);
        if (a.contains(r) || a.contains(n)) {
          c.distance(r) < c.distance(n) ? (b = n, d = r) : (b = r, d = n);
        }
      }
      0 < Math.abs(CTAT.Math.round(u)) && (u = new DOMPoint((m - g * a.top) / e, a.top), e = new DOMPoint((m - g * a.bottom) / e, a.bottom), a.containsPoint(u) || a.containsPoint(e)) && (c.distance(u) < c.distance(e) ? (b = e, d = u) : (b = u, d = e));
  ...
  }.bind(this), r = 0, v = null, w = new DOMPoint(-30, -30), x = !1, B = function(a) {
    w.x = a.clientX;
    w.y = a.clientY;
  }, E = function(a) {
    ...
    if (!0 === this.getEnabled()) {
      this.setHintHighlight(!1);
      var b;
      q ? (a = C(a.clientX, a.clientY), b = a.location, a = a.data) : (a = z(a.clientX, a.clientY), b = this.X_Axis.getProjectedPoint(a), a = this.X_Axis.getAxisValue(a));
  ...
  this.init = function() {
    ...
    this.component.addEventListener("mouseenter", function() {
      !0 === a() && (x = !0, v.style.visibility = null, r = requestAnimationFrame(p));
    });
  ...
  var z = function(a, b) {
  ...
  }.bind(this), t = function(a, b) {
    return this.getProjectedPoint(z(a, b));
  }.bind(this.X_Axis), C = function(a, b) {
    for (var d = t(a, b), c = null, f = Number.POSITIVE_INFINITY, e, g, l = 0;l < this._tickmarks.length;l++) {
    ...
    if (x && !0 === this.getEnabled()) {
      if (q) {
        ...
        v.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(t(w.x, w.y), !0));
      }
...
var CTATPieChart = function(a, b, c, e, g) {
  ...
  var d = 3, f = 3, h = this, k, l, m, n = null, q = CTATGlobals.NameSpace.svg;
  this.init = function() {
    this.initSVG();
    this.baseGroup = document.createElementNS(q, "g");
    this.getComponent().appendChild(this.baseGroup);
    this.getComponent().classList.add("CTAT-pie-chart");
    k = document.createElementNS(q, "filter");
    k.id = this.genName("Shadow");
    l = "#" + k.id;
    m = "url(" + l + ")";
    k.setAttributeNS(null, "width", "200%");
    k.setAttributeNS(null, "height", "200%");
    n = document.createElementNS(q, "feOffset");
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      ...
      a.reduce(function(a, b, f, l) {
        if (1 <= b.valueOf()) {
          f = document.createElementNS(q, "circle"), f.classList.add("CTAT-pie-chart--piece"), f.cx.baseVal.value = e.x, f.cy.baseVal.value = e.y, f.r.baseVal.value = c, this.addPieceElem(f, b, b.selected), g.appendChild(f);
        } else {
          f = document.createElementNS(q, "path");
          ...
          b.reduce();
          var m = e.add(CTAT.Geom.Point.polar(c, 2 * Math.PI * b.valueOf() + k)), r = e.clone();
          if (0 < d && d < c) {
            ...
            l = CTAT.Geom.Point.circle_intersection(r, l, e, c).reduce(n.bind(this, l));
            m = m.add(k);
            m = CTAT.Geom.Point.circle_intersection(r, m, e, c).reduce(n.bind(this, m));
          }
          k = CTAT.Geom.Point.to2DString;
          r = "M " + k(r);
          n = new DOMPoint(c, c);
          r += " L " + k(l);
          r += " A " + k(n) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + k(m);
          f.setAttributeNS(null, "d", r + " Z");
...
var CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (t.ctatdebug("errScrimUp (" + a + ")"), 1 == g ? 1 == u && (u = !1, getSafeElementById(ctatcontainer).removeChild(y)) : 1 == f && (u = !0), t.scrimUp(a));
  }
  function c(a, b) {
  ...
  var e = !1, g = !1, d = !0, f = !1, h = !1, k = !0, l = !0, m = "", n = !1, q = !1, u = !1, r = null, v = null, w = new CTATCanvasComponent("CTAT Scrim"), x = [], B = null, E = null, y = null, z = null, t = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (t.ctatdebug("scrimUp ()"), t.ctatdebug("Message: " + b), 1 == e ? (m = 1 == d ? b : m + (" \n " + b), w.removeComponent()) : (m = b, e = !0), t.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        t.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + m + "<br><br></div></div></div>\t\t"), !0 === u && (y = c(a, "close"), $(y).appendTo("#scrimpanel")), !0 === n && (B = c(r, "yes"), $(B).appendTo("#scrimpanel")), !0 === q && (E = c(v, "no"), $(E).appendTo("#scrimpanel")), 
        1 == d)) {
  ...
  this.waitScrimUp = function() {
    "google" != CTATConfig.platform && (t.ctatdebug("waitScrimUp ()"), d = !0, t.scrimUp(CTATGlobals.languageManager.getString("LOADING")));
  };
  this.nextProblemScrimUp = function() {
    "google" != CTATConfig.platform && (t.ctatdebug("nextProblemScrimUp ()"), t.scrimUp(CTATGlobals.languageManager.getString("NEXTPROBLEM")));
  };
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (t.ctatdebug("OKScrimUp (" + a + "," + b + ")"), t.scrimUp(a), z = c(b, spaceUsedUp, "OK"), $(z).appendTo("#scrimpanel"));
  };
  this.confirmScrimUp = function(a, b, d) {
    "google" != CTATConfig.platform && (t.ctatdebug("confirmScrimUp (" + a + "," + b + "," + d + ")"), q = n = !0, v = d, r = b, t.scrimUp(a));
  };
  this.errorScrimUp = function(a) {
    "google" != CTATConfig.platform && (0 == k ? (t.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), x.push("ERROR: " + a), g = !0) : 0 == l ? t.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (g = !0, b("ERROR: " + a)));
  };
  this.warningScrimUp = function(a) {
    "google" != CTATConfig.platform && (0 == k ? (t.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), x.push("WARNING: " + a), f = !0) : 0 == l ? t.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (f = !0, b("WARNING: " + a)));
  };
  ...
  this.scrimDown = function() {
    "google" != CTATConfig.platform && (0 == e ? t.ctatdebug("The scrim isn't up, returning") : 1 == g ? t.ctatdebug("The scrim is up to describe errors to the user, leave it up!") : 1 == f ? t.ctatdebug("The scrim is up to display warnings to the user, leave it up!") : 1 == h ? t.ctatdebug("The scrim is up for a connection issue leave it up!") : ($("#scrim").remove(), w.removeComponent(), d = e = !1, m = ""));
  };
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b, c) {
  ...
  var e = authenticityToken = "", g = 0, d = [], f = a ? a : null, h = null == b ? !0 : b, k = !0, l = null, m = c ? c : {}, n = this, q = "http";
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, c = !0, e = !1, g = !1, d = [], f = "undefined", h = "undefined", k = "undefined", l = "undefined", m = "undefined", n = "undefined", q = "undefined", u = "undefined", r = "UnassignedDataset", v = "UnassignedLevelName", w = "UnassignedLevelType", u = (new CTATGuid).guid();
...
var CTATMessageHandler = function() {
        ...
        for (var l = e.getElementChildren(k), m = 0;m < l.length;m++) {
          ...
          if ("MessageType" == e.getElementName(n)) {
            ...
            if ("AssociatedRules" == n) {
              ...
              for (var q = "", u = "", r = 0;r < l.length;r++) {
                var v = l[r];
                "TutorAdvice" == e.getElementName(v) && (q = e.getNodeTextValue(v));
              ...
              a.processAssociatedRules(f, u, q);
            }
            ...
            if ("ShowHintsMessage" == n) {
              ...
              for (r = 0;r < l.length;r++) {
                if (v = l[r], "HintsMessage" == e.getElementName(v)) {
                  for (var v = e.getElementChildren(v), w = 0;w < v.length;w++) {
                    var x = v[w];
                    "value" == e.getElementName(x) && (u.push(e.getNodeTextValue(x)), q = !0);
                  }
                }
              }
              !0 === q ? a.processHintResponse(f, u) : b.ctatdebug("Error: incomplete hint message received");
            }
  ...
  this.deserializeComponent = function(a, c, g) {
    ...
    if (null === e.getElementAttr(g, "x")) {
      ...
      var k = e.getElementAttr(g, "x"), l = e.getElementAttr(g, "y"), m = e.getElementAttr(g, "width"), n = e.getElementAttr(g, "height"), q = e.getElementAttr(g, "tabIndex"), u = e.getElementAttr(g, "zIndex");
      null === q && (q = -1);
      null === u && (u = 0);
      ...
      r.tabIndex = q;
      r.zIndex = u;
      r.width = Math.floor(m);
      r.height = Math.floor(n);
        ...
        if ("Parameters" == e.getElementName(l)) {
          for (this.ctatdebug("Processing component parameters ..."), m = e.getElementChildren(l)[0], m = e.getElementChildren(m), n = 0;n < m.length;n++) {
            ...
            if ("CTATComponentParameter" == e.getElementName(v)) {
              ...
              for (var u = q = void 0, v = e.getElementChildren(v), w = 0;w < v.length;w++) {
                var x = v[w];
              ...
              void 0 !== q && (r.params[q] = u, "group" == q && (r.groupName = u));
            }
          }
        }
          ...
          for (this.ctatdebug("Processing component styles ..."), l = e.getElementChildren(l)[0], l = e.getElementChildren(l), m = 0;m < l.length;m++) {
            if (u = l[m], "CTATStyleProperty" == e.getElementName(u)) {
              ...
              for (v = 0;v < u.length;v++) {
                w = u[v], "name" == e.getElementName(w) && (n = e.getNodeTextValue(w)), "value" == e.getElementName(w) && (q = e.getNodeTextValue(w).trim());
              }
...
var CTATRadioButton = function(a, b, c, e, g) {
  ...
  this.showCorrect = function(a) {
    u("CTAT--hint");
    u("CTAT--incorrect");
    (a ? 0 === a.getInput().indexOf(h.value) : 1) ? q("CTAT--correct") : u("CTAT-correct");
  };
  this.removeCorrect = function() {
    u("CTAT--correct");
  };
  this.showInCorrect = function(a) {
    u("CTAT--hint");
    u("CTAT--correct");
    (a ? 0 === a.getInput().indexOf(h.value) : 1) ? q("CTAT--incorrect") : u("CTAT-incorrect");
  };
  this.removeInCorrect = u.bind(this, "CTAT--incorrect");
  this.showHintHighlight = function(a) {
    this.removeCorrect();
    this.removeInCorrect();
    a ? q("CTAT--hint") : u("CTAT--hint");
  };
};
...
function prepTutorArea(a) {
  "on" == CTATGlobalFunctions.parseQueryString().AUTORUN ? initTutor(a) : new CTATPlayButton;
}
...
(function(a) {
  ...
  b.format = function(a, d) {
    var f = 1, h = a.length, k = "", l = [], m, q, z, t, C = !0, p = "";
    for (m = 0;m < h;m++) {
      if (k = c(a[m]), "string" === k) {
        l[l.length] = a[m];
      } else {
        if ("array" === k) {
          z = a[m];
          if (z[2]) {
            for (k = d[f], q = 0;q < z[2].length;q++) {
              if (!k.hasOwnProperty(z[2][q])) {
                throw Error(b("[sprintf] property '%s' does not exist", z[2][q]));
              }
              k = k[z[2][q]];
            }
          } else {
          ...
          "function" == c(k) && (k = k());
          if (e.test(z[8]) && "number" != c(k) && isNaN(k)) {
          ...
          switch(z[8]) {
            ...
            case "d":
              ...
              break;
            case "e":
              k = z[7] ? k.toExponential(z[7]) : k.toExponential();
              break;
            case "f":
              k = z[7] ? parseFloat(k).toFixed(z[7]) : parseFloat(k);
              break;
            case "o":
              k = k.toString(8);
              break;
            case "s":
              k = (k = String(k)) && z[7] ? k.substring(0, z[7]) : k;
              break;
            case "u":
              k >>>= 0;
              break;
          ...
          if (!C || g.test(z[8]) && z[3]) {
            p = C ? "+" : "-", k = k.toString().replace(n, "");
          }
          q = z[4] ? "0" == z[4] ? "0" : z[4].charAt(1) : " ";
          t = z[6] - (p + k).length;
          t = z[6] ? Array(t + 1).join(q) : "";
          l[l.length] = z[5] ? p + k + t : 0 == q ? p + t + k : t + p + k;
        }
      }
    }
    return l.join("");
...
var CTATExampleTracerSkill = function(a, b, c, e, g, d) {
  ...
  var f = null == a || "" == a.trim() ? b : b + " " + a, h = e, k = 0, l = 0, m = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, n = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, q = null, u = this;
  this.getSkillName = function() {
    return f;
  };
  this.getCategory = function() {
...
var CTATProblemSummary = function(a, b, c) {
  ...
  var e = Number.MAX_VALUE, g = b, d = 0, f = new Date, h = {}, k = 0, l = 0, m = 0, n = 0, q = 0, u = 0, r = 0, v = CTATMsgType.CompletionValue[0], w = this;
  ...
  this.addCorrect = function(a) {
    ...
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++q, 1 > b.getNFirstHints() && u++), b.incrementNCorrect()) : (w.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), h[a] = b, q++, u++);
    k++;
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, c = [1, 6], e = [1, 7], g = [1, 10], d = [1, 11], f = [1, 12], h = [1, 13], k = [1, 21], l = [1, 22], m = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], n = [1, 23], q = [1, 24], u = [1, 26], r = [1, 27], v = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], w = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:k, 15:l}, b(m, [2, 11], {22:9, 19:25, 16:n, 18:q, 20:u, 21:r, 24:g, 25:d, 27:f, 28:h}), b(v, [2, 17]), {13:c, 15:e, 17:28, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:29, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(v, [2, 20]), b(v, [2, 23], {23:[1, 30]}), {13:c, 15:e, 17:31, 19:8, 22:9, 24:g, 25:d, 27:f, 
  ...
  15:l, 26:[1, 46]}, {5:[2, 2], 13:k, 15:l}, {5:[2, 3], 13:k, 15:l}, {5:[2, 4], 13:k, 15:l}, {5:[2, 5], 13:k, 15:l}, {5:[2, 6], 13:k, 15:l}, {5:[2, 7], 13:k, 15:l}, b(m, [2, 9], {22:9, 19:25, 16:n, 18:q, 20:u, 21:r, 24:g, 25:d, 27:f, 28:h}), b(m, [2, 10], {22:9, 19:25, 16:n, 18:q, 20:u, 21:r, 24:g, 25:d, 27:f, 28:h}), b(v, [2, 12]), b(v, [2, 13]), b(v, [2, 15]), b(v, [2, 16]), b(v, [2, 21]), b(w, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      throw Error(a);
    ...
    var b = [0], c = [null], d = [], e = this.table, f = "", g = 0, k = 0, h = 0, m = d.slice.call(arguments, 1), l = Object.create(this.lexer), n = {}, q;
    for (q in this.yy) {
    ...
    for (var H, u, w, v, L = {}, M, I;;) {
      w = b[b.length - 1];
      if (this.defaultActions[w]) {
        v = this.defaultActions[w];
      } else {
      ...
      if ("undefined" === typeof v || !v.length || !v[0]) {
        ...
        I = [];
        for (M in e[w]) {
          this.terminals_[M] && 2 < M && I.push("'" + this.terminals_[M] + "'");
        }
        N = l.showPosition ? "Parse error on line " + (g + 1) + ":\n" + l.showPosition() + "\nExpecting " + I.join(", ") + ", got '" + (this.terminals_[H] || H) + "'" : "Parse error on line " + (g + 1) + ": Unexpected " + (1 == H ? "end of input" : "'" + (this.terminals_[H] || H) + "'");
        this.parseError(N, {text:l.match, token:this.terminals_[H] || H, line:l.yylineno, loc:q, expected:I});
      }
      if (v[0] instanceof Array && 1 < v.length) {
        throw Error("Parse Error: multiple actions possible at state: " + w + ", token: " + H);
      }
      switch(v[0]) {
        case 1:
          b.push(H);
          ...
          b.push(v[1]);
          H = null;
          u ? (H = u, u = null) : (k = l.yyleng, f = l.yytext, g = l.yylineno, q = l.yylloc, 0 < h && h--);
          break;
        case 2:
          I = this.productions_[v[1]][1];
          L.$ = c[c.length - I];
          L._$ = {first_line:d[d.length - (I || 1)].first_line, last_line:d[d.length - 1].last_line, first_column:d[d.length - (I || 1)].first_column, last_column:d[d.length - 1].last_column};
          r && (L._$.range = [d[d.length - (I || 1)].range[0], d[d.length - 1].range[1]]);
          w = this.performAction.apply(L, [f, k, g, n, v[1], c, d].concat(m));
          if ("undefined" !== typeof w) {
            return w;
          }
          I && (b = b.slice(0, -2 * I), c = c.slice(0, -1 * I), d = d.slice(0, -1 * I));
          b.push(this.productions_[v[1]][0]);
          c.push(L.$);
          d.push(L._$);
          v = e[b[b.length - 2]][b[b.length - 1]];
          b.push(v);
          break;
        case 3:
          return !0;
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, d, k, l) {
      ...
      try {
        ...
        }).apply(r, [d, k, l].concat(e.call(this.values)));
      } catch (B) {
        return console.log(B), null;
      } finally {
        for (q in r) {
          null != q && 0 > g.call(m, q) && (x[q] = r[q], delete r[q]);
        }
      }
    };
...
var CTATExampleTracerLink = function(a, b, c) {
  ...
  var e = "undefined" === typeof a || null === a ? null : a, g = null, d = "undefined" === typeof b || null === b ? null : b, f = "undefined" === typeof c || null === c ? null : c, h = null, k = 1, l = 1, m = "CORRECT_ACTION", n = [], q = !1, u = null, r = "", v = null, w = null, x = this;
...
var CTATExampleTracerEvent = function(a, b, c) {
  ...
  var e = "", g = !1, d = CTATExampleTracerLink.NO_MODEL, f = !1, h = null, k = null, l = "student", m = null, n = null, q = "", u = null, r = null, v = null, w = null, x = null, B = [], E = !1, y = null, z = null, t = this;
  this.getActor = function() {
    return l;
  };
  this.setActor = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e setActor(" + a + ")");
    l = a;
  };
  this.getStudentSAI = function() {
    t.ctatdebug("CTATExampleTracerEvent.getStudentSAI() returning type " + typeof h + ", value " + h);
    return h;
  };
  this.setStudentSAI = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setStudentSAI(" + a + ")");
    null !== a && "undefined" !== typeof a && (h = a);
    t.ctatdebug("CTATExampleTracerEvent --\x3e out of setStudentSAI");
  };
  this.getPreloadedLinkMatches = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in getPreloadedLinkMatches");
    return r;
  };
  this.setTutorSAI = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setTutorSAI");
    null !== a && "undefined" !== typeof a && (k = a);
    t.ctatdebug("CTATExampleTracerEvent --\x3e out of setTutorSAI");
  };
  this.setNumberOfInterpretations = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setNumberOfInterpretations( " + a + " )");
  };
  this.getTransactionID = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in getTransactionID() returning " + e);
    return e;
  };
  this.setTransactionID = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setTransactionID( " + a + " )");
    e = a;
  };
  this.setDoneStepFailed = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setDoneStepFailed( " + a + " )");
    g = a;
  };
  ...
  this.setResult = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setResult( " + a + " )");
    d = a;
  };
  this.isSolverResult = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in isSolverResult");
    return !1;
  };
  this.getResult = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in getResult() returning " + d);
    return d;
  };
  this.setReportableLink = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableLink(" + a + ")");
    m = a;
  };
  this.setReportableInterpretation = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableInterpretation(" + a + ")");
    n = a;
  };
  this.setStepID = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setStepID(" + a + ")");
    q = a;
  };
  ...
  this.setSuccessOrBuggyMsg = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setSuccessOrBuggyMsg(" + a + ")");
    x = a;
  };
  this.setReportableHints = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableHints(" + a + ")");
    B = Array.isArray(a) && 0 < a.length ? a : [];
  };
  this.getWantReportableHints = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning " + E);
    return E;
  };
  this.setOutOfOrder = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setOutOfOrder(" + a + ")");
    u = a;
  };
  this.isOutOfOrder = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + u);
    return u;
  };
  this.setEvaluatedInput = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setEvaluatedInput(" + a + ")");
  ...
  this.addPreloadedLinkMatch = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in addPreloadedLinkMatch(" + a + ")");
  ...
  this.setInterpolatedSAI = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedSAI(" + a + ")");
    a && (y = a);
  };
  this.getInterpolatedSAI = function() {
    return y ? y : t.getStudentSAI();
  };
  this.setInterpolatedHints = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedHints(" + a + ")");
    null !== z && "undefined" !== typeof z && (z.length = 0);
    null !== a && "undefined" !== typeof a && (z = a.slice(0));
    t.ctatdebug("CTATExampleTracerEvent --\x3e out of setInterpolatedHints");
  };
  this.setWantReportableHints = function(a) {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in setWantReportableHints(" + a + ")");
    E = a;
  };
  this.getSuccessOrBuggyMsg = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning " + x);
    return x;
  };
  this.getReportableHints = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning " + B);
    return B;
  };
  this.getReportableLink = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning " + m);
    return m;
  };
  this.getReportableVariableTable = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning " + w);
    return w;
  };
  this.getReportableInterpretation = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning " + n);
    return n;
  };
  this.getStepID = function() {
    t.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning " + q);
    return q;
  };
  ...
  this.getTutorInput = function() {
    return null !== v && "undefined" !== typeof v ? t.getEvaluatedInputArray() : null !== k && "undefined" !== typeof k ? k.getInputArray() : null;
  };
  ...
  this.toString = function() {
    var a;
    a = "[" + t.getResult();
    null !== t.getStudentSAI() && "undefined" !== typeof t.getStudentSAI() && (a += ", StudentSAI " + t.getStudentSAI());
    null !== t.getReportableLink() && "undefined" !== typeof t.getReportableLink() && (a += ", reportableLink " + t.getReportableLink());
    !0 === t.isDoneStepFailed() && (a += ", doneStepFailed");
    null !== t.getTutorSAI() && "undefined" !== typeof t.getTutorSAI() && (a += ", TutorSAI " + t.getTutorSAI());
    return a + "]";
  };
...
var CTATVectorMatcher = function(a, b, c, e) {
  function g(a, b, c, e, g) {
    ...
    for (var w = 0;3 > w;w++) {
      var x = k[w][0], B = x instanceof CTATExpressionMatcher ? x.matchConcatenation(a, b, c, e) : x.matchConcatenation(v[w]);
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function e(a, b, d, e, f, g) {
    ...
    if (b) {
      p.ctatdebug("finishEvaluate -- in if Branch doUpdate()");
      ...
      if (d.toString() === CTATExampleTracerLink.CORRECT_ACTION.toString() || d.toString() === CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()) {
        ...
        g.forEach(function(a) {
          a.getLastMatchedLink().getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && (p.ctatdebug("In evaluate -- deleting an incorrect interp"), g.delete(a));
        });
        p.ctatdebug("In evaluate -- to call setInterpretations(), if 0 < newInterps.size " + g.size);
        0 < g.size && n(g);
        for (var h in B) {
      ...
      d.toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && E.splice(E.length - 1, 1);
    }
    a.isSolverResult() || (p.ctatdebug("In evaluate inside the solver result if condition + " + d), a.setResult(d));
    ...
    a.getHintRequest() || (b = e.getTutorSAI(a.getInterpolatedSAI(), f.getVariableTable()), p.ctatdebug("In evaluate -- TUTORSAI: " + b + ", studentSAI was " + a.getStudentSAI()), a.setTutorSAI(b));
    ...
    a.getHintRequest() && (f = e.interpolateHints(f.getVariableTable()), a.setInterpolatedHints(f), p.ctatdebug("In evaluate after calling setInterpolatedHints"), Array.isArray(f) && 0 < f.length ? a.setReportableHints(f) : a.setReportableHints(e.getHints()), p.ctatdebug("In evaluate --\x3e after setReportableHints"));
    p.ctatdebug("In evaluate after fireExampleTracerEvent");
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of finishEvaluate");
    return d.toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString();
  }
  function g(a, b, c, d) {
    p.ctatdebug("checkDoneStep() hintTrace " + b + ", sai " + a.getStudentSAI() + ", exitOnIncorrectDone " + y.exitOnIncorrectDone() + ", hideButRequireSteps " + y.hideButRequireSteps() + ", nInterps " + d.size);
    ...
    if (!b && y.hideButRequireSteps()) {
      b = y.getDoneLinks();
      p.ctatdebug("checkDoneStep getDoneLinks().size " + b.size);
      b = b.values();
      for (var f;!(f = b.next()).done;) {
        if (y.pathToLinkIsSubset(f.value, C)) {
          return a.setDoneStepFailed(!1), 1 > d.size ? e(a, c, CTATExampleTracerLink.CORRECT_ACTION, f.value, p.getBestInterpretation(), p.getInterpretationsInternal()) : e(a, c, CTATExampleTracerLink.CORRECT_ACTION, f.value, m(d), d);
        }
      }
    }
  ...
  function d(a, b, c) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e _evaluate(" + a + ", " + b + ", " + c + ")");
    z = a;
    var d = new Set, n = a.getPreloadedLinkMatches();
    p.ctatdebug("interps # : " + x.length);
    p.ctatdebug("interps: " + x);
    x.forEach(function(e) {
      p.ctatdebug("In evaluate -- entered the interpretations loop");
      if ("undefined" === typeof n || null === n) {
        p.ctatdebug("In evaluate -- entered if check for saiLinkMatches"), n = h(a.getStudentSAI(), a.getActor(), b, e.getVariableTable(), a), p.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");
      } else {
      ...
      n.forEach(function(b) {
        ...
        var f = e.clone();
        p.ctatdebug("In evaluate size of getPaths " + f.getPaths().size);
        f.getPaths().forEach(function(c) {
          p.ctatdebug("In evaluate -- looping through the newInterp.getPaths()\n Examining path: " + c);
          !1 === k(b, f, c, !1, a) && (p.ctatdebug("In evaluate -- in if condition, checking if isPathOK"), f.getPaths().delete(c), p.ctatdebug("In evaluate -- out of if condition, checking if isPathOK\n Tried to delete path."));
        });
        p.ctatdebug("In evaluate -- done looping through the newInterp.getPaths(), size " + f.getPaths().size);
        if (0 < f.getPaths().size) {
          ...
          if (!0 === c) {
            ...
            p.ctatdebug("In evaluate -- done updatingVariable table: " + f.getVariableTable());
          }
          d.add(f);
    ...
    p.ctatdebug("In evaluate -- number of interpretations " + d.size + " set");
    var r = g(a, b, c, d);
    if (null != r) {
      return r.valueOf();
    }
    ...
    var q = null;
    !0 === a.isSolverResult() ? (p.ctatdebug("In evaluate -- in if branch of isSolverResult"), q = CTATExampleTracerLink.NO_MODEL.toString().toUpperCase() === a.getResult().toString().toUpperCase() ? CTATExampleTracerLink.BUGGY_ACTION.toString() : a.getResult().toString()) : (p.ctatdebug("In evaluate -- in else branch of isSolverResult"), q = r.getLastMatchedLink().getType());
    return e(a, c, q, null, r, d);
  }
  function f(a, b, c, d, e) {
    var f = b && c.isCorrect();
    if ("undefined" != typeof C[c.getUniqueID()] || c.matchesSAIforHint(a, d, null, e)) {
      C[c.getUniqueID()] = f;
    }
    p.ctatdebug("updateMatchedSelections(): link " + c.getUniqueID() + ", matched " + b + ", newResult " + f + ", matchedSelections[link] " + C[c.getUniqueID()]);
  }
  function h(a, b, c, d, e) {
    ...
    y.getLinks().forEach(function(h) {
      if (!1 === c) {
        p.ctatdebug("Calling link.matchesSAI() on link " + h + ", sai " + a);
        var k = h.matchesSAI(a, b, d);
        p.ctatdebug("Result from link.matchesSAI() on link " + h + ": " + k + ", typeof " + typeof k);
        !0 === k && g.push(h);
    ...
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of findSAIMatchingLinks: #matchingLinks " + g.length);
    return g;
  }
  function k(a, b, c, d, e) {
    ...
    if (!0 === d) {
      ...
      b.getMatchedLinks().forEach(function(a) {
        !1 !== k && (!1 === y.observesOrderingConstraints(h, a, f, e) || !1 === u(b, a, f) ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), k = !1) : h.push(a));
      });
      if (!1 === k) {
  ...
  function n(a) {
    ...
    0 === a.size ? p.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations") : (p.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: " + a.size), a.forEach(function(a) {
      x.push(a);
    }), t = null, p.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"));
  }
  function q() {
  ...
  function r(a, b) {
    ...
    d.getSortedLinks().forEach(function(b) {
      !0 !== g && (p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in for loop" + b), f = b, c.getTraversalCount(b) < b.getMaxTraversals() && (!1 === a || 0 < p.nonEmptyHints(b, c.getVariableTable())) && y.observesOrderingConstraints(c.getMatchedLinks(), b, d.getLinks(), null) && u(c, b, d.getLinks()) && (p.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in link: " + b), h = b, g = !0));
    });
    if (!0 === g) {
      return h;
    }
  ...
  function v(a, b, c, d) {
    ...
    var e = new CTATExampleTracerEvent(p, null, CTATMsgType.DEFAULT_STUDENT_ACTOR), f = !0, g = [];
    b.getSortedLinks().forEach(function(b) {
      ...
      p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop interp.isTraversed(link, countOptionalAsTraversed): " + a.isTraversed(b, d));
      p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop isNoOp(link): " + w(b));
      !0 === a.isTraversed(b, d) || !0 === w(b) ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in if condition"), f = !0) : (!0 === f && (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in second if condition"), y.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
        c && 1 > p.nonEmptyHints(b, a.getVariableTable()) || a.getTraversalCount(b) >= b.getMaxTraversals() || (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink pushing outlink: " + b.getUniqueID()), g.push(b));
    ...
    g.forEach(function(c) {
      !0 !== h && (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting in fro loop"), !0 === k(c, a, b, !1, e) ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting first if"), l = c, h = !0) : a.getPaths().forEach(function(d) {
        !0 !== h && (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting in inner loop"), b !== d && (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting second if"), !0 === k(c, a, d, !1, e) && (p.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting third if"), l = c, h = !0)));
      }));
    });
    if (!0 === h) {
  ...
  var x = null, B = null, E = null, y = a, z = null;
  ...
  this.resetTracer = function() {
    ...
    null === x || "undefined" === typeof x ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"), x = []) : (p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"), x.length = 0);
    var a = new CTATExampleTracerInterpretation(q());
    ...
    t = a;
    if (null === B || "undefined" === typeof B) {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"), B = {};
    } else {
    ...
    C = {};
    null === E || "undefined" === typeof E ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer last if condition"), E = []) : (p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of last if condition"), E.length = 0);
  ...
  this.getBestInterpretation = function() {
    ...
    if (null === t || "undefined" === typeof t) {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"), t = m(p.getInterpretationsInternal());
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation " + (null === t || void 0 === t));
    return t;
  };
  ...
  this.findCurrentState = function() {
    ...
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = r(!1, [a])) ? a.getPrevNode() : y ? y.getStartNode() : null;
  };
};
...
var CTATExampleTracerGraph = function(a, b, c) {
  ...
  function d(a) {
    A.ctatdebug("in findGroupsOfLink(link " + a + "): typeof(groupModel) " + typeof D);
  ...
  var w = null, x = null, B = null, E = null, y = null, z = null, t = new Set, C = new Set, p = null, D = null, F = CTATMsgType.SHOW_ALL_FEEDBACK, A = this;
  this.getFeedbackPolicy = function() {
    return F;
  };
  this.setFeedbackPolicy = function(a) {
    A.ctatdebug("Graph.setFeedbackPolicy(" + a + ") old policy " + F);
  ...
  this.observesOrderingConstraints = function(a, b, c, d) {
    ...
    if (null === c || "undefined" === typeof c || 0 === c.size || null === b || "undefined" === typeof b) {
      return A.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints first if"), null !== d && "undefined" !== typeof d && (A.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints setting out of order false"), d.setOutOfOrder(!1)), A.ctatdebug("CTATExampleTracerGraph --\x3e returning first true observesOrderingConstraints"), !0;
    }
    ...
    null !== d && "undefined" !== typeof d && (A.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints setting out of order true"), d.setOutOfOrder(!0));
  ...
  this.isIncorrectLinkOK = function(a, b, c, d) {
    ...
    if (!0 === f && (b = A.getSmallestContainingGroup(b), !0 === D.isLinkInGroup(b, g) && !1 === D.isGroupOrdered(b) && !0 === l(b, c, d))) {
      return !1;
    }
  ...
  this.getNode = function(a) {
    A.ctatdebug("CTATExampleTracerGraph --\x3e in getNode(" + a + ") returning " + E[a]);
    return E[a];
  };
  ...
  this.getStartNode = function() {
    A.ctatdebug("CTATExampleTracerGraph --\x3e in getStartNode() returning " + y);
    return y;
  };
  ...
  this.getStudentStartsHereNode = function() {
    A.ctatdebug("CTATExampleTracerGraph --\x3e getStudentStartsHereNode() returns " + z);
    return z;
  };
  ...
  this.getExampleTracer = function() {
    A.ctatdebug("CTATExampleTracerGraph --\x3e in getExampleTracer() returning " + w);
    return w;
  };
  ...
  this.getVisualData = function() {
    A.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning " + p);
    return p;
  };
  ...
  (function(a, b) {
    ...
    E = {};
    if (null === D || "undefined" === typeof D) {
      D = new CTATDefaultGroupModel, A.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");
    }
    D.clear();
    ...
    w = new CTATExampleTracerTracer(A, c);
...
var CTATMessageTank = function(a, b) {
    ...
    a && h.forEach(function(b) {
      if (b.msgType == CTATMsgType.ASSOCIATED_RULES) {
        ...
        if (c) {
          ...
          q.ctatdebug("updateProblemSummmary() Completion status " + e + ", doneStep " + g + ", correct " + f);
          ...
          e = c.getActor();
          q.ctatdebug("updateProblemSummmary() actor " + e + ", indicatorObj " + b);
  ...
  function e(a) {
    switch(q.suppressFeedback(a, d.getFeedbackPolicy())) {
  ...
  function g(a, b) {
    for (var c = new CTATMessageTank(a, null), d = 0;d < b.length;++d) {
      var e = b[d];
      q.ctatdebug("sendNewTankful() mto[" + d + "] msgType " + e.msgType);
  ...
  var n = b, q = this, f = null, u = /^([^:]+):([0-9]+)$/;
  this.toString = function() {
    q.ctatdebug("toString tank " + h);
    if (!h || 1 > h.length) {
  ...
  this.enqueueToolActionToStudent = function(a, b, c, e) {
    q.ctatdebug("Entering enqueueToolActionToStudent(" + a + ", " + b + ", " + c + ", " + e + ")");
    var f = CTATMsgType.INTERFACE_ACTION;
    q.ctatdebug("entering enqueueMessageToStudent()");
    ...
    q.addToMessageTank(f, b, e, a);
    return g;
  };
  this.addToMessageTank = function(a, b, c, d) {
    q.ctatdebug("Entering addToMessageTank(" + a + ", " + b + ", " + c + ")");
    if (b) {
      h || (h = [], k = {}, l = {});
      var e = {};
      e.msgType = a;
      ...
      l[a] = l[a] ? l[a] + 1 : 1;
      q.ctatdebug("Exiting addToMessageTank() this " + q.toString());
    }
  };
  this.flushMessageTank = function(a, b) {
    q.ctatdebug("Entering flushMessageTank(" + a + ", " + b + ")");
    if (h && !(1 > h.length)) {
      c(a);
      q.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length " + h.length + ", transaction_id " + n);
      for (var f = [], m = [], B = 0;B < h.length;++B) {
        var E = h[B];
        if (E.msg) {
          var y = E.msgType, z = E.evt;
          q.ctatdebug("entering processInterfaceVariables() msgType " + y + ", evt " + z);
          y && (q.ctatdebug("entering processInterfaceVariables() et " + d + ", tracer " + (d ? d.getTracer() : null)), y = y.toLowerCase(), 0 !== y.indexOf("correct") && 0 !== y.indexOf("interfaceaction") || d.getTracer().addInterfaceVariablesFromEvent(z));
          if (!(y = e(E))) {
            var y = E, z = m, t = void 0, C = void 0;
            if (!(y && y.sai && (t = y.sai.getAction()) && (C = u.exec(t))) || 3 > C.length || 1 >= C[2]) {
              y = !1;
            } else {
              var p = z.length - 1, p = 0 > p ? null : z[p];
              y.msg = y.msg.replace(t, C[1]);
              p && p.timeout == C[2] ? p.msgTuples.push(y) : z.push({timeout:Number(C[2]), msgTuples:[y]});
              y = !0;
            }
          }
          y || f.push(E.msg);
      ...
      q.ctatdebug("flushMessageTank(): msgBundle.length " + f.length + ", delayedMsgsBundle.length " + m.length);
      for (B = 0;B < m.length;++B) {
        E = m[B], q.ctatdebug("processDelayedMsgs() delayedMsgs.timeout " + E.timeout + ", .msgTuples.length " + E.msgTuples.length), setTimeout(g, E.timeout, d, E.msgTuples);
      }
      0 < f.length && (q.ctatdebug("Bottom of flushMessageTank(); to send bundle of length " + f.length + " via " + d), d.sendBundle(f) && (q.ctatdebug("CTATMessageTank.shouldSaveNow() resultTypes " + l + ", msgTypes " + k), (l[CTATExampleTracerLink.CORRECT_ACTION] || l[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION] || k.CorrectAction || k.InterfaceAction || k.UntutoredAction) && d.getOutputStatus().isSendingSavedMsgsForRestore() && (CTATGlobalFunctions.isInstructorMode() ? q.ctatdebug("We're in reviewer mode: we shouldn't save as we go") : 
      d.getProblemStateSaver().saveAsYouGo(a))), q.ctatdebug("Exiting flushMessageTank() #CorrectAction " + k.CorrectAction + ", #InterfaceAction " + k.InterfaceAction + ", #UntutoredAction " + k.UntutoredAction));
      k = h = n = null;
    }
  };
  this.flushDelayedFeedback = function() {
    q.ctatdebug("Entering flushDelayedFeedback()");
    if (null !== f && "undefined" !== typeof f) {
      for (var a in f) {
        if (f.hasOwnProperty(a)) {
          var b = f[a];
          q.ctatdebug("entering sendMessage()");
  ...
  this.suppressFeedback = function(a, b) {
    q.ctatdebug("CTATMessageTank.suppressFeedback(" + a.msgType + ", " + b + ")");
    var c = null;
    b == CTATMsgType.SHOW_ALL_FEEDBACK ? (q.ctatdebug("if.1"), c = b) : CTATMsgType.hasTextFeedback(a.msgType) ? (q.ctatdebug("if.2"), b == CTATMsgType.HIDE_ALL_FEEDBACK || b == CTATMsgType.HIDE_BUT_ENFORCE ? (q.ctatdebug("if.2.1"), c = b) : (q.ctatdebug("if.2.2"), (c = CTATMsgType.getProperty(a.msg, CTATMsgType.BUGGY_MSG)) && -1 != c.toLowerCase().indexOf(CTATMsgType.NOT_DONE_MSG.toLowerCase()) ? (q.ctatdebug("if.2.2.1"), c = CTATMsgType.SHOW_ALL_FEEDBACK) : (q.ctatdebug("if.2.2.2"), c = CTATMsgType.HIDE_ALL_FEEDBACK))) : 
    CTATMsgType.isCorrectOrIncorrect(a.msgType) ? (q.ctatdebug("if.3: " + a.msg), CTATMsgType.isDoneMessage(a.msg) ? (q.ctatdebug("if.3.1"), c = CTATMsgType.SHOW_ALL_FEEDBACK) : (q.ctatdebug("if.3.2"), c = b)) : (q.ctatdebug("if.4"), c = CTATMsgType.SHOW_ALL_FEEDBACK);
    q.ctatdebug("CTATMessageTank.suppressFeedback() returning " + c);
    return c;
  };
};
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var c = new CTATExampleTracerLink(null, null, null), e = f.getElementChildren(a), g, h, k, l, n, y = a = -1, z = CTATMsgType.DEFAULT_ACTOR, t = !1, C = 0;C < e.length;C++) {
      "sourceID" === f.getElementName(e[C]) && (a = parseInt(f.getNodeTextValue(e[C])), c.setPrevNode(a));
      "destID" === f.getElementName(e[C]) && (y = parseInt(f.getNodeTextValue(e[C])), c.setNextNode(y));
      if ("rule" === f.getElementName(e[C])) {
        for (var p = f.getElementChildren(e[C]), D = 0;D < p.length;D++) {
          "text" === f.getElementName(p[D]) && c.addSkillName(f.getNodeTextValue(p[D]).toString());
        }
      }
      if ("actionLabel" === f.getElementName(e[C])) {
        for (c.setIsPreferredLink("false" != f.getElementAttr(e[C], "preferPathMark")), c.setMinTraversalsStr(f.getElementAttr(e[C], "minTraversals")), c.setMaxTraversalsStr(f.getElementAttr(e[C], "maxTraversals")), p = f.getElementChildren(e[C]), D = 0;D < p.length;D++) {
          "uniqueID" === f.getElementName(p[D]) && (n = f.getNodeTextValue(p[D]), c.setUniqueID(parseInt(f.getNodeTextValue(p[D]))));
          "message" === f.getElementName(p[D]) && (l = new CTATMessage(p[D]));
          "actionType" === f.getElementName(p[D]) && c.setActionType(f.getNodeTextValue(p[D]));
          "buggyMessage" === f.getElementName(p[D]) && c.setBuggyMsg(f.getNodeTextValue(p[D]));
          "successMessage" === f.getElementName(p[D]) && c.setSuccessMsg(f.getNodeTextValue(p[D]));
          "hintMessage" === f.getElementName(p[D]) && c.addHint(f.getNodeTextValue(p[D]));
          if ("matchers" === f.getElementName(p[D])) {
            for (var F = f.getElementChildren(p[D]), A = 0;A < F.length;A++) {
              "Selection" === f.getElementName(F[A]) && (g = b(F[A], 0)), "Action" === f.getElementName(F[A]) && (h = b(F[A], 1)), "Input" === f.getElementName(F[A]) && (k = b(F[A], 2)), "Actor" === f.getElementName(F[A]) && (z = f.getNodeTextValue(F[A]), t = (t = f.getElementAttr(F[A], "linkTriggered")) && "false" != t.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === f.getElementName(p[D])) {
            h = p[D];
            g = f.getElementAttr(h, "replacementFormula");
            h = f.getElementChildren(h);
            var A = F = z = k = void 0, J = CTATMsgType.DEFAULT_ACTOR;
            k = new CTATExactMatcher(CTATMatcher.SELECTION, null);
            for (var z = new CTATExactMatcher(CTATMatcher.ACTION, null), G = 0;G < h.length;G++) {
              if ("matcherType" === f.getElementName(h[G]) && ("ExactMatcher" === f.getNodeTextValue(h[G]) && (A = CTATExactMatcher), "RegexMatcher" === f.getNodeTextValue(h[G]) && (A = CTATRegexMatcher), "AnyMatcher" === f.getNodeTextValue(h[G]) && (A = CTATAnyMatcher), "RangeMatcher" === f.getNodeTextValue(h[G]) && (A = CTATRangeMatcher), "WildcardMatcher" === f.getNodeTextValue(h[G]) && (A = CTATWildcardMatcher), "ExpressionMatcher" === f.getNodeTextValue(h[G]) && (A = CTATExpressionMatcher)), 
              "matcherParameter" === f.getElementName(h[G])) {
                var K = f.getElementAttr(h[G], "name");
                "selection" == K && k.setParameter(f.getNodeTextValue(h[G]));
                "action" == K && z.setParameter(f.getNodeTextValue(h[G]));
                "input" == K && (F = F ? F : new A(CTATMatcher.INPUT, null), F.setParameter(f.getNodeTextValue(h[G])));
                "actor" == K && (J = f.getNodeTextValue(h[G]));
                "minimum" == K && (F = F ? F : new A(CTATMatcher.INPUT, null), F.setParameter(f.getNodeTextValue(h[G]), "minimum"));
                "maximum" == K && (F = F ? F : new A(CTATMatcher.INPUT, null), F.setParameter(f.getNodeTextValue(h[G]), "maximum"));
              }
            }
    ...
    d.getStartNode() && y == d.getStartNode().getNodeID() && console.log("***WARNING*** edge " + n + " destination is graph startNode " + d.getStartNode());
    n = new CTATVectorMatcher(g, h, k, z);
    n.setDefaultSAI(l.getSAI());
    n.setCaseInsensitive(m);
    n.setLinkTriggered(t);
    c.setMatcher(n);
    ctatdebug("GraphParser.processEdge() " + a + "->" + y + ", edge " + c);
  ...
  function c(a, b) {
    ...
    for (var h = function(a) {
      ...
      if ("link" === f.getElementName(k[m])) {
        var n = Number(f.getElementAttr(k[m], "id")), z = b[n];
        if (null !== z || void 0 !== z) {
          ctatdebug("Added link ID : " + n), d.add(z);
        }
      }
  ...
  this.parseGraph = function(b, e) {
    ctatdebug("parseBRD()");
    var r = 0, v = f.getElementAttr(b, "startStateNodeName"), w = "true" === f.getElementAttr(b, "unordered");
    m = "false" != String(f.getElementAttr(b, "caseInsensitive")).toLowerCase();
    n = f.getElementAttr(b, "lockWidget");
    var x = new CTATVariableTable;
    d = new CTATExampleTracerGraph(w, !1, x);
    var x = f.getElementChildren(b), B = f.getElementAttr(b, "suppressStudentFeedback");
    if (null === B || void 0 === B) {
      B = CTATMsgType.SHOW_ALL_FEEDBACK;
    }
    d.setFeedbackPolicy(B);
    e.setFeedbackSuppressed(B);
    var E = f.getElementAttr(b, "highlightRightSelection");
    e.setHighlightRightSelection("false" != E);
    ...
    for (var B = null, z = 0;z < x.length;z++) {
      switch(f.getElementName(x[z])) {
        case "startNodeMessages":
          k = f.getElementChildren(x[z]);
          var t = new CTATTutorMessageBuilder;
          "true" !== y && "false" !== y && e.isFeedbackSuppressed() && (y = "true");
          h = t.createStateGraphMessage(m, w, n, e.isFeedbackSuppressed(), E, confirmDone, e.getSkillBarVector());
          break;
        case "node":
          r++;
          t = x[z];
          ctatdebug("processNode(" + t + ")");
          for (var C = f.getElementChildren(t), p = -1, t = "", D = 0;D < C.length;D++) {
            switch(f.getElementName(C[D])) {
              case "uniqueID":
                p = parseInt(f.getNodeTextValue(C[D]));
                break;
              case "text":
                t = f.getNodeTextValue(C[D]);
            }
          }
          C = new CTATExampleTracerNode(p, new Set);
          "" !== t && C.setNodeName(t);
          t = C;
          d.addNode(t);
          1 == r && (d.setStartNode(t), d.setStudentStartsHereNode(t));
          t.getNodeName() == v && d.setStudentStartsHereNode(t);
          break;
        case "edge":
          d.addLink(a(x[z]));
          break;
    ...
    if (B) {
      ...
      l.setGroupOrdered(l.getTopLevelGroup(), r);
      ...
      ctatdebug("processGroup() order of group: isOrdered= " + r);
      ctatdebug("processGroup() order of group: isOrdered typeof= " + typeof r);
      r = f.getElementChildren(v);
      for (v = 0;v < r.length;v++) {
        switch(f.getElementName(r[v])) {
          case "group":
            c(r[v], w);
            break;
          case "outOfOrderMessage":
            l.getTopLevelGroup().setDefaultBuggyMsg(f.getNodeTextValue(r[v]));
        }
      }
    }
    d.redoLinkDepths();
...
var CTATExampleTracer = function() {
  function a() {
    m.ctatdebug("workTheQueue() working " + A + ", workQueue.length " + F.length + ", restoreQueue.length " + D.length);
    if (0 == A) {
      for (;0 != (A = 0 < F.length | (0 < D.length) << 1);) {
        var a = null, c = !1;
        0 < D.length ? (a = D.shift(), c = !0) : a = F.shift();
        if (!b(a, c)) {
          m.ctatdebug("workTheQueue() suspending workQueue.length " + F.length + ", restoreQueue.length " + D.length);
          m.setWorking(c ? 1 : 0, !0);
          break;
        }
        m.ctatdebug("workTheQueue() bottom workQueue.length " + F.length + ", restoreQueue.length " + D.length);
      }
    }
  }
  function b(a, b) {
    ...
    switch(h) {
      ...
      case CTATMsgType.PROBLEM_SUMMARY_REQUEST:
        return setTimeout(function(a) {
          ...
          d.push(c);
          m.sendBundle(d);
          p.transition(CTATMsgType.PROBLEM_SUMMARY_RESPONSE, a.getCompletionStatus());
          m.ctatdebug("CTATExampleTracer.handleProblemSummaryRequest() sent result '" + c + "';");
          m.setWorking(b ? 1 : 0, !1);
        }, 4E3), !1;
      case CTATMsgType.START_STATE_END:
        return p.transition(CTATMsgType.START_STATE_END), !0;
      case CTATMsgType.PROBLEM_RESTORE_END:
        return l(), !0;
      default:
  ...
  function c(a, b, c, d) {
    ...
    m.ctatdebug("SetPreferences.problem_name = " + z);
      ...
      if (d = c.getElementName(a[b]), m.ctatdebug("SetPreferences eltName " + d), d) {
        switch(d.toLowerCase()) {
          ...
          case "skills":
            ...
            for (var e = v.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              ...
              if (g && "skill" == g.toLowerCase()) {
                ...
                if (h && "" != h.trim()) {
                  var g = v.getElementAttr(e[f], "label"), k = v.getElementAttr(e[f], "pSlip"), l = v.getElementAttr(e[f], "description"), q = v.getElementAttr(e[f], "pKnown"), r = v.getElementAttr(e[f], "category"), u = v.getElementAttr(e[f], "pLearn"), w = v.getElementAttr(e[f], "pGuess"), h = new CTATExampleTracerSkill(r, h, w, q, k, u);
                  h.setLabel(g);
                  h.setDescription(l);
                  d.push(h);
                }
          ...
          case "problem_state_status":
            p.transition(CTATMsgType.SET_PREFERENCES, c.getNodeTextValue(a[b]));
            C || (C = new ProblemStateRestorer(m));
            m.ctatdebug("SetPreferences problemStateRestorer " + C);
            break;
          case "curriculum_service_url":
            t.setCurriculumServiceUrl(c.getNodeTextValue(a[b]));
            break;
          case "restore_problem_url":
            C || (C = new ProblemStateRestorer(m));
            m.ctatdebug("SetPreferences problemStateRestorer " + C);
            C.setRestoreProblemUrl(c.getNodeTextValue(a[b]));
            break;
          case "session_id":
            G = c.getNodeTextValue(a[b]);
            break;
          case "authenticity_token":
            t.setAuthenticityToken(c.getNodeTextValue(a[b]));
        }
      }
    }
    m.ctatdebug("questionFile " + n + ", outputStatus " + p + ", problemStateRestorer " + C);
    a = n;
    m.ctatdebug("retrieveBRD (" + a + ")");
    K.retrieveXMLFile(a, c, m);
    C && C.retrieveMessages(p);
  }
  function e(a, b, c, d) {
    b = b.getTransactionID();
    m.ctatdebug("UntutoredAction (" + a + "), getTransactionID " + b);
    t.appendToProblemState(a, m.getOutputStatus(), !1);
    if (!J) {
      return !1;
    }
  ...
  function k(a, b, c, e, g, h) {
    ...
    k.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || t.appendToProblemState(h, m.getOutputStatus(), !1);
    k.setTransactionID(g);
    var n;
    m.ctatdebug("finishNewExampleTrace(" + k + ", " + b + ", " + c + ", " + e + ")");
    h = k.getStudentSAI();
    var l = k.getTutorSAI(), p = k.getTransactionID(), r = new CTATTutorMessageBuilder, u = [];
    ...
    if (k.isSolverResult()) {
      ...
      if (k.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        n = u ? "" + u.getUniqueID() : "", k.setStepID(n), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && m.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, r.createCorrectActionMessage(p, l), k, l), null !== u && "undefined" !== typeof u && m.updateSkills(CTATExampleTracerSkill.CORRECT, u.getSkillNames(), u.getUniqueID()), n = k.getSuccessOrBuggyMsg(), m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, r.createAssociatedRulesMessageForAction(k.getResult(), 
        l, h, m.getSkillBarVector(), u.getUniqueID(), p, n), k, l), m.ctatdebug("finishNewExampleTrace() successMsg " + n), n && m.messageTank.addToMessageTank("SuccessMessage", r.createSuccessMessage(p, n), k, null), w = null, e && (v = f(u ? u.getNextNode() : null, q.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = v);
      } else {
        m.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION, r.createInCorrectActionMessage(p, h), k, null);
        ...
        v || (v = q.getBestNextLink(!1, x), m.ctatdebug("getBestNextLink result: " + x + "; hintLink " + v));
        ...
        m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, r.createAssociatedRulesMessageForAction(k.getResult(), l && l.getSelection() ? l : h, h, m.getSkillBarVector(), n, p, x.tutorAdvice), k, null);
        x.msg && m.messageTank.addToMessageTank(x.msgType, x.msg, k);
        w = h;
        e && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == k.getResult() && (v = f(u ? u.getNextNode() : null, q.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = v);
      }
    }
    m.lastResult = k;
  ...
  function l() {
    p.transition(CTATMsgType.PROBLEM_RESTORE_END);
  ...
  var m = this, n = null, q, u, r, v = new CTATXML;
  new XMLSerializer;
  var w = null, x, B = !0, E = !1, y = null, z = null, t = new ProblemStateSaver(m);
  t.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());
  var C = null, p = new CTATProblemStateStatus, D = [], F = [], A = 0, J = !1, G = "";
  m.ctatdebug("CTATExampleTracer constructor outputStatus=" + p);
  ...
  var K = new CTATCommLibrary;
  this.receiveFromInterface = function(b) {
    console.log("CTATExampleTracer.receiveFromInterface(" + b + ")");
    F.push(b);
    a();
  };
  ...
  this.processXML = function(a) {
    ...
    if (null != a) {
      ...
      a = c.ssm;
      var d = c.sgMsg;
      m.ctatdebug("sendStartStateMessages() nMsgs " + a.length + ", outputStatus " + p);
      for (var c = [], e = new XMLSerializer, g = -1, h = 0;h < a.length;h++) {
        if ("message" == v.getElementName(a[h])) {
          ...
          p.isIncomplete() && CTATMsgType.START_STATE_END == l ? g = 0 : c.push(k);
        }
      }
      d = c.unshift(d);
      e = new CTATTutorMessageBuilder;
      c.splice(d - g, 0, e.createLockWidgetMsg(b.getLockWidget()));
      m.ctatdebug("sendStartStateMessages(): " + a.length + " elts, " + c.length + " strings, " + p);
      m.sendBundle(c);
      b = [];
      a = r.getStartNode();
      c = r.getStudentStartsHereNode();
      null != a && null != c && a.getNodeID() != c.getNodeID() && (b = r.getBestSubpath(a, c), m.ctatdebug("advanceToStudentStartsHere() path " + b), b = b.getSortedLinks(), b = m.traceLinks(b), m.ctatdebug("advanceToStudentStartsHere() results " + b));
      c = a = null;
  ...
  this.sendBundle = function(a) {
    m.ctatdebug("sending bundle #msgs = " + a.length + ", outputStatus " + p);
    for (var b = 0, c = 0;c < a.length;c++) {
      m.ctatdebug("Sending message #" + c);
      var d = a[c];
      0 >= c && (d = '<?xml version="1.0" encoding="UTF-8"?>' + d);
      t.forwardToInterface(d, c >= a.length - 1, p) && ++b;
    }
    return 0 < b;
  };
  ...
  this.getProblemSummary = function(a) {
    ...
    a && y.setRequiredSteps(a.countStepsForScore(r));
    return y;
  };
  ...
  this.setFeedbackSuppressed = function(a) {
    E = "false" === a ? !1 : "true" === a ? !0 : a === CTATMsgType.SHOW_ALL_FEEDBACK ? !1 : a === CTATMsgType.HIDE_ALL_FEEDBACK ? !0 : a === CTATMsgType.HIDE_BUT_ENFORCE ? !0 : a === CTATMsgType.HIDE_BUT_COMPLETE ? !0 : a === CTATMsgType.DELAY_FEEDBACK ? !0 : !1;
    m.ctatdebug("setFeedbackSuppressed(" + a + "): " + E);
  };
  ...
  this.setOutputStatus = function(a) {
    ...
    CTATProblemStateStatus[a] ? p.setStatus(CTATProblemStateStatus[a]) : (console.error("CTATExampleTracer.setOutputStatus() unexpected argument " + a), p.setStatus(CTATProblemStateStatus.empty));
  };
  this.getFeedbackPolicy = function() {
    return r ? r.getFeedbackPolicy() : CTATMsgType.SHOW_ALL_FEEDBACK;
  };
