...
var jstz = function() {
  ...
  "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, b = function(a) {
    ...
    a = a.getTime() + b;
    for (var g = (new Date(e)).getTimezoneOffset(), f = null;e < a - c;) {
      var d = new Date(e);
      if (d.getTimezoneOffset() !== g) {
        f = d;
        break;
      }
      e += c;
    }
    return 864E5 === b ? k(f, 36E5, 6E4) : 36E5 === b ? k(f, 6E4, 1E3) : f;
  }, c = function(a, b, c, e) {
    if ("N/A" !== c) {
      return c;
    }
    ...
    for (var g = {}, f = jstz.olson.dst_rules.zones, d = f.length, h = a[e], w = 0;w < d;w++) {
      var x = f[w], t;
      t = f[w];
    ...
    for (var G in g) {
      if (g.hasOwnProperty(G) && -1 != h.indexOf(G)) {
        return G;
      }
    }
    return e;
    ...
    var b = function() {
      for (var a = [], b = 0;b < jstz.olson.dst_rules.years.length;b++) {
        ...
        for (var g = (new Date(e)).getTimezoneOffset(), f = null, h = null;e < c - 864E5;) {
          var k = new Date(e), p = k.getTimezoneOffset();
          p !== g && (p < g && (f = k), p > g && (h = k), g = p);
          e += 864E5;
        }
...
(function(a, b) {
  ...
  function f(a, b, c, e) {
    ...
    p[g] || (m.insertRule("@" + (f && "-" + f + "-" || "") + "keyframes " + g + "{0%{opacity:" + e + "}" + c + "%{opacity:" + a + "}" + (c + .01) + "%{opacity:1}" + (c + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + e + "}}", m.cssRules.length), p[g] = 1);
    return g;
  }
  function g(a, b) {
    var c = a.style, e, g;
  ...
  function l() {
    ...
    h.prototype.lines = function(a, g) {
      function f() {
        return d(c("group", {coordsize:k + " " + k, coordorigin:-l + " " + -l}), {width:k, height:k});
      }
      function h(a, k, m) {
        b(p, b(d(f(), {rotation:360 / g.lines * a + "deg", left:~~k}), b(d(c("roundrect", {arcsize:g.corners}), {width:l, height:g.scale * g.width, left:g.scale * g.radius, top:-g.scale * g.width >> 1, filter:m}), c("fill", {color:e(g.color, a), opacity:g.opacity}), c("stroke", {opacity:0}))));
      }
      var l = g.scale * (g.length + g.width), k = 2 * g.scale * l, m = -(g.width + g.length) * g.scale * 2 + "px", p = d(f(), {position:"absolute", top:m, left:m});
      if (g.shadow) {
        for (m = 1;m <= g.lines;m++) {
  ...
  var k = ["webkit", "Moz", "ms", "O"], p = {}, n, m, u = {lines:12, length:7, width:5, radius:10, scale:1, corners:1, color:"#000", opacity:.25, rotate:0, direction:1, speed:1, trail:100, fps:20, zIndex:2E9, className:"spinner", top:"50%", left:"50%", shadow:!1, hwaccel:!1, position:"absolute"};
  h.defaults = {};
  c(h.prototype, {spin:function(b) {
    this.stop();
    var c = this, e = c.opts, g = c.el = a(null, {className:e.className});
    d(g, {position:e.position, width:0, zIndex:e.zIndex, left:e.left, top:e.top});
    b && b.insertBefore(g, b.firstChild || null);
    g.setAttribute("role", "progressbar");
    c.lines(g, c.opts);
    if (!n) {
      var f = 0, h = (e.lines - 1) * (1 - e.direction) / 2, l, k = e.fps, m = k / e.speed, p = (1 - e.opacity) / (m * e.trail / 100), u = m / e.lines;
      (function A() {
        f++;
        for (var a = 0;a < e.lines;a++) {
          l = Math.max(1 - (f + (e.lines - a) * u) % m * p, e.opacity), c.opacity(g, a * e.direction + h, l, e);
        }
    ...
    function h(b, c) {
      return d(a(), {position:"absolute", width:g.scale * (g.length + g.width) + "px", height:g.scale * g.width + "px", background:b, boxShadow:c, transformOrigin:"left", transform:"rotate(" + ~~(360 / g.lines * l + g.rotate) + "deg) translate(" + g.scale * g.radius + "px,0)", borderRadius:(g.corners * g.scale * g.width >> 1) + "px"});
    }
    for (var l = 0, k = (g.lines - 1) * (1 - g.direction) / 2, m;l < g.lines;l++) {
      m = d(a(), {position:"absolute", top:1 + ~(g.scale * g.width / 2) + "px", transform:g.hwaccel ? "translate3d(0,0,0)" : "", opacity:g.opacity, animation:n && f(g.opacity, g.trail, k + l * g.direction, g.lines) + " " + 1 / g.speed + "s linear infinite"}), g.shadow && b(m, d(h("#000", "0 0 4px #000"), {top:"2px"})), b(c, b(m, h(e(g.color, l), "0 0 1px rgba(0,0,0,.1)")));
    }
    return c;
  ...
  if ("undefined" !== typeof document) {
    ...
    !g(r, "transform") && r.adj ? l() : n = g(r, "animation");
  }
  return h;
});
...
;var CTATConfig = {Options:{}, addProperty:function(a, b, f, g) {
  f = f || b[0];
  Object.defineProperty(CTATConfig, a, {enumerable:!0, configurable:!1, writable:!g, value:f.toLowerCase()});
  var d = {};
...
function parseQueryStringArgs(a) {
  ...
  if (b) {
    for (var b = b.split("&"), f = 0;f < b.length;f++) {
      var g = b[f].split("=");
      a[decodeURIComponent(g[0])] = decodeURIComponent(g[1].replace(/\+/g, " "));
    }
  }
  return a;
}
...
function introspect(a, b, f, g) {
  console.log("introspect (" + a + ")");
  f = f || "";
  "number" !== this.typeOf(g) && (g = 1);
  var d = this.typeOf(b);
  a = [f, a, " ", d, " :"].join("");
  if ("object" === d) {
    if (0 < g) {
      f = [f, "  "].join("");
      for (var c in b) {
        d = this.introspect(c, b[c], f, g - 1), a = [a, "\n", d].join("");
      }
      return a;
    }
    return [a, " ..."].join("");
...
function getIndicesOf(a, b, f) {
  var g = 0, d = a.length, c = [];
  f || (b = b.toLowerCase(), a = a.toLowerCase());
  for (;-1 < (f = b.indexOf(a, g));) {
    c.push(f), g = f + d;
  }
  return c;
}
...
var CTATBase = function(a, b) {
  ...
  var g = a, d = b, c = this, e = !0;
  "undefined" != CTATBase.DebuggingFilter[g] && CTATBase.DebuggingFilter[g] && (e = !1);
  ...
  this.ctatdebugInternal = function(a, b) {
    var e = a, g = "No msg assigned yet";
    if (null === e || void 0 === e) {
      e = "No message!";
    }
    "" === e && (e = "Empty message!");
    if (useDebuggingBasic) {
      g = f("Unknown", "undefined", e), null === customconsole && (customconsole = getSafeElementById("customconsole")), null !== customconsole ? (customconsole.innerHTML += g + "<br>", customconsole.scrollTop = customconsole.scrollHeight) : console.log(g);
    } else {
...
var CTATShellTools = {ctat_base:new CTATBase("CTATShellTools", "shelltools"), component_descriptions:{}, registerComponentDescription:function(a) {
...
}, feedback_components:[], registerFeedbackComponent:function(a, b, f, g, d) {
  CTATShellTools.feedback_components.push({component:a, next:b, prev:f, showHints:g, showFeedback:d});
  ...
  for (var h in f) {
    ...
    d.groupName == a && (CTATShellTools.ctat_base.ctatdebug("Found the component group (" + d.groupName + "), adding component instance for " + d.name + " ..."), g.push(d.getComponentPointer()));
  }
  return null === g ? (CTATShellTools.ctat_base.ctatdebug("Info (groupArray==null), no appropriate component found, perhaps this is a group component"), -1 != a.indexOf(".") ? (f = a.split("."), this.findComponent(f[0])) : g) : 0 === g.length && (CTATShellTools.ctat_base.ctatdebug("Info (groupArray.length==0), no appropriate component found, perhaps this is a group component"), -1 != a.indexOf(".")) ? (f = a.split("."), this.findComponent(f[0])) : g;
...
var CTATXML = function() {
  ...
  this.getNodeTextValue = function(a) {
    ...
    for (var b = a.childNodes, f = 0;f < b.length;f++) {
      var g = b[f];
      if ("value" == g.nodeName || "Value" == g.nodeName) {
        if (1 == g.childNodes.length) {
          return g.childNodes[0].nodeValue;
        }
        if (0 == g.childNodes.length) {
          break;
        } else {
          return g.childNodes[1].nodeValue;
        }
      }
    }
...
var CTATSAI = function(a, b, f, g) {
  function d(a, b, c, e) {
    e = String(r.getElementName(b)).toLowerCase();
    if (e == a || "value" == e) {
      if (e = r.getElementChildren(b), !Array.isArray(e) || 1 > e.length) {
  ...
  var c = "undefined", e = "undefined", h = new CTATStringUtil, l = [], k = [], p = [], n = [], m = [], u = [], r, w = this;
  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, c = 0;c < a.length;c++) {
      var e = a[c];
      if ("selection" == r.getElementName(e) || "Selection" == r.getElementName(e)) {
        for (var g = r.getElementChildren(e), f = !1, d = 0;d < g.length;d++) {
          b = g[d], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > d ? this.setSelectionArray(b) : this.appendToSelectionArray(b), f = !0, this.setSelection(b));
        }
        !1 === f && (b = r.getNodeTextValue(e), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == r.getElementName(e) || "Action" == r.getElementName(e)) {
        g = r.getElementChildren(e);
        f = !1;
        for (d = 0;d < g.length;d++) {
          b = g[d], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > d ? this.setActionArray(b) : this.appendToActionArray(b), f = !0, this.setAction(b));
        }
        !1 === f && (b = r.getNodeTextValue(e), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == r.getElementName(e) || "value" == r.getElementName(e) || "Input" == r.getElementName(e)) {
        var b = r.getElementChildren(e), h = null;
        l = [];
        g = new CTATHTMLManager;
        f = new CTATArgument;
        d = 0;
        l.push(f);
        for (var m = 0;m < b.length;m++) {
          var k = b[m];
          "value" == r.getElementName(k) && (h = r.getElementChildren(k), null !== h ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + h.length), 1 === h.length ? (h = g.htmlDecode(r.getNodeTextValue(k)), this.ctatdebug("Setting new value to: " + h), f.setValue(h)) : (h = g.htmlDecode(r.getNodeTextValue(k)), this.ctatdebug("Setting new value to: " + h), f.setValue(h), f.setName(k.attributes.getNamedItem("name").value), f.setType(k.attributes.getNamedItem("type").value), 
          f.setFormat(k.attributes.getNamedItem("format").value), d++), 1 > m ? this.setInputArray(h) : this.appendToInputArray(h)) : (k = g.htmlDecode(r.getNodeTextValue(k)), this.ctatdebug("Setting new value to: " + k), f.setValue(k), 1 > m ? this.setInputArray(k) : this.appendToInputArray(k)));
        }
      }
      if ("prompt" == r.getElementName(e) || "Prompt" == r.getElementName(e)) {
        this.ctatdebug("Parsing prompt ..."), this.setPrompt(r.getNodeTextValue(e));
      }
    }
    this.checkDefaultArgument();
  };
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, c = 0;c < a.length;c++) {
      ...
      if ("internalArguments" == r.getElementName(e) || "Input" == r.getElementName(e)) {
        b = e.childNodes;
        l = [];
        var g = new CTATHTMLManager, f = new CTATArgument, d = 0, h = null;
        l.push(f);
        for (var k = 0;k < b.length;k++) {
          if (h = b[k], "value" == r.getElementName(h)) {
            var m = r.getElementChildren(h);
            null !== m ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + m.length), 1 === m.length ? (h = g.htmlDecode(r.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + h), f.setValue(h)) : (h = g.htmlDecode(r.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + h), f.setValue(h), f.setName(r.getElementAttr("name")), f.setType(r.getElementAttr("type")), f.setFormat(r.getElementAttr("format")), d++)) : (h = g.htmlDecode(r.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + 
            h), f.setValue(h));
            1 > k ? this.setInputArray(h) : this.appendToInputArray(h);
          }
        }
      }
      if ("prompt" == r.getElementName(e) || "Prompt" == r.getElementName(e)) {
  ...
  if (Array.isArray(a) && Array.isArray(b) && (Array.isArray(f) || null == f) && (this.setSelectionArray(a), this.setActionArray(b), this.setInputArray(f), x = !0, 0 < a.length && 0 < b.length)) {
    this.setSAI(a[0], b[0], null == f ? null : f[0], "String", g);
    return;
  }
  null !== a && "" !== a && this.setSelection(a);
  null !== a && (this.setSAI(a, b, f, "String", g), x || (this.setSelectionArray(Array.isArray(a) ? a : [a]), this.setActionArray(Array.isArray(b) ? b : [b]), this.setInputArray(Array.isArray(f) ? f : [f]), x = !0));
};
...
var CTATSkill = function() {
  ...
  var a = "", b = "", f = "", g = "", d = 0, c = "", e = !1, h = "", l = "", k = "", p = "", n = "";
  ...
  this.toSetPreferencesXMLString = function() {
    ...
    return e += '" pKnown="' + k + '" category="' + f + '" pLearn="' + p + '" name="' + a + '" pGuess="' + h + '" history="' + n + '" />';
  };
...
var CTATSkillSet = function() {
  ...
  this.parseByValue = function(b) {
    ...
    if (b) {
      b = b.childNodes;
      for (var f = new CTATXML, g = 0;g < b.length;g++) {
        var d = f.getNodeTextValue(b[g]).split("`"), c = d[0].split(" ");
  ...
  this.parseDOM = function(a) {
    ...
    for (var g = 0;g < a.length;g++) {
      var d = f.getNodeTextValue(a[g]).split("`"), c = d[0].split(" ");
      4 == d.length ? this.addSkill(c[0], d[1], d[2], d[3], d[3], c[1]) : this.addSkill(c[0], d[1], d[2], d[3], d[4], c[1]);
    }
  };
    ...
    if (b) {
      if (b = b.childNodes) {
        for (var f = 0;f < b.length;f++) {
          var g = b[f];
          if ("Skill" == g.nodeName || "skill" == g.nodeName) {
            this.ctatdebug("Parsing node (" + f + "): " + g.nodeName + " -> " + g.nodeValue);
            var d = g.attributes.getNamedItem("name");
            if (d = d ? d.value : "") {
              var c = g.attributes.getNamedItem("pKnown"), c = c ? c.value : "", e = g.attributes.getNamedItem("description"), e = e ? e.value : "", h = g.attributes.getNamedItem("label"), h = h ? h.value : "", l = g.attributes.getNamedItem("category"), l = l ? l.value : "", k = g.attributes.getNamedItem("pGuess"), k = k ? k.value : "", p = g.attributes.getNamedItem("pLearn"), p = p ? p.value : "", n = g.attributes.getNamedItem("pSlip"), n = n ? n.value : "", g = (g = g.attributes.getNamedItem("history")) ? 
              g.value : "";
              this.addSkill(d, c, .95, e, h, l, k, p, n, g);
            }
          }
        }
      } else {
  ...
  this.addSkill = function(a, f, g, d, c, e, h, l, k, p) {
    this.ctatdebug("addSkill() name = " + a + " level = " + f + " mastery = " + g + " aDescription = " + d + " adisplayName = " + c + " aCategory = " + e + " pguess= " + h + " plearn = " + l + " pslip = " + k + " history = " + p);
    a = this.setSkillLevel(a, f, g);
  ...
  this.setSkillLevel = function(a, f, g) {
    this.ctatdebug("setSkillLevel (" + a + "," + f + "," + g + ")");
    g = this.getSkill(a);
    null === g ? (this.ctatdebug("Skill not found, creating new one ..."), g = new CTATSkill, g.setSkillName(a), g.setLevel(f), this.internalSkillSet.push(g)) : (this.ctatdebug("Skill found, adjusting ..."), g.setLevel(1), g.setLevel(f));
    g.setTouched(!0);
    return g;
  };
  this.getSkill = function(a) {
    ...
    for (var f = 0;f < this.internalSkillSet.length;f++) {
      var g = this.internalSkillSet[f];
      if (g.getSkillName() == a) {
        return this.ctatdebug("Returning: " + f), g;
      }
    }
    return null;
  };
  ...
  this.getTouched = function() {
    ...
    for (var a = [], f = 0;f < this.internalSkillSet.length;f++) {
      var g = this.internalSkillSet[f];
      !0 === g.getTouched() && (this.ctatdebug("Adding touched skill: " + g.getSkillName()), a.push(g));
    }
    return a;
  };
  ...
  this.toLogString = function() {
    ...
    for (var a = "", f = 0;f < this.internalSkillSet.length;f++) {
      var g = this.internalSkillSet[f], a = a + ('<skill probability="' + g.getLevel() + '"><name>' + g.getSkillName() + "</name>");
      g.hasCategory() && (a += "<category>" + g.getCategory() + "</category>");
      g.hasModelName() && (a += "<model_name>" + g.getModelName() + "</model_name>");
      a += "</skill>";
    }
    return a;
  };
...
var transformArray = [], CTATJSON = function() {
  ...
  this.parseJSON = function(b) {
    ...
    for (var g in a) {
      return this.ctatdebug("Creating internal JSON object with name: " + g), b = new CTATJSONObject, b.name = g, b.value = a[g], b;
    }
    return null;
  };
  this.getElementName = function(a) {
  ...
  this.getElementChildren = function(a) {
    ...
    for (c in a) {
      var e = a[c];
      if ("string" == typeof e) {
        b = new CTATJSONObject, b.name = c, b.value = e, d.push(b);
      } else {
        if (null == e[0] || void 0 == e[0]) {
          b = new CTATJSONObject, b.name = c, b.value = e, d.push(b);
        } else {
          for (var h in e) {
            b = new CTATJSONObject, b.name = c, b.value = e[h], d.push(b);
          }
        }
      }
    }
  ...
  this.walk = function(a) {
    ...
    if (!(5 < b)) {
      ...
      for (d in a) {
        var c = a[d];
        this.ctatdebug("(" + g + ") typeof (key): " + typeof d + " -> typeof(value): " + typeof c + "(" + c.length + ")");
...
var CTATMessage = function(a) {
  ...
  var b = a, f = null, g = null;
  void 0 == a && (b = null);
  g = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  b && (this.ctatdebug("messageParser " + g + ", messageObj " + b), b.children && this.ctatdebug(b.children));
  var d = "ungraded", c = !1, e = !1, h = new CTATSkillSet, l = "", k = "", p = "", n = "", m = "", u = null, r = !1;
  ...
  this.parse = function() {
    ...
    if (null !== b) {
      this.ctatdebug("messageParser: " + g);
      this.ctatdebug("Root name: " + g.getElementName(b));
      "tool_message" == g.getElementName(b) ? (this.ctatdebug("Detected tool message"), l = "tool_message") : "message" != g.getElementName(b) ? (this.ctatdebug("Detected log message"), c = !0, l = g.getElementName(b)) : (this.ctatdebug("Detected regular message"), c = !1, this.parseMessageType());
      this.parseTransactionID();
      this.parseSAI();
      for (var a = g.getElementChildren(b), e = 0;e < a.length;e++) {
        var d = a[e];
        "properties" == g.getElementName(d) && (ctatdebug("Found a 'properties' element ... "), f = g.getElementChildren(d));
      }
  ...
  this.parseSAI = function() {
    ...
    if ("tool_message" == l) {
      ...
      a = g.getElementChildren(b);
      for (d = 0;d < a.length;d++) {
        if (f = a[d], "tool_message" == g.getElementName(f)) {
          for (f = g.getElementChildren(f), k = 0;k < f.length;k++) {
            r = f[k], "event_descriptor" == g.getElementName(r) && (u = new CTATSAI, u.fromXMLInternal(r));
          }
        }
      }
      e = !0;
      ...
      if (c) {
        ...
        for (var z = g.getElementChildren(b), y = 0;y < z.length;y++) {
          var q = z[y];
          if ("event_descriptor" == g.getElementName(q)) {
            for (var q = g.getElementChildren(q), F = 0;F < q.length;F++) {
              var E = q[F];
              "selection" == g.getElementName(E) && (a = g.getNodeTextValue(E), r.push(E));
              "action" == g.getElementName(E) && (d = g.getNodeTextValue(E), G.push(E));
              "input" == g.getElementName(E) && (f = g.getNodeTextValue(E), D.push(E));
              "prompt" == g.getElementName(E) && (k = g.getNodeTextValue(E));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), z = g.getElementChildren(b), y = 0;y < z.length;y++) {
          if (q = z[y], "properties" == g.getElementName(q)) {
            for (q = g.getElementChildren(q), F = 0;F < q.length;F++) {
              E = q[F], this.ctatdebug("Nodename: " + g.getElementName(E)), "Skills" == g.getElementName(E) && h.parseByValue(E), "SuccessMsg" == g.getElementName(E) && (p = a = g.getNodeTextValue(E)), "BuggyMsg" == g.getElementName(E) && (n = g.getNodeTextValue(E)), "Selection" == g.getElementName(E) && (a = g.getNodeTextValue(E), r.push(E)), "Action" == g.getElementName(E) && (d = g.getNodeTextValue(E), G.push(E)), "Input" == g.getElementName(E) && (f = g.getNodeTextValue(E), D.push(E)), "prompt" == 
              g.getElementName(E) && (k = g.getNodeTextValue(E)), "HighlightMsgText" == g.getElementName(E) && (m = g.getNodeTextValue(E));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + d + "," + f);
      "" !== a && null !== a ? (u = new CTATSAI(a, d, f, k), u.setArrayFromElements(r), u.setArrayFromElements(G), u.setArrayFromElements(D), e = !0) : (this.ctatdebug("No SAI found"), e = !1);
      this.ctatdebug("parseSAI () done, hassai: " + e + ", (" + a + "," + d + "," + f + "," + k + ")");
    }
  };
  this.parseTransactionID = function() {
    ...
    if ("tool_message" != l) {
      if (!c) {
        for (var a = g.getElementChildren(b), e = 0;e < a.length;e++) {
          var d = a[e];
          if ("properties" == g.getElementName(d)) {
            for (var d = g.getElementChildren(d), f = 0;f < d.length;f++) {
              var h = d[f];
              "transaction_id" == g.getElementName(h) && (k = g.getNodeTextValue(h));
            }
          }
        }
      }
  ...
  this.parseMessageType = function() {
    ...
    for (var a = g.getElementChildren(b), c = 0;c < a.length;c++) {
      var e = a[c];
      if ("properties" == g.getElementName(e)) {
        for (var e = g.getElementChildren(e), d = 0;d < e.length;d++) {
          var f = e[d];
          "MessageType" == g.getElementName(f) && (l = g.getNodeTextValue(f));
        }
      }
    }
    ...
    if (!c) {
      if (null !== f) {
        for (var b = 0;b < f.length;b++) {
          var e = f[b];
          if (g.getElementName(e) == a) {
            return g.getNodeTextValue(e);
          }
        }
      } else {
        this.ctatdebug("Internal error: no messageProperties object available");
...
var CTATCompBase = function(a, b, f, g, d, c) {
  CTATBase.call(this, a, b);
  var e = f || 0, h = g || 0, l = d || -2, k = c || -2, p = 50, n = 25, m = !1, u = !1, r = "", w = !1, x = !0, t = null, B = "", C = null;
  ...
  this.createCanvas = function() {
    ...
    q.setAttribute("width", l + canvasCalibrate + "px");
    q.setAttribute("height", k + canvasCalibrate + "px");
  ...
  this.move = function(a, b) {
    e = a;
    h = b;
    t && (t.style.left = e + "px", t.style.top = h + "px");
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    F = !0 === a ? "block" : "hidden";
    q && q.setAttribute("style", "border: 0px; position: absolute; " + (a ? "" : "visibility:hidden; ") + "; left:" + e + "px; top:" + h + "px; z-index:" + H + ";");
...
var CTATCSS = function() {
  ...
  this.addCSSAttribute = function(c, g) {
    b[a] = c;
    b[a + 1] = g;
    a += 2;
  };
  ...
  this.modifyCSSAttribute = function(a, c) {
    var g = b.indexOf(a);
    -1 == g ? this.addCSSAttribute(a, c) : b[g + 1] = c;
  };
  ...
  this.addSelectorAttribute = function(a, b, c) {
    ...
    a: {
      if (0 === f) {
        ...
        for (var p = 0;p < g.length && null !== g[p][0];p++) {
          if (g[p][0] == a) {
            a = p;
            break a;
          }
  ...
  this.toCSSString = function() {
    for (var a = "", d = 0;d < g.length;d++) {
      for (var a = a + (g[d][0] + " { "), f = 1;f < g[d].length;f++) {
        a += g[d][f], a = 0 === f % 2 ? a + "; " : a + ": ";
      }
      a += " }; ";
    }
...
CTAT.Component = {};
CTAT.Component.Base = {};
CTAT.Component.Base.Style = function(a, b, f, g, d, c) {
  CTATCompBase.call(this, a, b, f, g, d, c);
  var e = new CTATCSS;
...
CTAT.Component.Base.Graphical = function(a, b, f, g, d, c, e) {
  ...
  var l = CTATGlobals.Visual.BackgroundColor, k = "white", p = 1, n = CTATGlobals.Visual.BorderColor, m = !1, u = "solid", r = 0, w = "1px", x = 0, t = CTATGlobals.Font.color, B = "black", C = CTATGlobals.Font.family, G = CTATGlobals.Font.size, D = !1, z = !1, y = !1;
...
CTAT.Component.Base.SAIHandler = function(a, b, f, g, d, c, e) {
...
CTAT.Component.Base.Tutorable = function(a, b, f, g, d, c, e) {
  CTAT.Component.Base.SAIHandler.call(this, a, b, f, g, d, c, e);
  var h = !0, l = !0, k = !0, p = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, n = !0, m = this, u = !1;
...
CTAT.Component.Base.Clickable = function(a, b, f, g, d, c, e) {
  CTAT.Component.Base.Tutorable.call(this, a, b, f, g, d, c, e);
  var h = this;
...
var CTATRadioButton = function(a, b, f, g, d) {
  CTAT.Component.Base.Clickable.call(this, "CTATRadioButton", "__undefined__", a, b, f, g, d);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var c = this, e = null, h = null, l = null, k = CTATRadioButton.Options.Placement.right;
  ...
  var p = this.setText;
  this.setText = function(a) {
    console.log(this.getDivWrap().id, "setText", a);
    p(a);
    null !== e && (l.textContent = this.getText());
  };
...
var CTATButtonBasedComponent = function(a, b, f, g, d, c, e) {
  ...
  this.setImage = function(a) {
    ...
    "" != a && (h.getComponent().style.backgroundColor = "transparent", h.getDivWrap().style.backgroundImage = "url('" + a + "')");
  };
  ...
  this.getImagesFromDiv = function() {
    h.ctatdebug("getImagesFromDiv ()");
    k = h.getDivWrap().getAttribute("data-ctat-image-default");
    p = h.getDivWrap().getAttribute("data-ctat-image-clicked");
    n = h.getDivWrap().getAttribute("data-ctat-image-hover");
    h.getDivWrap().getAttribute("data-ctat-image-disabled");
    h.setImage(k);
  };
  this.processMousedown = function() {
    h.ctatdebug("processMousedown ()");
    void 0 != p && "" != p && (h.getComponent().style.backgroundImage = "url('" + p + "')");
  };
  this.processMouseup = function() {
    h.ctatdebug("processMouseup ()");
    void 0 != k && "" != k && (h.getComponent().style.backgroundImage = "url('" + k + "')");
  };
  this.processBaseMouseover = function() {
    h.ctatdebug("processBaseMouseover ()");
    void 0 != n && "" != n && (h.getComponent().style.backgroundImage = "url('" + n + "')");
  };
...
var CTATImageButtonComponent = function(a, b, f, g, d, c, e) {
  CTATButtonBasedComponent.call(this, a, b, f, g, d, c, e);
  var h = "", l = "", k = "", p = "", n = !1, m = "Image to Component", u = this;
  ...
  this.processMouseOver = function(a) {
    !0 !== n && (n = !0, !0 === u.getEnabled() ? u.assignActiveImage(k) : u.ctatdebug("Error component is disabled"), n = !1);
  };
...
var CTATImageButton = function(a, b, f, g, d) {
  CTATImageButtonComponent.call(this, "CTATImageButton", "__undefined__", a, b, f, g, d);
  var c = this, e = null, h = null, l = null;
  ...
  this.init = function() {
    ...
    l.setAttribute("style", "position: absolute;left:0px; top: 0px; z-index: " + CTATGlobalFunctions.gensym.z_index() + ";width: " + c.getWidth() + "px;height: " + c.getHeight() + "px; opacity : 0.0; filter: alpha(opacity=0); background-color: #ffffff");
    c.getDivWrap().appendChild(l);
    c.addSafeEventListener("click", c.processClick, l);
    c.addSafeEventListener("focus", c.processFocus, l);
    c.addSafeEventListener("mouseover", c.processMouseOver, l);
    c.addSafeEventListener("mouseout", c.processMouseOut, l);
  };
};
...
var CTATConfiguration = function() {
  ...
  var a = this, b = [], f = null, g = null, d = null, c = null;
  ...
  this.getSingleParameterValues = function(b) {
    ...
    for (var g = a.getRawFlashVars(), d = 0;d < b.length;++d) {
      g[b[d]] && c.push(b[d]);
    }
    return c;
  };
  this.generateDefaultConfiguration = function(b) {
    ...
    a.ctatdebug("generateDefaultConfiguration() nDefaults " + g + ", result['session_id'] " + c.session_id);
    g = b = null;
    if (window && window.frameElement && (g = window.frameElement.getAttribute("data-params"))) {
      b = jQuery.parseJSON(g);
      for (var d in b) {
    ...
    if (null == b) {
      for (d = $('object param[name="flashvars"]'), a.ctatdebug("generateDefaultConfiguration() objs " + d), b = 0;b < d.length;++b) {
        if (g = $(d[b]).attr("value"), a.ctatdebug("generateDefaultConfiguration() fVarsAsString " + g), g && (g = parseQueryStringArgs(g)) && g.question_file) {
          for (v in g) {
            c[v] = g[v];
          }
        }
    ...
    if (null == c) {
      ...
      if ("undefined" != typeof CTATTarget && "XBlock" != CTATTarget && "OLI" != CTATTarget) {
        ...
        g = "?" == b.charAt(0) ? b.substring(1) : b;
        b = {};
        if (g) {
          for (var g = g.split("&"), f = 0;f < g.length;f++) {
            var n = g[f].split("=");
  ...
  this.preParse = function() {
    ...
    for (g = !0;1 == g;) {
      ...
      null != a.raw[d] && (a.ctatdebug("Adding: " + d + "," + a.raw[f]), b[a.raw[d]] = a.raw[f], g = !0, c++);
    }
  };
  this.getDatasetNames = function() {
    ...
    f = [];
    for (var b = 0, c = !0;1 == c;) {
      var c = !1, g = "dataset_level_name" + (b + 1);
      null != a.raw[g] && (a.ctatdebug("Adding: " + g + "," + a.raw[g]), f[b] = a.raw[g], c = !0, b++);
    }
    return f;
  };
  this.getDatasetTypes = function() {
    ...
    for (var b = 0, c = !0;1 == c;) {
      ...
      null != a.raw[d] && (a.ctatdebug("Adding: " + d + "," + a.raw[d]), g[b] = a.raw[d], c = !0, b++);
    }
    return g;
  };
  this.getConditionNames = function() {
    ...
    for (var g = 0, d = !0;1 == d;) {
      var d = !1, f = "study_condition_name" + (g + 1);
      null != a.raw[f] && (a.ctatdebug("Adding: " + f + "," + a.raw[f]), b[g + c] = a.raw[f], d = !0, g++);
    }
    return b;
  };
  this.getConditionTypes = function() {
    ...
    for (var c = 0, g = !0;1 == g;) {
      var g = !1, f = "study_condition_type" + (c + 1);
      null != a.raw[f] && (a.ctatdebug("Adding: " + f + "," + a.raw[f]), d[c + b] = a.raw[f], g = !0, c++);
    }
    return d;
  };
  this.getConditionDescriptions = function() {
    ...
    for (var g = 0, d = !0;1 == d;) {
      var d = !1, f = "study_condition_description" + (g + 1);
      null != a.raw[f] && (a.ctatdebug("Adding: " + f + "," + a.raw[f]), c[g + b] = a.raw[f], d = !0, g++);
    }
    return c;
  };
  this.get = function(b) {
  ...
  this.setTutorDimensions = function(b, c, g) {
    a.raw.width = c;
    a.raw.height = g;
  };
  this.setTutorValue = function(b, c, g) {
    a.raw[c] = g;
  };
...
var CTATJumble = function(a, b, f, g, d) {
  CTAT.Component.Base.Tutorable.call(this, "CTATJumble", "aJumble", a, b, f, g, d);
  var c = "", e = "center", h = 0, l = 10, k = !1, p = this;
  ...
  this.init = function() {
    ...
    this.setComponent(n);
    this.addComponentReference(this, n);
    $(n).children().addClass("CTAT-jumble--item").attr({unselectable:"on", draggable:!0}).each(function() {
  ...
  this.init_items = function(a) {
    if (n) {
      ...
      for (var c = a.length, e = 0;e < c;e++) {
        ...
        g.classList.add("CTAT-jumble--item");
        g.addEventListener("dragstart", u, !1);
        g.addEventListener("dragenter", w, !1);
        g.addEventListener("dragover", r, !1);
        g.addEventListener("dragleave", x, !1);
        g.addEventListener("drop", t, !1);
        g.addEventListener("dragend", C, !1);
        b.appendChild(g);
        B.push(g);
      }
      n.innerHTML = "";
  ...
  this.getOrder = function() {
    for (var a = n.children, b = [], e = 0;e < a.length;e++) {
      var g = a[e];
      g.draggable && (g.id ? b.push(g.id) : console.log("ERROR: The CTATJumble " + p.getName() + " has a child with no id attribute: " + g + "!!!"));
    }
    return c = b.join(";");
  };
  this.updateSAI = function() {
...
var CTATConnection = function(a) {
  ...
  var b = null, f = null, g = !1, d = this, c = "text/plain";
  ...
  this.init = function() {
    ...
    if (null !== f) {
      ...
      try {
        ...
        alert("HTTP object creation error: " + g.message);
      }
    } else {
...
var CTATGraphicsTools = function(a, b, f, g, d, c) {
  CTATBase.call(this, "CTATGraphicsTools", "__undefined__");
  var e = b || 1, h = f || "#000000", l = g || "#EEEEEE", k = d || !1, p = "Arial", n = a || null;
  a = c || !1;
  var m = 0, u = this;
  if (null == n) {
  ...
  this.drawLine = function(a, b, c, e, g, d) {
  ...
  this.drawRectangle = function(a, b, c, g) {
    ...
    b += m;
    n.lineWidth = e;
    1 == k ? (n.fillStyle = l, n.fillRect(a, b, c, g)) : (n.strokeStyle = h, n.beginPath(), n.rect(a, b, c, g), n.stroke());
  };
  ...
  this.drawRoundedRect = function(a, b, c, g, d) {
    a += m;
    b += m;
    null != n && (n.strokeStyle = h, n.lineWidth = e, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + g - d), n.quadraticCurveTo(a, b + g, a + d, b + g), n.lineTo(a + c - d, b + g), n.quadraticCurveTo(a + c, b + g, a + c, b + g - d), n.lineTo(a + c, b + d), n.quadraticCurveTo(a + c, b, a + c - d, b), n.lineTo(a + d, b), n.quadraticCurveTo(a, b, a, b + d), n.stroke());
  };
  this.drawRoundedRectFilled = function(a, b, c, g, d) {
    a += m;
    b += m;
    null != n && (n.strokeStyle = h, n.lineWidth = e, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + g - d), n.quadraticCurveTo(a, b + g, a + d, b + g), n.lineTo(a + c - d, b + g), n.quadraticCurveTo(a + c, b + g, a + c, b + g - d), n.lineTo(a + c, b + d), n.quadraticCurveTo(a + c, b, a + c - d, b), n.lineTo(a + d, b), n.quadraticCurveTo(a, b, a, b + d), n.stroke(), n.fillStyle = l, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + g - d), n.quadraticCurveTo(a, b + g, a + d, b + g), n.lineTo(a + 
    c - d, b + g), n.quadraticCurveTo(a + c, b + g, a + c, b + g - d), n.lineTo(a + c, b + d), n.quadraticCurveTo(a + c, b, a + c - d, b), n.lineTo(a + d, b), n.quadraticCurveTo(a, b, a, b + d), n.fill());
  };
  ...
  this.drawTextFormatted = function(a, b, c, e, g, d, f, h, l, k) {
    if (null != n) {
      a += m;
      b += m;
      e = "";
  ...
  this.drawTriangle = function(a, b, c, g, d, f) {
  ...
  this.drawTriangleFilled = function(a, b, c, g, d, f) {
...
var CTATShape = function(a, b, f, g, d, c) {
  var e = this;
  if (void 0 == a || null == a) {
    return e.ctatdebug("--- Error: Must pass a valid ID. ---"), null;
  }
  var h = [], l = [], k = d, p = c, n = b, m = void 0, u = "black", r = "black", w = "Arial", x = 12, t = [], B = 1, C = 5, G = document.createElement("canvas");
  G.id = n;
  G.width = k;
  G.height = p;
  var D = new CTATCSS;
  ...
  this.drawLine = function() {
    z.drawLine(h[0] + B, l[0] + B, h[1], l[1], u, B);
  };
  this.drawCircle = function() {
    z.drawCircle(h[0] + C, l[0] + C, C);
  };
  this.drawCircleFilled = function() {
    z.drawCircleFilled(h[0] + C, l[0] + C, C - 1);
  };
  this.drawRectangle = function(a, b, c, e) {
    z.drawRectangle(a[0] + B, b[0] + B, k - B, p - B);
  };
  this.drawRectangleFilled = function() {
    z.drawRectangleFilled(h[0], l[0], k, p);
  };
  this.drawRoundedRect = function() {
    z.drawRoundedRect(h[0] + B, l[0] + B, k - C - B, p - C - B, C);
  };
  this.drawRoundedRectFilled = function() {
    z.drawRoundedRectFilled(h[0] + B, l[0] + B, k - C - B, p - C - B, C);
  };
  this.drawText = function() {
    z.drawText(x / 2, x / 2, m);
  };
  this.drawTriangle = function() {
    z.drawTriangle(h[0] + B, l[0] + B, h[1], l[1], h[2], l[2]);
  };
  this.drawTriangleFilled = function() {
    z.drawTriangleFilled(h[0], l[0], h[1], l[1], h[2], l[2]);
  };
  this.save = function() {
    z.save();
  };
...
var CTATCanvasComponent = function(a) {
  ...
  this.moveShape = function(a, b, c) {
    for (var e = 0;e < f.length;e++) {
      if (f[e].getName() == a) {
        f[e].modifyCanvasCSS("left", b + "px");
        f[e].modifyCanvasCSS("top", c + "px");
        break;
      }
    }
  };
...
var scrimIsUp = !1, errorScrim = !1, waitScrim = !0, warnScrim = !1, connectionScrim = !1, authorTimeSet = !0, inAuthorTime = !0, CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && w.scrimDownForced(), w.ctatdebug("errScrimUp (" + a + ")"), 1 == errorScrim ? 1 == e && (e = !1, getSafeElementById(ctatcontainer).removeChild(u)) : 1 == warnScrim && (e = !0), w.scrimUp(a));
  }
  function f(a, b) {
  ...
  var g = "", d = !1, c = !1, e = !1, h = null, l = null, k = new CTATCanvasComponent("CTAT Scrim"), p = [], n = null, m = null, u = null, r = null, w = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (w.ctatdebug("scrimUp ()"), b = CTATGlobals.languageManager.filterString(b), w.ctatdebug("Message: " + b), 1 == scrimIsUp ? (g = 1 == waitScrim ? b : g + (" \n " + b), k.removeComponent()) : (g = b, scrimIsUp = !0), w.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        w.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + g + "<br><br></div></div></div>"), !0 === e && (u = f(a, "close"), $(u).appendTo("#scrimpanel")), !0 === d && (n = f(h, "yes"), $(n).appendTo("#scrimpanel")), !0 === c && (m = f(l, "no"), $(m).appendTo("#scrimpanel")), 
        1 == waitScrim)) {
  ...
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && w.scrimDownForced(), w.ctatdebug("OKScrimUp (" + a + "," + b + ")"), c = d = e = warnScrim = errorScrim = !1, w.scrimUp(a), r = f(b, "OK"), $(r).appendTo("#scrimpanel"));
  };
  ...
  this.setInAuthorTime = function(a) {
    ...
    inAuthorTime = a;
    if (!a) {
      warnScrim = errorScrim = !1, e && null.removeChild(u);
    } else {
...
var CTATWSConnection = function(a) {
  ...
  var b = "", f = !1, g = this, d = null, c = [], e = !1, h = 0, l = 0, k = null, p = null;
  g.setSocketType("ws");
  this.setConsumed = function(a) {
    f = a;
  ...
  this.init = function() {
    g.ctatdebug("init (" + g.getURL() + "); websocket " + d);
    null == d && (d = new WebSocket(g.getURL()), d.addEventListener("open", function(a) {
      g.ctatdebug("STATUS: open");
      e = !0;
      g.ctatdebug("Connection open, flushing outgoing queue ...");
      h = (new Date).getTime();
      if (0 < c.length) {
      ...
      l = (new Date).getTime();
      g.ctatdebug("STATUS: message after " + (l - h) + " ms");
      g.ctatdebug("Received: " + a.data);
      k ? k(a.data) : g.ctatdebug("Error: no processing function provided");
    }), d.addEventListener("close", function(a) {
      g.ctatdebug("STATUS: close; " + (a ? "code " + a.code + ", reason " + a.reason : "no event"));
      e = !1;
      d.close(1E3, a ? a.reason ? a.reason : "received close code " + a.code : "no close event received");
      p && p(a);
    }), d.addEventListener("error", function(a) {
      g.ctatdebug("STATUS: error; " + (a ? a.type : "no event"));
      e = !1;
  ...
  this.send = function() {
    g.ctatdebug("send ()");
    g.init();
    !1 === e ? (g.ctatdebug("Connection not ready yet, storing ..."), c.push(b)) : (g.ctatdebug("Connection ready, sending data ..."), h = (new Date).getTime(), d.send(b));
  };
};
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b) {
  ...
  var f = authenticityToken = "", g = 0, d = [], c = a ? a : null, e = null == b ? !0 : b, h = !0, l = null, k = this, p = "http";
  ...
  this.encodeVariablesOLI = function(a) {
    k.ctatdebug("encodeVariablesOLI ()");
    for (var b = "", c = 0;c < a.length;c++) {
      var e = a[c];
      0 < c && (b += "&");
      b += e.name;
  ...
  this.createConnection = function(a, b) {
    k.ctatdebug("createConnection ()");
    if (!b) {
      return new CTATConnection(a);
    }
    flashVars.getRawFlashVars();
    var c = null;
    if ("websocket" == k.getSocketType()) {
  ...
  this.endBundle = function() {
    k.ctatdebug("endBundle ()");
    0 == useBundling ? k.ctatdebug("Not using bundling, bump") : (inBundle = !1, bundleFormatter += "</messages></properties></message>", k.sendXML(bundleFormatter));
  };
  ...
  this.getURL = function() {
    k.ctatdebug("getURL ()");
    if ("" != f) {
      return k.ctatdebug("Returning fixedURL: " + f), f;
    }
    var a = flashVars.getRawFlashVars(), b = "http://";
    "https" == k.getSocketType() && (b = "https://");
  ...
  this.sendXML = function(a) {
    k.ctatdebug("Sending: " + a);
    k.ctatdebug("sendXML (" + a + ")");
    if (1 == useBundling && 1 == inBundle) {
      k.ctatdebug("Bundling ..."), bundleFormatter += a;
    } else {
      bundleFormatter = a;
      flashVars.getRawFlashVars();
      a = this.getURL();
      ...
      1 == this.getUseCommSettings() ? "javascript" == k.getSocketType() ? CTAT.ToolTutor.sendToTutor(b) : this.send_post(a, b) : this.send_post(a, b);
    }
  };
  this.sendXMLNoBundle = function(a) {
    k.ctatdebug("sendXMLNoBundle (" + a + ")");
    bundleFormatter = a;
    var b = this.getURL(), c = a;
    -1 == a.indexOf("<?xml") && (c = '<?xml version="1.0" encoding="UTF-8"?>' + a);
    flashVars.getRawFlashVars();
    1 == this.getUseCommSettings() ? "javascript" == k.getSocketType() ? CTAT.ToolTutor.sendToTutor(c) : this.send_post(b, c) : this.send_post(b, c);
  };
  this.sendXMLURL = function(a, b) {
    k.ctatdebug("sendXMLURL (" + b + ")");
    var c = a;
    -1 == a.indexOf("<?xml") && (c = '<?xml version="1.0" encoding="UTF-8"?>' + a);
    flashVars.getRawFlashVars();
    k.ctatdebug("Sending: " + c);
    1 == this.getUseCommSettings() ? "javascript" == k.getSocketType() ? CTAT.ToolTutor.sendToTutor(c) : this.send_post(b, c) : this.send_post(b, c);
  };
  ...
  this.send = function(a) {
    ...
    if (!0 === globalCommDisabled) {
      k.ctatdebug("Communications globally disabled, please check your settings");
    } else {
  ...
  this.send_post_variables = function(a, b) {
    k.ctatdebug("send_post_variables (" + a + ")");
    flashVars.getRawFlashVars();
    k.getSocketType();
    ...
    if (!0 === globalCommDisabled) {
      ...
      var e = k.createConnection(CTATConfiguration.getRawFlashVars(), a);
  ...
  this.send_post = function(a, b) {
    var c = null;
    k.ctatdebug("send_post (" + a + ")");
    if (!0 === globalCommDisabled) {
      k.ctatdebug("Communications globally disabled, please check your settings");
    } else {
      k.ctatdebug("Outoing on wire: " + b);
      var c = flashVars.getRawFlashVars(), e = a;
      "websocket" == k.getSocketType() ? (e = a.replace("http:", "ws:"), c = k.createConnection(c, e), c.setData(b), k.ctatdebug(b)) : (c = k.createConnection(c, e), c.setData(b));
      null != l && l.processOutgoing(b);
      c.send();
    }
  };
  this.processReply = function(a) {
    k.ctatdebug("processReply (" + d.length + "," + a + ")");
    var b = 0, g = !1;
    a = [];
    for (var f = 0, f = 0;f < d.length;f++) {
      var h = d[f], p = h.getHTTPObject();
      k.ctatdebug("Testing connection entry " + f + ", readyState: " + p.readyState + ", testConnection.consumed: " + h.getConsumed());
      4 == p.readyState && 0 == h.getConsumed() ? (k.ctatdebug("Investigating request response: " + b + " -> " + p.status + ", for: " + h.getURL()), g = !1, 0 === p.status && (g = !0, k.ctatdebug("Received message (status 0): " + p.responseText)), 408 == p.status && (g = !0, k.ctatdebug("Received message (status 408): " + p.responseText), e && CTATScrim.scrim.scrimDown()), 502 == p.status && (g = !0, k.ctatdebug("Received message (status 502): " + p.responseText), e && CTATScrim.scrim.errorScrimUp("Error contacting the server, please refresh the page and try again (HTTP status 502: gateway response).")), 
      200 == p.status ? (g = !0, k.ctatdebug("Processing 200 response ..."), null !== c ? (a.push(p.responseText), null != l && l.processIncoming(p.responseText)) : k.ctatdebug("Error: httphandler is null, can't process response!")) : c && c.processError && (g = !0, k.ctatdebug("Processing non-200 response, status " + p.status), c.processError(p.status, p.responseText)), !1 === g && k.ctatdebug("Error: status not handled for: " + p.status), k.ctatdebug("Marking connection as consumed ..."), h.setConsumed(!0)) : 
      (0 === p.readyState && k.ctatdebug("Received message (status 0, request not initialized)"), 1 === p.readyState && k.ctatdebug("Received message (status 1, server connection established)"), 2 === p.readyState && k.ctatdebug("Received message (status 2, request received)"), 3 === p.readyState && k.ctatdebug("Received message (status 3, processing request)"));
      b++;
    }
    k.cleanup();
    for (b = 0;b < a.length;b++) {
      g = a[b], -1 != g.indexOf("status=success") ? k.ctatdebug("Info: logging success message received, not propagating to message handler") : (k.ctatdebug("Processing incoming message: " + g), c.processMessage(g));
    }
  };
  this.processWSReply = function(a) {
    k.ctatdebug("processWSReply() length " + (null == a ? null : a.toString().length));
    "string" == typeof a && (null != l && l.processIncoming(a), -1 != a.indexOf("status=success") ? k.ctatdebug("processWSReply() logging success message received, not propagating to message handler: " + a) : (k.ctatdebug("Processing incoming message: " + a), c.processMessage(a)));
  };
  this.processWSClose = function(a) {
    k.ctatdebug("processWSClose(" + a + ")");
    a instanceof CloseEvent && k.ctatdebug("CloseEvent: code " + a.code + ", reason " + a.reason + ", wasClean " + a.wasClean);
  ...
  this.cleanup = function() {
    ...
    k.ctatdebug("Removed " + a + " entries");
  };
  this.checkEntries = function() {
    k.ctatdebug("checkEntries (" + d.length + ")");
    for (var a = 0, b = 0, b = 0;b < d.length;b++) {
      var c = d[b];
      if (!0 === c.getConsumed()) {
        return k.ctatdebug("Removing : " + c.getID()), d.splice(a, 1), !0;
      }
      var e = c.getHTTPObject();
      k.ctatdebug("Check, readyState: " + e.readyState + ", consumed: " + c.getConsumed());
      a++;
    }
    return !1;
  };
  this.retrieveXMLFile = function(a, b, c) {
    k.ctatdebug("retrieveXMLFile (" + a + ")");
    var e = (new CTATConnection).getHTTPObject();
    e.onreadystatechange = function() {
      k.ctatdebug("onready... GET for xmlFile xmlhttp.readyState " + e.readyState + ", .status " + e.status + ", parser " + b);
      if (4 == e.readyState && 200 == e.status) {
        var g = null;
        e.responseXML ? (k.ctatdebug("parsing brd xml using something else"), g = e.responseXML.documentElement) : (k.ctatdebug("parsing brd xml using node"), g = (b = new CTATXML).parseXML(e.responseText));
        null == g ? (g = (new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile " + a), k.ctatdebug("Error parsing xmlFile " + a + ": " + g), CTAT.ToolTutor.sendToInterface(g, !0)) : c.processXML(g);
      }
    };
    e.onerror = function() {
      var a = (new CTATTutorMessageBuilder).createErrorMessage("Load Problem Error", e.status + " " + e.statusText);
      k.ctatdebug("onerror GET for xmlFile " + a);
  ...
  this.retrieveJSONFile = function(a, b) {
    k.ctatdebug("retrieveJSONFile (" + a + ")");
    var c = (new CTATConnection).getHTTPObject();
    c.onreadystatechange = function() {
      4 == c.readyState && 200 == c.status && (k.ctatdebug("Successfully retrieved file: " + a), b(JSON.parse(c.responseText)));
    };
    c.onerror = function() {
      k.ctatdebug("Error retrieving JSON file");
    };
    c.open("GET", a, !0);
  ...
  this.retrieveFile = function(a, b) {
    k.ctatdebug("retrieveFile (" + a + ")");
    var c = (new CTATConnection).getHTTPObject();
    c.onreadystatechange = function() {
      4 == c.readyState && 200 == c.status && (k.ctatdebug("Successfully retrieved file: " + a), b(c.responseText));
    };
    c.onerror = function() {
      k.ctatdebug("Error retrieving file");
    };
    c.open("GET", a, !0);
    c.setRequestHeader("Content-type", "text/plain");
    c.send();
...
var CTATTutoringServiceMessageBuilder = function() {
  ...
  this.createSetPreferencesMessage = function(a) {
    ...
    f = f + ("<log_to_remote_server>" + g + "</log_to_remote_server><log_to_disk>" + d + "</log_to_disk>") + ("<log_to_disk_directory>" + b.log_to_disk_directory + "</log_to_disk_directory>");
  ...
  this.createAssociatedRulesMessage = function(a, b, f, g, d, c) {
...
var CTATLogMessageBuilder = function() {
  ...
  this.createContextMessage = function(b) {
    ...
    var e = e + c, c = flashVars.getCustomFields(), k;
    for (k in c) {
      c.hasOwnProperty(k) && (e += "<custom_field>", e += "<name>" + k + "</name>", e += "<value>" + c[k] + "</value>", e += "</custom_field>");
    }
    e += "</context_message>";
    a.ctatdebug("messageString = " + e);
    return e;
  };
  this.createSemanticEventToolMessage = function(g, d, c, e, h) {
  ...
  this.createUIEventToolMessage = function(g, d, c, e) {
    ...
    g = "<event_descriptor>" + g.toSerializedString();
    l += g + "</event_descriptor>";
    l += this.createCustomFields(b, f);
    l += "</tool_message>";
    a.ctatdebug("messageString = " + l);
    return l;
  };
  this.createTutorMessage = function(g, d, c, e, h, l, k, p) {
    ...
    "" !== l && (d += ' subtype="' + l + '"');
    m += d + "/>";
    g = "<event_descriptor>" + g.toXMLString(!0);
    m += g + "</event_descriptor>";
    g = "<action_evaluation ";
    e.hasClassification() && null != e.getAttributeString() && (g += e.getAttributeString());
    g += ">" + e.getEvaluation() + "</action_evaluation>";
    m += g;
    "" != h && (m += "<tutor_advice>" + h + "</tutor_advice>");
    null != k && (a.ctatdebug("Adding skills to log message ..."), m += k.toLogString());
  ...
  this.addCustomFields = function(g, d) {
    a.ctatdebug("addCustomFields ()");
    if (void 0 != g) {
      for (var c = 0;c < g.length;c++) {
        b.push(g[c]), f.push(d[c]);
      }
    }
  };
  this.addCustomField = function(g, d) {
    a.ctatdebug("addCustomfield (" + g + "," + d + ")");
    b.push(g);
    f.push(d);
  };
...
var CTATNameTranslator = function() {
  ...
  this.manufactorJSON = function(a, g) {
    b.ctatdebug("manufactorJSON (" + a + "," + g + ")");
    var d = a.split(":");
    if (1 == d.length) {
  ...
  this.translateFromCTAT = function(f, g) {
    if (!0 === a) {
      return f;
    }
    var d = f.toLowerCase();
    ...
    if (-1 != d.indexOf(".r")) {
      ...
      if (0 >= c.length) {
        ...
        return e = c[1], c = c[0].substr(1), b.ctatdebug("Original row (1st format): " + c + " original col: " + e), e = !0 === g ? colName(e, !1) + c : h[0] + "." + colName(e, !1) + c, b.ctatdebug("Translated: " + e), e;
      }
    } else {
      if (0 === d.indexOf("r")) {
        var h = d.indexOf("c"), l = parseInt(d.substr(1, h - 1)), d = parseInt(d.substr(h + 1)), c = l + 1, e = d;
        b.ctatdebug("Original row (2nd format) (columnindex: " + h + "): " + l + " -> " + c + ", original col: " + d + " -> " + e);
        e = colName(e, !1) + c;
  ...
  this.translateToCTAT = function(b) {
    ...
    var g = this.letterToColumn(b.substr(0, 1)) - 1;
    return "R" + (parseInt(b.substr(1)) - 1) + "C" + g;
  };
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, f = !0, g = !1, d = !1, c = [], e = "undefined", h = "undefined", l = "undefined", k = "undefined", p = "undefined", n = "undefined", m = "undefined", u = "undefined", r = "UnassignedDataset", w = "UnassignedLevelName", x = "UnassignedLevelType", u = (new CTATGuid).guid();
  void 0 != a && null != a ? (g = a, 0 == g && (commLogMessageBuilder = new CTATLogMessageBuilder)) : commLogMessageBuilder = new CTATLogMessageBuilder;
  ...
  this.initCheck = function() {
    ...
    0 == g && 0 == d && (b.setupExternalLibraryUsage(), d = !0);
  };
  ...
  this.logSemanticEvent = function(a, c, e, g, d, f) {
    ...
    a = commLogMessageBuilder.createSemanticEventToolMessage(c, a, e, g, !0);
    this.sendMessage(a);
  };
  this.logTutorResponse = function(a, c, e, g, d, f, h, l, p) {
    b.ctatdebug("logTutorResponse ()");
    b.initCheck();
    var k = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(l, p);
    ...
    l = "";
    void 0 != f && null != f ? l = "<![CDATA[" + CTATGlobals.languageManager.filterString(f) + "]]\x3e" : (b.ctatdebug("No feedback provided, using empty string"), l = "");
    b.ctatdebug("Creating tutor message ...");
    a = commLogMessageBuilder.createTutorMessage(c, a, e, d, l, g, h, !0);
    this.sendMessage(a);
  };
  this.processMessage = function(a) {
...
var CTATMessageHandler = function() {
  ...
  var a = null, b = this, f = [], g = null, d = 0, g = CTATConfig.parserType_is_XML() ? new CTATXML : new CTATJSON;
  ...
  this.processSingleMessage = function(c) {
    b.ctatdebug("processSingleMessage (" + g.getElementName(c) + ")");
    var h = new CTATMessage(c);
    c = g.getElementChildren(c);
    b.ctatdebug("Generated CTATMessage, now doing regular processing ...");
    for (var l = 0;l < c.length;l++) {
      var k = c[l];
      if ("properties" == g.getElementName(k)) {
        b.ctatdebug("Parsing properties ...");
        for (var p = g.getElementChildren(k), n = 0;n < p.length;n++) {
          var m = p[n];
          if ("MessageType" == g.getElementName(m)) {
            m = g.getNodeTextValue(m);
            b.ctatdebug("MessageType: " + m);
            "StateGraph" == m && (console.log("Setting inStartState to true"), inStartState = !0, this.processStateGraph(k), commShell.propagateShellEvent("StateGraph", h));
            ...
            if ("AssociatedRules" == m) {
              ...
              for (var u = "", r = "", w = 0;w < p.length;w++) {
                var x = p[w];
                "TutorAdvice" == g.getElementName(x) && (u = g.getNodeTextValue(x));
                "Actor" == g.getElementName(x) && g.getNodeTextValue(x);
                "Indicator" == g.getElementName(x) && (r = g.getNodeTextValue(x));
                "StepID" == g.getElementName(x) && g.getNodeTextValue(x);
                "LogAsResult" == g.getElementName(x) && g.getNodeTextValue(x);
                "tool_selection" == g.getElementName(x) && g.getNodeTextValue(x);
                "Skills" == g.getElementName(x) && (b.ctatdebug("Processing skills ..."), null === skillSet && (b.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."), skillSet = new CTATSkillSet), skillSet.parseByValue(x));
              }
            ...
            if ("ShowHintsMessage" == m) {
              ...
              for (w = 0;w < p.length;w++) {
                if (x = p[w], "HintsMessage" == g.getElementName(x)) {
                  for (var x = g.getElementChildren(x), t = 0;t < x.length;t++) {
                    var B = x[t];
                    "value" == g.getElementName(B) && (r.push(g.getNodeTextValue(B)), u = !0);
                  }
                }
              }
  ...
  this.processStateGraph = function(c) {
    ...
    if (void 0 === c || null === c) {
      ...
      if (b.ctatdebug("Processing node: " + c.nodeName), null === g.getElementChildren(c)) {
        b.ctatdebug("Error: state graph property list is undefined");
      } else {
        c = g.getElementChildren(c);
        for (var d = 0;d < c.length;d++) {
          var f = c[d];
          b.ctatdebug("State graph attribute: " + g.getElementName(f));
          "caseInsensitive" == g.getElementName(f) && (caseInsensitive = "false" == g.getNodeTextValue(f) ? !1 : !0);
          "unordered" == g.getElementName(f) && (unordered = "false" == g.getNodeTextValue(f) ? !1 : !0);
          "lockWidget" == g.getElementName(f) && (lockWidget = "false" == g.getNodeTextValue(f) ? !1 : !0);
          "suppressStudentFeedback" == g.getElementName(f) && ("false" == g.getNodeTextValue(f) ? CTATGlobals.suppressStudentFeedback = !1 : CTATGlobals.suppressStudentFeedback = !0);
          "highlightRightSelection" == g.getElementName(f) && (highlightRightSelection = "false" == g.getNodeTextValue(f) ? !1 : !0);
          "confirmDone" == g.getElementName(f) && (b.ctatdebug("Confirm done: " + g.getNodeTextValue(f)), "true" == g.getNodeTextValue(f) ? CTATGlobals.confirmDone = !0 : CTATGlobals.confirmDone = !1);
          "Skills" == g.getElementName(f) && (null === skillSet && (skillSet = new CTATSkillSet), skillSet.parseByValue(f), a.updateSkillWindow());
        }
      }
    }
  };
  ...
  this.processInterfaceDescription = function(a) {
    ...
    for (var c = "Unknown", d = "Unknown", f = null, p = 0;p < a.length;p++) {
      var n = a[p];
      b.ctatdebug("Inspecting element: " + g.getElementName(n));
      "WidgetType" == g.getElementName(n) && (b.ctatdebug("Widget type: " + g.getNodeTextValue(n)), c = g.getNodeTextValue(n));
      "CommName" == g.getElementName(n) && (b.ctatdebug("Instance name: " + g.getNodeTextValue(n)), d = g.getNodeTextValue(n));
      if ("serialized" == g.getElementName(n)) {
        b.ctatdebug("Prepareing to de-serialize component ...");
        for (var m = g.getElementChildren(n), u = 0;u < m.length;u++) {
          var r = m[u];
          -1 != g.getElementName(r).indexOf("CTAT") && (f = r);
        }
      }
      "interface" == g.getElementName(n) && (b.ctatdebug("Storing interface for post start-state reconstruction ..."), CTATGlobals.interfaceElement = n);
      "script" == g.getElementName(n) && (b.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."), scriptElement = g.getNodeTextValue(n));
    }
  ...
  this.deserializeComponent = function(a, c, d) {
    ...
    if (1 == ignoreInterfaceDescriptions) {
      ...
      if (null === g.getElementAttr(d, "x")) {
        b.ctatdebug("Warning: this component does not have x,y information. Probably an older component");
      } else {
        var f = g.getElementAttr(d, "x"), p = g.getElementAttr(d, "y"), n = g.getElementAttr(d, "width"), m = g.getElementAttr(d, "height"), u = g.getElementAttr(d, "tabIndex"), r = g.getElementAttr(d, "zIndex");
        null === u && (u = -1);
        null === r && (r = 0);
        ...
        d = g.getElementChildren(d);
        for (f = 0;f < d.length;f++) {
          p = d[f];
          g.getElementName(p);
          if ("Parameters" == g.getElementName(p)) {
            for (this.ctatdebug("Processing component parameters ..."), n = g.getElementChildren(p)[0], n = g.getElementChildren(n), m = 0;m < n.length;m++) {
              var x = n[m];
              if ("CTATComponentParameter" == g.getElementName(x)) {
                this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");
                for (var r = u = void 0, x = g.getElementChildren(x), t = 0;t < x.length;t++) {
                  var B = x[t];
                  "name" == g.getElementName(B) && (this.ctatdebug("Found parameter name: " + g.getNodeTextValue(B)), u = g.getNodeTextValue(B));
                  "value" == g.getElementName(B) && (this.ctatdebug("Found parameter value: " + g.getNodeTextValue(B)), r = g.getNodeTextValue(B).trim());
                }
          ...
          if ("Styles" == g.getElementName(p)) {
            for (this.ctatdebug("Processing component styles ..."), p = g.getElementChildren(p)[0], p = g.getElementChildren(p), n = 0;n < p.length;n++) {
              if (r = p[n], "CTATStyleProperty" == g.getElementName(r)) {
                this.ctatdebug("Processing style property (CTATStyleProperty) ...");
                u = m = "";
                r = g.getElementChildren(r);
                for (x = 0;x < r.length;x++) {
                  t = r[x], "name" == g.getElementName(t) && (m = g.getNodeTextValue(t)), "value" == g.getElementName(t) && (u = g.getNodeTextValue(t).trim());
                }
...
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForHint = function(a, b, f, g, d, c) {
...
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForAction = function(a, b, f, g, d, c, e, h) {
  ...
  a += b.toXMLString();
  b = g.toXMLString().replace("<Selection>", "<StudentSelection>").replace("<Action>", "<StudentAction>").replace("<Input>", "<StudentInput>");
...
CTATTutorMessageBuilder.prototype.isDoneStep = function(a, b) {
  ...
  var g = a.getStudentSelection();
  g || (g = a.getProperty("tool_selection"));
  b[0] = CTATTutorMessageBuilder.isCorrect(indicator);
  var d = "done" == g;
  this.ctatdebug("isDoneStep() indicatorObj " + f + ", selectionObj " + g + ", correct[0] " + b[0] + ", result " + d);
  return d;
};
CTATTutorMessageBuilder.prototype.createHintMessage = function(a, b, f, g) {
...
CTATTutorMessageBuilder.prototype.createStateGraphMessage = function(a, b, f, g, d, c, e) {
  ...
  a += "<suppressStudentFeedback>" + g + "</suppressStudentFeedback>";
...
CTATTutorMessageBuilder.prototype.createHighlightWidgetMessage = function(a, b, f, g) {
...
CTATLMS.init.TutorShop = function() {
  ...
  CTATLMS.getProblemState = function(a) {
    CTATConfiguration.get("restoreProblemUrl") ? $.get(CTATConfiguration.get("restoreProblemUrl"), "", null, "text").done(function(b) {
      ...
      a(null);
      b = (new CTATTutorMessageBuilder).createErrorMessage("Load ProblemState Error", f + " " + g);
...
var CTATCommShell = function() {
  ...
  var a = null, b = this, f = null, g = null, d = {}, c = null, e = null, h = null, l = null, k = [], g = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  ...
  this.processComponentAction = function(a, c, e, d) {
    ...
    var g = "", g = !1 !== c ? d.createInterfaceActionMessage(e, a) : d.createUntutoredActionMessage(e, a);
  ...
  this.processCorrectAction = function(a) {
    ...
    if (d[e] && null != c) {
      ...
      var g = CTATShellTools.findComponent(e);
      if (null != g) {
        for (ctatdebug("Processing " + g.length + " components ..."), e = 0;e < g.length;e++) {
          ctatdebug("Check " + g[e].getName()), g[e] ? g[e].setCorrect && g[e].setCorrect(a) : b.ctatdebug("Internal error, component pointer is null");
        }
      } else {
    ...
    if (d[e] && null != c) {
      ...
      if (null != g) {
        for (e = 0;e < g.length;e++) {
          ctatdebug("Calling setIncorrect on component (" + g[e].getClassName() + ")..."), g[e].setIncorrect && g[e].setIncorrect(a);
        }
      } else {
        b.ctatdebug("Error: component is null for selection " + e);
      }
  ...
  this.processAssociatedRules = function(a, c, e) {
    ...
    if (0 == commMessageHandler.getInStartState()) {
      logHintSAI = a.getSAI();
      var d = "", g = new CTATActionEvaluationData("");
      b.ctatdebug("Found tutor advice: " + e);
      "Hint" == c || "HintWindow" == c ? (ctatdebug("Preparing log message to indicate a hint response", "commShell"), g.setCurrentHintNumber(hintIndex + 1), g.setTotalHintsAvailable(hints.length), g.setEvaluation("HINT"), d = "HINT_MSG", hints[hintIndex] && (e = hints[hintIndex])) : ("Correct" == a.getIndicator() ? g.setEvaluation("CORRECT") : g.setEvaluation("INCORRECT"), d = "RESULT");
      ...
      null != commLoggingLibrary ? 0 == inStartState && 0 == inProcessStartStateActions && commLoggingLibrary.logTutorResponse(a.getTransactionID(), logHintSAI, d, "", g, e, h, c, f) : this.ctatdebug("Info: no logging library available!");
  ...
  this.processTutoringServiceAlert = function(a) {
    ...
    for (var c = "", e = 0;e < a.length;e++) {
      var d = a[e];
      "ErrorType" == g.getElementName(d) && g.getNodeTextValue(d);
      "Details" == g.getElementName(d) && (c = g.getNodeTextValue(d));
    }
  ...
  this.processTutoringServiceError = function(a) {
    ...
    for (var c = "", e = "", d = 0;d < a.length;d++) {
      var f = a[d];
      "ErrorType" == g.getElementName(f) && (c = g.getNodeTextValue(f));
      "Details" == g.getElementName(f) && (e = g.getNodeTextValue(f));
    }
    CTATScrim.scrim.scrimDown();
  ...
  this.processProblemSummaryResponse = function(a) {
    ...
    if (null != h) {
      var c = a.getXMLObject(), e = c.getElementsByTagName("ProblemSummary"), d = c.getElementsByTagName("cmi.core.lesson_status"), g = c.getElementsByTagName("cmi.core.score.raw");
...
var CTATProblem = function() {
  ...
  var a = "", b = "", f = "tutor", g = "", d = "", c = "notstarted";
  ...
  this.init = function(d) {
    ...
    if (null == d) {
      ...
      for (var c = 0;c < d.length;c++) {
        var e = d[c], g = b.getElementName(e);
        ...
        if ("Problems" == g) {
          ...
          for (var e = b.getElementChildren(e), l = 0;l < e.length;l++) {
            var k = e[l];
            a.ctatdebug("Problem [" + l + "] desc: " + b.getElementAttr(k, "description") + ", interface: " + b.getElementAttr(k, "student_interface") + ", brd: " + b.getElementAttr(k, "problem_file"));
            var p = new CTATProblem;
            p.setName(b.getElementAttr(k, "name"));
            p.setLabel(b.getElementAttr(k, "label"));
            p.setDescription(b.getElementAttr(k, "description"));
            p.setTutorFlag(b.getElementAttr(k, "tutor_flag"));
            p.setProblemFile(b.getElementAttr(k, "problem_file"));
            p.setStudentInterface(b.getElementAttr(k, "student_interface"));
            a.ctatdebug("Adding problem ...");
            f.push(p);
          }
        }
        "ProblemSets" == g && a.ctatdebug("Processing ProblemSets ...");
        "Assets" == g && a.ctatdebug("Processing Assets ...");
      }
    }
  };
...
var CTATScrollPaneComponent = function(a, b, f, g, d) {
  CTAT.Component.Base.Tutorable.call(this, "CTATScrollPaneComponent", "__undefined__", a, b, f, g, d);
  var c = 0, e = this;
  e.isTabIndexable = !1;
      ...
      if ("TargetMovieClip" == a) {
        ...
        if (null !== c) {
          if (e.ctatdebug("Found target movieclip, temporarily removing ..."), null !== c.getDivWrapper().parentNode) {
            ...
            b++;
            var g = c.getDivWrapper().style.left, f = c.getDivWrapper().style.top;
            c.getDivWrapper().style.left = "0px";
            c.getDivWrapper().style.top = "0px";
            e.ctatdebug("Moving canvas from: " + g + "," + f + " to: 0,0");
...
var CTATHintButton = function(a, b, f, g, d) {
  CTAT.Component.Base.Clickable.call(this, "hint", "CTATHintButton", a, b, f, g, d);
  this.setName("hint");
...
var CTATButton = function(a, b, f, g, d) {
  CTATButtonBasedComponent.call(this, "CTATButton", "aButton", a, b, f, g, d);
  var c = this, e = null;
  this.init = function() {
    ...
    c.addSafeEventListener("mousedown", c.processBaseMousedown);
    c.addSafeEventListener("mouseup", c.processBaseMouseup);
    c.addSafeEventListener("mouseover", c.processBaseMouseover);
    c.addSafeEventListener("mouseout", c.processBaseMouseout);
    c.getImagesFromDiv();
  };
  this.render = function() {
  };
...
var CTATSequencer = function() {
  ...
  var a = this, b = new CTATPackage, f = new CTATXML, g = null, d = "sequential", c = null;
  ...
  this.init = function(b, d) {
    a.ctatdebug("init ()");
    c = d;
    g = new CTATCommLibrary(null, !1);
    g.retrieveXMLFile(b, f, this);
  };
...
var CTATComboBox = function(a, b, f, g, d) {
  CTAT.Component.Base.Clickable.call(this, "CTATComboBox", "__undefined__", a, b, f, g, d);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var c = this, e = null;
  ...
  this.init = function() {
    ...
    k && e.setAttribute("size", k);
    var a = this.getDivWrap().innerHTML;
    this.getDivWrap().innerHTML = "";
    a ? e.innerHTML = a : this.addLabels(l, h);
    c.assignEnabled(!0);
...
CTAT.Component.Base.SVG = function(a, b, f, g, d, c, e) {
  CTAT.Component.Base.Clickable.call(this, a, b, f, g, d, c, e);
  var h = null;
...
CTAT.Math.Fraction.prototype = Object.create(CTAT.Math.Fraction.prototype, {numerator:{get:function() {
  ...
  if (1 == this.denominator) {
    ...
    var f = document.createElementNS("http://www.w3.org/1998/Math/MathML", "mfrac"), g = document.createElementNS("http://www.w3.org/1998/Math/MathML", "mrow");
    g.appendChild(b);
    f.appendChild(g);
    b = document.createElementNS("http://www.w3.org/1998/Math/MathML", "mrow");
    g = document.createElementNS("http://www.w3.org/1998/Math/MathML", "mn");
    g.textContent = this.denominator;
    b.appendChild(g);
    f.appendChild(b);
    a.appendChild(f);
  }
...
CTAT.Component.Base.UnitDisplay = function(a, b, f, g, d, c, e) {
  CTAT.Component.Base.SVG.call(this, a, b, f, g, d, c, e);
  var h = "1/2+1/4+(0*1/8)";
  this.setActionInput("SetPieces", h);
  var l = "#FF00FF", k = 1, p = "#FF00FF", n = .2, m = "black", u = 1;
  ...
  this.set_denominator = function(a) {
    ...
    if (!isNaN(b) && (b = D(b), this.get_denominator() != a)) {
      ...
      a = [];
      c.set_denominator(b);
      for (var e = new CTAT.Math.Fraction(1, b), d = Math.floor(c.numerator), g = b - d, f = 0;f < d;f++) {
        a.push(C(e, !0));
      }
      b = new CTAT.Math.Fraction(c.numerator - d, b);
      b.equals(0) || (a.push(C(b, !0)), a.push(C(e.subtract(b), !1)), g--);
      for (b = 0;b < g;b++) {
        a.push(C(e, !1));
      }
  ...
  this.get_denominator = function() {
    return r.reduce(function(a, b, c, e) {
...
try {
  ...
  if (console.log("WARNING: new DOMPoint():", a, typeof a), a instanceof ReferenceError || a instanceof TypeError) {
    console.log("   Using shim!"), DOMPoint = function(b, f, g, d) {
      ...
      if (b instanceof DOMPoint) {
        ...
        this.x = b || 0, this.y = f || 0, this.z = g || 0, this.w = d || 1;
      }
    };
  }
}
...
CTAT.Geom.Point.equals = function(a, b) {
  var f = !0, g;
  for (g in a) {
    if (g in b ? "w" != g && (f &= a[g] / a.w == b[g] / b.w) : f = !1, !f) {
      break;
    }
  }
  return f;
...
CTAT.Geom.Point.scale = function(a, b) {
  ...
  var f = new DOMPoint(a), g;
  for (g in f) {
    "w" != g && (f[g] = CTAT.Math.round(a[g] * b));
  }
  return f;
};
...
CTAT.Geom.Point.circle_intersection = function(a, b, f, g) {
...
var CTATPieChart = function(a, b, f, g, d) {
  CTAT.Component.Base.UnitDisplay.call(this, "CTATPieChart", "aPieChart", a, b, f, g, d);
  var c = 3, e = 3, h = this, l, k, p, n = null, m = CTATGlobals.NameSpace.svg;
  this.init = function() {
    this.initSVG();
    ...
    l = document.createElementNS(m, "filter");
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      var a = window.getComputedStyle(this.getComponent()), a = parseFloat(a.getPropertyValue("stroke-width")), b = this.getBoundingBox(), d = Math.min(b.width / 2, b.height / 2) - (a + e + 4), g = new DOMPoint(b.width / 2, b.height / 2), a = this.parseValue(), f = document.createDocumentFragment();
      a.reduce(function(a, b, e, l) {
        if (1 <= b.valueOf()) {
          e = document.createElementNS(m, "circle"), e.classList.add("CTAT-pie-chart--piece"), e.cx.baseVal.value = g.x, e.cy.baseVal.value = g.y, e.r.baseVal.value = d, this.addPieceElem(e, b, b.selected), f.appendChild(e);
        } else {
          ...
          l = g.add(CTAT.Geom.Point.polar(d, k));
          b.reduce();
          var p = g.add(CTAT.Geom.Point.polar(d, 2 * Math.PI * b.valueOf() + k)), u = g.clone();
          if (0 < c && c < d) {
            k = CTAT.Geom.Point.polar(c, k + Math.PI * b.valueOf());
            u = u.add(k);
            l = l.add(k);
            var n = function(a, b, c) {
              return a.distance(b) < a.distance(c) ? b : c;
            };
            l = CTAT.Geom.Point.circle_intersection(u, l, g, d).reduce(n.bind(this, l));
            p = p.add(k);
            p = CTAT.Geom.Point.circle_intersection(u, p, g, d).reduce(n.bind(this, p));
          }
          k = CTAT.Geom.Point.to2DString;
          u = "M " + k(u);
          n = new DOMPoint(d, d);
          u += " L " + k(l);
          u += " A " + k(n) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + k(p);
          e.setAttributeNS(null, "d", u + " Z");
...
var CTATSubmitButton = function(a, b, f, g, d) {
  CTATButton.call(this, a, b, f, g, d);
...
var CTATGroupingComponent = function(a, b, f, g, d) {
  CTAT.Component.Base.Tutorable.call(this, "CTATGroupingComponent", "__undefined__", a, b, f, g, d);
  var c = this;
  c.isTabIndexable = !1;
  var e = null;
  this.init = function() {
...
var CTATSkillWindow = function(a, b, f, g, d) {
  CTAT.Component.Base.Graphical.call(this, "CTATSkillWindow", "__undefined__", a, b, f, g, d);
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), e = 0;e < a.length;e++) {
            ...
            var f = document.createElement("div"), r = d.getLevel();
            .95 > r ? f.classList.add("CTAT-skill-window--bar--nonmastered") : f.classList.add("CTAT-skill-window--bar--mastery");
            f.style.width = .95 < r ? "100%" : 100 * r + "%";
            g.appendChild(f);
            b.appendChild(g);
            g = document.createElement("div");
            g.textContent = d.getDisplayName() || "no-name";
...
var CTATDoneButton = function(a, b, f, g, d) {
  CTAT.Component.Base.Clickable.call(this, "done", "CTATDoneButton", a, b, f, g, d);
  this.setName("done");
...
var CTATPlayButton = function() {
  ...
  var g = null, d = null, c = null, e = null, h = null;
  (function() {
    ...
    if ("disabled" != g && ("auto" != g || 0 != d)) {
      if (null != CTATGlobals.selectedTextInput) {
        ...
        if (this.ctatdebug("Attempting to call AS3 method ..."), e = getSafeElementById(a), null != e) {
          try {
            f += b, this.ctatdebug(f), e.processExternalKeyboard(f), this.ctatdebug("Successfully called AS3 method");
          } catch (h) {
...
function processTextFocus(a, b, f, g, d) {
  mobileAPI.processTextFocus(a, b, f, g, d);
}
function processFocusOut() {
  closeK();
}
;var CTATMovieClip = function(a, b, f, g, d) {
...
var CTATTextBasedComponent = function(a, b, f, g, d, c, e) {
  CTAT.Component.Base.Tutorable.call(this, a, b, f, g, d, c, e);
  var h = this, l = "", k = !0, p = 255, n = !0;
...
var CTATTextArea = function(a, b, f, g, d) {
  CTATTextBasedComponent.call(this, "CTATTextArea", "__undefined__", a, b, f, g, d);
  this.setDefaultWidth(100);
...
var CTATTable = function(a, b, f, g, d) {
  CTAT.Component.Base.Graphical.call(this, "CTATTable", "__undefined__", a, b, f, g, d);
  var c = this;
  c.isTabIndexable = !1;
  var e = null, h = !1;
  ...
  this.adjustTableContents = function() {
    ...
    for (var a = e.createTBody(), g = b;g < l;g++) {
    ...
    for (a = 0;a < e.rows.length;a++) {
      for (b = e.rows[a], d = 0;d < b.cells.length;d++) {
        var k = b.cells[d], x = c.getName() + ".R" + a + "C" + d;
        CTATShellTools.findComponent(x).forEach(function(a) {
          ...
          a = a.getDivWrap();
          null != a ? (a.parentNode.removeChild(a), a.style.position = null, a.style.top = null, a.style.left = null, k.appendChild(a)) : c.ctatdebug("Error: unable to get div wrapper from component");
        });
      }
    }
  };
...
;var CTATAudioButton = function(a, b, f, g, d) {
  CTATButtonBasedComponent.call(this, "CTATAudioButton", "audiobutton", a, b, f, g, d);
  var c = this;
...
var CTATVideo = function(a, b, f, g, d) {
  CTAT.Component.Base.Tutorable.call(this, "CTATVideo", "__undefined__", a, b, f, g, d);
...
var CTATNumericStepper = function(a, b, f, g, d) {
  CTAT.Component.Base.Tutorable.call(this, "CTATNumericStepper", "__undefined__", a, b, f, g, d);
...
var CTATHintWindow = function(a, b, f, g, d) {
  CTAT.Component.Base.Graphical.call(this, "CTATHintWindow", "__undefined__", a, b, f, g, d);
  this.setDefaultWidth(240);
  this.setDefaultHeight(140);
  var c = this;
  c.isTabIndexable = !1;
  var e = null, h = null, l = null, k = null, p = CTATGlobals.languageManager.getString("NEXT"), n = CTATGlobals.languageManager.getString("PREVIOUS"), m = null;
  ...
  this.init = function() {
    ...
    if (u) {
      ...
      if (r) {
        ...
        h = document.createElement("button"), h.classList.add("CTAT-hint-window--previous"), b = document.createElement("span"), b.classList.add("CTAT-hint-window--button-icon"), b.textContent = "\u25c0", h.appendChild(b), n && (b.style.cssFloat = "left", h.appendChild(document.createTextNode(n)));
      }
    }
    h.addEventListener("click", function(a) {
    ...
    a.appendChild(h);
    m ? (l = document.createElement("button"), l.classList.add("CTAT-hint-window--next"), l.innerHTML = m) : r ? (l = document.createElementNS(CTATGlobals.NameSpace.svg, "svg"), l.classList.add("CTAT-hint-window--next"), l.setAttributeNS(null, "viewBox", "0 0 82 20"), b = document.createElementNS(CTATGlobals.NameSpace.svg, "path"), b.style.fill = "none", b.style.strokeWidth = "3px", b.style.strokeLinecap = "round", b.setAttributeNS(null, "d", "M75 10 h-12 M75 10 m-4 -4 l4 4 -4 4"), b.setAttributeNS(null, 
    "pointer-events", "none"), l.appendChild(b), p && (b = document.createElementNS(CTATGlobals.NameSpace.svg, "text"), b.setAttributeNS(null, "pointer-events", "none"), b.textContent = p, b.setAttributeNS(null, "text-anchor", "middle"), b.setAttributeNS(null, "x", "34px"), b.setAttributeNS(null, "dominant-baseline", "middle"), b.setAttributeNS(null, "y", "50%"), l.appendChild(b))) : (l = document.createElement("button"), l.classList.add("CTAT-hint-window--next"), b = document.createElement("span"), 
    b.style.fontWeight = "bold", b.classList.add("CTAT-hint-window--button-icon"), b.textContent = "\u25b6", p && (b.style.cssFloat = "right", l.appendChild(document.createTextNode(p))), l.appendChild(b));
...
var CTATControllerButton = function(a, b, f, g, d) {
  CTATButton.call(this, a, b, f, g, d);
...
var CTATTextInput = function(a, b, f, g, d) {
  CTATTextBasedComponent.call(this, "CTATTextInput", "__undefined__", a, b, f, g, d);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var c = this, e = null, h = null;
  this.ctatdebug(this.getClassName() + " (" + this.getX() + "," + this.getY() + "," + this.getWidth() + "," + this.getHeight() + ")");
...
var CTATDragNDrop = function() {
  ...
  var a = function(a) {
    ...
    var e = a(this.id);
    CTATDragNDrop.dragging[e] = {id:this.id, group:d, source:c};
      ...
      if ($(this).data("CTATComponent").getEnabled()) {
        ...
        if ((isNaN(d) || 0 > d || $(this).children().length < d) && (new Set(a.dataTransfer.types)).has("ctat/group")) {
          if (a.dataTransfer.getData("text")) {
            ...
            for (var g, d = 0;d < a.dataTransfer.types.length;d++) {
              if (g = /^ctat\/id\/(.+)$/.exec(a.dataTransfer.types[d])) {
                g = g[1], CTATDragNDrop.dragging.hasOwnProperty(g) && CTATDragNDrop.dragging[g].group === $(this).attr("name") && CTATDragNDrop.dragging[g].source !== this.id && (b = !0);
              }
            }
          }
        }
...
try {
  ...
  if (console.log("WARNING: new DOMRect():", a, typeof a), a instanceof ReferenceError || a instanceof TypeError) {
    console.log("    Using shim!"), DOMRect = function(b, f, g, d) {
      this.x = b || 0;
      this.y = f || 0;
      this.width = g || 0;
      this.height = d || 0;
...
CTAT.Geom.Rectangle.contains = function(a, b, f) {
  var g = CTAT.Geom.Rectangle.contains;
  if (b instanceof DOMRect) {
    return g(a, b.left, b.top) & g(a, b.right, b.bottom);
  }
  if (b instanceof DOMPoint) {
    var d = !0;
    if (f instanceof DOMPoint) {
      d = g(a, f.x / f.w, f.y / f.w);
    } else {
      if ("number" == typeof f) {
        return g(a, b.x - f, b.y - f) & g(a, b.x + f, b.y + f);
      }
    }
    return d & g(a, b.x, b.y);
  }
...
CTAT.Geom.Rectangle.setTo = function(a, b, f, g, d) {
  a.x = b;
  a.y = f;
  a.width = g;
  a.height = d;
...
var CTATNumberLine = function(a, b, f, g, d) {
  CTAT.Component.Base.SVG.call(this, "CTATNumberLine", "aNumberLine", a, b, f, g, d);
  var c = CTAT.Math.Fraction, e = CTATGlobals.NameSpace.svg;
  a = function(a, b, d, g, f) {
    this.numberline = a;
    this.step = new c(b);
    this.size = d;
    this.origin = new c(0);
  ...
  var k = new a(this, new c(0), 25, "CTAT-number-line--denominator-tickmark", "CTAT-number-line--denominator-tickmark-label");
  ...
  this.setParameterHandler("DenominatorTickmarkStep", function(a) {
    k.setStep((new c(a)).reciprocal());
  });
  this.data_ctat_handlers.denominator = function(a) {
    a = new c(a);
    k.setStep(a.reciprocal());
  };
  ...
  this.genTickmark = function(a, b, c) {
    ...
    if (!this._tickmarks.some(function(b) {
      ...
      var g = document.createElementNS(e, "line"), f = this.X_Axis.getPosition(a), h = CTAT.Geom.Point.polar(c / 2, this.theta + Math.PI / 2).add(f);
      c = CTAT.Geom.Point.polar(-c / 2, this.theta + Math.PI / 2).add(f);
      g.setAttributeNS(null, "x1", h.x);
      g.setAttributeNS(null, "y1", h.y);
      g.setAttributeNS(null, "x2", c.x);
      g.setAttributeNS(null, "y2", c.y);
      g.setAttributeNS(null, "data-value", a.toString());
      g.data = a;
      g.location = f;
      g.label = null;
      this._tickmarks.push(g);
      d.appendChild(g);
      if ("" !== b) {
        ...
        if (null === b || void 0 === b) {
          if (1 == a.denominator) {
            ...
            k.setAttributeNS(null, "x", c.x);
            k.setAttributeNS(null, "y", c.y);
  ...
  var u = function() {
    if (null !== this.X_Axis && null !== this.X_Axis.svg_group) {
      ...
      for (c = 0;c < b.length;c++) {
        a = b[c], d = this.X_Axis.getPosition(a.value), g = new DOMPoint(a.cx.baseVal.value, a.cy.baseVal.value), 1 < d.distance(g) && (a.cx.baseVal.value = d.x, a.cy.baseVal.value = d.y);
      }
    }
  ...
  this.init = function() {
    ...
    this.component.addEventListener("mouseenter", function() {
      !0 === a() && 0 < p && (t = !0, w.style.visibility = null, r = requestAnimationFrame(F));
    });
  ...
  var D = -1 < navigator.userAgent.toLowerCase().indexOf("firefox"), z = function(a, b) {
    ...
    for (var c = y(a, b), e = null, d = Number.POSITIVE_INFINITY, g, f, h = 0;h < this._tickmarks.length;h++) {
      g = this._tickmarks[h], f = c.distance(g.location), f < d && (e = g, d = f);
    }
    return e;
  ...
  this.set_denominator = function(a) {
    0 === parseInt(a) ? k.setStep(0) : k.setStep((new c(a)).reciprocal());
    this.render();
  };
  a = function(a, b) {
  ...
  this.change_denominator = function(a) {
    a = new c(a);
    0 !== a.valueOf() && (a = a.add(k.step.denominator), k.setStep(a.reciprocal()));
  };
...
function tableCreate() {
  ...
  for (var f = 0;3 > f;f++) {
    for (var g = b.insertRow(), d = 0;2 > d && (2 != f || 1 != d);d++) {
      var c = g.insertCell();
...
;var CTATFractionBar = function(a, b, f, g, d) {
  CTAT.Component.Base.UnitDisplay.call(this, "CTATFractionBar", "aFractionBar", a, b, f, g, d);
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      for (var a = this.parseValue(), b = 0, d = document.createDocumentFragment(), g = 0;g < a.length;g++) {
        var f = a[g], n = 100 * f, m = document.createElementNS(c, "rect");
      ...
      Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a) {
        if ("rect" == a.nodeName) {
          ...
          1 > b.x ? e -= c / 2 : (d += c / 2, e = b.x + b.width >= u ? e - c / 2 : e - c);
...
var CTATTextField = function(a, b, f, g, d) {
  CTATTextBasedComponent.call(this, "CTATTextBasedComponent", "__undefined__", a, b, f, g, d);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var c = this, e = null;
  this.setAction("UpdateTextArea");
...
var CTATCheckBox = function(a, b, f, g, d) {
  CTAT.Component.Base.Clickable.call(this, "CTATCheckBox", "__undefined__", a, b, f, g, d);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var c = null, e = null, h = null, l = "top";
  ...
  this.init = function() {
    ...
    this.getText() ? c.value = k.getText() : this.getDivWrap() && this.getDivWrap().textContent ? c.value = this.getDivWrap().textContent : c.value = c.id;
    this.getComponentGroup() ? c.name = k.getComponentGroup() : this.getDivWrap() && $(this.getDivWrap()).attr("name") ? c.name = $(this.getDivWrap()).attr("name") : c.name = "checkBoxGroup";
    k.assignEnabled(!0);
    !0 === k.getEnabled() ? c.disabled = !1 : c.disabled = !0;
    k.ctatdebug("Final location: " + k.getX() + "," + k.getY() + " with text: " + k.getText());
    k.addComponentReference(k, c);
    var a = this.getDivWrap().innerHTML;
    this.getDivWrap().innerHTML = "";
    ...
    c.addEventListener("focus", k.processFocus);
  ...
  for (var a in CTAT.ComponentRegistry) {
    ...
    $("." + a).each(function() {
      ...
      if (0 == a.isFeedbackComponent()) {
        var g = new CTATComponentDescription;
        g.type = a.getClassName();
        g.name = a.getName();
        g.setComponentPointer(a);
        CTATShellTools.registerComponentDescription(g);
      }
...
CTATTutor.createStaticInterface = function(a, b, f) {
  ...
  for (a = 0;a < b.length;a++) {
    ...
    var e, h, l, k;
    "shape" == this.parser.getElementName(d) && (e = this.parser.getElementAttr(d, "x"), h = this.parser.getElementAttr(d, "y"), l = this.parser.getElementAttr(d, "width"), k = this.parser.getElementAttr(d, "height"), c = this.parser.getElementAttr(d, "instance"), ctatdebug("Creating shape: " + c + " at: " + e + "," + h + "," + l + "," + k), l = "data:image/png;base64, " + this.parser.getNodeTextValue(d), k = new Image, k.setAttribute("style", "position: absolute; top: " + h + "px; left:" + e + "px; z-index:" + 
    CTATGlobalFunctions.gensym.z_index() + ";"), k.setAttribute("id", c), k.setAttribute("src", l), g.appendChild(k));
    "statictext" == this.parser.getElementName(d) && (e = this.parser.getElementAttr(d, "x"), h = this.parser.getElementAttr(d, "y"), l = this.parser.getElementAttr(d, "width"), k = this.parser.getElementAttr(d, "height"), c = this.parser.getElementAttr(d, "instance"), ctatdebug("Creating static text: " + c + " at: " + e + "," + h + "," + l + "," + k), l = "data:image/png;base64, " + this.parser.getNodeTextValue(d), k = new Image, k.setAttribute("style", "position: absolute; top: " + h + "px; left:" + 
    e + "px; z-index:" + CTATGlobalFunctions.gensym.z_index() + ";"), k.setAttribute("id", c), k.setAttribute("src", l), g.appendChild(k));
    "statictext" == this.parser.getElementName(d) && (c = this.parser.getElementAttr("instance"), ctatdebug("Creating movieclip: " + c), e = this.parser.getElementAttr(d, "x"), h = this.parser.getElementAttr(d, "y"), l = this.parser.getElementAttr(d, "width"), k = this.parser.getElementAttr(d, "height"), e = new CTATMovieClip(c, e, h, l, k), h = e.wrapComponent(g), ctatdebug("Created movieclip: " + c + " at: " + e.x + "," + e.y + "," + e.width + "," + e.height), movieclips.push(e), d = this.parser.getElementChildren(d), 
    this.createStaticInterface(h, d, e));
  }
};
CTATTutor.runTutor = function(a) {
  ctatdebug("runTutor ()");
  !0 === CTATGlobals.tutorRunning ? ctatdebug("The tutor is already running") : (null == skillSet && (skillSet = new CTATSkillSet), window.onerror = function(a, f, g) {
    var d = new CTATHTMLManager;
    ctatdebug(d.htmlEncode(a) + " in " + f + ", line " + g);
  }, centerTutorContainer(), CTATTutor.initialize(), CTATGlobals.tutorRunning = !0, ctatdebug("runTutor () ... all set"));
};
CTATTutor.initTutor = function(a, b, f, g) {
  console.trace("initTutor() #aFlashVars " + (a ? a.length : null) + ", usingFlash " + g);
  ctatdebug("initTutor() #aFlashVars " + (a ? a.length : null) + ", usingFlash " + g);
  1 == CTATTutor.tutorInitialized ? console.log("Tutor already initialized, probably in author mode") : (CTATConfiguration.generateDefaultConfigurationObject(), CTATConfiguration.setParams(a), null == g && (g = CTATConfiguration.getSingleParameterValues(["student_interface", "swf_name"]).some(function(a) {
  ...
  {jnlp_href:"/ctat_applet/TSApplet.jnlp"}, "1.6"), g || CTATTutor.runTutor(a), CTATTutor.tutorInitialized = !0);
};
...
function centerTutorContainer() {
  ...
  if (null == a) {
    ...
    var b = null;
    if (flashVars) {
      var b = flashVars.getRawFlashVars(), f = "550", g = "450", f = a.offsetWidth, g = a.offsetHeight;
      b && b.width && b.height && (ctatdebug("We have raw width and height variables in our flashvars: " + b.width + "," + b.height), f = b.width, g = b.height);
      b.centerTutor ? 1 == b.centerTutor && (ctatdebug("Moving tutor over by: " + ("-" + Number(f / 2) + "px 0 0 -" + Number(g / 2) + "px;")), a.style.position = "absolute", a.style.top = "0", a.style.left = "0", a.style.right = "0", a.style.bottom = "0", a.style.margin = "auto") : ctatdebug("The tutor is not configured to center the container, bump");
    } else {
...
function checkTutorCanvas() {
  ...
  var a = getSafeElementById(ctatcontainer), b = getSafeElementById("main-canvas"), f = flashVars.getRawFlashVars(), g = "550", d = "450";
  a && (ctatdebug("Recording the actual CSS width and height: " + a.offsetWidth + " , " + a.offsetHeight), g = a.offsetWidth, d = a.offsetHeight);
  f && f.width && f.height && (ctatdebug("We have tutor size flashvars, using those instead: " + f.width + " , " + f.height), g = f.width, d = f.height);
...
Math.imul || (Math.imul = function(a, b) {
  var f = a & 65535, g = b & 65535;
  return f * g + ((a >>> 16 & 65535) * g + f * (b >>> 16 & 65535) << 16 >>> 0) | 0;
});
...
Array.prototype.every || (Array.prototype.every = function(a, b) {
  ...
  for (g = 0;g < c;) {
    var e;
    if (g in d && (e = d[g], !a.call(f, e, g, d))) {
      return !1;
    }
    g++;
  }
...
Array.prototype.some || (Array.prototype.some = function(a) {
  ...
  for (var g = 2 <= arguments.length ? arguments[1] : void 0, d = 0;d < f;d++) {
    if (d in b && a.call(g, b[d], d, b)) {
      return !0;
    }
  }
  return !1;
...
Array.prototype.filter || (Array.prototype.filter = function(a) {
  ...
  for (var g = [], d = 2 <= arguments.length ? arguments[1] : void 0, c = 0;c < f;c++) {
    if (c in b) {
      var e = b[c];
      a.call(d, e, c, b) && g.push(e);
    }
  }
  return g;
});
...
Array.prototype.map || (Array.prototype.map = function(a, b) {
  ...
  for (d = 0;d < e;) {
    var h;
    d in c && (h = c[d], h = a.call(f, h, d, c), g[d] = h);
    d++;
  }
  return g;
});
Array.prototype.reduce || (Array.prototype.reduce = function(a) {
  ...
  var b = Object(this), f = b.length >>> 0, g = 0, d;
...
Array.prototype.reduceRight || (Array.prototype.reduceRight = function(a) {
  ...
  var b = Object(this), f = (b.length >>> 0) - 1, g;
  if (2 <= arguments.length) {
    g = arguments[1];
  } else {
    for (;0 <= f && !f in b;) {
...
Array.from || (Array.from = function() {
  ...
  return function(a) {
    ...
    for (var l = b(this) ? Object(new this(h)) : Array(h), k = 0, p;k < h;) {
      p = d[k], l[k] = c ? "undefined" === typeof e ? c(p, k) : c.call(e, p, k) : p, k += 1;
    }
    l.length = h;
    return l;
  };
...
Array.prototype.copyWithin || (Array.prototype.copyWithin = function(a, b, f) {
  ...
  for (;0 < d;) {
    b in g ? g[a] = g[b] : delete g[a], b += f, a += f, d--;
  }
  return g;
});
...
Array.prototype.find || (Array.prototype.find = function(a, b) {
  ...
  for (var f = Object(this), g = f.length >>> 0, d, c = 0;c < g;c++) {
...
Array.prototype.includes || (Array.prototype.includes = function(a, b) {
  var f = Object(this), g = parseInt(f.length) || 0;
  if (0 === g) {
    return !1;
  }
  var d = parseInt(b) || 0;
...
String.fromCodePoint || function() {
  var a = function() {
    try {
      var a = {}, b = Object.defineProperty, e = b(a, a, a) && b;
    } catch (g) {
    }
    return e;
  }(), b = String.fromCharCode, f = Math.floor, g = function() {
    var a = [], c, e, g = -1, l = arguments.length;
    if (!l) {
      return "";
    }
    for (var k = "";++g < l;) {
      e = Number(arguments[g]);
      if (!isFinite(e) || 0 > e || 1114111 < e || f(e) != e) {
        throw RangeError("Invalid code point: " + e);
      }
      65535 >= e ? a.push(e) : (e -= 65536, c = (e >> 10) + 55296, e = e % 1024 + 56320, a.push(c, e));
      if (g + 1 == l || 16384 < a.length) {
        k += b.apply(null, a), a.length = 0;
      }
    }
    return k;
  };
  a ? a(String, "fromCodePoint", {value:g, configurable:!0, writable:!0}) : String.fromCodePoint = g;
}();
String.prototype.codePointAt || function() {
  var a = function(a) {
    ...
    var f = String(this), g = f.length, d = a ? Number(a) : 0;
    d != d && (d = 0);
    if (!(0 > d || d >= g)) {
      return a = f.charCodeAt(d), 55296 <= a && 56319 >= a && g > d + 1 && (f = f.charCodeAt(d + 1), 56320 <= f && 57343 >= f) ? 1024 * (a - 55296) + f - 56320 + 65536 : a;
    }
  };
...
(function(a) {
  ...
  var g = /[^s]/, d = /[def]/, c = /^[^\x25]+/, e = /^\x25{2}/, h = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/, l = /^([a-z_][a-z_\d]*)/i, k = /^\.([a-z_][a-z_\d]*)/i, p = /^\[(\d+)\]/, n = /^[\+\-]/;
  b.format = function(a, c) {
    var e = 1, h = a.length, k = "", l = [], m, p, D, z, y = !0, q = "";
    for (m = 0;m < h;m++) {
      if (k = f(a[m]), "string" === k) {
        l[l.length] = a[m];
      } else {
        if ("array" === k) {
          ...
          "function" == f(k) && (k = k());
          if (g.test(D[8]) && "number" != f(k) && isNaN(k)) {
...
CTATMsgType.findProperty = function(a, b) {
  var f = a.toLowerCase(), g = "<" + b.toLowerCase() + ">", d = f.indexOf(g) + g.length, f = f.indexOf("</" + b.toLowerCase() + ">");
  if (d < g.length || 0 > f) {
    return null;
  }
  g = {};
...
CTATMsgType.makeValues = function(a) {
  ...
  if (a.constructor && "Array" == a.constructor.name) {
    ...
    for (var b = 0, f, g = "<value>" + (null == (f = a[b++]) ? "" : f.toString());b < a.length;) {
      g += "</value><value>" + (null == (f = a[b++]) ? "" : f.toString());
    }
    return g + "</value>";
  }
...
CTATMsgType.setProperty = function(a, b, f) {
  var g = CTATMsgType.findProperty(a, b), d = "";
  g ? (d = a.slice(0, g.start), d += CTATMsgType.makeValues(f), d += a.slice(g.end, a.length)) : (g = a.indexOf("</properties>"), d = a.slice(0, g), d += "<" + b + ">" + CTATMsgType.makeValues(f) + "</" + b + ">", d += a.slice(g, a.length));
  return d;
};
...
CTATMsgType.getSAIArraysFromElement = function(a, b) {
  for (var f = {selection:[], action:[], input:[]}, g = b.getElementChildren(a), d = 0;d < g.length;d++) {
    var c = g[d];
    switch(b.getElementName(c)) {
      case "Selection":
        for (var c = b.getElementChildren(c), e = 0;e < c.length;e++) {
          f.selection.push(b.getNodeTextValue(c[e]));
        }
        break;
      case "Action":
        c = b.getElementChildren(c);
        for (e = 0;e < c.length;e++) {
          f.action.push(b.getNodeTextValue(c[e]));
        }
        break;
      case "Input":
        c = b.getElementChildren(c);
        for (e = 0;e < c.length;e++) {
          f.input.push(b.getNodeTextValue(c[e]));
        }
        break;
      case "properties":
...
ProblemStateSaver.prototype.editForProblemState = function(a) {
  var b = a.split(ProblemStateSaver.XML_PROLOGUE), f = b[0], g;
  ...
  f = b[0];
  for (g = 1;g < b.length;++g) {
    f.endsWith("\n") && (f = f.slice(0, -1)), f.endsWith("\r") && (f = f.slice(0, -1)), f += "<" + b[g];
  }
...
ProblemStateSaver.prototype.forwardToInterface = function(a, b, f) {
  var g = CTATMsgType.getMessageType(a);
  this.ctatdebug("PSS.forwardToInterface(" + g + ") problemState.length " + this.getProblemState().length + ", outputStatus " + f);
...
var ProblemStateRestorer = function(a) {
  ...
  this.retrieveMessages = function(g) {
    console.log("retrieveMessages(" + g + ", ...)");
    g.mustRetrieveProblemState() ? (a.stopWorking(1), CTATLMS.getProblemState(b.process)) : console.log("Retrieval status indicates that we should not retrieve");
  };
  this.process = function(g) {
    if ("string" != typeof g) {
      console.log("ProblemStateRestorer.process() called with parameter not a string: ", typeof g), a.enqueueForRestore([]);
    } else {
      if (g.slice(0, ProblemStateSaver.MESSAGES_TAG.length) != ProblemStateSaver.MESSAGES_TAG) {
        console.log("ProblemStateRestorer.process() called with unrecognized string: ", g.slice(0, 20)), a.enqueueForRestore([]);
      } else {
        var d = [];
        if ("string" == typeof g && (g = g.split(/<\/?messages>/), b.ctatdebug("msgsArr.length " + g.length + ", msgsArr[1].length " + (g[1] ? g[1].length : -1)), !(2 > g.length))) {
          g = g[1].split("<message>");
          b.ctatdebug("problemStateArr.length " + g.length);
          for (var c = 0, e = !1, f = 1;f < g.length;++f) {
            var l = "<message>" + g[f], k = CTATMsgType.getMessageType(l);
            CTATMsgType.STATE_GRAPH == k ? e = !0 : CTATMsgType.START_STATE_END == k ? e = !1 : e ? c++ : (a.getProblemStateSaver().appendToProblemState(l, null, !0), d.push(l));
            b.ctatdebug("problemStateArr[" + f + "] " + (e ? "omit " : "keep ") + k + " omitted " + c + " kept " + d.length);
          }
        }
...
var CTATProblemSummary = function(a, b, f) {
  ...
  var g = Number.MAX_VALUE, d = b, c = f, e = 0, h = new Date, l = {}, k = 0, p = 0, n = 0, m = 0, u = 0, r = 0, w = 0, x = CTATMsgType.CompletionValue[0], t = this;
  ...
  this.addHint = function(a) {
    ...
    var b = l[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNFirstHints() && ++m, b.incrementFirstHints()) : (b = new CTATStep(a, CTATStep.StepResult[2]), l[a] = b, m++);
    p++;
  ...
  this.addCorrect = function(a) {
    ...
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++u, 1 > b.getNFirstHints() && r++), b.incrementNCorrect()) : (t.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), l[a] = b, u++, r++);
    k++;
    b.setLastResult(CTATStep.StepResult[3]);
    t.ctatdebug("exiting addCorrect() correct count " + k + ", trial " + b);
  };
...
var CTATMatcher = function(a, b, f) {
  ...
  var g = new CTATSAI("", "", ""), d = f, c = CTATMsgType.DEFAULT_ACTOR, e = !1, h = this;
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.setParens = function(f, g) {
      var d;
      null == g && (g = !1);
    ...
    a.prototype.compare = function(f, g) {
  ...
  a = function(a) {
    ...
    d.prototype.combineSimilar = function() {
      ...
      this.terms.forEach(function(b) {
        var d, g;
        g = b.constant() ? [null, b] : (b = b.multiplyOne(), [b, b.factors.shift()]);
        return (d = a.find(function(a) {
          var b;
          return null != (b = a[0]) ? b.equals(g[0]) : void 0;
        })) ? d[1] += g[1].evaluate() : a.push([g[0], g[1].evaluate()]);
      });
    ...
    d.prototype.compare = function(a, b) {
      var g;
      return (g = d.__super__.compare.apply(this, arguments)) || this.countVariables() - a.countVariables() || this.terms.some(function(d, f) {
        return g = d.compare(a.terms[f], b);
  ...
  a = function(a) {
    ...
    d.prototype.toString = function() {
      return d.__super__.toString.call(this, this.factors.reduce(function(a) {
        return function(b, d) {
          var g;
          d.setParens(a.operator);
          g = d.inverted() ? (d.invert(), "/") : /^\d/.test(d = d.toString()) && /\d$/.test(b) ? "*" : "";
          return "" + b + g + d;
        };
    ...
    d.prototype.combineSimilar = function() {
      ...
      this.factors.forEach(function(b) {
        ...
        })) ? d[1] += (null != (g = p[1]) ? g.evaluate() : void 0) || 1 : a.push([p[0], (null != (f = p[1]) ? f.evaluate() : void 0) || 1]);
      });
    ...
    d.prototype.distributeFactors = function(a) {
      ...
      a.slice(1).forEach(function(a) {
        ...
        return a.addition() ? 1 === b.length ? b = a.terms.map(function(a) {
          ...
          var g;
          return a.multiplication() ? (g = b[d]).push.apply(g, a.pushNegation().factors.map(function(a) {
            return a.clone();
          })) : b[d].push(a.clone());
        });
      });
    ...
    d.prototype.compare = function(a, b) {
      var g, f;
      return (f = d.__super__.compare.apply(this, arguments)) || this.countVariables() - a.countVariables() || (g = a.factors.slice(0).reverse()) && this.factors.slice(0).reverse().some(function(a, c) {
        return f = a.compare(g[c], b);
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, f = [1, 6], g = [1, 7], d = [1, 10], c = [1, 11], e = [1, 12], h = [1, 13], l = [1, 21], k = [1, 22], p = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], n = [1, 23], m = [1, 24], u = [1, 26], r = [1, 27], w = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], x = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  20:"IDIVIDE", 21:"REM", 23:"EXP", 24:"SQRT", 25:"LPAREN", 26:"RPAREN", 27:"VARIABLE", 28:"NUMBER"}, productions_:[0, [3, 2], [4, 3], [4, 3], [4, 3], [4, 3], [4, 3], [4, 3], [4, 1], [6, 3], [6, 3], [6, 1], [14, 3], [14, 3], [14, 2], [14, 3], [14, 3], [14, 1], [17, 2], [17, 2], [17, 1], [19, 3], [19, 2], [19, 1], [22, 3], [22, 1], [22, 1]], performAction:function(a, b, c, d, g, e, f) {
    b = e.length - 1;
    switch(g) {
      case 1:
        return e[b - 1];
  ...
  }, table:[{3:1, 4:2, 6:3, 13:f, 14:4, 15:g, 17:5, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:l, 15:k}, b(p, [2, 11], {22:9, 19:25, 16:n, 18:m, 20:u, 21:r, 24:d, 25:c, 27:e, 28:h}), b(w, [2, 17]), {13:f, 15:g, 17:28, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, {13:f, 15:g, 17:29, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, b(w, [2, 20]), b(w, [2, 23], {23:[1, 30]}), {13:f, 15:g, 17:31, 19:8, 22:9, 24:d, 25:c, 27:e, 
  28:h}, {6:32, 13:f, 14:4, 15:g, 17:5, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, b(x, [2, 25]), b(x, [2, 26]), {1:[2, 1]}, {6:33, 13:f, 14:4, 15:g, 17:5, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, {6:34, 13:f, 14:4, 15:g, 17:5, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, {6:35, 13:f, 14:4, 15:g, 17:5, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, {6:36, 13:f, 14:4, 15:g, 17:5, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, {6:37, 13:f, 14:4, 15:g, 17:5, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, {6:38, 13:f, 14:4, 15:g, 17:5, 19:8, 22:9, 
  24:d, 25:c, 27:e, 28:h}, {13:f, 14:39, 15:g, 17:5, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, {13:f, 14:40, 15:g, 17:5, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, {13:f, 15:g, 17:41, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, {13:f, 15:g, 17:42, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, b(w, [2, 14]), {13:f, 15:g, 17:43, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, {13:f, 15:g, 17:44, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, b(w, [2, 18]), b(w, [2, 19]), {13:f, 15:g, 17:45, 19:8, 22:9, 24:d, 25:c, 27:e, 28:h}, b(w, [2, 22]), {13:l, 
  15:k, 26:[1, 46]}, {5:[2, 2], 13:l, 15:k}, {5:[2, 3], 13:l, 15:k}, {5:[2, 4], 13:l, 15:k}, {5:[2, 5], 13:l, 15:k}, {5:[2, 6], 13:l, 15:k}, {5:[2, 7], 13:l, 15:k}, b(p, [2, 9], {22:9, 19:25, 16:n, 18:m, 20:u, 21:r, 24:d, 25:c, 27:e, 28:h}), b(p, [2, 10], {22:9, 19:25, 16:n, 18:m, 20:u, 21:r, 24:d, 25:c, 27:e, 28:h}), b(w, [2, 12]), b(w, [2, 13]), b(w, [2, 15]), b(w, [2, 16]), b(w, [2, 21]), b(x, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      var c = function(a, b) {
    ...
    var b = [0], c = [null], d = [], e = this.table, g = "", f = 0, h = 0, k = 0, m = d.slice.call(arguments, 1), l = Object.create(this.lexer), p = {}, u;
    for (u in this.yy) {
    ...
    u = l.yylloc;
    d.push(u);
    var n = l.options && l.options.ranges;
    ...
    for (var r, w, x, K, N = {}, P, L;;) {
      ...
      if ("undefined" === typeof K || !K.length || !K[0]) {
        ...
        Q = l.showPosition ? "Parse error on line " + (f + 1) + ":\n" + l.showPosition() + "\nExpecting " + L.join(", ") + ", got '" + (this.terminals_[r] || r) + "'" : "Parse error on line " + (f + 1) + ": Unexpected " + (1 == r ? "end of input" : "'" + (this.terminals_[r] || r) + "'");
        this.parseError(Q, {text:l.match, token:this.terminals_[r] || r, line:l.yylineno, loc:u, expected:L});
      }
      ...
      switch(K[0]) {
        case 1:
          ...
          b.push(K[1]);
          r = null;
          w ? (r = w, w = null) : (h = l.yyleng, g = l.yytext, f = l.yylineno, u = l.yylloc, 0 < k && k--);
          break;
        case 2:
          ...
          x = this.performAction.apply(N, [g, h, f, p, K[1], c, d].concat(m));
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.polyTermsEqual = function(f, g) {
      return this.parser.parse(f).simplify(a.partial).equals(this.parser.parse(g).simplify(a.partial));
    };
...
(function() {
  var a, b, f, g, d, c, e, h, l, k, p, n = [].slice;
  d = /^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;
  g = /^\d+(\.\d\d)?$/;
  ...
  a = function() {
    ...
    a.matchWithPrecision = function(a, c) {
      var d, e;
      return (d = String(a).match(k)) && (e = String(c).match(k)) && p(d) === p(e) && b(a, c, function(a, b) {
        return a === b;
      });
    };
    a.matchWithoutPrecision = function(a, c) {
      var d, e;
      return (d = String(a).match(k)) && (e = String(c).match(k)) && (a = p(d) > p(e) ? (+a).toFixed(f(e)) : String(a)) && b(a, c, function(a, b) {
        return a === b;
      });
    };
    ...
    a.constantsDollar = function(a) {
      return this.constantsConform(a, g);
    };
    ...
    a.pointInRange = function(a, b, c, d, e) {
      var g, f, h;
      if (g = null != b ? "function" === typeof b.match ? b.match(l) : void 0 : void 0) {
        e = [g[1], g[8], c, d], b = e[0], c = e[1], d = e[2], e = e[3];
      }
      null == d && (d = 0);
      null == e && (e = d);
      return (g = a.match(l)) && b - d <= (f = g[1]) && f <= +b + +d && c - e <= (h = g[8]) && h <= +c + +e;
    };
    a.plural = function(a, b, c, d) {
      ...
      null == c && (c = h.test(g = b.toLowerCase()) ? "y" : "");
      if (!b.endsWith(c)) {
        return b;
      }
      null == d && (d = h.test(g) ? "ies" : e.test(g) ? "es" : "s");
...
var CTATVariableTableCount = 0, CTATVariableTable = function() {
  ...
  this.clone = function() {
    ...
    var g = new CTATVariableTable;
    ctatdebug("CTATVariableTable --\x3e in clone; copy " + g + ", copy.setTable() " + g.setTable);
    g.setTable(a(b));
...
(function() {
  var a, b, f, g = [].slice, d = [].indexOf || function(a) {
  ...
  a = function() {
    function a(b) {
      ...
      for (d = f.length;b < d;b++) {
        c = f[b], this.keys.push(c), this.values.push(function(a) {
          return function() {
            var b, c;
            c = arguments[0];
            b = 2 <= arguments.length ? g.call(arguments, 1) : [];
            return a.apply(c, b);
          };
        }(Number.prototype[c]));
      }
      ...
      for (b = f.length;d < b;d++) {
        c = f[d], this.keys.push(c), this.values.push(function(a, b) {
          return function() {
            var c;
            c = 1 <= arguments.length ? g.call(arguments, 0) : [];
            return a.apply(b, c);
          };
    ...
    a.prototype.evaluate = function(a, c, l, k) {
      var p, n, m, u, r, w, x, t;
      try {
        ...
        }(Function, ["selection", "action", "input"].concat(g.call(this.keys), ["return " + a.replace(/\\/g, "\\\\")]), function() {
        }).apply(r, [c, l, k].concat(g.call(this.values)));
      } catch (B) {
    ...
    a.prototype.interpolate = function(a, b, c, d) {
      ...
      for (m = u.length;f < m;a = ++f) {
        g = u[a], r.push(a % 2 ? this.evaluate(g, b, c, d) : g);
      }
      return r.join("");
    };
    return a;
...
var CTATSingleMatcher = function(a, b) {
  ...
  this.setSingle = function(a) {
    null === a || "undefined" === typeof a ? f.ctatdebug('CTATSingleMatcher --\x3e bad argument "' + a + '" to setSingle()') : g = a;
  };
  this.toString = function() {
  ...
  this.evaluateReplacement = function(a, b, g) {
    g = null;
    if (!d) {
      return g;
    }
    ...
    f.ctatdebug("CTATSingleMatcher calling CTATFormulaParser.evaluate(" + d + ", " + l + ", " + k + ", " + a + ")");
    try {
      g = b.evaluate(d, l, k, a);
    } catch (p) {
      f.ctatdebug("CTATSingleMatcher error from CTATFormulaParser.evaluate(" + d + ") " + p.name + ": " + p.message), g = null;
    }
    f.ctatdebug("CTATSingleMatcher.evaluateReplacement() returns " + g + ", type " + typeof g);
    return g;
  };
};
...
CTATSingleMatcher.prototype.match = function(a, b, f, g) {
...
var CTATExpressionMatcher = function(a, b) {
  function f(a, b, d, e, f) {
    h.ctatdebug("CTATExpressionMatcher.testVector[" + e + "](" + a + ", " + b + ", " + d + ", " + f + ") to call evaluate");
    ...
    d = h.evaluate(a, b, u, f);
    h.ctatdebug("CTATExpressionMatcher.testVector evaluate(" + a + ", " + b + ", " + u + ", " + f + ") returned " + d + ", type " + typeof d);
    f = null;
    switch(e) {
    ...
    c = f;
    h.ctatdebug("CTATExpressionMatcher.testVector comparee " + f + ", type " + typeof f + ", relation " + g + "( " + CTATExpressionMatcher.RELATIONS[g] + " )");
    try {
      switch(g) {
        ...
        case CTATExpressionMatcher.EQ_RELATION:
          ...
          return h.compareNumberOrString(f, d, g);
        case CTATExpressionMatcher.NOT_EQ_RELATION:
          return null == f ? null != d : null == d ? !0 : h.compareNumberOrString(f, d, g);
  ...
  var g = CTATExpressionMatcher.EQ_RELATION, d = b, c = null, e = !1, h = this;
  ...
  this.isEqualRelation = function() {
    ...
    return g === CTATExpressionMatcher.EQ_RELATION;
  };
  this.getEvaluatedInput = function(a, b) {
  ...
  this.toString = function() {
    return CTATExpressionMatcher.RELATIONS[g] + ' "' + d + '"';
  };
  this.matchSingle = function(a) {
  ...
  this.matchConcatenation = function(b, c, d, g) {
    b = h.array2ConcatString(b);
    null === c || "undefined" === typeof c || null === d || "undefined" === typeof d ? e = f(b, null, null, a, g) : (c = h.array2ConcatString(c), d = h.array2ConcatString(d), e = f(b, c, d, a, g));
    return e;
  };
  ...
  (function() {
    if (null !== b && "undefined" !== typeof b) {
      ...
      a = b.indexOf('"');
      var c = b.lastIndexOf('"');
      0 <= a && 0 <= c ? (a = b.substring(a + 1, c), c = b.substring(0, b.indexOf(" ")), g = CTATExpressionMatcher.nameToRelation(c)) : a = b;
...
var CTATVectorMatcher = function(a, b, f, g) {
  function d(a, b, d, f, g) {
    k.ctatdebug("CTATVectorMatcher --\x3e in _match(" + a + ", " + b + ", " + d + ", " + f + ")");
    if (0 === c.length || 0 === e.length || 0 === h.length) {
      c.push(new CTATExactMatcher(CTATMatcher.SELECTION, k.array2ConcatString(k.getDefaultSelectionArray()))), e.push(new CTATExactMatcher(CTATMatcher.ACTION, k.array2ConcatString(k.getDefaultActionArray()))), h.push(new CTATExactMatcher(CTATMatcher.INPUT, k.array2ConcatString(k.getDefaultInputArray())));
    }
    var w = [];
    ...
    for (var x = 0;3 > x;x++) {
      var t = l[x][0], B = t instanceof CTATExpressionMatcher ? t.matchConcatenation(a, b, d, f) : t.matchConcatenation(w[x]);
      k.ctatdebug("CTATVectorMatcher --\x3e in _match[" + x + "] after " + t + ".concat returns: " + B);
      if (g) {
        g.push(B);
      } else {
        if (!1 === B) {
  ...
  var c = a instanceof Array ? a : [], e = b instanceof Array ? b : [], h = f instanceof Array ? f : [], l = [];
  l[CTATMatcher.SELECTION] = c;
  l[CTATMatcher.ACTION] = e;
  l[CTATMatcher.INPUT] = h;
  var k = this;
  this.match = function(a, b, c, e, f) {
    return !1 !== d(a, b, c, f) && k.matchActor(e) ? !0 : !1;
  };
  ...
  this.getSelection = function() {
    return 0 === c.length ? k.getDefaultSelection() : c[0].toString();
  };
  this.getAction = function() {
    return 0 === e.length ? k.getDefaultAction() : e[0].getAction();
  };
  this.setDefaultSelection = function(a) {
    return 0 === c.length ? k.internalSetDefaultSelection(a) : c[0].setDefaultSelection(a);
  };
  this.setDefaultAction = function(a) {
    return 0 === e.length ? k.internalSetDefaultAction(a) : e[0].setDefaultAction(a);
  };
...
var CTATExampleTracerLink = function(a, b, f) {
  ...
  var g = "undefined" === typeof a || null === a ? null : a, d = null, c = "undefined" === typeof b || null === b ? null : b, e = "undefined" === typeof f || null === f ? null : f, h = null, l = 1, k = 1, p = "CORRECT_ACTION", n = [], m = !1, u = null, r = "", w = null, x = null, t = this;
  ...
  this.addSkillName = function(a) {
    t.ctatdebug("ETLink[" + g + "].addSkillName(" + a + ")");
    if ("unnamed" !== a) {
...
var CTATRegexMatcher = function(a, b) {
  CTATSingleMatcher.call(this, a, !0);
  var f = null, g = null, d = this;
  this.toString = function() {
    return f;
  };
  this.setSinglePattern = function(a) {
    "undefined" === typeof a || null === a ? console.log("CTATRegexMatcher: null or undefined pattern") : (f = a, g = d.getCaseInsensitive() ? new RegExp(a, "i") : new RegExp(a));
  };
  this.setSingle = function(a) {
...
var CTATExampleTracerNode = function(a, b) {
  ...
  var f = null, g = "", d = b ? b : new Set, c = new Set;
...
var CTATVersionComparator = function() {
  ...
  this.compare = function(a, b) {
    ...
    var f = 0, g = a.split("."), d = b.split("."), c;
    for (c = 0;c < Math.min(g.length, d.length);c++) {
      try {
        var e = parseInt(g[c]), h = parseInt(d[c]), f = e < h ? -1 : e > h ? 1 : 0;
        if (0 !== f) {
          return f;
        }
      } catch (l) {
        if (f = g[c].toString() < d[c].toString() ? -1 : g[c].toString() > d[c].toString() ? 1 : 0, 0 !== f) {
          return f;
        }
      }
    }
    return c < g.length ? 1 : c < d.length ? -1 : a.toString() < b.toString() ? -1 : a.toString() > b.toString() ? 1 : 0;
  };
};
...
var CTATExampleTracerSkill = function(a, b, f, g, d, c, e) {
  ...
  var k = Number(g);
  Number.isNaN(k) && (k = CTATExampleTracerSkill.DEFAULT_P_KNOWN);
  var p = Number(c);
  Number.isNaN(p) && (p = CTATExampleTracerSkill.DEFAULT_P_LEARN);
  var n = Number(d);
  Number.isNaN(n) && (n = CTATExampleTracerSkill.DEFAULT_P_SLIP);
  var m = /^0*[xX]([0-9a-fA-F]+)$/.test(e) ? parseInt(e, 16) : /^(\-|\+)?[0-9]+$/.test(e) ? parseInt(e, 10) : CTATExampleTracerSkill.DEFAULT_HISTORY, u = 0, r = 0, w = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, x = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, t = null, B = null, C = this;
  this.getSkillName = function() {
    return h;
  };
  this.getCategory = function() {
  ...
  this.updatePKnown = function(a) {
    return k = CTATExampleTracerSkill.updatePKnownStatic(a, l, k, n, p);
  };
...
var CTATWildcardMatcher = function(a, b) {
  function f(a) {
    ...
    var b = (new String(a)).replace(RegExp("\\?", "g"), "."), e = b.replace(RegExp("\\*", "g"), ".*"), f = e.replace(RegExp("\\[\\!", "g"), "[^");
    g.ctatdebug("CTATWildcardMatcher.convertToFullRegex(" + a + ") after qm: " + b + "; after aster: " + e + "; after negate: " + f + ";");
    return f;
  }
  ...
  this.setSingle = function(a) {
    g.simpleSinglePattern = a;
    g.setSinglePattern.call(g, f(a));
  };
  this.setSingle(b);
...
var CTATExampleTracerPathComparator = function() {
  ...
  this.compare = function(b, f) {
    ...
    var g = b.getNumberOfPreferredPrefixLinks(), d = f.getNumberOfPreferredPrefixLinks();
    if (g > d) {
      return -1;
    }
    if (g < d) {
    ...
    g = b.getNumberOfSuboptimalLinks();
  ...
  this.breakByLowerLinkID = function(b, f) {
    ...
    var g = b.getSortedLinks(), d = f.getSortedLinks(), c = null, e = null, h = 0, l = 0;
    do {
      a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID in do while"), l >= g.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 1 is shorter"), h = -1) : l >= d.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 2 is shorter"), h = 1) : (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path are same, compare IDS"), c = g[l], e = d[l]), l++;
...
var CTATExampleTracerPath = function(a) {
  ...
  var f = null, g = null, d = null, c = null, e = null, h = null, l = this;
...
CTATRangeMatcher.prototype.match = function(a, b, f, g) {
  return this.matchSingle(a, b, f, g);
};
...
var CTATMatcherComparator = function() {
  ...
  CTATMatcherComparator.compareBasedOnType = function(a, b) {
    ...
    for (var g in CTATMatcherComparator.matcherPrecedenceOrder) {
      if (CTATMatcherComparator.matcherPrecedenceOrder.hasOwnProperty(g) && b instanceof CTATMatcherComparator.matcherPrecedenceOrder[g]) {
        break;
      }
    }
...
var CTATExampleTracerLinkComparator = function(a, b) {
  ...
  this.compare = function(f, g) {
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l1.getUniqueID(): " + f.getUniqueID());
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l2.getUniqueID(): " + g.getUniqueID());
    var d = f.getType(), c = g.getType(), d = CTATExampleTracerLink.compareLinkTypes(d, c);
    if (0 !== d) {
    ...
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l1.getDepth(), l2.getDepth(): " + f.getDepth() + ", " + g.getDepth());
    if (f.getDepth() < g.getDepth()) {
      return -1;
    }
    if (f.getDepth() > g.getDepth()) {
      return 1;
    ...
    c = a.getTraversalCount(g) - g.getMinTraversals();
    ...
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l2.getIsPreferredLink(): " + g.getIsPreferredLink());
    ...
    if (0 !== (d = CTATMatcherComparator.compare(f.getMatcher(), g.getMatcher()))) {
      return d;
    }
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l1.getUniqueID(): " + f.getUniqueID());
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l2.getUniqueID(): " + g.getUniqueID());
    return f.getUniqueID() < g.getUniqueID() ? -1 : 1;
  };
};
...
var CTATExampleTracerInterpretation = function(a) {
  ...
  var b = [], f = {}, g = new CTATVariableTable, d = new Set;
  a.forEach(function(a) {
    d.add(a);
  });
  ...
  this.addLink = function(a) {
    ...
    b.push(a);
    var d = a.getMatcher(), d = null === d || "undefined" === typeof d ? 1 : d.getTraversalIncrement(), g = f[a.getUniqueID()];
    null !== g && "undefined" !== typeof g ? g[0] += d : (g = [], g.push(d), f[a.getUniqueID()] = g);
    a = a.getType();
  ...
  this.updateVariableTable = function(a, b, c) {
    ...
    g.put("link" + c.getUniqueID() + ".selection", a.getSelection());
    g.put("link" + c.getUniqueID() + ".action", a.getAction());
    b = "link" + c.getUniqueID() + ".input";
    g.put(b, e);
    g.put(CTATVariableTable.nameAsString(e), CTATVariableTable.valueAsString(e));
    if (CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase() === c.getActionType().toString().toUpperCase() || CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase() === c.getActionType().toString().toUpperCase()) {
      a = a.getSelection(), null !== a && "undefined" !== typeof a && 0 < a.length && g.put(a, e);
    }
    return d;
  };
...
var CTATExampleTracerInterpretationComparator = function() {
  ...
  this.compare = function(b, f) {
    ...
    var g = b.getType(), d = CTATExampleTracerLink.compareLinkTypes(g, f.getType());
    ...
    if (CTATExampleTracerLink.BUGGY_ACTION.toString().toUpperCase() === g.toString().toUpperCase() && (ctatdebug("CTATExampleTracerInterpretationComparator checking for buggy actions"), g = b.getLastMatchedLink(), d = f.getLastMatchedLink(), g = CTATMatcherComparator.compare(g.getMatcher(), d.getMatcher()), 0 !== g)) {
      return g;
    }
    var d = CTATExampleTracerPath.getBestPath(b.getPaths()), g = CTATExampleTracerPath.getBestPath(f.getPaths()), c = new Set;
    c.add(d);
    c.add(g);
    d = CTATExampleTracerPath.getBestPath(c);
    ctatdebug("CTATExampleTracerInterpretationComparator found best path: " + (d === g));
...
var CTATExampleTracerEvent = function(a, b, f) {
  ...
  var g = "", d = !1, c = CTATExampleTracerLink.NO_MODEL, e = !1, h = null, l = null, k = "student", p = null, n = null, m = "", u = null, r = null, w = null, x = null, t = null, B = [], C = !1, G = null, D = null, z = this;
  this.getActor = function() {
    return k;
  };
  this.setActor = function(a) {
  ...
  this.getTransactionID = function() {
    z.ctatdebug("CTATExampleTracerEvent --\x3e in getTransactionID() returning " + g);
    return g;
  };
  this.setTransactionID = function(a) {
  ...
  this.getTutorInput = function() {
    return null !== w && "undefined" !== typeof w ? z.getEvaluatedInputArray() : null !== l && "undefined" !== typeof l ? l.getInputArray() : null;
  };
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
    ...
    if (!b && G.hideButRequireSteps()) {
      ...
      for (var e;!(e = b.next()).done;) {
        if (G.pathToLinkIsSubset(e.value, y)) {
          return a.setDoneStepFailed(!1), 1 > d.size ? g(a, c, CTATExampleTracerLink.CORRECT_ACTION, e.value, q.getBestInterpretation(), q.getInterpretationsInternal()) : g(a, c, CTATExampleTracerLink.CORRECT_ACTION, e.value, p(d), d);
        }
      }
    }
    ...
    t.forEach(function(d) {
      ...
      if ("undefined" === typeof m || null === m) {
        ...
        for (var g = 0;g < m.length;++g) {
          e(a.getStudentSAI(), !0, m[g], m[g].getActor(), d.getVariableTable());
        }
      }
      ...
      m.forEach(function(b) {
        ...
        e.getPaths().forEach(function(c) {
          ...
          !1 === l(b, e, c, !1, a) && (q.ctatdebug("In evaluate -- in if condition, checking if isPathOK"), e.getPaths()["delete"](c), q.ctatdebug("In evaluate -- out of if condition, checking if isPathOK\n Tried to delete path."));
        });
  ...
  function w(a, b, c, d) {
    ...
    g.forEach(function(c) {
      !0 !== h && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting in fro loop"), !0 === l(c, a, b, !1, e) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting first if"), k = c, h = !0) : a.getPaths().forEach(function(d) {
        !0 !== h && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting in inner loop"), b !== d && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting second if"), !0 === l(c, a, d, !1, e) && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting third if"), k = c, h = !0)));
      }));
    });
    if (!0 === h) {
      return q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink returning: " + k.getUniqueID()), k;
    }
  ...
  this.goToState = function(a, b) {
    ...
    var e = q.getBestInterpretation();
    if (e && (c ? q.goToDone(e, G, b) : q.advanceToNode(d, G, b))) {
      return !0;
    }
    for (var f = 0;f < t.length;++f) {
      var g = t[f];
      if (g != e && (c ? q.goToDone(g, G, b) : q.advanceToNode(d, G, b))) {
        return !0;
      }
    }
    return !1;
  ...
  this.advanceToNode = function(a, b, c) {
    ...
    q.ctatdebug("advanceToNode() path " + a);
    a && (a = a.getSortedLinks(), results = c.traceLinks(a), q.ctatdebug("advanceToNode() results " + results));
  };
...
var CTATDefaultLinkGroup = function(a, b, f, g) {
  CTATLinkGroup.call(this, "CTATDefaultLinkGroup", a);
  var d = a, c = b, e = f, h = new Set;
  null !== g && "undefined" !== typeof g && g.forEach(function(a) {
    h.add(a);
  });
  var l = new Set, k = null, p = null, n = this;
...
InternalGroupIterator = function(a, b) {
  ...
  this.toString = function() {
    return "{" + a + " at " + g + " with " + d.length + " subgroups}";
  };
  this.next = function() {
    ...
    b.forEach(function(e) {
      if (!0 !== c) {
        ...
        l.getGroupSubgroups(a).forEach(function(f) {
          !0 !== c && !0 === l.isLinkInGroup(f, e) && (l.getGroupLinkCount(f) >= b.size ? (d = g(f, b), c = !0) : l.getGroupLinks(f).forEach(function(c) {
            if (!1 === b.has(c)) {
              throw new CTATExampleTracerException("Invalid link selection: Partial overlap with existing group: " + a);
            }
          }));
...
var CTATExampleTracerGraph = function(a, b, f) {
  ...
  function d(a, b, d) {
    ...
    if (0 !== a.length) {
      ...
      h.forEach(function(b) {
        !1 !== k && d.forEach(function(c) {
          !1 !== k && l(a, c) < c.getMinTraversals() && !0 === F.isLinkInGroup(b, c) && (k = !1);
        });
      });
      if (!1 === k) {
        return !1;
  ...
  function e(a, b, c, d) {
    ...
    F.getGroupSubgroups(a).forEach(function(a) {
      if (!1 === F.isLinkInGroup(a, b) && 0 !== F.getGroupLinkCount(a)) {
        var l = h(a, d);
        null !== l && "undefined" !== typeof l && (l = l.getDepth(), l < b.getDepth() && l > e && (!1 === p(a) || !0 === n(a, c)) && (e = l, f = a), l > b.getDepth() && l < g && (!1 === p(a) || !0 === n(a, c)) && (g = l, k = a));
      }
    });
    ...
    return null !== k && "undefined" !== typeof k && (k instanceof CTATExampleTracerLink && -1 < c.indexOf(k) || k instanceof CTATLinkGroup && !0 === n(k, c)) ? !1 : !0;
  }
  function h(a, b) {
  ...
  this.observesOrderingConstraints = function(a, b, c, e) {
    ...
    if (!0 === c.has(b) && !0 === g(a, b, c) && !0 === d(a, b, c)) {
  ...
  this.isIncorrectLinkOK = function(a, b, c, d) {
    ...
    var e = !1, f = null, h = !0, l = !1;
    A.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
      !0 !== l && !1 !== h && b.getType().toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString() && !0 === c.has(b) && (e = !0, !1 === g(a, b, c) ? h = !1 : (f = b, l = !0));
    });
    ...
    if (!0 === e && (b = A.getSmallestContainingGroup(b), !0 === F.isLinkInGroup(b, f) && !1 === F.isGroupOrdered(b) && !0 === k(b, c, d))) {
      return !1;
    }
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var d = new CTATExampleTracerLink(null, null, null), f = e.getElementChildren(a), g, h, k, l, m, n = a = -1, z = CTATMsgType.DEFAULT_ACTOR, y = !1, q = 0;q < f.length;q++) {
      "sourceID" === e.getElementName(f[q]) && (a = parseInt(e.getNodeTextValue(f[q])), d.setPrevNode(a));
      "destID" === e.getElementName(f[q]) && (n = parseInt(e.getNodeTextValue(f[q])), d.setNextNode(n));
      if ("rule" === e.getElementName(f[q])) {
        for (var F = e.getElementChildren(f[q]), E = 0;E < F.length;E++) {
          "text" === e.getElementName(F[E]) && d.addSkillName(e.getNodeTextValue(F[E]).toString());
        }
      }
      if ("actionLabel" === e.getElementName(f[q])) {
        for (d.setIsPreferredLink("false" != e.getElementAttr(f[q], "preferPathMark")), d.setMinTraversalsStr(e.getElementAttr(f[q], "minTraversals")), d.setMaxTraversalsStr(e.getElementAttr(f[q], "maxTraversals")), F = e.getElementChildren(f[q]), E = 0;E < F.length;E++) {
          "uniqueID" === e.getElementName(F[E]) && (m = e.getNodeTextValue(F[E]), d.setUniqueID(parseInt(e.getNodeTextValue(F[E]))));
          "message" === e.getElementName(F[E]) && (l = new CTATMessage(F[E]));
          "actionType" === e.getElementName(F[E]) && d.setActionType(e.getNodeTextValue(F[E]));
          "buggyMessage" === e.getElementName(F[E]) && d.setBuggyMsg(e.getNodeTextValue(F[E]));
          "successMessage" === e.getElementName(F[E]) && d.setSuccessMsg(e.getNodeTextValue(F[E]));
          "hintMessage" === e.getElementName(F[E]) && d.addHint(e.getNodeTextValue(F[E]));
          if ("matchers" === e.getElementName(F[E])) {
            for (var A = e.getElementChildren(F[E]), H = 0;H < A.length;H++) {
              "Selection" === e.getElementName(A[H]) && (g = b(A[H], 0)), "Action" === e.getElementName(A[H]) && (h = b(A[H], 1)), "Input" === e.getElementName(A[H]) && (k = b(A[H], 2)), "Actor" === e.getElementName(A[H]) && (z = e.getNodeTextValue(A[H]), y = (y = e.getElementAttr(A[H], "linkTriggered")) && "false" != y.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === e.getElementName(F[E])) {
            h = F[E];
            ...
            for (var z = new CTATExactMatcher(CTATMatcher.ACTION, null), I = 0;I < h.length;I++) {
              if ("matcherType" === e.getElementName(h[I]) && ("ExactMatcher" === e.getNodeTextValue(h[I]) && (H = CTATExactMatcher), "RegexMatcher" === e.getNodeTextValue(h[I]) && (H = CTATRegexMatcher), "AnyMatcher" === e.getNodeTextValue(h[I]) && (H = CTATAnyMatcher), "RangeMatcher" === e.getNodeTextValue(h[I]) && (H = CTATRangeMatcher), "WildcardMatcher" === e.getNodeTextValue(h[I]) && (H = CTATWildcardMatcher), "ExpressionMatcher" === e.getNodeTextValue(h[I]) && (H = CTATExpressionMatcher)), 
              "matcherParameter" === e.getElementName(h[I])) {
                var M = e.getElementAttr(h[I], "name");
                "selection" == M && k.setParameter(e.getNodeTextValue(h[I]));
                "action" == M && z.setParameter(e.getNodeTextValue(h[I]));
                "input" == M && (A = A ? A : new H(CTATMatcher.INPUT, null), A.setParameter(e.getNodeTextValue(h[I])));
                "actor" == M && (J = e.getNodeTextValue(h[I]));
                "minimum" == M && (A = A ? A : new H(CTATMatcher.INPUT, null), A.setParameter(e.getNodeTextValue(h[I]), "minimum"));
                "maximum" == M && (A = A ? A : new H(CTATMatcher.INPUT, null), A.setParameter(e.getNodeTextValue(h[I]), "maximum"));
              }
            }
            A.setReplacementFormula(g);
            z = [[k], [z], [A], J];
            g = z[0];
            h = z[1];
            k = z[2];
    ...
    m = new CTATVectorMatcher(g, h, k, z);
  ...
  function b(a, b) {
    g.ctatdebug("processMatchers()");
    for (var c = e.getElementChildren(a), d = [], f = 0;f < c.length;f++) {
      if ("matcher" === e.getElementName(c[f])) {
        for (var h = null, k = e.getElementAttr(c[f], "replacementFormula"), l = e.getElementChildren(c[f]), m = 0;m < l.length;m++) {
          if ("matcherType" === e.getElementName(l[m])) {
            switch(h = e.getNodeTextValue(l[m]), g.ctatdebug("CTATGraphParser.processMatchers() matcherType[" + m + "] = " + h), h) {
              case "ExactMatcher":
  ...
  function f(a, b) {
    ...
    for (var l = function(a) {
      c.add(a);
    }, m = e.getElementChildren(a), n = 0;n < m.length;n++) {
      if ("link" === e.getElementName(m[n])) {
        var p = Number(e.getElementAttr(m[n], "id")), y = b[p];
        if (null !== y || void 0 !== y) {
          ctatdebug("Added link ID : " + p), c.add(y);
        }
      }
      "group" === e.getElementName(m[n]) && (ctatdebug("encountered a subgroup"), f(m[n], b).forEach(l));
    }
    k.addGroup(d, g, c);
    k.setGroupReenterable(k.getGroupByName(d), h);
    return c;
  }
  CTATBase.call(this, "CTATGraphParser", "__undefined__");
  var g = this, d, c, e = new CTATXML, h = null, l = [];
  new XMLSerializer;
  var k, p = !0, n = !0, m = [];
  this.getLockWidget = function() {
    return n;
  };
  this.parseGraph = function(b, g) {
    ctatdebug("parseBRD()");
    var w = 0, x = e.getElementAttr(b, "startStateNodeName"), t = "true" === e.getElementAttr(b, "unordered");
    ...
    var C = e.getElementChildren(b), B = e.getElementAttr(b, "suppressStudentFeedback");
    if (null === B || void 0 === B) {
      B = CTATMsgType.SHOW_ALL_FEEDBACK;
    }
    c.setFeedbackPolicy(B);
    g.setFeedbackSuppressed(B);
    B = e.getElementAttr(b, "highlightRightSelection");
    g.setHighlightRightSelection("false" != B);
    var G = e.getElementAttr(b, "confirmDone");
    "true" !== G && "false" !== G && (G = c.getFeedbackPolicy() === CTATMsgType.HIDE_ALL_FEEDBACK ? "true" : "false");
    g.setHintPolicy(e.getElementAttr(b, "hintPolicy"));
    g.setOutOfOrderMessage(e.getElementAttr(b, "outOfOrderMessage"));
    for (var D = null, z = 0;z < C.length;z++) {
      switch(e.getElementName(C[z])) {
        case "startNodeMessages":
          l = e.getElementChildren(C[z]);
          break;
        case "node":
          w++;
          var y;
          ...
          var q = e.getElementChildren(y), F = -1;
          y = "";
          for (var E = 0;E < q.length;E++) {
            switch(e.getElementName(q[E])) {
              case "uniqueID":
                F = parseInt(e.getNodeTextValue(q[E]));
                break;
              case "text":
                y = e.getNodeTextValue(q[E]);
            }
          }
        ...
        case "productionRule":
          ...
          for (var q = y = "", E = F = null, A = e.getElementChildren(A), H = 0;H < A.length;H++) {
            var J = e.getElementName(A[H]);
            "ruleName" == J && (y = e.getNodeTextValue(A[H]), ctatdebug("ruleName=" + y));
            "productionSet" == J && (q = e.getNodeTextValue(A[H]), ctatdebug("productionSet=" + q));
            "label" == J && (F = e.getNodeTextValue(A[H]), ctatdebug("label=" + F));
            "description" == J && (E = e.getNodeTextValue(A[H]), ctatdebug("description=" + E));
          }
    ...
    if (D) {
      ...
      k.setGroupOrdered(k.getTopLevelGroup(), C);
      ...
      x = e.getElementChildren(x);
      for (C = 0;C < x.length;C++) {
        switch(e.getElementName(x[C])) {
          case "group":
            f(x[C], w);
            break;
          case "outOfOrderMessage":
            k.getTopLevelGroup().setDefaultBuggyMsg(e.getNodeTextValue(x[C]));
        }
      }
    }
    w = g.getSkillBarVector(!1, !0);
    if (!w || 1 > w.length) {
      ctatdebug("No existing skills. Add skills from BRD."), g.addGraphSkills(m), w = g.getSkillBarVector();
    }
    h = (new CTATTutorMessageBuilder).createStateGraphMessage(p, t, n, g.isFeedbackSuppressed(), B, G, w);
    c.redoLinkDepths();
...
SCORMProblemSummary.getSessionTime = function(a) {
  ...
  a = b % 1E3;
  var b = (b - a) / 1E3, f = b / 60, g = f / 60, b = b % 60;
  9999 < g && (g = 9999, f = b = 99, a = 990);
  return sprintf("%04d:%02d:%02d.%02d", g, f, b, a / 10);
};
SCORMProblemSummary.getProblemSummaryElements = function(a) {
  var b = sprintf("<%s>%s</%s>", SCORMProblemSummary.LESSON_STATUS, SCORMProblemSummary.getLessonStatus(a), SCORMProblemSummary.LESSON_STATUS), f = sprintf("<%s>%d</%s>", SCORMProblemSummary.RAW_SCORE, SCORMProblemSummary.getRawScore(a), SCORMProblemSummary.RAW_SCORE), g = sprintf("<%s>%s</%s>", SCORMProblemSummary.EXIT, SCORMProblemSummary.getExitReason(a), SCORMProblemSummary.EXIT);
...
var CTATMessageTank = function(a, b) {
  ...
  var c = a, e = null, h = null, l = null, k = new Set;
  ...
  this.flushMessageTank = function(a, b) {
    ...
    if (e && !(1 > e.length)) {
      ...
      n.ctatdebug("flushMessageTank(): msgBundle.length " + k.length + ", delayedMsgsBundle.length " + x.length);
...
var CTATSkills = function(a) {
  ...
  var g = new Set, d = this;
  this.toXML = function(a, d) {
    d || (d = "");
    var f = a ? "&lt;Skills&gt;" : "<Skills>", g = f.length, k;
    for (k in b) {
      b.hasOwnProperty(k) && b[k] && (f += d + b[k].toXML(a));
    }
    f += d && f.length > g ? "\n" : "";
    return f + (a ? "&lt;/Skills&gt;" : "</Skills>");
  };
  this.updateSkill = function(a, b, h) {
    var l = null, k = d.getSkill(b);
    null !== k && "undefined" !== typeof k && (k.setTransactionNumber(f), b = h + " " + b, g.has(b) || (g.add(b), k.updatePKnown(a), k.updateHistory(a), k.changeOpportunityCount(1)), CTATExampleTracerSkill.CORRECT.toString().toUpperCase() === a.toString().toUpperCase() && g["delete"](b), l = k);
    return l;
  };
  ...
  this.getSkillBarVector = function(a, d) {
    var g = [], l;
    for (l in b) {
      !0 === b.hasOwnProperty(l) && (!0 !== d && b[l].getTransactionNumber() !== f || g.push(b[l].getSkillBarString(a)));
    }
    return g;
  };
...
var CTATExampleTracer = function() {
  ...
  function f(a, b) {
    ...
    var e = m.lastMessageAsXML = (new CTATXML).parseXML(a), f = m.lastMessage = new CTATMessage(e), h = f.getMessageType();
    ...
    switch(h) {
      ...
      case CTATMsgType.UNTUTORED_ACTION:
        return b && m.sendBundle([a]), d(a, f, t, e), !0;
      case CTATMsgType.INTERFACE_ACTION:
        return b && m.sendBundle([a]), c(a, f, t, e), !0;
  ...
  function c(a, b, c, d) {
    ...
    m.ctatdebug("selectionArray " + e + ", message.getSelectionArray() " + b.getSelectionArray());
    if (e[0] && "_tutor" == e[0].toLowerCase()) {
      return m.ctatdebug("handleInterfaceAction tutor cmd SAI " + b.getSAI() + ";"), d[0] && "function" === typeof m[d[0]] && (c = b.getSAI().getInput(), m[d[0]](c)), !0;
    }
    !e[0] || "hint" != e[0].toLowerCase() && "help" != e[0].toLowerCase() ? (m.ctatdebug("calling doNewExampleTrace(null, " + b.getSAI() + ") sai.selectionArray " + b.getSAI().getSelectionArray() + " msg.selectionArray " + b.getSelectionArray()), k(null, b.getSAI(), "student", !0, c, a)) : (m.ctatdebug("handleInterfaceAction() hint request: hintPolicy " + C + ", errorSAI " + B), C === CTATHintPolicyEnum.HINTS_UNBIASED ? (1 < e.length && (e[1] = ""), 1 < d.length && (d[1] = "")) : C !== CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY && 
    (C === CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY ? B && B.getSelection() ? (e.splice(1, 0, B.getSelection()), d.splice(1, 0, "PreviousFocus")) : (e[1] = "", d[1] = "") : C === CTATHintPolicyEnum.HINTS_BIASED_BY_ALL && B && B.getSelection() && (e.splice(1, 0, B.getSelection()), d[1] = CTATMsgType.PREVIOUS_FOCUS.toString())), m.startSkillTransaction(), a = [], d = r.doHint(e, d, b.getInputArray(), "student", a, !0), b = a[0], a = b.getReportableHints(), e = d ? "" + d.getUniqueID() : 
  ...
  function k(a, b, c, d, f, g) {
    ...
    k.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || q.appendToProblemState(g, m.getOutputStatus(), !1);
    ...
    if (k.isSolverResult()) {
      ...
      if (k.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        ...
        l, p(c), g, m.getSkillBarVector(!0, c), w.getUniqueID(), n, u), k, l), m.ctatdebug("finishNewExampleTrace() successMsg " + u), u && m.messageTank.addToMessageTank("SuccessMessage", t.createSuccessMessage(n, u), k, null), B = null, d && (x = h(w ? w.getNextNode() : null, r.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = x);
      } else {
        ...
        var y = m.lastSilentHintResult = new CTATExampleTracerEvent(m, g, c);
        y.setHintRequest(!0);
        x = r.traceForHint(y);
        ...
        m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, t.createAssociatedRulesMessageForAction(k.getResult(), l && l.getSelection() ? l : g, p(c), g, m.getSkillBarVector(!0, c), u, n, y.tutorAdvice), k, null);
  ...
  this.traceLinks = function(a) {
    for (var b = [], c = m.getTracer().getBestInterpretation(), d = 0;d < a.length && null !== a[d];++d) {
      c.getTraversalCount(a[d]) < a[d].getMinTraversals() && (m.messageTank = new CTATMessageTank(m, null), b.push(k(a[d], a[d].getDefaultSAI(), a[d].getActor(), !1, null)), m.ctatdebug("traceLinks[" + d + "] result " + b[d]));
    }
    return b;
  };
