...
a[d]&&(a[d]=c[d])}return a}function g(a,b){return"string"==typeof a?a:a[b%a.length]}function h(a){this.opts=c(a||{},h.defaults,m)}function l(){function c(b,c){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',c)}x.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,e){function h(){return d(c("group",{coordsize:m+" "+m,coordorigin:-f+" "+-f}),{width:m,height:m})}function l(a,l,m){b(t,b(d(h(),{rotation:360/e.lines*a+"deg",left:~~l}),b(d(c("roundrect",
{arcsize:e.corners}),{width:f,height:e.scale*e.width,left:e.scale*e.radius,top:-e.scale*e.width>>1,filter:m}),c("fill",{color:g(e.color,a),opacity:e.opacity}),c("stroke",{opacity:0}))))}var f=e.scale*(e.length+e.width),m=2*e.scale*f,v=-(e.width+e.length)*e.scale*2+"px",t=d(h(),{position:"absolute",top:v,left:v});if(e.shadow)for(v=1;v<=e.lines;v++)l(v,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(v=1;v<=e.lines;v++)l(v);return b(a,t)};h.prototype.opacity=
function(a,b,c,d){a=a.firstChild;d=d.shadow&&d.lines||0;a&&b+d<a.childNodes.length&&(a=(a=(a=a.childNodes[b+d])&&a.firstChild)&&a.firstChild)&&(a.opacity=c)}}var n=["webkit","Moz","ms","O"],q={},p,x,m={lines:12,length:7,width:5,radius:10,scale:1,corners:1,color:"#000",opacity:.25,rotate:0,direction:1,speed:1,trail:100,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",shadow:!1,hwaccel:!1,position:"absolute"};h.defaults={};c(h.prototype,{spin:function(b){this.stop();var c=this,g=c.opts,e=
c.el=a(null,{className:g.className});d(e,{position:g.position,width:0,zIndex:g.zIndex,left:g.left,top:g.top});b&&b.insertBefore(e,b.firstChild||null);e.setAttribute("role","progressbar");c.lines(e,c.opts);if(!p){var h=0,l=(g.lines-1)*(1-g.direction)/2,f,m=g.fps,v=m/g.speed,t=(1-g.opacity)/(v*g.trail/100),n=v/g.lines;(function y(){h++;for(var a=0;a<g.lines;a++)f=Math.max(1-(h+(g.lines-a)*n)%v*t,g.opacity),c.opacity(e,a*g.direction+l,f,g);c.timeout=c.el&&setTimeout(y,~~(1E3/m))})()}return c},stop:function(){var a=
this.el;a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0);return this},lines:function(c,h){function l(b,c){return d(a(),{position:"absolute",width:h.scale*(h.length+h.width)+"px",height:h.scale*h.width+"px",background:b,boxShadow:c,transformOrigin:"left",transform:"rotate("+~~(360/h.lines*f+h.rotate)+"deg) translate("+h.scale*h.radius+"px,0)",borderRadius:(h.corners*h.scale*h.width>>1)+"px"})}for(var f=0,m=(h.lines-1)*(1-h.direction)/2,v;f<h.lines;f++)v=d(a(),
{position:"absolute",top:1+~(h.scale*h.width/2)+"px",transform:h.hwaccel?"translate3d(0,0,0)":"",opacity:h.opacity,animation:p&&e(h.opacity,h.trail,m+f*h.direction,h.lines)+" "+1/h.speed+"s linear infinite"}),h.shadow&&b(v,d(l("#000","0 0 4px #000"),{top:"2px"})),b(c,b(v,l(g(h.color,f),"0 0 1px rgba(0,0,0,.1)")));return c},opacity:function(a,b,c){b<a.childNodes.length&&(a.childNodes[b].style.opacity=c)}});if("undefined"!==typeof document){x=function(){var c=a("style",{type:"text/css"});b(document.getElementsByTagName("head")[0],
c);return c.sheet||c.styleSheet}();var v=d(a("group"),{behavior:"url(#default#VML)"});!f(v,"transform")&&v.adj?l():p=f(v,"animation")}return h});(function(a,b){"function"===typeof define&&define.amd?define([],b):"object"===typeof exports?module.exports=b():a.X2JS=b()})(this,function(){return function(a){function b(a){var b=a.localName;null==b&&(b=a.baseName);if(null==b||""==b)b=a.nodeName;return b}function e(a){return"string"==typeof a?a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&apos;"):a}function f(a,b,c,d){for(var g=0;g<a.length;g++){var e=a[g];if("string"===typeof e){if(e==d)break}else if(e instanceof
RegExp){if(e.test(d))break}else if("function"===typeof e&&e(b,c,d))break}return g!=a.length}function d(b,c,d){switch(a.arrayAccessForm){case "property":b[c+"_asArray"]=b[c]instanceof Array?b[c]:[b[c]]}!(b[c]instanceof Array)&&0<a.arrayAccessFormPaths.length&&f(a.arrayAccessFormPaths,b,c,d)&&(b[c]=[b[c]])}function c(a){var b=a.split(/[-T:+Z]/g),c=new Date(b[0],b[1]-1,b[2]),d=b[5].split(".");c.setHours(b[3],b[4],d[0]);1<d.length&&c.setMilliseconds(d[1]);b[6]&&b[7]?(b=60*b[6]+Number(b[7]),b=0+("-"==
(/\d\d-\d\d:\d\d$/.test(a)?"-":"+")?-1*b:b),c.setMinutes(c.getMinutes()-b-c.getTimezoneOffset())):-1!==a.indexOf("Z",a.length-1)&&(c=new Date(Date.UTC(c.getFullYear(),c.getMonth(),c.getDate(),c.getHours(),c.getMinutes(),c.getSeconds(),c.getMilliseconds())));return c}function g(b,d,g){return 0<a.datetimeAccessFormPaths.length?(g=g.split(".#")[0],f(a.datetimeAccessFormPaths,b,d,g)?c(b):b):b}function h(c,e){if(c.nodeType==t.DOCUMENT_NODE){for(var l={},m=c.childNodes,v=0;v<m.length;v++){var n=m.item(v);
if(n.nodeType==t.ELEMENT_NODE){var p=b(n);l[p]=h(n,p)}}return l}if(c.nodeType==t.ELEMENT_NODE){l={__cnt:0};m=c.childNodes;for(v=0;v<m.length;v++)if(n=m.item(v),p=b(n),n.nodeType!=t.COMMENT_NODE){var q=e+"."+p,r;r=n.nodeType==t.ELEMENT_NODE&&0<a.xmlElementsFilter.length?f(a.xmlElementsFilter,l,p,q):!0;r&&(l.__cnt++,null==l[p]?(l[p]=h(n,q),d(l,p,q)):(null==l[p]||l[p]instanceof Array||(l[p]=[l[p]],d(l,p,q)),l[p][l[p].length]=h(n,q)))}for(m=0;m<c.attributes.length;m++)v=c.attributes.item(m),l.__cnt++,
l[a.attributePrefix+v.name]=v.value;m=c.prefix;null!=m&&""!=m&&(l.__cnt++,l.__prefix=m);null!=l["#text"]&&(l.__text=l["#text"],l.__text instanceof Array&&(l.__text=l.__text.join("\n")),a.stripWhitespaces&&(l.__text=l.__text.trim()),delete l["#text"],"property"==a.arrayAccessForm&&delete l["#text_asArray"],l.__text=g(l.__text,p,e+"."+p));null!=l["#cdata-section"]&&(l.__cdata=l["#cdata-section"],delete l["#cdata-section"],"property"==a.arrayAccessForm&&delete l["#cdata-section_asArray"]);0==l.__cnt&&
"text"==a.emptyNodeForm?l="":1==l.__cnt&&null!=l.__text?l=l.__text:1!=l.__cnt||null==l.__cdata||a.keepCData?1<l.__cnt&&null!=l.__text&&a.skipEmptyTextNodesForObj&&(a.stripWhitespaces&&""==l.__text||""==l.__text.trim())&&delete l.__text:l=l.__cdata;delete l.__cnt;!a.enableToStringFunc||null==l.__text&&null==l.__cdata||(l.toString=function(){return(null!=this.__text?this.__text:"")+(null!=this.__cdata?this.__cdata:"")});return l}if(c.nodeType==t.TEXT_NODE||c.nodeType==t.CDATA_SECTION_NODE)return c.nodeValue}
function l(b,c,d,g){c="<"+(null!=b&&null!=b.__prefix?b.__prefix+":":"")+c;if(null!=d)for(var h=0;h<d.length;h++){var l=d[h],f=b[l];a.escapeMode&&(f=e(f));c+=" "+l.substr(a.attributePrefix.length)+"=";c=a.useDoubleQuotes?c+('"'+f+'"'):c+("'"+f+"'")}return g?c+"/>":c+">"}function n(a,b){return"</"+(null!=a.__prefix?a.__prefix+":":"")+b+">"}function q(b,c){var d;if(d="property"==a.arrayAccessForm)d=c.toString(),d=-1!==d.indexOf("_asArray",d.length-8);return d||0==c.toString().indexOf(a.attributePrefix)||
0==c.toString().indexOf("__")||b[c]instanceof Function?!0:!1}function p(a){var b=0;if(a instanceof Object)for(var c in a)q(a,c)||b++;return b}function x(b){var c=[];if(b instanceof Object)for(var d in b)-1==d.toString().indexOf("__")&&0==d.toString().indexOf(a.attributePrefix)&&c.push(d);return c}function m(b){var c="";if(b instanceof Object){var d="";null!=b.__cdata&&(d+="<![CDATA["+b.__cdata+"]]\x3e");null!=b.__text&&(d=a.escapeMode?d+e(b.__text):d+b.__text);c+=d}else null!=b&&(c=a.escapeMode?c+
e(b):c+b);return c}function v(b,c){var d="";if(0<p(b))for(var g in b){var e;!(e=q(b,g))&&(e=""!=c)&&(e=""===c?g:c+"."+g,e=!(0==a.jsonPropertiesFilter.length||""==e||f(a.jsonPropertiesFilter,b,g,e)));if(!e){var h=b[g];e=x(h);if(null==h||void 0==h)d+=l(h,g,e,!0);else if(h instanceof Object)if(h instanceof Array){var t=g,r=c,B="";if(0==h.length)B+=l(h,t,e,!0);else for(e=0;e<h.length;e++)B+=l(h[e],t,x(h[e]),!1),B+=v(h[e],""===r?t:r+"."+t),B+=n(h[e],t);d+=B}else h instanceof Date?(d+=l(h,g,e,!1),d+=h.toISOString(),
d+=n(h,g)):0<p(h)||null!=h.__text||null!=h.__cdata?(d+=l(h,g,e,!1),d+=v(h,""===c?g:c+"."+g),d+=n(h,g)):d+=l(h,g,e,!0);else d+=l(h,g,e,!1),d+=m(h),d+=n(h,g)}}return d+=m(b)}a=a||{};void 0===a.escapeMode&&(a.escapeMode=!0);a.attributePrefix=a.attributePrefix||"_";a.arrayAccessForm=a.arrayAccessForm||"none";a.emptyNodeForm=a.emptyNodeForm||"text";void 0===a.enableToStringFunc&&(a.enableToStringFunc=!0);a.arrayAccessFormPaths=a.arrayAccessFormPaths||[];void 0===a.skipEmptyTextNodesForObj&&(a.skipEmptyTextNodesForObj=
!0);void 0===a.stripWhitespaces&&(a.stripWhitespaces=!0);a.datetimeAccessFormPaths=a.datetimeAccessFormPaths||[];void 0===a.useDoubleQuotes&&(a.useDoubleQuotes=!1);a.xmlElementsFilter=a.xmlElementsFilter||[];a.jsonPropertiesFilter=a.jsonPropertiesFilter||[];void 0===a.keepCData&&(a.keepCData=!1);var t={ELEMENT_NODE:1,TEXT_NODE:3,CDATA_SECTION_NODE:4,COMMENT_NODE:8,DOCUMENT_NODE:9};this.parseXmlString=function(a){var b=window.ActiveXObject||"ActiveXObject"in window;if(void 0===a)return null;var c;
if(window.DOMParser){var d=new window.DOMParser,g=null;if(!b)try{g=d.parseFromString("INVALID","text/xml").getElementsByTagName("parsererror")[0].namespaceURI}catch(I){g=null}try{c=d.parseFromString(a,"text/xml"),null!=g&&0<c.getElementsByTagNameNS(g,"parsererror").length&&(c=null)}catch(I){c=null}}else 0==a.indexOf("<?")&&(a=a.substr(a.indexOf("?>")+2)),c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(a);return c};this.asArray=function(a){return void 0===a||null==a?[]:a instanceof
Array?a:[a]};this.toXmlDateTime=function(a){return a instanceof Date?a.toISOString():"number"===typeof a?(new Date(a)).toISOString():null};this.asDateTime=function(a){return"string"==typeof a?c(a):a};this.xml2json=function(a){return h(a)};this.xml_str2json=function(a){a=this.parseXmlString(a);return null!=a?this.xml2json(a):null};this.json2xml_str=function(a){return v(a,"")};this.json2xml=function(a){a=this.json2xml_str(a);return this.parseXmlString(a)};this.getVersion=function(){return"1.2.0"}}});var CTATConfig={Options:{},addProperty:function(a,b,e,f){e=e||b[0];Object.defineProperty(CTATConfig,a,{enumerable:!0,configurable:!1,writable:!f,value:e.toLowerCase()});var d={};b.forEach(function(b){d[b]=b.toLowerCase();Object.defineProperty(CTATConfig,a+"_is_"+b,{enumerable:!1,writable:!1,value:function(){return CTATConfig[this.prop].toLowerCase()==this.val}.bind({prop:a,val:d[b]})})});CTATConfig.Options[a]=d}};CTATConfig.addProperty("platform",["CTAT","Google","Undefined"],"CTAT",!0);
...
l=0;l<g.length;l++){var f=g[l];a.ctatdebug("Problem ["+l+"] desc: "+b.getElementAttr(f,"description")+", interface: "+b.getElementAttr(f,"student_interface")+", brd: "+b.getElementAttr(f,"problem_file"));var q=new CTATProblem;q.setName(b.getElementAttr(f,"name"));q.setLabel(b.getElementAttr(f,"label"));q.setDescription(b.getElementAttr(f,"description"));q.setTutorFlag(b.getElementAttr(f,"tutor_flag"));q.setProblemFile(b.getElementAttr(f,"problem_file"));q.setStudentInterface(b.getElementAttr(f,"student_interface"));
...
g.message)}};d.createHTTPObject()};CTATConnection.prototype=Object.create(CTATConnectionBase.prototype);CTATConnection.prototype.constructor=CTATConnection;var CTATWSConnection=function(a){CTATConnectionBase.call(this,"CTATWSConnection");var b="",e=!1,f=this,d=null,c=[],g=!1,h=0,l=0,n=null,q=null;f.setSocketType("ws");this.setConsumed=function(a){e=a;f.ctatdebug("consumed: "+e)};this.getConsumed=function(){f.ctatdebug("consumed: "+e);return e};this.assignReceiveFunction=function(a){n=a};this.assignCloseFunction=function(a){q=a};this.setData=function(a){b=a};this.getData=function(){return b};this.init=function(){console.log("init ("+f.getURL()+"); websocket "+
d);null==d&&(d=new WebSocket(f.getURL()),d.addEventListener("open",function(a){f.ctatdebug("STATUS: open");g=!0;f.ctatdebug("Connection open, flushing outgoing queue ...");h=(new Date).getTime();if(0<c.length){for(a=0;a<c.length;a++)d.send(c[a]);c=[]}}),d.addEventListener("message",function(a){l=(new Date).getTime();f.ctatdebug("STATUS: message after "+(l-h)+" ms");f.ctatdebug("Received: "+a.data);n?n(a.data):f.ctatdebug("Error: no processing function provided")}),d.addEventListener("close",function(a){f.ctatdebug("STATUS: close; "+
...
CTATLanguagePack[b]),CTATLanguagePack[b]}else a.ctatdebug("No custom language pack defined, using default...");return"undefined"!==typeof CTATDefaultLangagePack&&CTATDefaultLangagePack[b]?(a.ctatdebug("Found tag in default language pack, returning: "+CTATDefaultLangagePack[b]),CTATDefaultLangagePack[b]):b}};CTATLanguageManager.prototype=Object.create(CTATBase.prototype);CTATLanguageManager.prototype.constructor=CTATLanguageManager;CTATLanguageManager.theSingleton=new CTATLanguageManager;var scrimIsUp=!1,errorScrim=!1,waitScrim=!0,warnScrim=!1,connectionScrim=!1,authorTimeSet=!0,inAuthorTime=!0,CTATScrim=function(){function a(){warnScrim=!1;t.scrimDown()}function b(a){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&t.scrimDownForced(),t.ctatdebug("errScrimUp ("+a+")"),!0===errorScrim?!0===g&&(g=!1,getSafeElementById(ctatcontainer).removeChild(m)):!0===warnScrim&&(g=!0),t.scrimUp(a))}function e(a,b){t.ctatdebug("makeHTMLButton ()");var c=document.createElement("input");c.type="button";
c.value=b;a?(t.ctatdebug("clickHandle!=null"),c.onclick=a):(t.ctatdebug("clickHandle==null"),c.onclick=t.defaultClickHandler);c.id=b;c.setAttribute("class","scrimButton");return c}CTATBase.call(this,"CTATScrim","__undefined__");var f="",d=!1,c=!1,g=!1,h=null,l=null,n=new CTATCanvasComponent("CTAT Scrim"),q=[],p=null,x=null,m=null,v=null,t=this;this.scrimUp=function(b){if("google"!=CTATConfig.platform)if(t.ctatdebug("scrimUp ()"),b=CTATGlobals.languageManager.filterString(b),t.ctatdebug("Message: "+
b),!0===scrimIsUp?(f=!0===waitScrim?b:f+(" \n "+b),n.removeComponent(),t.removeHTMLElements()):(f=b,scrimIsUp=!0),t.ctatdebug("drawScrim ()"),"google"==CTATConfig.platform)t.ctatdebug("This is not available for now when we're in this environment");else if($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"),$("#scrim").css("z-index",1E3),"google"!=CTATConfig.platform&&($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>'+
f+"<br><br></div></div></div>"),!0===g&&(m=e(a,"close"),$(m).appendTo("#scrimpanel")),!0===d&&(p=e(h,"yes"),$(p).appendTo("#scrimpanel")),!0===c&&(x=e(l,"no"),$(x).appendTo("#scrimpanel")),!0===waitScrim)){t.ctatdebug("Adding spinner ...");$("#scrimpanel").append("<br>");b=$('<div id="scrim_spin">');b.css("width","100%");b.css("position","relative");$("#scrimpanel").append(b);try{var v=(new Spinner({className:"scrim_spinner"})).spin();$("#scrim_spin").append(v.el)}catch(z){(z instanceof ReferenceError||
z instanceof TypeError)&&t.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.',z,typeof z)}}};this.waitScrimUp=function(){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&t.scrimDownForced(),t.ctatdebug("waitScrimUp ()"),waitScrim=!0,t.scrimUp(CTATGlobals.languageManager.getString("LOADING")))};this.nextProblemScrimUp=function(){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&t.scrimDownForced(),t.ctatdebug("nextProblemScrimUp ()"),
t.scrimUp(CTATGlobals.languageManager.getString("NEXTPROBLEM")))};this.OKScrimUp=function(a,b){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&t.scrimDownForced(),t.ctatdebug("OKScrimUp ("+a+","+b+")"),c=d=g=warnScrim=errorScrim=!1,t.scrimUp(a),v=e(b,"OK"),$(v).appendTo("#scrimpanel"))};this.confirmScrimUp=function(a,b,g){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&t.scrimDownForced(),t.ctatdebug("confirmScrimUp ("+a+","+b+","+g+")"),c=d=!0,l=g,h=b,t.scrimUp(a))};this.errorScrimUp=function(a){"google"!=
CTATConfig.platform&&(!0===scrimIsUp&&t.scrimDownForced(),!1===authorTimeSet?(t.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"),q.push("ERROR: "+a),errorScrim=!0):!1===inAuthorTime?t.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes"):(errorScrim=!0,b("ERROR: "+a)))};this.warningScrimUp=function(a){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&t.scrimDownForced(),!1===authorTimeSet?(t.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"),
q.push("WARNING: "+a),warnScrim=!0):!1===inAuthorTime?t.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes"):(warnScrim=!0,b("WARNING: "+a)))};this.handleTSDisconnect=function(){connectionScrim=!0;t.scrimUp(CTATGlobals.languageManager.getString("TUTORDISCONNECTED"))};this.removeHTMLElements=function(){};this.scrimDown=function(){"google"!=CTATConfig.platform&&(!1===scrimIsUp?t.ctatdebug("The scrim isn't up, returning"):!0===errorScrim?t.ctatdebug("The scrim is up to describe errors to the user, leave it up!"):
!0===warnScrim?t.ctatdebug("The scrim is up to display warnings to the user, leave it up!"):!0===connectionScrim?t.ctatdebug("The scrim is up for a connection issue leave it up!"):t.scrimDownForced())};this.scrimDownForced=function(){$("#scrim").remove();n.removeComponent();t.removeHTMLElements();waitScrim=scrimIsUp=!1;f=""};this.defaultClickHandler=function(){t.ctatdebug("defaultClickHandler ()");t.scrimDown()};this.setInAuthorTime=function(a){t.ctatdebug("setting inAuthorTime = "+a);authorTimeSet=
!0;inAuthorTime=a;if(!a)warnScrim=errorScrim=!1,g&&null.removeChild(m);else if(errorScrim||warnScrim)for(var c in q)b(c)};this.getInAuthorTime=function(){return inAuthorTime}};CTATScrim.prototype=Object.create(CTATBase.prototype);CTATScrim.prototype.constructor=CTATScrim;CTATGlobals.languageManager=CTATLanguageManager.theSingleton;function manualCTATScrim(){console.log("manualCTATScrim ()");CTATScrim.scrim=new CTATScrim;!1===noScrim&&CTATScrim.scrim.waitScrimUp()}window.jQuery?manualCTATScrim():alert("CTAT is unable to access JQuery, please make sure the library is referenced in your html file and loaded before CTAT.");var CTAT={ToolTutor:{interfaceMessages:[],tutorMessages:[]}};
...
decodeURIComponent(g[x].replace(/\+/g," "));ctatdebug("Decoded args: "+e[decodeURIComponent(g[0])])}null!==e&&(ctatdebug("tutorPrep(): Assigning parsed arguments ..."),f=e);e=!1;for(var m in f)if(f.hasOwnProperty(m))switch(ctatdebug("Processing external FlashVar "+m+"("+f[m]+")"),m){case "GENERATED":"on"==f[m]&&(c.session_id=CTATGuid.guid(),e=!0);break;case "BRD":c.question_file=f[m];break;case "BRMODE":c.BehaviorRecorderMode=f[m];break;case "PROBLEM":c.problem_name=f[m];break;case "DATASET":c.dataset_name=
f[m];break;case "LEVEL1":c.dataset_level_name1=f[m];break;case "TYPE1":c.dataset_level_type1=f[m];break;case "LEVEL2":c.dataset_level_name2=f[m];break;case "TYPE2":c.dataset_level_type2=f[m];break;case "LEVEL3":c.dataset_level_name3=f[m];break;case "TYPE3":c.dataset_level_type3=f[m];break;case "LEVEL4":c.dataset_level_name4=f[m];break;case "TYPE4":c.dataset_level_type4=f[m];break;case "USER":c.user_guid=f[m];break;case "SESSION":!1===e&&(c.session_id=f[m]);break;case "SOURCE":c.source_id=f[m];break;
case "LOGTYPE":c.Logging=f[m];break;case "PORT":c.remoteSocketPort=f[m];break;case "REMOTEURL":c.remoteSocketURL=f[m];break;case "DISKDIR":c.log_to_disk_directory=f[m];break;case "log_service_url":c.log_service_url=f[m];break;case "URL":c.log_service_url=f[m];break;case "LOGURL":c.log_service_url=f[m];break;case "CONNECTION":c.tutoring_service_communication=f[m];break;case "SUI":c.sui=f[m];break;case "VAR1":c.var1=f[m];break;case "VAL1":c.val1=f[m];break;case "VAR2":c.var2=f[m];break;case "VAL2":c.val2=
f[m];break;case "VAR3":c.var3=f[m];break;case "VAL3":c.val3=f[m];break;case "VAR4":c.var4=f[m];break;case "VAL4":c.val4=f[m];break;case "SLOG":case "SessionLog":c.SessionLog=f[m];break;case "KEYBOARDGROUP":"Disabled"==f[m]&&(c.keyboard="disabled");"Auto"==f[m]&&(c.keyboard="auto");"On"==f[m]&&(c.keyboard="on");break;default:c[m]=f[m]}}return c};this.getCustomFields=function(){return b};this.setTimeZone=function(b){a.ctatdebug("setTimeZone ("+b+")");null==b||""==b||void 0==b?(b=jstz.determine(),a.ctatdebug("Assigning detected timezone: "+
...
CTATLMS.is.Assistments=function(){return CTATTarget&&"ASSISTMENTS"==CTATTarget};var bundleFormatter="",inBundle=!1,useBundling=!1,useOLIEncoding=!1,CTATCommLibrary=function(a,b){CTATBase.call(this,"CTATCommLibrary",a);var e=authenticityToken="",f=0,d=[],c=a?a:null,g=null==b?!0:b,h=!0,l=null,n=this,q="http",p="ERROR_CONN_TS",x="";this.setUseCommSettings=function(a){h=a};this.getUseCommSettings=function(){return h};this.setConnectionRefusedMessage=function(a){p=a};this.setSocketType=function(a){q=a};this.getSocketType=function(){return q};this.assignHandler=function(a){c=a};this.assignMessageListener=
function(a){l=a};this.encodeVariables=function(a){n.ctatdebug("encodeVariables ()");for(var b="",c=0;c<a.length;c++){var d=a[c];0<c&&(b+="&");b+=d.name;b+="=";b+=encodeURIComponent(d.value)}return b};this.encodeVariablesOLI=function(a){n.ctatdebug("encodeVariablesOLI ()");for(var b="",c=0;c<a.length;c++){var d=a[c];0<c&&(b+="&");b+=d.name;b+="=";b+=encodeURIComponent(d.value)}return b};this.createConnection=function(a,b){n.ctatdebug("createConnection ()");if(!b)return new CTATConnection(a);flashVars.getRawFlashVars();
...
d=a.replace("http:","ws:"),"https:"===window.top.location.protocol&&(console.log("We're embedded in an https window, using wss..."),d=d.replace("ws:","wss:")),c=n.createConnection(c,d),c.setData(b),n.ctatdebug(b)):(c=n.createConnection(c,d),c.setData(b));null!==l&&l.processOutgoing(b);c.send()}};this.processReply=function(a){n.ctatdebug("processReply ("+d.length+","+a+")");var b=0,e;a=[];var f;for(f=0;f<d.length;f++){var h=d[f],m=h.getHTTPObject();n.ctatdebug("Testing connection entry "+f+", readyState: "+
m.readyState+", consumed: "+h.getConsumed()+", status: "+m.status);4==m.readyState&&!1===h.getConsumed()?(n.ctatdebug("Investigating request response: "+b+" -> "+m.status+", for: "+h.getURL()),e=!1,0===m.status&&(e=!0,n.ctatdebug("Received message (status 0): ("+m.responseText+"), status: "+m.status),g&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(p))),408==m.status&&(e=!0,n.ctatdebug("Received message (status 408): "+m.responseText),g&&CTATScrim.scrim.scrimDown()),502==m.status&&
(e=!0,n.ctatdebug("Received message (status 502): "+m.responseText),g&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(ERROR_502))),200==m.status?(e=!0,n.ctatdebug("Processing 200 response ..."),null!==c?(a.push(m.responseText),null!==l&&l.processIncoming(m.responseText)):n.ctatdebug("Error: httphandler is null, can't process response!")):c&&c.processError&&(e=!0,n.ctatdebug("Processing non-200 response, status "+m.status),c.processError(m.status,m.responseText)),!1===e&&n.ctatdebug("Error: status not handled for: "+
m.status),n.ctatdebug("Marking connection as consumed ..."),h.setConsumed(!0)):(0===m.readyState&&n.ctatdebug("Received message (status 0, request not initialized)"),1===m.readyState&&n.ctatdebug("Received message (status 1, server connection established)"),2===m.readyState&&n.ctatdebug("Received message (status 2, request received)"),3===m.readyState&&n.ctatdebug("Received message (status 3, processing request)"));b++}n.cleanup();for(b=0;b<a.length;b++)n.ctatdebug("Processing incoming message: "+
b),e=a[b],-1!=e.indexOf("status=success")?n.ctatdebug("Info: logging success message received, not propagating to message handler"):(n.ctatdebug("Processing incoming message: "+e),c.processMessage(e))};this.processWSReply=function(a){n.ctatdebug("processWSReply() length "+(null===a?null:a.toString().length));"string"==typeof a&&(null!==l&&l.processIncoming(a),-1!=a.indexOf("status=success")?n.ctatdebug("processWSReply() logging success message received, not propagating to message handler: "+a):(n.ctatdebug("Processing incoming message: "+
...
"</context>"):d+"<context />";d+="</problem>";for(c=0;c<b.length;c++)d+="</level>";e+=d+"</dataset>"}c="";b=flashVars.getConditionNames();d=flashVars.getConditionTypes();h=flashVars.getConditionDescriptions();if(0<b.length)for(f=0;f<b.length;f++)c+="<condition><name>"+b[f]+"</name>",c+=""==d[f]?"":"<type>"+d[f]+"</type>",c+=""==h[f]?"":"<desc>"+h[f]+"</desc>",c+="</condition>";var e=e+c,c=flashVars.getCustomFields(),n;for(n in c)c.hasOwnProperty(n)&&(e+="<custom_field>",e+="<name>"+n+"</name>",e+=
"<value>"+c[n]+"</value>",e+="</custom_field>");e+="</context_message>";a.ctatdebug("messageString = "+e);return e};this.createSemanticEventToolMessage=function(f,d,c,g,h,l){a.ctatdebug("createSemanticEventToolMessage("+l+")");var n=new Date;flashVars.getRawFlashVars();var q='<tool_message context_message_id="'+this.getContextName()+'">';h||(q+=this.makeMetaElement(n));d='<semantic_event transaction_id="'+d+'" name="'+c+'"';""!=g&&(d+=' subtype="'+g+'"');void 0!=l&&""!=l&&(d+=' trigger="'+l+'"');
...
l=l+(f+"</event_descriptor>")+this.createCustomFields(b,e);l+="</tool_message>";a.ctatdebug("messageString = "+l);return l};this.createTutorMessage=function(f,d,c,g,h,l,n,q){a.ctatdebug("createTutorMessage()");var p=new Date;flashVars.getRawFlashVars();var x='<tutor_message context_message_id="'+this.getContextName()+'">';q||(x+=this.makeMetaElement(p));d='<semantic_event transaction_id="'+d+'" name="'+c+'"';""!==l&&(d+=' subtype="'+l+'"');x+=d+"/>";f="<event_descriptor>"+f.toXMLString(!0);x+=f+"</event_descriptor>";
...
void 0!=a.SessionLog&&("true"==a.SessionLog?(b.ctatdebug("Turning SessionLog on ..."),e=!0):(b.ctatdebug("Turning SessionLog off ..."),e=!1));!0===e&&this.sendMessage(CTATLogMessageBuilder.commLogMessageBuilder.createLogSessionStart())};this.logSemanticEvent=function(a,c,d,e,g,h,f){b.ctatdebug("logSemanticEvent ("+f+")");b.initCheck();var l=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(g,h);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tool_event_time",
CTATLogMessageBuilder.commLogMessageBuilder.formatTimeStamp(l)+" UTC");a=CTATLogMessageBuilder.commLogMessageBuilder.createSemanticEventToolMessage(c,a,d,e,!0,f);this.sendMessage(a)};this.logTutorResponse=function(a,c,d,e,g,h,f,l,v){b.ctatdebug("logTutorResponse ()");b.initCheck();var m=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(l,v);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tutor_event_time",
CTATLogMessageBuilder.commLogMessageBuilder.formatTimeStamp(m)+" UTC");b.ctatdebug("Formatting feedback ...");void 0!=h&&null!=h?h="<![CDATA["+CTATGlobals.languageManager.filterString(h)+"]]\x3e":(b.ctatdebug("No feedback provided, using empty string"),h="");b.ctatdebug("Creating tutor message ...");a=CTATLogMessageBuilder.commLogMessageBuilder.createTutorMessage(c,a,d,g,h,e,f,!0);this.sendMessage(a)};this.processMessage=function(a){b.ctatdebug("processMessage ()");b.ctatdebug("Response from log server: "+
...
Array.isArray(a)?a.slice():[String(a)]};this.getActionArray=function(){return h};this.appendToInputArray=function(a){p.ctatdebug("appendToInputArray ("+a+")");null==a?p.addArgument("","String","text"):p.addArgument(a,"String","text")};this.setInputArray=function(a){l=[];if(null!=a)for(var b=0;b<a.length;b++)p.appendToInputArray(a[b])};this.getInputArray=function(){p.ctatdebug("getInputArray ("+l.length+")");n=[];for(var a=0;a<l.length;a++){var b=l[a];"object"===typeof b?(p.ctatdebug("Adding object value ("+
b.getValue()+") to temp input array"),n.push(b.getValue())):(p.ctatdebug("Adding string value ("+b+") to temp input array"),n.push(b))}return n};this.setPrompt=function(a){c=a};this.getPrompt=function(){return c};this.propagate=function(a){p.ctatdebug("propagate ()");a=a.getArguments();for(var b=0;b<a.length;b++){var c=a[b],d=l[b];if(null===c||null===d){p.ctatdebug("Internal error: argument lists do not align between received SAI and source SAI");break}d.setValue(c.getValue())}};this.fromString=function(a){a=
q.parse(a);p.fromXML(a)};this.fromXML=function(a){p.ctatdebug("fromXML ()");l=[];a=q.getElementChildren(a);for(var b,c=0;c<a.length;c++){var d=a[c];if("selection"==q.getElementName(d)||"Selection"==q.getElementName(d)){for(var e=q.getElementChildren(d),g=!1,h=0;h<e.length;h++)b=e[h],"value"==q.getElementName(b)&&(b=q.getNodeTextValue(b),1>h?p.setSelectionArray(b):p.appendToSelectionArray(b),g=!0,p.setSelection(b));!1===g&&(b=q.getNodeTextValue(d),p.setSelectionArray(b),p.setSelection(b))}if("action"==
q.getElementName(d)||"Action"==q.getElementName(d)){e=q.getElementChildren(d);g=!1;for(h=0;h<e.length;h++)b=e[h],"value"==q.getElementName(b)&&(b=q.getNodeTextValue(b),1>h?p.setActionArray(b):p.appendToActionArray(b),g=!0,p.setAction(b));!1===g&&(b=q.getNodeTextValue(d),p.setActionArray(b),p.setAction(b))}if("inputArray"==q.getElementName(d)||"value"==q.getElementName(d)||"Input"==q.getElementName(d)){b=q.getElementChildren(d);var f;l=[];e=new CTATHTMLManager;g=new CTATArgument;h=0;l.push(g);for(var n=
0;n<b.length;n++){var m=b[n];"value"==q.getElementName(m)&&(f=q.getElementChildren(m),null!==f?(p.ctatdebug("Parsing SAI input ..."),p.ctatdebug("Childnodes: "+f.length),1===f.length?(f=e.htmlDecode(q.getNodeTextValue(m)),p.ctatdebug("Setting new value to: "+f),g.setValue(f)):(f=e.htmlDecode(q.getNodeTextValue(m)),p.ctatdebug("Setting new value to: "+f),g.setValue(f),g.setName(m.attributes.getNamedItem("name").value),g.setType(m.attributes.getNamedItem("type").value),g.setFormat(m.attributes.getNamedItem("format").value),
h++),1>n?p.setInputArray(f):p.appendToInputArray(f)):(m=e.htmlDecode(q.getNodeTextValue(m)),p.ctatdebug("Setting new value to: "+m),g.setValue(m),1>n?p.setInputArray(m):p.appendToInputArray(m)))}}if("prompt"==q.getElementName(d)||"Prompt"==q.getElementName(d))p.ctatdebug("Parsing prompt ..."),p.setPrompt(q.getNodeTextValue(d))}p.checkDefaultArgument()};this.appendFromElement=function v(a,b,c,d,e){p.ctatdebug("appendFromElement ()");d=String(q.getElementName(b)).toLowerCase();if(d==a||"value"==d)if(d=
...
h=h?h.value:"",l=f.attributes.getNamedItem("category"),l=l?l.value:"",n=f.attributes.getNamedItem("pGuess"),n=n?n.value:"",q=f.attributes.getNamedItem("pLearn"),q=q?q.value:"",p=f.attributes.getNamedItem("pSlip"),p=p?p.value:"",f=(f=f.attributes.getNamedItem("history"))?f.value:"";this.addSkill(d,c,.95,g,h,l,n,q,p,f)}}}else this.ctatdebug("Error: list of skill xml elements is null");else a.ctatdebug("Error: aSkills is null")};this.getSkillSet=function(){return this.internalSkillSet};this.getSize=
function(){return this.internalSkillSet.length};this.addSkill=function(a,e,f,d,c,g,h,l,n,q){this.ctatdebug("addSkill() name = "+a+" level = "+e+" mastery = "+f+" aDescription = "+d+" adisplayName = "+c+" aCategory = "+g+" pguess= "+h+" plearn = "+l+" pslip = "+n+" history = "+q);a=this.setSkillLevel(a,e,f);this.ctatdebug("Configuring "+a.getDisplayName());d&&a.setDescription(d);c&&a.setDisplayName(c);g&&a.setCategory(g);""!==h&&(a.setPGuess(h),a.setPLearn(l),a.setPSlip(n));""!==q&&a.setSkillHistory(q);
...
this.getSAI=function(){return h?t:new CTATSAI};this.getSelection=function(){return h?t.getSelection():""};this.getAction=function(){return h?t.getAction():""};this.getInput=function(){return h?t.getInput():""};this.getSelectionArray=function(){return h?t.getSelectionArray():[]};this.getActionArray=function(){return h?t.getActionArray():[]};this.getInputArray=function(){return h?t.getInputArray():[]};this.getXML=function(){return e};this.getXMLString=function(a){if(e.xml)return e.xml;if(XMLSerializer)return(new XMLSerializer).serializeToString(e);
...
l.push($(this).data("CTATComponent"))});if(0<l.length)return l}CTATShellTools.ctat_base.ctatdebug("JQuery couldn't find the component, let's try our internal list ...");for(var n in e){d=e[n];if(null===d)return CTATShellTools.ctat_base.ctatdebug("Internal error parsing component at index "+n),null;if(null===d.name)return CTATShellTools.ctat_base.ctatdebug("Internal error parsing component at index "+n+" (no name attribute available)"),null;CTATShellTools.ctat_base.ctatdebug("Comparing "+d.name+" to: "+
...
this.processSingleMessage=function(g){e.ctatdebug("processSingleMessage ("+d.getElementName(g)+")");var h=new CTATMessage(g);g=d.getElementChildren(g);e.ctatdebug("Generated CTATMessage, now doing regular processing ...");for(var n=0;n<g.length;n++){var q=g[n];if("properties"==d.getElementName(q)){e.ctatdebug("Parsing properties ...");for(var p=d.getElementChildren(q),x=0;x<p.length;x++){var m=p[x];if("MessageType"==d.getElementName(m)){m=d.getNodeTextValue(m);e.ctatdebug("MessageType: "+m);"StateGraph"==
m&&(console.log("Setting inStartState to true"),CTATMessageHandler.inStartState=!0,a.setGotProblemRestoreEnd(!1),this.processStateGraph(q),a.propagateShellEvent("StateGraph",h));"StartProblem"==m&&(e.ctatdebug("Setting inStartState to true"),CTATMessageHandler.inStartState=!0,a.setGotProblemRestoreEnd(!1),this.processStartProblem(p),a.propagateShellEvent("StartProblem",h));"InterfaceIdentification"==m&&(this.processInterfaceIdentification(p),a.propagateShellEvent("InterfaceIdentification",h));"InterfaceDescription"==
m&&(this.processInterfaceDescription(p),a.propagateShellEvent("InterfaceDescription",h));"GetAllInterfaceDescriptions"==m&&(a.getAllInterfaceDescriptions(),a.propagateShellEvent("GetAllInterfaceDescriptions",h));"SendWidgetLock"==m&&(e.ctatdebug("Found: SendWidgetLock"),a.propagateShellEvent("SendWidgetLock",h));"CorrectAction"==m&&(e.ctatdebug("Found: CorrectAction"),!0===this.getInStartState()?f.push(h):b.processCorrectAction(h),a.propagateShellEvent("CorrectAction",h));"InCorrectAction"==m&&(e.ctatdebug("Found: InCorrectAction"),
!0===CTATMessageHandler.inStartState?f.push(h):(e.ctatdebug("Handing incorrect message to messagehandler ..."),b.processInCorrectAction(h)),a.propagateShellEvent("InCorrectAction",h));"HighlightMsg"==m&&(e.ctatdebug("Found: HighlightMsg"),b.processHighlightMsg(h),a.propagateShellEvent("HighlightMsg",h));"UnHighlightMsg"==m&&(e.ctatdebug("Found: UnHighlightMsg"),b.processUnHighlightMsg(h),a.propagateShellEvent("UnHighlightMsg",h));if("AssociatedRules"==m){e.ctatdebug("Found: AssociatedRules ("+p.length+
")");for(var v="",t="",B=0;B<p.length;B++){var r=p[B];"TutorAdvice"==d.getElementName(r)&&(v=d.getNodeTextValue(r));"Actor"==d.getElementName(r)&&d.getNodeTextValue(r);"Indicator"==d.getElementName(r)&&(t=d.getNodeTextValue(r));"StepID"==d.getElementName(r)&&d.getNodeTextValue(r);"LogAsResult"==d.getElementName(r)&&d.getNodeTextValue(r);"tool_selection"==d.getElementName(r)&&d.getNodeTextValue(r);"Skills"==d.getElementName(r)&&(e.ctatdebug("Processing skills ..."),null===CTATSkillSet.skills&&(e.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."),
CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(r))}b.processAssociatedRules(h,t,v);a.propagateShellEvent("AssociatedRules",h)}"BuggyMessage"==m&&(e.ctatdebug("Found: BuggyMessage"),b.processBuggyMessage(h),a.propagateShellEvent("BuggyMessage",h));"SuccessMessage"==m&&(e.ctatdebug("Found: SuccessMessage"),b.processSuccessMessage(h),a.propagateShellEvent("SuccessMessage",h));-1!=m.indexOf("InterfaceAction")&&(e.ctatdebug("Found: InterfaceAction"),v=h.getSAI(),-1!=v.getAction().indexOf(":")?
(e.ctatdebug("Processing and storing timed interface action : "+v.getAction()),t=parseInt(v.getAction().substring(v.getAction().indexOf(":")+1)),e.ctatdebug("Target time: "+t),v.setAction(v.getAction().substring(0,v.getAction().indexOf(":"))),e.ctatdebug("Timing ..."),setTimeout(b.processInterfaceAction,t,h)):(e.ctatdebug("Processing regular (non-timed) interface action"),!0===CTATMessageHandler.inStartState?(e.ctatdebug("inStartState==true => storing for later playback ..."),f.push(h)):b.processInterfaceAction(h),
a.propagateShellEvent("InterfaceAction",h)));"InterfaceIdentification"==m&&(e.ctatdebug("Found: InterfaceIdentification"),a.propagateShellEvent("InterfaceIdentification",h));"AuthorModeChange"==m&&(e.ctatdebug("Found: AuthorModeChange"),b.globalReset(),a.propagateShellEvent("AuthorModeChange",h));"ResetAction"==m&&(e.ctatdebug("Found: ResetAction"),b.globalReset(),a.propagateShellEvent("ResetAction",h));if("ShowHintsMessage"==m){e.ctatdebug("Found: ShowHintsMessage");v=!1;t=[];for(B=0;B<p.length;B++)if(r=
p[B],"HintsMessage"==d.getElementName(r))for(var r=d.getElementChildren(r),z=0;z<r.length;z++){var A=r[z];"value"==d.getElementName(A)&&(t.push(d.getNodeTextValue(A)),v=!0)}!0===v?b.processHintResponse(h,t):e.ctatdebug("Error: incomplete hint message received");a.propagateShellEvent("ShowHintsMessage",h)}"ConfirmDone"==m&&(e.ctatdebug("Found: ConfirmDone"),b.processConfirmDone(h),a.propagateShellEvent("ConfirmDone",h));"VersionInfo"==m&&(e.ctatdebug("Found: VersionInfo"),b.processVersionInfo(p),a.propagateShellEvent("ConfirmDone",
h));"TutoringServiceAlert"==m&&(e.ctatdebug("Found: TutoringServiceAlert"),b.processTutoringServiceAlert(p),a.propagateShellEvent("TutoringServiceAlert",h));"TutoringServiceError"==m&&(e.ctatdebug("Found: TutoringServiceError"),b.processTutoringServiceError(p),a.propagateShellEvent("TutoringServiceError",h));"ProblemSummaryResponse"==m&&(e.ctatdebug("Found: ProblemSummaryResponse"),b.processProblemSummaryResponse(h),a.propagateShellEvent("ProblemSummaryResponse",h));if("StartStateEnd"==m){e.ctatdebug("Found: StartStateEnd");
CTATShellTools.listComponents();null!==b?b.processStartState():this.ctatdebug("Error: no message handler object available to process start state");try{e.processStartStateActions()}catch(E){e.ctatdebug("Caught in the act: "+E.message)}CTATMessageHandler.inStartState=!1;a.propagateShellEvent("StartStateEnd",h)}"ProblemRestoreEnd"==m&&(e.ctatdebug("Found: ProblemRestoreEnd"),b.processProblemRestoreEnd(h),a.propagateShellEvent("ProblemRestoreEnd",h));"GetURL"==m&&(e.ctatdebug("Found: GetURL"),b.processGetURL(h),
a.propagateShellEvent("GetURL",h));"InterfaceReboot"==m&&(c++,1<c&&(m=CTATLMS.is.Authoring()?location.href:null,console.log("Found: InterfaceReboot #"+c+" -- href "+m),m?location.replace(m):(m="ws://"+CTATConfiguration.get("remoteSocketURL")+":"+CTATConfiguration.get("remoteSocketPort"),console.log("closing connection w/ url: "+m),a.closeWSConnection(m,function(){var a=window.frameElement.getAttribute("id"),a=new CustomEvent("refreshIframe",{detail:a});window.parent.document.dispatchEvent(a)},"interfaceReboot"))))}}}}};
...
a.length+")");for(var b="Unknown",c="Unknown",g=null,h=0;h<a.length;h++){var f=a[h];e.ctatdebug("Inspecting element: "+d.getElementName(f));"WidgetType"==d.getElementName(f)&&(e.ctatdebug("Widget type: "+d.getNodeTextValue(f)),b=d.getNodeTextValue(f));"CommName"==d.getElementName(f)&&(e.ctatdebug("Instance name: "+d.getNodeTextValue(f)),c=d.getNodeTextValue(f));if("serialized"==d.getElementName(f)){e.ctatdebug("Prepareing to de-serialize component ...");for(var m=d.getElementChildren(f),v=0;v<m.length;v++){var t=
m[v];-1!=d.getElementName(t).indexOf("CTAT")&&(g=t)}}"interface"==d.getElementName(f)&&(e.ctatdebug("Storing interface for post start-state reconstruction ..."),CTATGlobals.interfaceElement=f);"script"==d.getElementName(f)&&(e.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."),scriptElement=d.getNodeTextValue(f))}null!==g?this.deserializeComponent(b,c,g):e.ctatdebug("Error: unable to find CTAT serialization point of attachement");e.ctatdebug("processInterfaceDescription () done")};
this.deserializeComponent=function(a,b,c){e.ctatdebug("deserializeComponent ("+a+","+b+")");if(!0===CTATGlobals.ignoreInterfaceDescriptions)e.ctatdebug("ignoreInterfaceDescriptions==true");else if(null===d.getElementAttr(c,"x"))e.ctatdebug("Warning: this component does not have x,y information. Probably an older component");else{var g=d.getElementAttr(c,"x"),h=d.getElementAttr(c,"y"),f=d.getElementAttr(c,"width"),l=d.getElementAttr(c,"height"),n=d.getElementAttr(c,"tabIndex"),t=d.getElementAttr(c,
"zIndex");null===n&&(n=-1);null===t&&(t=0);var B=new CTATComponentDescription;B.type=a;B.name=b;B.x=Math.floor(g);B.y=Math.floor(h);B.tabIndex=n;B.zIndex=t;B.width=Math.floor(f);B.height=Math.floor(l);CTATShellTools.registerComponentDescription(B);c=d.getElementChildren(c);for(g=0;g<c.length;g++){h=c[g];d.getElementName(h);if("Parameters"==d.getElementName(h))for(this.ctatdebug("Processing component parameters ..."),f=d.getElementChildren(h)[0],f=d.getElementChildren(f),l=0;l<f.length;l++){var r=
f[l];if("CTATComponentParameter"==d.getElementName(r)){this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");for(var t=n=void 0,r=d.getElementChildren(r),z=0;z<r.length;z++){var A=r[z];"name"==d.getElementName(A)&&(this.ctatdebug("Found parameter name: "+d.getNodeTextValue(A)),n=d.getNodeTextValue(A));"value"==d.getElementName(A)&&(this.ctatdebug("Found parameter value: "+d.getNodeTextValue(A)),t=d.getNodeTextValue(A).trim())}this.ctatdebug("Parameter name: "+n+", value: "+
t);void 0!==n&&(B.params[n]=t,"group"==n&&(B.groupName=t))}}if("Styles"==d.getElementName(h))for(this.ctatdebug("Processing component styles ..."),h=d.getElementChildren(h)[0],h=d.getElementChildren(h),f=0;f<h.length;f++)if(t=h[f],"CTATStyleProperty"==d.getElementName(t)){this.ctatdebug("Processing style property (CTATStyleProperty) ...");n=l="";t=d.getElementChildren(t);for(r=0;r<t.length;r++)z=t[r],"name"==d.getElementName(z)&&(l=d.getNodeTextValue(z)),"value"==d.getElementName(z)&&(n=d.getNodeTextValue(z).trim());
this.ctatdebug("Style (name: "+l+", value: "+n+")");""!==l&&(B.styles[l]=n)}}e.ctatdebug("deserializeComponent ("+a+","+b+") done")}};this.processStartStateActions=function(){e.ctatdebug("processStartStateActions ("+f.length+")");if(0===f.length)e.ctatdebug("No start state messages, bump");else if(0<CTATMessageHandler.startStateHandlers.length)for(var a=0;a<CTATMessageHandler.startStateHandlers.length;a++)CTATMessageHandler.startStateHandlers[a].processStartStateActions(f);else{for(a=0;a<f.length;a++){var c=
...
l.push(b.getProperty("StepID"));var n=b.getCustomFields(),p;for(p in n)f.push(p),l.push(n[p]);p=b.getSkillsObject();d.updateSkillWindow(p);ctatdebug("Sending log message ...");null!=commLoggingLibrary?m&&commLoggingLibrary.logTutorResponse(b.getTransactionID(),logHintSAI,c,"",h,g,p,f,l):this.ctatdebug("Info: no logging library available!");"done"==logHintSAI.getSelection()&&"Correct"==b.getIndicator()&&(b=e.createProblemSummaryRequestMessage(),a.sendXML(b))}else d.updateSkillWindow(null);d.ctatdebug("processAssociatedRules() done")};
this.processBuggyMessage=function(a){d.ctatdebug("processBuggyMessage()");this.showFeedback(a.getBuggyMsg())};this.processSuccessMessage=function(a){d.ctatdebug("processSuccessMessage()");this.showFeedback(a.getSuccessMessage())};this.processInterfaceAction=function(a){d.ctatdebug("processInterfaceAction ()","commShell");null!=commLoggingLibrary?m&&commLoggingLibrary.logSemanticEvent(a.getTransactionID(),a.getSAI(),"ATTEMPT","tutor-performed"):this.ctatdebug("Info: no logging library available!");
...
try{document.close()}catch(t){alert("Error closing document: "+t.message)}try{document.write(b)}catch(t){alert("Error writing document: "+t.message)}}};this.updateSkillWindow=function(a){d.ctatdebug("updateSkillWindow()");CTATSkillSet.skills.untouchSkills();var b=CTATShellTools.findComponentByClass("CTATSkillWindow");null!==b?null!=a?b.updateSkillSet(a):b.drawComponent():d.ctatdebug("Info: no skill window available")};this.processComponentFocus=function(a){d.ctatdebug("processComponentFocus("+a.getName()+
...
CTATComponentReference.getComponentFromID=function(a){var b=CTATComponentReference.components;return b.hasOwnProperty(a)?(a=b[a],a.getElement()?a.getElement():null):null};CTATComponentReference.add=function(a,b){var e=new CTATComponentReference(a,b);return CTATComponentReference.components[e.getDiv().getAttribute("id")]=e};var CTATCompBase=function(a,b,e,f,d,c){CTATBase.call(this,a,b);var g=e||0,h=f||0,l=d||-2,n=c||-2,q=50,p=25,x=!1,m=!1,v="",t=!1,B=!0,r=null,z="",A=null;this.isTabIndexable=!0;var E=0,I=null,w=this,D=null,u="hidden",C=CTATGlobalFunctions.gensym.z_index(),F=CTATGlobalFunctions.gensym.div_id(),y=CTATGlobalFunctions.gensym.z_index(),H=CTATGlobalFunctions.gensym.div_id();this.setIsAbstractComponent=function(a){x=a};this.isAbstractComponent=function(){return x};this.setIsFeedbackComponent=function(a){m=
a};this.isFeedbackComponent=function(){return m};this.setTabIndex=function(a){!0===this.isTabIndexable?(A=a,0>A?(A=CTATGlobals.Tab.Tracker,CTATGlobals.Tab.Tracker++):CTATGlobals.Tab.Tracker=A):A=-1};this.getTabIndex=function(){return A||this.getComponent().getAttribute("tabindex")};this.setStyles=function(){};this.setTabOrder=function(a){console.log("setTabIndex( "+a+" )");this.getComponent()&&(console.log("found comp"),isNaN(a)||(console.log("is a number"),this.getComponent().setAttribute("tabindex",
a)))};this.setZIndex=function(a){w.ctatdebug("Setting z index to: "+a);E=a;null!==r&&(r.style.zIndex=a)};this.getZIndex=function(){return E};this.setDefaultWidth=function(a){q=a};this.getDefaultWidth=function(){return q};this.setDefaultHeight=function(a){p=a};this.getDefaultHeight=function(){return p};this.processCommShellEvent=function(a,b){w.ctatdebug("processCommShellEvent ("+a+")")};this.makeDivWrapper=function(a){r=document.createElement("div");r.id=this.getName();r.setAttribute("onkeypress",
"return noenter(event)");r.setAttribute("data-ctat-component",this.getClassName());r.style.position="absolute";r.style.left=g+"px";r.style.top=h+"px";r.style.zIndex=C;r.style.width=w.getWidth()+"px";r.style.height=w.getHeight()+"px";$(r).data("CTATComponent",this);a.appendChild(r)};this.setDivWrapper=function(a){r=a;r.setAttribute("data-ctat-component",this.getClassName())};var G=this.setClassName;this.setClassName=function(a){G(a);r&&r.setAttribute("data-ctat-component",this.getClassName())};this.wrapComponent=
function(a){w.ctatdebug("wrapComponent ()");w.makeDivWrapper(a);w.ctatdebug("wrapComponent () done")};this.createCanvas=function(){w.ctatdebug("createCanvas ()");D=document.createElement("canvas");D.setAttribute("id",H);D.setAttribute("onkeypress","return noenter(event)");D.setAttribute("width",l+canvasCalibrate+"px");D.setAttribute("height",n+canvasCalibrate+"px");D.setAttribute("style","border: 1px "+this.borderColor+" solid; "+("hidden"==u?"visibility: hidden; ":"")+"z-index:"+y+";");r.firstChild?
r.insertBefore(D,r.firstChild):r.appendChild(D);return D};this.redraw=function(){var a=r.style.display;r.style.display="none";r.style.display=a};this.setCanvasVisibility=function(a){u=a};this.getSubCanvasCtx=function(){if(D)return D.getContext("2d")};this.getSubCanvas=function(){return D};this.getX=function(){return g};this.getY=function(){return h};this.getWidth=function(){if(0>=l){var a;I?a=window.getComputedStyle(I):r&&(a=window.getComputedStyle(r));if(a)return parseFloat(a.width)}return l};this.getHeight=
function(){if(0>=n&&r){var a=window.getComputedStyle(r);return parseFloat(a.getPropertyValue("height"))}return n};this.getText=function(){return v};this.getEnabled=function(){return B};this.assignEnabled=function(a){B=a;r.setAttribute("data-ctat-enabled",B)};this.setEnabled=function(a){w.ctatdebug("setEnabled ("+a+")");w.assignEnabled(a);I?I.disabled=!B:w.ctatdebug("Error: component pointer is null")};this.lock=this.setEnabled.bind(w,!1);this.unlock=this.setEnabled.bind(w,!0);this.getDivWrap=function(){return r};
...
this.initialize=function(){w.ctatdebug("initialize ()");w.configFromDescription();w.init();w.processSerialization();w.render();w.processTabOrder();w.ctatdebug("initialize () done")};this.getInitialized=function(){return t};this.setInitialized=function(a){w.ctatdebug("setInitialized ("+a+")");t=a;!0!==t||r?w.ctatdebug("Not wrapping, initialized="+t+", divWrapper = "+r):(w.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."),(a=findPointOfAttachment(this.getName()))?
...
w.ctatdebug("implement in child class")};this.move=function(a,b){g=Number(a);h=Number(b);if(void 0===b||null===b||isNaN(h))if(0<=a.indexOf(",")){var c=a.split(",");g=Number(c[0]);h=Number(c[1])}else h=0;g=isNaN(g)?0:g;h=isNaN(h)?0:h;r&&(r.style.left=g+"px",r.style.top=h+"px")};this.setSize=function(a,b){var c=Number(a),d=Number(b);(void 0===b||null===b||isNaN(d))&&0<=a.indexOf(",")&&(d=a.split(","),c=Number(d[0]),d=Number(d[1]));w.ctatdebug("setSize ("+c+","+d+")");isNaN(c)||w.setWidth(c);isNaN(d)||
w.setHeight(d)};this.SetVisible=this.setVisible=function(a){a=CTATGlobalFunctions.toBoolean(a);u=!0===a?"block":"hidden";D&&D.setAttribute("style","border: 0px; position: absolute; "+(a?"":"visibility:hidden; ")+"; left:"+g+"px; top:"+h+"px; z-index:"+y+";");r.style.visibility=!0===a?null:"hidden"};this.FadeIn=function(a){w.SetVisible(!0)};this.FadeOut=function(a){w.SetVisible(!1)};this.reset=function(){};this.setX=function(a){this.x=a;r.style.left=this.x+"px";!0===t&&this.render()};this.setY=function(a){this.y=
a;r.style.top=this.y+"px";!0===t&&this.render()};this.setWidth=function(a){w.ctatdebug("setWidth ("+a+")");l=a;r?r.style.width=l+"px":w.ctatdebug("Internal error: no div wrapper available to set width")};this.setHeight=function(a){w.ctatdebug("setHeight ("+a+")");n=a;r?r.style.height=n+"px":w.ctatdebug("Internal error: no div wrapper available to set height")};this.setText=function(a){v=a;return this};this.getValue=function(){return I?I.value:""};this.backgrade=!1;this.unHighlightAll=function(){$(".CTAT--hint").each(function(){for(var a=
...
CTAT.Component.Base.Style.prototype.constructor=CTAT.Component.Base.Style;CTAT.Component.Base.Graphical=function(a,b,e,f,d,c,g){CTAT.Component.Base.Style.call(this,a,b,f,d,c,g);var h=e||(new CTATComponentDescription).setGenericDefaults();this.getGrDescription=function(){return h};this.setGrDescription=function(a){h=a;this.processDescription(h)};var l={},n={};this.getAlign=function(){return this.component?$(this.component).css("text-align"):$(this.getDivWrap()).css("text-align")};this.setAlign=function(a){this.component&&(this.component.style.textAlign=a);return this};this.getBackgroundColor=
...
a)};this.setParameterHandler("DisableOnCorrect",this.setDisableOnCorrect);var m=!0;this.getShowHintHighlight=function(){return m};this.setShowHintHighlight=function(a){m=CTATGlobalFunctions.toBoolean(a)};this.setParameterHandler("ShowHintHighlight",this.setShowHintHighlight);this.data_ctat_handlers["show-hint-highlight"]=function(a){m=CTATGlobalFunctions.toBoolean(a)};var v=CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED;this.getComponentStatus=function(){return v};this.setComponentStatus=
...
{detail:{component:this},bubbles:!0,cancelable:!0});this.getDivWrap().dispatchEvent(a)}};this.showHintHighlight=function(a,b){this.component.classList.remove("CTAT--correct");this.component.classList.remove("CTAT--incorrect");a?this.component.classList.add("CTAT--hint"):this.component.classList.remove("CTAT--hint")};this.setHintHighlight=function(a,b){this.ctatdebug("setHintHighlight ("+a+")");if(m){var c=CTATGlobalFunctions.toBoolean(a);if(this.component){var d=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.highlight,
{detail:{isHighlighted:c,component:this},bubbles:!0,cancelable:!0});this.getDivWrap().dispatchEvent(d)}c!==x&&(x=c,this.showHintHighlight(c,b))}};this.moveHintHighlight=function(a,b){this.ctatdebug("moveHintHighlight ("+a+")");CTATGlobals.Tab.previousFocus=CTATGlobals.Tab.Focus;CTATGlobals.Tab.Focus=p;p.component.focus?CTATGlobals.Tab.Focus.getComponent().focus():CTATGlobals.Tab.Focus.getDivWrap().focus();if(m){var c=CTATGlobalFunctions.toBoolean(a);if(this.component){var d=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.highlight,
...
this.getCheckBox=function(){return c};this.setStyleHandler("labelPlacement",null);var n=function(a){this.updateSAI();this.processClick(a)};this.init=function(){l.setInitialized(!0);c=document.createElement("input");c.type="checkbox";c.setAttribute("id",this.getName()+"_check");c.classList.add("CTATCheckBox--button");this.getText()?c.value=l.getText():this.getDivWrap()&&this.getDivWrap().textContent?c.value=this.getDivWrap().textContent:c.value=c.id;this.getComponentGroup()?c.name=l.getComponentGroup():
...
a&&!h?g.innerHTML=a:this.getDivWrap().getAttribute("data-ctat-label")&&this.setText(this.getDivWrap().getAttribute("data-ctat-label"));$(this.getDivWrap()).append(g);l.setComponent(c);c.addEventListener("click",n.bind(this));c.addEventListener("focus",l.processFocus);c.onfocus=this.processOnFocus;this.setSelection(this.getComponentGroup());this.setStyles()};this.resize=function(){var a=$(this.getDivWrap()).height();$(g).css("font-size",a-5+"px");$(this.getComponent()).css("height",a-10+"px");$(this.getComponent()).css("width",
a-10+"px")};this.getConfigurationActions=function(){var a=[],b;0<g.innerHTML.trim().length&&(b=new CTATSAI,b.setSelection(this.getName()),b.setInput(g.innerHTML.toString()),b.setAction("setText"),a.push(b));return a};var q=this.setText;this.setText=function(a){l.ctatdebug("setText ("+a+")");q(a);c&&(c.value=a,g.innerHTML=a)};this.setStyleHandler("labelText",this.setText);var p=this.setEnabled;this.setEnabled=function(a){p(a);c&&(c.disabled=!this.getEnabled())};this.getCheckBoxInput=function(){return g.innerHTML+
...
return a.value+": "+a.checked});this.setSelection(c.name);this.setAction("UpdateCheckBox");this.setInput(a.join(";"))};var x=function(a){g.classList.add(a);c.classList.add(a)},m=function(a){g.classList.remove(a);c.classList.remove(a)};this.showCorrect=function(a){m("CTAT--incorrect");m("CTAT--hint");x("CTAT--correct")};this.removeCorrect=m.bind(this,"CTAT--correct");this.showInCorrect=function(a){m("CTAT--correct");m("CTAT--hint");x("CTAT--incorrect")};this.removeInCorrect=m.bind(this,"CTAT--incorrect");
this.showHintHighlight=function(a){m("CTAT--incorrect");m("CTAT--correct");a?x("CTAT--hint"):m("CTAT--hint")}};CTATCheckBox.prototype=Object.create(CTAT.Component.Base.Clickable.prototype);CTATCheckBox.prototype.constructor=CTATCheckBox;CTATCheckBox.escape=function(a){return a.replace(/[-[\]{}()*+?.,\\^$|#\s\/]/g,"\\$&")};CTAT.ComponentRegistry.addComponentType("CTATCheckBox",CTATCheckBox);var CTATComboBox=function(a,b,e,f,d){CTAT.Component.Base.Clickable.call(this,"CTATComboBox","__undefined__",a,b,e,f,d);var c=this,g=null;this.component=null;var h=CTATConfiguration.get("previewMode");this.setAction("UpdateComboBox");var l=",";a=function(a){l=a;g&&(g.innerHTML="",this.addLabels(n,l))}.bind(this);this.setStyleHandler("SplitCharacter",a);this.data_ctat_handlers["split-on"]=a;var n=null;this.setLabels=function(a){n=a;g&&(g.innerHTML="",this.addLabels(n,l))}.bind(this);this.setStyleHandler("Labels",
...
f=parseInt(c.getPropertyValue("border-left-width")),h=parseInt(c.getPropertyValue("border-right-width")),B=parseInt(c.getPropertyValue("border-bottom-width")),c=parseInt(c.getPropertyValue("border-right-width"));a.width-=b+g+f+c;a.height-=d+e+h+B;return a}};CTAT.Component.Base.SVG.prototype=Object.create(CTAT.Component.Base.Clickable.prototype);CTAT.Component.Base.SVG.prototype.constructor=CTAT.Component.Base.SVG;CTAT.Component.Base.UnitDisplay=function(a,b,e,f,d,c,g){CTAT.Component.Base.SVG.call(this,a,b,e,f,d,c,g);var h="1/2+1/4+(0*1/8)";this.setActionInput("SetPieces",h);var l="#800080";this.color=l;var n=1;this.colorAlpha=n;var q="#800080";this.deselectedColor=q;var p=.3;this.deselectedColorAlpha=p;var x="black";this.piece_border_color=x;this.piece_border_thickness=1;this.getPieceBorderColor=function(){return x};this.setPieceBorderColor=function(a){x=CTATGlobalFunctions.formatColor(a);return this};var m=
[],v=this;this.generateClassname=function(){return this.getName()+" UnitPart"};this.getPieces=function(){return m};var t=function(a){if(a.hasAttributeNS(null,"data-selected"))return CTATGlobalFunctions.toBoolean(a.getAttributeNS(null,"data-selected"));a.setAttributeNS(null,"data-selected",!0);return!0};this.getPiecesBySelected=function(a){for(var b=this.getPieces(),c=[],d,e=0;e<b.length;e++)d=b[e],t(d)===a&&c.push(d);return c};this.getSelectedPieces=this.getPiecesBySelected.bind(this,!0);this.getDeselectedPieces=
this.getPiecesBySelected.bind(this,!1);this.getColor=function(){return l};this.getColorAlpha=function(){return n};this.getDeselectedColor=function(){return q};this.getDeselectedColorAlpha=function(){return p};this.setColor=function(a){this.color=l=CTATGlobalFunctions.formatColor(a);a=this.getSelectedPieces();for(var b=0;b<a.length;b++)$(a[b]).css("fill",l)};this.setColorAlpha=function(a){n=Number(a);this.colorAlpha=n=isNaN(n)?1:n;a=this.getSelectedPieces();for(var b=0;b<a.length;b++)$(a[b]).css("fill-opacity",
n)};this.setDeselectedColor=function(a){this.deselectedColor=q=CTATGlobalFunctions.formatColor(a);a=this.getDeselectedPieces();for(var b=0;b<a.length;b++)$(a[b]).css("fill",l)};this.setDeselectedColorAlpha=function(a){p=Number(a);isNaN(p)&&(p=.3);this.deselectedColorAlpha=p;a=this.getDeselectedPieces();for(var b=0;b<a.length;b++)$(a[b]).css("fill-opacity",p)};this.valueOf=function(){return this.evaluate()};this.getValue=function(){return h};this.setValue=function(a){h=String(a);this.setInput(h);this.clear();
...
"data-selected",c);a.setAttributeNS(null,"data-value",b.toString());a.dataValue=b;this.getEnabled()&&(a.style.cursor="pointer");a.addEventListener("click",this.clickHandler);m.push(a)};var r=this.setEnabled;this.setEnabled=function(a){r(a);m.forEach(function(b){b.style.cursor=a?"pointer":"default"})};this.clear=function(){m=[]};var z=function(a,b){var c=a.toString();!1===b&&(c="(0*"+c+")");return c};this.AddPiece=function(a,b){if(a){var c=new CTAT.Math.Fraction(a);if(0<CTAT.Math.round(c.valueOf())){var d=
...
function(){this.drawPieces()};this.drawPieces=function(){if(this.baseGroup){this.clear();for(var a=this.parseValue(),b=0,d=document.createDocumentFragment(),e=0;e<a.length;e++){var f=a[e],p=100*f,x=document.createElementNS(c,"rect");x.classList.add("CTATFractionBar--piece");x.setAttributeNS(null,"height","100%");x.setAttributeNS(null,"width",p+"%");x.setAttributeNS(null,"y",0);x.setAttributeNS(null,"x",b+"%");this.addPieceElem(x,f,f.selected);d.appendChild(x);var m=document.createElementNS(c,"text");
m.classList.add("CTATFractionBar--label");m.setAttributeNS(null,"text-anchor","middle");m.setAttributeNS(null,"dominant-baseline","middle");d.appendChild(m);var x=""+String(f.numerator),f=""+String(f.denominator),v=document.createElementNS(c,"tspan"),t=document.createElementNS(c,"tspan");v.appendChild(document.createTextNode(x));t.appendChild(document.createTextNode(f));m.appendChild(v);m.appendChild(t);m=b+p/2;v.setAttributeNS(null,"x",m+"%");v.setAttributeNS(null,"y","60%");v.setAttributeNS(null,
"dy","-1em");t.setAttributeNS(null,"x",m+"%");t.setAttributeNS(null,"y","60%");x.length>f.length?v.style.textDecoration="underline":t.style.textDecoration="overline";b+=p}this.baseGroup.innerHTML="";this.baseGroup.appendChild(d);var B=this.baseGroup.getBBox().width-1;Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a){if("rect"==a.nodeName){var b=window.getComputedStyle(a),c=parseFloat(b.getPropertyValue("padding-left")),d=parseFloat(b.getPropertyValue("stroke-width")),b=a.getBBox();
...
CTATHintButton.prototype=Object.create(CTAT.Component.Base.Clickable.prototype);CTATHintButton.prototype.constructor=CTATHintButton;CTAT.ComponentRegistry.addComponentType("CTATHintButton",CTATHintButton);var CTATHintWindow=function(a,b,e,f,d){CTAT.Component.Base.Graphical.call(this,"CTATHintWindow","__undefined__",a,b,e,f,d);var c=this;c.isTabIndexable=!1;var g=null,h=null,l=null,n=null,q=CTATGlobals.languageManager.getString("NEXT"),p=CTATGlobals.languageManager.getString("PREVIOUS"),x=null;this.data_ctat_handlers["next-content"]=function(a){x=a;l&&(l.innerHTML=a)};var m=null;this.data_ctat_handlers["previous-content"]=function(a){m=a;h&&(h.innerHTML=a)};this.getCurrentHint=function(){return g.innerHTML};
this.init=function(){c.ctatdebug("init ("+c.getName()+")");c.setInitialized(!0);c.setIsAbstractComponent(!0);n=this.getDivWrap();n.id||n.setAttribute("id",CTATGlobalFunctions.gensym.div_id());n.setAttribute("onkeypress","return noenter(event)");c.setComponent(n);c.addComponentReference(c,n);g=document.createElement("div");n.appendChild(g);g.classList.add("CTATHintWindow--hint-content");var a=document.createElement("div");a.classList.add("CTATHintWindow--hint-button-area");n.appendChild(a);if(m)h=
document.createElement("button"),h.classList.add("CTATHintWindow--previous"),h.innerHTML=m;else{h=document.createElement("button");h.classList.add("CTATHintWindow--previous");var b=document.createElement("span");b.classList.add("CTATHintWindow--button-icon");b.textContent="\u25c0";h.appendChild(b);p&&(b.style.cssFloat="left",h.appendChild(document.createTextNode(p)))}h.addEventListener("click",function(a){CTATShellTools.showPrevHint()},!1);a.appendChild(h);x?(l=document.createElement("button"),l.classList.add("CTATHintWindow--next"),
...
b=CTAT.Geom.Point.polar(20,this.angle()),a=a.add(b.scale(-1));a.x=CTAT.Math.round(a.x);a.y=CTAT.Math.round(a.y);e.max_loc=a}return e.max_loc}});var h=c;Object.defineProperty(this,"min",{get:function(){return h},set:function(a){e={};h=a}});var l=d;Object.defineProperty(this,"max",{get:function(){return l},set:function(a){e={};l=a}});Object.defineProperty(this,"length",{get:function(){e.hasOwnProperty("length")||(e.length=CTAT.Math.round(this.min_loc.distance(this.max_loc)));return e.length}});this.isHorizontal=
...
f.setAttributeNS(null,"text-anchor","middle");d.appendChild(f);if(null===b||void 0===b)if(1==a.denominator)f.appendChild(document.createTextNode(String(a.numerator.toPrecision(S)))),f.setAttributeNS(null,"x",c.x),f.setAttributeNS(null,"y",c.y);else{b=""+String(a.numerator);h=""+String(a.denominator);f.style.fontSize="0.6em";f.setAttributeNS(null,"text-align","center");var l=document.createElementNS(g,"tspan"),m=document.createElementNS(g,"tspan");l.appendChild(document.createTextNode(b));m.appendChild(document.createTextNode(h));
f.appendChild(l);f.appendChild(m);l.setAttributeNS(null,"text-anchor","middle");l.setAttributeNS(null,"x",c.x);l.setAttributeNS(null,"y",c.y);l.setAttributeNS(null,"dy","-1em");m.setAttributeNS(null,"text-anchor","middle");m.setAttributeNS(null,"x",c.x);m.setAttributeNS(null,"y",c.y);b.length>h.length?l.style.textDecoration="underline":m.style.textDecoration="overline"}else f.appendChild(document.createTextNode(b.toString())),d.appendChild(tlabel),f.setAttributeNS(null,"x",c.x),f.setAttributeNS(null,
"y",c.y);e.label=f}}return d};var m=function(){if(null!==this.X_Axis&&null!==this.X_Axis.svg_group){var a=this.getBoundingBox(),b=window.getComputedStyle(this._axis_line_group),b=parseInt(b.getPropertyValue("stroke-width")),a=CTAT.Geom.Rectangle.inflate(a,-b,-b),c=new DOMPoint(a.width/2,a.height/2),d=c.add(CTAT.Geom.Point.polar(Math.min(40,a.height,a.width)/4,this.theta)),e=Math.sin(this.theta),f=-Math.cos(this.theta),m=e*c.x+f*c.y,p=-a.height*f,t=-e*a.width,b=new DOMPoint(a.left,c.y),c=new DOMPoint(a.right,
c.y);if(0<Math.abs(CTAT.Math.round(p))){var p=new DOMPoint(a.left,(m-e*a.left)/f),q=new DOMPoint(a.right,(m-e*a.right)/f);if(a.contains(p)||a.contains(q))d.distance(p)<d.distance(q)?(b=q,c=p):(b=p,c=q)}0<Math.abs(CTAT.Math.round(t))&&(t=new DOMPoint((m-f*a.top)/e,a.top),e=new DOMPoint((m-f*a.bottom)/e,a.bottom),a.contains(t)||a.contains(e))&&(d.distance(t)<d.distance(e)?(b=e,c=t):(b=t,c=e));if(this.X_Axis.start.x!=b.x||this.X_Axis.start.y!=b.y||this.X_Axis.end.x!=c.x||this.X_Axis.end.y!=c.y)this.X_Axis.start=
...
e=new DOMPoint(a.cx.baseVal.value,a.cy.baseVal.value),1<d.distance(e)&&(a.cx.baseVal.value=d.x,a.cy.baseVal.value=d.y)}}.bind(this),v=0,t=null,B=new DOMPoint(-30,-30),r=!1,z=function(a){B.x=a.clientX;B.y=a.clientY},A=function(a){cancelAnimationFrame(v);t.style.visibility="hidden";r=!1},E=function(a){if(!0===this.getEnabled()&&0<q){this.setHintHighlight(!1);var b;x?(a=u(a.clientX,a.clientY),b=a.location,a=a.data):(a=w(a.clientX,a.clientY),b=this.X_Axis.getProjectedPoint(a),a=this.X_Axis.getAxisValue(a));
...
c=new DOMPoint(this.svgPoint.x,this.svgPoint.y);if(I){var d=$(this.component),e=parseInt(d.css("borderLeftWidth"))+parseInt(d.css("paddingLeft"))+parseInt(d.css("marginLeft")),d=parseInt(d.css("borderTopWidth"))+parseInt(d.css("paddingTop"))+parseInt(d.css("marginTop"));c.x-=e;c.y-=d}return c}.bind(this),D=function(a,b){return this.getProjectedPoint(w(a,b))}.bind(this.X_Axis),u=function(a,b){for(var c=D(a,b),d=null,e=Number.POSITIVE_INFINITY,g,f,h=0;h<this._tickmarks.length;h++)g=this._tickmarks[h],
f=c.distance(g.location),f<e&&(d=g,e=f);return d}.bind(this),C=function(){if(r&&!0===this.getEnabled()){if(x){var a=u(B.x,B.y);t.setAttributeNS(null,"transform","translate"+CTAT.Geom.Point.to2DString(a.location,!0))}else t.setAttributeNS(null,"transform","translate"+CTAT.Geom.Point.to2DString(D(B.x,B.y),!0));v=requestAnimationFrame(C)}}.bind(this);this.render=function(){m()};this.calcXCoordinate=function(a){a=new c(a);var b=this.getWidth()-30,b=Math.abs(b-30),d=max.subtract(min);return 30+a.subtract(min).divide(d)/
...
Y(a)?(this.setAction("set_maximum"),this.setInput(this.Maximum.toString())):X(a)?(this.setAction("set_minimum"),this.setInput(this.Minimum.toString())):W(a)?(this.setAction("set_large_step"),this.setInput(h.step.toString())):V(a)?(this.setAction("set_small_step"),this.setInput(l.step.toString())):U(a)?(this.setAction("set_denominator"),this.setInput(n.step.reciprocal().toString())):this.updateSAI();this.processAction(!0)};this.updateSAI=function(){for(var a=this._point_group.children,b=[],c=0;c<a.length;c++)b.push(a[c].value);
...
var m=2*Math.PI*a.valueOf();l=e.add(CTAT.Geom.Point.polar(d,m));b.reduce();var n=e.add(CTAT.Geom.Point.polar(d,2*Math.PI*b.valueOf()+m)),p=e.clone();if(0<c&&c<d){m=CTAT.Geom.Point.polar(c,m+Math.PI*b.valueOf());p=p.add(m);l=l.add(m);var t=function(a,b,c){return a.distance(b)<a.distance(c)?b:c};l=CTAT.Geom.Point.circle_intersection(p,l,e,d).reduce(t.bind(this,l));n=n.add(m);n=CTAT.Geom.Point.circle_intersection(p,n,e,d).reduce(t.bind(this,n))}m=CTAT.Geom.Point.to2DString;p="M "+m(p);t=new DOMPoint(d,
d);p+=" L "+m(l);p+=" A "+m(t)+" 0 "+(.5<b.valueOf()?1:0)+",1 "+m(n);g.setAttributeNS(null,"d",p+" Z");h.addPieceElem(g,b,b.selected)}return a.add(b)},new CTAT.Math.Fraction);this.baseGroup.innerHTML="";this.baseGroup.appendChild(f);this.setColor(this.color);this.setDeselectedColor(this.deselectedColor);this.setDeselectedColorAlpha(this.deselectedColorAlpha)}};this.getExplode=function(){return c};this.getDropShadowDistance=function(){return g};this.setExplode=function(a){a=Number(a);if(!isNaN(a)){var b=
...
a.push(b)}return a};this.setFontColor=function(a){n=a;$(l).css("color",a)};this.getFontColor=function(){return n};this.resize=function(){var a=$(this.getDivWrap()).height();$(l).css("font-size",a-5+"px");$(this.getComponent()).css("height",a-10+"px");$(this.getComponent()).css("width",a-10+"px")};var q=this.setText;this.setText=function(a){q(a);null!==l&&(l.innerHTML=this.getText())};this.setStyleHandler("buttonLabel",this.setText);var p=this.setEnabled;this.setEnabled=function(a){p(a);null!==h&&
...
f.getLevel()+" ...");var x=document.createElement("div");x.classList.add("CTATSkillWindow--skill");var m=document.createElement("div");m.classList.add("CTATSkillWindow--bar");var v=document.createElement("div"),t=f.getLevel();t<d?v.classList.add("CTATSkillWindow--bar--nonmastered"):v.classList.add("CTATSkillWindow--bar--mastery");v.style.width=t>d?"100%":100*t+"%";m.appendChild(v);x.appendChild(m);b.appendChild(x);m=document.createElement("div");m.textContent=f.getDisplayName()||"no-name";m.classList.add("CTATSkillWindow--label");
x.appendChild(m)}g.innerHTML="";g.appendChild(b)}}}};CTATSkillWindow.prototype=Object.create(CTAT.Component.Base.Graphical.prototype);CTATSkillWindow.prototype.constructor=CTATSkillWindow;CTAT.ComponentRegistry.addComponentType("CTATSkillWindow",CTATSkillWindow);var CTATSubmitButton=function(a,b,e,f,d){CTATButton.call(this,a,b,e,f,d);this.setClassName("CTATSubmitButton");CTATConfiguration.get("previewMode");var c=this;this.setParameterHandler("target_components",function(a){this.getDivWrap().setAttribute("data-ctat-target",a);return this});var g=this.init;this.init=function(){g();this.setParameter("tutorComponent",CTAT.Component.Base.Tutorable.Options.DO_NOT_TUTOR);this.component.addEventListener("focus",this.processFocus);this.setStyles()};var h=function(a){var b=
...
CTAT.ComponentRegistry.addComponentType("CTATSubmitButton",CTATSubmitButton);var CTATTextBasedComponent=function(a,b,e,f,d,c,g){CTAT.Component.Base.Tutorable.call(this,a,b,e,f,d,c,g);var h=this,l="",n="#000000",q=16,p=!0,x=255,m=!0;this.setAction("UpdateTextField");this.backgrade=!0;this.setFontColor=function(a){n=a;$(h.getComponent()).css("color",a)};this.getFontColor=function(){return n};this.setFontSize=function(a){a.includes("px")||(a+="px");q=a;$(h.getComponent()).css("font-size",a)};this.getFontSize=function(){return q};this.assignText=function(a){l=a;this.setInput(a)};
this.UpdateTextArea=this.UpdateTextField=function(a){this.setText(a)};this.setTabOnEnter=function(a){p=CTATGlobalFunctions.toBoolean(a)};this.setStyleHandler("TabOnEnter",this.setTabOnEnter);this.data_ctat_handlers["tab-on-enter"]=this.setTabOnEnter;this.assignEditable=function(a){m=a};this.setMaxCharacters=function(a){x=a};this.setStyleHandler("MaxCharacters",this.setMaxCharacters);this.getText=function(){return l};this.getEditable=function(){return m};this.getTabOnEnter=function(){return p};this.getMaxCharacters=
...
(x(),n=1):n=0;this.setStyles()};var x=function(){$(this.getDivWrap()).children().first().addClass("CTATTable--headers").children().addClass("CTATTable--header")}.bind(this),m=function(a,b){var c=document.createElement("div"),d=this.getName()+".R"+a+"C"+b;c.id=d;c.classList.add("CTATTable--cell");c.classList.add("CTATTextArea");$(c).css("height","100%");var e=new CTATTextArea;e.setName(d);e.setDivWrapper(c);e.processAttributes();e.init();e.processTabOrder();g?e.setEnabled(!1):e.setEnabled(this.getEnabled());
$(c).data("CTATComponent",e);return c}.bind(this);this.addRow=function(){var a=document.createElement("div");a.classList.add("CTATTable--row");var b=q();parseInt(b,10);h[b]=[];for(var c=0;c<p();c++){var d=m(b,c);h[b].push(d);a.appendChild(d)}$(this.getDivWrap()).append(a);l.push(a);this.set_row_count(b+1);this.resize()};this.deleteRow=function(){var a=this.getDivWrap();a.removeChild(a.lastChild);l.pop();h.pop();this.set_row_count(this.get_row_count()-1);this.resize()};this.addColumn=function(){var a=
p(),b=0;l.forEach(function(c){var d=m(b,a);h[b].push(d);b<n&&d.classList.add("CTATTable--header");c.appendChild(d);b++});this.set_col_count(a+1);this.resize()};this.deleteColumn=function(){this.getDivWrap();for(var a=l.length,b=0;b<a;b++)l[b].removeChild(l[b].lastChild),h[b].pop();this.set_col_count(this.get_col_count()-1);this.resize()};this.resizeWidth=function(){if(h&&h[0])for(var a=h.length,b=h[0].length,c=Math.floor($(this.getDivWrap()).width()/b),d=0;d<a;d++)for(var e=0;e<b;e++)$(h[d][e]).css("width",
c+"px")};this.resizeHeight=function(){if(l)for(var a=l.length,b=0;b<a;b++)$(l[b]).css("height",Math.floor($(this.getDivWrap()).height()/a)+"px")};this.resize=function(a){a?"width"==a?this.resizeWidth():this.resizeHeight():(this.resizeWidth(),this.resizeHeight())};var v=function(a){var b=document.createElement("div");a=this.getName()+".R0C"+a;b.id=a;b.classList.add("CTATTable--header");b.classList.add("CTATTextField");var c=new CTATTextField;c.setName(a);c.setDivWrapper(b);c.processAttributes();c.init();
...
e&&(ctatdebug("Registering existence of CTAT component on MovieClip container: "+c),e.addComponent(c))}var g,h,l,n;"shape"==this.parser.getElementName(d)&&(g=this.parser.getElementAttr(d,"x"),h=this.parser.getElementAttr(d,"y"),l=this.parser.getElementAttr(d,"width"),n=this.parser.getElementAttr(d,"height"),c=this.parser.getElementAttr(d,"instance"),ctatdebug("Creating shape: "+c+" at: "+g+","+h+","+l+","+n),l="data:image/png;base64, "+this.parser.getNodeTextValue(d),n=new Image,n.setAttribute("style",
"position: absolute; top: "+h+"px; left:"+g+"px; z-index:"+CTATGlobalFunctions.gensym.z_index()+";"),n.setAttribute("id",c),n.setAttribute("src",l),f.appendChild(n));"statictext"==this.parser.getElementName(d)&&(g=this.parser.getElementAttr(d,"x"),h=this.parser.getElementAttr(d,"y"),l=this.parser.getElementAttr(d,"width"),n=this.parser.getElementAttr(d,"height"),c=this.parser.getElementAttr(d,"instance"),ctatdebug("Creating static text: "+c+" at: "+g+","+h+","+l+","+n),l="data:image/png;base64, "+
this.parser.getNodeTextValue(d),n=new Image,n.setAttribute("style","position: absolute; top: "+h+"px; left:"+g+"px; z-index:"+CTATGlobalFunctions.gensym.z_index()+";"),n.setAttribute("id",c),n.setAttribute("src",l),f.appendChild(n));"statictext"==this.parser.getElementName(d)&&(c=this.parser.getElementAttr("instance"),ctatdebug("Creating movieclip: "+c),g=this.parser.getElementAttr(d,"x"),h=this.parser.getElementAttr(d,"y"),l=this.parser.getElementAttr(d,"width"),n=this.parser.getElementAttr(d,"height"),
g=new CTATMovieClip(c,g,h,l,n),h=g.wrapComponent(f),ctatdebug("Created movieclip: "+c+" at: "+g.x+","+g.y+","+g.width+","+g.height),movieclips.push(g),d=this.parser.getElementChildren(d),this.createStaticInterface(h,d,g))}};
...
b){if(a){var d=a.contentDocument||a.contentWindow.document;d.open();d.write(b);d.close()}};document.addEventListener("refreshIframe",function(a){a=a.detail;console.log("refresh event for iframe "+a);b.refresh(a)})};(function(a){function b(){var a=arguments[0],c=b.cache;c[a]&&c.hasOwnProperty(a)||(c[a]=b.parse(a));return b.format.call(null,c[a],arguments)}function e(a){return Object.prototype.toString.call(a).slice(8,-1).toLowerCase()}var f=/[^s]/,d=/[def]/,c=/^[^\x25]+/,g=/^\x25{2}/,h=/^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/,l=/^([a-z_][a-z_\d]*)/i,n=/^\.([a-z_][a-z_\d]*)/i,q=/^\[(\d+)\]/,p=/^[\+\-]/;b.format=function(a,c){var g=1,h=a.length,m,l=[],n,q,v,x,D=!0,
u="";for(n=0;n<h;n++)if(m=e(a[n]),"string"===m)l[l.length]=a[n];else if("array"===m){v=a[n];if(v[2])for(m=c[g],q=0;q<v[2].length;q++){if(!m.hasOwnProperty(v[2][q]))throw Error(b("[sprintf] property '%s' does not exist",v[2][q]));m=m[v[2][q]]}else m=v[1]?c[v[1]]:c[g++];"function"==e(m)&&(m=m());if(f.test(v[8])&&"number"!=e(m)&&isNaN(m))throw new TypeError(b("[sprintf] expecting number but found %s",e(m)));d.test(v[8])&&(D=0<=m);switch(v[8]){case "b":m=m.toString(2);break;case "c":m=String.fromCharCode(m);
break;case "d":m=parseInt(m,10);break;case "e":m=v[7]?m.toExponential(v[7]):m.toExponential();break;case "f":m=v[7]?parseFloat(m).toFixed(v[7]):parseFloat(m);break;case "o":m=m.toString(8);break;case "s":m=(m=String(m))&&v[7]?m.substring(0,v[7]):m;break;case "u":m>>>=0;break;case "x":m=m.toString(16);break;case "X":m=m.toString(16).toUpperCase()}if(!D||d.test(v[8])&&v[3])u=D?"+":"-",m=m.toString().replace(p,"");q=v[4]?"0"==v[4]?"0":v[4].charAt(1):" ";x=v[6]-(u+m).length;x=v[6]?Array(x+1).join(q):
"";l[l.length]=v[5]?u+m+x:0==q?u+x+m:x+u+m}return l.join("")};b.cache={};b.parse=function(a){for(var b,d=[],e=0;a;){if(null!==(b=c.exec(a)))d[d.length]=b[0];else if(null!==(b=g.exec(a)))d[d.length]="%";else if(null!==(b=h.exec(a))){if(b[2]){var e=e|1,f=[],m=b[2],p;if(null!==(p=l.exec(m)))for(f[f.length]=p[1];""!==(m=m.substring(p[0].length));)if(null!==(p=n.exec(m)))f[f.length]=p[1];else if(null!==(p=q.exec(m)))f[f.length]=p[1];else throw new SyntaxError("[sprintf] failed to parse named argument key");
...
a);break;case 26:this.$=new d.CTATConstantNode(Number(a))}},table:[{3:1,4:2,6:3,13:e,14:4,15:f,17:5,19:8,22:9,24:d,25:c,27:g,28:h},{1:[3]},{5:[1,14]},{5:[2,8],7:[1,15],8:[1,16],9:[1,17],10:[1,18],11:[1,19],12:[1,20],13:l,15:n},b(q,[2,11],{22:9,19:25,16:p,18:x,20:m,21:v,24:d,25:c,27:g,28:h}),b(t,[2,17]),{13:e,15:f,17:28,19:8,22:9,24:d,25:c,27:g,28:h},{13:e,15:f,17:29,19:8,22:9,24:d,25:c,27:g,28:h},b(t,[2,20]),b(t,[2,23],{23:[1,30]}),{13:e,15:f,17:31,19:8,22:9,24:d,25:c,27:g,28:h},{6:32,13:e,14:4,15:f,
...
25:c,27:g,28:h},{13:e,15:f,17:41,19:8,22:9,24:d,25:c,27:g,28:h},{13:e,15:f,17:42,19:8,22:9,24:d,25:c,27:g,28:h},b(t,[2,14]),{13:e,15:f,17:43,19:8,22:9,24:d,25:c,27:g,28:h},{13:e,15:f,17:44,19:8,22:9,24:d,25:c,27:g,28:h},b(t,[2,18]),b(t,[2,19]),{13:e,15:f,17:45,19:8,22:9,24:d,25:c,27:g,28:h},b(t,[2,22]),{13:l,15:n,26:[1,46]},{5:[2,2],13:l,15:n},{5:[2,3],13:l,15:n},{5:[2,4],13:l,15:n},{5:[2,5],13:l,15:n},{5:[2,6],13:l,15:n},{5:[2,7],13:l,15:n},b(q,[2,9],{22:9,19:25,16:p,18:x,20:m,21:v,24:d,25:c,27:g,
28:h}),b(q,[2,10],{22:9,19:25,16:p,18:x,20:m,21:v,24:d,25:c,27:g,28:h}),b(t,[2,12]),b(t,[2,13]),b(t,[2,15]),b(t,[2,16]),b(t,[2,21]),b(B,[2,24])],defaultActions:{14:[2,1]},parseError:function(a,b){if(b.recoverable)this.trace(a);else{var c=function(a,b){this.message=a;this.hash=b};c.prototype=Error;throw new c(a,b);}},parse:function(a){var b=[0],c=[null],d=[],e=this.table,f="",g=0,h=0,m=0,l=d.slice.call(arguments,1),n=Object.create(this.lexer),p={},q;for(q in this.yy)Object.prototype.hasOwnProperty.call(this.yy,
q)&&(p[q]=this.yy[q]);n.setInput(a,p);p.lexer=n;p.parser=this;"undefined"==typeof n.yylloc&&(n.yylloc={});q=n.yylloc;d.push(q);var v=n.options&&n.options.ranges;this.parseError="function"===typeof p.parseError?p.parseError:Object.getPrototypeOf(this).parseError;for(var t,x,r,B,M={},P,K;;){r=b[b.length-1];if(this.defaultActions[r])B=this.defaultActions[r];else{if(null===t||"undefined"==typeof t)t=n.lex()||1,"number"!==typeof t&&(t=this.symbols_[t]||t);B=e[r]&&e[r][t]}if("undefined"===typeof B||!B.length||
!B[0]){var R;K=[];for(P in e[r])this.terminals_[P]&&2<P&&K.push("'"+this.terminals_[P]+"'");R=n.showPosition?"Parse error on line "+(g+1)+":\n"+n.showPosition()+"\nExpecting "+K.join(", ")+", got '"+(this.terminals_[t]||t)+"'":"Parse error on line "+(g+1)+": Unexpected "+(1==t?"end of input":"'"+(this.terminals_[t]||t)+"'");this.parseError(R,{text:n.match,token:this.terminals_[t]||t,line:n.yylineno,loc:q,expected:K})}if(B[0]instanceof Array&&1<B.length)throw Error("Parse Error: multiple actions possible at state: "+
r+", token: "+t);switch(B[0]){case 1:b.push(t);c.push(n.yytext);d.push(n.yylloc);b.push(B[1]);t=null;x?(t=x,x=null):(h=n.yyleng,f=n.yytext,g=n.yylineno,q=n.yylloc,0<m&&m--);break;case 2:K=this.productions_[B[1]][1];M.$=c[c.length-K];M._$={first_line:d[d.length-(K||1)].first_line,last_line:d[d.length-1].last_line,first_column:d[d.length-(K||1)].first_column,last_column:d[d.length-1].last_column};v&&(M._$.range=[d[d.length-(K||1)].range[0],d[d.length-1].range[1]]);r=this.performAction.apply(M,[f,h,
g,p,B[1],c,d].concat(l));if("undefined"!==typeof r)return r;K&&(b=b.slice(0,-2*K),c=c.slice(0,-1*K),d=d.slice(0,-1*K));b.push(this.productions_[B[1]][0]);c.push(M.$);d.push(M._$);B=e[b[b.length-2]][b[b.length-1]];b.push(B);break;case 3:return!0}}}},e=function(){return{EOF:1,parseError:function(a,b){if(this.yy.parser)this.yy.parser.parseError(a,b);else throw Error(a);},setInput:function(a,b){this.yy=b||this.yy||{};this._input=a;this._more=this._backtrack=this.done=!1;this.yylineno=this.yyleng=0;this.yytext=
...
(function(){var a,b,e,f,d,c,g,h,l,n,q,p=[].slice;d=/^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;f=/^\d+(\.\d\d)?$/;c=RegExp("((\\d+)\\.?(\\d+)?|\\.(\\d+))([Ee]([+-]?\\d+))?","g");n=/^[+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?$/;l=/^\s*\(\s*([+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?)\s*\,\s*([+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?)\s*\)\s*$/;h=/([bcdfghjklmnpqrstvwxz]|qu)y$/;g=/([bcdfghjklmnpqrstvwxz]o|[sc]h|s)$/;q=function(a,b){var c;null==b&&(b=!1);var d,e,f,g;f=null!=(c=a[4])?c:a[2]+(a[3]||
...
d.call(arguments,0):[];return a.apply(b,c)}}(CTATFormulaActions[b],CTATFormulaActions))}a.prototype.evaluate=function(a,g,n,q){var h,l,m,v,t,B,r,z,A,E,I,w;try{z="undefined"!==typeof window&&null!==window?window:global;h=function(){var a;a=[];for(v in z)a.push(v);return a}().concat(["selection","action","input"]);A=a.split(f);l=0;for(t=A.length;l<t;l++)for(r=A[l],I=null!=(E=r.match(b))?E:[],m=0,B=I.length;m<B;m++)v=I[m],0>c.call(e,v)&&0>c.call(h,v)&&0>c.call(this.keys,v)&&CTATFormulaFunctions.assign(v,
...
a;m[CTATMatcher.ACTION]=b;m[CTATMatcher.INPUT]=d;for(var p=0;3>p;p++){var q=l[p][0],t=q instanceof CTATExpressionMatcher?q.matchConcatenation(a,b,d,e):q.matchConcatenation(m[p]);n.ctatdebug("CTATVectorMatcher --\x3e in _match["+p+"] after "+q+".concat returns: "+t);if(f)f.push(t);else if(!1===t)return!1}if(f)for(a=0;a<f.length;++a)if(!f[a])return!1;return!0}CTATMatcher.call(this,!0,CTATMatcher.VECTOR,!0);var c=a instanceof Array?a:[],g=b instanceof Array?b:[],h=e instanceof Array?e:[],l=[];l[CTATMatcher.SELECTION]=
c;l[CTATMatcher.ACTION]=g;l[CTATMatcher.INPUT]=h;var n=this;this.match=function(a,b,c,e,f){return!1!==d(a,b,c,f)&&n.matchActor(e)?!0:!1};this.getMatchers=function(a){return l[a]};this.getTutorSAI=function(a,b,c){n.ctatdebug("CTATVectorMatcher.getTutorSAI("+a+", vt, "+c+")");if(c&&CTATExampleTracerLink.CORRECT_ACTION.toLowerCase()==c.toLowerCase())return a;var e=[];if(d(a.getSelectionArray(),a.getActionArray(),a.getInputArray(),b,e))return c=a.clone(),a=n.evaluateReplacement(a,b,null),null!=a&&c.setInput("object"==
...
CTATExampleTracerNode.prototype.constructor=CTATExampleTracerNode;"undefined"!==typeof module&&(module.exports=CTATExampleTracerNode);var CTATExampleTracerLink=function(a,b,e){CTATBase.call(this,"CTATExampleTracerLink","("+b+"-"+e+")");var f="undefined"===typeof a||null===a?null:a,d=null,c="undefined"===typeof b||null===b?null:b,g="undefined"===typeof e||null===e?null:e,h=null,l=1,n=1,q="CORRECT_ACTION",p=[],x=!1,m=null,v="",t=null,B=null,r=this;this.getUniqueID=function(){return f};this.getMatcher=function(){r.ctatdebug("CTATExampleTracerLink --\x3e in getMatcher");return h};this.isCorrect=function(){return q==CTATExampleTracerLink.CORRECT_ACTION};
this.matchesSAI=function(a,b,c){var d=r.getMatcher();r.ctatdebug("CTATExampleTracerLink --\x3e in matchesSAI(); matcher "+d+", typeof "+typeof d+", sai "+a);a=d.match(a.getSelectionArray(),a.getActionArray(),a.getInputArray(),b,c);r.ctatdebug("CTATExampleTracerLink --\x3e out of matchesSAI: result = "+a);return a};this.matchesSAIforHint=function(a,b,c,d){r.ctatdebug("CTATExampleTracerLink --\x3e in matchesSAIforHint("+a+", "+b+") selectionArray "+a.getSelectionArray());if(!1===r.getMatcher().matchForHint(a.getSelectionArray(),
a.getActionArray(),b,d))return r.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning false because no match"),!1;if(null!==c&&"undefined"!==typeof c&&!0===c.getWantReportableHints()&&(a=null===r.getAllHints()||"undefined"===typeof r.getAllHints()?0:r.getAllHints().length,1>a))return r.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning false nStaticHints "+a+"< 1"),!1;r.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning true");return!0};this.getDepth=
function(){return d};this.getBuggyMsg=function(){return v};this.getSuccessMsg=function(){return m};this.getType=function(){return q};this.getPrevNode=function(){return c};this.getNextNode=function(){return g};this.setPrevNode=function(a){c=a};this.setNextNode=function(a){g=a};this.toString=function(){var a;a="[link "+r.getUniqueID();a+=" ("+r.getPrevNode()+"-"+r.getNextNode();a+=") "+r.getType();return a+"]"};this.getTutorSAI=function(a,b){return r.getMatcher().getTutorSAI(a,b,r.getActionType())};
this.getEvaluatedInput=function(a,b){return r.getMatcher().getEvaluatedInput(a,b)};this.setDepth=function(a){d=a};this.getMaxTraversals=function(){return l};this.isDone=function(){var a=String(r.getDefaultSAI().getSelection()).toLowerCase(),b=String(r.getDefaultSAI().getAction()).toLowerCase(),a=CTATMsgType.DONE.toLowerCase()==a&&CTATMsgType.BUTTON_PRESSED.toLowerCase()==b;r.ctatdebug("CTATExampleTracerLink.isDone() returns "+a);return a};this.interpolateHints=function(a){r.ctatdebug("CTATExampleTracerLink --\x3e interpolateHints("+
a+")");var b=[];if(null===p||"undefined"===typeof p||0===p.length)return b;null==a&&(a=new CTATVariableTable);var c=new CTATFormulaParser(a);p.forEach(function(a){if(!(1>String(a).trim().length)){var d=r.getDefaultSAI().getSelection(),e=r.getDefaultSAI().getAction(),f=CTATVariableTable.standardizeType(r.getDefaultSAI().getInput());r.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate("+a+", "+d+", "+e+", "+f+")");a=c.interpolate(a,d,e,f);r.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate() returns "+
a);b.push(a)}});r.ctatdebug("CTATExampleTracerLink --\x3e out of interpolateHints "+b);return b};this.getHints=function(){r.ctatdebug("CTATExampleTracerLink --\x3e in getHints");var a=[];r.interpolateHints(null).forEach(function(b){r.ctatdebug("CTATExampleTracerLink --\x3e in getHints loop");b.toString()!=="".toString()&&a.push(b)});r.ctatdebug("CTATExampleTracerLink --\x3e out of getHints");return a};this.getAllNonEmptyHints=function(){var a=[];p.forEach(function(b){b.trim().toString()!=="".toString()&&
a.push(b)});return a};this.isTraversable=function(){return 1>r.getMaxTraversals()?!1:CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase()==r.getActionType().toString().toUpperCase()||CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase()==r.getActionType().toString().toUpperCase()?!0:!1};this.replaceInput=function(){return CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase()!==r.getActionType().toString().toUpperCase()&&CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase()!==
r.getActionType().toString().toUpperCase()?!1:r.getMatcher().replaceInput()};this.evaluateReplacement=function(a,b,c){return r.getMatcher().evaluateReplacement(a,b,c)};this.getActor=function(){return r.getMatcher().getActor()};this.getDefaultSAI=function(){r.ctatdebug(r.toString()+".getSAI(): "+(h?h.getDefaultSAI():"(matcher null)"));return h.getDefaultSAI()};this.getActionType=function(){return q};this.getMinTraversals=function(){return n};this.getIsPreferredLink=function(){return x};this.getAllHints=
function(){return p};this.setMatcher=function(a){h=a};this.addHint=function(a){null!==a&&"undefined"!==typeof a&&a.toString()!=="".toString()&&p.push(a)};this.setSelection=function(a){r.getMatcher().setDefaultSelection(null===a[0]||"undefined"===typeof a[0]?"":a[0].toString())};this.setAction=function(a){r.getMatcher().setDefaultAction(null===a[0]||"undefined"===typeof a[0]?"":a[0].toString())};this.setActionType=function(a){if(null===a||"undefined"===typeof a||a.toString()!==CTATExampleTracerLink.CORRECT_ACTION.toString()&&
...
function(a){m=a};this.setMinTraversalsStr=function(a){if(null===a||"undefined"===typeof a||1>a.length)n=1;else try{n=parseInt(a.trim()),isNaN(n)&&(n=1)}catch(A){n=1}};this.setMaxTraversalsStr=function(a){if(null===a||"undefined"===typeof a||1>a.length)l=n;else try{l=parseInt(a.trim()),isNaN(l)&&(l=1)}catch(A){l=n}};this.setUniqueID=function(a){f=a};this.addSkillName=function(a){r.ctatdebug("ETLink["+f+"].addSkillName("+a+")");if("unnamed"!==a){if(null===B||"undefined"===typeof B)B=[];-1<B.indexOf(a)||
(B.push(a),r.ctatdebug("ETLink.addSkillName() return with skillNames "+B))}};this.getSkillNames=function(){if(null===B||"undefined"===typeof B)B=[];return B};this.isTutorPerformed=function(a){if(CTATExampleTracerLink.CORRECT_ACTION.toUpperCase()!==r.getActionType().toUpperCase())return!1;var b=r.getMatcher();if(null===b||"undefined"===typeof b||null!==a&&"undefined"!==typeof a&&a!==b.isLinkTriggered())return!1;a=r.getActor();return CTATMatcher.isTutorActor(a,!0)?!0:!1};this.setIsPreferredLink=function(a){r.ctatdebug("ETLink.setIsPreferredLink() was "+
x+", now "+a);x=a};this.setVisualData=function(a){t=a};this.getVisualData=function(){return t}};
...
function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableInterpretation("+a+")");p=a};this.setStepID=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setStepID("+a+")");x=a?a.toString():""};this.setReportableVariableTable=function(a){B=a.clone()};this.setSuccessOrBuggyMsg=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setSuccessOrBuggyMsg("+a+")");r=a};this.setReportableHints=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableHints("+a+")");z=
Array.isArray(a)&&0<a.length?a:[]};this.getWantReportableHints=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning "+A);return A};this.setOutOfOrder=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setOutOfOrder("+a+")");m=a};this.isOutOfOrder=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning "+m);return m};this.setEvaluatedInput=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setEvaluatedInput("+a+")");if(null===
t||"undefined"===typeof t)t=[];t.push(a)};this.addPreloadedLinkMatch=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in addPreloadedLinkMatch("+a+")");if(null===v||"undefined"===typeof v)v=[];v.push(a)};this.setInterpolatedSAI=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedSAI("+a+")");a&&(E=a)};this.getInterpolatedSAI=function(){return E?E:w.getStudentSAI()};this.setInterpolatedHints=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedHints("+
a+")");null!==I&&"undefined"!==typeof I&&(I.length=0);null!==a&&"undefined"!==typeof a&&(I=a.slice(0));w.ctatdebug("CTATExampleTracerEvent --\x3e out of setInterpolatedHints")};this.setWantReportableHints=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setWantReportableHints("+a+")");A=a};this.getSuccessOrBuggyMsg=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning "+r);return r};this.getReportableHints=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning "+
...
d.getSuccessMsg():d.getBuggyMsg();a.setSuccessOrBuggyMsg(e(b,f.getVariableTable(),a.getStudentSAI()));a.getHintRequest()&&(f=d.interpolateHints(f.getVariableTable()),a.setInterpolatedHints(f),u.ctatdebug("In evaluate after calling setInterpolatedHints"),Array.isArray(f)&&0<f.length?a.setReportableHints(f):a.setReportableHints(d.getHints()),u.ctatdebug("In evaluate --\x3e after setReportableHints"));u.ctatdebug("In evaluate after fireExampleTracerEvent");u.ctatdebug("CTATExampleTracerTracer --\x3e out of finishEvaluate");
return c.toString()!==CTATExampleTracerLink.BUGGY_ACTION.toString()}function d(a,b,c,d){u.ctatdebug("checkDoneStep() hintTrace "+b+", sai "+a.getStudentSAI()+", exitOnIncorrectDone "+E.exitOnIncorrectDone()+", hideButRequireSteps "+E.hideButRequireSteps()+", nInterps "+d.size);if(!a.getStudentSAI().isDone())return u.ctatdebug("checkDoneStep() not isDone(), so setDoneStepFailed(false) & return null "),null;if(E.exitOnIncorrectDone())return a.setDoneStepFailed(!1),u.ctatdebug("checkDoneStep() exitOnIncorrectDone() with setDoneStepFailed(false), so return null "),
null;if(!b&&E.hideButRequireSteps()){b=E.getDoneLinks();u.ctatdebug("checkDoneStep getDoneLinks().size "+b.size);b=b.values();for(var e;!(e=b.next()).done;)if(E.pathToLinkIsSubset(e.value,D))return a.setDoneStepFailed(!1),1>d.size?f(a,c,CTATExampleTracerLink.CORRECT_ACTION,e.value,u.getBestInterpretation(),u.getInterpretationsInternal()):f(a,c,CTATExampleTracerLink.CORRECT_ACTION,e.value,q(d),d)}1>d.size&&a.setDoneStepFailed(!0);return null}function c(a,b,c){u.ctatdebug("CTATExampleTracerTracer --\x3e _evaluate("+
a+", "+b+", "+c+")");I=a;var e=new Set,m=a.getPreloadedLinkMatches();u.ctatdebug("interps # : "+r.length);u.ctatdebug("interps: "+r);r.forEach(function(d){u.ctatdebug("In evaluate -- entered the interpretations loop");if("undefined"===typeof m||null===m)u.ctatdebug("In evaluate -- entered if check for saiLinkMatches"),m=h(a.getStudentSAI(),a.getActor(),b,d.getVariableTable(),a),u.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");else for(var f=0;f<m.length;++f)g(a.getStudentSAI(),!0,
m[f],m[f].getActor(),d.getVariableTable());u.ctatdebug("Link matches # : "+m.length);m.forEach(function(b){u.ctatdebug("In evaluate -- entered the saiLinkMatches loop + "+b);if(!E.relaxOrderConstraints()&&d.getTraversalCount(b)>=b.getMaxTraversals())return u.ctatdebug("In evaluate -- skipped a saiLinkMatches loop \n Skipped due to max traversals"+b.getMaxTraversals()),!1;var f=d.clone();u.ctatdebug("In evaluate size of getPaths "+f.getPaths().size);f.getPaths().forEach(function(c){u.ctatdebug("In evaluate -- looping through the newInterp.getPaths()\n Examining path: "+
c);!1===l(b,f,c,!1,a)&&(u.ctatdebug("In evaluate -- in if condition, checking if isPathOK"),f.getPaths()["delete"](c),u.ctatdebug("In evaluate -- out of if condition, checking if isPathOK\n Tried to delete path."))});u.ctatdebug("In evaluate -- done looping through the newInterp.getPaths(), size "+f.getPaths().size);if(0<f.getPaths().size){u.ctatdebug("In evaluate -- if number of paths is greater than 0");f.addLink(b);u.ctatdebug("In evaluate -- new link added");if(!0===c){u.ctatdebug("In evaluate -- we are in the doUpdate if condition");
var g=n(b,a.getStudentSAI(),f);u.ctatdebug("In evaluate -- updatingVariable table");a.setInterpolatedSAI(f.updateVariableTable(a.getStudentSAI(),g,b));u.ctatdebug("In evaluate -- done updatingVariable table: "+f.getVariableTable())}e.add(f);u.ctatdebug("In evaluate -- added new interp")}u.ctatdebug("In evaluate -- out of saiLinkMatches loop")});u.ctatdebug("In evaluate -- out of interpretation loops")});a.setNumberOfInterpretations(e.size);u.ctatdebug("In evaluate -- number of interpretations "+e.size+
" set");var p=d(a,b,c,e);if(null!==p)return p;if(0===e.size)return u.ctatdebug("In evaluate -- if condition no new interpretations"),0!==m.length&&!0===m[0].isDone()&&a.setDoneStepFailed(!0),a.setResult(CTATExampleTracerLink.NO_MODEL),u.ctatdebug("In evaluate -- if condition no new interpretations returning false"),!1;p=q(e);u.ctatdebug("In evaluate -- just found bestInterp");var t=null;!0===a.isSolverResult()?(u.ctatdebug("In evaluate -- in if branch of isSolverResult"),t=CTATExampleTracerLink.NO_MODEL.toString().toUpperCase()===
a.getResult().toString().toUpperCase()?CTATExampleTracerLink.BUGGY_ACTION.toString():a.getResult().toString()):(u.ctatdebug("In evaluate -- in else branch of isSolverResult"),t=p.getLastMatchedLink().getType());return f(a,c,t,null,p,e)}function g(a,b,c,d,e){var f=b&&c.isCorrect();if("undefined"!=typeof D[c.getUniqueID()]||c.matchesSAIforHint(a,d,null,e))D[c.getUniqueID()]=f;u.ctatdebug("updateMatchedSelections(): link "+c.getUniqueID()+", matched "+b+", newResult "+f+", matchedSelections[link] "+
D[c.getUniqueID()])}function h(a,b,c,d,e){u.ctatdebug("CTATExampleTracerTracer --\x3e in findSAIMatchingLinks("+a+", "+b+", "+c+")");var f=[];E.getLinks().forEach(function(h){if(!1===c){u.ctatdebug("Calling link.matchesSAI() on link "+h+", sai "+a);var m=h.matchesSAI(a,b,d);u.ctatdebug("Result from link.matchesSAI() on link "+h+": "+m+", typeof "+typeof m);!0===m&&f.push(h);E.hideButRequireSteps()&&g(a,m,h,b,d)}else!0===h.matchesSAIforHint(a,b,e,d)&&f.push(h)});u.ctatdebug("CTATExampleTracerTracer --\x3e out of findSAIMatchingLinks: #matchingLinks "+
f.length);return f}function l(a,b,c,d,e){u.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK");var f=null;if(!0===d){u.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK in demonstrate mode");var g=b.getMatchedLinks().slice();g.push(a);f=c.getLinksRestricted(g)}else u.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK NOT in demonstrate mode"),f=c.getLinks();u.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK path.getLinks() "+c.getLinks().size);u.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK pathLinks "+
f.size);if(!0===d){var h=[],l=!0;b.getMatchedLinks().forEach(function(a){!1!==l&&(!1===E.observesOrderingConstraints(h,a,f,e)||!1===m(b,a,f)?(u.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"),l=!1):h.push(a))});if(!1===l)return u.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false2"),!1}if(a.getType().toString()===CTATExampleTracerLink.BUGGY_ACTION.toString()){if(!1===E.isIncorrectLinkOK(b.getMatchedLinks(),a,f,b))return u.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false3"),
!1}else{if(!1===E.observesOrderingConstraints(b.getMatchedLinks(),a,f,e))return u.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false4"),!1;if(!1===m(b,a,f))return u.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false5"),!1}u.ctatdebug("CTATExampleTracerTracer --\x3e out of isPathOK returning true");return!0}function n(a,b,c){u.ctatdebug("CTATExampleTracerTracer.replaceInput("+a+", "+b+", ...)");if(null===a||"undefined"===typeof a||!1===a.replaceInput())return u.ctatdebug("replaceInput false, returning null"),
null;a=a.evaluateReplacement(b,c.getVariableTable(),u);u.ctatdebug("CTATExampleTracerTracer.replaceInput() returning "+a);return a}function q(a){u.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation");var b=new CTATExampleTracerInterpretationComparator,c=null;a.forEach(function(a){u.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation iteration");null===c||"undefined"===typeof c?(u.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation first if condition"),
c=a):(u.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation else of first if condition"),0<b.compare(a,c)&&(u.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation second if condition"),c=a))});u.ctatdebug("CTATExampleTracerTracer --\x3e out of findBestInterpretation");return c}function p(a){u.ctatdebug("CTATExampleTracerTracer --\x3e in setInterpretations");r.length=0;0===a.size?u.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations"):(u.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: "+
a.size),a.forEach(function(a){r.push(a)}),w=null,u.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"))}function x(){u.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths");var a=E.findAllPaths();u.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths: #paths "+a.size);a.forEach(function(a){u.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths loopring through paths");u.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths size of path"+a.getLinks().size)});return a}
function m(a,b,c){u.ctatdebug("CTATExampleTracerTracer --\x3e in doneStepOK: link "+b+", isDone() "+b.isDone());if(null===b||"undefined"===typeof b||!1===b.isDone())return u.ctatdebug("doneStepOK in first if condition"),!0;if(b.isDone()&&E.exitOnIncorrectDone())return!0;if(b.getType().toString()===CTATExampleTracerLink.BUGGY_ACTION.toString())return u.ctatdebug("doneStepOK in second if condition"),!0;u.ctatdebug("doneStepOK before loop");var d=!0;c.forEach(function(c){if(!1===d)u.ctatdebug("CTATExampleTracerTracer --\x3e we are breaking from the loop");
else if(c.getUniqueID()===b.getUniqueID())u.ctatdebug("CTATExampleTracerTracer --\x3e inside second if condition");else{var e=a.getTraversalCount(c);E.hideButRequireSteps()&&(0<e||1>c.getMinTraversals())||!(e<c.getMinTraversals())||(u.ctatdebug("CTATExampleTracerTracer --\x3e we should return false from the second if condition"),d=!1)}});if(!1===d)return u.ctatdebug("CTATExampleTracerTracer --\x3e out of doneStepOK returning false"),!1;u.ctatdebug("CTATExampleTracerTracer --\x3e out of doneStepOK returning true");
return!0}function v(a,b){u.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink");var c=null!==b&&"undefined"!==typeof b&&null!==b[0]&&"undefined"!==typeof b[0]?b[0]:null;if(null===c||"undefined"===typeof c)u.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink first if condition"),c=u.getBestInterpretation();null!==b&&"undefined"!==typeof b&&(b[0]=c);u.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink interp.getPaths(): "+c.getPaths().size);var d=CTATExampleTracerPath.getBestPath(c.getPaths());
...
c,h=!0)))}))});if(!0===h)return u.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink returning: "+m.getUniqueID()),m;u.ctatdebug("CTATExampleTracerTracer --\x3e out of getHighestUntraversedLink");return null}function B(a){return null===a||"undefined"===typeof a?!1:1>a.getMinTraversals()&&1>a.getMaxTraversals()}CTATBase.call(this,"CTATExampleTracerTracer",a);var r=null,z=null,A=null,E=a,I=null;CTATExampleTracerTracer_count++;var w=null,D={},u=this;this.goToState=function(a,b){if(!a)return!1;
var c="done"==a.toString().toLowerCase(),d="start"==a.toString().toLowerCase(),e=null;if(!c&&!d&&!(e=E.findNode(a)))return!1;if(d=d||e==E.getStartNode())throw c=location.href.replace(/problem_state_status=[^&]*/,"problem_state_status=empty"),1>c.search(/problem_state_status=empty/)&&(c+=c.search(/[?&]/g)?"&":"?",c+="problem_state_status=empty"),console.log("CTATExampleTracerTracer.goToState("+a+") to call location.replace("+c+")"),location.replace(c),c;if((d=u.getBestInterpretation())&&(c?u.goToDone(d,
E,b):u.advanceToNode(e,E,b)))return!0;for(var f=0;f<r.length;++f){var g=r[f];if(g!=d&&(c?u.goToDone(g,E,b):u.advanceToNode(e,E,b)))return!0}return!1};this.goToDone=function(a,b,c){return(a=a.getPathToDone(b))?c.traceLinks(a.getSortedLinks()):!1};this.advanceToNode=function(a,b,c){a=b.getBestSubpath(b.getStartNode(),a);u.ctatdebug("advanceToNode() path "+a);a&&(a=a.getSortedLinks(),results=c.traceLinks(a),u.ctatdebug("advanceToNode() results "+results))};this.getMatchedSelections=function(){return D};
this.getLastResult=function(){u.ctatdebug("CTATExampleTracerTracer --\x3e in getResult");return I};this.resetTracer=function(){u.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer entering");null===r||"undefined"===typeof r?(u.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"),r=[]):(u.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"),r.length=0);var a=new CTATExampleTracerInterpretation(x());u.ctatdebug("CTATExampleTracerTracer tempInterp--\x3e in resetTracer tempInterp "+
a);null!==b&&"undefined"!==typeof b&&(u.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer startStateVT if condition"),a.setVariableTable(b));r.push(a);w=a;if(null===z||"undefined"===typeof z)u.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"),z={};else{u.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of incorrectActionMatches if condition");for(var c in z)z.hasOwnProperty(c)&&delete z[c]}D={};null===A||"undefined"===typeof A?
(u.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer last if condition"),A=[]):(u.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of last if condition"),A.length=0);u.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer before iterating over all the links in the graphs");E.getLinks().forEach(function(a){a.getMatcher().resetMatcher()});u.ctatdebug("CTATExampleTracerTracer --\x3e out of resetTracer")};this.evaluate=function(a){u.ctatdebug("CTATExampleTracerTracer --\x3e in public evaluate(), calling private _evaluate; given event "+
a);return c(a,!1,!0)};this.nonEmptyHints=function(a,b){u.ctatdebug("CTATExampleTracerTracer --\x3e in nonEmptyHints");if(null===a||"undefined"===typeof a)return 0;var c=a.interpolateHints(b);u.ctatdebug("CTATExampleTracerTracer --\x3e in nonEmptyHints: link.interpolateHints() "+a.interpolateHints().length);if(null===c||"undefined"===typeof c||1>c.length)return 0;for(var d=0,e=0;e<c.length;++e)0<String(c[e]).trim().length&&d++;u.ctatdebug("CTATExampleTracerTracer --\x3e returning from nonEmptyHints "+
d);return d};this.traceForHint=function(a){u.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint");var b=c(a,!0,!1);u.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint return from evaluate "+b);u.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint result from evaluate "+a.getResult().toString());u.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint link   from evaluate "+a.getReportableLink());if(a.getResult().toString()===CTATExampleTracerLink.CORRECT_ACTION.toString())return b=
a.getReportableLink(),a.setTutorSAI(new CTATSAI(a.getStudentSAI().getSelection(),b.getDefaultSAI().getAction(),b.getDefaultSAI().getInput())),a.setActor(CTATMsgType.DEFAULT_STUDENT_ACTOR),u.ctatdebug("CTATExampleTracerTracer --\x3e traceForHint returning hintLink "+b+", result "+a),b;u.ctatdebug("CTATExampleTracerTracer --\x3e out of traceForHint, returning null");return null};this.matchForHint=function(a){u.ctatdebug("CTATExampleTracerTracer --\x3e in matchForHint");var b;b=null===a.getStudentSAI()||
"undefined"===typeof a.getStudentSAI()?null:a.getStudentSAI().getSelectionArray();if(null!==b&&"undefined"!==typeof b&&0<b.length&&(u.ctatdebug("CTATExampleTracerTracer --\x3e in matchForHint first if"),a.setWantReportableHints(!0),b=u.traceForHint(a),null!==b&&"undefined"!==typeof b&&0<a.getReportableHints().length))return u.ctatdebug("CTATExampleTracerTracer --\x3e matchForHint via traceForHint returning "+b+", result "+a),b;b=u.getBestNextLink(!0,a);u.ctatdebug("CTATExampleTracerTracer --\x3e matchForHint() traceForHint via getBestNextLink returning "+
b);return b};this.getBestNextLink=function(a,b){u.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink");var c=[],d=v(a,c);if(null===d||"undefined"===typeof d)return u.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink returning null"),null;if(d.getType().toString()===CTATExampleTracerLink.BUGGY_ACTION.toString())return u.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink return null no correct suboptimal step"),null;u.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink else branch");
u.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink got interp "+(null==c?"null":c[0]));if(b){var e=d.interpolateHints(c[0].getVariableTable());b.setInterpolatedHints(e);u.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink setInterpolatedHints");Array.isArray(e)&&0<e.length?b.setReportableHints(e):b.setReportableHints(d.getHints());u.ctatdebug("In evaluate --\x3e after setReportableHints");b.setReportableLink(d);b.setReportableInterpretation(c[0]);b.setResult(d.getType());b.setTutorSAI(d.getDefaultSAI())}u.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink return etLink");
return d};this.doHint=function(a,b,c,d,e,f){u.ctatdebug("CTATExampleTracerTracer --\x3e in doHint");var g=c=null;if(f&&null!==b&&"undefined"!==typeof b&&1<b.length&&b[1].toString()===CTATMsgType.PREVIOUS_FOCUS.toString()&&null!==a&&"undefined"!==typeof a&&1<a.length&&null!==a[1]&&"undefined"!==typeof a[1]&&a[1].toString()!=="null".toString()&&(u.ctatdebug("CTATExampleTracerTracer --\x3e in doHint first if condition"),c=[],c.push(a[1]),2<b.length))for(u.ctatdebug("CTATExampleTracerTracer --\x3e in doHint inner if condition"),
g=[],a=2;a<b.length;a++)u.ctatdebug("CTATExampleTracerTracer --\x3e in doHint for loop "+a),g.push(b[a]);u.ctatdebug("CTATExampleTracerTracer --\x3e in doHint out of if condition");d=new CTATExampleTracerEvent(u,new CTATSAI(c,g,null),d);d.setHintRequest(!0);u.ctatdebug("CTATExampleTracerTracer --\x3e in doHint result: "+d);b=u.matchForHint(d);Array.isArray(e)&&(u.ctatdebug("CTATExampleTracerTracer --\x3e in doHint last if condition"),e.push(d));u.ctatdebug("CTATExampleTracerTracer --\x3e returning from doHint: "+
b);return b};this.getBestInterpretation=function(){u.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation");if(null===w||"undefined"===typeof w)u.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"),w=q(u.getInterpretationsInternal());u.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation "+(null===w||void 0===w));return w};this.getInterpretationsInternal=function(){u.ctatdebug("CTATExampleTracerTracer --\x3e in getInterpretationsInternal");
return r};this.toString=function(){var a="TracerState\n";null===r?a+="(no interpretations)\n":r.forEach(function(b){a+=b.toString()+"\n"});return a};this.addInterfaceVariablesFromEvent=function(a){if(a){var b=a.getTutorSelection();a=a.getTutorInput();u.addInterfaceVariables(b,a)}};this.addInterfaceVariables=function(a,c){u.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables("+a+", "+c+")");if(a&&c){var d=a.length;d>c.length&&(d=c.length);for(var e=0;e<d;e++)a[e]&&(b.put(a[e],CTATVariableTable.standardizeType(c[e])),
b.put(CTATVariableTable.nameAsString(a[e]),CTATVariableTable.valueAsString(c[e])));u.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables() startStateVT "+b);r&&r.forEach(function(b){if(b=b.getVariableTable()){for(var e=0;e<d;e++)a[e]&&(b.put(a[e],CTATVariableTable.standardizeType(c[e])),b.put(CTATVariableTable.nameAsString(a[e]),CTATVariableTable.valueAsString(c[e])));u.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables() interp.vt "+b)}})}};this.findCurrentState=function(){u.ctatdebug("Entering findCurrentState");
var a=u.getBestInterpretation();return a&&a.getLastMatchedLink()&&a.getLastMatchedLink().isDone()?a.getLastMatchedLink().getNextNode():(a=v(!1,[a]))?a.getPrevNode():E?E.getStartNode():null}};CTATExampleTracerTracer.prototype=Object.create(CTATBase.prototype);CTATExampleTracerTracer.prototype.constructor=CTATExampleTracerTracer;"undefined"!==typeof module&&(module.exports=CTATExampleTracerTracer);var CTATExampleTracerGraph=function(a,b,e){function f(a,b,d){y.ctatdebug("CTATExampleTracerGraph --\x3e in isOrderOK");if(y.relaxOrderConstraints()||b.isDone()&&y.exitOnIncorrectDone())return!0;for(var e=c(b),f=0;f<e.length;f++){var m=e[f];if(!0===C.isGroupOrdered(m))if(f!==e.length-1){if(!1===g(m,h(e[f+1],d),a,d))return!1}else if(!1===g(m,b,a,d))return!1}y.ctatdebug("CTATExampleTracerGraph --\x3e out of isOrderOK");return!0}function d(a,b,d){y.ctatdebug("CTATExampleTracerGraph --\x3e in isReenteringOK");
...
r.forEach(function(a){y.ctatdebug(a.getNodeID())});y.ctatdebug("Links in the graph -- ids, from, to");z.forEach(function(a){y.ctatdebug(a)})};this.getSmallestContainingGroup=function(a){return C.getLowestLevelGroupOfLink(a)};this.redoLinkDepths=function(){m();y.getLinks().forEach(function(a){a.setDepth(-1)});y.getLinks().forEach(function(a){-1===a.getDepth()&&t(a)})};this.getGroupModel=function(){return C};this.setVisualData=function(a){y.ctatdebug("CTATExampleTracerGraph --\x3e in setVisualData");
u=a};this.getVisualData=function(){y.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning "+u);return u};this.getDoneLinks=function(){return D};(function(a,b){y.ctatdebug("CTATExampleTracerGraph --\x3e in initGraph ("+a+" , "+b);z=[];r=[];A={};if(null===C||"undefined"===typeof C)C=new CTATDefaultGroupModel,y.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");C.clear();C.setDefaultReenterable(!b);C.setGroupOrdered(C.getTopLevelGroup(),a);C.setGroupName(C.getTopLevelGroup(),
CTATExampleTracerGraph.TOP_LEVEL);B=new CTATExampleTracerTracer(y,e);y.ctatdebug("CTATExampleTracerGraph --\x3e out of initGraph")})(!a,b)};Object.defineProperty(CTATExampleTracerGraph,"TOP_LEVEL",{enumerable:!1,configurable:!1,writable:!1,value:"Top Level"});CTATExampleTracerGraph.prototype=Object.create(CTATBase.prototype);CTATExampleTracerGraph.prototype.constructor=CTATExampleTracerGraph;"undefined"!==typeof module&&(module.exports=CTATExampleTracerGraph);var CTATGraphParser=function(){function a(a){ctatdebug("processEdge()");for(var d=new CTATExampleTracerLink(null,null,null),e=g.getElementChildren(a),f,h,m,l,n,p=a=-1,w=CTATMsgType.DEFAULT_ACTOR,x=!1,u=0;u<e.length;u++){"sourceID"===g.getElementName(e[u])&&(a=parseInt(g.getNodeTextValue(e[u])),d.setPrevNode(a));"destID"===g.getElementName(e[u])&&(p=parseInt(g.getNodeTextValue(e[u])),d.setNextNode(p));if("rule"===g.getElementName(e[u]))for(var C=g.getElementChildren(e[u]),F=0;F<C.length;F++)"text"===
g.getElementName(C[F])&&d.addSkillName(g.getNodeTextValue(C[F]).toString());if("actionLabel"===g.getElementName(e[u]))for(d.setIsPreferredLink("false"!=g.getElementAttr(e[u],"preferPathMark")),d.setMinTraversalsStr(g.getElementAttr(e[u],"minTraversals")),d.setMaxTraversalsStr(g.getElementAttr(e[u],"maxTraversals")),C=g.getElementChildren(e[u]),F=0;F<C.length;F++){"uniqueID"===g.getElementName(C[F])&&(n=g.getNodeTextValue(C[F]),d.setUniqueID(parseInt(g.getNodeTextValue(C[F]))));"message"===g.getElementName(C[F])&&
(l=new CTATMessage(C[F]));"actionType"===g.getElementName(C[F])&&d.setActionType(g.getNodeTextValue(C[F]));"buggyMessage"===g.getElementName(C[F])&&d.setBuggyMsg(g.getNodeTextValue(C[F]));"successMessage"===g.getElementName(C[F])&&d.setSuccessMsg(g.getNodeTextValue(C[F]));"hintMessage"===g.getElementName(C[F])&&d.addHint(g.getNodeTextValue(C[F]));if("matchers"===g.getElementName(C[F]))for(var y=g.getElementChildren(C[F]),H=0;H<y.length;H++)"Selection"===g.getElementName(y[H])&&(f=b(y[H],0)),"Action"===
g.getElementName(y[H])&&(h=b(y[H],1)),"Input"===g.getElementName(y[H])&&(m=b(y[H],2)),"Actor"===g.getElementName(y[H])&&(w=g.getNodeTextValue(y[H]),x=(x=g.getElementAttr(y[H],"linkTriggered"))&&"false"!=x.toLowerCase().trim()?!0:!1);if("matcher"===g.getElementName(C[F])){h=C[F];f=g.getElementAttr(h,"replacementFormula");h=g.getElementChildren(h);var H=y=void 0,G,J=void 0,N=CTATMsgType.DEFAULT_ACTOR;m=new CTATExactMatcher(CTATMatcher.SELECTION,null);for(var w=new CTATExactMatcher(CTATMatcher.ACTION,
null),L=0;L<h.length;L++)"matcherType"===g.getElementName(h[L])&&(G=g.getNodeTextValue(h[L]),"ExactMatcher"===G&&(H=CTATExactMatcher),"RegexMatcher"===G&&(H=CTATRegexMatcher),"AnyMatcher"===G&&(H=CTATAnyMatcher),"RangeMatcher"===G&&(H=CTATRangeMatcher),"WildcardMatcher"===G&&(H=CTATWildcardMatcher),"ExpressionMatcher"===G&&(H=CTATExpressionMatcher)),"matcherParameter"===g.getElementName(h[L])&&(G=g.getElementAttr(h[L],"name"),J=g.getNodeTextValue(h[L]),"selection"==G&&m.setParameter(J),"action"==
...
null),y.setParameter(J?J:""));y.setReplacementFormula(f);w=[[m],[w],[y],N];f=w[0];h=w[1];m=w[2];w=w[3]}}}c.getStartNode()&&p==c.getStartNode().getNodeID()&&console.log("***WARNING*** edge "+n+" destination is graph startNode "+c.getStartNode());n=new CTATVectorMatcher(f,h,m,w);n.setDefaultSAI(l.getSAI());n.setCaseInsensitive(q);n.setLinkTriggered(x);d.setMatcher(n);ctatdebug("GraphParser.processEdge() "+a+"->"+p+", edge "+d);c.getNode(a).addOutLink(d);c.checkForDoneState(d);return d}function b(a,
b){f.ctatdebug("processMatchers()");for(var c=g.getElementChildren(a),d=[],e=0;e<c.length;e++)if("matcher"===g.getElementName(c[e])){for(var h=null,m=g.getElementAttr(c[e],"replacementFormula"),l=g.getElementChildren(c[e]),n=0;n<l.length;n++){if("matcherType"===g.getElementName(l[n]))switch(h=g.getNodeTextValue(l[n]),f.ctatdebug("CTATGraphParser.processMatchers() matcherType["+n+"] = "+h),h){case "ExactMatcher":h=new CTATExactMatcher(b,null);break;case "RegexMatcher":h=new CTATRegexMatcher(b,null);
break;case "AnyMatcher":h=new CTATAnyMatcher(b,null);break;case "RangeMatcher":h=new CTATRangeMatcher(b,null);break;case "WildcardMatcher":h=new CTATWildcardMatcher(b,null);break;case "ExpressionMatcher":h=new CTATExpressionMatcher(b,null);break;default:console.log("CTATGraphParser.processMatchers() unknown matcherType["+n+"] = "+h+"; using CTATExactMatcher"),h=new CTATExactMatcher(b,null)}if("matcherParameter"===g.getElementName(l[n])){var p=g.getElementAttr(l[n],"name");"single"===p?h.setParameter(g.getNodeTextValue(l[n])):
"minimum"===p?h.setParameter(g.getNodeTextValue(l[n]),"minimum"):"maximum"===p?h.setParameter(g.getNodeTextValue(l[n]),"maximum"):h.setParameter(l[n],p,g)}}h&&h.setReplacementFormula(m);d.push(h)}return d}function e(a,b){var c=new Set;if("group"!==g.getElementName(a))return c;var d=g.getElementAttr(a,"name");ctatdebug("readGroupFromXML group name: "+d);var f="true"===g.getElementAttr(a,"ordered"),h="true"===g.getElementAttr(a,"reenterable");ctatdebug("readGroupFromXML group isOrdered typeof: "+typeof f);
ctatdebug("readGroupFromXML group isOrdered: "+f);for(var m=function(a){c.add(a)},l=g.getElementChildren(a),p=0;p<l.length;p++){if("link"===g.getElementName(l[p])){var q=Number(g.getElementAttr(l[p],"id")),v=b[q];if(null!==v||void 0!==v)ctatdebug("Added link ID : "+q),c.add(v)}"group"===g.getElementName(l[p])&&(ctatdebug("encountered a subgroup"),e(l[p],b).forEach(m))}n.addGroup(d,f,c);n.setGroupReenterable(n.getGroupByName(d),h);return c}CTATBase.call(this,"CTATGraphParser","__undefined__");var f=
this,d,c,g=new CTATXML,h=null,l=[];new XMLSerializer;var n,q=!0,p=!0,x=[];this.getLockWidget=function(){return p};this.parseGraph=function(b,f){ctatdebug("parseBRD()");var m=0,v=g.getElementAttr(b,"startStateNodeName"),r="true"===g.getElementAttr(b,"unordered");q="false"!=String(g.getElementAttr(b,"caseInsensitive")).toLowerCase();p=g.getElementAttr(b,"lockWidget");var z=new CTATVariableTable;c=new CTATExampleTracerGraph(r,!1,z);var A=g.getElementChildren(b),z=g.getElementAttr(b,"suppressStudentFeedback");
if(null===z||void 0===z)z=CTATMsgType.SHOW_ALL_FEEDBACK;c.setFeedbackPolicy(z);f.setFeedbackSuppressed(z);z=g.getElementAttr(b,"highlightRightSelection");f.setHighlightRightSelection("false"!=z);var E=g.getElementAttr(b,"confirmDone");"true"!==E&&"false"!==E&&(E=c.getFeedbackPolicy()===CTATMsgType.HIDE_ALL_FEEDBACK?"true":"false");f.setHintPolicy(g.getElementAttr(b,"hintPolicy"));f.setOutOfOrderMessage(g.getElementAttr(b,"outOfOrderMessage"));for(var I=null,w=0;w<A.length;w++)switch(g.getElementName(A[w])){case "startNodeMessages":l=
g.getElementChildren(A[w]);break;case "node":m++;var D;D=A[w];ctatdebug("processNode("+D+")");var u=g.getElementChildren(D),C=-1;D="";for(var F=0;F<u.length;F++)switch(g.getElementName(u[F])){case "uniqueID":C=parseInt(g.getNodeTextValue(u[F]));break;case "text":D=g.getNodeTextValue(u[F])}u=new CTATExampleTracerNode(C,new Set);""!==D&&u.setNodeName(D);D=u;c.addNode(D);1==m&&(c.setStartNode(D),c.setStudentStartsHereNode(D));D.getNodeName()==v&&c.setStudentStartsHereNode(D);break;case "edge":c.addLink(a(A[w]));
break;case "EdgesGroups":I=A[w];break;case "productionRule":var y=A[w];ctatdebug("processSkill()");for(var u=D="",F=C=null,y=g.getElementChildren(y),H=0;H<y.length;H++){var G=g.getElementName(y[H]);"ruleName"==G&&(D=g.getNodeTextValue(y[H]),ctatdebug("ruleName="+D));"productionSet"==G&&(u=g.getNodeTextValue(y[H]),ctatdebug("productionSet="+u));"label"==G&&(C=g.getNodeTextValue(y[H]),ctatdebug("label="+C));"description"==G&&(F=g.getNodeTextValue(y[H]),ctatdebug("description="+F))}D&&(y=new CTATExampleTracerSkill(u,
D,CTATExampleTracerSkill.DEFAULT_P_GUESS,CTATExampleTracerSkill.DEFAULT_P_KNOWN,CTATExampleTracerSkill.DEFAULT_P_SLIP,CTATExampleTracerSkill.DEFAULT_P_LEARN,CTATExampleTracerSkill.DEFAULT_HISTORY),null!=C?y.setLabel(C):y.setLabel(D),null!=F?y.setDescription(F):y.setDescription(D+(u?" "+u:"")),x.push(y))}if(I){m=g.getElementAttr(I,"ordered");if(null===m||"undefined"==typeof isordered)m=!r;ctatdebug("parseGraph() value of isOrdered = "+m);ctatdebug("parseGraph() value of isUnordered = "+r);ctatdebug("parseGraph() typeof isOrdered: "+
typeof m);ctatdebug("parseGraph()typeof isUnordered: "+typeof r);v=I;A=m;ctatdebug("processGroup()");n=c.getGroupModel();m=n.createIdToLinkMap();n.setGroupOrdered(n.getTopLevelGroup(),A);ctatdebug("processGroup() name of group: "+n.getGroupName(n.getTopLevelGroup()));ctatdebug("processGroup() group isOrdered?: "+n.isGroupOrdered(n.getTopLevelGroup()));ctatdebug("processGroup() order of group: isOrdered= "+A);ctatdebug("processGroup() order of group: isOrdered typeof= "+typeof A);v=g.getElementChildren(v);
for(A=0;A<v.length;A++)switch(g.getElementName(v[A])){case "group":e(v[A],m);break;case "outOfOrderMessage":n.getTopLevelGroup().setDefaultBuggyMsg(g.getNodeTextValue(v[A]))}}m=f.getSkillBarVector(!1,!0);if(!m||1>m.length)ctatdebug("No existing skills. Add skills from BRD."),f.addGraphSkills(x),m=f.getSkillBarVector();h=(new CTATTutorMessageBuilder).createStateGraphMessage(q,r,p,f.isSourceFlash()?c.exitOnIncorrectDone():f.isFeedbackSuppressed(),z,E,m);c.redoLinkDepths();d=c.getExampleTracer();d.resetTracer();
...
b,c,d){p.ctatdebug("Entering addToMessageTank("+a+", "+b+", "+c+")");if(b){g||(g=[],h={},l={});var e={};e.msgType=a;e.msg=b;e.evt=c;e.sai=d;g.push(e);h[a]=h[a]?h[a]+1:1;a=c.getResult();c.getHintRequest()&&(a=CTATExampleTracerLink.HINT_ACTION);l[a]=l[a]?l[a]+1:1;p.ctatdebug("Exiting addToMessageTank() this "+p.toString())}};this.flushMessageTank=function(a,b){p.ctatdebug("Entering flushMessageTank("+a+", "+b+")");if(g&&!(1>g.length)){e(a);p.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length "+
g.length+", transaction_id "+q);for(var m=[],n=[],r=0;r<g.length;++r){var v=g[r];if(v.msg){var A=v.msgType,E=v.evt;p.ctatdebug("entering processInterfaceVariables() msgType "+A+", evt "+E);A&&(p.ctatdebug("entering processInterfaceVariables() et "+c+", tracer "+(c?c.getTracer():null)),A=A.toLowerCase(),0!==A.indexOf("correct")&&0!==A.indexOf("interfaceaction")||c.getTracer().addInterfaceVariablesFromEvent(E));if(!(A=f(v)))if(A=v,E=n,CTATConfiguration.usingFlash()){var I=void 0,w=void 0;if(!(A&&A.sai&&
(I=A.sai.getAction())&&(w=x.exec(I)))||3>w.length||1>=w[2])A=!1;else{var D=E.length-1,D=0>D?null:E[D];A.msg=A.msg.replace(I,w[1]);D&&D.timeout==w[2]?D.msgTuples.push(A):E.push({timeout:Number(w[2]),msgTuples:[A]});A=!0}}else A=!1;A||m.push(v.msg)}}p.ctatdebug("flushMessageTank(): msgBundle.length "+m.length+", delayedMsgsBundle.length "+n.length);for(r=0;r<n.length;++r)v=n[r],p.ctatdebug("processDelayedMsgs() delayedMsgs.timeout "+v.timeout+", .msgTuples.length "+v.msgTuples.length),setTimeout(d,
v.timeout,c,v.msgTuples);0<m.length&&(p.ctatdebug("Bottom of flushMessageTank(); to send bundle of length "+m.length+" via "+c),c.sendBundle(m)&&(p.ctatdebug("CTATMessageTank.shouldSaveNow() resultTypes "+l+", msgTypes "+h),(l[CTATExampleTracerLink.CORRECT_ACTION]||l[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION]||h.CorrectAction||h.InterfaceAction||h.UntutoredAction||c.isFeedbackSuppressed()&&h.AssociatedRules)&&c.isSendingSavedMsgsForRestore()&&(CTATGlobalFunctions.isInstructorMode()?p.ctatdebug("We're in reviewer mode: we shouldn't save as we go"):
...
function(){var a=new Date;h+=a.getTime()-l.getTime();return a};this.restartTimer=function(){l=z.stopTimer();return h};this.addHint=function(a){z.ctatdebug("addHint("+a+")");var b=n[a];null!==b&&"undefined"!==typeof b?(1>b.getNFirstHints()&&++m,b.incrementFirstHints()):(b=new CTATStep(a,CTATStep.StepResult[2]),n[a]=b,m++);p++;b.setLastResult(CTATStep.StepResult[2]);z.ctatdebug("exiting addHint() hint count "+p+", trial "+b)};this.addError=function(a){z.ctatdebug("addError("+a+")");var b=n[a];null!==
b&&"undefined"!==typeof b?(1>b.getNCorrect()&&1>b.getNErrors()&&++B,b.incrementErrors()):(b=new CTATStep(a,CTATStep.StepResult[1]),n[a]=b,B++);x++;b.setLastResult(CTATStep.StepResult[1]);z.ctatdebug("exiting addError() error count "+x+", trial "+b)};this.addCorrect=function(a){var b=n[a];z.ctatdebug("entering addCorrect("+a+") trial "+b);b?(1>b.getNCorrect()&&1>b.getNErrors()&&(++v,1>b.getNFirstHints()&&t++),b.incrementNCorrect()):(z.ctatdebug("to call CTATStep("+a+", StepResult "+CTATStep.StepResult[3]),
b=new CTATStep(a,CTATStep.StepResult[3]),n[a]=b,v++,t++);q++;b.setLastResult(CTATStep.StepResult[3]);z.ctatdebug("exiting addCorrect() correct count "+q+", trial "+b)};this.setShowCounts=function(a){f=a};this.setCompletionStatus=function(a,b){z.ctatdebug("setCompletionStatus("+a+", "+b+")");if(CTATMsgType.CompletionValue[1]!=r||b)r=a};this.getCompletionStatus=function(){return r}};CTATProblemSummary.prototype=Object.create(CTATBase.prototype);CTATProblemSummary.prototype.constructor=CTATProblemSummary;
...
e.slice(0,20));a.enqueueForRestore([]);return}}d=[];if("string"==typeof e&&(e=e.split(/<\/?messages>/),b.ctatdebug("msgsArr.length "+e.length+", msgsArr[1].length "+(e[1]?e[1].length:-1)),!(2>e.length))){e=e[1].split("<message>");b.ctatdebug("problemStateArr.length "+e.length);for(var c=0,f=!1,h=1;h<e.length;++h){var l="<message>"+e[h],n=CTATMsgType.getMessageType(l);CTATMsgType.STATE_GRAPH==n?f=!0:CTATMsgType.START_STATE_END==n?f=!1:f?c++:CTATMsgType.INTERFACE_ACTION==n&&h==e.length-1&&CTATMsgType.isDoneMessage(l)&&
a.getOutputStatus().isComplete()||(a.getProblemStateSaver().appendToProblemState(l,null,!0),d.push(l));b.ctatdebug("problemStateArr["+h+"] "+(f?"omit ":"keep ")+n+" omitted "+c+" kept "+d.length)}}a.enqueueForRestore(d)}}};ProblemStateRestorer.prototype=Object.create(CTATBase.prototype);ProblemStateRestorer.prototype.constructor=ProblemStateRestorer;var SCORMProblemSummary=function(){CTATBase.call(this,"SCORMProblemSummary","")};Object.defineProperty(SCORMProblemSummary,"LESSON_STATUS",{enumerable:!1,configurable:!1,writable:!1,value:"cmi.core.lesson_status"});Object.defineProperty(SCORMProblemSummary,"RAW_SCORE",{enumerable:!1,configurable:!1,writable:!1,value:"cmi.core.score.raw"});Object.defineProperty(SCORMProblemSummary,"EXIT",{enumerable:!1,configurable:!1,writable:!1,value:"cmi.core.exit"});
...
SCORMProblemSummary.SESSION_TIME);return b+e+f+a};CTATMsgType.prototype=Object.create(CTATBase.prototype);CTATMsgType.prototype.constructor=SCORMProblemSummary;"undefined"!==typeof module&&(module.exports=SCORMProblemSummary);var CTATExampleTracer=function(){function a(a,c){c?N|=1<<a:(N&=-65537>>16-a,b())}function b(){m.ctatdebug("workTheQueue() working "+N+", workQueue.length "+J.length+", restoreQueue.length "+G.length);if(0==N)for(;0!=(N=0<J.length|(0<G.length)<<1);){var a,b=!1;0<G.length?(a=G.shift(),b=!0):a=J.shift();if(!e(a,b)){m.ctatdebug("workTheQueue() suspending workQueue.length "+J.length+", restoreQueue.length "+G.length);m.stopWorking(b?1:0);break}m.ctatdebug("workTheQueue() bottom workQueue.length "+J.length+
", restoreQueue.length "+G.length)}}function e(a,b){m.lastMessageAsString=a;var e=m.lastMessageAsXML=(new CTATXML).parseXML(a),g=m.lastMessage=new CTATMessage(e),h=g.getMessageType();m.ctatdebug("CTATExampleTracer.handleMessageFromInterface(msgType "+h+")");switch(h){case CTATMsgType.SET_PREFERENCES:return f(a,g,z,e),!1;case CTATMsgType.INTERFACE_IDENTIFICATION:return!0;case CTATMsgType.UNTUTORED_ACTION:return b&&m.sendBundle([a]),d(a,g,z,e),!0;case CTATMsgType.INTERFACE_ACTION:return b&&m.sendBundle([a]),
c(a,g,z,e),!0;case CTATMsgType.PROBLEM_SUMMARY_REQUEST:return setTimeout(function(a){a=m.getProblemSummary();m.ctatdebug("CTATExampleTracer.ProblemSummaryRequest getProblemSummary() "+m.getProblemSummary());var c="<message><verb>NotePropertySet</verb><properties><MessageType>"+CTATMsgType.PROBLEM_SUMMARY_RESPONSE+"</MessageType>",c=c+SCORMProblemSummary.getProblemSummaryElements(a),c=c+("<ProblemSummary>"+a.toXML(!0)+"</ProblemSummary>"),c=c+"<end_of_transaction>true</end_of_transaction></properties></message>",
d=[];d.push(c);m.sendBundle(d);H.transition(CTATMsgType.PROBLEM_SUMMARY_RESPONSE,a.getCompletionStatus());m.ctatdebug("CTATExampleTracer.handleProblemSummaryRequest() sent result '"+c+"';");m.startWorking(b?1:0)},4E3),!1;case CTATMsgType.START_STATE_END:return H.transition(CTATMsgType.START_STATE_END),!0;case CTATMsgType.PROBLEM_RESTORE_END:return x(),!0;default:return console.log("CTATExampleTracer.handleMessageFromInterface(restoring "+b+") "+(b?"sending":"unprocessed")+" message, type "+h+"\n  "+
a),b&&m.sendBundle([a]),!0}}function f(a,b,c,d){m.ctatdebug("handleSetPreferences ()");L=!1;u=b.getProperty("problem_name");m.ctatdebug("SetPreferences.problem_name = "+u);a=c.getElementChildren(c.getElementChildren(d)[1]);for(b=0;b<a.length;b++)if(d=c.getElementName(a[b]),m.ctatdebug("SetPreferences eltName "+d),d)switch(d.toLowerCase()){case "source_id":C=c.getNodeTextValue(a[b]);break;case "question_file":v=c.getNodeTextValue(a[b]);break;case "skills":m.ctatdebug(" parseSkills("+a[b]+")");d=[];
for(var e=z.getElementChildren(a[b]),f=0;f<e.length;f++){var g=z.getElementName(e[f]);if(g&&"skill"==g.toLowerCase()){var h=z.getElementAttr(e[f],"name");if(h&&""!=h.trim()){var g=z.getElementAttr(e[f],"label"),l=z.getElementAttr(e[f],"pSlip"),n=z.getElementAttr(e[f],"description"),p=z.getElementAttr(e[f],"pKnown"),q=z.getElementAttr(e[f],"category"),t=z.getElementAttr(e[f],"pLearn"),r=z.getElementAttr(e[f],"pGuess"),P=z.getElementAttr(e[f],"history"),h=new CTATExampleTracerSkill(q,h,r,p,l,t,P);h.setLabel(g);
h.setDescription(n);d.push(h)}}}m.getProblemSummary().setSkills(new CTATSkills(d));break;case "problem_state_status":H.transition(CTATMsgType.SET_PREFERENCES,c.getNodeTextValue(a[b]));y||(y=new ProblemStateRestorer(m));m.ctatdebug("SetPreferences problemStateRestorer "+y);break;case "curriculum_service_url":CTATConfiguration.set("curriculum_service_url",c.getNodeTextValue(a[b]));break;case "restore_problem_url":y||(y=new ProblemStateRestorer(m));m.ctatdebug("SetPreferences problemStateRestorer "+
y);CTATConfiguration.set("restoreProblemUrl",c.getNodeTextValue(a[b]));break;case "session_id":S=c.getNodeTextValue(a[b]);break;case "authenticity_token":F.setAuthenticityToken(c.getNodeTextValue(a[b]))}m.ctatdebug("outputStatus "+H+", problemStateRestorer "+y);a=v;m.ctatdebug("retrieveBRD ("+a.indexOf("data:file/brd;base64,")+")");m.ctatdebug("Using network retrieval to obtain BRD ..."+a);M.retrieveXMLFile(a,c,m);y&&y.retrieveMessages(H)}function d(a,b,c,d){b=b.getTransactionID();m.ctatdebug("UntutoredAction ("+
a+"), getTransactionID "+b);F.appendToProblemState(a,m.getOutputStatus(),!1);if(!L)return!1;m.setVariablesFromSAI(d,c);return!0}function c(a,b,c,d){m.ctatdebug("Interface action received.");c=b.getTransactionID();if(!L)return!1;m.messageTank=new CTATMessageTank(m,c);m.ctatdebug("MessageTank "+m.messageTank);m.ctatdebug("InterfaceAction ("+a+"), getTransactionID "+c);var e=b.getSelectionArray().slice(0);d=b.getActionArray().slice(0);m.ctatdebug("selectionArray "+e+", message.getSelectionArray() "+
b.getSelectionArray());if(e[0]&&"_tutor"==e[0].toLowerCase())return m.ctatdebug("handleInterfaceAction tutor cmd SAI "+b.getSAI()+";"),d[0]&&"function"===typeof m[d[0]]&&(c=b.getSAI().getInput(),m[d[0]](c)),!0;!e[0]||"hint"!=e[0].toLowerCase()&&"help"!=e[0].toLowerCase()?(m.ctatdebug("calling doNewExampleTrace(null, "+b.getSAI()+") sai.selectionArray "+b.getSAI().getSelectionArray()+" msg.selectionArray "+b.getSelectionArray()),n(null,b.getSAI(),"student",!0,c,a)):(m.ctatdebug("handleInterfaceAction() hint request: hintPolicy "+
E+", errorSAI "+A),E===CTATHintPolicyEnum.HINTS_UNBIASED?(1<e.length&&(e[1]=""),1<d.length&&(d[1]="")):E!==CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY&&(E===CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY?A&&A.getSelection()?(e.splice(1,0,A.getSelection()),d.splice(1,0,"PreviousFocus")):(e[1]="",d[1]=""):E===CTATHintPolicyEnum.HINTS_BIASED_BY_ALL&&A&&A.getSelection()&&(e.splice(1,0,A.getSelection()),d[1]=CTATMsgType.PREVIOUS_FOCUS.toString())),m.startSkillTransaction(),a=[],d=t.doHint(e,
d,b.getInputArray(),"student",a,!0),b=a[0],a=b.getReportableHints(),e=d?""+d.getUniqueID():"",b.setStepID(e),m.updateSkills(CTATExampleTracerSkill.HINT,d?d.getSkillNames():[],e),m.ctatdebug("Before building hint message: tutorSAI "+b.getTutorSAI()+", hints "+a+", edge # "+e),d=(new CTATTutorMessageBuilder).createHintMessage(a,b.getTutorSAI(),e,c),m.messageTank.addToMessageTank(CTATMsgType.SHOW_HINTS_MESSAGE,d,b,null),c=(new CTATTutorMessageBuilder).createAssociatedRulesMessageForHint(a,b.getTutorSAI(),
q(CTATMsgType.DEFAULT_STUDENT_ACTOR),m.getSkillBarVector(!0),e,c),m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,c,b,null),c=m.getProblemSummary(b.getReportableInterpretation()),m.messageTank.flushMessageTank(c,!0),m.ctatdebug("handleInterfaceAction() sent hint result "+b),A=null);return!0}function g(a,b,c){var d={tutorAdvice:null,msg:null,msgType:null};if(a.getReportableLink())return d.tutorAdvice=a.getSuccessOrBuggyMsg(),d.tutorAdvice&&d.tutorAdvice.trim()?(d.msg=c.createBuggyMessage(a.getTransactionID(),
d.tutorAdvice),d.msgType="BuggyMessage"):d.tutorAdvice=null,d;m.ctatdebug("CTATET.createBuggyMessage() past getReportableLink()");if(a.isDoneStepFailed())return d.tutorAdvice=CTATMsgType.NOT_DONE_MSG,d.msg=c.createBuggyMessage(a.getTransactionID(),d.tutorAdvice),d.msgType="BuggyMessage",d;m.ctatdebug("CTATET.createBuggyMessage() past isDoneStepFailed()");var e=b&&b.getTutorSAI()?b.getTutorSAI().getSelection():null,e=e&&""!==e.trim()?e:null,f=a.getStudentSAI()?a.getStudentSAI().getSelection():null,
f=f&&""!==f.trim()?f:null;m.ctatdebug("CTATET.createBuggyMessage() past hintSelection0 "+e+", studentSelection0 "+f);if(a.getResult()==CTATExampleTracerLink.NO_MODEL&&a.isOutOfOrder()&&e&&e!=f)return m.ctatdebug("CTATET.createBuggyMessage() to create out of order"),m.isHighlightRightSelection()?(d.tutorAdvice=m.getOutOfOrderMessage(),d.msg=c.createHighlightWidgetMessage(e,b.getTutorSAI().getAction(),d.tutorAdvice,a.getTransactionID()),d.msgType="HighlightMsg",m.ctatdebug("createBuggyMessage() out of order with highlight; rtn: "+
d)):(d.tutorAdvice=CTATGlobals.languageManager.getString("OUTOFORDER"),d.msg=c.createBuggyMessage(a.getTransactionID,d.tutorAdvice),d.msgType="BuggyMessage",m.ctatdebug("createBuggyMessage() out of order without highlight; rtn: "+d)),d;if(b=r.getDefaultBuggyMsg())return d.tutorAdvice=b,d.msg=c.createBuggyMessage(a.getTransactionID,d.tutorAdvice),d.msgType="BuggyMessage",m.ctatdebug("createBuggyMessage() default buggy msg: "+d),d;m.ctatdebug("createBuggyMessage() no buggy msg: "+d);return d}function h(a,
b,c,d){m.ctatdebug("checkForTutorAction("+a+", "+b+", "+c+", "+d+")");var e=[];e[0]=l(r.getNode(a),!0);e[1]=l(r.getNode(b),!1);m.ctatdebug("checkForTutorAction() links[0] "+e[0]+", links[1] "+e[1]+";");a=0;if(e[0]===e[1])e[1]=null;else if(null===e[0]||"undefined"===typeof e[0])a=1;b=null;m.messageTank||(m.messageTank=new CTATMessageTank(m,null));for(;a<e.length&&null!==e[a]&&"undefined"!==typeof e[a];++a)if(null==c||"undefined"==typeof c)b=n(e[a],e[a].getDefaultSAI(),e[a].getActor(),!0,null);else{b=
e[a].getEvaluatedInput(c,d.getReportableVariableTable());var f=e[a].getDefaultSAI().clone();f.setInput(b);b=n(e[a],f,e[a].getActor(),!0,null)}m.ctatdebug("checkForTutorAction() returning "+b+";");return b}function l(a,b){if(null===a||"undefined"===typeof a||1!==a.getCorrectOutDegree())return null;var c=null;a.getCorrectOutLinks().forEach(function(a){null===c&&a.isTutorPerformed(b)&&0<a.getMaxTraversals()&&(c=a)});return c}function n(a,b,c,d,e,f){m.ctatdebug("doNewExampleTrace (link "+a+", sai "+b+
", actor "+c+", doTutorPerformedSteps "+d+", transactionID "+e+", origMsgTxt "+f);var g=e;e=new CTATExampleTracerEvent(m,b,c);if(m.getOutputStatus().isComplete()&&b.isDone())return e.setResult(CTATExampleTracerLink.CORRECT_ACTION),e.setTutorSAI(b),e.setTransactionID(g),e=p(e,b,c,!1),m.ctatdebug("doNewExampleTrace("+a+", "+b+", "+c+", "+d+", "+g+") returns "+e),e;m.startSkillTransaction();a&&e.addPreloadedLinkMatch(a);var h=t.evaluate(e);m.ctatdebug("Evaluate returned : "+h+", given link "+a+", result "+
e);a?(m.ctatdebug("result.getTutorSelection() "+e.getTutorSelection()),m.ctatdebug("result.getTutorAction() "+e.getTutorAction()),m.ctatdebug("result.getTutorInput() "+e.getTutorInput()),m.ctatdebug("typeof(messageTank) "+typeof messageTank),f=e.getTutorSelection(),g=e.getTutorAction(),h=e.getTutorInput(),(g=m.messageTank.enqueueToolActionToStudent(f,g,h,CTATTutorMessageBuilder.TUTOR_PERFORMED))&&m.messageTank.setTransaction_id(g)):m.isFeedbackSuppressed()?F.replaceInProblemState(f,m.getOutputStatus(),
e.getStudentSAI(),r.getFeedbackPolicy()==CTATMsgType.HIDE_BUT_ENFORCE):e.getResult()!=CTATExampleTracerLink.CORRECT_ACTION&&e.getResult()!=CTATExampleTracerLink.FIREABLE_BUGGY_ACTION||F.appendToProblemState(f,m.getOutputStatus(),!1);e.setTransactionID(g);e=p(e,b,c,d);m.ctatdebug("doNewExampleTrace("+a+", "+b+", "+c+", "+d+", "+g+") returns "+e);return e}function q(a){return"undefined"!=typeof a&&a&&0<=a.toString().toLowerCase().indexOf("tutor")?"Tutor":"Student"}function p(a,b,c,d){m.ctatdebug("finishNewExampleTrace("+
a+", "+b+", "+c+", "+d+")");b=a.getStudentSAI();var e=a.getTutorSAI(),f=a.getTransactionID(),l=new CTATTutorMessageBuilder,n="",p=[];null!==a.getReportableLink()&&"undefined"!==typeof a.getReportableLink()?p[0]=a.getReportableLink():p[0]=null;p=p[0];if(a.isSolverResult())a.getResult();else if(a.getResult()===CTATExampleTracerLink.CORRECT_ACTION)n=p?""+p.getUniqueID():"",a.setStepID(n),CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase()!=c.toUpperCase()&&m.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION,
l.createCorrectActionMessage(f,e),a,e),null!==p&&"undefined"!==typeof p&&m.updateSkills(CTATExampleTracerSkill.CORRECT,p.getSkillNames(),p.getUniqueID()),n=a.getSuccessOrBuggyMsg(),m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,l.createAssociatedRulesMessageForAction(a.getResult(),e,q(c),b,m.getSkillBarVector(!0,c),p?p.getUniqueID():-1,f,n),a,e),m.ctatdebug("finishNewExampleTrace() successMsg "+n),n&&m.messageTank.addToMessageTank("SuccessMessage",l.createSuccessMessage(f,n),a,null),
A=null,d&&(c=h(p?p.getNextNode():null,t.findCurrentState(!1,!1),m.lastMessage?m.lastMessage.getSAI():null,a))&&(a=c);else{m.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION,l.createInCorrectActionMessage(f,a.getInterpolatedSAI()),a,null);m.ctatdebug("about to do silent traceForHint("+b+"), selectionArray "+b.getSelectionArray());var r=m.lastSilentHintResult=new CTATExampleTracerEvent(m,b,c);r.setHintRequest(!0);var u=t.traceForHint(r);m.ctatdebug("silent hint result: "+r+"; hintLink "+u);
u||(u=t.getBestNextLink(!1,r),m.ctatdebug("getBestNextLink result: "+r+"; hintLink "+u));e=null;u&&((e=r.getTutorSAI())&&e.getSelection()&&a.setTutorSAI(e),n=""+u.getUniqueID(),a.setStepID(n));r=g(a,r,l);m.ctatdebug("createBuggyMessage() tutorAdvice: "+r.tutorAdvice+";\n  msg "+r.msg);m.updateSkills(CTATExampleTracerSkill.INCORRECT,u?u.getSkillNames():[],n);m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,l.createAssociatedRulesMessageForAction(a.getResult(),e&&e.getSelection()?e:b,q(c),
b,m.getSkillBarVector(!0,c),n,f,r.tutorAdvice),a,null);r.msg&&m.messageTank.addToMessageTank(r.msgType,r.msg,a);A=b;d&&CTATExampleTracerLink.FIREABLE_BUGGY_ACTION==a.getResult()?(c=h(p?p.getNextNode():null,t.findCurrentState(!1,!1),m.lastMessage?m.lastMessage.getSAI():null,a))&&(a=c):a.isDoneStepFailed()&&m.messageTank.flushDelayedFeedback()}m.lastResult=a;c=m.getProblemSummary(a.getReportableInterpretation());m.ctatdebug("finishNewExampleTrace() to flushMessageTank");m.messageTank.flushMessageTank(c,
!0);m.ctatdebug("finishNewExampleTrace() sent result "+a.getResult()+", studentSAI "+b);return a}function x(){H.transition(CTATMsgType.PROBLEM_RESTORE_END);var a=m.getSkillBarVector(),b=[],c=new CTATTutorMessageBuilder;b.push(c.createMessage(CTATMsgType.PROBLEM_RESTORE_END,a?{Skills:a}:null));m.sendBundle(b)}CTATBase.call(this,"CTATExampleTracer","tracer");var m=this,v=null,t,B,r,z=new CTATXML;new XMLSerializer;var A=null,E,I=!0,w=!1,D=null,u=null,C=null,F=new ProblemStateSaver(m);F.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());
var y=null,H=new CTATProblemStateStatus,G=[],J=[],N=0,L=!1,S="",Q=null;m.ctatdebug("CTATExampleTracer constructor outputStatus="+H);this.messageTank=this.lastSilentHintResult=this.lastResult=this.lastMessage=this.lastMessageAsXML=this.lastMessageAsString=null;var M=new CTATCommLibrary;this.receiveFromInterface=function(a){m.ctatdebug("CTATExampleTracer.receiveFromInterface() \n  "+a);J.push(a);b()};this.setVariablesFromSAI=function(a,b){var c=CTATMsgType.getSAIArraysFromElement(a,b);m.getTracer()&&
m.getTracer().addInterfaceVariables(c.selection,c.input)};this.traceLinks=function(a){for(var b=[],c=m.getTracer().getBestInterpretation(),d=0;d<a.length&&null!==a[d];++d)c.getTraversalCount(a[d])<a[d].getMinTraversals()&&(m.messageTank=new CTATMessageTank(m,null),b.push(n(a[d],a[d].getDefaultSAI(),a[d].getActor(),!1,null)),m.ctatdebug("traceLinks["+d+"] result "+b[d]));return b};this.enqueueForRestore=function(a){m.ctatdebug("enqueueForRestore: got "+a.length+" message elements");G=G.concat(a);a=
(new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null);G.push(a);m.startWorking(1)};this.startWorking=function(b){a(b,!1)};this.stopWorking=function(b){a(b,!0)};this.goToState=function(a){t.resetTracer();return t.goToState(a,m)};this.goToStartState=function(){return m.goToState("start")};this.processXML=function(a){m.ctatdebug("processXML ()");if(null!=a){m.ctatdebug("No of children"+z.getElementChildren(a).length);var b=new CTATGraphParser,c=b.parseGraph(a,m);r=c.gr;t=
c.tracer;a=c.ssm;c=c.sgMsg;m.ctatdebug("sendStartStateMessages() nMsgs "+a.length+", outputStatus "+H);for(var d=[],e=new XMLSerializer,f=null,g=0;g<a.length;g++)if("message"==z.getElementName(a[g])){var l=e.serializeToString(a[g]),n=CTATMsgType.getMessageType(l);CTATMsgType.UNTUTORED_ACTION!=n&&CTATMsgType.INTERFACE_ACTION!=n||m.setVariablesFromSAI(a[g],z);CTATMsgType.START_STATE_END==n?(f=d,r.getFeedbackPolicy()!=CTATMsgType.SHOW_ALL_FEEDBACK&&(n=new CTATSAI("hint","SetVisible","false"),n=(new CTATTutoringServiceMessageBuilder).createInterfaceActionMessage("dummyTransactionID",
n),f.push(n)),f=l,d.push((new CTATTutoringServiceMessageBuilder).createInterfaceConfigurationEnd()),d.push((new CTATTutorMessageBuilder).createLockWidgetMsg(b.getLockWidget()))):d.push(l)}d.unshift(c);m.ctatdebug("sendStartStateMessages(): "+a.length+" elts, "+d.length+" strings, "+H);m.sendBundle(d);b=f;a:{a=[];c=r.getStartNode();d=r.getStudentStartsHereNode();if(null!==c&&null!==d&&c.getNodeID()!=d.getNodeID()){a=r.getBestSubpath(c,d);m.ctatdebug("advanceToStudentStartsHere() path "+a);if(!a)break a;
a=a.getSortedLinks();a=m.traceLinks(a);m.ctatdebug("advanceToStudentStartsHere() results "+a)}d=c=null;0<a.length&&(d=a[a.length-1],a=d.getReportableLink(),null!==a&&(c=a.getNextNode()));m.ctatdebug("advanceToStudentStartsHere() to check for TPA "+c+", "+d);h(c,t.findCurrentState(!1,!1),null,d)}a=[];b&&a.push(b);H.canRestore()||a.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null));0<a.length&&m.sendBundle(a);L=!0}m.startWorking(0)};this.addGraphSkills=function(a){m.ctatdebug("adding graph skills: "+
a.length);0<a.length&&(a=new CTATSkills(a),a.setExternallyDefined(!1),m.getProblemSummary().setSkills(a))};this.sendBundle=function(a){m.ctatdebug("sending bundle #msgs = "+a.length+", outputStatus "+H);for(var b=0,c=0;c<a.length;c++){m.ctatdebug("Sending message #"+c);var d=a[c];0>=c&&(d='<?xml version="1.0" encoding="UTF-8"?>'+d);F.forwardToInterface(d,c>=a.length-1,H)&&++b}return 0<b};this.setHintPolicy=function(a){E=CTATHintPolicyEnum.lookup(a)};this.isHighlightRightSelection=function(){return I};
this.setHighlightRightSelection=function(a){I=a};this.updateSkills=function(a,b,c){var d=[];m.ctatdebug("in updateSkills("+b+") with step ID = "+c+", transaction result = "+a);var e=m.getProblemSummary().getSkills();if(null===e||"undefined"===typeof e)return d;b.forEach(function(b){b=e.updateSkill(a,b,c);null!==b&&"undefined"!==typeof b&&d.push(b)});return d};this.getSessionID=function(){return S};this.getProblemSummary=function(a){m.ctatdebug("Entering getProblemSummary() problemSummary "+D);if(null===
D||"undefined"===typeof D){var b=m.getProblemName();D=null===b||"undefined"===typeof b||1>b.length?new CTATProblemSummary("NoProblemDefined",null,m.isFeedbackSuppressed()):new CTATProblemSummary(b,null,m.isFeedbackSuppressed())}a&&D.setRequiredSteps(a.countStepsForScore(r));return D};this.getProblemName=function(){return u};this.getSourceID=function(){return C};this.isSourceFlash=function(){return"string"==typeof C&&C.match(/flash/i)};this.isFeedbackSuppressed=function(){return w};this.setFeedbackSuppressed=
function(a){w="false"===a?!1:"true"===a?!0:a===CTATMsgType.SHOW_ALL_FEEDBACK?!1:a===CTATMsgType.HIDE_ALL_FEEDBACK?!0:a===CTATMsgType.HIDE_BUT_ENFORCE?!0:a===CTATMsgType.HIDE_BUT_COMPLETE?!0:!1;m.ctatdebug("setFeedbackSuppressed("+a+"): "+w);D&&D.setCountOnlyLastResults(w)};this.getSkillBarVector=function(a,b){var c=m.getProblemSummary().getSkills();return null===c||"undefined"===typeof c?null:"Student"!=q(b)?null:"undefined"!=typeof a&&a?c.getSkillBarVector(!1,!1):c.getSkillBarVector(!0,!0)};this.startSkillTransaction=
function(){var a=m.getProblemSummary().getSkills();a&&a.startTransaction()};this.getProblemStateSaver=function(){return F};this.isSendingSavedMsgsForRestore=function(){return m.getOutputStatus().isSendingSavedMsgsForRestore()};this.getOutputStatus=function(){return H};this.setOutputStatus=function(a){var b=H.getStatus();m.ctatdebug("setOutputStatus() old "+b+", new "+a);CTATProblemStateStatus[a]?H.setStatus(CTATProblemStateStatus[a]):(console.error("CTATExampleTracer.setOutputStatus() unexpected argument "+
a),H.setStatus(CTATProblemStateStatus.empty))};this.getFeedbackPolicy=function(){return r?r.getFeedbackPolicy():CTATMsgType.SHOW_ALL_FEEDBACK};this.getGraph=function(){return r};this.getTracer=function(){return t};this.getOutOfOrderMessage=function(){return B?B:CTATMsgType.DEFAULT_OUT_OF_ORDER_MESSAGE};this.setOutOfOrderMessage=function(a){B=a};this.getDelayedFeedback=function(){null==Q&&(Q={});return Q};this.clearDelayedFeedback=function(){Q=null};this.getQuestionFile=function(a){if(!v||a)return v;
