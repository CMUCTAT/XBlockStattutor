...
var jstz = function() {
  ...
  "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, b = function(a) {
    ...
    a = a.getTime() + b;
    for (var d = (new Date(g)).getTimezoneOffset(), f = null;g < a - c;) {
      var e = new Date(g);
      if (e.getTimezoneOffset() !== d) {
        f = e;
        break;
      }
      g += c;
    ...
    for (var d = {}, f = jstz.olson.dst_rules.zones, e = f.length, h = a[g], w = 0;w < e;w++) {
      var x = f[w], y;
      y = f[w];
      for (var z = 0, B = 0;B < b.length;B++) {
        if (y.rules[B] && b[B]) {
          if (b[B].s >= y.rules[B].s && b[B].e <= y.rules[B].e) {
            z = 0, z += Math.abs(b[B].s - y.rules[B].s), z += Math.abs(y.rules[B].e - b[B].e);
          } else {
            z = "N/A";
            break;
          }
    ...
    for (var C in d) {
      if (d.hasOwnProperty(C) && -1 != h.indexOf(C)) {
        return C;
      }
    }
    return g;
    ...
    var b = function() {
      for (var a = [], b = 0;b < jstz.olson.dst_rules.years.length;b++) {
        ...
        for (var d = (new Date(g)).getTimezoneOffset(), f = null, h = null;g < c - 864E5;) {
          var l = new Date(g), p = l.getTimezoneOffset();
          p !== d && (p < d && (f = l), p > d && (h = l), d = p);
          g += 864E5;
        }
        c = f && h ? {s:e(f).getTime(), e:e(h).getTime()} : !1;
        a.push(c);
      }
      return a;
    }();
...
(function(a, b) {
  ...
  function f(a, b, c, g) {
    var d = ["opacity", b, ~~(100 * a), c, g].join("-");
    c = .01 + c / g * 100;
    g = Math.max(1 - (1 - a) / b * (100 - c), a);
    var f = n.substring(0, n.indexOf("Animation")).toLowerCase();
    p[d] || (m.insertRule("@" + (f && "-" + f + "-" || "") + "keyframes " + d + "{0%{opacity:" + g + "}" + c + "%{opacity:" + a + "}" + (c + .01) + "%{opacity:1}" + (c + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + g + "}}", m.cssRules.length), p[d] = 1);
    return d;
  }
  function d(a, b) {
    var c = a.style, g, d;
  ...
  function k() {
    ...
    h.prototype.lines = function(a, d) {
      function f() {
        return e(c("group", {coordsize:l + " " + l, coordorigin:-k + " " + -k}), {width:l, height:l});
      }
      function h(a, l, m) {
        b(p, b(e(f(), {rotation:360 / d.lines * a + "deg", left:~~l}), b(e(c("roundrect", {arcsize:d.corners}), {width:k, height:d.scale * d.width, left:d.scale * d.radius, top:-d.scale * d.width >> 1, filter:m}), c("fill", {color:g(d.color, a), opacity:d.opacity}), c("stroke", {opacity:0}))));
      }
      var k = d.scale * (d.length + d.width), l = 2 * d.scale * k, m = -(d.width + d.length) * d.scale * 2 + "px", p = e(f(), {position:"absolute", top:m, left:m});
      if (d.shadow) {
        for (m = 1;m <= d.lines;m++) {
  ...
  c(h.prototype, {spin:function(b) {
    this.stop();
    var c = this, g = c.opts, d = c.el = a(null, {className:g.className});
    e(d, {position:g.position, width:0, zIndex:g.zIndex, left:g.left, top:g.top});
    b && b.insertBefore(d, b.firstChild || null);
    ...
    if (!n) {
      ...
      (function A() {
        ...
        for (var a = 0;a < g.lines;a++) {
          k = Math.max(1 - (f + (g.lines - a) * t) % m * p, g.opacity), c.opacity(d, a * g.direction + h, k, g);
        }
    ...
    function h(b, c) {
      return e(a(), {position:"absolute", width:d.scale * (d.length + d.width) + "px", height:d.scale * d.width + "px", background:b, boxShadow:c, transformOrigin:"left", transform:"rotate(" + ~~(360 / d.lines * k + d.rotate) + "deg) translate(" + d.scale * d.radius + "px,0)", borderRadius:(d.corners * d.scale * d.width >> 1) + "px"});
    }
    for (var k = 0, l = (d.lines - 1) * (1 - d.direction) / 2, m;k < d.lines;k++) {
      m = e(a(), {position:"absolute", top:1 + ~(d.scale * d.width / 2) + "px", transform:d.hwaccel ? "translate3d(0,0,0)" : "", opacity:d.opacity, animation:n && f(d.opacity, d.trail, l + k * d.direction, d.lines) + " " + 1 / d.speed + "s linear infinite"}), d.shadow && b(m, e(h("#000", "0 0 4px #000"), {top:"2px"})), b(c, b(m, h(g(d.color, k), "0 0 1px rgba(0,0,0,.1)")));
    }
    return c;
  ...
  if ("undefined" !== typeof document) {
    ...
    var r = e(a("group"), {behavior:"url(#default#VML)"});
    !d(r, "transform") && r.adj ? k() : n = d(r, "animation");
  }
  return h;
});
...
;var CTATConfig = {Options:{}, addProperty:function(a, b, f, d) {
  f = f || b[0];
  Object.defineProperty(CTATConfig, a, {enumerable:!0, configurable:!1, writable:!d, value:f.toLowerCase()});
  var e = {};
...
function introspect(a, b, f, d) {
  ...
  if ("object" === e) {
    if (0 < d) {
      f = [f, "  "].join("");
      for (var c in b) {
        e = this.introspect(c, b[c], f, d - 1), a = [a, "\n", e].join("");
      }
      return a;
    }
    return [a, " ..."].join("");
  }
  return "null" === e ? [a, " null"].join("") : [a, " ", b].join("");
}
...
function getIndicesOf(a, b, f) {
  var d = 0, e = a.length, c = [];
  f || (b = b.toLowerCase(), a = a.toLowerCase());
  for (;-1 < (f = b.indexOf(a, d));) {
    c.push(f), d = f + e;
  }
  return c;
}
...
var CTATBase = function(a, b) {
  ...
  this.ctatdebugInternal = function(a, b) {
    var g = a, d = "No msg assigned yet";
    if (null === g || void 0 === g) {
      g = "No message!";
    }
    "" === g && (g = "Empty message!");
    if (useDebuggingBasic) {
      d = f("Unknown", "undefined", g), null === customconsole && (customconsole = getSafeElementById("customconsole")), null !== customconsole ? (customconsole.innerHTML += d + "<br>", customconsole.scrollTop = customconsole.scrollHeight) : console.log(d);
    } else {
      ...
      "google" == CTATConfig.platform ? Logger.log(d) : (null === customconsole && (customconsole = getSafeElementById("customconsole")), null !== customconsole && (customconsole.innerHTML += d + "<br>", customconsole.scrollTop = customconsole.scrollHeight));
    }
  };
...
var CTATShellTools = {ctat_base:new CTATBase("CTATShellTools", "shelltools"), components:{}, component_descriptions:{}, registerComponentDescription:function(a) {
...
}, feedback_components:[], registerFeedbackComponent:function(a, b, f, d, e) {
  CTATShellTools.feedback_components.push({component:a, next:b, prev:f, showHints:d, showFeedback:e});
  ...
  var f = CTATShellTools.component_descriptions, d = [], e = null, e = -1 < a.indexOf(".") ? $('[id="' + a + '"]') : $("#" + a);
  if (0 < e.length) {
    var c = [];
    e.each(function() {
  ...
  e = $('div[data-ctat-component]:has(input[name="' + a + '"])');
  if (0 < e.length) {
    var g = [];
    e.each(function() {
  ...
  for (var h in f) {
    ...
    if (e.name == a) {
      if (null === e.getComponentPointer()) {
        return null;
      }
      d = [];
      d.push(e.getComponentPointer());
      return d;
    }
    e.groupName == a && d.push(e.getComponentPointer());
  }
  return null === d ? -1 != a.indexOf(".") ? (f = a.split("."), this.findComponent(f[0])) : d : 0 === d.length && -1 != a.indexOf(".") ? (f = a.split("."), this.findComponent(f[0])) : d;
...
var CTATSAI = function(a, b, f, d) {
  ...
  var c = "undefined", g = "undefined", h = new CTATStringUtil, k = [], l = [], p = [], n = [], m = [], t = [], r, w = this;
  ...
  this.setSAI = function(a, b, d, f, e) {
  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, c = 0;c < a.length;c++) {
      ...
      if ("selection" == r.getElementName(g) || "Selection" == r.getElementName(g)) {
        for (var d = r.getElementChildren(g), f = !1, e = 0;e < d.length;e++) {
          b = d[e], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > e ? this.setSelectionArray(b) : this.appendToSelectionArray(b), f = !0, this.setSelection(b));
        }
        !1 === f && (b = r.getNodeTextValue(g), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == r.getElementName(g) || "Action" == r.getElementName(g)) {
        d = r.getElementChildren(g);
        f = !1;
        for (e = 0;e < d.length;e++) {
          b = d[e], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > e ? this.setActionArray(b) : this.appendToActionArray(b), f = !0, this.setAction(b));
        }
        !1 === f && (b = r.getNodeTextValue(g), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == r.getElementName(g) || "value" == r.getElementName(g) || "Input" == r.getElementName(g)) {
        ...
        for (var l = 0;l < b.length;l++) {
          var m = b[l];
          "value" == r.getElementName(m) && (h = r.getElementChildren(m), null !== h ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + h.length), 1 === h.length ? (h = d.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + h), f.setValue(h)) : (h = d.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + h), f.setValue(h), f.setName(m.attributes.getNamedItem("name").value), f.setType(m.attributes.getNamedItem("type").value), 
          f.setFormat(m.attributes.getNamedItem("format").value), e++), 1 > l ? this.setInputArray(h) : this.appendToInputArray(h)) : (m = d.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), f.setValue(m), 1 > l ? this.setInputArray(m) : this.appendToInputArray(m)));
        }
      }
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, c = 0;c < a.length;c++) {
      ...
      if ("internalArguments" == r.getElementName(g) || "Input" == r.getElementName(g)) {
        b = g.childNodes;
        k = [];
        var d = new CTATHTMLManager, f = new CTATArgument, e = 0, h = null;
        k.push(f);
        for (var l = 0;l < b.length;l++) {
          if (h = b[l], "value" == r.getElementName(h)) {
            var m = r.getElementChildren(h);
            null !== m ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + m.length), 1 === m.length ? (h = d.htmlDecode(r.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + h), f.setValue(h)) : (h = d.htmlDecode(r.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + h), f.setValue(h), f.setName(r.getElementAttr("name")), f.setType(r.getElementAttr("type")), f.setFormat(r.getElementAttr("format")), e++)) : (h = d.htmlDecode(r.getNodeTextValue(h)), this.ctatdebug("Setting new value to: " + 
            h), f.setValue(h));
  ...
  if (Array.isArray(a) && Array.isArray(b) && (Array.isArray(f) || null == f) && (this.setSelectionArray(a), this.setActionArray(b), this.setInputArray(f), x = !0, 0 < a.length && 0 < b.length)) {
    this.setSAI(a[0], b[0], null == f ? null : f[0], "String", d);
    return;
  }
  null !== a && "" !== a && this.setSelection(a);
  null !== a && (this.setSAI(a, b, f, "String", d), x || (this.setSelectionArray(Array.isArray(a) ? a : [a]), this.setActionArray(Array.isArray(b) ? b : [b]), this.setInputArray(Array.isArray(f) ? f : [f]), x = !0));
...
var CTATSkill = function() {
  ...
  var a = "", b = "", f = "", d = "", e = 0, c = "", g = !1, h = "", k = "", l = "", p = "", n = "";
  ...
  this.setLevel = function(a) {
    !0 === isNaN(a) ? ctatdebug("Error: attempting to set a level to NaN") : (e = a, this.setPKnown(String(e)));
  };
...
var CTATSkillSet = function() {
  ...
  this.parseByValue = function(b) {
    ...
    if (b) {
      b = b.childNodes;
      for (var f = new CTATXML, d = 0;d < b.length;d++) {
        var e = f.getNodeTextValue(b[d]).split("`"), c = e[0].split(" ");
        4 == e.length ? this.addSkill(c[0], e[1], e[2], e[3], e[3], c[1]) : this.addSkill(c[0], e[1], e[2], e[3], e[4], c[1]);
      }
    } else {
  ...
  this.parseDOM = function(a) {
    ...
    for (var d = 0;d < a.length;d++) {
      var e = f.getNodeTextValue(a[d]).split("`"), c = e[0].split(" ");
      4 == e.length ? this.addSkill(c[0], e[1], e[2], e[3], e[3], c[1]) : this.addSkill(c[0], e[1], e[2], e[3], e[4], c[1]);
    }
  };
      ...
      if (b = b.childNodes) {
        for (var f = 0;f < b.length;f++) {
          ...
          if ("Skill" == d.nodeName || "skill" == d.nodeName) {
            this.ctatdebug("Parsing node (" + f + "): " + d.nodeName + " -> " + d.nodeValue);
            var e = "";
            d.attributes.getNamedItem("history") && (e = d.attributes.getNamedItem("history").value);
            this.addSkill(d.attributes.getNamedItem("name").value, d.attributes.getNamedItem("pKnown").value, .95, d.attributes.getNamedItem("label").value, d.attributes.getNamedItem("label").value, d.attributes.getNamedItem("category").value, d.attributes.getNamedItem("pGuess").value, d.attributes.getNamedItem("pLearn").value, d.attributes.getNamedItem("pSlip").value, e);
          }
        }
      } else {
  ...
  this.addSkill = function(a, f, d, e, c, g, h, k, l, p) {
    this.ctatdebug("addSkill() name = " + a + " level = " + f + " mastery = " + d + " aDescription = " + e + " adisplayName = " + c + " aCategory = " + g + " pguess= " + h + " plearn = " + k + " pslip = " + l + " history = " + p);
    a = this.setSkillLevel(a, f, d);
    this.ctatdebug("Configuring " + a.getDisplayName());
    e && a.setDescription(e);
  ...
  this.setSkillLevel = function(a, f, d) {
    this.ctatdebug("setSkillLevel (" + a + "," + f + "," + d + ")");
    d = this.getSkill(a);
    null === d ? (this.ctatdebug("Skill not found, creating new one ..."), d = new CTATSkill, d.setSkillName(a), d.setLevel(f), this.internalSkillSet.push(d)) : (this.ctatdebug("Skill found, adjusting ..."), d.setLevel(1), d.setLevel(f));
    d.setTouched(!0);
    return d;
  };
  this.getSkill = function(a) {
    ...
    for (var f = 0;f < this.internalSkillSet.length;f++) {
      var d = this.internalSkillSet[f];
      if (d.getSkillName() == a) {
        return this.ctatdebug("Returning: " + f), d;
      }
    }
    return null;
  };
  ...
  this.toLogString = function() {
    ...
    for (var a = "", f = 0;f < this.internalSkillSet.length;f++) {
      var d = this.internalSkillSet[f], a = a + ('<skill probability="' + d.getLevel() + '"><name>' + d.getSkillName() + "</name>");
...
var transformArray = [], CTATJSON = function() {
  ...
  this.parseJSON = function(b) {
    ...
    if ("string" == typeof b) {
      ...
      try {
        ...
        return this.ctatdebug("Error parsing JSON message: " + e.message), a = null;
      }
  ...
  this.getElementChildren = function(a) {
    ...
    for (c in a) {
      var g = a[c];
      if ("string" == typeof g) {
        b = new CTATJSONObject, b.name = c, b.value = g, e.push(b);
      } else {
        if (null == g[0] || void 0 == g[0]) {
          b = new CTATJSONObject, b.name = c, b.value = g, e.push(b);
        } else {
          for (var h in g) {
            b = new CTATJSONObject, b.name = c, b.value = g[h], e.push(b);
          }
        }
      }
    }
  ...
  this.walk = function(a) {
    ...
    if (!(5 < b)) {
      ...
      for (e in a) {
        var c = a[e];
        this.ctatdebug("(" + d + ") typeof (key): " + typeof e + " -> typeof(value): " + typeof c + "(" + c.length + ")");
        "string" != typeof c ? (this.ctatdebug("walk (" + e + ")"), this.walk(c)) : this.ctatdebug("walk (" + e + ") : " + c);
        d++;
      }
    }
  };
...
var CTATMessage = function(a) {
  ...
  var e = "ungraded", c = !1, g = !1, h = new CTATSkillSet, k = "", l = "", p = "", n = "", m = "", t = null, r = !1;
  ...
  this.parse = function() {
    ...
    if (null !== b) {
      ...
      for (var a = d.getElementChildren(b), g = 0;g < a.length;g++) {
        var e = a[g];
        "properties" == d.getElementName(e) && (ctatdebug("Found a 'properties' element ... "), f = d.getElementChildren(e));
      }
  ...
  this.parseSAI = function() {
    ...
    if ("tool_message" == k) {
      ...
      for (e = 0;e < a.length;e++) {
        if (f = a[e], "tool_message" == d.getElementName(f)) {
          for (f = d.getElementChildren(f), l = 0;l < f.length;l++) {
            r = f[l], "event_descriptor" == d.getElementName(r) && (t = new CTATSAI, t.fromXMLInternal(r));
          }
        }
      }
      g = !0;
      ...
      if (c) {
        ...
        for (var u = d.getElementChildren(b), E = 0;E < u.length;E++) {
          var q = u[E];
          if ("event_descriptor" == d.getElementName(q)) {
            for (var q = d.getElementChildren(q), F = 0;F < q.length;F++) {
              var D = q[F];
              "selection" == d.getElementName(D) && (a = d.getNodeTextValue(D), r.push(D));
              "action" == d.getElementName(D) && (e = d.getNodeTextValue(D), C.push(D));
              "input" == d.getElementName(D) && (f = d.getNodeTextValue(D), G.push(D));
              "prompt" == d.getElementName(D) && (l = d.getNodeTextValue(D));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), u = d.getElementChildren(b), E = 0;E < u.length;E++) {
          if (q = u[E], "properties" == d.getElementName(q)) {
            for (q = d.getElementChildren(q), F = 0;F < q.length;F++) {
              D = q[F], this.ctatdebug("Nodename: " + d.getElementName(D)), "Skills" == d.getElementName(D) && h.parseByValue(D), "SuccessMsg" == d.getElementName(D) && (p = a = d.getNodeTextValue(D)), "BuggyMsg" == d.getElementName(D) && (n = d.getNodeTextValue(D)), "Selection" == d.getElementName(D) && (a = d.getNodeTextValue(D), r.push(D)), "Action" == d.getElementName(D) && (e = d.getNodeTextValue(D), C.push(D)), "Input" == d.getElementName(D) && (f = d.getNodeTextValue(D), G.push(D)), "prompt" == 
              d.getElementName(D) && (l = d.getNodeTextValue(D)), "HighlightMsgText" == d.getElementName(D) && (m = d.getNodeTextValue(D));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + e + "," + f);
      "" !== a && null !== a ? (t = new CTATSAI(a, e, f, l), t.setArrayFromElements(r), t.setArrayFromElements(C), t.setArrayFromElements(G), g = !0) : (this.ctatdebug("No SAI found"), g = !1);
      ...
      if (!c) {
        for (var a = d.getElementChildren(b), g = 0;g < a.length;g++) {
          ...
          if ("properties" == d.getElementName(e)) {
            for (var e = d.getElementChildren(e), f = 0;f < e.length;f++) {
              var h = e[f];
  ...
  this.parseMessageType = function() {
    ...
    for (var a = d.getElementChildren(b), c = 0;c < a.length;c++) {
      ...
      if ("properties" == d.getElementName(g)) {
        for (var g = d.getElementChildren(g), e = 0;e < g.length;e++) {
          var f = g[e];
...
var CTATCompBase = function(a, b, f, d, e, c) {
  CTATBase.call(this, a, b);
  var g = f || 0, h = d || 0, k = e || -2, l = c || -2, p = 50, n = 25, m = !1, t = "", r = !1, w = !0, x = null, y = "", z = -1;
  this.isTabIndexable = !0;
  var B = 0, C = null, G = null, u = this, E = null, q = "hidden", F = CTATGlobalFunctions.gensym.z_index(), D = CTATGlobalFunctions.gensym.div_id(), A = CTATGlobalFunctions.gensym.z_index(), H = CTATGlobalFunctions.gensym.div_id();
  ...
  this.makeDivWrapper = function(a) {
    ...
    x.style.top = h + "px";
    x.style.zIndex = F;
    x.style.width = u.getWidth() + "px";
    x.style.height = u.getHeight() + "px";
  ...
  this.createCanvas = function() {
    ...
    E.setAttribute("height", l + canvasCalibrate + "px");
    E.setAttribute("style", "border: 1px " + this.borderColor + " solid; " + ("hidden" == q ? "visibility: hidden; " : "") + "z-index:" + A + ";");
    x.firstChild ? x.insertBefore(E, x.firstChild) : x.appendChild(E);
    return E;
  };
  ...
  this.getWidth = function() {
    if (0 >= k) {
      var a;
      C ? a = window.getComputedStyle(C) : x && (a = window.getComputedStyle(x));
      if (a) {
  ...
  this.setEnabled = function(a) {
    ...
    u.assignEnabled(a);
    C ? C.disabled = !w : u.ctatdebug("Error: component pointer is null");
  };
  ...
  this.setInitialized = function(a) {
    ...
    r = a;
    !0 !== r || x ? u.ctatdebug("Not wrapping, initialized=" + r + ", divWrapper = " + x) : (u.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."), (a = findPointOfAttachment(this.getName())) ? (u.ctatdebug("Attaching component to existing MovieClip ..."), u.wrapComponent(a.getDivWrapper())) : (u.ctatdebug("Attaching component to main div ..."), $("#" + ctatcontainer).first() && u.wrapComponent(getSafeElementById(ctatcontainer))));
    u.ctatdebug("setInitialized () done");
  };
  this.addSafeEventListener = function(a, b, c) {
    u.ctatdebug("addSafeEventListener (" + a + ")");
    u.ctatdebug("Adding event listener to: " + c);
    c ? c.addEventListener(a, b) : (C ? (u.ctatdebug("Adding eventlistener to component instead of target"), C.addEventListener(a, b)) : u.ctatdebug("Error: pointer to component is null, can't add event listener"), u.ctatdebug("addSafeEventListener () done"));
  };
  ...
  this.move = function(a, b) {
    g = a;
    h = b;
    x && (x.style.left = g + "px", x.style.top = h + "px");
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    q = !0 === a ? "block" : "hidden";
    E && E.setAttribute("style", "border: 0px; position: absolute; " + (a ? "" : "visibility:hidden; ") + "; left:" + g + "px; top:" + h + "px; z-index:" + A + ";");
  ...
  this.processTabOrder = function() {
    u.ctatdebug("processTabOrder (" + z + ")");
    !0 === m ? u.ctatdebug("Component is an abstract component, bump") : C ? (u.ctatdebug("We have a component, actually assigning to html component ..."), C.tabIndex = z, C.onfocus = u.processOnFocus) : u.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
  ...
  this.addSelectorAttribute = function(a, b, c) {
    ...
    a: {
      if (0 === f) {
        ...
        for (var p = 0;p < d.length && null !== d[p][0];p++) {
          if (d[p][0] == a) {
            a = p;
            break a;
          }
...
CTAT.Component = {};
CTAT.Component.Base = {};
CTAT.Component.Base.Style = function(a, b, f, d, e, c) {
  CTATCompBase.call(this, a, b, f, d, e, c);
  var g = new CTATCSS;
...
CTAT.Component.Base.Graphical = function(a, b, f, d, e, c, g) {
  CTAT.Component.Base.Style.call(this, a, b, d, e, c, g);
  ...
  var k = CTATGlobals.Visual.BackgroundColor, l = "white", p = 1, n = CTATGlobals.Visual.BorderColor, m = !1, t = "solid", r = 0, w = "1px", x = 0, y = CTATGlobals.Font.color, z = "black", B = CTATGlobals.Font.family, C = CTATGlobals.Font.size, G = !1, u = !1, E = !1;
  ...
  this.getFontFamily = function() {
    return this.component ? $(this.component).css("font-family") : B;
  };
  this.setFontFamily = function(a) {
    B = a;
    this.component && this.getFontFamily() !== B && (this.component.style.fontFamily = B);
    return this;
  };
  ...
  this.setFontSize = function(a) {
    a = parseInt(a);
    C = isNaN(a) ? CTATGlobals.Font.size : a;
    this.component && parseInt(this.getFontSize()) !== C && (this.component.style.fontSize = C + "pt");
    return this;
  };
  ...
  this.getBolded = function() {
    return this.component ? "bold" === window.getComputedStyle(this.component).getPropertyValue("font-weight") : G;
  };
  this.setBolded = function(a) {
    G = CTATGlobalFunctions.stringToBoolean(a);
    this.component && this.getBolded() !== G && (this.component.style.fontWeight = G ? "bold" : null);
    return this;
  };
...
CTAT.Component.Base.SAIHandler = function(a, b, f, d, e, c, g) {
  CTAT.Component.Base.Graphical.call(this, a, b, f, d, e, c, g);
...
CTAT.Component.Base.Tutorable = function(a, b, f, d, e, c, g) {
  CTAT.Component.Base.SAIHandler.call(this, a, b, f, d, e, c, g);
...
CTAT.Component.Base.Clickable = function(a, b, f, d, e, c, g) {
  CTAT.Component.Base.Tutorable.call(this, a, b, f, d, e, c, g);
  var h = this;
...
var CTATRadioButton = function(a, b, f, d, e) {
  CTAT.Component.Base.Clickable.call(this, "CTATRadioButton", "__undefined__", a, b, f, d, e);
...
var CTATButtonBasedComponent = function(a, b, f, d, e, c, g) {
  CTAT.Component.Base.Clickable.call(this, a, b, f, d, e, c, g);
...
var CTATImageButtonComponent = function(a, b, f, d, e, c, g) {
  CTATButtonBasedComponent.call(this, a, b, f, d, e, c, g);
...
var CTATImageButton = function(a, b, f, d, e) {
  CTATImageButtonComponent.call(this, "CTATImageButton", "__undefined__", a, b, f, d, e);
...
var CTATConfiguration = function() {
  ...
  var a = this, b = [], f = null, d = null, e = null, c = null;
  ...
  this.getSingleParameterValues = function(b) {
    ...
    for (var d = a.getRawFlashVars(), e = 0;e < b.length;++e) {
      ctatdebug("CTATConfiguration.getSingleParameterValues [" + e + "]: " + b[e]), d[b[e]] && c.push(b[e]);
    }
    return c;
  };
  this.generateDefaultConfiguration = function(b) {
    ...
    if (window && window.frameElement && (d = window.frameElement.getAttribute("data-params"))) {
      ...
      for (var e in b) {
        c[e] = CTATGlobals.EncodedParams[e] ? decodeURIComponent(b[e].replace(/\+/g, "%20")) : b[e];
      }
    }
    if (null == b) {
      for (e = $('object param[name="flashvars"]'), a.ctatdebug("generateDefaultConfiguration() objs " + e), b = 0;b < e.length;++b) {
        if (d = $(e[b]).attr("value"), a.ctatdebug("generateDefaultConfiguration() fVarsAsString " + d), d && (d = parseQueryStringArgs(d)) && d.question_file) {
          for (v in d) {
            c[v] = d[v];
          }
        }
    ...
    if (null == c) {
      ...
      if ("undefined" != typeof CTATTarget && ("CTAT" == CTATTarget || "Default" == CTATTarget)) {
        ...
        null != b && (ctatdebug("tutorPrep(): Assigning parsed arguments ..."), e = b);
      }
      b = !1;
      for (var m in e) {
        if (e.hasOwnProperty(m)) {
          switch(ctatdebug("Processing external FlashVar " + m + "(" + e[m] + ")"), m) {
            case "GENERATED":
              "on" == e[m] && (b = new CTATGuid, c.session_id = b.guid(), b = !0);
              break;
            case "BRD":
              c.question_file = e[m];
              break;
            case "BRMODE":
              c.BehaviorRecorderMode = e[m];
              break;
            case "PROBLEM":
              c.problem_name = e[m];
              break;
            case "DATASET":
              ...
              break;
            case "LEVEL1":
              c.dataset_level_name1 = e[m];
              break;
            case "TYPE1":
              c.dataset_level_type1 = e[m];
              break;
            case "LEVEL2":
              c.dataset_level_name2 = e[m];
              break;
            case "TYPE2":
              c.dataset_level_type2 = e[m];
              break;
            case "LEVEL3":
              c.dataset_level_name3 = e[m];
              break;
            case "TYPE3":
              c.dataset_level_type3 = e[m];
              break;
            case "LEVEL4":
              c.dataset_level_name4 = e[m];
              break;
            case "TYPE4":
              c.dataset_level_type4 = e[m];
              break;
            case "USER":
              c.user_guid = e[m];
              break;
            case "SESSION":
              !1 === b && (c.session_id = e[m]);
              break;
            case "SOURCE":
              c.source_id = e[m];
              break;
            case "LOGTYPE":
              ...
              break;
            case "PORT":
              c.remoteSocketPort = e[m];
              break;
            case "REMOTEURL":
              c.remoteSocketURL = e[m];
              break;
            case "DISKDIR":
              c.log_to_disk_directory = e[m];
              break;
            case "USEOLI":
              c.DeliverUsingOLI = e[m];
              break;
            case "log_service_url":
              c.log_service_url = e[m];
              break;
            case "URL":
              c.log_service_url = e[m];
              break;
            case "LOGURL":
              ...
              break;
            case "CONNECTION":
              c.tutoring_service_communication = e[m];
              break;
            case "SUI":
              c.sui = e[m];
              break;
            ...
            case "SessionLog":
              ...
              break;
            case "KEYBOARDGROUP":
              "Disabled" == e[m] && (c.keyboard = "disabled");
              "Auto" == e[m] && (c.keyboard = "auto");
              "On" == e[m] && (c.keyboard = "on");
              break;
            default:
              c[m] = e[m];
          }
  ...
  this.preParse = function() {
    ...
    for (d = !0;1 == d;) {
      d = !1;
      var e = "custom_field_name" + (c + 1), f = "custom_field_value" + (c + 1);
  ...
  this.getConditionTypes = function() {
    e = [];
    var b = 0;
    void 0 != a.raw.study_condition_type && "" != a.raw.study_condition_type && (e.push(a.raw.study_condition_type), b++);
    for (var c = 0, d = !0;1 == d;) {
      var d = !1, f = "study_condition_type" + (c + 1);
      null != a.raw[f] && (a.ctatdebug("Adding: " + f + "," + a.raw[f]), e[c + b] = a.raw[f], d = !0, c++);
    }
    return e;
  };
...
var CTATJumble = function(a, b, f, d, e) {
  CTAT.Component.Base.Tutorable.call(this, "CTATJumble", "aJumble", a, b, f, d, e);
  ...
  this.init = function() {
    ...
    a ? (n.innerHTML = a, $(n).children().addClass("CTAT-jumble--item").attr({unselectable:"on", draggable:!0}).each(function() {
      ...
      this.addEventListener("dragend", B, !1);
    })) : this.init_items(c);
    this.component.addEventListener("focus", this.processFocus);
  };
  ...
  this.init_items = function(a) {
    if (n) {
      ...
      for (var c = a.length, g = 0;g < c;g++) {
        ...
        d.addEventListener("dragstart", t, !1);
        d.addEventListener("dragenter", w, !1);
        d.addEventListener("dragover", r, !1);
        d.addEventListener("dragleave", x, !1);
        d.addEventListener("drop", y, !1);
        d.addEventListener("dragend", B, !1);
        b.appendChild(d);
        z.push(d);
      }
      n.innerHTML = "";
  ...
  this.getOrder = function() {
    for (var a = n.children, b = [], g = 0;g < a.length;g++) {
      var d = a[g];
      d.draggable && (d.id ? b.push(d.id) : console.log("ERROR: The CTATJumble " + p.getName() + " has a child with no id attribute: " + d + "!!!"));
    }
    return c = b.join(";");
  };
  this.updateSAI = function() {
...
var CTATConnection = function(a) {
  ...
  var b = null, f = null, d = !1, e = this, c = "text/plain";
  e.setSocketType("http");
  ...
  this.createHTTPObject = function() {
    ...
    if (window.XMLHttpRequest) {
      e.ctatdebug("Creating regular XMLHttpRequest ..."), f = new XMLHttpRequest, f.overrideMimeType && f.overrideMimeType("text/html");
    } else {
      if (e.ctatdebug("Trying alternative HTTP object creation ..."), window.ActiveXObject) {
        e.ctatdebug("Detected window.ActiveXObject ...");
        try {
          e.ctatdebug("Creating Msxml2.XMLHTTP ..."), f = new ActiveXObject("Msxml2.XMLHTTP");
        } catch (a) {
          try {
            e.ctatdebug("Creating Microsoft.XMLHTTP ..."), f = new ActiveXObject("Microsoft.XMLHTTP");
          } catch (b) {
  ...
  this.send = function() {
    ...
    e.getHTTPObject().onerror = function() {
      e.ctatdebug("Networking error!");
    };
    try {
      e.getHTTPObject().open("POST", e.getURL(), !0);
    } catch (a) {
      e.ctatdebug("Error in newConnection.httpObject.open: " + a.message);
      return;
    }
    e.init();
    try {
      b ? e.getHTTPObject().send(b) : e.getHTTPObject().send();
    } catch (a) {
...
NOTDONE:"I'm sorry, but you are not done yet. Please continue working.", AUTHORPLEASECLOSE:"Authoring Tools disconnected. Please close this page."}, CTATLanguageManager = function(a, b, f) {
...
var CTATGraphicsTools = function(a, b, f, d, e, c) {
  CTATBase.call(this, "CTATGraphicsTools", "__undefined__");
  var g = b || 1, h = f || "#000000", k = d || "#EEEEEE", l = e || !1, p = "Arial", n = a || null;
  a = c || !1;
  var m = 0, t = this;
  if (null == n) {
  ...
  this.drawLine = function(a, b, c, g, d, e) {
  ...
  this.drawTextFormatted = function(a, b, c, d, g, e, f, h, k, l) {
    if (null != n) {
      a += m;
      b += m;
      d = "";
      ...
      d += "12pt " + p;
      try {
        n.fillStyle = e, n.font = d, n.fillText(c, a, b);
      } catch (t) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
...
var CTATShape = function(a, b, f, d, e, c) {
  var g = this;
  if (void 0 == a || null == a) {
    return g.ctatdebug("--- Error: Must pass a valid ID. ---"), null;
  }
  var h = [], k = [], l = e, p = c, n = b, m = void 0, t = "black", r = "black", w = "Arial", x = 12, y = [], z = 1, B = 5, C = document.createElement("canvas");
  C.id = n;
  C.width = l;
  C.height = p;
  var G = new CTATCSS;
  G.addCSSAttribute("position", "absolute");
  G.addCSSAttribute("left", f + "px");
  G.addCSSAttribute("top", d + "px");
  G.addCSSAttribute("visibility", "visible");
  G.addCSSAttribute("background-color", "rgba(0, 0, 0, 0)");
  G.addCSSAttribute("border-style", "none");
  C.setAttribute("style", G.toCSSString());
  getSafeElementById(a).appendChild(C);
  var u = new CTATGraphicsTools(C.getContext("2d"));
  u.setGraphicBorderWidth(z);
  u.setLineColor(t);
  u.setFillColor(r);
  ...
  this.setXPoints = function(a) {
    h = a;
    G.modifyCSSAttribute("left", h[0] + "px");
    C.setAttribute("style", G.toCSSString());
  };
  this.setYPoints = function(a) {
    k = a;
    G.modifyCSSAttribute("top", k[0] + "px");
    C.setAttribute("style", G.toCSSString());
  };
  this.setWidth = function(b) {
    l = b;
    "main-canvas" != a && (C.width = l);
  };
  this.setHeight = function(b) {
    p = b;
    "main-canvas" != a && (C.height = p);
  };
  this.setName = function(a) {
    n = a;
  };
  ...
  this.detatchCanvas = function() {
    a == ctatcontainer ? getSafeElementById(a).removeChild(C) : getSafeElementById("ctatdiv" + a).removeChild(C);
  };
  ...
  this.drawLine = function() {
    u.drawLine(h[0] + z, k[0] + z, h[1], k[1], t, z);
  };
  this.drawCircle = function() {
    u.drawCircle(h[0] + B, k[0] + B, B);
  };
  this.drawCircleFilled = function() {
    u.drawCircleFilled(h[0] + B, k[0] + B, B - 1);
  };
  this.drawRectangle = function(a, b, c, d) {
    u.drawRectangle(a[0] + z, b[0] + z, l - z, p - z);
  };
  this.drawRectangleFilled = function() {
    u.drawRectangleFilled(h[0], k[0], l, p);
  };
  this.drawRoundedRect = function() {
    u.drawRoundedRect(h[0] + z, k[0] + z, l - B - z, p - B - z, B);
  };
  this.drawRoundedRectFilled = function() {
    u.drawRoundedRectFilled(h[0] + z, k[0] + z, l - B - z, p - B - z, B);
  };
  this.drawText = function() {
    u.drawText(x / 2, x / 2, m);
  };
  this.drawTriangle = function() {
    u.drawTriangle(h[0] + z, k[0] + z, h[1], k[1], h[2], k[2]);
  };
  ...
  this.erase = function() {
    ...
    G.addCSSAttribute("border-style", "none");
    C.setAttribute("style", G.toCSSString());
    a == ctatcontainer ? getSafeElementById(a).appendChild(C) : getSafeElementById("ctatdiv" + a).appendChild(C);
    for (var b = 0;b < y.length;b++) {
      C.addEventListener(y[b][0], y[b][1]);
    }
  };
};
...
var scrimIsUp = !1, errorScrim = !1, waitScrim = !0, warnScrim = !1, connectionScrim = !1, authorTimeSet = !0, inAuthorTime = !0, CTATScrim = function() {
  ...
  var d = "", e = !1, c = !1, g = !1, h = null, k = null, l = new CTATCanvasComponent("CTAT Scrim"), p = [], n = null, m = null, t = null, r = null, w = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (w.ctatdebug("scrimUp ()"), b = CTATGlobals.languageManager.filterString(b), w.ctatdebug("Message: " + b), 1 == scrimIsUp ? (d = 1 == waitScrim ? b : d + (" \n " + b), l.removeComponent()) : (d = b, scrimIsUp = !0), w.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        w.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + d + "<br><br></div></div></div>"), !0 === g && (t = f(a, "close"), $(t).appendTo("#scrimpanel")), !0 === e && (n = f(h, "yes"), $(n).appendTo("#scrimpanel")), !0 === c && (m = f(k, "no"), $(m).appendTo("#scrimpanel")), 
        1 == waitScrim)) {
  ...
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && w.scrimDownForced(), w.ctatdebug("OKScrimUp (" + a + "," + b + ")"), c = e = g = warnScrim = errorScrim = !1, w.scrimUp(a), r = f(b, "OK"), $(r).appendTo("#scrimpanel"));
  };
  this.confirmScrimUp = function(a, b, d) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && w.scrimDownForced(), w.ctatdebug("confirmScrimUp (" + a + "," + b + "," + d + ")"), c = e = !0, k = d, h = b, w.scrimUp(a));
  };
...
var CTATWSConnection = function(a) {
  ...
  var b = "", f = !1, d = this, e = null, c = [], g = !1, h = 0, k = 0, l = null, p = null;
  d.setSocketType("ws");
  this.setConsumed = function(a) {
    f = a;
  ...
  this.init = function() {
    d.ctatdebug("init (" + d.getURL() + "); websocket " + e);
    null == e && (e = new WebSocket(d.getURL()), e.addEventListener("open", function(a) {
      ...
      g = !1;
      a instanceof CloseEvent ? e.close(a.code, a.reason) : e.close();
      p && p(a);
    }), e.addEventListener("error", function(a) {
      d.ctatdebug("STATUS: error");
      g = !1;
      e.close(1002, "client closing in response to error");
    }), d.ctatdebug("init () done"));
  };
  this.send = function() {
    d.ctatdebug("send ()");
    d.init();
    !1 === g ? (d.ctatdebug("Connection not ready yet, storing ..."), c.push(b)) : (d.ctatdebug("Connection ready, sending data ..."), h = (new Date).getTime(), e.send(b));
  };
};
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b) {
  ...
  var f = authenticityToken = "", d = 0, e = [], c = a ? a : null, g = null == b ? !0 : b, h = !0, k = null, l = this, p = "http";
  ...
  this.send_post = function(a, b) {
    ...
    if (!0 === globalCommDisabled) {
      ...
      var c = flashVars.getRawFlashVars(), d = a;
      "websocket" == l.getSocketType() ? (d = a.replace("http:", "ws:"), c = l.createConnection(c, d), c.setData(b), l.ctatdebug(b)) : (c = l.createConnection(c, d), c.setData(b));
      null != k && k.processOutgoing(b);
      c.send();
    }
  };
  this.processReply = function(a) {
    l.ctatdebug("processReply (" + e.length + "," + a + ")");
    var b = 0, d = !1;
    a = [];
    for (var f = 0, f = 0;f < e.length;f++) {
      var h = e[f], p = h.getHTTPObject();
      l.ctatdebug("Testing connection entry " + f + ", readyState: " + p.readyState + ", testConnection.consumed: " + h.getConsumed());
      4 == p.readyState && 0 == h.getConsumed() ? (l.ctatdebug("Investigating request response: " + b + " -> " + p.status + ", for: " + h.getURL()), d = !1, 0 === p.status && (d = !0, l.ctatdebug("Received message (status 0): " + p.responseText)), 408 == p.status && (d = !0, l.ctatdebug("Received message (status 408): " + p.responseText), g && CTATScrim.scrim.scrimDown()), 502 == p.status && (d = !0, l.ctatdebug("Received message (status 502): " + p.responseText), g && CTATScrim.scrim.errorScrimUp("Error contacting the server, please refresh the page and try again (HTTP status 502: gateway response).")), 
      200 == p.status ? (d = !0, l.ctatdebug("Processing 200 response ..."), null !== c ? (a.push(p.responseText), null != k && k.processIncoming(p.responseText)) : l.ctatdebug("Error: httphandler is null, can't process response!")) : c && c.processError && (d = !0, l.ctatdebug("Processing non-200 response, status " + p.status), c.processError(p.status, p.responseText)), !1 === d && l.ctatdebug("Error: status not handled for: " + p.status), l.ctatdebug("Marking connection as consumed ..."), h.setConsumed(!0)) : 
  ...
  this.checkEntries = function() {
    l.ctatdebug("checkEntries (" + e.length + ")");
    for (var a = 0, b = 0, b = 0;b < e.length;b++) {
      var c = e[b];
      if (!0 === c.getConsumed()) {
        return l.ctatdebug("Removing : " + c.getID()), e.splice(a, 1), !0;
      }
      var d = c.getHTTPObject();
      l.ctatdebug("Check, readyState: " + d.readyState + ", consumed: " + c.getConsumed());
      a++;
    }
    return !1;
  };
  this.retrieveXMLFile = function(a, b, c) {
    ...
    d.onreadystatechange = function() {
      l.ctatdebug("onready... GET for xmlFile xmlhttp.readyState " + d.readyState + ", .status " + d.status + ", parser " + b);
      if (4 == d.readyState && 200 == d.status) {
        var g = null;
        d.responseXML ? (l.ctatdebug("parsing brd xml using something else"), g = d.responseXML.documentElement) : (l.ctatdebug("parsing brd xml using node"), g = (b = new CTATXML).parseXML(d.responseText));
        null == g ? (g = (new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile " + a), l.ctatdebug("Error parsing xmlFile " + a + ": " + g), CTAT.ToolTutor.sendToInterface(g, !0)) : c.processXML(g);
      }
    };
    d.onerror = function() {
...
var CTATTutoringServiceMessageBuilder = function() {
  ...
  this.createSetPreferencesMessage = function(a) {
    ...
    f = f + ("<log_to_remote_server>" + d + "</log_to_remote_server><log_to_disk>" + e + "</log_to_disk>") + ("<log_to_disk_directory>" + b.log_to_disk_directory + "</log_to_disk_directory>");
  ...
  this.createAssociatedRulesMessage = function(a, b, f, d, e, c) {
...
var CTATCurriculumService = function(a) {
  ...
  this.sendSummary = function(d) {
    ...
    var e = new CTATXML, c = d.getXMLObject();
    d = c.getElementsByTagName("ProblemSummary");
    d = $("<div>").html(d[0].innerHTML).text();
    e.xmlToString(c);
    var c = flashVars.getRawFlashVars(), e = c.curriculum_service_url, g = new CTATXML, h = g.parse(d), g = g.getElementAttr(h, "CompletionStatus");
    e ? ("complete" == g && (CTATScrim.scrim.nextProblemScrimUp(), a.assignMessageListener(f), a.assignHandler(f)), b = [], this.addVariable("user_guid", c.user_guid), this.addVariable("session_id", c.session_id), this.addVariable("authenticity_token", c.authenticity_token), this.addVariable("school_name", c.school_name), this.addVariable("summary", d), d = c.target_frame, g = c.reuse_swf, c = c.run_problem_url, this.addVariable("targetFrame", d), this.addVariable("reuseSWF", g), f.ctatdebug("CTATCurriculumService.sendSummary about to send targetFrame = " + 
    d + ", reuseSwf " + g + ", runProblemUrl " + c), a.send_post_variables(e, b)) : "complete" == g && CTATScrim.scrim.scrimUp("Congratulations, you are done with this problem.");
  };
...
var CTATLogMessageBuilder = function() {
  ...
  this.createContextMessage = function(b) {
    ...
    if (null != b && null != f) {
      ...
      for (var e = "<dataset>" + ("<name>" + c.dataset_name + "</name>"), k = 0;k < b.length;k++) {
        a.ctatdebug("Adding ..."), e += '<level type="' + b[k] + '">', e += "<name>" + f[k] + "</name>";
      }
      e += "<problem ";
    ...
    if (0 < b.length) {
      for (k = 0;k < b.length;k++) {
        c += "<condition><name>" + b[k] + "</name>", c += "" == e[k] ? "" : "<type>" + e[k] + "</type>", c += "" == f[k] ? "" : "<desc>" + f[k] + "</desc>", c += "</condition>";
      }
    }
  ...
  this.createSemanticEventToolMessage = function(d, e, c, g, h) {
    ...
    e = '<semantic_event transaction_id="' + e + '" name="' + c + '"';
    "" != g && (e += ' subtype="' + g + '"');
    l += e + "/>";
    g = "<event_descriptor>";
    d = d.toXMLString(!0);
  ...
  this.createTutorMessage = function(d, e, c, g, h, k, l, p) {
  ...
  this.addCustomFields = function(d, e) {
    a.ctatdebug("addCustomFields ()");
    if (void 0 != d) {
      for (var c = 0;c < d.length;c++) {
        b.push(d[c]), f.push(e[c]);
      }
    }
  };
  this.addCustomField = function(d, e) {
    a.ctatdebug("addCustomfield (" + d + "," + e + ")");
    b.push(d);
    f.push(e);
  };
...
var CTATNameTranslator = function() {
  ...
  this.manufactorJSON = function(a, d) {
    ...
    var c = this.getA1Row(e[0]), g = this.getA1Col(e[0]), h = this.getA1Row(e[1]), k = this.getA1Col(e[1]);
  ...
  this.translateFromCTAT = function(f, d) {
    if (!0 === a) {
      return f;
    }
    var e = f.toLowerCase();
    b.ctatdebug("translateFromCTAT (" + e + ")");
    var c = 0, g = 0, g = "";
    if (-1 != e.indexOf(".r")) {
      var h = e.split("."), c = h[1].split("r");
      ...
      if (0 === e.indexOf("r")) {
        var h = e.indexOf("c"), k = parseInt(e.substr(1, h - 1)), e = parseInt(e.substr(h + 1)), c = k + 1, g = e;
        b.ctatdebug("Original row (2nd format) (columnindex: " + h + "): " + k + " -> " + c + ", original col: " + e + " -> " + g);
        g = colName(g, !1) + c;
  ...
  this.columnToLetter = function(a) {
    for (var b, e = "";0 < a;) {
      b = (a - 1) % 26, e = String.fromCharCode(b + 65) + e, a = (a - b - 1) / 26;
    }
    return e;
  };
  this.letterToColumn = function(a) {
    for (var b = 0, e = a.length, c = 0;c < e;c++) {
      b += (a.charCodeAt(c) - 64) * Math.pow(26, e - c - 1);
    }
    return b;
  };
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, f = !0, d = !1, e = !1, c = [], g = "undefined", h = "undefined", k = "undefined", l = "undefined", p = "undefined", n = "undefined", m = "undefined", t = "undefined", r = "UnassignedDataset", w = "UnassignedLevelName", x = "UnassignedLevelType", t = (new CTATGuid).guid();
  ...
  this.initCheck = function() {
    ...
    0 == d && 0 == e && (b.setupExternalLibraryUsage(), e = !0);
  };
  ...
  this.logSemanticEvent = function(a, c, g, d, e, f) {
  ...
  this.logTutorResponse = function(a, c, g, d, e, f, h, k, p) {
    ...
    a = commLogMessageBuilder.createTutorMessage(c, a, g, e, k, d, h, !0);
    this.sendMessage(a);
  };
  this.processMessage = function(a) {
...
var CTATMessageHandler = function() {
  ...
  var a = null, b = this, f = [], d = null, e = 0, d = CTATConfig.parserType_is_XML() ? new CTATXML : new CTATJSON;
  ...
  this.processSingleMessage = function(c) {
    ...
    for (var k = 0;k < c.length;k++) {
      ...
      if ("properties" == d.getElementName(l)) {
        ...
        for (var p = d.getElementChildren(l), n = 0;n < p.length;n++) {
          var m = p[n];
          if ("MessageType" == d.getElementName(m)) {
            m = d.getNodeTextValue(m);
            ...
            if ("AssociatedRules" == m) {
              ...
              for (var t = "", r = "", w = 0;w < p.length;w++) {
                var x = p[w];
                "TutorAdvice" == d.getElementName(x) && (t = d.getNodeTextValue(x));
                "Actor" == d.getElementName(x) && d.getNodeTextValue(x);
                "Indicator" == d.getElementName(x) && (r = d.getNodeTextValue(x));
                "StepID" == d.getElementName(x) && d.getNodeTextValue(x);
                "LogAsResult" == d.getElementName(x) && d.getNodeTextValue(x);
                "tool_selection" == d.getElementName(x) && d.getNodeTextValue(x);
                "Skills" == d.getElementName(x) && (b.ctatdebug("Processing skills ..."), null === skillSet && (b.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."), skillSet = new CTATSkillSet), skillSet.parseByValue(x));
              }
              a.processAssociatedRules(h, r, t);
            ...
            if ("ShowHintsMessage" == m) {
              ...
              for (w = 0;w < p.length;w++) {
                if (x = p[w], "HintsMessage" == d.getElementName(x)) {
                  for (var x = d.getElementChildren(x), y = 0;y < x.length;y++) {
                    var z = x[y];
                    "value" == d.getElementName(z) && (r.push(d.getNodeTextValue(z)), t = !0);
                  }
                }
              }
              !0 === t ? a.processHintResponse(h, r) : b.ctatdebug("Error: incomplete hint message received");
            ...
            "InterfaceReboot" == m && (m = "AUTHORING" == CTATTarget ? location.href : null, b.ctatdebug("Found: InterfaceReboot -- href " + m), m && 1 < ++e && location.replace(m));
          }
        }
      }
    }
  ...
  this.processInterfaceDescription = function(a) {
    ...
    for (var c = "Unknown", e = "Unknown", f = null, p = 0;p < a.length;p++) {
      var n = a[p];
      ...
      if ("serialized" == d.getElementName(n)) {
        ...
        for (var m = d.getElementChildren(n), t = 0;t < m.length;t++) {
          var r = m[t];
          -1 != d.getElementName(r).indexOf("CTAT") && (f = r);
        }
      }
  ...
  this.deserializeComponent = function(a, c, e) {
    ...
    if (null === d.getElementAttr(e, "x")) {
      ...
      var f = d.getElementAttr(e, "x"), p = d.getElementAttr(e, "y"), n = d.getElementAttr(e, "width"), m = d.getElementAttr(e, "height"), t = d.getElementAttr(e, "tabIndex"), r = d.getElementAttr(e, "zIndex");
      null === t && (t = -1);
      null === r && (r = 0);
      ...
      for (f = 0;f < e.length;f++) {
        p = e[f];
        d.getElementName(p);
        if ("Parameters" == d.getElementName(p)) {
          for (this.ctatdebug("Processing component parameters ..."), n = d.getElementChildren(p)[0], n = d.getElementChildren(n), m = 0;m < n.length;m++) {
            var x = n[m];
            if ("CTATComponentParameter" == d.getElementName(x)) {
              this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");
              for (var r = t = void 0, x = d.getElementChildren(x), y = 0;y < x.length;y++) {
                var z = x[y];
                "name" == d.getElementName(z) && (this.ctatdebug("Found parameter name: " + d.getNodeTextValue(z)), t = d.getNodeTextValue(z));
                "value" == d.getElementName(z) && (this.ctatdebug("Found parameter value: " + d.getNodeTextValue(z)), r = d.getNodeTextValue(z).trim());
              }
              this.ctatdebug("Parameter name: " + t + ", value: " + r);
              void 0 !== t && (w.params[t] = r, "group" == t && (w.groupName = r));
            }
          }
        }
        if ("Styles" == d.getElementName(p)) {
          for (this.ctatdebug("Processing component styles ..."), p = d.getElementChildren(p)[0], p = d.getElementChildren(p), n = 0;n < p.length;n++) {
            if (r = p[n], "CTATStyleProperty" == d.getElementName(r)) {
              this.ctatdebug("Processing style property (CTATStyleProperty) ...");
              t = m = "";
              r = d.getElementChildren(r);
              for (x = 0;x < r.length;x++) {
                y = r[x], "name" == d.getElementName(y) && (m = d.getNodeTextValue(y)), "value" == d.getElementName(y) && (t = d.getNodeTextValue(y).trim());
              }
    ...
    if (0 == f.length) {
      ...
      if (0 < startStateHandlers.length) {
        ...
        for (c = 0;c < f.length;c++) {
          var e = f[c];
          b.ctatdebug("Processing startstate message type: " + e.getMessageType() + "(" + inProcessStartStateActions + ")");
        ...
        if ("" != scriptElement) {
          try {
            ...
            alert("Error executing script from BRD: " + d.message);
          }
        }
      }
    }
...
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForHint = function(a, b, f, d, e, c) {
...
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForAction = function(a, b, f, d, e, c, g, h) {
...
CTATTutorMessageBuilder.prototype.isDoneStep = function(a, b) {
  ...
  var e = "done" == d;
  this.ctatdebug("isDoneStep() indicatorObj " + f + ", selectionObj " + d + ", correct[0] " + b[0] + ", result " + e);
  return e;
};
CTATTutorMessageBuilder.prototype.createHintMessage = function(a, b, f, d) {
  f = "<message><verb>SendNoteProperty</verb><properties><MessageType>ShowHintsMessage</MessageType><HintsMessage>";
  for (var e = 0;e < a.length;e++) {
    f += "<value><![CDATA[" + a[e] + "]]\x3e</value>";
  }
...
CTATTutorMessageBuilder.prototype.createStateGraphMessage = function(a, b, f, d, e, c, g) {
  ...
  a += "<highlightRightSelection>" + e + "</highlightRightSelection>";
...
CTATTutorMessageBuilder.prototype.createHighlightWidgetMessage = function(a, b, f, d) {
...
CTATLMS.init.OLI = function() {
  ...
  CTATLMS.saveProblemState = function(b) {
    var f = a();
    f.commandName = "writeFileRecord";
    f.attemptNumber = CTATConfiguration.get("current_attempt");
    f.fileName = CTAT.ToolTutor.tutor.getQuestionFile();
    f.mimeType = "text/xml";
    f.byteEncoding = "urlencoded";
    f.fileRecordData = b.problem_state;
    b = [];
    for (var d in f) {
      b.push(d + "=" + encodeURIComponent(f[d]));
    }
  ...
  CTATLMS.getProblemState = function(b) {
    ...
    $.post(CTATConfiguration.get("superactivity_url"), d.join("&"), null, "text").done(function(a) {
      b(a);
    });
  };
  CTATLMS.gradeStudent = function(b, f) {
    var d = !1, e = 0;
    0 >= f ? (e = 100, d = !0) : (e = Math.round(100 * b / f), d = b >= f);
    var c = a();
    ...
    var e = [], g = null;
    for (g in c) {
      e.push(g + "=" + encodeURIComponent(c[g]));
    }
    $.post(CTATConfiguration.get("superactivity_url"), e.join("&"), null, "application/x-www-form-urlencoded");
    c.scoreId = "completed";
    c.scoreValue = d;
    e = [];
    for (g in c) {
...
CTATLMS.init.TutorShop = function() {
  ...
  CTATLMS.getProblemState = function(a) {
    CTATConfiguration.get("restoreProblemUrl") ? $.get(CTATConfiguration.get("restoreProblemUrl"), "", null, "text").done(function(b) {
      ...
      a(null);
      b = (new CTATTutorMessageBuilder).createErrorMessage("Load ProblemState Error", f + " " + d);
...
var CTATCommShell = function() {
  ...
  var a = null, b = this, f = null, d = null, e = {}, c = null, g = null, h = null, k = null, l = [], d = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  this.init = function(c) {
    this.ctatdebug("init ()");
    var e = flashVars.getRawFlashVars(), g = "http://";
    "https" == e.tutoring_service_communication && (g = "https://");
    e.remoteSocketURL && -1 != e.remoteSocketURL.indexOf("http") && (g = "");
    a = c;
    ...
    this.ctatdebug("Connecting to: " + g + e.remoteSocketURL + ":" + e.remoteSocketPort);
    commLibrary.sendXMLURL(commMessageBuilder.createSetPreferencesMessage(version), g + e.remoteSocketURL + ":" + e.remoteSocketPort);
  };
  ...
  this.processComponentAction = function(a, c, e, g) {
    ...
    g = new CTATTutoringServiceMessageBuilder;
    var d = "", d = !1 !== c ? g.createInterfaceActionMessage(e, a) : g.createUntutoredActionMessage(e, a);
    commLibrary.sendXML(d);
  };
  ...
  this.processCorrectAction = function(a) {
    ...
    if (e[g] && null != c) {
      ...
      var d = CTATShellTools.findComponent(g);
      if (null != d) {
        for (ctatdebug("Processing " + d.length + " components ..."), g = 0;g < d.length;g++) {
          ctatdebug("Check " + d[g].getName()), d[g] ? d[g].setCorrect && d[g].setCorrect(a) : b.ctatdebug("Internal error, component pointer is null");
        }
      } else {
    ...
    if (e[g] && null != c) {
      ...
      if (null != d) {
        for (g = 0;g < d.length;g++) {
          ctatdebug("Calling setIncorrect on component (" + d[g].getClassName() + ")..."), d[g].setIncorrect && d[g].setIncorrect(a);
        }
      } else {
        b.ctatdebug("Error: component is null for selection " + g);
      }
  ...
  this.processAssociatedRules = function(a, c, e) {
    ...
    if (0 == commMessageHandler.getInStartState()) {
      logHintSAI = a.getSAI();
      var g = "", d = new CTATActionEvaluationData("");
      b.ctatdebug("Found tutor advice: " + e);
      "Hint" == c || "HintWindow" == c ? (ctatdebug("Preparing log message to indicate a hint response", "commShell"), d.setCurrentHintNumber(hintIndex + 1), d.setTotalHintsAvailable(hints.length), d.setEvaluation("HINT"), g = "HINT_MSG", hints[hintIndex] && (e = hints[hintIndex])) : ("Correct" == a.getIndicator() ? d.setEvaluation("CORRECT") : d.setEvaluation("INCORRECT"), g = "RESULT");
      ...
      null != commLoggingLibrary ? 0 == inStartState && 0 == inProcessStartStateActions && commLoggingLibrary.logTutorResponse(a.getTransactionID(), logHintSAI, g, "", d, e, h, c, f) : this.ctatdebug("Info: no logging library available!");
    ...
    if ("root" == a.getSelection()) {
      ...
      if (c = CTATShellTools.findComponent(a.getSelection()), null == c) {
        ...
        for (var g = 0;g < c.length;g++) {
          ...
          1 == commMessageHandler.getInStartState() && d.setEnabled(!1);
        }
  ...
  this.processProblemSummaryResponse = function(a) {
    ...
    if (null != h) {
      var c = a.getXMLObject(), e = c.getElementsByTagName("ProblemSummary"), g = c.getElementsByTagName("cmi.core.lesson_status"), d = c.getElementsByTagName("cmi.core.score.raw");
      ...
      d = "<cmi.core.score.raw>" + $("<div>").html(d[0].innerHTML).text() + "</cmi.core.score.raw>";
      ...
      if (e = e.getSelection(), null != e) {
        if (b.ctatdebug("Highlighting selection for hint: " + e), e = CTATShellTools.findComponent(e), null != e) {
          for (var g = 0;g < e.length;g++) {
            1 == detailedFeedback && (0 === g ? e[g].moveHintHighlight && e[g].moveHintHighlight(!0, a) : e[g].setHintHighlight && e[g].setHintHighlight(!0, a));
          }
        } else {
  ...
  this.showHighlightSelection = function(a, c) {
    ...
    if (null != e) {
      for (var g = 0;g < e.length;g++) {
        1 == detailedFeedback && (0 === g ? e[g].moveHintHightlight && e[g].moveHintHighlight(!0, c) : e[g].setHintHighlight && e[g].setHintHighlight(!0, c));
      }
    } else {
      b.ctatdebug("Unable to find component name in list: " + e);
    }
...
var CTATScrollPaneComponent = function(a, b, f, d, e) {
  CTAT.Component.Base.Tutorable.call(this, "CTATScrollPaneComponent", "__undefined__", a, b, f, d, e);
  var c = 0, g = this;
  g.isTabIndexable = !1;
        ...
        if (null !== c) {
          if (g.ctatdebug("Found target movieclip, temporarily removing ..."), null !== c.getDivWrapper().parentNode) {
            try {
              ...
              CTATScrim.scrim.errorScrimUp(e.message);
              break;
            }
            ...
            b++;
            var d = c.getDivWrapper().style.left, f = c.getDivWrapper().style.top;
            c.getDivWrapper().style.left = "0px";
            c.getDivWrapper().style.top = "0px";
            g.ctatdebug("Moving canvas from: " + d + "," + f + " to: 0,0");
...
var CTATHintButton = function(a, b, f, d, e) {
  CTAT.Component.Base.Clickable.call(this, "hint", "CTATHintButton", a, b, f, d, e);
  this.setName("hint");
...
var CTATButton = function(a, b, f, d, e) {
  CTATButtonBasedComponent.call(this, "CTATButton", "aButton", a, b, f, d, e);
  var c = this, g = null;
  this.init = function() {
...
var OLIDriver = function(a) {
  ...
  this.translateResourceFile = function(a) {
    f.ctatdebug("translateResourceFile (" + a + ")");
    return f.translateOLIResourceFile(a);
  };
  this.translateOLIResourceFile = function(a) {
    f.ctatdebug("translateOLIResourceFile (" + a + ")");
    var c = flashVars.getRawFlashVars();
  ...
  this.translateURL = function(a) {
    f.ctatdebug("translateURL ()");
    for (var c = flashVars.getRawFlashVars(), g = getIndicesOf("<img", a, !1), d = getIndicesOf("<a", a, !1), k = -1, l = k = -1, p = !1, n = "", k = "";!1 === p;) {
      p = !0;
      if (0 === g.length && 0 === d.length) {
        return f.ctatdebug("Nothing to do here, bump"), a;
      }
      g = getIndicesOf("<img", a, !1);
      for (d = 0;d < g.length;d++) {
        k = g[d], k = a.indexOf("src", k), -1 != k && (k += 5, l = a.indexOf('"', k), -1 != l && (n = a.substr(k, l - k), f.ctatdebug("We have a valid url (img) to replace between: " + k + "," + l + ", with content: " + n), -1 == n.indexOf("http:") ? (p = !1, n = c.web_content_url + b(currentOLIModule) + "/" + n, k = a.substr(0, k) + n + a.substr(l), f.ctatdebug("Replaced: " + k), a = k) : f.ctatdebug("The provided url is an absolute url, returning as is, bump")));
      }
      d = getIndicesOf("<a", a, !1);
      for (g = 0;g < d.length;g++) {
        k = d[g], k = a.indexOf("href", k), -1 != k && (k += 6, l = a.indexOf('"', k), -1 != l && (n = a.substr(k, l - k), f.ctatdebug("We have a valid url (href) to replace between: " + k + "," + l + ", with content: " + n), -1 == n.indexOf("http:") ? (p = !1, n = c.web_content_url + b(currentOLIModule) + "/" + n, k = a.substr(0, k) + n + a.substr(l), f.ctatdebug("Replaced: " + k), a = k) : f.ctatdebug("The provided url is an absolute url, returning as is, bump")));
      }
      g = getIndicesOf("<img", a, !1);
      d = getIndicesOf("<a", a, !1);
    }
  ...
  this.forwardToClientHandler = function(a) {
    f.ctatdebug("OLIDriver.forwardToClientHandler() handler is " + typeof d);
...
var currentOLIModule = "", OLIMessageHandler = function() {
  ...
  var a = null, b = "", f = new CTATXML, d = this, e = [];
  ...
  this.processError = function(c, g) {
    d.ctatdebug("OLIMessageHandler.processError(" + c + ", " + g + ")\n  from command " + b);
    if (a) {
    ...
    if (null == g) {
      ...
      switch(e) {
        ...
        case "file_record":
          ...
          break;
        default:
          a ? a.forwardToClientHandler(b) : d.ctatdebug("Unknown xml recieved with root " + e);
      }
    }
  };
  this.parseClientConfig = function(b) {
    ...
    b = f.getElementChildren(b);
    for (var e = null, k = 0;k < b.length;k++) {
      var l = b[k], p = f.getElementName(l);
      "resource_type" != p && "base" != p && ("authentication" == p && "review" != g.activity_mode ? g.user_guid = f.getElementAttr(l, "user_guid") : "logging" == p && (g.log_session_id = f.getElementAttr(l, "session_id"), g.source_id = f.getElementAttr(l, "source_id"), e = f.getElementChildren(l), e = f.getNodeTextValue(e[0])));
    }
    a.oliClientConfig(e);
  };
  this.parseBeginSession = function(b) {
    ...
    if (void 0 == g) {
      ...
      var e = flashVars.getRawFlashVars(), k = b.getElementsByTagName("web_content")[0];
      e.web_content_url = f.getElementAttr(k, "href");
      g = f.getElementAttr(g, "guid");
      e.resource_file_id = g;
      if (k = b.getElementsByTagName("section")[0]) {
        e.class_name = f.getElementAttr(k, "admit_code"), e.class_description = f.getElementAttr(k, "title"), e.school_name = f.getElementAttr(k, "institution");
      }
      (k = b.getElementsByTagName("instructors")[0]) && (k = f.getElementChildren(k)) && (e.instructor = f.getElementAttr(k[0], "guid"));
      (k = b.getElementsByTagName("user")[0]) && "review" != e.activity_mode && (e.user_guid = f.getElementAttr(k, "guid"));
      if (k = b.getElementsByTagName("activity")[0]) {
        if (e.activity_guid = f.getElementAttr(k, "guid"), k = k.getElementsByTagName("item_info")[0]) {
          if (k = k.getElementsByTagName("resource_info")[0]) {
            if (k = k.getElementsByTagName("file")[0]) {
              if (k = f.getElementAttr(k, "href")) {
      ...
      if (k = b.getElementsByTagName("file_record")[0]) {
        for (e.file_record_file_name = f.getElementAttr(k, "file_name"), k = f.getElementChildren(k), l = 0;l < k.length;l++) {
          var p = k[l];
          "record_context" == String(f.getElementName(p)).toLowerCase() && f.getElementAttr(p, "activity_guid") == e.activity_guid && (e.file_record_attempt = f.getElementAttr(p, "attempt")) && (e.problem_state_status = "incomplete");
        }
      }
  ...
  this.setAttemptFromAttemptHistory = function(a, b) {
    ...
    var e = flashVars.getRawFlashVars(), k = a ? a.getElementsByTagName("activity_attempt") : [], l = null;
    return 1 > k.length || !(l = k[k.length - 1]) ? (d.ctatdebug("can't find activity_attempt in attempt_history"), null != b ? e.current_attempt = b : "") : e.current_attempt = f.getElementAttr(l, "number");
  };
  this.parseResourceFile = function(a, b) {
    d.ctatdebug("parseResourceFile ()");
    e = [];
    for (var h = f.getElementChildren(a), k = flashVars.getRawFlashVars(), l = 0;l < h.length;l++) {
      var p = h[l], n = f.getElementName(p);
      "interface" == n ? (p = f.getNodeTextValue(p), n = oliDriver.translateResourceFile(p), d.ctatdebug("Building BRD url from web_content_url: " + k.web_content_url + " and OLI-provided url: " + p + " = " + n), e.push(n)) : "title" == n && (k.problem_name = f.getNodeTextValue(p));
    }
    oliComm.BRDAvailable(e, b);
  };
  this.parseFileRecord = function(a) {
    d.ctatdebug("parseFileRecord()");
    var b = Number(f.getElementAttr(a, "date_created")), e = f.getElementAttr(a, "file_size");
    a = f.getElementAttr(a, "file_name");
    console.log("OLI writeFileRecord at", isNaN(b) ? null : new Date(b), "wrote", a, ", size", e);
  };
};
OLIMessageHandler.prototype = Object.create(CTATBase.prototype);
OLIMessageHandler.prototype.constructor = OLIMessageHandler;
var CTATComboBox = function(a, b, f, d, e) {
  CTAT.Component.Base.Clickable.call(this, "CTATComboBox", "__undefined__", a, b, f, d, e);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var c = this, g = null;
...
CTAT.Component.Base.SVG = function(a, b, f, d, e, c, g) {
  CTAT.Component.Base.Clickable.call(this, a, b, f, d, e, c, g);
  var h = null;
...
CTAT.Math.Fraction.prototype = Object.create(CTAT.Math.Fraction.prototype, {numerator:{get:function() {
  ...
  if (1 == this.denominator) {
    ...
    var f = document.createElementNS("http://www.w3.org/1998/Math/MathML", "mfrac"), d = document.createElementNS("http://www.w3.org/1998/Math/MathML", "mrow");
    d.appendChild(b);
    f.appendChild(d);
...
CTAT.Component.Base.UnitDisplay = function(a, b, f, d, e, c, g) {
  CTAT.Component.Base.SVG.call(this, a, b, f, d, e, c, g);
  var h = "1/2+1/4+(0*1/8)";
  ...
  this.updateValue = function() {
    return h = this.getPieces().map(function(a) {
      return B(a.getAttributeNS(null, "data-value"), CTATGlobalFunctions.toBoolean(a.getAttributeNS(null, "data-selected")));
    }).join("+");
  };
  var y = function(a, b) {
  ...
  this.set_denominator = function(a) {
    ...
    if (!isNaN(b) && (b = G(b), this.get_denominator() != a)) {
      var c = w.evaluate();
      w.clear();
      a = [];
      c.set_denominator(b);
      ...
      b.equals(0) || (a.push(B(b, !0)), a.push(B(g.subtract(b), !1)), e--);
      for (b = 0;b < e;b++) {
        a.push(B(g, !1));
      }
    ...
    if (0 !== Object.keys(E).length) {
      if (a instanceof CTAT.Component.Base.Tutorable) {
        ...
        if (a instanceof CTATSAI) {
          if (a.getSelection() != w.getName() && E.hasOwnProperty(a.getSelection())) {
            return E[a.getSelection()];
          }
        } else {
          if (a instanceof String) {
            if (a != w.getName() && E.hasOwnProperty(a)) {
              return E[a];
            }
          } else {
            if (a instanceof Element && a != w.getComponent() && E.hasOwnProperty(a.id)) {
              return E[a.id];
            }
          }
        }
  ...
  if (console.log("error on new DOMPoint():", a, typeof a), a instanceof ReferenceError || a instanceof TypeError) {
    DOMPoint = function(b, f, d, e) {
      ...
      if (b instanceof DOMPoint) {
        ...
        this.x = b || 0, this.y = f || 0, this.z = d || 0, this.w = e || 1;
      }
    };
  }
}
...
CTAT.Geom.Point.equals = function(a, b) {
  var f = !0, d;
  for (d in a) {
    if (d in b ? "w" != d && (f &= a[d] / a.w == b[d] / b.w) : f = !1, !f) {
      break;
    }
  }
  return f;
...
CTAT.Geom.Point.scale = function(a, b) {
  ...
  var f = new DOMPoint(a), d;
  for (d in f) {
    "w" != d && (f[d] = CTAT.Math.round(a[d] * b));
  }
  return f;
};
...
CTAT.Geom.Point.circle_intersection = function(a, b, f, d) {
  b = b.add(a.scale(-1)).normalize();
  var e = CTAT.Geom.Point.dot(b, f.add(a.scale(-1))), c = a.add(b.scale(e));
  f = CTAT.Geom.Point.distance(f, c);
  return f < d ? (d = Math.sqrt(d * d - f * f), [a.add(b.scale(e - d)), a.add(b.scale(e + d))]) : f == d ? [c] : [];
};
...
var CTATPieChart = function(a, b, f, d, e) {
  CTAT.Component.Base.UnitDisplay.call(this, "CTATPieChart", "aPieChart", a, b, f, d, e);
      ...
      a.reduce(function(a, b, g, k) {
        if (1 <= b.valueOf()) {
          ...
          if (0 < c && c < d) {
            ...
            k = CTAT.Geom.Point.circle_intersection(t, k, e, d).reduce(n.bind(this, k));
            p = p.add(l);
            p = CTAT.Geom.Point.circle_intersection(t, p, e, d).reduce(n.bind(this, p));
          }
          l = CTAT.Geom.Point.to2DString;
          t = "M " + l(t);
          n = new DOMPoint(d, d);
          t += " L " + l(k);
          t += " A " + l(n) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + l(p);
...
var CTATSubmitButton = function(a, b, f, d, e) {
  CTATButton.call(this, a, b, f, d, e);
...
var CTATGroupingComponent = function(a, b, f, d, e) {
  CTAT.Component.Base.Tutorable.call(this, "CTATGroupingComponent", "__undefined__", a, b, f, d, e);
  var c = this;
  c.isTabIndexable = !1;
  var g = null;
  this.init = function() {
...
var CTATSkillWindow = function(a, b, f, d, e) {
  CTAT.Component.Base.Graphical.call(this, "CTATSkillWindow", "__undefined__", a, b, f, d, e);
...
var CTATDoneButton = function(a, b, f, d, e) {
  CTAT.Component.Base.Clickable.call(this, "done", "CTATDoneButton", a, b, f, d, e);
  this.setName("done");
...
var CTATPlayButton = function() {
  ...
  var d = null, e = null, c = null, g = null, h = null;
  (function() {
  ...
  (function() {
    ...
    e = new CTATShape("PlayTutor", "play circle", h.width / 2 - k, h.height / 2 - k, 2 * k, 2 * k);
    e.addPoint(0, 0);
    e.setFillColor("green");
    e.setRadius(k);
    e.drawCircleFilled();
    c = new CTATShape("PlayTutor", "play triangle", e.getXOffset() + .25 * e.getWidth() - 5, e.getYOffset() + .25 * e.getHeight() - 5, e.getWidth() - .25 * e.getWidth(), .6 * e.getHeight());
    c.addPoint(0, 0);
...
function processTextFocus(a, b, f, d, e) {
  mobileAPI.processTextFocus(a, b, f, d, e);
}
function processFocusOut() {
  closeK();
}
;var CTATMovieClip = function(a, b, f, d, e) {
  ...
  this.wrapComponent = function(a) {
    ...
    p.setAttribute("width", d + "px");
    p.setAttribute("height", e + "px");
...
var CTATTextBasedComponent = function(a, b, f, d, e, c, g) {
  CTAT.Component.Base.Tutorable.call(this, a, b, f, d, e, c, g);
...
var CTATTextArea = function(a, b, f, d, e) {
  CTATTextBasedComponent.call(this, "CTATTextArea", "__undefined__", a, b, f, d, e);
  this.setDefaultWidth(100);
...
var CTATTable = function(a, b, f, d, e) {
  CTAT.Component.Base.Graphical.call(this, "CTATTable", "__undefined__", a, b, f, d, e);
  var c = this;
  c.isTabIndexable = !1;
  var g = null, h = !1;
...
var CTATAudioButton = function(a, b, f, d, e) {
  CTATButtonBasedComponent.call(this, "CTATAudioButton", "audiobutton", a, b, f, d, e);
  var c = this;
...
var CTATVideo = function(a, b, f, d, e) {
  CTAT.Component.Base.Tutorable.call(this, "CTATVideo", "__undefined__", a, b, f, d, e);
...
var CTATNumericStepper = function(a, b, f, d, e) {
  CTAT.Component.Base.Tutorable.call(this, "CTATNumericStepper", "__undefined__", a, b, f, d, e);
...
var CTATHintWindow = function(a, b, f, d, e) {
  CTAT.Component.Base.Graphical.call(this, "CTATHintWindow", "__undefined__", a, b, f, d, e);
  this.setDefaultWidth(240);
  this.setDefaultHeight(140);
  var c = this;
  c.isTabIndexable = !1;
...
var CTATControllerButton = function(a, b, f, d, e) {
  CTATImageButton.call(this, a, b, f, d, e);
...
var CTATTextInput = function(a, b, f, d, e) {
  CTATTextBasedComponent.call(this, "CTATTextInput", "__undefined__", a, b, f, d, e);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var c = this, g = null, h = null;
  this.ctatdebug(this.getClassName() + " (" + this.getX() + "," + this.getY() + "," + this.getWidth() + "," + this.getHeight() + ")");
...
var CTATDragNDrop = function() {
  ...
  this.init = function() {
    ...
    if (!$(a).attr("name")) {
      var e = CTATDragNDrop.default_groupname;
      this.getComponentGroup() && (e = this.getComponentGroup());
      $(a).attr("name", e);
    }
    this.setComponent(a);
...
CTAT.Geom.Rectangle.contains = function(a, b, f) {
  ...
  if (b instanceof DOMPoint) {
    ...
    if (f instanceof DOMPoint) {
      e = d(a, f.x / f.w, f.y / f.w);
    } else {
      if ("number" == typeof f) {
        return d(a, b.x - f, b.y - f) & d(a, b.x + f, b.y + f);
      }
    }
    return e & d(a, b.x, b.y);
  }
...
CTAT.Geom.Rectangle.setTo = function(a, b, f, d, e) {
  a.x = b;
  a.y = f;
  a.width = d;
  a.height = e;
...
var CTATNumberLine = function(a, b, f, d, e) {
  CTAT.Component.Base.SVG.call(this, "CTATNumberLine", "aNumberLine", a, b, f, d, e);
  ...
  this.X_Axis = new function(a, b, c, d) {
    ...
    Object.defineProperty(this, "length", {get:function() {
      g.hasOwnProperty("length") || (g.length = CTAT.Math.round(this.min_loc.distance(this.max_loc)));
      return g.length;
    }});
    ...
    this.step = function() {
      g.hasOwnProperty("step") || (g.step = this.s_vec().normalize(this.step_size));
      return g.step;
    };
    this.scalar = function() {
      g.hasOwnProperty("scalar") || (g.scalar = this.range / this.length);
      return g.scalar;
    };
    this.zero = function() {
      g.hasOwnProperty("zero") || (g.zero = this.min_loc.add(this.step().scale(-this.min)), g.zero.x = CTAT.Math.round(g.zero.x), g.zero.y = CTAT.Math.round(g.zero.y));
      return g.zero;
    };
    this.angle = function() {
      if (!g.hasOwnProperty("angle")) {
        var a = this.end.add(this.start.scale(-1));
        g.angle = Math.atan2(a.y, a.x);
      }
      return g.angle;
    };
  ...
  var t = function() {
    if (null !== this.X_Axis && null !== this.X_Axis.svg_group) {
      ...
      if (0 < Math.abs(CTAT.Math.round(p))) {
        var p = new DOMPoint(a.left, (m - e * a.left) / f), r = new DOMPoint(a.right, (m - e * a.right) / f);
        if (a.contains(p) || a.contains(r)) {
          d.distance(p) < d.distance(r) ? (b = r, c = p) : (b = p, c = r);
        }
      }
      0 < Math.abs(CTAT.Math.round(t)) && (t = new DOMPoint((m - f * a.top) / e, a.top), e = new DOMPoint((m - f * a.bottom) / e, a.bottom), a.containsPoint(t) || a.containsPoint(e)) && (d.distance(t) < d.distance(e) ? (b = e, c = t) : (b = t, c = e));
  ...
  }.bind(this), r = 0, w = null, x = new DOMPoint(-30, -30), y = !1, z = function(a) {
    x.x = a.clientX;
    x.y = a.clientY;
  }, B = function(a) {
    ...
    if (!0 === this.getEnabled()) {
      this.setHintHighlight(!1);
      var b;
      m ? (a = E(a.clientX, a.clientY), b = a.location, a = a.data) : (a = G(a.clientX, a.clientY), b = this.X_Axis.getProjectedPoint(a), a = this.X_Axis.getAxisValue(a));
  ...
  this.init = function() {
    ...
    this.component.addEventListener("mouseleave", B);
    var a = this.getEnabled;
    this.component.addEventListener("mouseenter", function() {
      !0 === a() && (y = !0, w.style.visibility = null, r = requestAnimationFrame(q));
    });
    this.component.addEventListener("click", C);
    this.component.addEventListener("focus", this.processFocus);
  };
  var G = function(a, b) {
    ...
    return this.getProjectedPoint(G(a, b));
  }.bind(this.X_Axis), E = function(a, b) {
    for (var c = u(a, b), d = null, g = Number.POSITIVE_INFINITY, e, f, h = 0;h < this._tickmarks.length;h++) {
    ...
    if (y && !0 === this.getEnabled()) {
      if (m) {
        ...
        w.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(u(x.x, x.y), !0));
      }
...
function tableCreate() {
  ...
  for (var f = 0;3 > f;f++) {
    for (var d = b.insertRow(), e = 0;2 > e && (2 != f || 1 != e);e++) {
      var c = d.insertCell();
      c.appendChild(document.createTextNode(" "));
      1 == f && 1 == e && c.setAttribute("rowSpan", "2");
    }
  }
  a.appendChild(b);
  return b;
}
;var CTATFractionBar = function(a, b, f, d, e) {
  CTAT.Component.Base.UnitDisplay.call(this, "CTATFractionBar", "aFractionBar", a, b, f, d, e);
...
var CTATTextField = function(a, b, f, d, e) {
  CTATTextBasedComponent.call(this, "CTATTextBasedComponent", "__undefined__", a, b, f, d, e);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var c = this, g = null;
  this.setAction("UpdateTextArea");
...
var CTATCheckBox = function(a, b, f, d, e) {
  CTAT.Component.Base.Clickable.call(this, "CTATCheckBox", "__undefined__", a, b, f, d, e);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
...
CTATTutor.createStaticInterface = function(a, b, f) {
  ...
  for (a = 0;a < b.length;a++) {
    var e = b[a];
    ctatdebug(this.parser.getElementName(e));
    if ("timeline" == this.parser.getElementName(e)) {
      ctatdebug("Timeline node found, obtaining visual elements ...");
      b = this.parser.getElementChildren(e);
      this.createStaticInterface(null, b, null);
      break;
    }
    if ("ctatcomponent" == this.parser.getElementName(e)) {
    ...
    var g, h, k, l;
    "shape" == this.parser.getElementName(e) && (g = this.parser.getElementAttr(e, "x"), h = this.parser.getElementAttr(e, "y"), k = this.parser.getElementAttr(e, "width"), l = this.parser.getElementAttr(e, "height"), c = this.parser.getElementAttr(e, "instance"), ctatdebug("Creating shape: " + c + " at: " + g + "," + h + "," + k + "," + l), k = "data:image/png;base64, " + this.parser.getNodeTextValue(e), l = new Image, l.setAttribute("style", "position: absolute; top: " + h + "px; left:" + g + "px; z-index:" + 
    CTATGlobalFunctions.gensym.z_index() + ";"), l.setAttribute("id", c), l.setAttribute("src", k), d.appendChild(l));
    "statictext" == this.parser.getElementName(e) && (g = this.parser.getElementAttr(e, "x"), h = this.parser.getElementAttr(e, "y"), k = this.parser.getElementAttr(e, "width"), l = this.parser.getElementAttr(e, "height"), c = this.parser.getElementAttr(e, "instance"), ctatdebug("Creating static text: " + c + " at: " + g + "," + h + "," + k + "," + l), k = "data:image/png;base64, " + this.parser.getNodeTextValue(e), l = new Image, l.setAttribute("style", "position: absolute; top: " + h + "px; left:" + 
    g + "px; z-index:" + CTATGlobalFunctions.gensym.z_index() + ";"), l.setAttribute("id", c), l.setAttribute("src", k), d.appendChild(l));
    "statictext" == this.parser.getElementName(e) && (c = this.parser.getElementAttr("instance"), ctatdebug("Creating movieclip: " + c), g = this.parser.getElementAttr(e, "x"), h = this.parser.getElementAttr(e, "y"), k = this.parser.getElementAttr(e, "width"), l = this.parser.getElementAttr(e, "height"), g = new CTATMovieClip(c, g, h, k, l), h = g.wrapComponent(d), ctatdebug("Created movieclip: " + c + " at: " + g.x + "," + g.y + "," + g.width + "," + g.height), movieclips.push(g), e = this.parser.getElementChildren(e), 
    this.createStaticInterface(h, e, g));
  }
};
CTATTutor.runTutor = function(a) {
  ctatdebug("runTutor ()");
  !0 === CTATGlobals.tutorRunning ? ctatdebug("The tutor is already running") : (null == skillSet && (skillSet = new CTATSkillSet), window.onerror = function(a, f, d) {
    var e = new CTATHTMLManager;
    ctatdebug(e.htmlEncode(a) + " in " + f + ", line " + d);
  }, centerTutorContainer(), CTATTutor.initialize(), CTATGlobals.tutorRunning = !0, ctatdebug("runTutor () ... all set"));
};
function initTutor(a, b, f, d) {
  ...
  1 == tutorInitialized ? console.log("Tutor already initialized, probably in author mode") : (CTATConfiguration.generateDefaultConfigurationObject(), CTATConfiguration.setParams(a), null == d && (d = CTATConfiguration.getSingleParameterValues(["student_interface", "swf_name"]).some(function(a) {
  ...
  ctatdebug("initTutor ()"), "applet" == a.tutoring_service_communication && deployJava.runApplet({id:"TSApplet", width:150, height:10}, {jnlp_href:"/ctat_applet/TSApplet.jnlp"}, "1.6"), d || CTATTutor.runTutor(a), tutorInitialized = !0);
}
...
function centerTutorContainer() {
  ...
  if (null == a) {
    ...
    var b = null;
    if (flashVars) {
      var b = flashVars.getRawFlashVars(), f = "550", d = "450", f = a.offsetWidth, d = a.offsetHeight;
      b && b.width && b.height && (ctatdebug("We have raw width and height variables in our flashvars: " + b.width + "," + b.height), f = b.width, d = b.height);
      b.centerTutor ? 1 == b.centerTutor && (ctatdebug("Moving tutor over by: " + ("-" + Number(f / 2) + "px 0 0 -" + Number(d / 2) + "px;")), a.style.position = "absolute", a.style.top = "0", a.style.left = "0", a.style.right = "0", a.style.bottom = "0", a.style.margin = "auto") : ctatdebug("The tutor is not configured to center the container, bump");
    } else {
...
function checkTutorCanvas() {
  ...
  var a = getSafeElementById(ctatcontainer), b = getSafeElementById("main-canvas"), f = flashVars.getRawFlashVars(), d = "550", e = "450";
  a && (ctatdebug("Recording the actual CSS width and height: " + a.offsetWidth + " , " + a.offsetHeight), d = a.offsetWidth, e = a.offsetHeight);
  f && f.width && f.height && (ctatdebug("We have tutor size flashvars, using those instead: " + f.width + " , " + f.height), d = f.width, e = f.height);
  null === b ? (ctatdebug("No canvas available, creating ..."), b = document.createElement("canvas"), b.id = "main-canvas", b.innerHTML = "Your browser does not support CTAT. Please update or use another browser.", ctatdebug("Setting canvas to: 0,0," + d + " , " + e), getSafeElementById(ctatcontainer).appendChild(b)) : (ctatdebug("Setting canvas to: 0 , 0, " + d + " , " + e), b.style.top = "0", b.style.left = "0");
  b.style.width = d + "px";
  b.style.height = e + "px";
  return b;
}
...
Math.imul || (Math.imul = function(a, b) {
  var f = a & 65535, d = b & 65535;
  return f * d + ((a >>> 16 & 65535) * d + f * (b >>> 16 & 65535) << 16 >>> 0) | 0;
});
...
Array.prototype.lastIndexOf || (Array.prototype.lastIndexOf = function(a) {
  ...
  var b, f = Object(this), d = f.length >>> 0;
  if (0 === d) {
    return -1;
  }
  b = d - 1;
...
Array.prototype.every || (Array.prototype.every = function(a, b) {
  ...
  for (d = 0;d < c;) {
    var g;
    if (d in e && (g = e[d], !a.call(f, g, d, e))) {
      return !1;
    }
    d++;
  }
...
Array.prototype.some || (Array.prototype.some = function(a) {
  ...
  for (var d = 2 <= arguments.length ? arguments[1] : void 0, e = 0;e < f;e++) {
...
Array.prototype.filter || (Array.prototype.filter = function(a) {
  ...
  for (var d = [], e = 2 <= arguments.length ? arguments[1] : void 0, c = 0;c < f;c++) {
    if (c in b) {
      var g = b[c];
      a.call(e, g, c, b) && d.push(g);
    }
  }
  return d;
});
...
Array.prototype.map || (Array.prototype.map = function(a, b) {
  ...
  for (e = 0;e < g;) {
    var h;
    e in c && (h = c[e], h = a.call(f, h, e, c), d[e] = h);
    e++;
  }
  return d;
});
Array.prototype.reduce || (Array.prototype.reduce = function(a) {
  ...
  var b = Object(this), f = b.length >>> 0, d = 0, e;
...
Array.prototype.reduceRight || (Array.prototype.reduceRight = function(a) {
  ...
  var b = Object(this), f = (b.length >>> 0) - 1, d;
  if (2 <= arguments.length) {
    d = arguments[1];
  } else {
    for (;0 <= f && !f in b;) {
...
Array.from || (Array.from = function() {
  ...
  return function(a) {
    ...
    for (var k = b(this) ? Object(new this(h)) : Array(h), l = 0, p;l < h;) {
      p = e[l], k[l] = c ? "undefined" === typeof g ? c(p, l) : c.call(g, p, l) : p, l += 1;
    }
    k.length = h;
    return k;
  };
...
Array.prototype.copyWithin || (Array.prototype.copyWithin = function(a, b, f) {
  ...
  f = void 0 === f ? e : f >> 0;
  e = Math.min((0 > f ? Math.max(e + f, 0) : Math.min(f, e)) - b, e - a);
  f = 1;
  b < a && a < b + e && (f = -1, b += e - 1, a += e - 1);
  for (;0 < e;) {
    b in d ? d[a] = d[b] : delete d[a], b += f, a += f, e--;
  }
  return d;
});
Array.prototype.fill || (Array.prototype.fill = function(a, b, f) {
  ...
  b = 0 > b ? Math.max(e + b, 0) : Math.min(b, e);
  f = void 0 === f ? e : f >> 0;
  for (e = 0 > f ? Math.max(e + f, 0) : Math.min(f, e);b < e;) {
    d[b] = a, b++;
  }
  return d;
});
Array.prototype.find || (Array.prototype.find = function(a, b) {
  ...
  for (var f = Object(this), d = f.length >>> 0, e, c = 0;c < d;c++) {
    if (c in f && (e = f[c], a.call(b, e, c, f))) {
      return e;
    }
  }
});
...
Array.prototype.includes || (Array.prototype.includes = function(a, b) {
  var f = Object(this), d = parseInt(f.length) || 0;
  if (0 === d) {
    return !1;
  }
  var e = parseInt(b) || 0;
...
String.fromCodePoint || function() {
  var a = function() {
    ...
    return d;
  }(), b = String.fromCharCode, f = Math.floor, d = function() {
    ...
    for (var l = "";++h < k;) {
      ...
      if (!isFinite(d) || 0 > d || 1114111 < d || f(d) != d) {
...
String.prototype.codePointAt || function() {
  var a = function(a) {
    ...
    var f = String(this), d = f.length, e = a ? Number(a) : 0;
    e != e && (e = 0);
    if (!(0 > e || e >= d)) {
      return a = f.charCodeAt(e), 55296 <= a && 56319 >= a && d > e + 1 && (f = f.charCodeAt(e + 1), 56320 <= f && 57343 >= f) ? 1024 * (a - 55296) + f - 56320 + 65536 : a;
    }
  };
...
(function(a) {
  ...
  var d = /[^s]/, e = /[def]/, c = /^[^\x25]+/, g = /^\x25{2}/, h = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/, k = /^([a-z_][a-z_\d]*)/i, l = /^\.([a-z_][a-z_\d]*)/i, p = /^\[(\d+)\]/, n = /^[\+\-]/;
  b.format = function(a, c) {
    var g = 1, h = a.length, k = "", l = [], m, p, G, u, E = !0, q = "";
    for (m = 0;m < h;m++) {
      if (k = f(a[m]), "string" === k) {
        l[l.length] = a[m];
      } else {
        if ("array" === k) {
          G = a[m];
          if (G[2]) {
            for (k = c[g], p = 0;p < G[2].length;p++) {
              if (!k.hasOwnProperty(G[2][p])) {
                throw Error(b("[sprintf] property '%s' does not exist", G[2][p]));
              }
              k = k[G[2][p]];
            }
          } else {
          ...
          "function" == f(k) && (k = k());
          if (d.test(G[8]) && "number" != f(k) && isNaN(k)) {
          ...
          switch(G[8]) {
            ...
            case "d":
              ...
              break;
            case "e":
              k = G[7] ? k.toExponential(G[7]) : k.toExponential();
              break;
            case "f":
              k = G[7] ? parseFloat(k).toFixed(G[7]) : parseFloat(k);
              break;
            case "o":
              k = k.toString(8);
              break;
            case "s":
              k = (k = String(k)) && G[7] ? k.substring(0, G[7]) : k;
              break;
            case "u":
              k >>>= 0;
              break;
          ...
          if (!E || e.test(G[8]) && G[3]) {
            q = E ? "+" : "-", k = k.toString().replace(n, "");
          }
          p = G[4] ? "0" == G[4] ? "0" : G[4].charAt(1) : " ";
          u = G[6] - (q + k).length;
          u = G[6] ? Array(u + 1).join(p) : "";
          l[l.length] = G[5] ? q + k + u : 0 == p ? q + u + k : u + q + k;
        }
      }
    }
    return l.join("");
...
CTATMsgType.findProperty = function(a, b) {
  var f = a.toLowerCase(), d = "<" + b.toLowerCase() + ">", e = f.indexOf(d) + d.length, f = f.indexOf("</" + b.toLowerCase() + ">");
  if (e < d.length || 0 > f) {
    return null;
  }
  d = {};
...
CTATMsgType.makeValues = function(a) {
  ...
  if (a.constructor && "Array" == a.constructor.name) {
    ...
    for (var b = 0, f, d = "<value>" + (null == (f = a[b++]) ? "" : f.toString());b < a.length;) {
      d += "</value><value>" + (null == (f = a[b++]) ? "" : f.toString());
    }
    return d + "</value>";
  }
...
CTATMsgType.setProperty = function(a, b, f) {
  var d = CTATMsgType.findProperty(a, b), e = "";
  d ? (e = a.slice(0, d.start), e += CTATMsgType.makeValues(f), e += a.slice(d.end, a.length)) : (d = a.indexOf("</properties>"), e = a.slice(0, d), e += "<" + b + ">" + CTATMsgType.makeValues(f) + "</" + b + ">", e += a.slice(d, a.length));
  return e;
};
...
CTATMsgType.getSAIArraysFromElement = function(a, b) {
  for (var f = {selection:[], action:[], input:[]}, d = b.getElementChildren(a), e = 0;e < d.length;e++) {
    var c = d[e];
...
var ProblemStateSaver = function(a) {
  ...
  this.setAuthenticityToken = function(a) {
    b.ctatdebug("ProblemStateSaver.setAuthenticityToken() old " + e + ", new " + a);
    a && (e = a);
  };
...
ProblemStateSaver.prototype.editForProblemState = function(a) {
  var b = a.split(ProblemStateSaver.XML_PROLOGUE), f = b[0], d;
  ...
  f = b[0];
  for (d = 1;d < b.length;++d) {
    f.endsWith("\n") && (f = f.slice(0, -1)), f.endsWith("\r") && (f = f.slice(0, -1)), f += "<" + b[d];
  }
...
ProblemStateSaver.prototype.forwardToInterface = function(a, b, f) {
  ...
  this.ctatdebug("PSS.forwardToInterface(" + d + ") problemState.length " + this.getProblemState().length + ", outputStatus " + f);
    ...
    if ("string" != typeof d) {
      ...
      if (d.slice(0, ProblemStateSaver.MESSAGES_TAG.length) != ProblemStateSaver.MESSAGES_TAG) {
        ...
        if ("string" == typeof d && (d = d.split(/<\/?messages>/), b.ctatdebug("msgsArr.length " + d.length + ", msgsArr[1].length " + (d[1] ? d[1].length : -1)), !(2 > d.length))) {
          ...
          for (var c = 0, g = !1, f = 1;f < d.length;++f) {
            var k = "<message>" + d[f], l = CTATMsgType.getMessageType(k);
            ...
            b.ctatdebug("problemStateArr[" + f + "] " + (g ? "omit " : "keep ") + l + " omitted " + c + " kept " + e.length);
          }
        }
...
var CTATProblemSummary = function(a, b, f) {
  ...
  var d = Number.MAX_VALUE, e = b, c = 0, g = new Date, h = {}, k = 0, l = 0, p = 0, n = 0, m = 0, t = 0, r = 0, w = CTATMsgType.CompletionValue[0], x = this;
  ...
  this.toXML = function(b) {
    var d;
    d = "" + (' ProblemName="' + a + '"');
    d += ' CompletionStatus="' + w + '"';
    d += ' Correct="' + k + '"';
    d += ' UniqueCorrect="' + m + '"';
    d += ' UniqueCorrectUnassisted="' + t + '"';
    d += ' Hints="' + l + '"';
    d += ' UniqueHints="' + n + '"';
    d += ' HintsOnly="' + x.getHintsOnly() + '"';
    d += ' Errors="' + p + '"';
    d += ' UniqueErrors="' + r + '"';
    d += ' ErrorsOnly="' + x.getErrorsOnly() + '"';
    d += ' UniqueSteps="' + x.getUniqueSteps() + '"';
    d += ' RequiredSteps="' + x.getRequiredSteps() + '"';
    d += ' TimeElapsed="' + c + '"';
    var e = x.getSkills() ? x.getSkills().toXML(b) : "";
  ...
  this.addHint = function(a) {
    ...
    x.ctatdebug("exiting addHint() hint count " + l + ", trial " + b);
  };
  this.addError = function(a) {
    x.ctatdebug("addError(" + a + ")");
    var b = h[a];
    ...
    x.ctatdebug("exiting addError() error count " + p + ", trial " + b);
  };
  this.addCorrect = function(a) {
    var b = h[a];
    x.ctatdebug("entering addCorrect(" + a + ") trial " + b);
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++m, 1 > b.getNFirstHints() && t++), b.incrementNCorrect()) : (x.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), h[a] = b, m++, t++);
    k++;
    b.setLastResult(CTATStep.StepResult[3]);
    x.ctatdebug("exiting addCorrect() correct count " + k + ", trial " + b);
  };
  this.setCompletionStatus = function(a, b) {
    x.ctatdebug("setCompletionStatus(" + a + ", " + b + ")");
...
var CTATMatcher = function(a, b, f) {
  ...
  var d = new CTATSAI("", "", ""), e = f, c = CTATMsgType.DEFAULT_ACTOR, g = !1, h = this;
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.toString = function(a) {
      ...
      this.negated() && (a = "-" + a);
      b = 0;
      for (e = this.parens;0 <= e ? b < e : b > e;0 <= e ? ++b : --b) {
        a = "(" + a + ")";
      }
      return a;
    };
    a.prototype.setParens = function(f, d) {
      var e;
      null == d && (d = !1);
      e = this.negated() ? "UMINUS" : this.inverted() ? "DIVIDE" : this.operator;
      e = a.operatorPrecedence(f, e);
      if (0 > e || 0 === e && d) {
        this.parens = 1;
      }
      return this;
    ...
    a.prototype.simplifyNode = function(a) {
      ...
      for (b = c.length;a < b;a++) {
        e = c[a], g = g[e].call(g), g.methods = this.methods;
      }
      delete g.methods;
      return g;
    };
    ...
    a.prototype.compare = function(f, d) {
...
(function() {
  ...
  a = function(a) {
    ...
    e.prototype.compare = function(a, b) {
      var d, f;
      return (f = e.__super__.compare.apply(this, arguments)) || this.countVariables() - a.countVariables() || (d = a.factors.slice(0).reverse()) && this.factors.slice(0).reverse().some(function(a, c) {
        return f = a.compare(d[c], b);
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, f = [1, 6], d = [1, 7], e = [1, 10], c = [1, 11], g = [1, 12], h = [1, 13], k = [1, 21], l = [1, 22], p = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], n = [1, 23], m = [1, 24], t = [1, 26], r = [1, 27], w = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], x = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:f, 14:4, 15:d, 17:5, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:k, 15:l}, b(p, [2, 11], {22:9, 19:25, 16:n, 18:m, 20:t, 21:r, 24:e, 25:c, 27:g, 28:h}), b(w, [2, 17]), {13:f, 15:d, 17:28, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, {13:f, 15:d, 17:29, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, b(w, [2, 20]), b(w, [2, 23], {23:[1, 30]}), {13:f, 15:d, 17:31, 19:8, 22:9, 24:e, 25:c, 27:g, 
  28:h}, {6:32, 13:f, 14:4, 15:d, 17:5, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, b(x, [2, 25]), b(x, [2, 26]), {1:[2, 1]}, {6:33, 13:f, 14:4, 15:d, 17:5, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, {6:34, 13:f, 14:4, 15:d, 17:5, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, {6:35, 13:f, 14:4, 15:d, 17:5, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, {6:36, 13:f, 14:4, 15:d, 17:5, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, {6:37, 13:f, 14:4, 15:d, 17:5, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, {6:38, 13:f, 14:4, 15:d, 17:5, 19:8, 22:9, 
  24:e, 25:c, 27:g, 28:h}, {13:f, 14:39, 15:d, 17:5, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, {13:f, 14:40, 15:d, 17:5, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, {13:f, 15:d, 17:41, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, {13:f, 15:d, 17:42, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, b(w, [2, 14]), {13:f, 15:d, 17:43, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, {13:f, 15:d, 17:44, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, b(w, [2, 18]), b(w, [2, 19]), {13:f, 15:d, 17:45, 19:8, 22:9, 24:e, 25:c, 27:g, 28:h}, b(w, [2, 22]), {13:k, 
  15:l, 26:[1, 46]}, {5:[2, 2], 13:k, 15:l}, {5:[2, 3], 13:k, 15:l}, {5:[2, 4], 13:k, 15:l}, {5:[2, 5], 13:k, 15:l}, {5:[2, 6], 13:k, 15:l}, {5:[2, 7], 13:k, 15:l}, b(p, [2, 9], {22:9, 19:25, 16:n, 18:m, 20:t, 21:r, 24:e, 25:c, 27:g, 28:h}), b(p, [2, 10], {22:9, 19:25, 16:n, 18:m, 20:t, 21:r, 24:e, 25:c, 27:g, 28:h}), b(w, [2, 12]), b(w, [2, 13]), b(w, [2, 15]), b(w, [2, 16]), b(w, [2, 21]), b(x, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      var c = function(a, b) {
    ...
    var b = [0], c = [null], d = [], e = this.table, f = "", g = 0, k = 0, h = 0, l = d.slice.call(arguments, 1), m = Object.create(this.lexer), p = {}, t;
    for (t in this.yy) {
    ...
    for (var r, w, x, K, N = {}, P, L;;) {
      ...
      if ("undefined" === typeof K || !K.length || !K[0]) {
        ...
        this.parseError(Q, {text:m.match, token:this.terminals_[r] || r, line:m.yylineno, loc:t, expected:L});
      }
      ...
      switch(K[0]) {
        case 1:
          ...
          b.push(K[1]);
          r = null;
          w ? (r = w, w = null) : (k = m.yyleng, f = m.yytext, g = m.yylineno, t = m.yylloc, 0 < h && h--);
          break;
        case 2:
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.algPartialSimplified = function(a) {
      var b, e;
      return null != (b = this.algPartialSimplify(a)) && null != (e = this.algParse(a)) ? b.toString() === e.toString() : null;
    };
    a.prototype.algSimplified = function(a) {
      var b, e;
      return null != (b = this.algSimplify(a)) && null != (e = this.algParse(a)) ? b.toString() === e.toString() : null;
    };
    a.prototype.algIdentical = function(a, b) {
      var e, c;
      return null != (e = this.algParse(a)) && null != (c = this.algParse(b)) ? e.equals(c) : null;
    };
    a.prototype.algEqual = function(a, b) {
      var e, c;
      return null != (e = this.algEvaluate(a)) && null != (c = this.algEvaluate(b)) ? e === c : null;
    };
    a.prototype.algPartialEquivalent = function(a, b) {
      var e, c;
      return null != (e = this.algPartialSimplify(a)) && null != (c = this.algPartialSimplify(b)) ? e === c : null;
    };
    a.prototype.algEquivalent = function(a, b) {
      var e, c;
      return null != (e = this.algSimplify(a)) && null != (c = this.algSimplify(b)) ? e === c : null;
    };
    ...
    a.prototype.polyTermsEqual = function(f, d) {
      return this.parser.parse(f).simplify(a.partial).equals(this.parser.parse(d).simplify(a.partial));
    };
...
(function() {
  var a, b, f, d, e, c, g, h, k, l, p, n = [].slice;
  e = /^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;
  d = /^\d+(\.\d\d)?$/;
  ...
  a = function() {
    ...
    a.getWhole = function(a) {
      return null != (a = a.match(e)) ? a[1] || "0" : null;
    };
    a.getNumerator = function(a) {
      return null != (a = a.match(e)) ? a[2] || "0" : null;
    };
    a.getDividend = a.getNumerator;
    a.getDenominator = function(a) {
      return null != (a = a.match(e)) ? a[3] || "1" : null;
    };
    a.getDivisor = a.getDenominator;
    a.convertToMixed = function(a) {
      return null != (a = a.match(e)) ? (a[1] = (+a[1] || 0) + Math.floor((+a[2] || 0) / (+a[3] || 1)), a[2] = (+a[2] || 0) % (+a[3] || 1), this.makeFraction(a[1], a[2], a[3])) : null;
    };
    a.convertToImproper = function(a) {
      return null != (a = a.match(e)) ? (a[2] = (+a[1] || 0) * (+a[3] || 1) + (+a[2] || 0), a[1] = 0, null == a[3] && (a[3] = 1), this.makeFraction(a[1], a[2], a[3])) : null;
    };
    a.evaluateFraction = function(a) {
      return null != (a = a.match(e)) ? ((+a[1] || 0) * (+a[3] || 1) + (+a[2] || 0)) / (+a[3] || 1) : null;
    };
    a.divEvaluate = a.evaluateFraction;
    a.simplifyFraction = function(a) {
      var b;
      return null != (a = a.match(e)) ? (null != a[1] && null != a[2] && (a[1] = +a[1] + Math.floor(+a[2] / +a[3]), a[2] = +a[2] % +a[3]), b = null != a[2] ? this.gcf(+a[2], +a[3]) : 1, this.makeFraction(a[1], a[2] / b, a[3] / b)) : null;
    };
...
var CTATVariableTableCount = 0, CTATVariableTable = function() {
  ...
  this.put = function(a, e) {
    f.ctatdebug("CTATVariableTable.put(" + a + ", " + e + ") typeof value " + typeof e);
    var c;
    if (a) {
      if (0 > a.indexOf(".")) {
        b[a] = e;
...
(function() {
  var a, b, f, d = [].slice, e = [].indexOf || function(a) {
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, c, k, l) {
      ...
      try {
        ...
        for (t = x.length;n < t;n++) {
          m = x[n], 0 > e.call(f, m) && CTATFormulaFunctions.assign(m, void 0);
        }
        for (m in y = this.variableTable.getTable()) {
          r[m] = y[m];
        }
        ...
        }).apply(r, [c, k, l].concat(d.call(this.values)));
      } catch (z) {
        return console.log(z), null;
      } finally {
        for (m in r) {
          null != m && 0 > e.call(p, m) && (y[m] = r[m], delete r[m]);
        }
      }
    };
    ...
    a.prototype.interpolate = function(a, b, c, d) {
      ...
      for (m = t.length;f < m;a = ++f) {
        e = t[a], r.push(a % 2 ? this.evaluate(e, b, c, d) : e);
      }
      return r.join("");
    };
    return a;
...
var CTATSingleMatcher = function(a, b) {
  ...
  this.setSingle = function(a) {
    null === a || "undefined" === typeof a ? f.ctatdebug('CTATSingleMatcher --\x3e bad argument "' + a + '" to setSingle()') : d = a;
  };
  this.toString = function() {
  ...
  this.evaluateReplacement = function(a, b, d) {
    ...
    f.ctatdebug("CTATSingleMatcher calling CTATFormulaParser.evaluate(" + e + ", " + k + ", " + l + ", " + a + ")");
    try {
      d = b.evaluate(e, k, l, a);
    } catch (p) {
      f.ctatdebug("CTATSingleMatcher error from CTATFormulaParser.evaluate(" + e + ") " + p.name + ": " + p.message), d = null;
    }
    f.ctatdebug("CTATSingleMatcher.evaluateReplacement() returns " + d + ", type " + typeof d);
    return d;
  };
};
...
CTATSingleMatcher.prototype.match = function(a, b, f, d) {
...
var CTATExpressionMatcher = function(a, b) {
  function f(a, b, e, f, g) {
    h.ctatdebug("CTATExpressionMatcher.testVector[" + f + "](" + a + ", " + b + ", " + e + ", " + g + ") to call evaluate");
    var t = CTATVariableTable.standardizeType(e);
    h.ctatdebug("CTATExpressionMatcher.testVector typeof input " + typeof e + "; inputConv " + t + ", typeof " + typeof t);
    e = h.evaluate(a, b, t, g);
    h.ctatdebug("CTATExpressionMatcher.testVector evaluate(" + a + ", " + b + ", " + t + ", " + g + ") returned " + e + ", type " + typeof e);
    g = null;
    switch(f) {
    ...
    c = g;
    h.ctatdebug("CTATExpressionMatcher.testVector comparee " + g + ", type " + typeof g + ", relation " + d + "( " + CTATExpressionMatcher.RELATIONS[d] + " )");
    try {
      switch(d) {
        ...
        case CTATExpressionMatcher.EQ_RELATION:
          ...
          return h.compareNumberOrString(g, e, d);
        case CTATExpressionMatcher.NOT_EQ_RELATION:
          return null == g ? null != e : null == e ? !0 : h.compareNumberOrString(g, e, d);
  ...
  var d = CTATExpressionMatcher.EQ_RELATION, e = b, c = null, g = !1, h = this;
  ...
  this.toString = function() {
    return CTATExpressionMatcher.RELATIONS[d] + ' "' + e + '"';
  };
  this.matchSingle = function(a) {
...
var CTATVectorMatcher = function(a, b, f, d) {
  function e(a, b, d, e, f) {
    ...
    for (var x = 0;3 > x;x++) {
      var y = k[x][0], z = y instanceof CTATExpressionMatcher ? y.matchConcatenation(a, b, d, e) : y.matchConcatenation(w[x]);
      l.ctatdebug("CTATVectorMatcher --\x3e in _match[" + x + "] after " + y + ".concat returns: " + z);
      if (f) {
        f.push(z);
      } else {
        if (!1 === z) {
  ...
  var l = this;
  this.match = function(a, b, c, d, f) {
    return !1 !== e(a, b, c, f) && l.matchActor(d) ? !0 : !1;
  };
  ...
  this.getTutorSAI = function(a, b, c) {
    ...
    var d = [];
    if (e(a.getSelectionArray(), a.getActionArray(), a.getInputArray(), b, d)) {
...
var CTATExampleTracerLink = function(a, b, f) {
  ...
  var d = "undefined" === typeof a || null === a ? null : a, e = null, c = "undefined" === typeof b || null === b ? null : b, g = "undefined" === typeof f || null === f ? null : f, h = null, k = 1, l = 1, p = "CORRECT_ACTION", n = [], m = !1, t = null, r = "", w = null, x = null, y = this;
  ...
  this.addSkillName = function(a) {
    y.ctatdebug("ETLink[" + d + "].addSkillName(" + a + ")");
    if ("unnamed" !== a) {
      if (null === x || "undefined" === typeof x) {
        x = [];
      }
      -1 < x.indexOf(a) || (x.push(a), y.ctatdebug("ETLink.addSkillName() return with skillNames " + x));
    }
  };
  ...
  this.setIsPreferredLink = function(a) {
    y.ctatdebug("ETLink.setIsPreferredLink() was " + m + ", now " + a);
    m = a;
  };
...
var CTATRegexMatcher = function(a, b) {
  CTATSingleMatcher.call(this, a, !0);
  var f = null, d = null, e = this;
  this.toString = function() {
    return f;
  };
  this.setSinglePattern = function(a) {
    "undefined" === typeof a || null === a ? console.log("CTATRegexMatcher: null or undefined pattern") : (f = a, d = e.getCaseInsensitive() ? new RegExp(a, "i") : new RegExp(a));
  };
  this.setSingle = function(a) {
    e.setSinglePattern(a);
  };
  this.matchSingle = function(a) {
    if (null == a) {
...
var CTATExampleTracerNode = function(a, b) {
  ...
  var f = null, d = "", e = b ? b : new Set, c = new Set;
  e.forEach(function(a, b, d) {
    b.isCorrect() && c.add(b);
  });
...
var CTATVersionComparator = function() {
  ...
  this.compare = function(a, b) {
    ...
    var f = 0, d = a.split("."), e = b.split("."), c;
    for (c = 0;c < Math.min(d.length, e.length);c++) {
      try {
        var g = parseInt(d[c]), h = parseInt(e[c]), f = g < h ? -1 : g > h ? 1 : 0;
        if (0 !== f) {
          return f;
        }
      } catch (k) {
        if (f = d[c].toString() < e[c].toString() ? -1 : d[c].toString() > e[c].toString() ? 1 : 0, 0 !== f) {
          return f;
        }
      }
    }
    return c < d.length ? 1 : c < e.length ? -1 : a.toString() < b.toString() ? -1 : a.toString() > b.toString() ? 1 : 0;
  };
};
...
var CTATExampleTracerSkill = function(a, b, f, d, e, c, g) {
  CTATBase.call(this, "CTATExampleTracerSkill", b);
  var h = null == a || "" == a.trim() ? b : b + " " + a, k = d, l = /^0*[xX]([0-9a-fA-F]+)$/.test(g) ? parseInt(g, 16) : /^(\-|\+)?[0-9]+$/.test(g) ? parseInt(g, 10) : CTATExampleTracerSkill.DEFAULT_HISTORY, p = 0, n = 0, m = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, t = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, r = null, w = this;
  this.getSkillName = function() {
    return h;
  };
  this.getCategory = function() {
  ...
  this.updatePKnown = function(a) {
    return k = CTATExampleTracerSkill.updatePKnownStatic(a, f, k, e, c);
  };
  ...
  this.hasReachedMastery = function() {
    return null === k || "undefined" === typeof k ? !1 : k >= t;
  };
  this.getLabel = function() {
...
var CTATWildcardMatcher = function(a, b) {
  function f(a) {
    ...
    d.ctatdebug("CTATWildcardMatcher.convertToFullRegex(" + a + ") after qm: " + b + "; after aster: " + f + "; after negate: " + h + ";");
    return h;
  }
...
var CTATExampleTracerPathComparator = function() {
  ...
  this.compare = function(b, f) {
    ...
    var d = b.getNumberOfPreferredPrefixLinks(), e = f.getNumberOfPreferredPrefixLinks();
    if (d > e) {
      return -1;
    }
    if (d < e) {
    ...
    e = f.getNumberOfSuboptimalLinks();
    if (d < e) {
      return -1;
    }
    if (d > e) {
  ...
  this.breakByLowerLinkID = function(b, f) {
    ...
    var d = b.getSortedLinks(), e = f.getSortedLinks(), c = null, g = null, h = 0, k = 0;
    do {
      a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID in do while"), k >= d.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 1 is shorter"), h = -1) : k >= e.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 2 is shorter"), h = 1) : (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path are same, compare IDS"), c = d[k], g = e[k]), k++;
...
var CTATExampleTracerPath = function(a) {
  ...
  var f = null, d = null, e = null, c = null, g = null, h = null, k = this;
...
CTATRangeMatcher.prototype.match = function(a, b, f, d) {
  return this.matchSingle(a, b, f, d);
};
...
var CTATExampleTracerLinkComparator = function(a, b) {
  ...
  this.compare = function(f, d) {
    ...
    var e = f.getType(), c = d.getType(), e = CTATExampleTracerLink.compareLinkTypes(e, c);
    if (0 !== e) {
      return ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare m: " + e), e;
    }
    e = b.nonEmptyHints(f, a.getVariableTable());
    c = b.nonEmptyHints(d, a.getVariableTable());
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare h1, h2: " + e + ", " + c);
    if (0 < e && 0 >= c) {
      return -1;
    }
    if (0 >= e && 0 < c) {
    ...
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l1.getDepth(), l2.getDepth(): " + f.getDepth() + ", " + d.getDepth());
    if (f.getDepth() < d.getDepth()) {
      return -1;
    }
    if (f.getDepth() > d.getDepth()) {
      return 1;
    }
    e = a.getTraversalCount(f) - f.getMinTraversals();
    c = a.getTraversalCount(d) - d.getMinTraversals();
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare tc1, tc2: " + e + ", " + c);
    if (0 > e && 0 <= c) {
      return -1;
    }
    if (0 <= e && 0 > c) {
    ...
    if (0 !== (e = CTATMatcherComparator.compare(f.getMatcher(), d.getMatcher()))) {
      return e;
    }
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l1.getUniqueID(): " + f.getUniqueID());
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l2.getUniqueID(): " + d.getUniqueID());
    return f.getUniqueID() < d.getUniqueID() ? -1 : 1;
  };
};
...
var CTATExampleTracerInterpretation = function(a) {
  ...
  var b = [], f = {}, d = new CTATVariableTable, e = new Set;
  a.forEach(function(a) {
    e.add(a);
  });
  ...
  this.clone = function() {
    var a = new CTATExampleTracerInterpretation(e);
  ...
  this.updateVariableTable = function(a, b, c) {
    var e = a, f = a.getInput();
    null !== b && "undefined" !== typeof b && (f = b, e = new CTATSAI(a.getSelection(), a.getAction(), f));
    d.put("link" + c.getUniqueID() + ".selection", a.getSelection());
    d.put("link" + c.getUniqueID() + ".action", a.getAction());
    b = "link" + c.getUniqueID() + ".input";
    d.put(b, f);
    d.put(CTATVariableTable.nameAsString(f), CTATVariableTable.valueAsString(f));
    if (CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase() === c.getActionType().toString().toUpperCase() || CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase() === c.getActionType().toString().toUpperCase()) {
      a = a.getSelection(), null !== a && "undefined" !== typeof a && 0 < a.length && d.put(a, f);
    }
    return e;
  };
  ...
  this.toString = function() {
    ...
    a += " (" + (null === e || "undefined" === typeof e ? -1 : e.size) + " paths)";
    a += " var tbl " + d;
    return a += "}";
  };
};
...
var CTATExampleTracerInterpretationComparator = function() {
  ...
  this.compare = function(b, f) {
    ...
    var d = b.getType(), e = CTATExampleTracerLink.compareLinkTypes(d, f.getType());
    ...
    ctatdebug("CTATExampleTracerInterpretationComparator comparing link types result: " + e);
    if (0 !== e) {
      return ctatdebug("CTATExampleTracerInterpretationComparator result is not equal to 0"), 0 > e ? 1 : -1;
    }
    if (CTATExampleTracerLink.BUGGY_ACTION.toString().toUpperCase() === d.toString().toUpperCase() && (ctatdebug("CTATExampleTracerInterpretationComparator checking for buggy actions"), d = b.getLastMatchedLink(), e = f.getLastMatchedLink(), d = CTATMatcherComparator.compare(d.getMatcher(), e.getMatcher()), 0 !== d)) {
      return d;
    }
    var e = CTATExampleTracerPath.getBestPath(b.getPaths()), d = CTATExampleTracerPath.getBestPath(f.getPaths()), c = new Set;
    c.add(e);
    c.add(d);
    e = CTATExampleTracerPath.getBestPath(c);
    ctatdebug("CTATExampleTracerInterpretationComparator found best path: " + (e === d));
    e.getLinks().forEach(function(b) {
...
var CTATExampleTracerEvent = function(a, b, f) {
  ...
  var d = "", e = !1, c = CTATExampleTracerLink.NO_MODEL, g = !1, h = null, k = null, l = "student", p = null, n = null, m = "", t = null, r = null, w = null, x = null, y = null, z = [], B = !1, C = null, G = null, u = this;
  this.getActor = function() {
    return l;
  };
  this.setActor = function(a) {
  ...
  this.getTransactionID = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getTransactionID() returning " + d);
    return d;
  };
  this.setTransactionID = function(a) {
  ...
  this.getResult = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getResult() returning " + c);
    return c;
  };
  ...
  this.getWantReportableHints = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning " + B);
    return B;
  };
  ...
  this.isOutOfOrder = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + t);
    return t;
  };
  ...
  this.getSuccessOrBuggyMsg = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning " + y);
    return y;
  };
  this.getReportableHints = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning " + z);
    return z;
  };
  this.getReportableLink = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning " + p);
    return p;
  };
  this.getReportableVariableTable = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning " + x);
    return x;
  };
  this.getReportableInterpretation = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning " + n);
    return n;
  };
  this.getStepID = function() {
    u.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning " + m);
    return m;
  };
  ...
  this.getTutorInput = function() {
    return null !== w && "undefined" !== typeof w ? u.getEvaluatedInputArray() : null !== k && "undefined" !== typeof k ? k.getInputArray() : null;
  };
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function d(a, b, c, d, e, g) {
    ...
    if (b) {
      ...
      c.toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && B.splice(B.length - 1, 1);
    }
  ...
  function e(a, b, c, e) {
    q.ctatdebug("checkDoneStep() hintTrace " + b + ", sai " + a.getStudentSAI() + ", exitOnIncorrectDone " + C.exitOnIncorrectDone() + ", hideButRequireSteps " + C.hideButRequireSteps() + ", nInterps " + e.size);
    if (!a.getStudentSAI().isDone()) {
      return null;
    }
    if (C.exitOnIncorrectDone()) {
      return a.setDoneStepFailed(!1), null;
    }
    if (!b && C.hideButRequireSteps()) {
      b = C.getDoneLinks();
      q.ctatdebug("checkDoneStep getDoneLinks().size " + b.size);
      b = b.values();
      for (var f;!(f = b.next()).done;) {
        if (C.pathToLinkIsSubset(f.value, E)) {
          return a.setDoneStepFailed(!1), 1 > e.size ? d(a, c, CTATExampleTracerLink.CORRECT_ACTION, f.value, q.getBestInterpretation(), q.getInterpretationsInternal()) : d(a, c, CTATExampleTracerLink.CORRECT_ACTION, f.value, p(e), e);
        }
      }
    }
  ...
  function c(a, b, c) {
    ...
    q.ctatdebug("interps # : " + y.length);
    q.ctatdebug("interps: " + y);
  ...
  function h(a, b, c, d, e) {
    ...
    C.getLinks().forEach(function(h) {
      if (!1 === c) {
        ...
        !0 === k && f.push(h);
        C.hideButRequireSteps() && g(a, k, h, b, d);
      } else {
  ...
  function k(a, b, c, d, e) {
    ...
    if (!0 === d) {
      ...
      b.getMatchedLinks().forEach(function(a) {
        !1 !== k && (!1 === C.observesOrderingConstraints(h, a, f, e) || !1 === t(b, a, f) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), k = !1) : h.push(a));
      });
      if (!1 === k) {
    ...
    if (a.getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString()) {
      if (!1 === C.isIncorrectLinkOK(b.getMatchedLinks(), a, f, b)) {
        return q.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false3"), !1;
      }
    } else {
      if (!1 === C.observesOrderingConstraints(b.getMatchedLinks(), a, f, e)) {
  ...
  function t(a, b, c) {
    ...
    if (b.isDone() && C.exitOnIncorrectDone()) {
      return !0;
    }
  ...
  function r(a, b) {
    ...
    d.getSortedLinks().forEach(function(b) {
      !0 !== g && (q.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in for loop" + b), f = b, c.getTraversalCount(b) < b.getMaxTraversals() && (!1 === a || 0 < q.nonEmptyHints(b, c.getVariableTable())) && C.observesOrderingConstraints(c.getMatchedLinks(), b, d.getLinks(), null) && t(c, b, d.getLinks()) && (q.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in link: " + b), h = b, g = !0));
    });
    if (!0 === g) {
      return h;
    }
  ...
  function w(a, b, c, d) {
    ...
    b.getSortedLinks().forEach(function(b) {
      ...
      !0 === a.isTraversed(b, d) || !0 === x(b) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in if condition"), f = !0) : (!0 === f && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in second if condition"), C.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
  ...
  var y = null, z = null, B = null, C = a, G = null;
  ...
  this.resetTracer = function() {
    ...
    null === y || "undefined" === typeof y ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"), y = []) : (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"), y.length = 0);
    ...
    if (null === z || "undefined" === typeof z) {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"), z = {};
    } else {
    ...
    E = {};
    null === B || "undefined" === typeof B ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer last if condition"), B = []) : (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of last if condition"), B.length = 0);
    q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer before iterating over all the links in the graphs");
    C.getLinks().forEach(function(a) {
  ...
  this.getBestInterpretation = function() {
    ...
    if (null === u || "undefined" === typeof u) {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"), u = p(q.getInterpretationsInternal());
    }
  ...
  this.findCurrentState = function() {
    ...
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = r(!1, [a])) ? a.getPrevNode() : C ? C.getStartNode() : null;
  };
};
...
var CTATDefaultLinkGroup = function(a, b, f, d) {
  CTATLinkGroup.call(this, "CTATDefaultLinkGroup", a);
  var e = a, c = b, g = f, h = new Set;
  ...
  this.setOrdered = function(a) {
    n.ctatdebug("CTATDefaultLinkGroup --\x3e in setOrdered group name: " + e);
...
InternalGroupIterator = function(a, b) {
  ...
  var f = this, d = b.length, e = [], c = 0;
  a.getSubgroups().forEach(function(a) {
    a && e.push(a);
  });
  b.push(f);
  f.ctatdebug("InternalGroupIterator() constructor group " + a + ", stack.length " + b.length + ", sgList.length " + e.length);
  this.toString = function() {
    return "{" + a + " at " + d + " with " + e.length + " subgroups}";
  };
  this.next = function() {
    return c >= e.length ? (b.pop(), f.ctatdebug("InternalGroupIterator at deepest next() returning " + a + " with stack.length " + b.length), {value:a, done:!1}) : (new InternalGroupIterator(e[c++], b)).next();
  };
};
    ...
    b.forEach(function(f) {
      if (!0 !== c) {
        ...
        k.getGroupSubgroups(a).forEach(function(g) {
          !0 !== c && !0 === k.isLinkInGroup(g, f) && (k.getGroupLinkCount(g) >= b.size ? (e = d(g, b), c = !0) : k.getGroupLinks(g).forEach(function(c) {
            if (!1 === b.has(c)) {
              throw new CTATExampleTracerException("Invalid link selection: Partial overlap with existing group: " + a);
            }
          }));
...
var CTATExampleTracerGraph = function(a, b, f) {
  ...
  function e(a, b, d) {
    ...
    if (0 !== a.length) {
      ...
      h.forEach(function(a) {
        !0 === F.isGroupReenterable(a) && h.splice(h.indexOf(a), 1);
      });
      var l = !0;
  ...
  var x = null, y = null, z = null, B = null, C = null, G = null, u = new Set, E = new Set, q = null, F = null, D = CTATMsgType.SHOW_ALL_FEEDBACK, A = this;
  this.getFeedbackPolicy = function() {
    return D;
  };
  this.setFeedbackPolicy = function(a) {
    A.ctatdebug("Graph.setFeedbackPolicy(" + a + ") old policy " + D);
    D = "false" === a ? CTATMsgType.SHOW_ALL_FEEDBACK : "true" === a ? CTATMsgType.HIDE_ALL_FEEDBACK : a;
  };
  this.hideButRequireSteps = function() {
    return D == CTATMsgType.HIDE_BUT_COMPLETE;
  };
  ...
  this.observesOrderingConstraints = function(a, b, c, f) {
    ...
    if (!0 === c.has(b) && !0 === d(a, b, c) && !0 === e(a, b, c)) {
  ...
  this.isIncorrectLinkOK = function(a, b, c, e) {
    ...
    A.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
      !0 !== k && !1 !== h && b.getType().toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString() && !0 === c.has(b) && (f = !0, !1 === d(a, b, c) ? h = !1 : (g = b, k = !0));
    });
    ...
    if (!0 === f && (b = A.getSmallestContainingGroup(b), !0 === F.isLinkInGroup(b, g) && !1 === F.isGroupOrdered(b) && !0 === l(b, c, e))) {
      return !1;
    }
  ...
  this.getNode = function(a) {
    A.ctatdebug("CTATExampleTracerGraph --\x3e in getNode(" + a + ") returning " + B[a]);
    return B[a];
  };
  ...
  this.getStartNode = function() {
    A.ctatdebug("CTATExampleTracerGraph --\x3e in getStartNode() returning " + C);
    return C;
  };
  ...
  this.getStudentStartsHereNode = function() {
    A.ctatdebug("CTATExampleTracerGraph --\x3e getStudentStartsHereNode() returns " + G);
    return G;
  };
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var d = new CTATExampleTracerLink(null, null, null), e = g.getElementChildren(a), f, h, k, l, m, n = a = -1, u = CTATMsgType.DEFAULT_ACTOR, E = !1, q = 0;q < e.length;q++) {
      ...
      if ("rule" === g.getElementName(e[q])) {
        for (var F = g.getElementChildren(e[q]), D = 0;D < F.length;D++) {
          "text" === g.getElementName(F[D]) && d.addSkillName(g.getNodeTextValue(F[D]).toString());
        }
      }
      if ("actionLabel" === g.getElementName(e[q])) {
        for (d.setIsPreferredLink("false" != g.getElementAttr(e[q], "preferPathMark")), d.setMinTraversalsStr(g.getElementAttr(e[q], "minTraversals")), d.setMaxTraversalsStr(g.getElementAttr(e[q], "maxTraversals")), F = g.getElementChildren(e[q]), D = 0;D < F.length;D++) {
          "uniqueID" === g.getElementName(F[D]) && (m = g.getNodeTextValue(F[D]), d.setUniqueID(parseInt(g.getNodeTextValue(F[D]))));
          "message" === g.getElementName(F[D]) && (l = new CTATMessage(F[D]));
          "actionType" === g.getElementName(F[D]) && d.setActionType(g.getNodeTextValue(F[D]));
          "buggyMessage" === g.getElementName(F[D]) && d.setBuggyMsg(g.getNodeTextValue(F[D]));
          "successMessage" === g.getElementName(F[D]) && d.setSuccessMsg(g.getNodeTextValue(F[D]));
          "hintMessage" === g.getElementName(F[D]) && d.addHint(g.getNodeTextValue(F[D]));
          if ("matchers" === g.getElementName(F[D])) {
            for (var A = g.getElementChildren(F[D]), H = 0;H < A.length;H++) {
              "Selection" === g.getElementName(A[H]) && (f = b(A[H], 0)), "Action" === g.getElementName(A[H]) && (h = b(A[H], 1)), "Input" === g.getElementName(A[H]) && (k = b(A[H], 2)), "Actor" === g.getElementName(A[H]) && (u = g.getNodeTextValue(A[H]), E = (E = g.getElementAttr(A[H], "linkTriggered")) && "false" != E.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === g.getElementName(F[D])) {
            h = F[D];
            f = g.getElementAttr(h, "replacementFormula");
            h = g.getElementChildren(h);
            var H = A = u = k = void 0, J = CTATMsgType.DEFAULT_ACTOR;
            k = new CTATExactMatcher(CTATMatcher.SELECTION, null);
            for (var u = new CTATExactMatcher(CTATMatcher.ACTION, null), I = 0;I < h.length;I++) {
              ...
              "matcherParameter" === g.getElementName(h[I])) {
                ...
                "action" == M && u.setParameter(g.getNodeTextValue(h[I]));
    ...
    m = new CTATVectorMatcher(f, h, k, u);
      ...
      if ("matcher" === g.getElementName(c[f])) {
        for (var h = null, k = g.getElementAttr(c[f], "replacementFormula"), l = g.getElementChildren(c[f]), m = 0;m < l.length;m++) {
          if ("matcherType" === g.getElementName(l[m])) {
            switch(h = g.getNodeTextValue(l[m]), d.ctatdebug("CTATGraphParser.processMatchers() matcherType[" + m + "] = " + h), h) {
              case "ExactMatcher":
  ...
  function f(a, b) {
    ...
    var e = "true" === g.getElementAttr(a, "ordered");
    ...
    for (var h = function(a) {
      c.add(a);
    }, k = g.getElementChildren(a), m = 0;m < k.length;m++) {
      if ("link" === g.getElementName(k[m])) {
        var n = Number(g.getElementAttr(k[m], "id")), p = b[n];
        if (null !== p || void 0 !== p) {
          ctatdebug("Added link ID : " + n), c.add(p);
        }
      }
      "group" === g.getElementName(k[m]) && (ctatdebug("encountered a subgroup"), f(k[m], b).forEach(h));
    }
    l.addGroup(d, e, c);
  ...
  var d = this, e, c, g = new CTATXML, h = null, k = [];
  new XMLSerializer;
  var l, p = !0, n = !0, m = [];
  ...
  this.parseGraph = function(b, d) {
    ctatdebug("parseBRD()");
    var w = 0, x = g.getElementAttr(b, "startStateNodeName"), y = "true" === g.getElementAttr(b, "unordered");
    p = "false" != String(g.getElementAttr(b, "caseInsensitive")).toLowerCase();
    n = g.getElementAttr(b, "lockWidget");
    var z = new CTATVariableTable;
    c = new CTATExampleTracerGraph(y, !1, z);
    var B = g.getElementChildren(b), z = g.getElementAttr(b, "suppressStudentFeedback");
    if (null === z || void 0 === z) {
    ...
    var C = g.getElementAttr(b, "confirmDone");
    "true" !== C && "false" !== C && (C = c.getFeedbackPolicy() === CTATMsgType.HIDE_ALL_FEEDBACK ? "true" : "false");
    d.setHintPolicy(g.getElementAttr(b, "hintPolicy"));
    d.setOutOfOrderMessage(g.getElementAttr(b, "outOfOrderMessage"));
    for (var G = null, u = 0;u < B.length;u++) {
      switch(g.getElementName(B[u])) {
        case "startNodeMessages":
          k = g.getElementChildren(B[u]);
          break;
        case "node":
          w++;
          var E;
          ...
          var q = g.getElementChildren(E), F = -1;
          E = "";
          for (var D = 0;D < q.length;D++) {
            switch(g.getElementName(q[D])) {
              case "uniqueID":
                F = parseInt(g.getNodeTextValue(q[D]));
                break;
              case "text":
                E = g.getNodeTextValue(q[D]);
            }
          }
          ...
          E = q;
          c.addNode(E);
          1 == w && (c.setStartNode(E), c.setStudentStartsHereNode(E));
          E.getNodeName() == x && c.setStudentStartsHereNode(E);
          break;
        case "edge":
          c.addLink(a(B[u]));
          break;
        ...
        case "productionRule":
          ...
          E = void 0;
          for (var D = "unknown", q = void 0, F = null, A = g.getElementChildren(A), H = 0;H < A.length;H++) {
            var J = g.getElementName(A[H]);
            "ruleName" === J && (E = g.getNodeTextValue(A[H]), ctatdebug("ruleName=" + E));
            "productionSet" === J && (D = g.getNodeTextValue(A[H]), ctatdebug("productionSet=" + D));
            "label" === J && (q = g.getNodeTextValue(A[H]), ctatdebug("label=" + D));
            "description" === J && (F = g.getNodeTextValue(A[H]), ctatdebug("description=" + D));
          }
          D = new CTATExampleTracerSkill(D, E, CTATExampleTracerSkill.DEFAULT_P_GUESS, CTATExampleTracerSkill.DEFAULT_P_KNOWN, CTATExampleTracerSkill.DEFAULT_P_SLIP, CTATExampleTracerSkill.DEFAULT_P_LEARN, CTATExampleTracerSkill.DEFAULT_HISTORY);
          null != q ? D.setLabel(q) : D.setLabel(E);
          null != F ? D.setDescription(F) : D.setDescription(E);
          m.push(D);
      }
    }
    if (G) {
      w = g.getElementAttr(G, "ordered");
      ...
      l.setGroupOrdered(l.getTopLevelGroup(), B);
      ...
      ctatdebug("processGroup() order of group: isOrdered= " + B);
      ctatdebug("processGroup() order of group: isOrdered typeof= " + typeof B);
      x = g.getElementChildren(x);
      for (B = 0;B < x.length;B++) {
        switch(g.getElementName(x[B])) {
          case "group":
            f(x[B], w);
            break;
          case "outOfOrderMessage":
            l.getTopLevelGroup().setDefaultBuggyMsg(g.getNodeTextValue(x[B]));
        }
      }
    }
    w = d.getSkillBarVector();
    if (!w || 1 > w.length) {
      ctatdebug("No existing skills. Add skills from BRD."), d.addGraphSkills(m), w = d.getSkillBarVector();
    }
    h = (new CTATTutorMessageBuilder).createStateGraphMessage(p, y, n, d.isFeedbackSuppressed(), z, C, w);
    c.redoLinkDepths();
    e = c.getExampleTracer();
    e.resetTracer();
    c.forDebugging();
    ctatdebug("Graph loaded.");
    return {gr:c, tracer:e, ssm:k, sgMsg:h};
  };
};
...
SCORMProblemSummary.getSessionTime = function(a) {
  ...
  a = b % 1E3;
  var b = (b - a) / 1E3, f = b / 60, d = f / 60, b = b % 60;
  9999 < d && (d = 9999, f = b = 99, a = 990);
  return sprintf("%04d:%02d:%02d.%02d", d, f, b, a / 10);
};
SCORMProblemSummary.getProblemSummaryElements = function(a) {
  var b = sprintf("<%s>%s</%s>", SCORMProblemSummary.LESSON_STATUS, SCORMProblemSummary.getLessonStatus(a), SCORMProblemSummary.LESSON_STATUS), f = sprintf("<%s>%d</%s>", SCORMProblemSummary.RAW_SCORE, SCORMProblemSummary.getRawScore(a), SCORMProblemSummary.RAW_SCORE), d = sprintf("<%s>%s</%s>", SCORMProblemSummary.EXIT, SCORMProblemSummary.getExitReason(a), SCORMProblemSummary.EXIT);
...
var CTATMessageTank = function(a, b) {
  ...
  this.flushMessageTank = function(a, b) {
    ...
    if (g && !(1 > g.length)) {
      ...
      for (var l = [], x = [], y = 0;y < g.length;++y) {
        var z = g[y];
        if (z.msg) {
          var B = z.msgType, C = z.evt;
          n.ctatdebug("entering processInterfaceVariables() msgType " + B + ", evt " + C);
          B && (n.ctatdebug("entering processInterfaceVariables() et " + c + ", tracer " + (c ? c.getTracer() : null)), B = B.toLowerCase(), 0 !== B.indexOf("correct") && 0 !== B.indexOf("interfaceaction") || c.getTracer().addInterfaceVariablesFromEvent(C));
          if (!(B = d(z))) {
            var B = z, C = x, G = void 0, u = void 0;
            if (!(B && B.sai && (G = B.sai.getAction()) && (u = m.exec(G))) || 3 > u.length || 1 >= u[2]) {
              B = !1;
            } else {
              var E = C.length - 1, E = 0 > E ? null : C[E];
              B.msg = B.msg.replace(G, u[1]);
              E && E.timeout == u[2] ? E.msgTuples.push(B) : C.push({timeout:Number(u[2]), msgTuples:[B]});
              B = !0;
            }
          }
          B || l.push(z.msg);
      ...
      for (y = 0;y < x.length;++y) {
        z = x[y], n.ctatdebug("processDelayedMsgs() delayedMsgs.timeout " + z.timeout + ", .msgTuples.length " + z.msgTuples.length), setTimeout(e, z.timeout, c, z.msgTuples);
      }
...
var CTATSkills = function(a) {
  ...
  this.updateSkill = function(a, b, h) {
    var k = null, l = e.getSkill(b);
    null !== l && "undefined" !== typeof l && (l.setTransactionNumber(f), b = h + " " + b, d.has(b) || (d.add(b), l.updatePKnown(a), l.updateHistory(a), l.changeOpportunityCount(1)), CTATExampleTracerSkill.CORRECT.toString().toUpperCase() === a.toString().toUpperCase() && d["delete"](b), k = l);
    return k;
  };
  ...
  this.getSkill = function(a) {
    ...
    e.ctatdebug("CTATSkills.getSkill(" + a + ") returns " + d);
    return d;
  };
...
var CTATExampleTracer = function() {
  ...
  function f(a, b) {
    ...
    switch(h) {
      ...
      case CTATMsgType.UNTUTORED_ACTION:
        return b && m.sendBundle([a]), e(a, g, y, f), !0;
      case CTATMsgType.INTERFACE_ACTION:
        return b && m.sendBundle([a]), c(a, g, y, f), !0;
  ...
  function d(a, b, c, d) {
    ...
    I = !1;
    E = b.getProperty("problem_name");
    m.ctatdebug("SetPreferences.problem_name = " + E);
      ...
      if (d = c.getElementName(a[b]), m.ctatdebug("SetPreferences eltName " + d), d) {
        switch(d.toLowerCase()) {
          ...
          case "skills":
            ...
            d = [];
            for (var e = y.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              var g = y.getElementName(e[f]);
              if (g && "skill" == g.toLowerCase()) {
                var h = y.getElementAttr(e[f], "name");
                if (h && "" != h.trim()) {
                  var g = y.getElementAttr(e[f], "label"), k = y.getElementAttr(e[f], "pSlip"), l = y.getElementAttr(e[f], "description"), n = y.getElementAttr(e[f], "pKnown"), p = y.getElementAttr(e[f], "category"), r = y.getElementAttr(e[f], "pLearn"), u = y.getElementAttr(e[f], "pGuess"), w = y.getElementAttr(e[f], "history"), h = new CTATExampleTracerSkill(p, h, u, n, k, r, w);
                  h.setLabel(g);
                  h.setDescription(l);
                  d.push(h);
                }
    ...
    m.ctatdebug("questionFile " + t + ", outputStatus " + D + ", problemStateRestorer " + F);
    a = t;
    m.ctatdebug("retrieveBRD (" + a + ")");
    R.retrieveXMLFile(a, c, m);
    F && F.retrieveMessages(D);
  }
  function e(a, b, c, d) {
  ...
  function c(a, b, c, d) {
    ...
    !d[0] || "hint" != d[0].toLowerCase() && "help" != d[0].toLowerCase() ? (m.ctatdebug("calling doNewExampleTrace(null, " + b.getSAI() + ") sai.selectionArray " + b.getSAI().getSelectionArray() + " msg.selectionArray " + b.getSelectionArray()), l(null, b.getSAI(), "student", !0, c, a)) : (m.ctatdebug("handleInterfaceAction() hint request: hintPolicy " + B + ", errorSAI " + z), B === CTATHintPolicyEnum.HINTS_UNBIASED ? (1 < d.length && (d[1] = ""), 1 < e.length && (e[1] = "")) : B !== CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY && 
    (B === CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY ? z && z.getSelection() ? (d.splice(1, 0, z.getSelection()), e.splice(1, 0, "PreviousFocus")) : (d[1] = "", e[1] = "") : B === CTATHintPolicyEnum.HINTS_BIASED_BY_ALL && z && z.getSelection() && (d.splice(1, 0, z.getSelection()), e[1] = CTATMsgType.PREVIOUS_FOCUS.toString())), m.startSkillTransaction(), a = [], d = r.doHint(d, e, b.getInputArray(), "student", a, !0), b = a[0], a = b.getReportableHints(), e = d ? "" + d.getUniqueID() : 
    ...
    e, c), m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, c, b, null), c = m.getProblemSummary(b.getReportableInterpretation()), m.messageTank.flushMessageTank(c, !0), m.ctatdebug("handleInterfaceAction() sent hint result " + b), z = null);
    return !0;
  }
  function g(a, b, c) {
  ...
  function l(a, b, c, d, e, f) {
    ...
    if (k.isSolverResult()) {
      ...
      if (k.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        ...
        l, p(c), f, m.getSkillBarVector(!0, c), w.getUniqueID(), n, u), k, l), m.ctatdebug("finishNewExampleTrace() successMsg " + u), u && m.messageTank.addToMessageTank("SuccessMessage", t.createSuccessMessage(n, u), k, null), z = null, d && (x = h(w ? w.getNextNode() : null, r.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = x);
      } else {
        ...
        x && (u = "" + x.getUniqueID(), k.setStepID(u));
        y = g(k, y, t);
  ...
  var m = this, t = null, r, w, x, y = new CTATXML;
  new XMLSerializer;
  var z = null, B, C = !0, G = !1, u = null, E = null, q = new ProblemStateSaver(m);
  q.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());
  var F = null, D = new CTATProblemStateStatus, A = [], H = [], J = 0, I = !1, M = "", O = null;
  m.ctatdebug("CTATExampleTracer constructor outputStatus=" + D);
  ...
  this.processXML = function(a) {
    ...
    if (null != a) {
      m.ctatdebug("No of children" + y.getElementChildren(a).length);
      var b = new CTATGraphParser, c = b.parseGraph(a, m);
      x = c.gr;
      r = c.tracer;
      a = c.ssm;
      var d = c.sgMsg;
      m.ctatdebug("sendStartStateMessages() nMsgs " + a.length + ", outputStatus " + D);
      for (var c = [], e = new XMLSerializer, f = null, g = 0;g < a.length;g++) {
        if ("message" == y.getElementName(a[g])) {
          var k = e.serializeToString(a[g]), l = CTATMsgType.getMessageType(k);
          CTATMsgType.UNTUTORED_ACTION != l && CTATMsgType.INTERFACE_ACTION != l || m.setVariablesFromSAI(a[g], y);
      ...
      m.ctatdebug("sendStartStateMessages(): " + a.length + " elts, " + c.length + " strings, " + D);
      m.sendBundle(c);
      b = [];
      a = x.getStartNode();
      ...
      D.isIncomplete() || (b = [], b.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END, null)), m.sendBundle([b]));
      I = !0;
    }
    m.startWorking(0);
  };
  ...
  this.sendBundle = function(a) {
    m.ctatdebug("sending bundle #msgs = " + a.length + ", outputStatus " + D);
    for (var b = 0, c = 0;c < a.length;c++) {
      m.ctatdebug("Sending message #" + c);
      var d = a[c];
      0 >= c && (d = '<?xml version="1.0" encoding="UTF-8"?>' + d);
      q.forwardToInterface(d, c >= a.length - 1, D) && ++b;
    }
    return 0 < b;
  };
  this.setHintPolicy = function(a) {
    B = CTATHintPolicyEnum.lookup(a);
  };
  ...
  this.getProblemSummary = function(a) {
    m.ctatdebug("Entering getProblemSummary() problemSummary " + u);
    if (null === u || "undefined" === typeof u) {
      var b = m.getProblemName();
      u = null === b || "undefined" === typeof b || 1 > b.length ? new CTATProblemSummary("NoProblemDefined", null, m.isFeedbackSuppressed()) : new CTATProblemSummary(b, null, m.isFeedbackSuppressed());
    }
    a && u.setRequiredSteps(a.countStepsForScore(x));
    return u;
  };
  ...
  this.setFeedbackSuppressed = function(a) {
    G = "false" === a ? !1 : "true" === a ? !0 : a === CTATMsgType.SHOW_ALL_FEEDBACK ? !1 : a === CTATMsgType.HIDE_ALL_FEEDBACK ? !0 : a === CTATMsgType.HIDE_BUT_ENFORCE ? !0 : a === CTATMsgType.HIDE_BUT_COMPLETE ? !0 : !1;
    m.ctatdebug("setFeedbackSuppressed(" + a + "): " + G);
  };
