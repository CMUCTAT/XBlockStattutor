...
a[6].e||"America/Campo_Grande"===d.name&&14136912E5===a[6].s&&13925196E5===a[6].e)return 0}else if("America/Montevideo"===b){if("America/Sao_Paulo"===d.name&&14136876E5===a[6].s&&1392516E6===a[6].e)return 0}else if("Pacific/Auckland"===b&&"Pacific/Fiji"===d.name&&14142456E5===a[6].s&&13961016E5===a[6].e)return 0;return c},g=function(b,d){for(var g={},e=jstz.olson.dst_rules.zones,h=e.length,r=a[d],f=0;f<h;f++){var n=e[f],u;u=e[f];for(var q=0,A=0;A<b.length;A++)if(u.rules[A]&&b[A]){if(b[A].s>=u.rules[A].s&&
b[A].e<=u.rules[A].e)q=0,q+=Math.abs(b[A].s-u.rules[A].s),q+=Math.abs(u.rules[A].e-b[A].e);else{q="N/A";break}if(864E6<q){q="N/A";break}}u=q=c(b,d,q,u);"N/A"!==u&&(g[n.name]=u)}for(var E in g)if(g.hasOwnProperty(E)&&-1!=r.indexOf(E))return E;return d},h=function(a){var b=function(){for(var a=[],b=0;b<jstz.olson.dst_rules.years.length;b++){var c;c=jstz.olson.dst_rules.years[b];var g=(new Date(c,0,1,0,0,1,0)).getTime();c=(new Date(c,12,31,23,59,59)).getTime();for(var e=(new Date(g)).getTimezoneOffset(),
...
a[d]&&(a[d]=c[d])}return a}function g(a,b){return"string"==typeof a?a:a[b%a.length]}function h(a){this.opts=c(a||{},h.defaults,l)}function m(){function c(b,c){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',c)}x.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,e){function h(){return d(c("group",{coordsize:r+" "+r,coordorigin:-f+" "+-f}),{width:r,height:r})}function m(a,m,r){b(n,b(d(h(),{rotation:360/e.lines*a+"deg",left:~~m}),b(d(c("roundrect",
{arcsize:e.corners}),{width:f,height:e.scale*e.width,left:e.scale*e.radius,top:-e.scale*e.width>>1,filter:r}),c("fill",{color:g(e.color,a),opacity:e.opacity}),c("stroke",{opacity:0}))))}var f=e.scale*(e.length+e.width),r=2*e.scale*f,l=-(e.width+e.length)*e.scale*2+"px",n=d(h(),{position:"absolute",top:l,left:l});if(e.shadow)for(l=1;l<=e.lines;l++)m(l,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(l=1;l<=e.lines;l++)m(l);return b(a,n)};h.prototype.opacity=
...
d);null==d&&(d=new WebSocket(f.getURL()),d.addEventListener("open",function(a){console.log("STATUS: open");g=!0;console.log("Connection open, flushing outgoing queue ...");h=(new Date).getTime();if(0<c.length){for(a=0;a<c.length;a++)d.send(c[a]);c=[]}}),d.addEventListener("message",function(a){m=(new Date).getTime();console.log("STATUS: message after "+(m-h)+" ms");console.log("Received: "+a.data);n?n(a.data):console.log("Error: no processing function provided")}),d.addEventListener("close",function(a){console.log("STATUS: close; "+
(a?"code "+a.code+", reason "+a.reason:"no event"));g=!1;d.close(1E3,a?a.reason?a.reason:"received close code "+a.code:"no close event received");q&&q(a)}),d.addEventListener("error",function(a){console.log("STATUS: error; "+(a?a.type:"no event"));g=!1;d.close(1E3,"client closing in response to error")}),console.log("init () done"))};this.send=function(){console.log("send ()");f.init();!1===g?(console.log("Connection not ready yet, storing ..."),c.push(b)):(console.log("Connection ready, sending data ..."),
...
CTATLanguagePack[b]),CTATLanguagePack[b]}else a.ctatdebug("No custom language pack defined, using default...");return"undefined"!==typeof CTATDefaultLangagePack&&CTATDefaultLangagePack[b]?(a.ctatdebug("Found tag in default language pack, returning: "+CTATDefaultLangagePack[b]),CTATDefaultLangagePack[b]):b}};CTATLanguageManager.prototype=Object.create(CTATBase.prototype);CTATLanguageManager.prototype.constructor=CTATLanguageManager;CTATLanguageManager.theSingleton=new CTATLanguageManager;var scrimIsUp=!1,errorScrim=!1,waitScrim=!0,warnScrim=!1,connectionScrim=!1,authorTimeSet=!0,inAuthorTime=!0,CTATScrim=function(){function a(){warnScrim=!1;v.scrimDown()}function b(a){"google"!=CTATConfig.platform&&(1==scrimIsUp&&v.scrimDownForced(),v.ctatdebug("errScrimUp ("+a+")"),1==errorScrim?1==g&&(g=!1,getSafeElementById(ctatcontainer).removeChild(l)):1==warnScrim&&(g=!0),v.scrimUp(a))}function e(a,b){v.ctatdebug("makeHTMLButton ()");var c=document.createElement("input");c.type="button";c.value=
b;null!=a?(v.ctatdebug("clickHandle!=null"),c.onclick=a):(v.ctatdebug("clickHandle==null"),c.onclick=v.defaultClickHandler);c.id=b;c.setAttribute("class","scrimButton");return c}CTATBase.call(this,"CTATScrim","__undefined__");var f="",d=!1,c=!1,g=!1,h=null,m=null,n=new CTATCanvasComponent("CTAT Scrim"),q=[],p=null,x=null,l=null,r=null,v=this;this.scrimUp=function(b){if("google"!=CTATConfig.platform)if(v.ctatdebug("scrimUp ()"),b=CTATGlobals.languageManager.filterString(b),v.ctatdebug("Message: "+
b),1==scrimIsUp?(f=1==waitScrim?b:f+(" \n "+b),n.removeComponent(),v.removeHTMLElements()):(f=b,scrimIsUp=!0),v.ctatdebug("scrimUp() to call drawScrim() scrimIsUp "+scrimIsUp),v.ctatdebug("drawScrim ()"),"google"==CTATConfig.platform)v.ctatdebug("This is not available for now when we're in this environment");else if($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"),$("#scrim").css("z-index",1E3),"google"!=CTATConfig.platform&&($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>'+
f+"<br><br></div></div></div>"),!0===g&&(l=e(a,"close"),$(l).appendTo("#scrimpanel")),!0===d&&(p=e(h,"yes"),$(p).appendTo("#scrimpanel")),!0===c&&(x=e(m,"no"),$(x).appendTo("#scrimpanel")),1==waitScrim)){v.ctatdebug("Adding spinner ...");$("#scrimpanel").append("<br>");b=$('<div id="scrim_spin">');b.css("width","100%");b.css("position","relative");$("#scrimpanel").append(b);try{var r=(new Spinner({className:"scrim_spinner"})).spin();$("#scrim_spin").append(r.el)}catch(z){(z instanceof ReferenceError||
z instanceof TypeError)&&v.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.',z,typeof z)}}};this.waitScrimUp=function(){console.log("waitScrimUp () CTATConfig.platform "+CTATConfig.platform+", scrimIsUp "+scrimIsUp);"google"!=CTATConfig.platform&&(1==scrimIsUp&&v.scrimDownForced(),waitScrim=!0,v.scrimUp(CTATGlobals.languageManager.getString("LOADING")),v.ctatdebug("return from waitScrimUp(): scrimIsUp "+
scrimIsUp))};this.nextProblemScrimUp=function(){"google"!=CTATConfig.platform&&(1==scrimIsUp&&v.scrimDownForced(),v.ctatdebug("nextProblemScrimUp ()"),v.scrimUp(CTATGlobals.languageManager.getString("NEXTPROBLEM")))};this.OKScrimUp=function(a,b){"google"!=CTATConfig.platform&&(1==scrimIsUp&&v.scrimDownForced(),v.ctatdebug("OKScrimUp ("+a+","+b+")"),c=d=g=warnScrim=errorScrim=!1,v.scrimUp(a),r=e(b,"OK"),$(r).appendTo("#scrimpanel"))};this.confirmScrimUp=function(a,b,g){"google"!=CTATConfig.platform&&
(1==scrimIsUp&&v.scrimDownForced(),v.ctatdebug("confirmScrimUp ("+a+","+b+","+g+")"),c=d=!0,m=g,h=b,v.scrimUp(a))};this.errorScrimUp=function(a){"google"!=CTATConfig.platform&&(1==scrimIsUp&&v.scrimDownForced(),0==authorTimeSet?(v.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"),q.push("ERROR: "+a),errorScrim=!0):0==inAuthorTime?v.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes"):(errorScrim=!0,b("ERROR: "+
a)))};this.warningScrimUp=function(a){"google"!=CTATConfig.platform&&(1==scrimIsUp&&v.scrimDownForced(),0==authorTimeSet?(v.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"),q.push("WARNING: "+a),warnScrim=!0):0==inAuthorTime?v.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes"):(warnScrim=!0,b("WARNING: "+a)))};this.handleTSDisconnect=function(){connectionScrim=!0;v.scrimUp(CTATGlobals.languageManager.getString("TUTORDISCONNECTED"))};
this.removeHTMLElements=function(){};this.scrimDown=function(){"google"!=CTATConfig.platform&&(0==scrimIsUp?v.ctatdebug("The scrim isn't up, returning"):1==errorScrim?v.ctatdebug("The scrim is up to describe errors to the user, leave it up!"):1==warnScrim?v.ctatdebug("The scrim is up to display warnings to the user, leave it up!"):1==connectionScrim?v.ctatdebug("The scrim is up for a connection issue leave it up!"):v.scrimDownForced())};this.scrimDownForced=function(){v.ctatdebug("enter scrimDownForced() scrimIsUp "+
scrimIsUp);$("#scrim").remove();n.removeComponent();v.removeHTMLElements();waitScrim=scrimIsUp=!1;f="";v.ctatdebug("exit scrimDownForced() scrimIsUp "+scrimIsUp)};this.defaultClickHandler=function(){v.ctatdebug("defaultClickHandler ()");v.scrimDown()};this.setInAuthorTime=function(a){v.ctatdebug("setting inAuthorTime = "+a);authorTimeSet=!0;inAuthorTime=a;if(!a)warnScrim=errorScrim=!1,g&&null.removeChild(l);else if(errorScrim||warnScrim)for(var c in q)b(c)};this.getInAuthorTime=function(){return inAuthorTime}};
CTATScrim.prototype=Object.create(CTATBase.prototype);CTATScrim.prototype.constructor=CTATScrim;CTATGlobals.languageManager=CTATLanguageManager.theSingleton;function manualCTATScrim(){console.log("manualCTATScrim (): noScrim "+noScrim+", useDebuggingBasic "+useDebuggingBasic);CTATScrim.scrim=new CTATScrim;0==noScrim&&CTATScrim.scrim.waitScrimUp()}window.jQuery?(ctatdebug("(Scrim) CTATTarget ("+("undefined"==typeof CTATTarget?"undefined":CTATTarget)+")"),manualCTATScrim()):alert("CTAT is unable to access JQuery, please make sure the library is referenced in your html file and loaded before CTAT.");var CTAT={ToolTutor:{interfaceMessages:[],tutorMessages:[]}};
...
var c;if("websocket"==n.getSocketType())return c=this.findWSConnection(b),c||(c=new CTATWSConnection(a),c.setID(f),c.setURL(b),c.assignReceiveFunction(this.processWSReply),c.assignCloseFunction(this.processWSClose),d.push(c),f++),c;c=new CTATConnection(a);c.setID(f);c.setURL(b);c.assignReceiveFunction(this.processReply);d.push(c);f++;return c};this.findWSConnection=function(a){console.log("findWSConnection( "+a+" )");for(var b=0;b<d.length;b++){var c=d[b];console.log("checking: socketType = "+c.getSocketType()+
" URL = "+c.getURL());if("ws"==c.getSocketType()&&c.getURL()==a)return c}return null};this.startBundle=function(){n.ctatdebug("startBundle ()");!1===useBundling?this.ctatdebug("Not using bundling, bump"):(bundleFormatter='<?xml version="1.0" encoding="UTF-8"?><message><verb/><properties><MessageType>MessageBundle</MessageType><messages>',inBundle=!0)};this.endBundle=function(){n.ctatdebug("endBundle ()");!1===useBundling?n.ctatdebug("Not using bundling, bump"):(inBundle=!1,bundleFormatter+="</messages></properties></message>",
n.sendXML(bundleFormatter))};this.setFixedURL=function(a){e=a};this.getURL=function(){n.ctatdebug("getURL ()");if(""!==e)return n.ctatdebug("Returning fixedURL: "+e),e;var a=flashVars.getRawFlashVars(),b="http://";"https"==n.getSocketType()&&(b="https://");b=b+a.remoteSocketURL+":"+a.remoteSocketPort;-1!=a.remoteSocketURL.indexOf("http")&&(b=a.remoteSocketURL+":"+a.remoteSocketPort);return b};this.sendXML=function(a){n.ctatdebug("Sending: "+a);n.ctatdebug("sendXML ("+a+")");if(!0===useBundling&&!0===
inBundle)n.ctatdebug("Bundling ..."),bundleFormatter+=a;else{bundleFormatter=a;flashVars.getRawFlashVars();a=this.getURL();var b=bundleFormatter;-1==bundleFormatter.indexOf("<?xml")&&(b='<?xml version="1.0" encoding="UTF-8"?>'+bundleFormatter);!0===this.getUseCommSettings()?"javascript"==n.getSocketType()?CTAT.ToolTutor.sendToTutor(b):this.send_post(a,b):this.send_post(a,b)}};this.sendXMLNoBundle=function(a){n.ctatdebug("sendXMLNoBundle ("+a+")");bundleFormatter=a;var b=this.getURL(),c=a;-1==a.indexOf("<?xml")&&
(c='<?xml version="1.0" encoding="UTF-8"?>'+a);flashVars.getRawFlashVars();!0===this.getUseCommSettings()?"javascript"==n.getSocketType()?CTAT.ToolTutor.sendToTutor(c):this.send_post(b,c):this.send_post(b,c)};this.sendXMLURL=function(a,b){n.ctatdebug("sendXMLURL ("+b+")");var c=a;-1==a.indexOf("<?xml")&&(c='<?xml version="1.0" encoding="UTF-8"?>'+a);flashVars.getRawFlashVars();n.ctatdebug("Sending: "+c);!0===this.getUseCommSettings()?"javascript"==n.getSocketType()?CTAT.ToolTutor.sendToTutor(c):this.send_post(b,
c):this.send_post(b,c)};this.sendURLVariables=function(a,b){this.ctatdebug("sendURLVariables ("+a+")");this.send_post_variables(a,b)};this.send=function(a){n.ctatdebug("send ("+a+")");if(!0===CTATGlobals.CommDisabled)n.ctatdebug("Communications globally disabled, please check your settings");else{var b=new CTATConnection(null);b.setID(f);f++;if(null===b.getHTTPObject())return alert("Cannot create XMLHTTP instance"),!1;d.push(b);b.setURL(a);b.assignReceiveFunction(this.processReply);try{b.getHTTPObject().open("GET",
a,!0)}catch(v){this.ctatdebug("Error in newConnection.httpObject.open: "+v.message);return}try{b.init()}catch(v){this.ctatdebug("Error in newConnection.init: "+v.message);return}try{b.getHTTPObject().send(null)}catch(v){this.ctatdebug("Error in newConnection.httpObject.send: "+v.message)}}};this.send_post_variables=function(a,b){n.ctatdebug("send_post_variables ("+a+")");flashVars.getRawFlashVars();n.getSocketType();var c;c=!1===useOLIEncoding?this.encodeVariables(b):this.encodeVariablesOLI(b);this.ctatdebug("Sending: "+
c);if(!0===CTATGlobals.CommDisabled)n.ctatdebug("Communications globally disabled, please check your settings");else{var e=n.createConnection(CTATConfiguration.getRawFlashVars(),a);e.setContentType("application/x-www-form-urlencoded");f++;d.push(e);n.ctatdebug(c);null!==m&&m.processOutgoing(c);e.setURL(a);e.setData(c);e.assignReceiveFunction(this.processReply);e.send()}};this.send_post=function(a,b){var c;console.log("send_post ("+a+")");if(!0===CTATGlobals.CommDisabled)n.ctatdebug("Communications globally disabled, please check your settings");
else{console.log("Outoing on wire: "+b);c=flashVars.getRawFlashVars();var d=a;"websocket"==n.getSocketType()?(console.log("opening websocket connection"),d=a.replace("http:","ws:"),"https:"===window.top.location.protocol&&(console.log("We're embedded in an https window, using wss..."),d=d.replace("ws:","wss:")),c=n.createConnection(c,d),c.setData(b),n.ctatdebug(b)):(c=n.createConnection(c,d),c.setData(b));null!==m&&m.processOutgoing(b);c.send()}};this.processReply=function(a){n.ctatdebug("processReply ("+
d.length+","+a+")");var b=0,e;a=[];var f;for(f=0;f<d.length;f++){var h=d[f],l=h.getHTTPObject();n.ctatdebug("Testing connection entry "+f+", readyState: "+l.readyState+", consumed: "+h.getConsumed()+", status: "+l.status);4==l.readyState&&!1===h.getConsumed()?(n.ctatdebug("Investigating request response: "+b+" -> "+l.status+", for: "+h.getURL()),e=!1,0===l.status&&(e=!0,n.ctatdebug("Received message (status 0): ("+l.responseText+"), status: "+l.status),g&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(p))),
408==l.status&&(e=!0,n.ctatdebug("Received message (status 408): "+l.responseText),g&&CTATScrim.scrim.scrimDown()),502==l.status&&(e=!0,n.ctatdebug("Received message (status 502): "+l.responseText),g&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(ERROR_502))),200==l.status?(e=!0,n.ctatdebug("Processing 200 response ..."),null!==c?(a.push(l.responseText),null!==m&&m.processIncoming(l.responseText)):n.ctatdebug("Error: httphandler is null, can't process response!")):c&&c.processError&&
(e=!0,n.ctatdebug("Processing non-200 response, status "+l.status),c.processError(l.status,l.responseText)),!1===e&&n.ctatdebug("Error: status not handled for: "+l.status),n.ctatdebug("Marking connection as consumed ..."),h.setConsumed(!0)):(0===l.readyState&&n.ctatdebug("Received message (status 0, request not initialized)"),1===l.readyState&&n.ctatdebug("Received message (status 1, server connection established)"),2===l.readyState&&n.ctatdebug("Received message (status 2, request received)"),3===
l.readyState&&n.ctatdebug("Received message (status 3, processing request)"));b++}n.cleanup();for(b=0;b<a.length;b++)n.ctatdebug("Processing incoming message: "+b),e=a[b],-1!=e.indexOf("status=success")?n.ctatdebug("Info: logging success message received, not propagating to message handler"):(n.ctatdebug("Processing incoming message: "+e),c.processMessage(e))};this.processWSReply=function(a){n.ctatdebug("processWSReply() length "+(null===a?null:a.toString().length));"string"==typeof a&&(null!==m&&
m.processIncoming(a),-1!=a.indexOf("status=success")?n.ctatdebug("processWSReply() logging success message received, not propagating to message handler: "+a):(n.ctatdebug("Processing incoming message: "+a),c.processMessage(a)))};this.processWSClose=function(a){n.ctatdebug("processWSClose("+a+")");a instanceof CloseEvent&&n.ctatdebug("CloseEvent: code "+a.code+", reason "+a.reason+", wasClean "+a.wasClean);CTATLMS.is.Authoring()?CTATScrim.scrim.scrimUp(CTATGlobals.languageManager.filterString("AUTHORPLEASECLOSE")):
CTATScrim.scrim.handleTSDisconnect()};this.cleanup=function(){n.ctatdebug("cleanup ()");for(var a=0,b,c=!1;!1===c;)b=this.checkEntries(),!1===b?c=!0:a++;n.ctatdebug("Removed "+a+" entries")};this.checkEntries=function(){n.ctatdebug("checkEntries ("+d.length+")");var a=0,b;for(b=0;b<d.length;b++){var c=d[b];if(!0===c.getConsumed())return n.ctatdebug("Removing : "+c.getID()),d.splice(a,1),!0;var e=c.getHTTPObject();n.ctatdebug("Check, readyState: "+e.readyState+", consumed: "+c.getConsumed());a++}return!1};
this.retrieveXMLFile=function(a,b,c){n.ctatdebug("retrieveXMLFile ("+a+")");if(location.href){if(n.ctatdebug("Location: "),-1!=location.href.toLowerCase().indexOf("file://")){a=(new CTATTutorMessageBuilder).createErrorMessage("","You have loaded your tutor directly from the file system, please do not load a tutor using file://. Please use the CTAT Authoring Tools to launch the html file.");n.ctatdebug("onerror GET for xmlFile "+a);CTAT.ToolTutor.sendToInterface(a,!0);return}}else n.ctatdebug("We can't check location.href in the current configuration");
...
function(){return b};this.getCustomFieldValues=function(){return e}};CTATLogMessageBuilder.prototype=Object.create(CTATBase.prototype);CTATLogMessageBuilder.prototype.constructor=CTATLogMessageBuilder;CTATLogMessageBuilder.contextGUID="";CTATLogMessageBuilder.commLogMessageBuilder=null;var CTATCustomLogElementObject=function(){this.reset=function(){};this.addCustomLogElement=function(a,b){customElementsNames.push(a);customElementsTypes.push(a)};this.getCustomElementNames=function(){return customElementsNames};this.getCustomElementTypes=function(){return customElementsTypes}};var loggingDisabled=!1,CTATLoggingLibrary=function(a){CTATBase.call(this,"CTATLoggingLibrary","logginglibrary");var b=this,e=!0,f=!1,d=!1,c=[],g="undefined",h="undefined",m="undefined",n="undefined",q="undefined",p="undefined",x="undefined",l="undefined",r="UnassignedDataset",v="UnassignedLevelName",B="UnassignedLevelType",u=null,l=CTATGuid.guid();void 0!=a&&null!=a?(f=a,0==f&&(CTATLogMessageBuilder.commLogMessageBuilder=new CTATLogMessageBuilder)):CTATLogMessageBuilder.commLogMessageBuilder=new CTATLogMessageBuilder;
var z=new CTATCommLibrary;z.setName("commLoggingLibrary");z.setUseCommSettings(!1);z.setConnectionRefusedMessage("ERROR_CONN_LS");z.assignHandler(this);this.assignLogListener=function(a){u=a};this.generateSession=function(){c.session_id="ctat_session_"+CTATGuid.guid();return c.session_id};this.setLogClassName=function(a){g=a};this.setDatasetName=function(a){r=a};this.setDatasetLevelName=function(a){v=a};this.setDatasetLevelType=function(a){B=a};this.setSchool=function(a){h=a};this.setPeriod=function(a){m=
a};this.setDescription=function(a){n=a};this.setInstructor=function(a){q=a};this.setProblemName=function(a){p=a};this.setProblemContext=function(a){x=a};this.setUserID=function(a){l=a};this.getLoggingCommLibrary=function(){return z};this.setUseSessionLog=function(a){e=a};this.setLoggingURL=function(a){b.getLoggingCommLibrary().setFixedURL(a)};this.getSessionIdentifierBundle=function(){var a=[];a.class_name=g;a.school_name=h;a.period_name=m;a.class_description=n;a.instructor_name=q;a.dataset_name=
r;a.problem_name=p;a.problem_context=x;a.auth_token="";a.user_guid=l;a.session_id=c.session_id;a.source_id="tutor";a.dataset_level_name1=v;a.dataset_level_type1=B;return a};this.setupExternalLibraryUsage=function(){b.ctatdebug("setupExternalLibraryUsage ()");c.class_name=g;c.school_name=h;c.period_name=m;c.class_description=n;c.instructor_name=q;c.dataset_name=r;c.problem_name=p;c.problem_context=x;c.auth_token="";c.user_guid=l;c.session_id="ctat_session_"+CTATGuid.guid();c.source_id="tutor";c.dataset_level_name1=
v;c.dataset_level_type1=B;flashVars=new CTATFlashVars;flashVars.assignRawFlashVars(c)};this.initCheck=function(){b.ctatdebug("initCheck ()");0==f&&0==d&&(b.setupExternalLibraryUsage(),d=!0)};this.sendMessage=function(a){b.ctatdebug("sendMessage ()");b.ctatdebug("Raw log message to send: "+a);this.sendMessageInternal(a);null!=u&&u(a)};this.sendMessageInternal=function(a){b.ctatdebug("sendMessageInternal ()");if(!0===loggingDisabled)b.ctatdebug("Warning: loggingDisabled==true");else if(1==f){var c=
CTATConfiguration.get("Logging");if("ClientToService"!=c&&"ClientToLogServer"!=c)b.ctatdebug("Logging is turned off, as per: "+c);else{var d=CTATConfiguration.get("tutoring_service_communication");"ClientToService"!=c||"http"!=d&&"https"!=d||(c=CTATConfiguration.get("remoteSocketURL")+":"+CTATConfiguration.get("remoteSocketPort"),b.setLoggingURL(c),b.ctatdebug("Reconfigured the logging url to be: "+c));b.ctatdebug("Pre encoded log message: "+a);0>a.indexOf("<log_session_start")&&(a=CTATLogMessageBuilder.commLogMessageBuilder.wrapForOLI('<?xml version="1.0" encoding="UTF-8"?><tutor_related_message_sequence version_number="4">'+
a+"</tutor_related_message_sequence>"));b.ctatdebug("Encoded log message: "+a);CTATLMS.logEvent(a);CTATConfiguration.get("log_service_url")&&z.sendXMLNoBundle(a)}}};this.startProblem=function(){b.ctatdebug("startProblem ()");b.initCheck();b.logSessionStart();b.sendMessage(CTATLogMessageBuilder.commLogMessageBuilder.createContextMessage(!0))};this.logSessionStart=function(){b.ctatdebug("logSessionStart ()");b.initCheck();var a=flashVars.getRawFlashVars();void 0!=a.SessionLog&&("false"==a.SessionLog||
"boolean"==typeof a.SessionLog&&!1===a.SessionLog?(b.ctatdebug("Turning SessionLog off ..."),e=!1):(b.ctatdebug("Turning SessionLog on ..."),e=!0));!0===e&&this.sendMessage(CTATLogMessageBuilder.commLogMessageBuilder.createLogSessionStart())};this.logSemanticEvent=function(a,c,d,e,g,h,f){b.ctatdebug("logSemanticEvent ("+f+")");b.initCheck();var m=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(g,h);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tool_event_time",
CTATLogMessageBuilder.commLogMessageBuilder.formatTimeStamp(m)+" UTC");a=CTATLogMessageBuilder.commLogMessageBuilder.createSemanticEventToolMessage(c,a,d,e,!0,f);this.sendMessage(a)};this.logTutorResponse=function(a,c,d,e,g,h,f,m,r){b.ctatdebug("logTutorResponse ()");b.initCheck();var l=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(m,r);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tutor_event_time",
...
h=0,f;m.push(g);for(var n=0;n<b.length;n++)if(f=b[n],"value"==q.getElementName(f)){var r=q.getElementChildren(f);null!==r?(p.ctatdebug("Parsing SAI input ..."),p.ctatdebug("Childnodes: "+r.length),1===r.length?(f=e.htmlDecode(q.getNodeTextValue(f)),p.ctatdebug("Setting new value to: "+f),g.setValue(f)):(f=e.htmlDecode(q.getNodeTextValue(f)),p.ctatdebug("Setting new value to: "+f),g.setValue(f),g.setName(q.getElementAttr("name")),g.setType(q.getElementAttr("type")),g.setFormat(q.getElementAttr("format")),
...
(this.ctatdebug("messageParser "+d+", messageObj "+e),e.children&&this.ctatdebug(e.children));var c="ungraded",g=!1,h=!1,m=new CTATSkillSet,n="",q="",p="",x="",l="",r,v=null,B=null,u=!1;this.setURL=function(a){r=a};this.getURL=function(){return r};this.assignSAI=function(a){h=!0;v=a};this.setTransactionID=function(a){q=a};this.getTransactionID=function(){return q};this.setGradeResult=function(a){c=a};this.getGradeResult=function(){return c};this.getXMLObject=function(){return e};this.getSkillsObject=
...
g=!0,n=d.getElementName(e)):(this.ctatdebug("Detected regular message"),g=!1,this.parseMessageType());this.parseTransactionID();this.parseSAI();for(var a=d.getElementChildren(e),b=0;b<a.length;b++){var c=a[b];"properties"==d.getElementName(c)&&(ctatdebug("Found a 'properties' element ... "),f=d.getElementChildren(c))}this.ctatdebug("Message "+n+", with transaction id: "+q)}};this.parseSAI=function(){this.ctatdebug("parseSAI ()");var a="",c="",f="",q="",u=[],D=[],t=[];if("tool_message"==n){this.ctatdebug("Parsing s, a and i");
a=d.getElementChildren(e);for(c=0;c<a.length;c++)if(f=a[c],"tool_message"==d.getElementName(f))for(f=d.getElementChildren(f),q=0;q<f.length;q++)u=f[q],"event_descriptor"==d.getElementName(u)&&(v=new CTATSAI,v.fromXMLInternal(u));h=!0}else{if(g){this.ctatdebug("isLogMessage ...");for(var C=d.getElementChildren(e),F=0;F<C.length;F++){var y=C[F];if("event_descriptor"==d.getElementName(y))for(var y=d.getElementChildren(y),H=0;H<y.length;H++){var G=y[H];"selection"==d.getElementName(G)&&(a=d.getNodeTextValue(G),
u.push(G));"action"==d.getElementName(G)&&(c=d.getNodeTextValue(G),D.push(G));"input"==d.getElementName(G)&&(f=d.getNodeTextValue(G),t.push(G));"prompt"==d.getElementName(G)&&(q=d.getNodeTextValue(G))}}}else for(this.ctatdebug("!isLogMessage ..."),C=d.getElementChildren(e),F=0;F<C.length;F++)if(y=C[F],"properties"==d.getElementName(y))for(y=d.getElementChildren(y),H=0;H<y.length;H++){var G=y[H],J=d.getElementName(G);this.ctatdebug("Nodename: "+J);switch(J){case "URL":r=d.getNodeTextValue(G);break;
case "Skills":m.parseByValue(G);break;case "SuccessMsg":p=a=d.getNodeTextValue(G);break;case "BuggyMsg":x=d.getNodeTextValue(G);break;case "Selection":a=d.getNodeTextValue(G);u.push(G);break;case "Action":c=d.getNodeTextValue(G);D.push(G);break;case "Input":f=d.getNodeTextValue(G);t.push(G);break;case "prompt":q=d.getNodeTextValue(G);break;case "HighlightMsgText":l=d.getNodeTextValue(G);break;case "custom_fields":B=b(G)}}this.ctatdebug("SAI: "+a+","+c+","+f);""!==a&&null!==a?(v=new CTATSAI(a,c,f,
q),v.setArrayFromElements(u),v.setArrayFromElements(D),v.setArrayFromElements(t),h=!0):(this.ctatdebug("No SAI found"),h=!1);this.ctatdebug("parseSAI () done, hassai: "+h+", ("+a+","+c+","+f+","+q+")")}};this.parseTransactionID=function(){this.ctatdebug("parseTransactionID()");if("tool_message"!=n){if(!g)for(var a=d.getElementChildren(e),b=0;b<a.length;b++){var c=a[b];if("properties"==d.getElementName(c))for(var c=d.getElementChildren(c),h=0;h<c.length;h++){var f=c[h];"transaction_id"==d.getElementName(f)&&
...
this.getSAI=function(){return h?v:new CTATSAI};this.getSelection=function(){return h?v.getSelection():""};this.getAction=function(){return h?v.getAction():""};this.getInput=function(){return h?v.getInput():""};this.getSelectionArray=function(){return h?v.getSelectionArray():[]};this.getActionArray=function(){return h?v.getActionArray():[]};this.getInputArray=function(){return h?v.getInputArray():[]};this.getXML=function(){return e};this.getXMLString=function(a){if(e.xml)return e.xml;if(XMLSerializer)return(new XMLSerializer).serializeToString(e);
...
")");for(var r="",v="",B=0;B<p.length;B++){var u=p[B];"TutorAdvice"==d.getElementName(u)&&(r=d.getNodeTextValue(u));"Actor"==d.getElementName(u)&&d.getNodeTextValue(u);"Indicator"==d.getElementName(u)&&(v=d.getNodeTextValue(u));"StepID"==d.getElementName(u)&&d.getNodeTextValue(u);"LogAsResult"==d.getElementName(u)&&d.getNodeTextValue(u);"tool_selection"==d.getElementName(u)&&d.getNodeTextValue(u);"Skills"==d.getElementName(u)&&(e.ctatdebug("Processing skills ..."),null===CTATSkillSet.skills&&(e.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."),
CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(u))}b.processAssociatedRules(h,v,r);a.propagateShellEvent("AssociatedRules",h)}"BuggyMessage"==l&&(e.ctatdebug("Found: BuggyMessage"),b.processBuggyMessage(h),a.propagateShellEvent("BuggyMessage",h));"SuccessMessage"==l&&(e.ctatdebug("Found: SuccessMessage"),b.processSuccessMessage(h),a.propagateShellEvent("SuccessMessage",h));-1!=l.indexOf("InterfaceAction")&&(e.ctatdebug("Found: InterfaceAction"),r=h.getSAI(),-1!=r.getAction().indexOf(":")?
(e.ctatdebug("Processing and storing timed interface action : "+r.getAction()),v=parseInt(r.getAction().substring(r.getAction().indexOf(":")+1)),e.ctatdebug("Target time: "+v),r.setAction(r.getAction().substring(0,r.getAction().indexOf(":"))),e.ctatdebug("Timing ..."),setTimeout(b.processInterfaceAction,v,h)):(e.ctatdebug("Processing regular (non-timed) interface action"),!0===CTATMessageHandler.inStartState?(e.ctatdebug("inStartState==true => storing for later playback ..."),f.push(h)):b.processInterfaceAction(h),
a.propagateShellEvent("InterfaceAction",h)));"InterfaceIdentification"==l&&(e.ctatdebug("Found: InterfaceIdentification"),a.propagateShellEvent("InterfaceIdentification",h));"AuthorModeChange"==l&&(e.ctatdebug("Found: AuthorModeChange"),b.globalReset(),a.propagateShellEvent("AuthorModeChange",h));"ResetAction"==l&&(e.ctatdebug("Found: ResetAction"),b.globalReset(),a.propagateShellEvent("ResetAction",h));if("ShowHintsMessage"==l){e.ctatdebug("Found: ShowHintsMessage");r=!1;v=[];for(B=0;B<p.length;B++)if(u=
p[B],"HintsMessage"==d.getElementName(u))for(var u=d.getElementChildren(u),z=0;z<u.length;z++){var A=u[z];"value"==d.getElementName(A)&&(v.push(d.getNodeTextValue(A)),r=!0)}!0===r?b.processHintResponse(h,v):e.ctatdebug("Error: incomplete hint message received");a.propagateShellEvent("ShowHintsMessage",h)}"ConfirmDone"==l&&(e.ctatdebug("Found: ConfirmDone"),b.processConfirmDone(h),a.propagateShellEvent("ConfirmDone",h));"VersionInfo"==l&&(e.ctatdebug("Found: VersionInfo"),b.processVersionInfo(p),a.propagateShellEvent("ConfirmDone",
...
a.propagateShellEvent("GetURL",h));"InterfaceReboot"==l&&(c++,1<c&&(l=CTATLMS.is.Authoring()?location.href:null,console.log("Found: InterfaceReboot #"+c+" -- href "+l),l?location.replace(l):(l=("https:"===window.top.location.protocol?"wss://":"ws://")+CTATConfiguration.get("remoteSocketURL")+":"+CTATConfiguration.get("remoteSocketPort"),console.log("closing connection w/ url: "+l),a.closeWSConnection(l,function(){var a=window.frameElement.getAttribute("id"),a=new CustomEvent("refreshIframe",{detail:a});
window.parent.document.dispatchEvent(a)},"interfaceReboot"))))}}}}};this.processStateGraph=function(a){e.ctatdebug("processStateGraph ()");if(void 0===a||null===a)e.ctatdebug("Error: state graph property list is undefined");else if(e.ctatdebug("Processing node: "+a.nodeName),null===d.getElementChildren(a))e.ctatdebug("Error: state graph property list is undefined");else{a=d.getElementChildren(a);for(var c=0;c<a.length;c++){var g=a[c];e.ctatdebug("State graph attribute: "+d.getElementName(g));"caseInsensitive"==
d.getElementName(g)&&(caseInsensitive="false"==d.getNodeTextValue(g)?!1:!0);"unordered"==d.getElementName(g)&&(unordered="false"==d.getNodeTextValue(g)?!1:!0);"lockWidget"==d.getElementName(g)&&(lockWidget="false"==d.getNodeTextValue(g)?!1:!0);"suppressStudentFeedback"==d.getElementName(g)&&("false"==d.getNodeTextValue(g)?CTATGlobals.suppressStudentFeedback=!1:CTATGlobals.suppressStudentFeedback=!0);"highlightRightSelection"==d.getElementName(g)&&(highlightRightSelection="false"==d.getNodeTextValue(g)?
!1:!0);"confirmDone"==d.getElementName(g)&&(e.ctatdebug("Confirm done: "+d.getNodeTextValue(g)),"true"==d.getNodeTextValue(g)?CTATGlobals.confirmDone=!0:CTATGlobals.confirmDone=!1);"Skills"==d.getElementName(g)&&(null===CTATSkillSet.skills&&(CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(g),b.updateSkillWindow())}}};this.processStartProblem=function(a){e.ctatdebug("processStartProblem ()");b.processStartProblem()};this.processInterfaceIdentification=function(a){};this.processInterfaceDescription=
function(a){e.ctatdebug("processInterfaceDescription ("+a.length+")");for(var b="Unknown",c="Unknown",g=null,h=0;h<a.length;h++){var f=a[h];e.ctatdebug("Inspecting element: "+d.getElementName(f));"WidgetType"==d.getElementName(f)&&(e.ctatdebug("Widget type: "+d.getNodeTextValue(f)),b=d.getNodeTextValue(f));"CommName"==d.getElementName(f)&&(e.ctatdebug("Instance name: "+d.getNodeTextValue(f)),c=d.getNodeTextValue(f));if("serialized"==d.getElementName(f)){e.ctatdebug("Prepareing to de-serialize component ...");
for(var l=d.getElementChildren(f),r=0;r<l.length;r++){var v=l[r];-1!=d.getElementName(v).indexOf("CTAT")&&(g=v)}}"interface"==d.getElementName(f)&&(e.ctatdebug("Storing interface for post start-state reconstruction ..."),CTATGlobals.interfaceElement=f);"script"==d.getElementName(f)&&(e.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."),scriptElement=d.getNodeTextValue(f))}null!==g?this.deserializeComponent(b,c,g):e.ctatdebug("Error: unable to find CTAT serialization point of attachement");
e.ctatdebug("processInterfaceDescription () done")};this.deserializeComponent=function(a,b,c){e.ctatdebug("deserializeComponent ("+a+","+b+")");if(!0===CTATGlobals.ignoreInterfaceDescriptions)e.ctatdebug("ignoreInterfaceDescriptions==true");else if(null===d.getElementAttr(c,"x"))e.ctatdebug("Warning: this component does not have x,y information. Probably an older component");else{var g=d.getElementAttr(c,"x"),h=d.getElementAttr(c,"y"),f=d.getElementAttr(c,"width"),m=d.getElementAttr(c,"height"),n=
d.getElementAttr(c,"tabIndex"),v=d.getElementAttr(c,"zIndex");null===n&&(n=-1);null===v&&(v=0);var B=new CTATComponentDescription;B.type=a;B.name=b;B.x=Math.floor(g);B.y=Math.floor(h);B.tabIndex=n;B.zIndex=v;B.width=Math.floor(f);B.height=Math.floor(m);CTATShellTools.registerComponentDescription(B);c=d.getElementChildren(c);for(g=0;g<c.length;g++){h=c[g];d.getElementName(h);if("Parameters"==d.getElementName(h))for(this.ctatdebug("Processing component parameters ..."),f=d.getElementChildren(h)[0],
f=d.getElementChildren(f),m=0;m<f.length;m++){var u=f[m];if("CTATComponentParameter"==d.getElementName(u)){this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");for(var v=n=void 0,u=d.getElementChildren(u),z=0;z<u.length;z++){var A=u[z];"name"==d.getElementName(A)&&(this.ctatdebug("Found parameter name: "+d.getNodeTextValue(A)),n=d.getNodeTextValue(A));"value"==d.getElementName(A)&&(this.ctatdebug("Found parameter value: "+d.getNodeTextValue(A)),v=d.getNodeTextValue(A).trim())}this.ctatdebug("Parameter name: "+
n+", value: "+v);void 0!==n&&(B.params[n]=v,"group"==n&&(B.groupName=v))}}if("Styles"==d.getElementName(h))for(this.ctatdebug("Processing component styles ..."),h=d.getElementChildren(h)[0],h=d.getElementChildren(h),f=0;f<h.length;f++)if(v=h[f],"CTATStyleProperty"==d.getElementName(v)){this.ctatdebug("Processing style property (CTATStyleProperty) ...");n=m="";v=d.getElementChildren(v);for(u=0;u<v.length;u++)z=v[u],"name"==d.getElementName(z)&&(m=d.getNodeTextValue(z)),"value"==d.getElementName(z)&&
(n=d.getNodeTextValue(z).trim());this.ctatdebug("Style (name: "+m+", value: "+n+")");""!==m&&(B.styles[m]=n)}}e.ctatdebug("deserializeComponent ("+a+","+b+") done")}};this.processStartStateActions=function(){e.ctatdebug("processStartStateActions ("+f.length+")");if(0===f.length)e.ctatdebug("No start state messages, bump");else if(0<CTATMessageHandler.startStateHandlers.length)for(var a=0;a<CTATMessageHandler.startStateHandlers.length;a++)CTATMessageHandler.startStateHandlers[a].processStartStateActions(f);
else{for(a=0;a<f.length;a++){var c=f[a];e.ctatdebug("Processing startstate message type: "+c.getMessageType());"InterfaceAction"==c.getMessageType()&&b.processInterfaceAction(c);"CorrectAction"==c.getMessageType()&&b.processCorrectAction(c);"InCorrectAction"==c.getMessageType()&&b.processInCorrectAction(c);this.sleep(1E3)}if(""!==CTATMessageHandler.scriptElement)try{eval(CTATMessageHandler.scriptElement)}catch(n){alert("Error executing script from BRD: "+n.message)}}};this.sleep=function(a){e.ctatdebug("sleep ("+
...
m.push(b.getProperty("StepID"));var n=b.getCustomFields(),r;for(r in n)f.push(r),m.push(n[r]);r=b.getSkillsObject();d.updateSkillWindow(r);ctatdebug("Sending log message ...");null!=commLoggingLibrary?l&&commLoggingLibrary.logTutorResponse(b.getTransactionID(),logHintSAI,c,"",h,g,r,f,m):this.ctatdebug("Info: no logging library available!");"done"==logHintSAI.getSelection()&&"Correct"==b.getIndicator()&&(b=e.createProblemSummaryRequestMessage(),a.sendXML(b))}else d.updateSkillWindow(null);d.ctatdebug("processAssociatedRules() done")};
...
try{document.close()}catch(v){alert("Error closing document: "+v.message)}try{document.write(b)}catch(v){alert("Error writing document: "+v.message)}}};this.updateSkillWindow=function(a){d.ctatdebug("updateSkillWindow()");CTATSkillSet.skills.untouchSkills();var b=CTATShellTools.findComponentByClass("CTATSkillWindow");null!==b?null!=a?b.updateSkillSet(a):b.drawComponent():d.ctatdebug("Info: no skill window available")};this.processComponentFocus=function(a){d.ctatdebug("processComponentFocus("+a.getName()+
...
a)))};this.setZIndex=function(a){w.ctatdebug("Setting z index to: "+a);E=a;null!==u&&(u.style.zIndex=a)};this.getZIndex=function(){return E};this.setDefaultWidth=function(a){q=a};this.getDefaultWidth=function(){return q};this.setDefaultHeight=function(a){p=a};this.getDefaultHeight=function(){return p};this.processCommShellEvent=function(a,b){w.ctatdebug("processCommShellEvent ("+a+")")};this.makeDivWrapper=function(a){u=document.createElement("div");u.id=this.getName();u.setAttribute("onkeypress",
"return noenter(event)");u.setAttribute("data-ctat-component",this.getClassName());u.style.position="absolute";u.style.left=g+"px";u.style.top=h+"px";u.style.zIndex=C;u.style.width=w.getWidth()+"px";u.style.height=w.getHeight()+"px";$(u).data("CTATComponent",this);a.appendChild(u)};this.setDivWrapper=function(a){u=a;u.setAttribute("data-ctat-component",this.getClassName())};var G=this.setClassName;this.setClassName=function(a){G(a);u&&u.setAttribute("data-ctat-component",this.getClassName())};this.wrapComponent=
...
u.insertBefore(D,u.firstChild):u.appendChild(D);return D};this.redraw=function(){var a=u.style.display;u.style.display="none";u.style.display=a};this.setCanvasVisibility=function(a){t=a};this.getSubCanvasCtx=function(){if(D)return D.getContext("2d")};this.getSubCanvas=function(){return D};this.getX=function(){return g};this.getY=function(){return h};this.getWidth=function(){if(0>=m){var a;I?a=window.getComputedStyle(I):u&&(a=window.getComputedStyle(u));if(a)return parseFloat(a.width)}return m};this.getHeight=
function(){if(0>=n&&u){var a=window.getComputedStyle(u);return parseFloat(a.getPropertyValue("height"))}return n};this.getText=function(){return r};this.getEnabled=function(){return B};this.assignEnabled=function(a){B=a;u.setAttribute("data-ctat-enabled",B)};this.setEnabled=function(a){w.ctatdebug("setEnabled ("+a+")");w.assignEnabled(a);I?I.disabled=!B:w.ctatdebug("Error: component pointer is null")};this.lock=this.setEnabled.bind(w,!1);this.unlock=this.setEnabled.bind(w,!0);this.getDivWrap=function(){return u};
this.getComponent=function(){return I};this.component=null;Object.defineProperty(this,"component",{get:function(){return I}});this.getCanvasZIndex=function(){return y};this.getComponentGroup=function(){return z};this.setComponent=function(a){I=a;this.setEnabled(this.getEnabled())};this.getTopDivZIndex=function(){return C};this.getTopDivID=function(){return F};this.setComponentGroup=function(a){z=a;I&&(I.name=a)};this.assignText=function(a){r=a};this.init=function(){w.ctatdebug("THIS IS THE BASE INIT METHOD")};
this.initialize=function(){w.ctatdebug("initialize ()");w.configFromDescription();w.init();w.processSerialization();w.render();w.processTabOrder();w.ctatdebug("initialize () done")};this.getInitialized=function(){return v};this.setInitialized=function(a){w.ctatdebug("setInitialized ("+a+")");v=a;!0!==v||u?w.ctatdebug("Not wrapping, initialized="+v+", divWrapper = "+u):(w.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."),(a=findPointOfAttachment(this.getName()))?
...
w.ctatdebug("implement in child class")};this.move=function(a,b){g=Number(a);h=Number(b);if(void 0===b||null===b||isNaN(h))if(0<=a.indexOf(",")){var c=a.split(",");g=Number(c[0]);h=Number(c[1])}else h=0;g=isNaN(g)?0:g;h=isNaN(h)?0:h;u&&(u.style.left=g+"px",u.style.top=h+"px")};this.setSize=function(a,b){var c=Number(a),d=Number(b);(void 0===b||null===b||isNaN(d))&&0<=a.indexOf(",")&&(d=a.split(","),c=Number(d[0]),d=Number(d[1]));w.ctatdebug("setSize ("+c+","+d+")");isNaN(c)||w.setWidth(c);isNaN(d)||
w.setHeight(d)};this.SetVisible=this.setVisible=function(a){a=CTATGlobalFunctions.toBoolean(a);t=!0===a?"block":"hidden";D&&D.setAttribute("style","border: 0px; position: absolute; "+(a?"":"visibility:hidden; ")+"; left:"+g+"px; top:"+h+"px; z-index:"+y+";");u.style.visibility=!0===a?null:"hidden"};this.FadeIn=function(a){w.SetVisible(!0)};this.FadeOut=function(a){w.SetVisible(!1)};this.reset=function(){};this.setX=function(a){this.x=a;u.style.left=this.x+"px";!0===v&&this.render()};this.setY=function(a){this.y=
a;u.style.top=this.y+"px";!0===v&&this.render()};this.setWidth=function(a){w.ctatdebug("setWidth ("+a+")");m=a;u?u.style.width=m+"px":w.ctatdebug("Internal error: no div wrapper available to set width")};this.setHeight=function(a){w.ctatdebug("setHeight ("+a+")");n=a;u?u.style.height=n+"px":w.ctatdebug("Internal error: no div wrapper available to set height")};this.setText=function(a){r=a;return this};this.getValue=function(){return I?I.value:""};this.backgrade=!1;this.unHighlightAll=function(){$(".CTAT--hint").each(function(){for(var a=
...
a)};this.setParameterHandler("DisableOnCorrect",this.setDisableOnCorrect);var l=!0;this.getShowHintHighlight=function(){return l};this.setShowHintHighlight=function(a){l=CTATGlobalFunctions.toBoolean(a)};this.setParameterHandler("ShowHintHighlight",this.setShowHintHighlight);this.data_ctat_handlers["show-hint-highlight"]=function(a){l=CTATGlobalFunctions.toBoolean(a)};var r=CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED;this.getComponentStatus=function(){return r};this.setComponentStatus=
function(a){r=a};this.isCorrect=function(){return r===CTAT.Component.Base.Tutorable.Options.Status.CORRECT};this.isIncorrect=function(){return r===CTAT.Component.Base.Tutorable.Options.Status.INCORRECT};this.isNotGraded=function(){return r===CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED};this.setCorrect=function(a){this.setNotGraded();"CTATTableGoogle"!=this.getClassName()&&this.executeSAI(a);r=CTAT.Component.Base.Tutorable.Options.Status.CORRECT;!0===this.getDisableOnCorrect()&&this.setEnabled(!1);
!1===CTATGlobals.suppressStudentFeedback&&n&&this.showCorrect(a);this.ctatdebug("setCorrect() post showCorrect");this.component&&(a=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.correct,{detail:{sai:a,component:this},bubbles:!0,cancelable:!0}),this.getDivWrap().dispatchEvent(a))};this.setIncorrect=function(a){this.ctatdebug("setIncorrect()");this.setNotGraded();"CTATTableGoogle"!=this.getClassName()&&this.executeSAI(a);r=CTAT.Component.Base.Tutorable.Options.Status.INCORRECT;!1===CTATGlobals.suppressStudentFeedback&&
n&&this.showInCorrect(a);this.component&&(a=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.incorrect,{detail:{sai:a,component:this},bubbles:!0,cancelable:!0}),this.getDivWrap().dispatchEvent(a))};this.setNotGraded=function(){this.ctatdebug("setNotGraded ()");this.setHintHighlight(!1);if(!this.isNotGraded()&&(r=CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED,this.removeCorrect(),this.removeInCorrect(),this.component)){var a=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.ungrade,
...
[],r=this;this.generateClassname=function(){return this.getName()+" UnitPart"};this.getPieces=function(){return l};var v=function(a){if(a.hasAttributeNS(null,"data-selected"))return CTATGlobalFunctions.toBoolean(a.getAttributeNS(null,"data-selected"));a.setAttributeNS(null,"data-selected",!0);return!0};this.getPiecesBySelected=function(a){for(var b=this.getPieces(),c=[],d,e=0;e<b.length;e++)d=b[e],v(d)===a&&c.push(d);return c};this.getSelectedPieces=this.getPiecesBySelected.bind(this,!0);this.getDeselectedPieces=
...
r.color),$(a).css("fill-opacity",r.colorAlpha)):($(a).css("fill",r.deselectedColor),$(a).css("fill-opacity",r.deselectedColorAlpha),a.setAttributeNS(null,"data-selected",!1))};this.clickHandler=function(a){!0===r.getEnabled()&&(a=CTATGlobalFunctions.toBoolean(this.getAttributeNS(null,"data-selected")),B(this,!a),r.setActionInput("SetPieces",r.updateValue()),r.processAction())};this.updateSAI=function(){r.setActionInput("SetPieces",r.updateValue())};this.addPieceElem=function(a,b,c){a.setAttributeNS(null,
"data-selected",c);a.setAttributeNS(null,"data-value",b.toString());a.dataValue=b;this.getEnabled()&&(a.style.cursor="pointer");a.addEventListener("click",this.clickHandler);l.push(a)};var u=this.setEnabled;this.setEnabled=function(a){u(a);l.forEach(function(b){b.style.cursor=a?"pointer":"default"})};this.clear=function(){l=[]};var z=function(a,b){var c=a.toString();!1===b&&(c="(0*"+c+")");return c};this.AddPiece=function(a,b){if(a){var c=new CTAT.Math.Fraction(a);if(0<CTAT.Math.round(c.valueOf())){var d=
h.split("+");d.push(z(c,b));r.setValue(d.join("+"))}}};this.AddToValue=function(a,b){if(a){var c=new CTAT.Math.Fraction(a);if(0<CTAT.Math.round(c.valueOf())){var d=h.split("+");d.push(z(c,b));h=d.join("+")}}return h};var A=-1,E=function(a){isNaN(a)&&this.get_denominator();a=Math.max(a,1);1<A&&(a=Math.min(a,A));return a}.bind(this);this.set_max_denominator=function(a){a=parseInt(a);isNaN(a)||(A=a)};this.set_denominator=function(a){r.setHintHighlight(!1);var b="string"===typeof a?parseInt(a):a;if(!isNaN(b)&&
(b=E(b),this.get_denominator()!=a)){var c=r.evaluate();r.clear();a=[];c.set_denominator(b);for(var d=new CTAT.Math.Fraction(1,b),e=Math.floor(c.numerator),g=b-e,f=0;f<e;f++)a.push(z(d,!0));b=new CTAT.Math.Fraction(c.numerator-e,b);b.equals(0)||(a.push(z(b,!0)),a.push(z(d.subtract(b),!1)),g--);for(b=0;b<g;b++)a.push(z(d,!1));this.setValue(a.join("+"));r.setActionInput("SetPieces",h);r.processAction();return h}};this.get_denominator=function(){return l.reduce(function(a,b,c,d){return Math.min(a,b.dataValue.denominator)},
Infinity)};this.change_denominator=function(a){return this.set_denominator(this.get_denominator()+Number(a))};this.set_number_pieces=function(a){r.setHintHighlight(!1);a="string"===typeof a?parseInt(a):a;if(!isNaN(a)){a=E(a);var b=r.numActive();r.clear();for(var c=[],d=new CTAT.Math.Fraction(1,a),e=0;e<a;e++)c.push(z(d,0<b)),b--;this.setValue(c.join("+"));r.setActionInput("SetPieces",h);r.processAction();return h}};this.change_number_pieces=function(a){this.set_number_pieces(l.length+a)};this.set_numerator=
function(a){return this.change_numerator(a-this.getSelectedPieces().length)};this.change_numerator=function(a){0!==a&&(0<a?l.every(function(b){!1===v(b)&&(B(b,!0),a--);return 0<a}):(l.reverse(),l.every(function(b){!0===v(b)&&(B(b,!1),a++);return 0>a}),l.reverse()))};this.SetPieces=function(a){r.setValue(a)};e=function(a){return(a=$(this.getDivWrap()).attr(a))?a.split(/\s*;\s*/).map(function(a){return a.trim()}):[]};a=e.bind(this,"data-ctat-ctrl-denominator");b=e.bind(this,"data-ctat-ctrl-partition");
e=e.bind(this,"data-ctat-ctrl-numerator");f=function(a,b){return 0<=a().indexOf(b)};var I=f.bind(null,a),w=f.bind(null,b),D=f.bind(null,e),t=function(a){var b=null;if(a instanceof CTAT.Component.Base.Tutorable)a!=this&&(b=a.getName());else if(a instanceof CTATSAI)a.getSelection()!=r.getName()&&(b=a.getSelection());else if(a instanceof String)a!=r.getName()&&(b=a);else if(a instanceof Element)a!=r.getComponent()&&(b=a.id);else return null;if(b){if(I(b))return C.bind(this,this.change_denominator,this.set_denominator);
if(D(b))return C.bind(this,this.change_numerator,this.set_numerator);if(w(b))return C.bind(this,this.change_number_pieces,this.set_number_pieces)}return null}.bind(this);document.addEventListener(CTAT.Component.Base.Tutorable.EventType.action,function(a){var b=a.detail.sai;a=t(a.detail.component);b&&null!==a&&a(b)},!1);var C=function(a,b,c){var d=parseInt(c.getInput());if(!isNaN(d)){switch(c.getAction()){case "ButtonPressed":a.call(this,d);break;case "Update":case "UpdateTextField":case "UpdateTextArea":b.call(this,
...
l.classList.add("CTATFractionBar--label");l.setAttributeNS(null,"text-anchor","middle");l.setAttributeNS(null,"dominant-baseline","middle");d.appendChild(l);var x=""+String(f.numerator),f=""+String(f.denominator),r=document.createElementNS(c,"tspan"),v=document.createElementNS(c,"tspan");r.appendChild(document.createTextNode(x));v.appendChild(document.createTextNode(f));l.appendChild(r);l.appendChild(v);l=b+p/2;r.setAttributeNS(null,"x",l+"%");r.setAttributeNS(null,"y","60%");r.setAttributeNS(null,
"dy","-1em");v.setAttributeNS(null,"x",l+"%");v.setAttributeNS(null,"y","60%");x.length>f.length?r.style.textDecoration="underline":v.style.textDecoration="overline";b+=p}this.baseGroup.innerHTML="";this.baseGroup.appendChild(d);var B=this.baseGroup.getBBox().width-1;Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a){if("rect"==a.nodeName){var b=window.getComputedStyle(a),c=parseFloat(b.getPropertyValue("padding-left")),d=parseFloat(b.getPropertyValue("stroke-width")),b=a.getBBox();
...
this.render()};var n=new a(this,new c(0),25,"CTATNumberLine--denominator-tickmark","CTATNumberLine--denominator-tickmark-label");this.setParameterHandler("DenominatorTickmarkSize",function(a){n.setSize(a);this.render();return this});this.setParameterHandler("DenominatorTickmarkStep",function(a){n.setStep((new c(a)).reciprocal())});this.data_ctat_handlers.denominator=function(a){a=new c(a);n.setStep(a.reciprocal())};this.setColor=function(a){};this.getColor=function(){};this.X_Axis=new function(a,
b,c,d){var e={};this.svg_group=null;var g=a;Object.defineProperty(this,"start",{get:function(){return g},set:function(a){e={};g=a}});Object.defineProperty(this,"min_loc",{get:function(){if(!e.hasOwnProperty("min_loc")){var a=this.start.clone(),b=CTAT.Geom.Point.polar(20,this.angle()),a=a.add(b);a.x=CTAT.Math.round(a.x);a.y=CTAT.Math.round(a.y);e.min_loc=a}return e.min_loc}});var f=b;Object.defineProperty(this,"end",{get:function(){return f},set:function(a){e={};f=a}});Object.defineProperty(this,"max_loc",
{get:function(){if(!e.hasOwnProperty("max_loc")){var a=this.end.clone(),b=CTAT.Geom.Point.polar(20,this.angle()),a=a.add(b.scale(-1));a.x=CTAT.Math.round(a.x);a.y=CTAT.Math.round(a.y);e.max_loc=a}return e.max_loc}});var h=c;Object.defineProperty(this,"min",{get:function(){return h},set:function(a){e={};h=a}});var m=d;Object.defineProperty(this,"max",{get:function(){return m},set:function(a){e={};m=a}});Object.defineProperty(this,"length",{get:function(){e.hasOwnProperty("length")||(e.length=CTAT.Math.round(this.min_loc.distance(this.max_loc)));
return e.length}});this.isHorizontal=function(){return this.start.y===this.end.y};this.isVertical=function(){return this.start.x===this.end.x};Object.defineProperty(this,"range",{get:function(){return this.max.subtract(this.min)}});Object.defineProperty(this,"step_size",{get:function(){return CTAT.Geom.Point.equals(this.min_loc,this.max_loc)?this.length:CTAT.Math.round(this.length/this.range)}});this.s_vec=function(){return this.max_loc.add(this.min_loc.scale(-1))};this.slope=function(){var a=this.s_vec();
return a.y/a.x};this.step=function(){e.hasOwnProperty("step")||(e.step=this.s_vec().normalize(this.step_size));return e.step};this.scalar=function(){e.hasOwnProperty("scalar")||(e.scalar=this.range/this.length);return e.scalar};this.zero=function(){e.hasOwnProperty("zero")||(e.zero=this.min_loc.add(this.step().scale(-this.min)),e.zero.x=CTAT.Math.round(e.zero.x),e.zero.y=CTAT.Math.round(e.zero.y));return e.zero};this.angle=function(){if(!e.hasOwnProperty("angle")){var a=this.end.add(this.start.scale(-1));
e.angle=Math.atan2(a.y,a.x)}return e.angle};this.angle_deg=function(){return CTAT.Math.rad2deg(this.angle())};this.getPosition=function(a){a=this.zero().add(this.step().scale(1*a));a.x=CTAT.Math.round(a.x);a.y=CTAT.Math.round(a.y);return a};this.projected_point=function(a){var b=this.s_vec(),c=a.add(this.min_loc.scale(-1)),c=0+(b.y*c.x-b.x*c.y)/(b.y*b.y+b.x*b.x);return a.add(new DOMPoint(-c*b.y,c*b.x))};this.getProjectedPoint=function(a){a=this.projected_point(a);return a.distance(this.max_loc)>this.length?
this.min_loc:a.distance(this.min_loc)>this.length?this.max_loc:a};this.getAxisValue=function(a){return CTAT.Math.round(h+this.scalar()*this.min_loc.distance(this.getProjectedPoint(a)))}}(new DOMPoint(0,0),new DOMPoint(0,0),new c(0),new c(3));Object.defineProperty(this,"Maximum",{get:function(){return this.X_Axis.max},set:function(a){this.X_Axis.max=new c(a)}});this.setMaximum=function(a){this.Maximum=a};this.setParameterHandler("Maximum",this.setMaximum);this.data_ctat_handlers.maximum=this.setMaximum;
Object.defineProperty(this,"Minimum",{get:function(){return this.X_Axis.min},set:function(a){this.X_Axis.min=new c(a)}});this.setMinimum=function(a){this.Minimum=a};this.setParameterHandler("Minimum",this.setMinimum);this.data_ctat_handlers.minimum=this.setMinimum;var q=1;Object.defineProperty(this,"Max_Points",{get:function(){return q},set:function(a){a=parseInt(a);isNaN(a)||(q=a)}});this.setMaxPoints=function(a){this.Max_Points=a};this.setParameterHandler("Max_Points",this.setMaxPoints);this.data_ctat_handlers["max-points"]=
this.setMaxPoints;var p=7;this.setPointSize=function(a){p=Number(a);v&&(v.setAttributeNS(null,"r",p),$(this._point_group).find("circle").each(function(){$(this).attr("r",p)}))};this.setStyleHandler("PointSize",this.setPointSize);this.data_ctat_handlers["point-size"]=this.setPointSize;var x=!1;this.setSnapToTickMark=function(a){x=CTATGlobalFunctions.toBoolean(a)};this.setParameterHandler("SnapToTickmark",this.setSnapToTickMark);this.data_ctat_handlers.snap=this.setSnapToTickMark;this.theta=0;Object.defineProperty(this,
"Orientation",{get:function(){return 180*this.theta/Math.PI},set:function(a){a=Number(a);isNaN(a)&&(a=0);this.theta=Math.PI*a/180}});this.setOrientation=function(a){this.Orientation=a;this.render()};this.setParameterHandler("Orientation",this.setOrientation);this.data_ctat_handlers.rotation=this.setOrientation;this._tickmarks=[];this.genTickmark=function(a,b,c){var d=document.createDocumentFragment();if(!this._tickmarks.some(function(b){return b.data.equals(a)})){var e=document.createElementNS(g,
"line"),f=this.X_Axis.getPosition(a),h=CTAT.Geom.Point.polar(c/2,this.theta+Math.PI/2).add(f);c=CTAT.Geom.Point.polar(-c/2,this.theta+Math.PI/2).add(f);e.setAttributeNS(null,"x1",h.x);e.setAttributeNS(null,"y1",h.y);e.setAttributeNS(null,"x2",c.x);e.setAttributeNS(null,"y2",c.y);e.setAttributeNS(null,"data-value",a.toString());e.data=a;e.location=f;e.label=null;this._tickmarks.push(e);d.appendChild(e);if(""!==b){f=document.createElementNS(g,"text");f.classList.add("CTATNumberLine--tickmark-label");
...
e=new DOMPoint(a.cx.baseVal.value,a.cy.baseVal.value),1<d.distance(e)&&(a.cx.baseVal.value=d.x,a.cy.baseVal.value=d.y)}}.bind(this),r=0,v=null,B=new DOMPoint(-30,-30),u=!1,z=function(a){B.x=a.clientX;B.y=a.clientY},A=function(a){cancelAnimationFrame(r);v.style.visibility="hidden";u=!1},E=function(a){if(!0===this.getEnabled()&&0<q){this.setHintHighlight(!1);var b;x?(a=t(a.clientX,a.clientY),b=a.location,a=a.data):(a=w(a.clientX,a.clientY),b=this.X_Axis.getProjectedPoint(a),a=this.X_Axis.getAxisValue(a));
...
this.setActionInput("AddPoint",a.toString());this.processAction()}}.bind(this);this.init=function(){this.initSVG();this.component.classList.add("CTATNumberLine--container");this._axis_line_group=document.createElementNS(g,"g");this._axis_line_group.classList.add("CTATNumberLine--axis");this._tick_mark_group=document.createElementNS(g,"g");this._tick_mark_group.classList.add("CTATNumberLine--tickmark");this._point_group=document.createElementNS(g,"g");v=document.createElementNS(g,"circle");v.setAttributeNS(null,
"r",p);v.classList.add("CTATNumberLine--cursor");v.setAttributeNS(null,"transform","translate(-30,-30)");this.component.appendChild(this._axis_line_group);this.component.appendChild(this._tick_mark_group);this.component.appendChild(this._point_group);this.component.appendChild(v);this.X_Axis.svg_group=this._axis_line_group;l();this.addComponentReference(this,this.getDivWrap());this.component.addEventListener("mousemove",z);this.component.addEventListener("mouseleave",A);var a=this.getEnabled;this.component.addEventListener("mouseenter",
function(){!0===a()&&0<q&&(u=!0,v.style.visibility=null,r=requestAnimationFrame(C))});this.component.addEventListener("click",E);this.component.addEventListener("focus",this.processFocus)};this.getConfigurationActions=function(){var a=[],b,c=$(this.getDivWrap());c.attr("data-ctat-minimum")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_minimum"),b.setInput(c.attr("data-ctat-minimum")),a.push(b));c.attr("data-ctat-maximum")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_maximum"),
...
c=new DOMPoint(this.svgPoint.x,this.svgPoint.y);if(I){var d=$(this.component),e=parseInt(d.css("borderLeftWidth"))+parseInt(d.css("paddingLeft"))+parseInt(d.css("marginLeft")),d=parseInt(d.css("borderTopWidth"))+parseInt(d.css("paddingTop"))+parseInt(d.css("marginTop"));c.x-=e;c.y-=d}return c}.bind(this),D=function(a,b){return this.getProjectedPoint(w(a,b))}.bind(this.X_Axis),t=function(a,b){for(var c=D(a,b),d=null,e=Number.POSITIVE_INFINITY,g,f,h=0;h<this._tickmarks.length;h++)g=this._tickmarks[h],
f=c.distance(g.location),f<e&&(d=g,e=f);return d}.bind(this),C=function(){if(u&&!0===this.getEnabled()){if(x){var a=t(B.x,B.y);v.setAttributeNS(null,"transform","translate"+CTAT.Geom.Point.to2DString(a.location,!0))}else v.setAttributeNS(null,"transform","translate"+CTAT.Geom.Point.to2DString(D(B.x,B.y),!0));r=requestAnimationFrame(C)}}.bind(this);this.render=function(){l()};this.calcXCoordinate=function(a){a=new c(a);var b=this.getWidth()-30,b=Math.abs(b-30),d=max.subtract(min);return 30+a.subtract(min).divide(d)/
...
this.getName(),b)}};var y=this.setEnabled;this.setEnabled=function(a){y(a);v&&u&&(v.style.visibility=this.getEnabled()?null:"hidden")};this.set_minimum=function(a){this.Minimum=a;this.render()};this.change_minimum=function(a){a=new c(a);0!==a.valueOf()&&(this.Minimum=this.Minimum.add(a),this.render())};var H=function(){this.setActionInput("set_minimum",this.Minimum)}.bind(this);this.set_maximum=function(a){this.Maximum=a;this.render()};this.change_maximum=function(a){a=new c(a);0!==a.valueOf()&&(this.Maximum=
...
var l=2*Math.PI*a.valueOf();m=e.add(CTAT.Geom.Point.polar(d,l));b.reduce();var n=e.add(CTAT.Geom.Point.polar(d,2*Math.PI*b.valueOf()+l)),r=e.clone();if(0<c&&c<d){l=CTAT.Geom.Point.polar(c,l+Math.PI*b.valueOf());r=r.add(l);m=m.add(l);var p=function(a,b,c){return a.distance(b)<a.distance(c)?b:c};m=CTAT.Geom.Point.circle_intersection(r,m,e,d).reduce(p.bind(this,m));n=n.add(l);n=CTAT.Geom.Point.circle_intersection(r,n,e,d).reduce(p.bind(this,n))}l=CTAT.Geom.Point.to2DString;r="M "+l(r);p=new DOMPoint(d,
d);r+=" L "+l(m);r+=" A "+l(p)+" 0 "+(.5<b.valueOf()?1:0)+",1 "+l(n);g.setAttributeNS(null,"d",r+" Z");h.addPieceElem(g,b,b.selected)}return a.add(b)},new CTAT.Math.Fraction);this.baseGroup.innerHTML="";this.baseGroup.appendChild(f);this.setColor(this.color);this.setDeselectedColor(this.deselectedColor);this.setDeselectedColorAlpha(this.deselectedColorAlpha)}};this.getExplode=function(){return c};this.getDropShadowDistance=function(){return g};this.setExplode=function(a){a=Number(a);if(!isNaN(a)){var b=
...
f.getLevel()+" ...");var x=document.createElement("div");x.classList.add("CTATSkillWindow--skill");var l=document.createElement("div");l.classList.add("CTATSkillWindow--bar");var r=document.createElement("div"),v=f.getLevel();v<d?r.classList.add("CTATSkillWindow--bar--nonmastered"):r.classList.add("CTATSkillWindow--bar--mastery");r.style.width=v>d?"100%":100*v+"%";l.appendChild(r);x.appendChild(l);b.appendChild(x);l=document.createElement("div");l.textContent=f.getDisplayName()||"no-name";l.classList.add("CTATSkillWindow--label");
...
(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_first_row_is_header"),b.setInput(c.attr("data-ctat-has-header")),a.push(b));return a};var p=function(){$(this.getDivWrap()).children().first().addClass("CTATTable--headers").children().addClass("CTATTable--header")}.bind(this),x=function(){$(this.getDivWrap()).children().first().removeClass("CTATTable--headers").children().removeClass("CTATTable--header")}.bind(this),l=function(a,b){var c=document.createElement("div"),d=this.getName()+
".R"+a+"C"+b;c.id=d;c.classList.add("CTATTable--cell");c.classList.add("CTATTextArea");$(c).css("height","100%");var e=new CTATTextArea;e.setName(d);e.setDivWrapper(c);e.processAttributes();e.init();e.processTabOrder();CTATConfiguration.get("previewMode")?e.setEnabled(!1):e.setEnabled(this.getEnabled());$(c).data("CTATComponent",e);return c}.bind(this);this.addRow=function(){var a=document.createElement("div");a.classList.add("CTATTable--row");var b=n();parseInt(b,10);g[b]=[];for(var c=0;c<q();c++){var d=
l(b,c);g[b].push(d);a.appendChild(d)}$(this.getDivWrap()).append(a);h.push(a);this.set_row_count(b+1)};this.deleteRow=function(){var a=this.getDivWrap();a.removeChild(a.lastChild);h.pop();g.pop();this.set_row_count(this.get_row_count()-1)};this.addColumn=function(){var a=q(),b=0;h.forEach(function(c){var d=l(b,a);g[b].push(d);b<m&&d.classList.add("CTATTable--header");c.appendChild(d);b++});this.set_col_count(a+1)};this.deleteColumn=function(){this.getDivWrap();for(var a=h.length,b=0;b<a;b++)h[b].removeChild(h[b].lastChild),
g[b].pop();this.set_col_count(this.get_col_count()-1)};this.adjustTableContents=function(){c.ctatdebug("adjustTableContents()");for(var a=n(),b=0;b<a;b++){var d=document.createElement("div");d.classList.add("CTATTable--row");$(this.getDivWrap()).append(d);h.push(d);for(var e=0;e<q();e++){var f=c.getName()+".R"+b+"C"+e,m=CTATShellTools.findComponent(f);m&&0!==m.length&&m[0].getName()===f?(f=m[0].getDivWrap(),f.classList.add("CTATTable--cell")):f=l(b,e);d.appendChild(f);g[b]||(g[b]=[]);g[b].push(f)}}}};
CTATTable.prototype=Object.create(CTAT.Component.Base.Graphical.prototype);CTATTable.prototype.constructor=CTATTable;CTAT.ComponentRegistry.addComponentType("CTATTable",CTATTable);var CTATTextField=function(a,b,e,f,d){CTATTextBasedComponent.call(this,"CTATTextBasedComponent","__undefined__",a,b,e,f,d);var c=this,g=null;this.setAction("UpdateTextArea");this.init=function(){g=this.getDivWrap();c.setComponent(g);this.getText()&&(g.innerHTML=c.getText());c.setInitialized(!0);c.addComponentReference(c,g);c.setEditable(!1);c.setEnabled(!1);c.render();c.addSafeEventListener("focus",c.processFocus,g)};this.getConfigurationActions=function(){return 0<g.innerHTML.trim().length?(console.log(g.innerHTML),
...
b){if(a){var d=a.contentDocument||a.contentWindow.document;d.open();d.write(b);d.close()}};document.addEventListener("refreshIframe",function(a){a=a.detail;console.log("refresh event for iframe "+a);b.refresh(a)})};(function(a){function b(){var a=arguments[0],c=b.cache;c[a]&&c.hasOwnProperty(a)||(c[a]=b.parse(a));return b.format.call(null,c[a],arguments)}function e(a){return Object.prototype.toString.call(a).slice(8,-1).toLowerCase()}var f=/[^s]/,d=/[def]/,c=/^[^\x25]+/,g=/^\x25{2}/,h=/^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/,m=/^([a-z_][a-z_\d]*)/i,n=/^\.([a-z_][a-z_\d]*)/i,q=/^\[(\d+)\]/,p=/^[\+\-]/;b.format=function(a,c){var g=1,h=a.length,l,m=[],n,q,r,x,D=!0,
t="";for(n=0;n<h;n++)if(l=e(a[n]),"string"===l)m[m.length]=a[n];else if("array"===l){r=a[n];if(r[2])for(l=c[g],q=0;q<r[2].length;q++){if(!l.hasOwnProperty(r[2][q]))throw Error(b("[sprintf] property '%s' does not exist",r[2][q]));l=l[r[2][q]]}else l=r[1]?c[r[1]]:c[g++];"function"==e(l)&&(l=l());if(f.test(r[8])&&"number"!=e(l)&&isNaN(l))throw new TypeError(b("[sprintf] expecting number but found %s",e(l)));d.test(r[8])&&(D=0<=l);switch(r[8]){case "b":l=l.toString(2);break;case "c":l=String.fromCharCode(l);
break;case "d":l=parseInt(l,10);break;case "e":l=r[7]?l.toExponential(r[7]):l.toExponential();break;case "f":l=r[7]?parseFloat(l).toFixed(r[7]):parseFloat(l);break;case "o":l=l.toString(8);break;case "s":l=(l=String(l))&&r[7]?l.substring(0,r[7]):l;break;case "u":l>>>=0;break;case "x":l=l.toString(16);break;case "X":l=l.toString(16).toUpperCase()}if(!D||d.test(r[8])&&r[3])t=D?"+":"-",l=l.toString().replace(p,"");q=r[4]?"0"==r[4]?"0":r[4].charAt(1):" ";x=r[6]-(t+l).length;x=r[6]?Array(x+1).join(q):
"";m[m.length]=r[5]?t+l+x:0==q?t+x+l:x+t+l}return m.join("")};b.cache={};b.parse=function(a){for(var b,d=[],e=0;a;){if(null!==(b=c.exec(a)))d[d.length]=b[0];else if(null!==(b=g.exec(a)))d[d.length]="%";else if(null!==(b=h.exec(a))){if(b[2]){var e=e|1,f=[],l=b[2],p;if(null!==(p=m.exec(l)))for(f[f.length]=p[1];""!==(l=l.substring(p[0].length));)if(null!==(p=n.exec(l)))f[f.length]=p[1];else if(null!==(p=q.exec(l)))f[f.length]=p[1];else throw new SyntaxError("[sprintf] failed to parse named argument key");
...
parseInt(g,10):CTATExampleTracerSkill.DEFAULT_HISTORY,l=0,r=0,v=CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11,B=CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD,u=null,z=null,A=this;this.getSkillName=function(){return h};this.getCategory=function(){var a=h.indexOf(" ");return 0>a?"":h.substring(a+1)};this.setTransactionNumber=function(a){l=a};this.updatePKnown=function(a){return n=CTATExampleTracerSkill.updatePKnownStatic(a,m,n,p,q)};this.updateHistory=function(a){return x=CTATExampleTracerSkill.updateHistoryStatic(a,
x)};this.changeOpportunityCount=function(a){return r+=a};this.getTransactionNumber=function(){return l};this.getSkillBarString=function(a){var b=this.getSkillName(),b=b+this.getSkillBarDelimiter()+n,b=b+this.getSkillBarDelimiter()+(this.hasReachedMastery()?"1":"0");!0===a&&(b=b+this.getSkillBarDelimiter()+this.getLabel());return b.toString()};this.getSkillBarDelimiter=function(){return v};this.toXML=function(a){var b;b=""+(' name="'+CTATExampleTracerSkill.getName(h)+'"');b+=' category="'+A.getCategory()+
'"';b+=' label="'+A.getLabel()+'"';b+=' description="'+A.getDescription()+'"';b+=' pKnown="'+Number(n).toFixed(2)+'"';b+=' pLearn="'+Number(q).toFixed(2)+'"';b+=' pGuess="'+Number(m).toFixed(2)+'"';b+=' pSlip="'+Number(p).toFixed(2)+'"';b+=' history="'+x+'"';b+=' opportunityCount="'+r+'"';return a?"&lt;Skill"+b+" /&gt;":"<Skill"+b+" />"};this.hasReachedMastery=function(){return null===n||"undefined"===typeof n?!1:n>=B};this.getLabel=function(){return!u||1>u.length?CTATExampleTracerSkill.getName(h):
u};this.getDescription=function(){return!z||1>z.length?h:z};this.setVersion=function(a){null!==a&&"undefined"!==typeof a&&0<a.length&&(v=CTATExampleTracerSkill.versionToSkillBarDelimiter(a))};this.setLabel=function(a){u=a};this.setDescription=function(a){z=a};CTATExampleTracerSkill.makeStepID=function(a,b){for(var c="",d=0,e=a;2>d++;e=b)if(!(null===e||"undefined"===typeof e||1>e.length)){for(var g=!1,f=0;f<e.length;f++)if(null!==e[f]&&"undefined"!==typeof e[f]){var h=e[f].toString();1>h.length||e===
...
a);break;case 26:this.$=new d.CTATConstantNode(Number(a))}},table:[{3:1,4:2,6:3,13:e,14:4,15:f,17:5,19:8,22:9,24:d,25:c,27:g,28:h},{1:[3]},{5:[1,14]},{5:[2,8],7:[1,15],8:[1,16],9:[1,17],10:[1,18],11:[1,19],12:[1,20],13:m,15:n},b(q,[2,11],{22:9,19:25,16:p,18:x,20:l,21:r,24:d,25:c,27:g,28:h}),b(v,[2,17]),{13:e,15:f,17:28,19:8,22:9,24:d,25:c,27:g,28:h},{13:e,15:f,17:29,19:8,22:9,24:d,25:c,27:g,28:h},b(v,[2,20]),b(v,[2,23],{23:[1,30]}),{13:e,15:f,17:31,19:8,22:9,24:d,25:c,27:g,28:h},{6:32,13:e,14:4,15:f,
...
25:c,27:g,28:h},{13:e,15:f,17:41,19:8,22:9,24:d,25:c,27:g,28:h},{13:e,15:f,17:42,19:8,22:9,24:d,25:c,27:g,28:h},b(v,[2,14]),{13:e,15:f,17:43,19:8,22:9,24:d,25:c,27:g,28:h},{13:e,15:f,17:44,19:8,22:9,24:d,25:c,27:g,28:h},b(v,[2,18]),b(v,[2,19]),{13:e,15:f,17:45,19:8,22:9,24:d,25:c,27:g,28:h},b(v,[2,22]),{13:m,15:n,26:[1,46]},{5:[2,2],13:m,15:n},{5:[2,3],13:m,15:n},{5:[2,4],13:m,15:n},{5:[2,5],13:m,15:n},{5:[2,6],13:m,15:n},{5:[2,7],13:m,15:n},b(q,[2,9],{22:9,19:25,16:p,18:x,20:l,21:r,24:d,25:c,27:g,
28:h}),b(q,[2,10],{22:9,19:25,16:p,18:x,20:l,21:r,24:d,25:c,27:g,28:h}),b(v,[2,12]),b(v,[2,13]),b(v,[2,15]),b(v,[2,16]),b(v,[2,21]),b(B,[2,24])],defaultActions:{14:[2,1]},parseError:function(a,b){if(b.recoverable)this.trace(a);else{var c=function(a,b){this.message=a;this.hash=b};c.prototype=Error;throw new c(a,b);}},parse:function(a){var b=[0],c=[null],d=[],e=this.table,f="",g=0,l=0,h=0,m=d.slice.call(arguments,1),n=Object.create(this.lexer),p={},r;for(r in this.yy)Object.prototype.hasOwnProperty.call(this.yy,
r)&&(p[r]=this.yy[r]);n.setInput(a,p);p.lexer=n;p.parser=this;"undefined"==typeof n.yylloc&&(n.yylloc={});r=n.yylloc;d.push(r);var q=n.options&&n.options.ranges;this.parseError="function"===typeof p.parseError?p.parseError:Object.getPrototypeOf(this).parseError;for(var v,x,u,B,M={},P,K;;){u=b[b.length-1];if(this.defaultActions[u])B=this.defaultActions[u];else{if(null===v||"undefined"==typeof v)v=n.lex()||1,"number"!==typeof v&&(v=this.symbols_[v]||v);B=e[u]&&e[u][v]}if("undefined"===typeof B||!B.length||
!B[0]){var R;K=[];for(P in e[u])this.terminals_[P]&&2<P&&K.push("'"+this.terminals_[P]+"'");R=n.showPosition?"Parse error on line "+(g+1)+":\n"+n.showPosition()+"\nExpecting "+K.join(", ")+", got '"+(this.terminals_[v]||v)+"'":"Parse error on line "+(g+1)+": Unexpected "+(1==v?"end of input":"'"+(this.terminals_[v]||v)+"'");this.parseError(R,{text:n.match,token:this.terminals_[v]||v,line:n.yylineno,loc:r,expected:K})}if(B[0]instanceof Array&&1<B.length)throw Error("Parse Error: multiple actions possible at state: "+
u+", token: "+v);switch(B[0]){case 1:b.push(v);c.push(n.yytext);d.push(n.yylloc);b.push(B[1]);v=null;x?(v=x,x=null):(l=n.yyleng,f=n.yytext,g=n.yylineno,r=n.yylloc,0<h&&h--);break;case 2:K=this.productions_[B[1]][1];M.$=c[c.length-K];M._$={first_line:d[d.length-(K||1)].first_line,last_line:d[d.length-1].last_line,first_column:d[d.length-(K||1)].first_column,last_column:d[d.length-1].last_column};q&&(M._$.range=[d[d.length-(K||1)].range[0],d[d.length-1].range[1]]);u=this.performAction.apply(M,[f,l,
g,p,B[1],c,d].concat(m));if("undefined"!==typeof u)return u;K&&(b=b.slice(0,-2*K),c=c.slice(0,-1*K),d=d.slice(0,-1*K));b.push(this.productions_[B[1]][0]);c.push(M.$);d.push(M._$);B=e[b[b.length-2]][b[b.length-1]];b.push(B);break;case 3:return!0}}}},e=function(){return{EOF:1,parseError:function(a,b){if(this.yy.parser)this.yy.parser.parseError(a,b);else throw Error(a);},setInput:function(a,b){this.yy=b||this.yy||{};this._input=a;this._more=this._backtrack=this.done=!1;this.yylineno=this.yyleng=0;this.yytext=
...
d.call(arguments,0):[];return a.apply(b,c)}}(CTATFormulaActions[b],CTATFormulaActions))}a.prototype.evaluate=function(a,g,n,q){var h,m,l,r,v,B,u,z,A,E,I,w;try{z="undefined"!==typeof window&&null!==window?window:global;h=function(){var a;a=[];for(r in z)a.push(r);return a}().concat(["selection","action","input"]);A=a.split(f);m=0;for(v=A.length;m<v;m++)for(u=A[m],I=null!=(E=u.match(b))?E:[],l=0,B=I.length;l<B;l++)r=I[l],0>c.call(e,r)&&0>c.call(h,r)&&0>c.call(this.keys,r)&&CTATFormulaFunctions.assign(r,
void 0);for(r in w=this.variableTable.getTable())z[r]=w[r];return function(a,b,c){c.prototype=a.prototype;c=new c;a=a.apply(c,b);return Object(a)===a?a:c}(Function,["selection","action","input"].concat(d.call(this.keys),["return "+a.trim()]),function(){}).apply(z,[g,n,q].concat(d.call(this.values)))}catch(D){return console.log(D),null}finally{for(r in z)null!=r&&0>c.call(h,r)&&(w[r]=z[r],delete z[r])}};a.prototype.interpolateSplitPattern=/<%=|%>/;a.prototype.interpolate=function(a,b,c,d){var e,f,
...
d,f);case CTATExpressionMatcher.LT_RELATION:case CTATExpressionMatcher.GT_RELATION:if(null==g||null==d)break;return h.compareNumberOrString(g,d,f);case CTATExpressionMatcher.LTE_RELATION:case CTATExpressionMatcher.GTE_RELATION:if(null==g)return null==d;if(null!=d)return h.compareNumberOrString(g,d,f)}}catch(r){}return!1}CTATSingleMatcher.call(this,a,b);var f=CTATExpressionMatcher.EQ_RELATION,d=b,c=null,g=!1,h=this;this.getLastInput=function(){h.ctatdebug("CTATExpressionMatcher.getLastInput() returns "+
...
function(){return d};this.getBuggyMsg=function(){return r};this.getSuccessMsg=function(){return l};this.getType=function(){return q};this.getPrevNode=function(){return c};this.getNextNode=function(){return g};this.setPrevNode=function(a){c=a};this.setNextNode=function(a){g=a};this.toString=function(){var a;a="[link "+u.getUniqueID();a+=" ("+u.getPrevNode()+"-"+u.getNextNode();a+=") "+u.getType();return a+"]"};this.getTutorSAI=function(a,b){return u.getMatcher().getTutorSAI(a,b,u.getActionType())};
...
v||"undefined"===typeof v)v=[];v.push(a)};this.addPreloadedLinkMatch=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in addPreloadedLinkMatch("+a+")");if(null===r||"undefined"===typeof r)r=[];r.push(a)};this.setInterpolatedSAI=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedSAI("+a+")");a&&(E=a)};this.getInterpolatedSAI=function(){return E?E:w.getStudentSAI()};this.setInterpolatedHints=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedHints("+
a+")");null!==I&&"undefined"!==typeof I&&(I.length=0);null!==a&&"undefined"!==typeof a&&(I=a.slice(0));w.ctatdebug("CTATExampleTracerEvent --\x3e out of setInterpolatedHints")};this.setWantReportableHints=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setWantReportableHints("+a+")");A=a};this.getSuccessOrBuggyMsg=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning "+u);return u};this.getReportableHints=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning "+
...
b+", link "+d+", bestInterp.getLastMatchedLink() "+f.getLastMatchedLink());null==d&&(d=f.getLastMatchedLink());if(b){A.push(a.getStudentSAI());d!=f.getLastMatchedLink()&&(f.addLink(d),a.setResult(d.getActionType()));if(c.toString()===CTATExampleTracerLink.CORRECT_ACTION.toString()||c.toString()===CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()){t.ctatdebug("In evaluate -- in first branch doUpdate()");g.forEach(function(a){a.getLastMatchedLink().getType().toString()===CTATExampleTracerLink.BUGGY_ACTION.toString()&&
(t.ctatdebug("In evaluate -- deleting an incorrect interp"),g["delete"](a))});t.ctatdebug("In evaluate -- to call setInterpretations(), if 0 < newInterps.size "+g.size);0<g.size&&(p(g),w=f);for(var h in z)z.hasOwnProperty(h)&&delete z[h];t.ctatdebug("In evaluate -- out of DoUpdate if branch")}else{t.ctatdebug("In evaluate -- in else branch of doUpdate");a.setNumberOfInterpretations(0);for(var l in z)z.hasOwnProperty(l)&&delete z[l];g.forEach(function(a){z[a.getLastMatchedLink().getUniqueID()]=a.getLastMatchedLink()})}c.toString()===
CTATExampleTracerLink.BUGGY_ACTION.toString()&&A.splice(A.length-1,1)}a.isSolverResult()||(t.ctatdebug("In evaluate inside the solver result if condition + "+c),a.setResult(c));t.ctatdebug("In evaluate out the solver result if condition");a.setReportableLink(d);a.setReportableInterpretation(f);a.setReportableVariableTable(f.getVariableTable());a.getHintRequest()||(h=d.getTutorSAI(a.getInterpolatedSAI(),f.getVariableTable()),t.ctatdebug("In evaluate -- TUTORSAI: "+h+", studentSAI was "+a.getStudentSAI()),
a.setTutorSAI(h));h=c==CTATExampleTracerLink.CORRECT_ACTION?d.getSuccessMsg():d.getBuggyMsg();a.setSuccessOrBuggyMsg(e(h,f.getVariableTable(),a.getStudentSAI()));(b||a.getWantReportableHints())&&u.forEach(function(b){var c=b.getLastMatchedLink();c&&c.getActionType()==CTATExampleTracerLink.CORRECT_ACTION&&(b.setLatestSuccessMessage(e(c.getSuccessMsg(),b.getVariableTable(),a.getStudentSAI())),a.getHintRequest()&&a.getWantReportableHints()&&b.setLatestHints(d.interpolateHints(b.getVariableTable()),c.getHints()))});
a.getHintRequest()&&(a.setReportableHints(f.getLatestHints()),t.ctatdebug("In evaluate --\x3e after setReportableHints"));t.ctatdebug("In evaluate after fireExampleTracerEvent");t.ctatdebug("CTATExampleTracerTracer --\x3e out of finishEvaluate");return c.toString()!==CTATExampleTracerLink.BUGGY_ACTION.toString()}function d(a,b,c,d){t.ctatdebug("checkDoneStep() hintTrace "+b+", sai "+a.getStudentSAI()+", exitOnIncorrectDone "+E.exitOnIncorrectDone()+", hideButRequireSteps "+E.hideButRequireSteps()+
", nInterps "+d.size);if(!a.getStudentSAI().isDone())return t.ctatdebug("checkDoneStep() not isDone(), so setDoneStepFailed(false) & return null "),null;if(E.exitOnIncorrectDone())return a.setDoneStepFailed(!1),t.ctatdebug("checkDoneStep() exitOnIncorrectDone() with setDoneStepFailed(false), so return null "),null;if(!b&&E.hideButRequireSteps()){b=E.getDoneLinks();t.ctatdebug("checkDoneStep getDoneLinks().size "+b.size);b=b.values();for(var e;!(e=b.next()).done;)if(E.pathToLinkIsSubset(e.value,D))return a.setDoneStepFailed(!1),
1>d.size?f(a,c,CTATExampleTracerLink.CORRECT_ACTION,e.value,t.getBestInterpretation(),t.getInterpretationsInternal()):f(a,c,CTATExampleTracerLink.CORRECT_ACTION,e.value,q(d),d)}1>d.size&&a.setDoneStepFailed(!0);return null}function c(a,b,c){t.ctatdebug("CTATExampleTracerTracer --\x3e _evaluate("+a+", "+b+", "+c+")");I=a;var l=new Set,p=a.getPreloadedLinkMatches();t.ctatdebug("interps # : "+u.length);t.ctatdebug("interps: "+u);u.forEach(function(d){t.ctatdebug("In evaluate -- entered the interpretations loop");
if("undefined"===typeof p||null===p)t.ctatdebug("In evaluate -- entered if check for saiLinkMatches"),p=h(a.getStudentSAI(),a.getActor(),b,d.getVariableTable(),a),t.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");else for(var f=0;f<p.length;++f)g(a.getStudentSAI(),!0,p[f],p[f].getActor(),d.getVariableTable());t.ctatdebug("Link matches # : "+p.length);p.forEach(function(b){t.ctatdebug("In evaluate -- entered the saiLinkMatches loop + "+b);if(!E.relaxOrderConstraints()&&d.getTraversalCount(b)>=
b.getMaxTraversals())return t.ctatdebug("In evaluate -- skipped a saiLinkMatches loop \n Skipped due to max traversals"+b.getMaxTraversals()),!1;var f=d.clone();t.ctatdebug("In evaluate size of getPaths "+f.getPaths().size);f.getPaths().forEach(function(c){t.ctatdebug("In evaluate -- looping through the newInterp.getPaths()\n Examining path: "+c);!1===m(b,f,c,!1,a)&&(t.ctatdebug("In evaluate -- in if condition, checking if isPathOK"),f.getPaths()["delete"](c),t.ctatdebug("In evaluate -- out of if condition, checking if isPathOK\n Tried to delete path."))});
t.ctatdebug("In evaluate -- done looping through the newInterp.getPaths(), size "+f.getPaths().size);if(0<f.getPaths().size){t.ctatdebug("In evaluate -- if number of paths is greater than 0");f.addLink(b);t.ctatdebug("In evaluate -- new link added");if(!0===c){b.getType().toString()==CTATExampleTracerLink.BUGGY_ACTION&&d.setLatestBuggyMessage(e(b.getBuggyMsg(),d.getVariableTable(),a.getStudentSAI()));t.ctatdebug("In evaluate -- we are in the doUpdate if condition");var g=n(b,a.getStudentSAI(),f);
t.ctatdebug("In evaluate -- updatingVariable table");a.setInterpolatedSAI(f.updateVariableTable(a.getStudentSAI(),g,b));t.ctatdebug("In evaluate -- done updatingVariable table: "+f.getVariableTable())}l.add(f);t.ctatdebug("In evaluate -- added new interp")}t.ctatdebug("In evaluate -- out of saiLinkMatches loop")});t.ctatdebug("In evaluate -- out of interpretation loops")});a.setNumberOfInterpretations(l.size);t.ctatdebug("In evaluate -- number of interpretations "+l.size+" set");var r=d(a,b,c,l);
if(null!==r)return r;if(0===l.size)return t.ctatdebug("In evaluate -- if condition no new interpretations"),0!==p.length&&!0===p[0].isDone()&&a.setDoneStepFailed(!0),a.setResult(CTATExampleTracerLink.NO_MODEL),t.ctatdebug("In evaluate -- if condition no new interpretations returning false"),!1;r=q(l);t.ctatdebug("In evaluate -- just found bestInterp");var v=null;!0===a.isSolverResult()?(t.ctatdebug("In evaluate -- in if branch of isSolverResult"),v=CTATExampleTracerLink.NO_MODEL.toString().toUpperCase()===
a.getResult().toString().toUpperCase()?CTATExampleTracerLink.BUGGY_ACTION.toString():a.getResult().toString()):(t.ctatdebug("In evaluate -- in else branch of isSolverResult"),v=r.getLastMatchedLink().getType());return f(a,c,v,null,r,l)}function g(a,b,c,d,e){var f=b&&c.isCorrect();if("undefined"!=typeof D[c.getUniqueID()]||c.matchesSAIforHint(a,d,null,e))D[c.getUniqueID()]=f;t.ctatdebug("updateMatchedSelections(): link "+c.getUniqueID()+", matched "+b+", newResult "+f+", matchedSelections[link] "+
D[c.getUniqueID()])}function h(a,b,c,d,e){t.ctatdebug("CTATExampleTracerTracer --\x3e in findSAIMatchingLinks("+a+", "+b+", "+c+")");var f=[];E.getLinks().forEach(function(h){if(!1===c){t.ctatdebug("Calling link.matchesSAI() on link "+h+", sai "+a);var l=h.matchesSAI(a,b,d);t.ctatdebug("Result from link.matchesSAI() on link "+h+": "+l+", typeof "+typeof l);!0===l&&f.push(h);E.hideButRequireSteps()&&g(a,l,h,b,d)}else!0===h.matchesSAIforHint(a,b,e,d)&&f.push(h)});t.ctatdebug("CTATExampleTracerTracer --\x3e out of findSAIMatchingLinks: #matchingLinks "+
...
!0===m(c,a,b,!1,e)?(t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting first if"),l=c,h=!0):a.getPaths().forEach(function(d){!0!==h&&(t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting in inner loop"),b!==d&&(t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting second if"),!0===m(c,a,d,!1,e)&&(t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting third if"),l=
c,h=!0)))}))});if(!0===h)return t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink returning: "+l.getUniqueID()),l;t.ctatdebug("CTATExampleTracerTracer --\x3e out of getHighestUntraversedLink");return null}function B(a){return null===a||"undefined"===typeof a?!1:1>a.getMinTraversals()&&1>a.getMaxTraversals()}CTATBase.call(this,"CTATExampleTracerTracer",a);var u=null,z=null,A=null,E=a,I=null;CTATExampleTracerTracer_count++;var w=null,D={},t=this;this.goToState=function(a,b){if(!a)return!1;
...
E,b):t.advanceToNode(e,E,b)))return!0;for(var f=0;f<u.length;++f){var g=u[f];if(g!=d&&(c?t.goToDone(g,E,b):t.advanceToNode(e,E,b)))return!0}return!1};this.goToDone=function(a,b,c){return(a=a.getPathToDone(b))?c.traceLinks(a.getSortedLinks()):!1};this.advanceToNode=function(a,b,c){a=b.getBestSubpath(b.getStartNode(),a);t.ctatdebug("advanceToNode() path "+a);a&&(a=a.getSortedLinks(),results=c.traceLinks(a),t.ctatdebug("advanceToNode() results "+results))};this.getMatchedSelections=function(){return D};
this.getLastResult=function(){t.ctatdebug("CTATExampleTracerTracer --\x3e in getResult");return I};this.resetTracer=function(){t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer entering");null===u||"undefined"===typeof u?(t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"),u=[]):(t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"),u.length=0);var a=new CTATExampleTracerInterpretation(x());t.ctatdebug("CTATExampleTracerTracer tempInterp--\x3e in resetTracer tempInterp "+
a);null!==b&&"undefined"!==typeof b&&(t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer startStateVT if condition"),a.setVariableTable(b));u.push(a);w=a;if(null===z||"undefined"===typeof z)t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"),z={};else{t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of incorrectActionMatches if condition");for(var c in z)z.hasOwnProperty(c)&&delete z[c]}D={};null===A||"undefined"===typeof A?
...
0;a<u.length;a++)u[a].clearInLinks();var b=y.getStartNode();null!==b&&"undefined"!==typeof b&&null!==b.getOutLinks()&&"undefined"!==typeof b.getOutLinks()&&(a=0,b.getOutLinks().forEach(function(b){r(b,a++)}))}function r(a,b){ctatdebug("updateInLinkSubGraph("+a+", "+b+")");var c=y.getNode(a.getNextNode());if(null!==c&&"undefined"!==typeof c){c.addInLink(a);var d=0;c.getOutLinks().forEach(function(a){r(a,d++)})}}function v(a){var b=y.getNode(a.getPrevNode());if(null!==b&&"undefined"!==typeof b){var c=
-1;b.getInLinks().forEach(function(a){-1===a.getDepth()&&v(a);a.getDepth()>c&&(c=a.getDepth())});a.setDepth(c+1)}}CTATBase.call(this,"CTATExampleTracerGraph","visualdata");var B=null,u=null,z=null,A=null,E=null,I=null,w=new Set,D=new Set,t=null,C=null,F=CTATMsgType.SHOW_ALL_FEEDBACK,y=this;this.getFeedbackPolicy=function(){return F};this.setFeedbackPolicy=function(a){y.ctatdebug("Graph.setFeedbackPolicy("+a+") old policy "+F);F="false"===a?CTATMsgType.SHOW_ALL_FEEDBACK:"true"===a?CTATMsgType.HIDE_ALL_FEEDBACK:
...
u.forEach(function(a){y.ctatdebug(a.getNodeID())});y.ctatdebug("Links in the graph -- ids, from, to");z.forEach(function(a){y.ctatdebug(a)})};this.getSmallestContainingGroup=function(a){return C.getLowestLevelGroupOfLink(a)};this.redoLinkDepths=function(){l();y.getLinks().forEach(function(a){a.setDepth(-1)});y.getLinks().forEach(function(a){-1===a.getDepth()&&v(a)})};this.getGroupModel=function(){return C};this.setVisualData=function(a){y.ctatdebug("CTATExampleTracerGraph --\x3e in setVisualData");
t=a};this.getVisualData=function(){y.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning "+t);return t};this.getDoneLinks=function(){return D};(function(a,b){y.ctatdebug("CTATExampleTracerGraph --\x3e in initGraph ("+a+" , "+b);z=[];u=[];A={};if(null===C||"undefined"===typeof C)C=new CTATDefaultGroupModel,y.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");C.clear();C.setDefaultReenterable(!b);C.setGroupOrdered(C.getTopLevelGroup(),a);C.setGroupName(C.getTopLevelGroup(),
CTATExampleTracerGraph.TOP_LEVEL);B=new CTATExampleTracerTracer(y,e);y.ctatdebug("CTATExampleTracerGraph --\x3e out of initGraph")})(!a,b)};Object.defineProperty(CTATExampleTracerGraph,"TOP_LEVEL",{enumerable:!1,configurable:!1,writable:!1,value:"Top Level"});CTATExampleTracerGraph.prototype=Object.create(CTATBase.prototype);CTATExampleTracerGraph.prototype.constructor=CTATExampleTracerGraph;"undefined"!==typeof module&&(module.exports=CTATExampleTracerGraph);var CTATGraphParser=function(){function a(a){ctatdebug("processEdge()");for(var d=new CTATExampleTracerLink(null,null,null),e=g.getElementChildren(a),f,h,l,m,n,p=a=-1,w=CTATMsgType.DEFAULT_ACTOR,x=!1,t=0;t<e.length;t++){"sourceID"===g.getElementName(e[t])&&(a=parseInt(g.getNodeTextValue(e[t])),d.setPrevNode(a));"destID"===g.getElementName(e[t])&&(p=parseInt(g.getNodeTextValue(e[t])),d.setNextNode(p));if("rule"===g.getElementName(e[t]))for(var C=g.getElementChildren(e[t]),F=0;F<C.length;F++)"text"===
g.getElementName(C[F])&&d.addSkillName(g.getNodeTextValue(C[F]).toString());if("actionLabel"===g.getElementName(e[t]))for(d.setIsPreferredLink("false"!=g.getElementAttr(e[t],"preferPathMark")),d.setMinTraversalsStr(g.getElementAttr(e[t],"minTraversals")),d.setMaxTraversalsStr(g.getElementAttr(e[t],"maxTraversals")),C=g.getElementChildren(e[t]),F=0;F<C.length;F++){"uniqueID"===g.getElementName(C[F])&&(n=g.getNodeTextValue(C[F]),d.setUniqueID(parseInt(g.getNodeTextValue(C[F]))));"message"===g.getElementName(C[F])&&
...
g.getElementChildren(A[w]);break;case "node":l++;var D;D=A[w];ctatdebug("processNode("+D+")");var t=g.getElementChildren(D),C=-1;D="";for(var F=0;F<t.length;F++)switch(g.getElementName(t[F])){case "uniqueID":C=parseInt(g.getNodeTextValue(t[F]));break;case "text":D=g.getNodeTextValue(t[F])}t=new CTATExampleTracerNode(C,new Set);""!==D&&t.setNodeName(D);D=t;c.addNode(D);1==l&&(c.setStartNode(D),c.setStudentStartsHereNode(D));D.getNodeName()==r&&c.setStudentStartsHereNode(D);break;case "edge":c.addLink(a(A[w]));
break;case "EdgesGroups":I=A[w];break;case "productionRule":var y=A[w];ctatdebug("processSkill()");for(var t=D="",F=C=null,y=g.getElementChildren(y),H=0;H<y.length;H++){var G=g.getElementName(y[H]);"ruleName"==G&&(D=g.getNodeTextValue(y[H]),ctatdebug("ruleName="+D));"productionSet"==G&&(t=g.getNodeTextValue(y[H]),ctatdebug("productionSet="+t));"label"==G&&(C=g.getNodeTextValue(y[H]),ctatdebug("label="+C));"description"==G&&(F=g.getNodeTextValue(y[H]),ctatdebug("description="+F))}D&&(y=new CTATExampleTracerSkill(t,
D,CTATExampleTracerSkill.DEFAULT_P_GUESS,CTATExampleTracerSkill.DEFAULT_P_KNOWN,CTATExampleTracerSkill.DEFAULT_P_SLIP,CTATExampleTracerSkill.DEFAULT_P_LEARN,CTATExampleTracerSkill.DEFAULT_HISTORY),null!=C?y.setLabel(C):y.setLabel(D),null!=F?y.setDescription(F):y.setDescription(D+(t?" "+t:"")),x.push(y))}if(I){l=g.getElementAttr(I,"ordered");if(null===l||"undefined"==typeof isordered)l=!u;ctatdebug("parseGraph() value of isOrdered = "+l);ctatdebug("parseGraph() value of isUnordered = "+u);ctatdebug("parseGraph() typeof isOrdered: "+
typeof l);ctatdebug("parseGraph()typeof isUnordered: "+typeof u);r=I;A=l;ctatdebug("processGroup()");n=c.getGroupModel();l=n.createIdToLinkMap();n.setGroupOrdered(n.getTopLevelGroup(),A);ctatdebug("processGroup() name of group: "+n.getGroupName(n.getTopLevelGroup()));ctatdebug("processGroup() group isOrdered?: "+n.isGroupOrdered(n.getTopLevelGroup()));ctatdebug("processGroup() order of group: isOrdered= "+A);ctatdebug("processGroup() order of group: isOrdered typeof= "+typeof A);r=g.getElementChildren(r);
for(A=0;A<r.length;A++)switch(g.getElementName(r[A])){case "group":e(r[A],l);break;case "outOfOrderMessage":n.getTopLevelGroup().setDefaultBuggyMsg(g.getNodeTextValue(r[A]))}}l=f.getSkillBarVector(!1,!0);if(!l||1>l.length)ctatdebug("No existing skills. Add skills from BRD."),f.addGraphSkills(x),l=f.getSkillBarVector();h=(new CTATTutorMessageBuilder).createStateGraphMessage(q,u,p,f.isSourceFlash()?c.exitOnIncorrectDone():f.isFeedbackSuppressed(),z,E,l);c.redoLinkDepths();d=c.getExampleTracer();d.resetTracer();
...
g.length+", transaction_id "+q);for(var l=[],n=[],r=0;r<g.length;++r){var z=g[r];if(z.msg){var A=z.msgType,E=z.evt;p.ctatdebug("entering processInterfaceVariables() msgType "+A+", evt "+E);A&&(p.ctatdebug("entering processInterfaceVariables() et "+c+", tracer "+(c?c.getTracer():null)),A=A.toLowerCase(),0!==A.indexOf("correct")&&0!==A.indexOf("interfaceaction")||c.getTracer().addInterfaceVariablesFromEvent(E));if(!(A=f(z)))if(A=z,E=n,CTATConfiguration.usingFlash()){var I=void 0,w=void 0;if(!(A&&A.sai&&
(I=A.sai.getAction())&&(w=x.exec(I)))||3>w.length||1>=w[2])A=!1;else{var D=E.length-1,D=0>D?null:E[D];A.msg=A.msg.replace(I,w[1]);D&&D.timeout==w[2]?D.msgTuples.push(A):E.push({timeout:Number(w[2]),msgTuples:[A]});A=!0}}else A=!1;A||l.push(z.msg)}}p.ctatdebug("flushMessageTank(): msgBundle.length "+l.length+", delayedMsgsBundle.length "+n.length);for(r=0;r<n.length;++r)z=n[r],p.ctatdebug("processDelayedMsgs() delayedMsgs.timeout "+z.timeout+", .msgTuples.length "+z.msgTuples.length),setTimeout(d,
z.timeout,c,z.msgTuples);0<l.length&&(p.ctatdebug("Bottom of flushMessageTank(); to send bundle of length "+l.length+" via "+c),c.sendBundle(l)&&(p.ctatdebug("CTATMessageTank.shouldSaveNow() resultTypes "+m+", msgTypes "+h),(m[CTATExampleTracerLink.CORRECT_ACTION]||m[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION]||h.CorrectAction||h.InterfaceAction||h.UntutoredAction||c.isFeedbackSuppressed()&&h.AssociatedRules)&&c.isSendingSavedMsgsForRestore()&&(CTATGlobalFunctions.isInstructorMode()?p.ctatdebug("We're in reviewer mode: we shouldn't save as we go"):
...
b&&"undefined"!==typeof b?(1>b.getNCorrect()&&1>b.getNErrors()&&++B,b.incrementErrors()):(b=new CTATStep(a,CTATStep.StepResult[1]),n[a]=b,B++);x++;b.setLastResult(CTATStep.StepResult[1]);z.ctatdebug("exiting addError() error count "+x+", trial "+b)};this.addCorrect=function(a){var b=n[a];z.ctatdebug("entering addCorrect("+a+") trial "+b);b?(1>b.getNCorrect()&&1>b.getNErrors()&&(++r,1>b.getNFirstHints()&&v++),b.incrementNCorrect()):(z.ctatdebug("to call CTATStep("+a+", StepResult "+CTATStep.StepResult[3]),
b=new CTATStep(a,CTATStep.StepResult[3]),n[a]=b,r++,v++);q++;b.setLastResult(CTATStep.StepResult[3]);z.ctatdebug("exiting addCorrect() correct count "+q+", trial "+b)};this.setShowCounts=function(a){f=a};this.setCompletionStatus=function(a,b){z.ctatdebug("setCompletionStatus("+a+", "+b+")");if(CTATMsgType.CompletionValue[1]!=u||b)u=a};this.getCompletionStatus=function(){return u}};CTATProblemSummary.prototype=Object.create(CTATBase.prototype);CTATProblemSummary.prototype.constructor=CTATProblemSummary;
...
y);CTATConfiguration.set("restoreProblemUrl",c.getNodeTextValue(a[b]));break;case "session_id":S=c.getNodeTextValue(a[b]);break;case "authenticity_token":F.setAuthenticityToken(c.getNodeTextValue(a[b]))}l.ctatdebug("outputStatus "+H+", problemStateRestorer "+y);a=r;l.ctatdebug("retrieveBRD ("+a.indexOf("data:file/brd;base64,")+")");l.ctatdebug("Using network retrieval to obtain BRD ..."+a);M.retrieveXMLFile(a,c,l);y&&y.retrieveMessages(H)}function d(a,b,c,d){b=b.getTransactionID();l.ctatdebug("UntutoredAction ("+
...
E+", errorSAI "+A),E===CTATHintPolicyEnum.HINTS_UNBIASED?(1<e.length&&(e[1]=""),1<d.length&&(d[1]="")):E!==CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY&&(E===CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY?A&&A.getSelection()?(e.splice(1,0,A.getSelection()),d.splice(1,0,"PreviousFocus")):(e[1]="",d[1]=""):E===CTATHintPolicyEnum.HINTS_BIASED_BY_ALL&&A&&A.getSelection()&&(e.splice(1,0,A.getSelection()),d[1]=CTATMsgType.PREVIOUS_FOCUS.toString())),l.startSkillTransaction(),a=[],d=v.doHint(e,
...
(new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null);G.push(a);l.startWorking(1)};this.startWorking=function(b){a(b,!1)};this.stopWorking=function(b){a(b,!0)};this.goToState=function(a){v.resetTracer();return v.goToState(a,l)};this.goToStartState=function(){return l.goToState("start")};this.processXML=function(a){l.ctatdebug("processXML ()");if(null!=a){l.ctatdebug("No of children"+z.getElementChildren(a).length);var b=new CTATGraphParser,c=b.parseGraph(a,l);u=c.gr;v=
c.tracer;a=c.ssm;c=c.sgMsg;l.ctatdebug("sendStartStateMessages() nMsgs "+a.length+", outputStatus "+H);for(var d=[],e=new XMLSerializer,f=null,g=0;g<a.length;g++)if("message"==z.getElementName(a[g])){var m=e.serializeToString(a[g]),n=CTATMsgType.getMessageType(m);CTATMsgType.UNTUTORED_ACTION!=n&&CTATMsgType.INTERFACE_ACTION!=n||l.setVariablesFromSAI(a[g],z);CTATMsgType.START_STATE_END==n?(f=d,u.getFeedbackPolicy()!=CTATMsgType.SHOW_ALL_FEEDBACK&&(n=new CTATSAI("hint","SetVisible","false"),n=(new CTATTutoringServiceMessageBuilder).createInterfaceActionMessage("dummyTransactionID",
n),f.push(n)),f=m,d.push((new CTATTutoringServiceMessageBuilder).createInterfaceConfigurationEnd()),d.push((new CTATTutorMessageBuilder).createLockWidgetMsg(b.getLockWidget()))):d.push(m)}d.unshift(c);l.ctatdebug("sendStartStateMessages(): "+a.length+" elts, "+d.length+" strings, "+H);l.sendBundle(d);b=f;a:{a=[];c=u.getStartNode();d=u.getStudentStartsHereNode();if(null!==c&&null!==d&&c.getNodeID()!=d.getNodeID()){a=u.getBestSubpath(c,d);l.ctatdebug("advanceToStudentStartsHere() path "+a);if(!a)break a;
a=a.getSortedLinks();a=l.traceLinks(a);l.ctatdebug("advanceToStudentStartsHere() results "+a)}d=c=null;0<a.length&&(d=a[a.length-1],a=d.getReportableLink(),null!==a&&(c=a.getNextNode()));l.ctatdebug("advanceToStudentStartsHere() to check for TPA "+c+", "+d);h(c,v.findCurrentState(!1,!1),null,d)}a=[];b&&a.push(b);H.canRestore()||a.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null));0<a.length&&l.sendBundle(a);L=!0}l.startWorking(0)};this.addGraphSkills=function(a){l.ctatdebug("adding graph skills: "+
...
D||"undefined"===typeof D){var b=l.getProblemName();D=null===b||"undefined"===typeof b||1>b.length?new CTATProblemSummary("NoProblemDefined",null,l.isFeedbackSuppressed()):new CTATProblemSummary(b,null,l.isFeedbackSuppressed())}a&&D.setRequiredSteps(a.countStepsForScore(u));return D};this.getProblemName=function(){return t};this.getSourceID=function(){return C};this.isSourceFlash=function(){return"string"==typeof C&&C.match(/flash/i)};this.isFeedbackSuppressed=function(){return w};this.setFeedbackSuppressed=
...
a),H.setStatus(CTATProblemStateStatus.empty))};this.getFeedbackPolicy=function(){return u?u.getFeedbackPolicy():CTATMsgType.SHOW_ALL_FEEDBACK};this.getGraph=function(){return u};this.getTracer=function(){return v};this.getOutOfOrderMessage=function(){return B?B:CTATMsgType.DEFAULT_OUT_OF_ORDER_MESSAGE};this.setOutOfOrderMessage=function(a){B=a};this.getDelayedFeedback=function(){null==Q&&(Q={});return Q};this.clearDelayedFeedback=function(){Q=null};this.getQuestionFile=function(a){if(!r||a)return r;
a=r.split("/");return a[a.length-1]}};CTATExampleTracer.prototype=Object.create(CTATBase.prototype);CTATExampleTracer.prototype.constructor=CTATExampleTracer;"undefined"!==typeof module&&(module.exports=CTATExampleTracer);
