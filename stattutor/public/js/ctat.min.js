...
$jscomp.polyfill("WeakMap",function(a){function b(a){$jscomp.owns(a,f)||$jscomp.defineProperty(a,f,{value:{}})}function e(a){var c=Object[a];c&&(Object[a]=function(a){b(a);return c(a)})}if(function(){if(!a||!Object.seal)return!1;try{var b=Object.seal({}),c=Object.seal({}),d=new a([[b,2],[c,3]]);if(2!=d.get(b)||3!=d.get(c))return!1;d["delete"](b);d.set(c,4);return!d.has(b)&&4==d.get(c)}catch(n){return!1}}())return a;var f="$jscomp_hidden_"+Math.random().toString().substring(2);e("freeze");e("preventExtensions");
...
e.length;h++){var m=e[h];if(c!==c&&m.key!==m.key||c===m.key)return{id:d,list:e,index:h,entry:m}}return{id:d,list:e,index:-1,entry:void 0}},d=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},c=function(){var a={};return a.previous=a.next=a.head=a},g=0;return e},"es6-impl","es3");$jscomp.ASSUME_NO_NATIVE_SET=!1;
...
{e:13652568E5,s:13803768E5},{e:13967064E5,s:14118264E5}]},{name:"Pacific/Fiji",rules:[!1,!1,{e:12696984E5,s:12878424E5},{e:13271544E5,s:1319292E6},{e:1358604E6,s:13507416E5},{e:139005E7,s:1382796E6},{e:14215032E5,s:14148504E5}]}]};(function(a,b){"object"==typeof module&&module.exports?module.exports=b():"function"==typeof define&&define.amd?define(b):a.Spinner=b()})(this,function(){function a(a,b){var c=document.createElement(a||"div"),d;for(d in b)c[d]=b[d];return c}function b(a){for(var b=1,c=arguments.length;b<c;b++)a.appendChild(arguments[b]);return a}function e(a,b,c,d){var g=["opacity",b,~~(100*a),c,d].join("-");c=.01+c/d*100;d=Math.max(1-(1-a)/b*(100-c),a);var e=p.substring(0,p.indexOf("Animation")).toLowerCase();q[g]||
(x.insertRule("@"+(e&&"-"+e+"-"||"")+"keyframes "+g+"{0%{opacity:"+d+"}"+c+"%{opacity:"+a+"}"+(c+.01)+"%{opacity:1}"+(c+b)%100+"%{opacity:"+a+"}100%{opacity:"+d+"}}",x.cssRules.length),q[g]=1);return g}function f(a,b){var c=a.style,d,g;b=b.charAt(0).toUpperCase()+b.slice(1);if(void 0!==c[b])return b;for(g=0;g<n.length;g++)if(d=n[g]+b,void 0!==c[d])return d}function d(a,b){for(var c in b)a.style[f(a,c)||c]=b[c];return a}function c(a){for(var b=1;b<arguments.length;b++){var c=arguments[b],d;for(d in c)void 0===
a[d]&&(a[d]=c[d])}return a}function g(a,b){return"string"==typeof a?a:a[b%a.length]}function h(a){this.opts=c(a||{},h.defaults,l)}function m(){function c(b,c){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',c)}x.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,e){function h(){return d(c("group",{coordsize:l+" "+l,coordorigin:-f+" "+-f}),{width:l,height:l})}function m(a,m,l){b(n,b(d(h(),{rotation:360/e.lines*a+"deg",left:~~m}),b(d(c("roundrect",
{arcsize:e.corners}),{width:f,height:e.scale*e.width,left:e.scale*e.radius,top:-e.scale*e.width>>1,filter:l}),c("fill",{color:g(e.color,a),opacity:e.opacity}),c("stroke",{opacity:0}))))}var f=e.scale*(e.length+e.width),l=2*e.scale*f,v=-(e.width+e.length)*e.scale*2+"px",n=d(h(),{position:"absolute",top:v,left:v});if(e.shadow)for(v=1;v<=e.lines;v++)m(v,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(v=1;v<=e.lines;v++)m(v);return b(a,n)};h.prototype.opacity=
function(a,b,c,d){a=a.firstChild;d=d.shadow&&d.lines||0;a&&b+d<a.childNodes.length&&(a=(a=(a=a.childNodes[b+d])&&a.firstChild)&&a.firstChild)&&(a.opacity=c)}}var n=["webkit","Moz","ms","O"],q={},p,x,l={lines:12,length:7,width:5,radius:10,scale:1,corners:1,color:"#000",opacity:.25,rotate:0,direction:1,speed:1,trail:100,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",shadow:!1,hwaccel:!1,position:"absolute"};h.defaults={};c(h.prototype,{spin:function(b){this.stop();var c=this,g=c.opts,e=
c.el=a(null,{className:g.className});d(e,{position:g.position,width:0,zIndex:g.zIndex,left:g.left,top:g.top});b&&b.insertBefore(e,b.firstChild||null);e.setAttribute("role","progressbar");c.lines(e,c.opts);if(!p){var h=0,m=(g.lines-1)*(1-g.direction)/2,f,l=g.fps,v=l/g.speed,n=(1-g.opacity)/(v*g.trail/100),u=v/g.lines;(function y(){h++;for(var a=0;a<g.lines;a++)f=Math.max(1-(h+(g.lines-a)*u)%v*n,g.opacity),c.opacity(e,a*g.direction+m,f,g);c.timeout=c.el&&setTimeout(y,~~(1E3/l))})()}return c},stop:function(){var a=
this.el;a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0);return this},lines:function(c,h){function m(b,c){return d(a(),{position:"absolute",width:h.scale*(h.length+h.width)+"px",height:h.scale*h.width+"px",background:b,boxShadow:c,transformOrigin:"left",transform:"rotate("+~~(360/h.lines*f+h.rotate)+"deg) translate("+h.scale*h.radius+"px,0)",borderRadius:(h.corners*h.scale*h.width>>1)+"px"})}for(var f=0,l=(h.lines-1)*(1-h.direction)/2,v;f<h.lines;f++)v=d(a(),
{position:"absolute",top:1+~(h.scale*h.width/2)+"px",transform:h.hwaccel?"translate3d(0,0,0)":"",opacity:h.opacity,animation:p&&e(h.opacity,h.trail,l+f*h.direction,h.lines)+" "+1/h.speed+"s linear infinite"}),h.shadow&&b(v,d(m("#000","0 0 4px #000"),{top:"2px"})),b(c,b(v,m(g(h.color,f),"0 0 1px rgba(0,0,0,.1)")));return c},opacity:function(a,b,c){b<a.childNodes.length&&(a.childNodes[b].style.opacity=c)}});if("undefined"!==typeof document){x=function(){var c=a("style",{type:"text/css"});b(document.getElementsByTagName("head")[0],
c);return c.sheet||c.styleSheet}();var v=d(a("group"),{behavior:"url(#default#VML)"});!f(v,"transform")&&v.adj?m():p=f(v,"animation")}return h});var CTATConfig={Options:{},addProperty:function(a,b,e,f){e=e||b[0];Object.defineProperty(CTATConfig,a,{enumerable:!0,configurable:!1,writable:!f,value:e.toLowerCase()});var d={};b.forEach(function(b){d[b]=b.toLowerCase();Object.defineProperty(CTATConfig,a+"_is_"+b,{enumerable:!1,writable:!1,value:function(){return CTATConfig[this.prop].toLowerCase()==this.val}.bind({prop:a,val:d[b]})})});CTATConfig.Options[a]=d}};CTATConfig.addProperty("platform",["CTAT","Google","Undefined"],"CTAT",!0);
...
b){var d=a;if(null===d||void 0===d)d="No message!";""===d&&(d="Empty message!");if(useDebuggingBasic)d=e("Unknown","undefined",d),CTATBase.customconsole||(CTATBase.customconsole=getSafeElementById("customconsole")),CTATBase.customconsole?(CTATBase.customconsole.innerHTML+=d+"<br>",CTATBase.customconsole.scrollTop=CTATBase.customconsole.scrollHeight):console.log(d);else{null===b&&(b="UndefinedClass");null===d&&(d="No message");d=e(b,c.getName(),d);try{console.trace(d)}catch(q){}"google"==CTATConfig.platform?
Logger.log(d):(CTATBase.customconsole||(CTATBase.customconsole=getSafeElementById("customconsole")),null!==CTATBase.customconsole&&(CTATBase.customconsole.innerHTML+=d+"<br>",CTATBase.customconsole.scrollTop=CTATBase.customconsole.scrollHeight))}};this.ctatdebugObjectShallow=function(a){var b="",d;for(d in a)b+=d+", ";c.ctatdebugInternal("Object: "+b,"Global")};this.urldecode=function(a){return decodeURIComponent((a+"").replace(/\+/g,"%20"))};this.entitiesConvert=function(a){this.ctatdebug("entitiesConvert ()");
...
null):(new XMLSerializer).serializeToString(a)}};CTATXML.prototype=Object.create(CTATBase.prototype);CTATXML.prototype.constructor=CTATXML;"undefined"!==typeof module&&(module.exports=CTATXML);var CTATPackage=function(){CTATBase.call(this,"CTATPackage","packagemanager");var a=this,b=new CTATXML,e=[],f=[];this.init=function(d){a.ctatdebug("init ()");if(null==d)a.ctatdebug("Error: document root to be parsed is null.");else{a.ctatdebug("Root name: "+b.getElementName(d));d=b.getElementChildren(d);for(var c=0;c<d.length;c++){var g=d[c],h=b.getElementName(g);a.ctatdebug("Examining element: "+b.getElementName(g));if("Problems"==h){a.ctatdebug("Processing Problems ...");for(var g=b.getElementChildren(g),
f=0;f<g.length;f++){var n=g[f];a.ctatdebug("Problem ["+f+"] desc: "+b.getElementAttr(n,"description")+", interface: "+b.getElementAttr(n,"student_interface")+", brd: "+b.getElementAttr(n,"problem_file"));var q=new CTATProblem;q.setName(b.getElementAttr(n,"name"));q.setLabel(b.getElementAttr(n,"label"));q.setDescription(b.getElementAttr(n,"description"));q.setTutorFlag(b.getElementAttr(n,"tutor_flag"));q.setProblemFile(b.getElementAttr(n,"problem_file"));q.setStudentInterface(b.getElementAttr(n,"student_interface"));
a.ctatdebug("Adding problem ...");e.push(q)}}"ProblemSets"==h&&a.ctatdebug("Processing ProblemSets ...");"Assets"==h&&a.ctatdebug("Processing Assets ...")}}};this.getProblems=function(){return e};this.getProblemSets=function(){return f}};CTATPackage.prototype=Object.create(CTATBase.prototype);CTATPackage.prototype.constructor=CTATPackage;var CTATConnectionBase=function(a,b){CTATBase.call(this,"CTATConnectionBase","ctatconnection");var e=-1,f="",d="http";this.setURL=function(a){f=a};this.getURL=function(){return f};this.setID=function(a){e=a};this.getID=function(){return e};this.setSocketType=function(a){d=a};this.getSocketType=function(){return d}};CTATConnectionBase.prototype=Object.create(CTATBase.prototype);CTATConnectionBase.prototype.constructor=CTATConnectionBase;var CTATConnection=function(a){CTATConnectionBase.call(this,"CTATConnection");var b=null,e=null,f=!1,d=this,c="text/plain";d.setSocketType("http");this.setContentType=function(a){c=a};this.getContentType=function(){return c};this.setConsumed=function(a){f=a;d.ctatdebug("consumed: "+f)};this.getConsumed=function(){d.ctatdebug("consumed: "+f);return f};this.assignReceiveFunction=function(a){e.onreadystatechange=a};this.setData=function(a){b=a};this.getData=function(){return b};this.getHTTPObject=function(){return e};
...
g.message)}};d.createHTTPObject()};CTATConnection.prototype=Object.create(CTATConnectionBase.prototype);CTATConnection.prototype.constructor=CTATConnection;var CTATWSConnection=function(a){CTATConnectionBase.call(this,"CTATWSConnection");var b="",e=!1,f=this,d=null,c=[],g=!1,h=0,m=0,n=null,q=null;f.setSocketType("ws");this.setConsumed=function(a){e=a;f.ctatdebug("consumed: "+e)};this.getConsumed=function(){f.ctatdebug("consumed: "+e);return e};this.assignReceiveFunction=function(a){n=a};this.assignCloseFunction=function(a){q=a};this.setData=function(a){b=a};this.getData=function(){return b};this.init=function(){console.log("init ("+f.getURL()+"); websocket "+
d);null==d&&(d=new WebSocket(f.getURL()),d.addEventListener("open",function(a){f.ctatdebug("STATUS: open");g=!0;f.ctatdebug("Connection open, flushing outgoing queue ...");h=(new Date).getTime();if(0<c.length){for(a=0;a<c.length;a++)d.send(c[a]);c=[]}}),d.addEventListener("message",function(a){m=(new Date).getTime();f.ctatdebug("STATUS: message after "+(m-h)+" ms");f.ctatdebug("Received: "+a.data);n?n(a.data):f.ctatdebug("Error: no processing function provided")}),d.addEventListener("close",function(a){f.ctatdebug("STATUS: close; "+
(a?"code "+a.code+", reason "+a.reason:"no event"));g=!1;d.close(1E3,a?a.reason?a.reason:"received close code "+a.code:"no close event received");q&&q(a)}),d.addEventListener("error",function(a){f.ctatdebug("STATUS: error; "+(a?a.type:"no event"));g=!1;d.close(1E3,"client closing in response to error")}),console.log("init () done"))};this.send=function(){f.ctatdebug("send ()");f.init();!1===g?(f.ctatdebug("Connection not ready yet, storing ..."),c.push(b)):(f.ctatdebug("Connection ready, sending data ..."),
h=(new Date).getTime(),d.send(b))};this.getWebSocket=function(){return d};this.close=function(a,b){g=!1;q=b||q;d.close(1E3,a||"no reason")}};CTATWSConnection.prototype=Object.create(CTATConnectionBase.prototype);CTATWSConnection.prototype.constructor=CTATWSConnection;var CTATCanvasComponent=function(a){var b=this,e=[];this.addShape=function(a){e.push(a)};this.hideShape=function(a){for(var b=0;b<e.length;b++)if(e[b].getName()==a){e[b].modifyCanvasCSS("visibility","hidden");break}};this.showShape=function(a){for(var b=0;b<e.length;b++)if(e[b].getName()==a){e[b].modifyCanvasCSS("visibility","visible");break}};this.hideComponent=function(){for(var a=0;a<e.length;a++)e[a].modifyCanvasCSS("visibility","hidden")};this.showComponent=function(){for(var a=0;a<e.length;a++)e[a].modifyCanvasCSS("visibility",
...
CTATLanguagePack[b]),CTATLanguagePack[b]}else a.ctatdebug("No custom language pack defined, using default...");return"undefined"!==typeof CTATDefaultLangagePack&&CTATDefaultLangagePack[b]?(a.ctatdebug("Found tag in default language pack, returning: "+CTATDefaultLangagePack[b]),CTATDefaultLangagePack[b]):b}};CTATLanguageManager.prototype=Object.create(CTATBase.prototype);CTATLanguageManager.prototype.constructor=CTATLanguageManager;CTATLanguageManager.theSingleton=new CTATLanguageManager;var scrimIsUp=!1,errorScrim=!1,waitScrim=!0,warnScrim=!1,connectionScrim=!1,authorTimeSet=!0,inAuthorTime=!0,CTATScrim=function(){function a(){warnScrim=!1;u.scrimDown()}function b(a){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&u.scrimDownForced(),u.ctatdebug("errScrimUp ("+a+")"),!0===errorScrim?!0===g&&(g=!1,getSafeElementById(ctatcontainer).removeChild(l)):!0===warnScrim&&(g=!0),u.scrimUp(a))}function e(a,b){u.ctatdebug("makeHTMLButton ()");var c=document.createElement("input");c.type="button";
c.value=b;a?(u.ctatdebug("clickHandle!=null"),c.onclick=a):(u.ctatdebug("clickHandle==null"),c.onclick=u.defaultClickHandler);c.id=b;c.setAttribute("class","scrimButton");return c}CTATBase.call(this,"CTATScrim","__undefined__");var f="",d=!1,c=!1,g=!1,h=null,m=null,n=new CTATCanvasComponent("CTAT Scrim"),q=[],p=null,x=null,l=null,v=null,u=this;this.scrimUp=function(b){if("google"!=CTATConfig.platform)if(u.ctatdebug("scrimUp ()"),b=CTATGlobals.languageManager.filterString(b),u.ctatdebug("Message: "+
b),!0===scrimIsUp?(f=!0===waitScrim?b:f+(" \n "+b),n.removeComponent(),u.removeHTMLElements()):(f=b,scrimIsUp=!0),u.ctatdebug("drawScrim ()"),"google"==CTATConfig.platform)u.ctatdebug("This is not available for now when we're in this environment");else if($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"),$("#scrim").css("z-index",1E3),"google"!=CTATConfig.platform&&($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>'+
f+"<br><br></div></div></div>"),!0===g&&(l=e(a,"close"),$(l).appendTo("#scrimpanel")),!0===d&&(p=e(h,"yes"),$(p).appendTo("#scrimpanel")),!0===c&&(x=e(m,"no"),$(x).appendTo("#scrimpanel")),!0===waitScrim)){u.ctatdebug("Adding spinner ...");$("#scrimpanel").append("<br>");b=$('<div id="scrim_spin">');b.css("width","100%");b.css("position","relative");$("#scrimpanel").append(b);try{var v=(new Spinner({className:"scrim_spinner"})).spin();$("#scrim_spin").append(v.el)}catch(z){(z instanceof ReferenceError||
z instanceof TypeError)&&u.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.',z,typeof z)}}};this.waitScrimUp=function(){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&u.scrimDownForced(),u.ctatdebug("waitScrimUp ()"),waitScrim=!0,u.scrimUp(CTATGlobals.languageManager.getString("LOADING")))};this.nextProblemScrimUp=function(){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&u.scrimDownForced(),u.ctatdebug("nextProblemScrimUp ()"),
u.scrimUp(CTATGlobals.languageManager.getString("NEXTPROBLEM")))};this.OKScrimUp=function(a,b){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&u.scrimDownForced(),u.ctatdebug("OKScrimUp ("+a+","+b+")"),c=d=g=warnScrim=errorScrim=!1,u.scrimUp(a),v=e(b,"OK"),$(v).appendTo("#scrimpanel"))};this.confirmScrimUp=function(a,b,g){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&u.scrimDownForced(),u.ctatdebug("confirmScrimUp ("+a+","+b+","+g+")"),c=d=!0,m=g,h=b,u.scrimUp(a))};this.errorScrimUp=function(a){"google"!=
CTATConfig.platform&&(!0===scrimIsUp&&u.scrimDownForced(),!1===authorTimeSet?(u.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"),q.push("ERROR: "+a),errorScrim=!0):!1===inAuthorTime?u.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes"):(errorScrim=!0,b("ERROR: "+a)))};this.warningScrimUp=function(a){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&u.scrimDownForced(),!1===authorTimeSet?(u.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"),
q.push("WARNING: "+a),warnScrim=!0):!1===inAuthorTime?u.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes"):(warnScrim=!0,b("WARNING: "+a)))};this.handleTSDisconnect=function(){connectionScrim=!0;u.scrimUp(CTATGlobals.languageManager.getString("TUTORDISCONNECTED"))};this.removeHTMLElements=function(){};this.scrimDown=function(){"google"!=CTATConfig.platform&&(!1===scrimIsUp?u.ctatdebug("The scrim isn't up, returning"):!0===errorScrim?u.ctatdebug("The scrim is up to describe errors to the user, leave it up!"):
!0===warnScrim?u.ctatdebug("The scrim is up to display warnings to the user, leave it up!"):!0===connectionScrim?u.ctatdebug("The scrim is up for a connection issue leave it up!"):u.scrimDownForced())};this.scrimDownForced=function(){$("#scrim").remove();n.removeComponent();u.removeHTMLElements();waitScrim=scrimIsUp=!1;f=""};this.defaultClickHandler=function(){u.ctatdebug("defaultClickHandler ()");u.scrimDown()};this.setInAuthorTime=function(a){u.ctatdebug("setting inAuthorTime = "+a);authorTimeSet=
!0;inAuthorTime=a;if(!a)warnScrim=errorScrim=!1,g&&null.removeChild(l);else if(errorScrim||warnScrim)for(var c in q)b(c)};this.getInAuthorTime=function(){return inAuthorTime}};CTATScrim.prototype=Object.create(CTATBase.prototype);CTATScrim.prototype.constructor=CTATScrim;CTATGlobals.languageManager=CTATLanguageManager.theSingleton;function manualCTATScrim(){console.log("manualCTATScrim ()");CTATScrim.scrim=new CTATScrim;!1===noScrim&&CTATScrim.scrim.waitScrimUp()}window.jQuery?manualCTATScrim():alert("CTAT is unable to access JQuery, please make sure the library is referenced in your html file and loaded before CTAT.");var CTAT={ToolTutor:{interfaceMessages:[],tutorMessages:[]}};
...
CTAT.ToolTutor.sendToTutor=function(a){return window.hasOwnProperty("sendToTutor")&&"function"===typeof window.sendToTutor?window.sendToTutor(a):this.tutor?this.tutor.receiveFromInterface(a):this.tutorMessages.push(a)};var CTATGuid={s4:function(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)},guid:function(){return this.s4()+this.s4()+"-"+this.s4()+"-"+this.s4()+"-"+this.s4()+"-"+this.s4()+this.s4()+this.s4()}};var CTATConfiguration=function(){CTATBase.call(this,"CTATConfiguration","config");var a=this,b=[],e=null,f=null,d=null,c=null;this.raw={admit_code:"ies",authenticity_token:"",auth_token:"none",BehaviorRecorderMode:"AuthorTimeTutoring",class_name:"DefaultClass",curriculum_service_url:"",connection:"javascript",dataset_level_name:"none",dataset_level_type:"ProblemSet",dataset_name:"none",expire_logout_url:"none",info:"",instructor_name:"none",instrumentation_log:"off",lcId:"none",Logging:"None",log_service_url:"http://pslc-qa.andrew.cmu.edu/log/server",
log_to_disk_directory:".",problem_name:"none",problem_position:"none",problem_started_url:"none",problem_state_status:"empty",question_file:"none",refresh_session_url:"none",remoteSocketPort:"80",remoteSocketURL:"127.0.0.1",restore_problem_url:"",reuse_swf:"false",run_problem_url:"none",school_name:"none",SessionLog:"true",session_id:CTATGuid.guid(),session_timeout:"none",show_debug_traces:"false",skills:"",source_id:"PACT_CTAT_HTML5",student_interface:"none",student_problem_id:"none",study_condition_name:"none",
study_condition_type:"none",study_condition_description:"none",study_name:"Study1",target_frame:"_parent",TutorShopDeliveryMethod:"sendandload",tutoring_service_communication:"javascript",user_guid:"none",wmode:"opaque",ssl:"off",sui:"",centerTutor:!1,previewMode:!1,width:550,height:450};this.assignRawFlashVars=function(b){a.ctatdebug("assignRawFlashVars() raw['session_id'] "+a.raw.session_id+", aData['session_id'] "+b.session_id);a.raw=b;a.preParse()};this.getRawFlashVars=function(){return a.raw};
this.getSingleParameterValues=function(b){var c=[];if(!b)return c;var d=a.getRawFlashVars(),g;for(g in b){var e=b[g];d[e]&&"none"!=d[e]&&c.push(d[e])}return c};this.usingFlash=function(){return this.getSingleParameterValues(["student_interface","swf_name"]).some(function(a){return 0<=a.search(/[.]swf$/i)})};this.generateDefaultConfiguration=function(b){var c={},d=0;if(b)for(var g in b)c[g]=b[g],d++;a.ctatdebug("generateDefaultConfiguration() nDefaults "+d+", result['session_id'] "+c.session_id);d=
b=null;if(window&&window.frameElement&&(d=window.frameElement.getAttribute("data-params"))){b=jQuery.parseJSON(d);for(var e in b)c[e]=CTATGlobals.EncodedParams[e]?decodeURIComponent(b[e].replace(/\+/g,"%20")):b[e]}if(null===b)for(e=$('object param[name="flashvars"]'),a.ctatdebug("generateDefaultConfiguration() objs "+e),b=0;b<e.length;++b)if(d=$(e[b]).attr("value"),a.ctatdebug("generateDefaultConfiguration() fVarsAsString "+d),d&&(d=parseQueryStringArgs(d))&&d.question_file)for(var f in d)c[f]=d[f];
ctatdebug("tutorPrep ("+c+")");f={};if(null===c||void 0===c)ctatdebug("tutorPrep(): Internal error: null argument passed");else{ctatdebug("parseQueryString ()");e=location.search;ctatdebug("Query String: "+e);b="?"==e.charAt(0)?e.substring(1):e;e={};if(b)for(b=b.split("&"),d=0;d<b.length;d++){g=b[d].split("=");ctatdebug("Setting flashvar "+g[0]+", to: "+decodeURIComponent(g[1].replace(/\+/g," ")));e[decodeURIComponent(g[0])]="";for(var x=1;x<g.length;x++)e[decodeURIComponent(g[0])]+=(1<x?"=":"")+
decodeURIComponent(g[x].replace(/\+/g," "));ctatdebug("Decoded args: "+e[decodeURIComponent(g[0])])}null!==e&&(ctatdebug("tutorPrep(): Assigning parsed arguments ..."),f=e);e=!1;for(var l in f)if(f.hasOwnProperty(l))switch(ctatdebug("Processing external FlashVar "+l+"("+f[l]+")"),l){case "GENERATED":"on"==f[l]&&(c.session_id=CTATGuid.guid(),e=!0);break;case "BRD":c.question_file=f[l];break;case "BRMODE":c.BehaviorRecorderMode=f[l];break;case "PROBLEM":c.problem_name=f[l];break;case "DATASET":c.dataset_name=
f[l];break;case "LEVEL1":c.dataset_level_name1=f[l];break;case "TYPE1":c.dataset_level_type1=f[l];break;case "LEVEL2":c.dataset_level_name2=f[l];break;case "TYPE2":c.dataset_level_type2=f[l];break;case "LEVEL3":c.dataset_level_name3=f[l];break;case "TYPE3":c.dataset_level_type3=f[l];break;case "LEVEL4":c.dataset_level_name4=f[l];break;case "TYPE4":c.dataset_level_type4=f[l];break;case "USER":c.user_guid=f[l];break;case "SESSION":!1===e&&(c.session_id=f[l]);break;case "SOURCE":c.source_id=f[l];break;
case "LOGTYPE":c.Logging=f[l];break;case "PORT":c.remoteSocketPort=f[l];break;case "REMOTEURL":c.remoteSocketURL=f[l];break;case "DISKDIR":c.log_to_disk_directory=f[l];break;case "log_service_url":c.log_service_url=f[l];break;case "URL":c.log_service_url=f[l];break;case "LOGURL":c.log_service_url=f[l];break;case "CONNECTION":c.tutoring_service_communication=f[l];break;case "SUI":c.sui=f[l];break;case "VAR1":c.var1=f[l];break;case "VAL1":c.val1=f[l];break;case "VAR2":c.var2=f[l];break;case "VAL2":c.val2=
f[l];break;case "VAR3":c.var3=f[l];break;case "VAL3":c.val3=f[l];break;case "VAR4":c.var4=f[l];break;case "VAL4":c.val4=f[l];break;case "SLOG":case "SessionLog":c.SessionLog=f[l];break;case "KEYBOARDGROUP":"Disabled"==f[l]&&(c.keyboard="disabled");"Auto"==f[l]&&(c.keyboard="auto");"On"==f[l]&&(c.keyboard="on");break;default:c[l]=f[l]}}return c};this.getCustomFields=function(){return b};this.setTimeZone=function(b){a.ctatdebug("setTimeZone ("+b+")");null==b||""==b||void 0==b?(b=jstz.determine(),a.ctatdebug("Assigning detected timezone: "+
...
CTATLMS.init.XBlock=function(){var a=document.referrer?(new URL(document.referrer)).origin:"";CTATLMS.identifier="XBlock";CTATLMS.initLMSConnection=function(){};CTATLMS.closeLMSConnection=function(){};CTATLMS.commit=function(){};CTATLMS.setValue=function(a,e){};CTATLMS.getValue=function(a){return null};CTATLMS.logEvent=function(b){parent.postMessage({event_type:"ctat_log",action:"logevent",data:b},a)};CTATLMS.saveProblemState=function(b){parent.postMessage({action:"save_problem_state",input:window.btoa(b.problem_state)},
a)};CTATLMS.getProblemState=function(a){return a(window.atob(CTATConfiguration.get("saveandrestore")))};CTATLMS.gradeStudent=function(b,e){parent.postMessage({action:"grade",input:{value:b,max:e}},a)};CTATLMS.logEvent=function(a){parent.postMessage({action:"log",input:a})};CTATLMS.processProblemSummary=function(a){}};CTATLMS.is.Authoring=function(){return window.location.search&&/[?&;]mode=AUTH(ORING)?/i.test(window.location.search)};
CTATLMS.is.OLI=function(){return window.location.search&&/[?&;]mode=OLI/i.test(window.location.search)||CTATTarget&&"OLI"==CTATTarget};CTATLMS.is.TutorShop=function(){return"TutorShop"==CTATConfiguration.get("LMS")};
...
CTATLMS.is.Assistments=function(){return CTATTarget&&"ASSISTMENTS"==CTATTarget};var bundleFormatter="",inBundle=!1,useBundling=!1,useOLIEncoding=!1,CTATCommLibrary=function(a,b){CTATBase.call(this,"CTATCommLibrary",a);var e=authenticityToken="",f=0,d=[],c=a?a:null,g=null==b?!0:b,h=!0,m=null,n=this,q="http",p="ERROR_CONN_TS",x="";this.setUseCommSettings=function(a){h=a};this.getUseCommSettings=function(){return h};this.setConnectionRefusedMessage=function(a){p=a};this.setSocketType=function(a){q=a};this.getSocketType=function(){return q};this.assignHandler=function(a){c=a};this.assignMessageListener=
function(a){m=a};this.encodeVariables=function(a){n.ctatdebug("encodeVariables ()");for(var b="",c=0;c<a.length;c++){var d=a[c];0<c&&(b+="&");b+=d.name;b+="=";b+=encodeURIComponent(d.value)}return b};this.encodeVariablesOLI=function(a){n.ctatdebug("encodeVariablesOLI ()");for(var b="",c=0;c<a.length;c++){var d=a[c];0<c&&(b+="&");b+=d.name;b+="=";b+=encodeURIComponent(d.value)}return b};this.createConnection=function(a,b){n.ctatdebug("createConnection ()");if(!b)return new CTATConnection(a);flashVars.getRawFlashVars();
var c;if("websocket"==n.getSocketType())return c=this.findWSConnection(b),c||(c=new CTATWSConnection(a),c.setID(f),c.setURL(b),c.assignReceiveFunction(this.processWSReply),c.assignCloseFunction(this.processWSClose),d.push(c),f++),c;c=new CTATConnection(a);c.setID(f);c.setURL(b);c.assignReceiveFunction(this.processReply);d.push(c);f++;return c};this.findWSConnection=function(a){for(var b=0;b<d.length;b++){var c=d[b];if("ws"==c.getSocketType()&&c.getURL()==a)return c}return null};this.startBundle=function(){n.ctatdebug("startBundle ()");
!1===useBundling?this.ctatdebug("Not using bundling, bump"):(bundleFormatter='<?xml version="1.0" encoding="UTF-8"?><message><verb/><properties><MessageType>MessageBundle</MessageType><messages>',inBundle=!0)};this.endBundle=function(){n.ctatdebug("endBundle ()");!1===useBundling?n.ctatdebug("Not using bundling, bump"):(inBundle=!1,bundleFormatter+="</messages></properties></message>",n.sendXML(bundleFormatter))};this.setFixedURL=function(a){e=a};this.getURL=function(){n.ctatdebug("getURL ()");if(""!==
e)return n.ctatdebug("Returning fixedURL: "+e),e;var a=flashVars.getRawFlashVars(),b="http://";"https"==n.getSocketType()&&(b="https://");b=b+a.remoteSocketURL+":"+a.remoteSocketPort;-1!=a.remoteSocketURL.indexOf("http")&&(b=a.remoteSocketURL+":"+a.remoteSocketPort);return b};this.sendXML=function(a){n.ctatdebug("Sending: "+a);n.ctatdebug("sendXML ("+a+")");if(!0===useBundling&&!0===inBundle)n.ctatdebug("Bundling ..."),bundleFormatter+=a;else{bundleFormatter=a;flashVars.getRawFlashVars();a=this.getURL();
var b=bundleFormatter;-1==bundleFormatter.indexOf("<?xml")&&(b='<?xml version="1.0" encoding="UTF-8"?>'+bundleFormatter);!0===this.getUseCommSettings()?"javascript"==n.getSocketType()?CTAT.ToolTutor.sendToTutor(b):this.send_post(a,b):this.send_post(a,b)}};this.sendXMLNoBundle=function(a){n.ctatdebug("sendXMLNoBundle ("+a+")");bundleFormatter=a;var b=this.getURL(),c=a;-1==a.indexOf("<?xml")&&(c='<?xml version="1.0" encoding="UTF-8"?>'+a);flashVars.getRawFlashVars();!0===this.getUseCommSettings()?"javascript"==
n.getSocketType()?CTAT.ToolTutor.sendToTutor(c):this.send_post(b,c):this.send_post(b,c)};this.sendXMLURL=function(a,b){n.ctatdebug("sendXMLURL ("+b+")");var c=a;-1==a.indexOf("<?xml")&&(c='<?xml version="1.0" encoding="UTF-8"?>'+a);flashVars.getRawFlashVars();n.ctatdebug("Sending: "+c);!0===this.getUseCommSettings()?"javascript"==n.getSocketType()?CTAT.ToolTutor.sendToTutor(c):this.send_post(b,c):this.send_post(b,c)};this.sendURLVariables=function(a,b){this.ctatdebug("sendURLVariables ("+a+")");this.send_post_variables(a,
b)};this.send=function(a){n.ctatdebug("send ("+a+")");if(!0===CTATGlobals.CommDisabled)n.ctatdebug("Communications globally disabled, please check your settings");else{var b=new CTATConnection(null);b.setID(f);f++;if(null===b.getHTTPObject())return alert("Cannot create XMLHTTP instance"),!1;d.push(b);b.setURL(a);b.assignReceiveFunction(this.processReply);try{b.getHTTPObject().open("GET",a,!0)}catch(u){this.ctatdebug("Error in newConnection.httpObject.open: "+u.message);return}try{b.init()}catch(u){this.ctatdebug("Error in newConnection.init: "+
u.message);return}try{b.getHTTPObject().send(null)}catch(u){this.ctatdebug("Error in newConnection.httpObject.send: "+u.message)}}};this.send_post_variables=function(a,b){n.ctatdebug("send_post_variables ("+a+")");flashVars.getRawFlashVars();n.getSocketType();var c;c=!1===useOLIEncoding?this.encodeVariables(b):this.encodeVariablesOLI(b);this.ctatdebug("Sending: "+c);if(!0===CTATGlobals.CommDisabled)n.ctatdebug("Communications globally disabled, please check your settings");else{var e=n.createConnection(CTATConfiguration.getRawFlashVars(),
a);e.setContentType("application/x-www-form-urlencoded");f++;d.push(e);n.ctatdebug(c);null!==m&&m.processOutgoing(c);e.setURL(a);e.setData(c);e.assignReceiveFunction(this.processReply);e.send()}};this.send_post=function(a,b){var c;n.ctatdebug("send_post ("+a+")");if(!0===CTATGlobals.CommDisabled)n.ctatdebug("Communications globally disabled, please check your settings");else{n.ctatdebug("Outoing on wire: "+b);c=flashVars.getRawFlashVars();var d=a;"websocket"==n.getSocketType()?(console.log("opening websocket connection"),
d=a.replace("http:","ws:"),"https:"===window.top.location.protocol&&(console.log("We're embedded in an https window, using wss..."),d=d.replace("ws:","wss:")),c=n.createConnection(c,d),c.setData(b),n.ctatdebug(b)):(c=n.createConnection(c,d),c.setData(b));null!==m&&m.processOutgoing(b);c.send()}};this.processReply=function(a){n.ctatdebug("processReply ("+d.length+","+a+")");var b=0,e;a=[];var f;for(f=0;f<d.length;f++){var h=d[f],l=h.getHTTPObject();n.ctatdebug("Testing connection entry "+f+", readyState: "+
l.readyState+", consumed: "+h.getConsumed()+", status: "+l.status);4==l.readyState&&!1===h.getConsumed()?(n.ctatdebug("Investigating request response: "+b+" -> "+l.status+", for: "+h.getURL()),e=!1,0===l.status&&(e=!0,n.ctatdebug("Received message (status 0): ("+l.responseText+"), status: "+l.status),g&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(p))),408==l.status&&(e=!0,n.ctatdebug("Received message (status 408): "+l.responseText),g&&CTATScrim.scrim.scrimDown()),502==l.status&&
(e=!0,n.ctatdebug("Received message (status 502): "+l.responseText),g&&CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(ERROR_502))),200==l.status?(e=!0,n.ctatdebug("Processing 200 response ..."),null!==c?(a.push(l.responseText),null!==m&&m.processIncoming(l.responseText)):n.ctatdebug("Error: httphandler is null, can't process response!")):c&&c.processError&&(e=!0,n.ctatdebug("Processing non-200 response, status "+l.status),c.processError(l.status,l.responseText)),!1===e&&n.ctatdebug("Error: status not handled for: "+
l.status),n.ctatdebug("Marking connection as consumed ..."),h.setConsumed(!0)):(0===l.readyState&&n.ctatdebug("Received message (status 0, request not initialized)"),1===l.readyState&&n.ctatdebug("Received message (status 1, server connection established)"),2===l.readyState&&n.ctatdebug("Received message (status 2, request received)"),3===l.readyState&&n.ctatdebug("Received message (status 3, processing request)"));b++}n.cleanup();for(b=0;b<a.length;b++)n.ctatdebug("Processing incoming message: "+
b),e=a[b],-1!=e.indexOf("status=success")?n.ctatdebug("Info: logging success message received, not propagating to message handler"):(n.ctatdebug("Processing incoming message: "+e),c.processMessage(e))};this.processWSReply=function(a){n.ctatdebug("processWSReply() length "+(null===a?null:a.toString().length));"string"==typeof a&&(null!==m&&m.processIncoming(a),-1!=a.indexOf("status=success")?n.ctatdebug("processWSReply() logging success message received, not propagating to message handler: "+a):(n.ctatdebug("Processing incoming message: "+
a),c.processMessage(a)))};this.processWSClose=function(a){n.ctatdebug("processWSClose("+a+")");a instanceof CloseEvent&&n.ctatdebug("CloseEvent: code "+a.code+", reason "+a.reason+", wasClean "+a.wasClean);CTATLMS.is.Authoring()?CTATScrim.scrim.scrimUp(CTATGlobals.languageManager.filterString("AUTHORPLEASECLOSE")):CTATScrim.scrim.handleTSDisconnect()};this.cleanup=function(){n.ctatdebug("cleanup ()");for(var a=0,b,c=!1;!1===c;)b=this.checkEntries(),!1===b?c=!0:a++;n.ctatdebug("Removed "+a+" entries")};
this.checkEntries=function(){n.ctatdebug("checkEntries ("+d.length+")");var a=0,b;for(b=0;b<d.length;b++){var c=d[b];if(!0===c.getConsumed())return n.ctatdebug("Removing : "+c.getID()),d.splice(a,1),!0;var e=c.getHTTPObject();n.ctatdebug("Check, readyState: "+e.readyState+", consumed: "+c.getConsumed());a++}return!1};this.retrieveXMLFile=function(a,b,c){n.ctatdebug("retrieveXMLFile ("+a+")");if(location.href){if(n.ctatdebug("Location: "),-1!=location.href.toLowerCase().indexOf("file://")){a=(new CTATTutorMessageBuilder).createErrorMessage("",
"You have loaded your tutor directly from the file system, please do not load a tutor using file://. Please use the CTAT Authoring Tools to launch the html file.");n.ctatdebug("onerror GET for xmlFile "+a);CTAT.ToolTutor.sendToInterface(a,!0);return}}else n.ctatdebug("We can't check location.href in the current configuration");if(-1!=a.toLowerCase().indexOf("file://"))a=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+a+" - You are trying to use the file:// protocol, which is not allowed in this browser."),
n.ctatdebug("onerror GET for xmlFile "+a),CTAT.ToolTutor.sendToInterface(a,!0);else{x=a;var d=(new CTATConnection).getHTTPObject();d.onreadystatechange=function(){n.ctatdebug("onready... GET for xmlFile xmlhttp.readyState "+d.readyState+", .status "+d.status+", parser "+b);if(4==d.readyState){if(200==d.status){var a;d.responseXML?(n.ctatdebug("parsing brd xml using something else"),a=d.responseXML.documentElement):(n.ctatdebug("parsing brd xml using node"),a=(b=new CTATXML).parseXML(d.responseText));
if(null===a){a=(new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile "+x);n.ctatdebug("Error parsing xmlFile "+x+": "+a);CTAT.ToolTutor.sendToInterface(a,!0);return}c.processXML(a)}404==d.status&&(a=(new CTATTutorMessageBuilder).createErrorMessage("Unable to download file","("+x+") not found"),n.ctatdebug("Error loading xmlFile "+x+": "+a),CTAT.ToolTutor.sendToInterface(a,!0))}};d.onerror=function(){var a=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+x+" - Either you are trying to use the  file:// protocol, there is a firewall between the tutor and BRD, or the BRD is on a different domain and permission to retrieve data from that server is denied.");
n.ctatdebug("onerror GET for xmlFile "+a);CTAT.ToolTutor.sendToInterface(a,!0);c.processXML(null)};d.open("GET",a,!0);d.setRequestHeader("Content-type","text/plain");d.send()}};this.retrieveJSONFile=function(a,b){n.ctatdebug("retrieveJSONFile ("+a+")");if(location.href){if(n.ctatdebug("Location: "),-1!=location.href.toLowerCase().indexOf("file://")){var c=(new CTATTutorMessageBuilder).createErrorMessage("","You have loaded your tutor directly from the file system, please do not load a tutor using file://. Please use the CTAT Authoring Tools to launch the html file.");
n.ctatdebug("onerror GET for xmlFile "+c);CTAT.ToolTutor.sendToInterface(c,!0);return}}else n.ctatdebug("We can't check location.href in the current configuration");if(-1!=a.toLowerCase().indexOf("file://"))c=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+a+" - You are trying to use the file:// protocol, which is not allowed in this browser."),n.ctatdebug("onerror GET for xmlFile "+c),CTAT.ToolTutor.sendToInterface(c,!0);else{x=a;var d=(new CTATConnection).getHTTPObject();
d.onreadystatechange=function(){4==d.readyState&&200==d.status&&(n.ctatdebug("Successfully retrieved file: "+a),b(JSON.parse(d.responseText)))};d.onerror=function(){var a=(new CTATTutorMessageBuilder).createErrorMessage("","Unable to load: "+x+" - Either you are trying to use the  file:// protocol, there is a firewall between the tutor and BRD, or the BRD is on a different domain and permission to retrieve data from that server is denied.");n.ctatdebug("onerror GET for xmlFile "+a);CTAT.ToolTutor.sendToInterface(a,
!0)};d.open("GET",a,!0);d.setRequestHeader("Content-type","text/plain");d.send()}};this.retrieveFile=function(a,b){n.ctatdebug("retrieveFile ("+a+")");if(location.href){if(n.ctatdebug("Location: "),-1!=location.href.toLowerCase().indexOf("file://")){var c=(new CTATTutorMessageBuilder).createErrorMessage("","You have loaded your tutor directly from the file system, please do not load a tutor using file://. Please use the CTAT Authoring Tools to launch the html file.");n.ctatdebug("onerror GET for xmlFile "+
...
"</context>"):d+"<context />";d+="</problem>";for(c=0;c<b.length;c++)d+="</level>";e+=d+"</dataset>"}c="";b=flashVars.getConditionNames();d=flashVars.getConditionTypes();f=flashVars.getConditionDescriptions();if(0<b.length)for(m=0;m<b.length;m++)c+="<condition><name>"+b[m]+"</name>",c+=""==d[m]?"":"<type>"+d[m]+"</type>",c+=""==f[m]?"":"<desc>"+f[m]+"</desc>",c+="</condition>";var e=e+c,c=flashVars.getCustomFields(),n;for(n in c)c.hasOwnProperty(n)&&(e+="<custom_field>",e+="<name>"+n+"</name>",e+=
"<value>"+c[n]+"</value>",e+="</custom_field>");e+="</context_message>";a.ctatdebug("messageString = "+e);return e};this.createSemanticEventToolMessage=function(f,d,c,g,h,m){a.ctatdebug("createSemanticEventToolMessage("+m+")");var n=new Date;flashVars.getRawFlashVars();var q='<tool_message context_message_id="'+this.getContextName()+'">';h||(q+=this.makeMetaElement(n));d='<semantic_event transaction_id="'+d+'" name="'+c+'"';""!=g&&(d+=' subtype="'+g+'"');void 0!=m&&""!=m&&(d+=' trigger="'+m+'"');
q+=d+"/>";g="<event_descriptor>";f=f.toXMLString(!0);q+=g+f+"</event_descriptor>";q+=this.createCustomFields(b,e);q+="</tool_message>";a.ctatdebug("messageString = "+q);return q};this.createUIEventToolMessage=function(f,d,c,g){a.ctatdebug("createUIEventToolMessage()");var h=new Date;flashVars.getRawFlashVars();var m='<tool_message context_message_id="'+this.getContextName()+'">';g||(m+=this.makeMetaElement(h));m+='<ui_event name="'+d+'">'+c+"</ui_event>";f="<event_descriptor>"+f.toSerializedString();
m=m+(f+"</event_descriptor>")+this.createCustomFields(b,e);m+="</tool_message>";a.ctatdebug("messageString = "+m);return m};this.createTutorMessage=function(f,d,c,g,h,m,n,q){a.ctatdebug("createTutorMessage()");var p=new Date;flashVars.getRawFlashVars();var x='<tutor_message context_message_id="'+this.getContextName()+'">';q||(x+=this.makeMetaElement(p));d='<semantic_event transaction_id="'+d+'" name="'+c+'"';""!==m&&(d+=' subtype="'+m+'"');x+=d+"/>";f="<event_descriptor>"+f.toXMLString(!0);x+=f+"</event_descriptor>";
f="<action_evaluation ";g.hasClassification()&&null!=g.getAttributeString()&&(f+=g.getAttributeString());f+=">"+g.getEvaluation()+"</action_evaluation>";x+=f;""!=h&&(x+="<tutor_advice>"+h+"</tutor_advice>");null!=n&&(a.ctatdebug("Adding skills to log message ..."),x+=n.toLogString());x+=this.createCustomFields(b,e);x+="</tutor_message>";a.ctatdebug("messageString = "+x);return x};this.createGenericMessage=function(b,d){a.ctatdebug("createGenericMessage()");flashVars.getRawFlashVars();var c='<message context_message_id="'+
...
function(){return b};this.getCustomFieldValues=function(){return e}};CTATLogMessageBuilder.prototype=Object.create(CTATBase.prototype);CTATLogMessageBuilder.prototype.constructor=CTATLogMessageBuilder;CTATLogMessageBuilder.contextGUID="";CTATLogMessageBuilder.commLogMessageBuilder=null;var CTATCustomLogElementObject=function(){this.reset=function(){};this.addCustomLogElement=function(a,b){customElementsNames.push(a);customElementsTypes.push(a)};this.getCustomElementNames=function(){return customElementsNames};this.getCustomElementTypes=function(){return customElementsTypes}};var loggingDisabled=!1,CTATLoggingLibrary=function(a){CTATBase.call(this,"CTATLoggingLibrary","logginglibrary");var b=this,e=!0,f=!1,d=!1,c=[],g="undefined",h="undefined",m="undefined",n="undefined",q="undefined",p="undefined",x="undefined",l="undefined",v="UnassignedDataset",u="UnassignedLevelName",B="UnassignedLevelType",t=null,z=null;window.hasOwnProperty("X2JS")?z=new X2JS:console.log("WARNING: X2JS is unavailable!");l=CTATGuid.guid();void 0!=a&&null!=a?(f=a,0==f&&(CTATLogMessageBuilder.commLogMessageBuilder=
new CTATLogMessageBuilder)):CTATLogMessageBuilder.commLogMessageBuilder=new CTATLogMessageBuilder;var A=new CTATCommLibrary;A.setName("commLoggingLibrary");A.setUseCommSettings(!1);A.setConnectionRefusedMessage("ERROR_CONN_LS");A.assignHandler(this);this.assignLogListener=function(a){t=a};this.generateSession=function(){c.session_id="ctat_session_"+CTATGuid.guid();return c.session_id};this.setLogClassName=function(a){g=a};this.setDatasetName=function(a){v=a};this.setDatasetLevelName=function(a){u=
a};this.setDatasetLevelType=function(a){B=a};this.setSchool=function(a){h=a};this.setPeriod=function(a){m=a};this.setDescription=function(a){n=a};this.setInstructor=function(a){q=a};this.setProblemName=function(a){p=a};this.setProblemContext=function(a){x=a};this.setUserID=function(a){l=a};this.getLoggingCommLibrary=function(){return A};this.setUseSessionLog=function(a){e=a};this.setLoggingURL=function(a){b.getLoggingCommLibrary().setFixedURL(a)};this.setupExternalLibraryUsage=function(){b.ctatdebug("setupExternalLibraryUsage ()");
c.class_name=g;c.school_name=h;c.period_name=m;c.class_description=n;c.instructor_name=q;c.dataset_name=v;c.problem_name=p;c.problem_context=x;c.auth_token="";c.user_guid=l;c.session_id="ctat_session_"+CTATGuid.guid();c.source_id="tutor";c.dataset_level_name1=u;c.dataset_level_type1=B;flashVars=new CTATFlashVars;flashVars.assignRawFlashVars(c)};this.initCheck=function(){b.ctatdebug("initCheck ()");0==f&&0==d&&(b.setupExternalLibraryUsage(),d=!0)};this.sendMessage=function(a){b.ctatdebug("sendMessage ()");
b.ctatdebug("Raw log message to send: "+a);this.sendMessageInternal(a);null!=t&&t(a)};this.sendMessageInternal=function(a){b.ctatdebug("sendMessageInternal ()");if(!0===loggingDisabled)b.ctatdebug("Warning: loggingDisabled==true");else{if(1==f){var c=flashVars.getRawFlashVars();if(null!=c){if("ClientToService"!=c.Logging&&"ClientToLogServer"!=c.Logging){b.ctatdebug("Logging is turned off, as per: "+c.Logging);return}"ClientToService"!=c.Logging||"http"!=c.tutoring_service_communication&&"https"!=
c.tutoring_service_communication||(b.setLoggingURL(c.remoteSocketURL+":"+c.remoteSocketPort),b.ctatdebug("Reconfigured the logging url to be: "+c.remoteSocketURL+":"+c.remoteSocketPort))}}b.ctatdebug("Pre encoded log message: "+a);0>a.indexOf("<log_session_start")&&(a=CTATLogMessageBuilder.commLogMessageBuilder.wrapForOLI('<?xml version="1.0" encoding="UTF-8"?><tutor_related_message_sequence version_number="4">'+a+"</tutor_related_message_sequence>"));b.ctatdebug("Encoded log message: "+a);1==f&&
("edx://localhost"==CTATConfiguration.get("log_service_url")&&z?(console.log("Logging JSON message to LMS: "+JSON.stringify(z.xml_str2json(a))),CTATLMS.logEvent(JSON.stringify(z.xml_str2json(a)))):A.sendXMLNoBundle(a))}};this.startProblem=function(){b.ctatdebug("startProblem ()");b.initCheck();b.logSessionStart();b.sendMessage(CTATLogMessageBuilder.commLogMessageBuilder.createContextMessage(!0))};this.logSessionStart=function(){b.ctatdebug("logSessionStart ()");b.initCheck();var a=flashVars.getRawFlashVars();
void 0!=a.SessionLog&&("true"==a.SessionLog?(b.ctatdebug("Turning SessionLog on ..."),e=!0):(b.ctatdebug("Turning SessionLog off ..."),e=!1));!0===e&&this.sendMessage(CTATLogMessageBuilder.commLogMessageBuilder.createLogSessionStart())};this.logSemanticEvent=function(a,c,d,e,g,h,f){b.ctatdebug("logSemanticEvent ("+f+")");b.initCheck();var m=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(g,h);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tool_event_time",
CTATLogMessageBuilder.commLogMessageBuilder.formatTimeStamp(m)+" UTC");a=CTATLogMessageBuilder.commLogMessageBuilder.createSemanticEventToolMessage(c,a,d,e,!0,f);this.sendMessage(a)};this.logTutorResponse=function(a,c,d,e,g,h,f,m,v){b.ctatdebug("logTutorResponse ()");b.initCheck();var l=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(m,v);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tutor_event_time",
CTATLogMessageBuilder.commLogMessageBuilder.formatTimeStamp(l)+" UTC");b.ctatdebug("Formatting feedback ...");void 0!=h&&null!=h?h="<![CDATA["+CTATGlobals.languageManager.filterString(h)+"]]\x3e":(b.ctatdebug("No feedback provided, using empty string"),h="");b.ctatdebug("Creating tutor message ...");a=CTATLogMessageBuilder.commLogMessageBuilder.createTutorMessage(c,a,d,g,h,e,f,!0);this.sendMessage(a)};this.processMessage=function(a){b.ctatdebug("processMessage ()");b.ctatdebug("Response from log server: "+
a)};this.start=function(){b.ctatdebug("start ()");var a=b.generateSession();b.startProblem();return a};this.logInterfaceAttempt=function(a,c,d,e){b.ctatdebug("logInterfaceAttempt ()");e=CTATGuid.guid();a=new CTATSAI(a,c,d);a.setInput(d);this.logSemanticEvent(e,a,"ATTEMPT","");return e};this.logInterfaceAttemptSAI=function(a,c){b.ctatdebug("logInterfaceAttemptSAI ()");var d=CTATGuid.guid();this.logSemanticEvent(d,a,"ATTEMPT","");return d};this.endSession=function(){this.generateSession()}};
...
b);return b};this.addSelection=function(a,b){var c=new CTATArgument;c.setValue(a);void 0!=b&&null!=b&&c.setType(b);g.push(c)};this.addAction=function(a){h.push(a)};this.checkDefaultArgument=function(){p.ctatdebug("checkDefaultArgument ()");if(0===m.length){p.ctatdebug("Adding default argument ...");var a=new CTATArgument;m.push(a)}};this.setArgument=function(a,b){p.checkDefaultArgument();for(var c=m.length;c<=a;++c)m.push(new CTATArgument);c=m[a];c.setValue(b);return c};this.addArgument=function(a,
b,c){this.ctatdebug("addArgument ("+a+","+b+","+c+")");var d=new CTATArgument;d.setValue(a);d.setType(b);d.setFormat(c);m.push(d);return d};this.addExistingArgument=function(a){m.push(a);return a};this.setSAI=function(a,b,d,e,g){p.setSelection(Array.isArray(a)?0<a.length?a[0]:"":a);p.setAction(Array.isArray(b)?0<b.length?b[0]:"":b);p.setInput(Array.isArray(d)?0<d.length?d[0]:"":d);p.setType(e);c=g};this.setInput=function(a){p.ctatdebug("setInput("+a+")");p.checkDefaultArgument();p.getArgument(0).setValue(a)};
...
Array.isArray(a)?a.slice():[String(a)]};this.getActionArray=function(){return h};this.appendToInputArray=function(a){p.ctatdebug("appendToInputArray ("+a+")");null==a?p.addArgument("","String","text"):p.addArgument(a,"String","text")};this.setInputArray=function(a){m=[];if(null!=a)for(var b=0;b<a.length;b++)p.appendToInputArray(a[b])};this.getInputArray=function(){p.ctatdebug("getInputArray ("+m.length+")");n=[];for(var a=0;a<m.length;a++){var b=m[a];"object"===typeof b?(p.ctatdebug("Adding object value ("+
b.getValue()+") to temp input array"),n.push(b.getValue())):(p.ctatdebug("Adding string value ("+b+") to temp input array"),n.push(b))}return n};this.setPrompt=function(a){c=a};this.getPrompt=function(){return c};this.propagate=function(a){p.ctatdebug("propagate ()");a=a.getArguments();for(var b=0;b<a.length;b++){var c=a[b],d=m[b];if(null===c||null===d){p.ctatdebug("Internal error: argument lists do not align between received SAI and source SAI");break}d.setValue(c.getValue())}};this.fromString=function(a){a=
q.parse(a);p.fromXML(a)};this.fromXML=function(a){p.ctatdebug("fromXML ()");m=[];a=q.getElementChildren(a);for(var b,c=0;c<a.length;c++){var d=a[c];if("selection"==q.getElementName(d)||"Selection"==q.getElementName(d)){for(var e=q.getElementChildren(d),g=!1,h=0;h<e.length;h++)b=e[h],"value"==q.getElementName(b)&&(b=q.getNodeTextValue(b),1>h?p.setSelectionArray(b):p.appendToSelectionArray(b),g=!0,p.setSelection(b));!1===g&&(b=q.getNodeTextValue(d),p.setSelectionArray(b),p.setSelection(b))}if("action"==
q.getElementName(d)||"Action"==q.getElementName(d)){e=q.getElementChildren(d);g=!1;for(h=0;h<e.length;h++)b=e[h],"value"==q.getElementName(b)&&(b=q.getNodeTextValue(b),1>h?p.setActionArray(b):p.appendToActionArray(b),g=!0,p.setAction(b));!1===g&&(b=q.getNodeTextValue(d),p.setActionArray(b),p.setAction(b))}if("inputArray"==q.getElementName(d)||"value"==q.getElementName(d)||"Input"==q.getElementName(d)){b=q.getElementChildren(d);var f;m=[];e=new CTATHTMLManager;g=new CTATArgument;h=0;m.push(g);for(var n=
0;n<b.length;n++){var l=b[n];"value"==q.getElementName(l)&&(f=q.getElementChildren(l),null!==f?(p.ctatdebug("Parsing SAI input ..."),p.ctatdebug("Childnodes: "+f.length),1===f.length?(f=e.htmlDecode(q.getNodeTextValue(l)),p.ctatdebug("Setting new value to: "+f),g.setValue(f)):(f=e.htmlDecode(q.getNodeTextValue(l)),p.ctatdebug("Setting new value to: "+f),g.setValue(f),g.setName(l.attributes.getNamedItem("name").value),g.setType(l.attributes.getNamedItem("type").value),g.setFormat(l.attributes.getNamedItem("format").value),
h++),1>n?p.setInputArray(f):p.appendToInputArray(f)):(l=e.htmlDecode(q.getNodeTextValue(l)),p.ctatdebug("Setting new value to: "+l),g.setValue(l),1>n?p.setInputArray(l):p.appendToInputArray(l)))}}if("prompt"==q.getElementName(d)||"Prompt"==q.getElementName(d))p.ctatdebug("Parsing prompt ..."),p.setPrompt(q.getNodeTextValue(d))}p.checkDefaultArgument()};this.appendFromElement=function v(a,b,c,d,e){p.ctatdebug("appendFromElement ()");d=String(q.getElementName(b)).toLowerCase();if(d==a||"value"==d)if(d=
q.getElementChildren(b),!Array.isArray(d)||1>d.length)0==e?c.push(q.getNodeTextValue(b)):p.appendToInputArray(q.getNodeTextValue(b));else for(b=0;b<d.length;++b)v(a,d[b],c,b,e)};this.setArrayFromElements=function(a){p.ctatdebug("setArrayFromElements ()");if(!a||!Array.isArray(a)||1>a.length)p.ctatdebug("can't get name: don't know whether selection, action or input");else{var b,c=String(q.getElementName(a[0])).toLowerCase();switch(c){case "selection":p.ctatdebug("Processing selection field ...");g=
[];for(b=0;b<a.length;++b)p.appendFromElement(c,a[b],g,b,!1);break;case "action":p.ctatdebug("Processing action field ...");h=[];for(b=0;b<a.length;++b)p.appendFromElement(c,a[b],h,b,!1);break;case "input":p.ctatdebug("Processing input field ...");m=[];for(b=0;b<a.length;++b)p.appendFromElement(c,a[b],m,b,!0);break;default:console.log('CTATSAI.setArrayFromElements(): unexpected element name "'+c+'"');return}p.ctatdebug("CTATSAI.setArrayFromElements() eltName "+c+", length "+b+", selectionArray "+
p.getSelectionArray()+", actionArray "+p.getActionArray()+", inputArray "+p.getInputArray())}};this.fromXMLInternal=function(a){p.ctatdebug("fromXMLInternal ()");new CTATXML;m=[];a=q.getElementChildren(a);for(var b,c=0;c<a.length;c++){var d=a[c];if("selection"==q.getElementName(d)||"Selection"==q.getElementName(d)){for(var e=q.getElementChildren(d),g=!1,h=0;h<e.length;h++)b=e[h],"value"==q.getElementName(b)&&(b=q.getNodeTextValue(b),1>h?p.setSelectionArray(b):p.appendToSelectionArray(b),g=!0,p.setSelection(b));
!1===g&&(b=q.getNodeTextValue(d),p.setSelectionArray(b),p.setSelection(b))}if("action"==q.getElementName(d)||"Action"==q.getElementName(d)){e=d.childNodes;g=!1;for(h=0;h<e.length;h++)b=e[h],"value"==q.getElementName(b)&&(b=q.getNodeTextValue(b),1>h?p.setActionArray(b):p.appendToActionArray(b),g=!0,p.setAction(b));!1===g&&(b=q.getNodeTextValue(d),p.setActionArray(b),p.setAction(b))}if("inputArray"==q.getElementName(d)||"Input"==q.getElementName(d)){b=d.childNodes;m=[];var e=new CTATHTMLManager,g=new CTATArgument,
h=0,f;m.push(g);for(var n=0;n<b.length;n++)if(f=b[n],"value"==q.getElementName(f)){var v=q.getElementChildren(f);null!==v?(p.ctatdebug("Parsing SAI input ..."),p.ctatdebug("Childnodes: "+v.length),1===v.length?(f=e.htmlDecode(q.getNodeTextValue(f)),p.ctatdebug("Setting new value to: "+f),g.setValue(f)):(f=e.htmlDecode(q.getNodeTextValue(f)),p.ctatdebug("Setting new value to: "+f),g.setValue(f),g.setName(q.getElementAttr("name")),g.setType(q.getElementAttr("type")),g.setFormat(q.getElementAttr("format")),
h++)):(f=e.htmlDecode(q.getNodeTextValue(f)),p.ctatdebug("Setting new value to: "+f),g.setValue(f));1>n?p.setInputArray(f):p.appendToInputArray(f)}}if("prompt"==q.getElementName(d)||"Prompt"==q.getElementName(d))p.ctatdebug("Parsing prompt ..."),p.setPrompt(q.getNodeTextValue(d))}p.checkDefaultArgument()};this.toXMLString=function(a){p.ctatdebug("toXMLString ()");return a?p.toLSxmlString():p.toTSxmlString()};this.toLSxmlString=function(){p.ctatdebug("toLSxmlString ()");for(var a="",b=0;b<g.length;b++){var c=
...
return a};this.toTSxmlString=function(){p.ctatdebug("toTSxmlString ()");var a;a="<Selection><value>"+p.getSelection();for(var b=1;b<g.length;b++){var c=g[b];a="object"===typeof c?a+("</value><value>"+c.getValue()):a+("</value><value>"+c)}a+="</value></Selection><Action><value>"+p.getAction();for(b=1;b<h.length;b++)a+="</value><value>"+h[b];a+="</value></Action><Input>";if(1<m.length)for(b=0;b<m.length;b++)c=m[b],a+='<value fmt="text" name="'+c.getName()+'" type="'+c.getType()+'"><![CDATA['+c.getValue()+
...
h=h?h.value:"",m=f.attributes.getNamedItem("category"),m=m?m.value:"",n=f.attributes.getNamedItem("pGuess"),n=n?n.value:"",q=f.attributes.getNamedItem("pLearn"),q=q?q.value:"",p=f.attributes.getNamedItem("pSlip"),p=p?p.value:"",f=(f=f.attributes.getNamedItem("history"))?f.value:"";this.addSkill(d,c,.95,g,h,m,n,q,p,f)}}}else this.ctatdebug("Error: list of skill xml elements is null");else a.ctatdebug("Error: aSkills is null")};this.getSkillSet=function(){return this.internalSkillSet};this.getSize=
function(){return this.internalSkillSet.length};this.addSkill=function(a,e,f,d,c,g,h,m,n,q){this.ctatdebug("addSkill() name = "+a+" level = "+e+" mastery = "+f+" aDescription = "+d+" adisplayName = "+c+" aCategory = "+g+" pguess= "+h+" plearn = "+m+" pslip = "+n+" history = "+q);a=this.setSkillLevel(a,e,f);this.ctatdebug("Configuring "+a.getDisplayName());d&&a.setDescription(d);c&&a.setDisplayName(c);g&&a.setCategory(g);""!==h&&(a.setPGuess(h),a.setPLearn(m),a.setPSlip(n));""!==q&&a.setSkillHistory(q);
...
"&lt;").replace(/>/g,"&gt;");return a.replace(/("(\\u[a-zA-Z0-9]{4}|\\[^u]|[^\\"])*"(\s*:)?|\b(true|false|null)\b|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)/g,function(a){var b="number";/^"/.test(a)?b=/:$/.test(a)?"key":"string":/true|false/.test(a)?b="boolean":/null/.test(a)&&(b="null");return'<span class="'+b+'">'+a+"</span>"})}};CTATJSON.prototype=Object.create(CTATBase.prototype);CTATJSON.prototype.constructor=CTATJSON;"undefined"!==typeof module&&(module.exports=CTATJSON);var CTATMessage=function(a){function b(a){var b={},c=d.getElementChildren(a);this.ctatdebug("CTATMessage.parseCustomFields("+d.stringify(a)+"): cfElts.length "+c.length);for(a=0;a<c.length;++a){var e=c[a];if("custom_field"!=d.getElementName(e))console.log("CTATMessage.parseCustomFields(): unexpected element name "+d.getElementName(e)+" at custom_fields["+a+"]");else{for(var g=null,h=null,e=d.getElementChildren(e),f=0,m=0;f<e.length&&2>m;++f){var n=e[f];switch(d.getElementName(n)){case "name":g=d.getNodeTextValue(n);
m++;break;case "value":h=d.getNodeTextValue(n);m++;break;default:console.log("CTATMessage.parseCustomFields(): unexpected element name "+d.getElementName(n)+" within custom_field["+a+"]")}}g&&(b[g]=h?h:"",this.ctatdebug("CTATMessage.parseCustomFields(): result["+g+"]="+b[g]+";"))}}return b}CTATBase.call(this,"CTATMessage","message");CTATMessage.makeTransactionId=function(){return CTATGuid.guid()};var e=a,f=null,d=null;void 0==a&&(e=null);d="xml"==CTATConfig.parserType?new CTATXML:new CTATJSON;e&&
(this.ctatdebug("messageParser "+d+", messageObj "+e),e.children&&this.ctatdebug(e.children));var c="ungraded",g=!1,h=!1,m=new CTATSkillSet,n="",q="",p="",x="",l="",v,u=null,B=null,t=!1;this.setURL=function(a){v=a};this.getURL=function(){return v};this.assignSAI=function(a){h=!0;u=a};this.setTransactionID=function(a){q=a};this.getTransactionID=function(){return q};this.setGradeResult=function(a){c=a};this.getGradeResult=function(){return c};this.getXMLObject=function(){return e};this.getSkillsObject=
function(){return m};this.getCustomFields=function(){return B};this.getSuccessMessage=function(){return p};this.getBuggyMsg=function(){return x};this.getHighlightMsg=function(){return l};this.parse=function(){this.ctatdebug("parse ()");if(null!==e){this.ctatdebug("messageParser: "+d);this.ctatdebug("Root name: "+d.getElementName(e));"tool_message"==d.getElementName(e)?(this.ctatdebug("Detected tool message"),n="tool_message"):"message"!=d.getElementName(e)?(this.ctatdebug("Detected log message"),
g=!0,n=d.getElementName(e)):(this.ctatdebug("Detected regular message"),g=!1,this.parseMessageType());this.parseTransactionID();this.parseSAI();for(var a=d.getElementChildren(e),b=0;b<a.length;b++){var c=a[b];"properties"==d.getElementName(c)&&(ctatdebug("Found a 'properties' element ... "),f=d.getElementChildren(c))}this.ctatdebug("Message "+n+", with transaction id: "+q)}};this.parseSAI=function(){this.ctatdebug("parseSAI ()");var a="",c="",f="",q="",t=[],D=[],r=[];if("tool_message"==n){this.ctatdebug("Parsing s, a and i");
a=d.getElementChildren(e);for(c=0;c<a.length;c++)if(f=a[c],"tool_message"==d.getElementName(f))for(f=d.getElementChildren(f),q=0;q<f.length;q++)t=f[q],"event_descriptor"==d.getElementName(t)&&(u=new CTATSAI,u.fromXMLInternal(t));h=!0}else{if(g){this.ctatdebug("isLogMessage ...");for(var C=d.getElementChildren(e),F=0;F<C.length;F++){var y=C[F];if("event_descriptor"==d.getElementName(y))for(var y=d.getElementChildren(y),H=0;H<y.length;H++){var G=y[H];"selection"==d.getElementName(G)&&(a=d.getNodeTextValue(G),
t.push(G));"action"==d.getElementName(G)&&(c=d.getNodeTextValue(G),D.push(G));"input"==d.getElementName(G)&&(f=d.getNodeTextValue(G),r.push(G));"prompt"==d.getElementName(G)&&(q=d.getNodeTextValue(G))}}}else for(this.ctatdebug("!isLogMessage ..."),C=d.getElementChildren(e),F=0;F<C.length;F++)if(y=C[F],"properties"==d.getElementName(y))for(y=d.getElementChildren(y),H=0;H<y.length;H++){var G=y[H],J=d.getElementName(G);this.ctatdebug("Nodename: "+J);switch(J){case "URL":v=d.getNodeTextValue(G);break;
case "Skills":m.parseByValue(G);break;case "SuccessMsg":p=a=d.getNodeTextValue(G);break;case "BuggyMsg":x=d.getNodeTextValue(G);break;case "Selection":a=d.getNodeTextValue(G);t.push(G);break;case "Action":c=d.getNodeTextValue(G);D.push(G);break;case "Input":f=d.getNodeTextValue(G);r.push(G);break;case "prompt":q=d.getNodeTextValue(G);break;case "HighlightMsgText":l=d.getNodeTextValue(G);break;case "custom_fields":B=b(G)}}this.ctatdebug("SAI: "+a+","+c+","+f);""!==a&&null!==a?(u=new CTATSAI(a,c,f,
q),u.setArrayFromElements(t),u.setArrayFromElements(D),u.setArrayFromElements(r),h=!0):(this.ctatdebug("No SAI found"),h=!1);this.ctatdebug("parseSAI () done, hassai: "+h+", ("+a+","+c+","+f+","+q+")")}};this.parseTransactionID=function(){this.ctatdebug("parseTransactionID()");if("tool_message"!=n){if(!g)for(var a=d.getElementChildren(e),b=0;b<a.length;b++){var c=a[b];if("properties"==d.getElementName(c))for(var c=d.getElementChildren(c),h=0;h<c.length;h++){var f=c[h];"transaction_id"==d.getElementName(f)&&
(q=d.getNodeTextValue(f))}}this.ctatdebug("parseTransactionID() done, id: "+q)}};this.parseMessageType=function(){this.ctatdebug("parseMessageType()");for(var a=d.getElementChildren(e),b=0;b<a.length;b++){var c=a[b];if("properties"==d.getElementName(c))for(var c=d.getElementChildren(c),g=0;g<c.length;g++){var h=c[g];"MessageType"==d.getElementName(h)&&(n=d.getNodeTextValue(h))}}this.ctatdebug("parseMessageType() -> "+n)};this.getMessageType=function(){return n};this.getTransactionID=function(){return q};
this.getSAI=function(){return h?u:new CTATSAI};this.getSelection=function(){return h?u.getSelection():""};this.getAction=function(){return h?u.getAction():""};this.getInput=function(){return h?u.getInput():""};this.getSelectionArray=function(){return h?u.getSelectionArray():[]};this.getActionArray=function(){return h?u.getActionArray():[]};this.getInputArray=function(){return h?u.getInputArray():[]};this.getXML=function(){return e};this.getXMLString=function(a){if(e.xml)return e.xml;if(XMLSerializer)return(new XMLSerializer).serializeToString(e);
alert("ERROR: Extremely old browser");return""};this.getIndicator=function(){return"AssociatedRules"!=n?"":this.getProperty("Indicator")};this.getIndicatorSub=function(){return"AssociatedRules"!=n?"":this.getProperty("IndicatorSub")};this.setProperty=function(a,b){this.ctatdebug("setProperty ("+a+","+b+")");if(null!==f)for(var c=0;c<f.length;c++)d.getElementName(f[c]);else this.ctatdebug("Internal error: no messageProperties object available")};this.getProperty=function(a){if(!g)if(null!==f)for(var b=
0;b<f.length;b++){var c=f[b];if(d.getElementName(c)==a)return d.getNodeTextValue(c)}else this.ctatdebug("Internal error: no messageProperties object available");return""};this.hasProperty=function(a){a=this.getProperty(a);return!g&&""!==a};this.hasSAI=function(){return h};this.isEndOfTransaction=function(){return"true"==this.getProperty("end_of_transaction")?!0:!1};this.isLogMessageType=function(){return g};this.hasStudentSAI=function(){return!1};this.getStudentSelection=function(){return null.getSelection()};
this.getStudentAction=function(){return null.getAction()};this.getStudentInput=function(){return null.getInput()};this.getStudentSAI=function(){return null};this.getToolSelection=function(){return""};q=CTATMessage.makeTransactionId();this.parse();this.init=function(a){this.setMessageType(a)};this.setSelection=function(a){u&&u.setSelection(a);this.setProperty("SELECTION",a)};this.setAction=function(a){u&&u.setAction(a);this.setProperty("ACTION",a)};this.setInput=function(a){u&&u.setInput(a);this.setProperty("INPUT",
a)};this.lockTransactionId=function(a){if(null===a||"undefined"===typeof a||1>a.length)throw new CTATExampleTracerException("lockTranactionId() argument "+a+" must be a valid id");this.setProperty(CTATMessage.TRANSACTION_ID_TAG,a);t=!0};this.setMessageType=function(a){this.setProperty(CTATMessage.MESSAGE_TYPE,a);n=a};this.setTransactionId=function(a){if(!t){if(null===a||"undefined"===typeof a||1>a.length)a=CTATMessage.makeTransactionId();this.setProperty(CTATMessage.TRANSACTION_ID_TAG,a)}};CTATMessage.create=
function(a,b){var c=new CTATMessage;c.init(a);return c}};Object.defineProperty(CTATMessage,"MESSAGE_TYPE",{enumerable:!1,configurable:!1,writable:!1,value:"MessageType"});Object.defineProperty(CTATMessage,"TRANSACTION_ID_TAG",{enumerable:!1,configurable:!1,writable:!1,value:"transaction_id"});CTATMessage.prototype=Object.create(CTATBase.prototype);CTATMessage.prototype.constructor=CTATMessage;"undefined"!==typeof module&&(module.exports=CTATMessage);var CTATComponentDescription=function(){CTATBase.call(this,"CTATComponentDescription","");this.groupName=this.name=this.type="Unknown";this.height=this.width=this.y=this.x=0;this.tabIndex=this.zIndex=-1;this.styles={};this.params={};this.componentPointer=null;this.setComponentPointer=function(a){this.componentPointer=a};this.getComponentPointer=function(){return this.componentPointer};this.setGenericDefaults=function(){this.name="Generic name";this.styles={BackgroundColor:null,BorderColor:null,FontName:null,
...
m.push($(this).data("CTATComponent"))});if(0<m.length)return m}CTATShellTools.ctat_base.ctatdebug("JQuery couldn't find the component, let's try our internal list ...");for(var n in e){d=e[n];if(null===d)return CTATShellTools.ctat_base.ctatdebug("Internal error parsing component at index "+n),null;if(null===d.name)return CTATShellTools.ctat_base.ctatdebug("Internal error parsing component at index "+n+" (no name attribute available)"),null;CTATShellTools.ctat_base.ctatdebug("Comparing "+d.name+" to: "+
...
("<transaction_id>"+a+"</transaction_id>")+b.toXMLString(!1);return""+(e+"</properties></message>")};this.createAssociatedRulesMessage=function(a,b,e,f,d,c){a="<message><verb>SendNoteProperty</verb><properties><MessageType>AssociatedRules</MessageType>"+("<Indicator>"+a+"</Indicator>")+b.toXMLString();e=e.toXMLString().replace("<Selection>","<StudentSelection>").replace("<Action>","<StudentAction>").replace("<Input>","<StudentInput>");e=e.replace("</Selection>","</StudentSelection>").replace("</Action>",
"</StudentAction>").replace("</Input>","</StudentInput>");return""+(a+e)}};CTATTutoringServiceMessageBuilder.prototype=Object.create(CTATBase.prototype);CTATTutoringServiceMessageBuilder.prototype.constructor=CTATTutoringServiceMessageBuilder;var CTATMessageHandler=function(a){CTATBase.call(this,"CTATMessageHandler","messagehandler");var b=null,e=this,f=[],d=null,c=0,d=CTATConfig.parserType_is_XML()?new CTATXML:new CTATJSON;this.assignHandler=function(a){e.ctatdebug("assignHandler ()");b=a};this.reset=function(){e.ctatdebug("reset ()");f=[]};this.getInStartState=function(){return CTATMessageHandler.inStartState};var g=!1;this.receiveFromTutor=function(a){this.processMessage(a)};this.processMessage=function(a){e.ctatdebug("Incoming message: "+
...
this.processSingleMessage=function(g){e.ctatdebug("processSingleMessage ("+d.getElementName(g)+")");var h=new CTATMessage(g);g=d.getElementChildren(g);e.ctatdebug("Generated CTATMessage, now doing regular processing ...");for(var n=0;n<g.length;n++){var q=g[n];if("properties"==d.getElementName(q)){e.ctatdebug("Parsing properties ...");for(var p=d.getElementChildren(q),x=0;x<p.length;x++){var l=p[x];if("MessageType"==d.getElementName(l)){l=d.getNodeTextValue(l);e.ctatdebug("MessageType: "+l);"StateGraph"==
l&&(console.log("Setting inStartState to true"),CTATMessageHandler.inStartState=!0,a.setGotProblemRestoreEnd(!1),this.processStateGraph(q),a.propagateShellEvent("StateGraph",h));"StartProblem"==l&&(e.ctatdebug("Setting inStartState to true"),CTATMessageHandler.inStartState=!0,a.setGotProblemRestoreEnd(!1),this.processStartProblem(p),a.propagateShellEvent("StartProblem",h));"InterfaceIdentification"==l&&(this.processInterfaceIdentification(p),a.propagateShellEvent("InterfaceIdentification",h));"InterfaceDescription"==
l&&(this.processInterfaceDescription(p),a.propagateShellEvent("InterfaceDescription",h));"GetAllInterfaceDescriptions"==l&&(a.getAllInterfaceDescriptions(),a.propagateShellEvent("GetAllInterfaceDescriptions",h));"SendWidgetLock"==l&&(e.ctatdebug("Found: SendWidgetLock"),a.propagateShellEvent("SendWidgetLock",h));"CorrectAction"==l&&(e.ctatdebug("Found: CorrectAction"),!0===this.getInStartState()?f.push(h):b.processCorrectAction(h),a.propagateShellEvent("CorrectAction",h));"InCorrectAction"==l&&(e.ctatdebug("Found: InCorrectAction"),
!0===CTATMessageHandler.inStartState?f.push(h):(e.ctatdebug("Handing incorrect message to messagehandler ..."),b.processInCorrectAction(h)),a.propagateShellEvent("InCorrectAction",h));"HighlightMsg"==l&&(e.ctatdebug("Found: HighlightMsg"),b.processHighlightMsg(h),a.propagateShellEvent("HighlightMsg",h));"UnHighlightMsg"==l&&(e.ctatdebug("Found: UnHighlightMsg"),b.processUnHighlightMsg(h),a.propagateShellEvent("UnHighlightMsg",h));if("AssociatedRules"==l){e.ctatdebug("Found: AssociatedRules ("+p.length+
")");for(var v="",u="",B=0;B<p.length;B++){var t=p[B];"TutorAdvice"==d.getElementName(t)&&(v=d.getNodeTextValue(t));"Actor"==d.getElementName(t)&&d.getNodeTextValue(t);"Indicator"==d.getElementName(t)&&(u=d.getNodeTextValue(t));"StepID"==d.getElementName(t)&&d.getNodeTextValue(t);"LogAsResult"==d.getElementName(t)&&d.getNodeTextValue(t);"tool_selection"==d.getElementName(t)&&d.getNodeTextValue(t);"Skills"==d.getElementName(t)&&(e.ctatdebug("Processing skills ..."),null===CTATSkillSet.skills&&(e.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."),
CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(t))}b.processAssociatedRules(h,u,v);a.propagateShellEvent("AssociatedRules",h)}"BuggyMessage"==l&&(e.ctatdebug("Found: BuggyMessage"),b.processBuggyMessage(h),a.propagateShellEvent("BuggyMessage",h));"SuccessMessage"==l&&(e.ctatdebug("Found: SuccessMessage"),b.processSuccessMessage(h),a.propagateShellEvent("SuccessMessage",h));-1!=l.indexOf("InterfaceAction")&&(e.ctatdebug("Found: InterfaceAction"),v=h.getSAI(),-1!=v.getAction().indexOf(":")?
(e.ctatdebug("Processing and storing timed interface action : "+v.getAction()),u=parseInt(v.getAction().substring(v.getAction().indexOf(":")+1)),e.ctatdebug("Target time: "+u),v.setAction(v.getAction().substring(0,v.getAction().indexOf(":"))),e.ctatdebug("Timing ..."),setTimeout(b.processInterfaceAction,u,h)):(e.ctatdebug("Processing regular (non-timed) interface action"),!0===CTATMessageHandler.inStartState?(e.ctatdebug("inStartState==true => storing for later playback ..."),f.push(h)):b.processInterfaceAction(h),
a.propagateShellEvent("InterfaceAction",h)));"InterfaceIdentification"==l&&(e.ctatdebug("Found: InterfaceIdentification"),a.propagateShellEvent("InterfaceIdentification",h));"AuthorModeChange"==l&&(e.ctatdebug("Found: AuthorModeChange"),b.globalReset(),a.propagateShellEvent("AuthorModeChange",h));"ResetAction"==l&&(e.ctatdebug("Found: ResetAction"),b.globalReset(),a.propagateShellEvent("ResetAction",h));if("ShowHintsMessage"==l){e.ctatdebug("Found: ShowHintsMessage");v=!1;u=[];for(B=0;B<p.length;B++)if(t=
p[B],"HintsMessage"==d.getElementName(t))for(var t=d.getElementChildren(t),z=0;z<t.length;z++){var A=t[z];"value"==d.getElementName(A)&&(u.push(d.getNodeTextValue(A)),v=!0)}!0===v?b.processHintResponse(h,u):e.ctatdebug("Error: incomplete hint message received");a.propagateShellEvent("ShowHintsMessage",h)}"ConfirmDone"==l&&(e.ctatdebug("Found: ConfirmDone"),b.processConfirmDone(h),a.propagateShellEvent("ConfirmDone",h));"VersionInfo"==l&&(e.ctatdebug("Found: VersionInfo"),b.processVersionInfo(p),a.propagateShellEvent("ConfirmDone",
h));"TutoringServiceAlert"==l&&(e.ctatdebug("Found: TutoringServiceAlert"),b.processTutoringServiceAlert(p),a.propagateShellEvent("TutoringServiceAlert",h));"TutoringServiceError"==l&&(e.ctatdebug("Found: TutoringServiceError"),b.processTutoringServiceError(p),a.propagateShellEvent("TutoringServiceError",h));"ProblemSummaryResponse"==l&&(e.ctatdebug("Found: ProblemSummaryResponse"),b.processProblemSummaryResponse(h),a.propagateShellEvent("ProblemSummaryResponse",h));if("StartStateEnd"==l){e.ctatdebug("Found: StartStateEnd");
CTATShellTools.listComponents();null!==b?b.processStartState():this.ctatdebug("Error: no message handler object available to process start state");try{e.processStartStateActions()}catch(E){e.ctatdebug("Caught in the act: "+E.message)}CTATMessageHandler.inStartState=!1;a.propagateShellEvent("StartStateEnd",h)}"ProblemRestoreEnd"==l&&(e.ctatdebug("Found: ProblemRestoreEnd"),b.processProblemRestoreEnd(h),a.propagateShellEvent("ProblemRestoreEnd",h));"GetURL"==l&&(e.ctatdebug("Found: GetURL"),b.processGetURL(h),
a.propagateShellEvent("GetURL",h));"InterfaceReboot"==l&&(c++,1<c&&(l=CTATLMS.is.Authoring()?location.href:null,console.log("Found: InterfaceReboot #"+c+" -- href "+l),l?location.replace(l):(l="ws://"+CTATConfiguration.get("remoteSocketURL")+":"+CTATConfiguration.get("remoteSocketPort"),console.log("closing connection w/ url: "+l),a.closeWSConnection(l,function(){var a=window.frameElement.getAttribute("id"),a=new CustomEvent("refreshIframe",{detail:a});window.parent.document.dispatchEvent(a)},"interfaceReboot"))))}}}}};
this.processStateGraph=function(a){e.ctatdebug("processStateGraph ()");if(void 0===a||null===a)e.ctatdebug("Error: state graph property list is undefined");else if(e.ctatdebug("Processing node: "+a.nodeName),null===d.getElementChildren(a))e.ctatdebug("Error: state graph property list is undefined");else{a=d.getElementChildren(a);for(var c=0;c<a.length;c++){var g=a[c];e.ctatdebug("State graph attribute: "+d.getElementName(g));"caseInsensitive"==d.getElementName(g)&&(caseInsensitive="false"==d.getNodeTextValue(g)?
!1:!0);"unordered"==d.getElementName(g)&&(unordered="false"==d.getNodeTextValue(g)?!1:!0);"lockWidget"==d.getElementName(g)&&(lockWidget="false"==d.getNodeTextValue(g)?!1:!0);"suppressStudentFeedback"==d.getElementName(g)&&("false"==d.getNodeTextValue(g)?CTATGlobals.suppressStudentFeedback=!1:CTATGlobals.suppressStudentFeedback=!0);"highlightRightSelection"==d.getElementName(g)&&(highlightRightSelection="false"==d.getNodeTextValue(g)?!1:!0);"confirmDone"==d.getElementName(g)&&(e.ctatdebug("Confirm done: "+
d.getNodeTextValue(g)),"true"==d.getNodeTextValue(g)?CTATGlobals.confirmDone=!0:CTATGlobals.confirmDone=!1);"Skills"==d.getElementName(g)&&(null===CTATSkillSet.skills&&(CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(g),b.updateSkillWindow())}}};this.processStartProblem=function(a){e.ctatdebug("processStartProblem ()");b.processStartProblem()};this.processInterfaceIdentification=function(a){};this.processInterfaceDescription=function(a){e.ctatdebug("processInterfaceDescription ("+
a.length+")");for(var b="Unknown",c="Unknown",g=null,h=0;h<a.length;h++){var f=a[h];e.ctatdebug("Inspecting element: "+d.getElementName(f));"WidgetType"==d.getElementName(f)&&(e.ctatdebug("Widget type: "+d.getNodeTextValue(f)),b=d.getNodeTextValue(f));"CommName"==d.getElementName(f)&&(e.ctatdebug("Instance name: "+d.getNodeTextValue(f)),c=d.getNodeTextValue(f));if("serialized"==d.getElementName(f)){e.ctatdebug("Prepareing to de-serialize component ...");for(var l=d.getElementChildren(f),v=0;v<l.length;v++){var u=
l[v];-1!=d.getElementName(u).indexOf("CTAT")&&(g=u)}}"interface"==d.getElementName(f)&&(e.ctatdebug("Storing interface for post start-state reconstruction ..."),CTATGlobals.interfaceElement=f);"script"==d.getElementName(f)&&(e.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."),scriptElement=d.getNodeTextValue(f))}null!==g?this.deserializeComponent(b,c,g):e.ctatdebug("Error: unable to find CTAT serialization point of attachement");e.ctatdebug("processInterfaceDescription () done")};
this.deserializeComponent=function(a,b,c){e.ctatdebug("deserializeComponent ("+a+","+b+")");if(!0===CTATGlobals.ignoreInterfaceDescriptions)e.ctatdebug("ignoreInterfaceDescriptions==true");else if(null===d.getElementAttr(c,"x"))e.ctatdebug("Warning: this component does not have x,y information. Probably an older component");else{var g=d.getElementAttr(c,"x"),h=d.getElementAttr(c,"y"),f=d.getElementAttr(c,"width"),m=d.getElementAttr(c,"height"),n=d.getElementAttr(c,"tabIndex"),u=d.getElementAttr(c,
"zIndex");null===n&&(n=-1);null===u&&(u=0);var B=new CTATComponentDescription;B.type=a;B.name=b;B.x=Math.floor(g);B.y=Math.floor(h);B.tabIndex=n;B.zIndex=u;B.width=Math.floor(f);B.height=Math.floor(m);CTATShellTools.registerComponentDescription(B);c=d.getElementChildren(c);for(g=0;g<c.length;g++){h=c[g];d.getElementName(h);if("Parameters"==d.getElementName(h))for(this.ctatdebug("Processing component parameters ..."),f=d.getElementChildren(h)[0],f=d.getElementChildren(f),m=0;m<f.length;m++){var t=
f[m];if("CTATComponentParameter"==d.getElementName(t)){this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");for(var u=n=void 0,t=d.getElementChildren(t),z=0;z<t.length;z++){var A=t[z];"name"==d.getElementName(A)&&(this.ctatdebug("Found parameter name: "+d.getNodeTextValue(A)),n=d.getNodeTextValue(A));"value"==d.getElementName(A)&&(this.ctatdebug("Found parameter value: "+d.getNodeTextValue(A)),u=d.getNodeTextValue(A).trim())}this.ctatdebug("Parameter name: "+n+", value: "+
u);void 0!==n&&(B.params[n]=u,"group"==n&&(B.groupName=u))}}if("Styles"==d.getElementName(h))for(this.ctatdebug("Processing component styles ..."),h=d.getElementChildren(h)[0],h=d.getElementChildren(h),f=0;f<h.length;f++)if(u=h[f],"CTATStyleProperty"==d.getElementName(u)){this.ctatdebug("Processing style property (CTATStyleProperty) ...");n=m="";u=d.getElementChildren(u);for(t=0;t<u.length;t++)z=u[t],"name"==d.getElementName(z)&&(m=d.getNodeTextValue(z)),"value"==d.getElementName(z)&&(n=d.getNodeTextValue(z).trim());
this.ctatdebug("Style (name: "+m+", value: "+n+")");""!==m&&(B.styles[m]=n)}}e.ctatdebug("deserializeComponent ("+a+","+b+") done")}};this.processStartStateActions=function(){e.ctatdebug("processStartStateActions ("+f.length+")");if(0===f.length)e.ctatdebug("No start state messages, bump");else if(0<CTATMessageHandler.startStateHandlers.length)for(var a=0;a<CTATMessageHandler.startStateHandlers.length;a++)CTATMessageHandler.startStateHandlers[a].processStartStateActions(f);else{for(a=0;a<f.length;a++){var c=
f[a];e.ctatdebug("Processing startstate message type: "+c.getMessageType());"InterfaceAction"==c.getMessageType()&&b.processInterfaceAction(c);"CorrectAction"==c.getMessageType()&&b.processCorrectAction(c);"InCorrectAction"==c.getMessageType()&&b.processInCorrectAction(c);this.sleep(1E3)}if(""!==CTATMessageHandler.scriptElement)try{eval(CTATMessageHandler.scriptElement)}catch(n){alert("Error executing script from BRD: "+n.message)}}};this.sleep=function(a){e.ctatdebug("sleep ("+a+")")}};
CTATMessageHandler.prototype=Object.create(CTATBase.prototype);CTATMessageHandler.prototype.constructor=CTATMessageHandler;CTATMessageHandler.startStateHandlers=[];CTATMessageHandler.inStartState=!1;CTATMessageHandler.scriptElement="";var CTATNameTranslator=function(){CTATBase.call(this,"CTATNameTranslator","translator");var a=!1,b=this;this.setPassthrough=function(b){a=CTATGlobalFunctions.toBoolean(b)};this.getPassthrough=function(){return a};this.manufactorJSON=function(a,f){b.ctatdebug("manufactorJSON ("+a+","+f+")");var d=a.split(":");if(1==d.length)return b.ctatdebug("No range in aRange, returning basic JSON ..."),"";var c=this.getA1Row(d[0]),e=this.getA1Col(d[0]),h=this.getA1Row(d[1]),m=this.getA1Col(d[1]);b.ctatdebug("Manufacturing json from: ["+
...
try{document.close()}catch(u){alert("Error closing document: "+u.message)}try{document.write(b)}catch(u){alert("Error writing document: "+u.message)}}};this.updateSkillWindow=function(a){d.ctatdebug("updateSkillWindow()");CTATSkillSet.skills.untouchSkills();var b=CTATShellTools.findComponentByClass("CTATSkillWindow");null!==b?null!=a?b.updateSkillSet(a):b.drawComponent():d.ctatdebug("Info: no skill window available")};this.processComponentFocus=function(a){d.ctatdebug("processComponentFocus("+a.getName()+
...
null!=n&&n(a)):d.ctatdebug("showFeedback(): False alarm: empty message. This can happen when the commshell is trying to clear the hint window and there is no hint window.")};this.assignFeedbackHandler=function(a){d.ctatdebug("assignFeedbackHandler()");n=a};this.gradeSAI=function(a,b,c){d.ctatdebug("gradeSAI()");h[a]=c;a=new CTATSAI(a,b,c);d.processComponentAction(a,!0,!0)};this.assignGradingHandler=function(a){d.ctatdebug("assignGradingHandler()");m=a};this.assignAnonymousGradingProcessor=function(a){p=
a};this.assignDoneProcessor=function(a){c=a};this.addEventListener=function(a,b){};this.addGlobalEventListener=function(a){d.ctatdebug("addGlobalEventListener()");x.push(a)};this.closeWSConnection=function(b,c,d){console.log("closeWSConnection: "+b);(b=a.findWSConnection(b))?(console.log("connection found, closing..."),b.close(d,c)):console.warn("connection not found")}};CTATCommShell.prototype=Object.create(CTATBase.prototype);CTATCommShell.prototype.constructor=CTATCommShell;
CTATCommShell.commShell=null;CTATCommShell.detailedFeedback=!0;function enableDetailedFeedback(a){CTATCommShell.detailedFeedback=a};var CTATComponentReference=function(a,b){var e=a,f=b;this.setElement=function(a){e=a};this.getElement=function(){return e};this.setDiv=function(a){f=a};this.getDiv=function(){return f}};CTATComponentReference.components={};CTATComponentReference.list=function(){for(var a in CTATComponentReference.components){var b=CTATComponentReference.components[a];ctatdebug("Component: "+b.getElement().getName()+", with div: "+b.getDiv().id)}};
CTATComponentReference.getComponentFromID=function(a){var b=CTATComponentReference.components;return b.hasOwnProperty(a)?(a=b[a],a.getElement()?a.getElement():null):null};CTATComponentReference.add=function(a,b){var e=new CTATComponentReference(a,b);return CTATComponentReference.components[e.getDiv().getAttribute("id")]=e};var CTATCompBase=function(a,b,e,f,d,c){CTATBase.call(this,a,b);var g=e||0,h=f||0,m=d||-2,n=c||-2,q=50,p=25,x=!1,l=!1,v="",u=!1,B=!0,t=null,z="",A=null;this.isTabIndexable=!0;var E=0,I=null,w=this,D=null,r="hidden",C=CTATGlobalFunctions.gensym.z_index(),F=CTATGlobalFunctions.gensym.div_id(),y=CTATGlobalFunctions.gensym.z_index(),H=CTATGlobalFunctions.gensym.div_id();this.setIsAbstractComponent=function(a){x=a};this.isAbstractComponent=function(){return x};this.setIsFeedbackComponent=function(a){l=
a};this.isFeedbackComponent=function(){return l};this.setTabIndex=function(a){!0===this.isTabIndexable?(A=a,0>A?(A=CTATGlobals.Tab.Tracker,CTATGlobals.Tab.Tracker++):CTATGlobals.Tab.Tracker=A):A=-1};this.getTabIndex=function(){return A||this.getComponent().getAttribute("tabindex")};this.setStyles=function(){};this.setTabOrder=function(a){console.log("setTabIndex( "+a+" )");this.getComponent()&&(console.log("found comp"),isNaN(a)||(console.log("is a number"),this.getComponent().setAttribute("tabindex",
a)))};this.setZIndex=function(a){w.ctatdebug("Setting z index to: "+a);E=a;null!==t&&(t.style.zIndex=a)};this.getZIndex=function(){return E};this.setDefaultWidth=function(a){q=a};this.getDefaultWidth=function(){return q};this.setDefaultHeight=function(a){p=a};this.getDefaultHeight=function(){return p};this.processCommShellEvent=function(a,b){w.ctatdebug("processCommShellEvent ("+a+")")};this.makeDivWrapper=function(a){t=document.createElement("div");t.id=this.getName();t.setAttribute("onkeypress",
"return noenter(event)");t.setAttribute("data-ctat-component",this.getClassName());t.style.position="absolute";t.style.left=g+"px";t.style.top=h+"px";t.style.zIndex=C;t.style.width=w.getWidth()+"px";t.style.height=w.getHeight()+"px";$(t).data("CTATComponent",this);a.appendChild(t)};this.setDivWrapper=function(a){t=a;t.setAttribute("data-ctat-component",this.getClassName())};var G=this.setClassName;this.setClassName=function(a){G(a);t&&t.setAttribute("data-ctat-component",this.getClassName())};this.wrapComponent=
function(a){w.ctatdebug("wrapComponent ()");w.makeDivWrapper(a);w.ctatdebug("wrapComponent () done")};this.createCanvas=function(){w.ctatdebug("createCanvas ()");D=document.createElement("canvas");D.setAttribute("id",H);D.setAttribute("onkeypress","return noenter(event)");D.setAttribute("width",m+canvasCalibrate+"px");D.setAttribute("height",n+canvasCalibrate+"px");D.setAttribute("style","border: 1px "+this.borderColor+" solid; "+("hidden"==r?"visibility: hidden; ":"")+"z-index:"+y+";");t.firstChild?
t.insertBefore(D,t.firstChild):t.appendChild(D);return D};this.redraw=function(){var a=t.style.display;t.style.display="none";t.style.display=a};this.setCanvasVisibility=function(a){r=a};this.getSubCanvasCtx=function(){if(D)return D.getContext("2d")};this.getSubCanvas=function(){return D};this.getX=function(){return g};this.getY=function(){return h};this.getWidth=function(){if(0>=m){var a;I?a=window.getComputedStyle(I):t&&(a=window.getComputedStyle(t));if(a)return parseFloat(a.width)}return m};this.getHeight=
function(){if(0>=n&&t){var a=window.getComputedStyle(t);return parseFloat(a.getPropertyValue("height"))}return n};this.getText=function(){return v};this.getEnabled=function(){return B};this.assignEnabled=function(a){B=a;t.setAttribute("data-ctat-enabled",B)};this.setEnabled=function(a){w.ctatdebug("setEnabled ("+a+")");w.assignEnabled(a);I?I.disabled=!B:w.ctatdebug("Error: component pointer is null")};this.lock=this.setEnabled.bind(w,!1);this.unlock=this.setEnabled.bind(w,!0);this.getDivWrap=function(){return t};
this.getComponent=function(){return I};this.component=null;Object.defineProperty(this,"component",{get:function(){return I}});this.getCanvasZIndex=function(){return y};this.getComponentGroup=function(){return z};this.setComponent=function(a){I=a;this.setEnabled(this.getEnabled())};this.getTopDivZIndex=function(){return C};this.getTopDivID=function(){return F};this.setComponentGroup=function(a){z=a;I&&(I.name=a)};this.assignText=function(a){v=a};this.init=function(){w.ctatdebug("THIS IS THE BASE INIT METHOD")};
this.initialize=function(){w.ctatdebug("initialize ()");w.configFromDescription();w.init();w.processSerialization();w.render();w.processTabOrder();w.ctatdebug("initialize () done")};this.getInitialized=function(){return u};this.setInitialized=function(a){w.ctatdebug("setInitialized ("+a+")");u=a;!0!==u||t?w.ctatdebug("Not wrapping, initialized="+u+", divWrapper = "+t):(w.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."),(a=findPointOfAttachment(this.getName()))?
(w.ctatdebug("Attaching component to existing MovieClip ..."),w.wrapComponent(a.getDivWrapper())):(w.ctatdebug("Attaching component to main div ..."),0<$("#"+ctatcontainer).length&&w.wrapComponent(getSafeElementById(ctatcontainer))));w.getDivWrap().classList.add("CTATComponent");w.ctatdebug("setInitialized () done")};this.addSafeEventListener=function(a,b,c){w.ctatdebug("addSafeEventListener ("+a+")");w.ctatdebug("Adding event listener to: "+c);c?c.addEventListener(a,b):(I?(w.ctatdebug("Adding eventlistener to component instead of target"),
...
w.ctatdebug("implement in child class")};this.move=function(a,b){g=Number(a);h=Number(b);if(void 0===b||null===b||isNaN(h))if(0<=a.indexOf(",")){var c=a.split(",");g=Number(c[0]);h=Number(c[1])}else h=0;g=isNaN(g)?0:g;h=isNaN(h)?0:h;t&&(t.style.left=g+"px",t.style.top=h+"px")};this.setSize=function(a,b){var c=Number(a),d=Number(b);(void 0===b||null===b||isNaN(d))&&0<=a.indexOf(",")&&(d=a.split(","),c=Number(d[0]),d=Number(d[1]));w.ctatdebug("setSize ("+c+","+d+")");isNaN(c)||w.setWidth(c);isNaN(d)||
w.setHeight(d)};this.SetVisible=this.setVisible=function(a){a=CTATGlobalFunctions.toBoolean(a);r=!0===a?"block":"hidden";D&&D.setAttribute("style","border: 0px; position: absolute; "+(a?"":"visibility:hidden; ")+"; left:"+g+"px; top:"+h+"px; z-index:"+y+";");t.style.visibility=!0===a?null:"hidden"};this.FadeIn=function(a){w.SetVisible(!0)};this.FadeOut=function(a){w.SetVisible(!1)};this.reset=function(){};this.setX=function(a){this.x=a;t.style.left=this.x+"px";!0===u&&this.render()};this.setY=function(a){this.y=
a;t.style.top=this.y+"px";!0===u&&this.render()};this.setWidth=function(a){w.ctatdebug("setWidth ("+a+")");m=a;t?t.style.width=m+"px":w.ctatdebug("Internal error: no div wrapper available to set width")};this.setHeight=function(a){w.ctatdebug("setHeight ("+a+")");n=a;t?t.style.height=n+"px":w.ctatdebug("Internal error: no div wrapper available to set height")};this.setText=function(a){v=a;return this};this.getValue=function(){return I?I.value:""};this.backgrade=!1;this.unHighlightAll=function(){$(".CTAT--hint").each(function(){for(var a=
$(this),b=null;a&&null===b;)a.data("CTATComponent")?b=a.data("CTATComponent"):a=a.parent();b&&b.setHintHighlight&&b.setHintHighlight(!1,null)})};this.processOnFocus=function(){w.ctatdebug("processOnFocus ("+w.getName()+")");CTATGlobals.Tab.previousFocus=CTATGlobals.Tab.Focus;CTATGlobals.Tab.Focus!=w?(w.ctatdebug("CTATGlobals.Tab.Focus!=pointer, updating CTATGlobals.Tab.Focus ..."),CTATGlobals.Tab.Focus=w):w.ctatdebug("CTATGlobals.Tab.Focus==pointer");w.ctatdebug("processOnFocus () done")};this.processFocus=
function(a){w.ctatdebug("processFocus ()");a.currentTarget.getAttribute("id");if(w){mobileAPI&&!0===mobileAPI.getEnabled()&&w.hideKeyboard();CTATCommShell.commShell&&CTATCommShell.commShell.processComponentFocus(w);if(CTATGlobals.Tab.Focus){w.ctatdebug("old focus: "+CTATGlobals.Tab.Focus.getName()+", new focus:"+w.getName()+", correct: "+CTATGlobals.Tab.Focus.isCorrect());if(1==CTATGlobals.Tab.Focus.isCorrect()){w.ctatdebug("Previous focus is a correct component, don't backgrade!");return}if(CTATGlobals.Tab.Focus==
w){w.ctatdebug("We're already there!");return}CTATGlobals.Tab.Focus.backgrade&&CTATGlobals.Tab.Focus.processAction()}else w.ctatdebug("No previously focused component yet, can't grade");"hint"==w.getClassName()||"CTATHintButton"==w.getClassName()?w.ctatdebug("Info: focus moved to hint, bump"):(CTATGlobals.Tab.previousFocus=CTATGlobals.Tab.Focus,CTATGlobals.Tab.Focus=w,w.ctatdebug("processFocus () done"))}else w.ctatdebug("Error: component reference is null")};this.processTabOrder=function(){w.ctatdebug("processTabOrder ("+
A+")");!0===x?w.ctatdebug("Component is an abstract component, bump"):I?(w.ctatdebug("We have a component, actually assigning to html component ..."),null!==A&&(I.tabIndex=A),I.onfocus=w.processOnFocus):w.ctatdebug("Error: we don't have an html component yet, can't assign tab index")};this.hideKeyboard=function(){document.activeElement.blur();$("input").blur()}};CTATCompBase.prototype=Object.create(CTATBase.prototype);CTATCompBase.prototype.constructor=CTATCompBase;var CTATCSS=function(){var a=0,b=[],e=0,f=[],d=0,c=[];this.resetSelectors=function(){e=0;f=[];f[e]=[]};this.resetCSSStringArray=function(){c=[];d=0};this.clearCSS=function(){this.resetSelectors();this.resetCSSStringArray();b=[];a=0};this.addStringCSS=function(a){c[d]=a;d++};this.addCSSAttribute=function(c,d){b[a]=c;b[a+1]=d;a+=2};this.removeStringCSS=function(a){a=c.indexOf(a);0<=a&&c.splice(a,1)};this.removeCSSAttribute=function(a){a=b.indexOf(a);0<=a&&b.splice(a,2)};this.modifyCSSAttribute=function(a,
...
CTAT.Component.Base.Style.prototype.constructor=CTAT.Component.Base.Style;CTAT.Component.Base.Graphical=function(a,b,e,f,d,c,g){CTAT.Component.Base.Style.call(this,a,b,f,d,c,g);var h=e||(new CTATComponentDescription).setGenericDefaults();this.getGrDescription=function(){return h};this.setGrDescription=function(a){h=a;this.processDescription(h)};var m={},n={};this.getAlign=function(){return this.component?$(this.component).css("text-align"):$(this.getDivWrap()).css("text-align")};this.setAlign=function(a){this.component&&(this.component.style.textAlign=a);return this};this.getBackgroundColor=
...
p_underlined?"underline":null);return this};this.setBolded=function(a){a=CTATGlobalFunctions.stringToBoolean(a);this.component&&(this.component.style.fontWeight=a?"bold":null);return this};this.setItalicized=function(a){CTATGlobalFunctions.toBoolean(a);this.component&&(this.component.style.fontStyle=n.italicized?"italic":null);return this};var q=this;a=function(a){var b=a||{};return{setHandler:function(a,c){b[a]=c},set:function(a){if(b.hasOwnProperty(a)){if(b[a]){var c=Array.prototype.slice.call(arguments,
...
!1===CTATGlobals.suppressStudentFeedback&&n&&this.showCorrect(a);this.ctatdebug("setCorrect() post showCorrect");this.component&&(a=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.correct,{detail:{sai:a,component:this},bubbles:!0,cancelable:!0}),this.getDivWrap().dispatchEvent(a))};this.setIncorrect=function(a){this.ctatdebug("setIncorrect()");this.setNotGraded();"CTATTableGoogle"!=this.getClassName()&&this.executeSAI(a);v=CTAT.Component.Base.Tutorable.Options.Status.INCORRECT;!1===CTATGlobals.suppressStudentFeedback&&
...
{detail:{component:this},bubbles:!0,cancelable:!0});this.getDivWrap().dispatchEvent(a)}};this.showHintHighlight=function(a,b){this.component.classList.remove("CTAT--correct");this.component.classList.remove("CTAT--incorrect");a?this.component.classList.add("CTAT--hint"):this.component.classList.remove("CTAT--hint")};this.setHintHighlight=function(a,b){this.ctatdebug("setHintHighlight ("+a+")");if(l){var c=CTATGlobalFunctions.toBoolean(a);if(this.component){var d=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.highlight,
{detail:{isHighlighted:c,component:this},bubbles:!0,cancelable:!0});this.getDivWrap().dispatchEvent(d)}c!==x&&(x=c,this.showHintHighlight(c,b))}};this.moveHintHighlight=function(a,b){this.ctatdebug("moveHintHighlight ("+a+")");CTATGlobals.Tab.previousFocus=CTATGlobals.Tab.Focus;CTATGlobals.Tab.Focus=p;p.component.focus?CTATGlobals.Tab.Focus.getComponent().focus():CTATGlobals.Tab.Focus.getDivWrap().focus();if(l){var c=CTATGlobalFunctions.toBoolean(a);if(this.component){var d=new CustomEvent(CTAT.Component.Base.Tutorable.EventType.highlight,
...
"url('"+a+"')")};this.setText=function(a){h.ctatdebug("setText ("+a+")");m=a;null!==h.getComponent()&&(h.getComponent().innerHTML=m)};this.setFontColor=function(a){n=a;$(h.getComponent()).css("color",a)};this.getFontColor=function(){return n};this.setStyleHandler("labelText",this.setText);this.getText=function(){return m};this.processClick=function(a){h.ctatdebug("processClick ("+a.currentTarget.getAttribute("id")+" -> "+a.eventPhase+")");!0===h.getEnabled()?(null!==CTATGlobals.Tab.Focus&&("CTATTextArea"==
...
CTATButtonBasedComponent.prototype.constructor=CTATButtonBasedComponent;CTAT.ComponentRegistry={};CTAT.ComponentRegistry.addComponentType=function(){};Object.defineProperty(CTAT.ComponentRegistry,"addComponentType",{enumerable:!1,value:function(a,b){"string"==typeof a&&(this.hasOwnProperty(a)?alert(a+" is already a registered component"):this[a]=b)}});var CTATAudioButton=function(a,b,e,f,d){CTATButtonBasedComponent.call(this,"CTATAudioButton","audiobutton",a,b,e,f,d);var c=this;c.setActionInput("play","-1");var g=null,h="",m=CTATConfiguration.get("previewMode");this.setSource=function(a){this.getDivWrap().setAttribute("data-ctat-src",a);return this};this.getSource=function(){return this.getDivWrap().getAttribute("data-ctat-src")};this.setParameterHandler("SoundFile",this.setSource);this.init=function(){var a=document.createElement("button");a.value=
"-1";a.name=c.getName();a.setAttribute("id",CTATGlobalFunctions.gensym.div_id());a.setAttribute("onkeypress","return noenter(event)");a.classList.add("CTAT-button");if(this.getDivWrap().getAttribute("data-ctat-label"))this.setText(this.getDivWrap().getAttribute("data-ctat-label"));else if(c.getText())a.textContent=c.getText();else if(c.getDivWrap()&&c.getDivWrap().innerHTML&&!m){var b=c.getDivWrap().innerHTML;c.getDivWrap().innerHTML="";a.innerHTML=b}c.setInitialized(!0);c.setComponent(a);c.addComponentReference(c,
a);c.getDivWrap().appendChild(a);c.ctatdebug("Final location: "+c.getX()+","+c.getY()+" with text: "+c.getText());a.addEventListener("click",c.processClick);a.addEventListener("focus",c.processFocus);g=document.createElement("audio");g.addEventListener("canplay",function(){c.ctatdebug("Audio loaded and ready for play");""!==h&&(c.logAudioEvent(h),h="")},!0);g.onended=function(){c.ctatdebug("Audio ended");c.logAudioEvent("end")};this.getDivWrap().appendChild(g);this.setStyles()};this.getConfigurationActions=
...
c.setInitialized(!0);if(this.getDivWrap().getAttribute("data-ctat-label"))this.setText(this.getDivWrap().getAttribute("data-ctat-label"));else if(c.getText())g.innerHTML=c.getText();else if(c.getDivWrap()&&c.getDivWrap().innerHTML&&!h){var a=c.getDivWrap().innerHTML;c.getDivWrap().innerHTML="";g.innerHTML=a}c.setComponent(g);c.addComponentReference(c,g);c.getDivWrap().appendChild(g);g.addEventListener("click",c.processClick);g.addEventListener("focus",c.processFocus);g.addEventListener("mousedown",
this.processBaseMousedown);g.addEventListener("mouseup",this.processBaseMouseup);g.addEventListener("mouseover",c.processBaseMouseover);g.addEventListener("mouseout",c.processBaseMouseout);c.setStyles()}.bind(this);this.render=function(){};this.getConfigurationActions=function(){var a=[],b;0<g.innerHTML.trim().length&&(b=new CTATSAI,b.setSelection(this.getName()),b.setInput(g.innerHTML.toString()),b.setAction("setText"),a.push(b));return a};this.reset=function(){c.configFromDescription();c.processSerialization();
...
this.getCheckBox=function(){return c};this.setStyleHandler("labelPlacement",null);var n=function(a){this.updateSAI();this.processClick(a)};this.init=function(){m.setInitialized(!0);c=document.createElement("input");c.type="checkbox";c.setAttribute("id",this.getName()+"_check");c.classList.add("CTATCheckBox--button");this.getText()?c.value=m.getText():this.getDivWrap()&&this.getDivWrap().textContent?c.value=this.getDivWrap().textContent:c.value=c.id;this.getComponentGroup()?c.name=m.getComponentGroup():
this.getDivWrap()&&$(this.getDivWrap()).attr("name")?c.name=$(this.getDivWrap()).attr("name"):c.name="checkBoxGroup";!0===m.getEnabled()?c.disabled=!1:c.disabled=!0;m.ctatdebug("Final location: "+m.getX()+","+m.getY()+" with text: "+m.getText());m.addComponentReference(m,c);if(!h){var a=this.getDivWrap().innerHTML;this.getDivWrap().innerHTML=""}$(m.getDivWrap()).append(c);g=document.createElement("label");g.htmlFor=c.id;g.classList.add("CTATCheckBox--label");this.getText()?g.textContent=this.getText():
a&&!h?g.innerHTML=a:this.getDivWrap().getAttribute("data-ctat-label")&&this.setText(this.getDivWrap().getAttribute("data-ctat-label"));$(this.getDivWrap()).append(g);m.setComponent(c);c.addEventListener("click",n.bind(this));c.addEventListener("focus",m.processFocus);c.onfocus=this.processOnFocus;this.setSelection(this.getComponentGroup());this.setStyles()};this.resize=function(){var a=$(this.getDivWrap()).height();$(g).css("font-size",a-5+"px");$(this.getComponent()).css("height",a-10+"px");$(this.getComponent()).css("width",
a-10+"px")};this.getConfigurationActions=function(){var a=[],b;0<g.innerHTML.trim().length&&(b=new CTATSAI,b.setSelection(this.getName()),b.setInput(g.innerHTML.toString()),b.setAction("setText"),a.push(b));return a};var q=this.setText;this.setText=function(a){m.ctatdebug("setText ("+a+")");q(a);c&&(c.value=a,g.innerHTML=a)};this.setStyleHandler("labelText",this.setText);var p=this.setEnabled;this.setEnabled=function(a){p(a);c&&(c.disabled=!this.getEnabled())};this.getCheckBoxInput=function(){return g.innerHTML+
...
return a.value+": "+a.checked});this.setSelection(c.name);this.setAction("UpdateCheckBox");this.setInput(a.join(";"))};var x=function(a){g.classList.add(a);c.classList.add(a)},l=function(a){g.classList.remove(a);c.classList.remove(a)};this.showCorrect=function(a){l("CTAT--incorrect");l("CTAT--hint");x("CTAT--correct")};this.removeCorrect=l.bind(this,"CTAT--correct");this.showInCorrect=function(a){l("CTAT--correct");l("CTAT--hint");x("CTAT--incorrect")};this.removeInCorrect=l.bind(this,"CTAT--incorrect");
this.showHintHighlight=function(a){l("CTAT--incorrect");l("CTAT--correct");a?x("CTAT--hint"):l("CTAT--hint")}};CTATCheckBox.prototype=Object.create(CTAT.Component.Base.Clickable.prototype);CTATCheckBox.prototype.constructor=CTATCheckBox;CTATCheckBox.escape=function(a){return a.replace(/[-[\]{}()*+?.,\\^$|#\s\/]/g,"\\$&")};CTAT.ComponentRegistry.addComponentType("CTATCheckBox",CTATCheckBox);var CTATComboBox=function(a,b,e,f,d){CTAT.Component.Base.Clickable.call(this,"CTATComboBox","__undefined__",a,b,e,f,d);var c=this,g=null;this.component=null;var h=CTATConfiguration.get("previewMode");this.setAction("UpdateComboBox");var m=",";a=function(a){m=a;g&&(g.innerHTML="",this.addLabels(n,m))}.bind(this);this.setStyleHandler("SplitCharacter",a);this.data_ctat_handlers["split-on"]=a;var n=null;this.setLabels=function(a){n=a;g&&(g.innerHTML="",this.addLabels(n,m))}.bind(this);this.setStyleHandler("Labels",
this.setLabels);this.data_ctat_handlers.labels=this.setLabels;var q=null;a=function(a){a=parseInt(a);q=isNaN(a)?null:a;g&&g.setAttribute("size",q)};this.setStyleHandler("DropDownSize",a);this.data_ctat_handlers.size=a;this.setStyleHandler("DropDownWidth",null);this.setNumOptions=a;this.init=function(){c.setInitialized(!0);g=document.createElement("select");g.name=c.getName();g.setAttribute("id",CTATGlobalFunctions.gensym.div_id());g.setAttribute("onkeypress","return noenter(event)");g.onchange=this.processComboSelection;
g.classList.add("CTAT-combobox");q&&!h&&g.setAttribute("size",q);if(!h){var a=this.getDivWrap().innerHTML;this.getDivWrap().innerHTML="";a.trim()&&(g.innerHTML=a)}n&&this.addLabels(n,m);!0===c.getEnabled()?g.disabled=!1:g.disabled=!0;c.addComponentReference(c,g);c.setComponent(g);c.getDivWrap().appendChild(g);this.component=g;c.setStyles();g.addEventListener("focus",c.processFocus)};this.getConfigurationActions=function(){var a=[];if(n){var b=new CTATSAI;b.setSelection(this.getName());b.setInput(n);
b.setAction("setLabels");a.push(b)}return a};this.getHTMLComponent=function(){return g};this.addLabels=function(a,b){for(var c=a.split(b?b:m),d=0;d<c.length;d++)this.addItem(c[d])};this.addBlank=function(a){for(var b=0;b<a;b++)this.addItem("")};this.addItem=function(a){c.ctatdebug("addItem ("+a+")");var b=document.createElement("option");b.setAttribute("value",a);b.textContent=a;g.appendChild(b)};this.setFontSize=function(a){isNaN(a)||($(this.getComponent()).css("font-size",a+"px"),this.getDivWrap().setAttribute("data-ctat-font-size",
...
f=parseInt(c.getPropertyValue("border-left-width")),h=parseInt(c.getPropertyValue("border-right-width")),B=parseInt(c.getPropertyValue("border-bottom-width")),c=parseInt(c.getPropertyValue("border-right-width"));a.width-=b+g+f+c;a.height-=d+e+h+B;return a}};CTAT.Component.Base.SVG.prototype=Object.create(CTAT.Component.Base.Clickable.prototype);CTAT.Component.Base.SVG.prototype.constructor=CTAT.Component.Base.SVG;CTAT.Component.Base.UnitDisplay=function(a,b,e,f,d,c,g){CTAT.Component.Base.SVG.call(this,a,b,e,f,d,c,g);var h="1/2+1/4+(0*1/8)";this.setActionInput("SetPieces",h);var m="#800080";this.color=m;var n=1;this.colorAlpha=n;var q="#800080";this.deselectedColor=q;var p=.3;this.deselectedColorAlpha=p;var x="black";this.piece_border_color=x;this.piece_border_thickness=1;this.getPieceBorderColor=function(){return x};this.setPieceBorderColor=function(a){x=CTATGlobalFunctions.formatColor(a);return this};var l=
[],v=this;this.generateClassname=function(){return this.getName()+" UnitPart"};this.getPieces=function(){return l};var u=function(a){if(a.hasAttributeNS(null,"data-selected"))return CTATGlobalFunctions.toBoolean(a.getAttributeNS(null,"data-selected"));a.setAttributeNS(null,"data-selected",!0);return!0};this.getPiecesBySelected=function(a){for(var b=this.getPieces(),c=[],d,e=0;e<b.length;e++)d=b[e],u(d)===a&&c.push(d);return c};this.getSelectedPieces=this.getPiecesBySelected.bind(this,!0);this.getDeselectedPieces=
this.getPiecesBySelected.bind(this,!1);this.getColor=function(){return m};this.getColorAlpha=function(){return n};this.getDeselectedColor=function(){return q};this.getDeselectedColorAlpha=function(){return p};this.setColor=function(a){this.color=m=CTATGlobalFunctions.formatColor(a);a=this.getSelectedPieces();for(var b=0;b<a.length;b++)$(a[b]).css("fill",m)};this.setColorAlpha=function(a){n=Number(a);this.colorAlpha=n=isNaN(n)?1:n;a=this.getSelectedPieces();for(var b=0;b<a.length;b++)$(a[b]).css("fill-opacity",
n)};this.setDeselectedColor=function(a){this.deselectedColor=q=CTATGlobalFunctions.formatColor(a);a=this.getDeselectedPieces();for(var b=0;b<a.length;b++)$(a[b]).css("fill",m)};this.setDeselectedColorAlpha=function(a){p=Number(a);isNaN(p)&&(p=.3);this.deselectedColorAlpha=p;a=this.getDeselectedPieces();for(var b=0;b<a.length;b++)$(a[b]).css("fill-opacity",p)};this.valueOf=function(){return this.evaluate()};this.getValue=function(){return h};this.setValue=function(a){h=String(a);this.setInput(h);this.clear();
...
v.color),$(a).css("fill-opacity",v.colorAlpha)):($(a).css("fill",v.deselectedColor),$(a).css("fill-opacity",v.deselectedColorAlpha),a.setAttributeNS(null,"data-selected",!1))};this.clickHandler=function(a){!0===v.getEnabled()&&(a=CTATGlobalFunctions.toBoolean(this.getAttributeNS(null,"data-selected")),B(this,!a),v.setActionInput("SetPieces",v.updateValue()),v.processAction())};this.updateSAI=function(){v.setActionInput("SetPieces",v.updateValue())};this.addPieceElem=function(a,b,c){a.setAttributeNS(null,
"data-selected",c);a.setAttributeNS(null,"data-value",b.toString());a.dataValue=b;this.getEnabled()&&(a.style.cursor="pointer");a.addEventListener("click",this.clickHandler);l.push(a)};var t=this.setEnabled;this.setEnabled=function(a){t(a);l.forEach(function(b){b.style.cursor=a?"pointer":"default"})};this.clear=function(){l=[]};var z=function(a,b){var c=a.toString();!1===b&&(c="(0*"+c+")");return c};this.AddPiece=function(a,b){if(a){var c=new CTAT.Math.Fraction(a);if(0<CTAT.Math.round(c.valueOf())){var d=
h.split("+");d.push(z(c,b));v.setValue(d.join("+"))}}};this.AddToValue=function(a,b){if(a){var c=new CTAT.Math.Fraction(a);if(0<CTAT.Math.round(c.valueOf())){var d=h.split("+");d.push(z(c,b));h=d.join("+")}}return h};var A=-1,E=function(a){isNaN(a)&&this.get_denominator();a=Math.max(a,1);1<A&&(a=Math.min(a,A));return a}.bind(this);this.set_max_denominator=function(a){a=parseInt(a);isNaN(a)||(A=a)};this.set_denominator=function(a){v.setHintHighlight(!1);var b="string"===typeof a?parseInt(a):a;if(!isNaN(b)&&
(b=E(b),this.get_denominator()!=a)){var c=v.evaluate();v.clear();a=[];c.set_denominator(b);for(var d=new CTAT.Math.Fraction(1,b),e=Math.floor(c.numerator),g=b-e,f=0;f<e;f++)a.push(z(d,!0));b=new CTAT.Math.Fraction(c.numerator-e,b);b.equals(0)||(a.push(z(b,!0)),a.push(z(d.subtract(b),!1)),g--);for(b=0;b<g;b++)a.push(z(d,!1));this.setValue(a.join("+"));v.setActionInput("SetPieces",h);v.processAction();return h}};this.get_denominator=function(){return l.reduce(function(a,b,c,d){return Math.min(a,b.dataValue.denominator)},
Infinity)};this.change_denominator=function(a){return this.set_denominator(this.get_denominator()+Number(a))};this.set_number_pieces=function(a){v.setHintHighlight(!1);a="string"===typeof a?parseInt(a):a;if(!isNaN(a)){a=E(a);var b=v.numActive();v.clear();for(var c=[],d=new CTAT.Math.Fraction(1,a),e=0;e<a;e++)c.push(z(d,0<b)),b--;this.setValue(c.join("+"));v.setActionInput("SetPieces",h);v.processAction();return h}};this.change_number_pieces=function(a){this.set_number_pieces(l.length+a)};this.set_numerator=
function(a){return this.change_numerator(a-this.getSelectedPieces().length)};this.change_numerator=function(a){0!==a&&(0<a?l.every(function(b){!1===u(b)&&(B(b,!0),a--);return 0<a}):(l.reverse(),l.every(function(b){!0===u(b)&&(B(b,!1),a++);return 0>a}),l.reverse()))};this.SetPieces=function(a){v.setValue(a)};e=function(a){return(a=$(this.getDivWrap()).attr(a))?a.split(/\s*;\s*/).map(function(a){return a.trim()}):[]};a=e.bind(this,"data-ctat-ctrl-denominator");b=e.bind(this,"data-ctat-ctrl-partition");
e=e.bind(this,"data-ctat-ctrl-numerator");f=function(a,b){return 0<=a().indexOf(b)};var I=f.bind(null,a),w=f.bind(null,b),D=f.bind(null,e),r=function(a){var b=null;if(a instanceof CTAT.Component.Base.Tutorable)a!=this&&(b=a.getName());else if(a instanceof CTATSAI)a.getSelection()!=v.getName()&&(b=a.getSelection());else if(a instanceof String)a!=v.getName()&&(b=a);else if(a instanceof Element)a!=v.getComponent()&&(b=a.id);else return null;if(b){if(I(b))return C.bind(this,this.change_denominator,this.set_denominator);
if(D(b))return C.bind(this,this.change_numerator,this.set_numerator);if(w(b))return C.bind(this,this.change_number_pieces,this.set_number_pieces)}return null}.bind(this);document.addEventListener(CTAT.Component.Base.Tutorable.EventType.action,function(a){var b=a.detail.sai;a=r(a.detail.component);b&&null!==a&&a(b)},!1);var C=function(a,b,c){var d=parseInt(c.getInput());if(!isNaN(d)){switch(c.getAction()){case "ButtonPressed":a.call(this,d);break;case "Update":case "UpdateTextField":case "UpdateTextArea":b.call(this,
...
CTATHintButton.prototype=Object.create(CTAT.Component.Base.Clickable.prototype);CTATHintButton.prototype.constructor=CTATHintButton;CTAT.ComponentRegistry.addComponentType("CTATHintButton",CTATHintButton);var CTATHintWindow=function(a,b,e,f,d){CTAT.Component.Base.Graphical.call(this,"CTATHintWindow","__undefined__",a,b,e,f,d);var c=this;c.isTabIndexable=!1;var g=null,h=null,m=null,n=null,q=CTATGlobals.languageManager.getString("NEXT"),p=CTATGlobals.languageManager.getString("PREVIOUS"),x=null;this.data_ctat_handlers["next-content"]=function(a){x=a;m&&(m.innerHTML=a)};var l=null;this.data_ctat_handlers["previous-content"]=function(a){l=a;h&&(h.innerHTML=a)};this.getCurrentHint=function(){return g.innerHTML};
this.init=function(){c.ctatdebug("init ("+c.getName()+")");c.setInitialized(!0);c.setIsAbstractComponent(!0);n=this.getDivWrap();n.id||n.setAttribute("id",CTATGlobalFunctions.gensym.div_id());n.setAttribute("onkeypress","return noenter(event)");c.setComponent(n);c.addComponentReference(c,n);g=document.createElement("div");n.appendChild(g);g.classList.add("CTATHintWindow--hint-content");var a=document.createElement("div");a.classList.add("CTATHintWindow--hint-button-area");n.appendChild(a);if(l)h=
document.createElement("button"),h.classList.add("CTATHintWindow--previous"),h.innerHTML=l;else{h=document.createElement("button");h.classList.add("CTATHintWindow--previous");var b=document.createElement("span");b.classList.add("CTATHintWindow--button-icon");b.textContent="\u25c0";h.appendChild(b);p&&(b.style.cssFloat="left",h.appendChild(document.createTextNode(p)))}h.addEventListener("click",function(a){CTATShellTools.showPrevHint()},!1);a.appendChild(h);x?(m=document.createElement("button"),m.classList.add("CTATHintWindow--next"),
m.innerHTML=x):(m=document.createElement("button"),m.classList.add("CTATHintWindow--next"),b=document.createElement("span"),b.classList.add("CTATHintWindow--button-icon"),b.textContent="\u25b6",q&&(b.style.cssFloat="right",m.appendChild(document.createTextNode(q))),m.appendChild(b));m.addEventListener("click",function(a){CTATShellTools.showNextHint()},!1);a.appendChild(m);var d=function(a){this.disabled=!a;a||(this.classList.remove("CTAT-hint-button--hover"),this.classList.remove("CTAT-hint-button--clicked"))};
...
CTATMobileTutorHandler.prototype=Object.create(CTATBase.prototype);CTATMobileTutorHandler.prototype.constructor=CTATMobileTutorHandler;function processTextFocus(a,b,e,f,d){mobileAPI.processTextFocus(a,b,e,f,d)}function processFocusOut(){closeK()};var CTATMovieClip=function(a,b,e,f,d){CTATBase.call(this,"CTATMovieClip",a);var c=CTATGlobalFunctions.gensym.z_index(),g=CTATGlobalFunctions.gensym.div_id(),h=CTATGlobalFunctions.gensym.z_index();CTATGlobalFunctions.gensym.div_id();var m=[],n=this,q=null;this.wrapComponent=function(a){q=document.createElement("div");q.setAttribute("id",g);q.setAttribute("name",this.getName());q.setAttribute("style","z-index: "+c);q.setAttribute("width",f+"px");q.setAttribute("height",d+"px");q.setAttribute("style",
"border: 0px; position: absolute; left:"+b+"px; top:"+e+"px; z-index:"+h+";");a.appendChild(q);return q};this.getDivWrapper=function(){return q};this.addComponent=function(a){n.ctatdebug("addComponent ("+a+")");m.push(a)};this.isRegistered=function(a){for(var b=0;b<m.length;b++)if(m[b]==a)return!0;return!1}};CTATMovieClip.prototype=Object.create(CTATBase.prototype);CTATMovieClip.prototype.constructor=CTATMovieClip;CTAT.Geom={};CTAT.Geom.Point={};try{new DOMPoint}catch(a){if(console.log("WARNING: new DOMPoint():",a,typeof a),a instanceof ReferenceError||a instanceof TypeError)console.log("   Using shim!"),DOMPoint=function(b,e,f,d){this.z=this.y=this.x=0;this.w=1;if(b instanceof DOMPoint)for(var c in b)this[c]=b[c];else this.x=b||0,this.y=e||0,this.z=f||0,this.w=d||1}}CTAT.Geom.Point.useDOMMatrix=!0;try{new DOMMatrix}catch(a){a instanceof ReferenceError&&(CTAT.Geom.Point.useDOMMatrix=!1)}
...
this.render()};var n=new a(this,new c(0),25,"CTATNumberLine--denominator-tickmark","CTATNumberLine--denominator-tickmark-label");this.setParameterHandler("DenominatorTickmarkSize",function(a){n.setSize(a);this.render();return this});this.setParameterHandler("DenominatorTickmarkStep",function(a){n.setStep((new c(a)).reciprocal())});this.data_ctat_handlers.denominator=function(a){a=new c(a);n.setStep(a.reciprocal())};this.X_Axis=new function(a,b,c,d){var e={};this.svg_group=null;var g=a;Object.defineProperty(this,
"start",{get:function(){return g},set:function(a){e={};g=a}});Object.defineProperty(this,"min_loc",{get:function(){if(!e.hasOwnProperty("min_loc")){var a=this.start.clone(),b=CTAT.Geom.Point.polar(20,this.angle()),a=a.add(b);a.x=CTAT.Math.round(a.x);a.y=CTAT.Math.round(a.y);e.min_loc=a}return e.min_loc}});var f=b;Object.defineProperty(this,"end",{get:function(){return f},set:function(a){e={};f=a}});Object.defineProperty(this,"max_loc",{get:function(){if(!e.hasOwnProperty("max_loc")){var a=this.end.clone(),
b=CTAT.Geom.Point.polar(20,this.angle()),a=a.add(b.scale(-1));a.x=CTAT.Math.round(a.x);a.y=CTAT.Math.round(a.y);e.max_loc=a}return e.max_loc}});var h=c;Object.defineProperty(this,"min",{get:function(){return h},set:function(a){e={};h=a}});var m=d;Object.defineProperty(this,"max",{get:function(){return m},set:function(a){e={};m=a}});Object.defineProperty(this,"length",{get:function(){e.hasOwnProperty("length")||(e.length=CTAT.Math.round(this.min_loc.distance(this.max_loc)));return e.length}});this.isHorizontal=
function(){return this.start.y===this.end.y};this.isVertical=function(){return this.start.x===this.end.x};Object.defineProperty(this,"range",{get:function(){return this.max.subtract(this.min)}});Object.defineProperty(this,"step_size",{get:function(){return CTAT.Geom.Point.equals(this.min_loc,this.max_loc)?this.length:CTAT.Math.round(this.length/this.range)}});this.s_vec=function(){return this.max_loc.add(this.min_loc.scale(-1))};this.slope=function(){var a=this.s_vec();return a.y/a.x};this.step=function(){e.hasOwnProperty("step")||
(e.step=this.s_vec().normalize(this.step_size));return e.step};this.scalar=function(){e.hasOwnProperty("scalar")||(e.scalar=this.range/this.length);return e.scalar};this.zero=function(){e.hasOwnProperty("zero")||(e.zero=this.min_loc.add(this.step().scale(-this.min)),e.zero.x=CTAT.Math.round(e.zero.x),e.zero.y=CTAT.Math.round(e.zero.y));return e.zero};this.angle=function(){if(!e.hasOwnProperty("angle")){var a=this.end.add(this.start.scale(-1));e.angle=Math.atan2(a.y,a.x)}return e.angle};this.angle_deg=
...
this.data_ctat_handlers["max-points"]=this.setMaxPoints;var p=7;this.setPointSize=function(a){p=Number(a);u&&(u.setAttributeNS(null,"r",p),$(this._point_group).find("circle").each(function(){$(this).attr("r",p)}))};this.setStyleHandler("PointSize",this.setPointSize);this.data_ctat_handlers["point-size"]=this.setPointSize;var x=!1;this.setSnapToTickMark=function(a){x=CTATGlobalFunctions.toBoolean(a)};this.setParameterHandler("SnapToTickmark",this.setSnapToTickMark);this.data_ctat_handlers.snap=this.setSnapToTickMark;
...
document.createElementNS(g,"line"),f=this.X_Axis.getPosition(a),h=CTAT.Geom.Point.polar(c/2,this.theta+Math.PI/2).add(f);c=CTAT.Geom.Point.polar(-c/2,this.theta+Math.PI/2).add(f);e.setAttributeNS(null,"x1",h.x);e.setAttributeNS(null,"y1",h.y);e.setAttributeNS(null,"x2",c.x);e.setAttributeNS(null,"y2",c.y);e.setAttributeNS(null,"data-value",a.toString());e.data=a;e.location=f;e.label=null;this._tickmarks.push(e);d.appendChild(e);if(""!==b){f=document.createElementNS(g,"text");f.classList.add("CTATNumberLine--tickmark-label");
f.setAttributeNS(null,"text-anchor","middle");d.appendChild(f);if(null===b||void 0===b)if(1==a.denominator)f.appendChild(document.createTextNode(String(a.numerator.toPrecision(S)))),f.setAttributeNS(null,"x",c.x),f.setAttributeNS(null,"y",c.y);else{b=""+String(a.numerator);h=""+String(a.denominator);f.style.fontSize="0.6em";f.setAttributeNS(null,"text-align","center");var m=document.createElementNS(g,"tspan"),l=document.createElementNS(g,"tspan");m.appendChild(document.createTextNode(b));l.appendChild(document.createTextNode(h));
f.appendChild(m);f.appendChild(l);m.setAttributeNS(null,"text-anchor","middle");m.setAttributeNS(null,"x",c.x);m.setAttributeNS(null,"y",c.y);m.setAttributeNS(null,"dy","-1em");l.setAttributeNS(null,"text-anchor","middle");l.setAttributeNS(null,"x",c.x);l.setAttributeNS(null,"y",c.y);b.length>h.length?m.style.textDecoration="underline":l.style.textDecoration="overline"}else f.appendChild(document.createTextNode(b.toString())),d.appendChild(tlabel),f.setAttributeNS(null,"x",c.x),f.setAttributeNS(null,
"y",c.y);e.label=f}}return d};var l=function(){if(null!==this.X_Axis&&null!==this.X_Axis.svg_group){var a=this.getBoundingBox(),b=window.getComputedStyle(this._axis_line_group),b=parseInt(b.getPropertyValue("stroke-width")),a=CTAT.Geom.Rectangle.inflate(a,-b,-b),c=new DOMPoint(a.width/2,a.height/2),d=c.add(CTAT.Geom.Point.polar(Math.min(40,a.height,a.width)/4,this.theta)),e=Math.sin(this.theta),f=-Math.cos(this.theta),l=e*c.x+f*c.y,p=-a.height*f,u=-e*a.width,b=new DOMPoint(a.left,c.y),c=new DOMPoint(a.right,
c.y);if(0<Math.abs(CTAT.Math.round(p))){var p=new DOMPoint(a.left,(l-e*a.left)/f),q=new DOMPoint(a.right,(l-e*a.right)/f);if(a.contains(p)||a.contains(q))d.distance(p)<d.distance(q)?(b=q,c=p):(b=p,c=q)}0<Math.abs(CTAT.Math.round(u))&&(u=new DOMPoint((l-f*a.top)/e,a.top),e=new DOMPoint((l-f*a.bottom)/e,a.bottom),a.contains(u)||a.contains(e))&&(d.distance(u)<d.distance(e)?(b=e,c=u):(b=u,c=e));if(this.X_Axis.start.x!=b.x||this.X_Axis.start.y!=b.y||this.X_Axis.end.x!=c.x||this.X_Axis.end.y!=c.y)this.X_Axis.start=
b,this.X_Axis.end=c,this.X_Axis.svg_group.innerHTML="",a=document.createDocumentFragment(),d=document.createElementNS(g,"line"),d.setAttributeNS(null,"x1",b.x),d.setAttributeNS(null,"y1",b.y),d.setAttributeNS(null,"x2",c.x),d.setAttributeNS(null,"y2",c.y),a.appendChild(d),d=document.createElementNS(g,"path"),d.setAttributeNS(null,"d","M 10,6 L 0,0 L 10,-6"),d.setAttributeNS(null,"transform","translate("+CTAT.Geom.Point.to2DString(b)+") rotate("+this.Orientation+")"),a.appendChild(d),b=document.createElementNS(g,
"path"),b.setAttributeNS(null,"d","M -10,6 L 0,0 L -10,-6"),b.setAttributeNS(null,"transform","translate("+CTAT.Geom.Point.to2DString(c)+") rotate("+this.Orientation+")"),a.appendChild(b),this.X_Axis.svg_group.appendChild(a);this._tickmarks=[];b=document.createDocumentFragment();b.appendChild(h.generate());b.appendChild(m.generate());b.appendChild(n.generate());this._tick_mark_group.innerHTML="";this._tick_mark_group.appendChild(b);b=this._point_group.children;for(c=0;c<b.length;c++)a=b[c],d=this.X_Axis.getPosition(a.value),
e=new DOMPoint(a.cx.baseVal.value,a.cy.baseVal.value),1<d.distance(e)&&(a.cx.baseVal.value=d.x,a.cy.baseVal.value=d.y)}}.bind(this),v=0,u=null,B=new DOMPoint(-30,-30),t=!1,z=function(a){B.x=a.clientX;B.y=a.clientY},A=function(a){cancelAnimationFrame(v);u.style.visibility="hidden";t=!1},E=function(a){if(!0===this.getEnabled()&&0<q){this.setHintHighlight(!1);var b;x?(a=r(a.clientX,a.clientY),b=a.location,a=a.data):(a=w(a.clientX,a.clientY),b=this.X_Axis.getProjectedPoint(a),a=this.X_Axis.getAxisValue(a));
var c=document.createElementNS(g,"circle");c.classList.add("CTATNumberLine--point");c.setAttributeNS(null,"cx",b.x);c.setAttributeNS(null,"cy",b.y);c.setAttributeNS(null,"r",p);c.value=a;if(this._point_group.children.length>=this.Max_Points){b=[].slice.call(this._point_group.children);var d=b.filter(function(a,b,c){return a.classList.contains("CTAT--incorrect")});0<d.length?this._point_group.removeChild(d[0]):(b=b.filter(function(a,b,c){return!a.classList.contains("CTAT--correct")}),0<b.length&&this._point_group.removeChild(b[0]))}this._point_group.appendChild(c);
this.setActionInput("AddPoint",a.toString());this.processAction()}}.bind(this);this.init=function(){this.initSVG();this.component.classList.add("CTATNumberLine--container");this._axis_line_group=document.createElementNS(g,"g");this._axis_line_group.classList.add("CTATNumberLine--axis");this._tick_mark_group=document.createElementNS(g,"g");this._tick_mark_group.classList.add("CTATNumberLine--tickmark");this._point_group=document.createElementNS(g,"g");u=document.createElementNS(g,"circle");u.setAttributeNS(null,
"r",p);u.classList.add("CTATNumberLine--cursor");u.setAttributeNS(null,"transform","translate(-30,-30)");this.component.appendChild(this._axis_line_group);this.component.appendChild(this._tick_mark_group);this.component.appendChild(this._point_group);this.component.appendChild(u);this.X_Axis.svg_group=this._axis_line_group;l();this.addComponentReference(this,this.getDivWrap());this.component.addEventListener("mousemove",z);this.component.addEventListener("mouseleave",A);var a=this.getEnabled;this.component.addEventListener("mouseenter",
function(){!0===a()&&0<q&&(t=!0,u.style.visibility=null,v=requestAnimationFrame(C))});this.component.addEventListener("click",E);this.component.addEventListener("focus",this.processFocus)};this.getConfigurationActions=function(){var a=[],b,c=$(this.getDivWrap());c.attr("data-ctat-minimum")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_minimum"),b.setInput(c.attr("data-ctat-minimum")),a.push(b));c.attr("data-ctat-maximum")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_maximum"),
...
b.setInput(c.attr("data-ctat-small-tick-step")),a.push(b));c.attr("data-ctat-denominator")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_denominator"),b.setInput(c.attr("data-ctat-denominator")),a.push(b));return a};var I=-1<navigator.userAgent.toLowerCase().indexOf("firefox"),w=function(a,b){this.svgPoint=this.svgPoint?this.svgPoint:this.component.createSVGPoint();this.svgPoint.x=a;this.svgPoint.y=b;var c=this._axis_line_group.getScreenCTM().inverse();this.svgPoint=this.svgPoint.matrixTransform(c);
c=new DOMPoint(this.svgPoint.x,this.svgPoint.y);if(I){var d=$(this.component),e=parseInt(d.css("borderLeftWidth"))+parseInt(d.css("paddingLeft"))+parseInt(d.css("marginLeft")),d=parseInt(d.css("borderTopWidth"))+parseInt(d.css("paddingTop"))+parseInt(d.css("marginTop"));c.x-=e;c.y-=d}return c}.bind(this),D=function(a,b){return this.getProjectedPoint(w(a,b))}.bind(this.X_Axis),r=function(a,b){for(var c=D(a,b),d=null,e=Number.POSITIVE_INFINITY,g,f,h=0;h<this._tickmarks.length;h++)g=this._tickmarks[h],
f=c.distance(g.location),f<e&&(d=g,e=f);return d}.bind(this),C=function(){if(t&&!0===this.getEnabled()){if(x){var a=r(B.x,B.y);u.setAttributeNS(null,"transform","translate"+CTAT.Geom.Point.to2DString(a.location,!0))}else u.setAttributeNS(null,"transform","translate"+CTAT.Geom.Point.to2DString(D(B.x,B.y),!0));v=requestAnimationFrame(C)}}.bind(this);this.render=function(){l()};this.calcXCoordinate=function(a){a=new c(a);var b=this.getWidth()-30,b=Math.abs(b-30),d=max.subtract(min);return 30+a.subtract(min).divide(d)/
b};this.calcNum=function(a){var b=this.getWidth()-30,b=Math.abs(b-30);a=max.subtract(min).multiply((a-30)/b);return min.add(a)};var F=function(a,b){switch(b.getClassName()){case "CTATMessage":b=b.getSAI()}var c=b.clone();c.setAction(a.getSAI().getAction());c.setSelection(a.getName());return c};this.showCorrect=function(a){a.getInput();var b=a.getAction(),c=function(b){b.setCorrect(F(b,a))};switch(b){case "AddPoint":0<this._point_group.children.length&&(b=[].slice.call(this._point_group.children),
c=b[b.length-1],c.classList.remove("CTAT--incorrect"),c.classList.remove("CTAT--hint"),c.classList.add("CTAT--correct"),this.getDisableOnCorrect()&&(b.length>=this.Max_Points&&b.every(function(a){return a.classList.contains("CTAT--correct")})?this.setEnabled(!1):this.setEnabled(!0)));break;case "Points":b=this._point_group.children;for(c=0;c<b.length;c++){var d=b[c];d.classList.remove("CTAT--incorrect");d.classList.remove("CTAT--hint");d.classList.add("CTAT--correct")}break;case "set_minimum":O(P()).forEach(c);
break;case "set_maximum":O(M()).forEach(c);break;case "set_large_step":O(K()).forEach(c);break;case "set_small_step":O(R()).forEach(c);break;case "set_denominator":O(T()).forEach(c);break;default:console.log("Unhandled Action in",this.getName(),b)}};this.showInCorrect=function(a){a.getInput();var b=a.getAction(),c=function(b){b.setIncorrect(F(b,a))};switch(b){case "AddPoint":0<this._point_group.children.length&&(b=[].slice.call(this._point_group.children),b=b[b.length-1],b.classList.remove("CTAT--correct"),
b.classList.remove("CTAT--hint"),b.classList.add("CTAT--incorrect"));break;case "Points":b=this._point_group.children;for(c=0;c<b.length;c++){var d=b[c];d.classList.remove("CTAT--correct");d.classList.remove("CTAT--hint");d.classList.add("CTAT--incorrect")}break;case "set_minimum":O(P()).forEach(c);break;case "set_maximum":O(M()).forEach(c);break;case "set_large_step":O(K()).forEach(c);break;case "set_small_step":O(R()).forEach(c);break;case "set_denominator":O(T()).forEach(c);break;default:console.log("Unhandled Action in",
this.getName(),b)}};var y=this.setEnabled;this.setEnabled=function(a){y(a);u&&t&&(u.style.visibility=this.getEnabled()?null:"hidden")};this.set_minimum=function(a){this.Minimum=a;this.render()};this.change_minimum=function(a){a=new c(a);0!==a.valueOf()&&(this.Minimum=this.Minimum.add(a),this.render())};var H=function(){this.setActionInput("set_minimum",this.Minimum)}.bind(this);this.set_maximum=function(a){this.Maximum=a;this.render()};this.change_maximum=function(a){a=new c(a);0!==a.valueOf()&&(this.Maximum=
this.Maximum.add(a),this.render())};var G=function(){this.setActionInput("set_maximum",this.Maximum)}.bind(this);this.set_max_user_entries=function(a){this.setMaxPoints(parseInt(a))};a=function(a,b){a.setStep(b);this.render()};this.set_large_step=a.bind(this,h);var J=function(){this.setActionInput("set_large_step",h.step.toString())}.bind(this);this.set_small_step=a.bind(this,m);var N=function(){this.setActionInput("set_small_step",m.step.toString())}.bind(this);this.set_denominator=function(a){0===
parseInt(a)?n.setStep(0):n.setStep((new c(a)).reciprocal());this.render()};var L=function(){var a=0===n.step.valueOf()?0:n.step.reciprocal();this.setActionInput("set_denominator",a.toString())}.bind(this);a=function(a,b){if(0!==(new c(b)).valueOf()){var d=a.step.add(b);0>d.valueOf()&&d.set(0,1);a.setStep(d);this.render()}};this.change_large_step=a.bind(this,h);this.change_small_step=a.bind(this,m);this.change_denominator=function(a){a=new c(a);0!==a.valueOf()&&(a=a.add(n.step.denominator),n.setStep(a.reciprocal()))};
var S=void 0;this.set_precision=function(a){S=parseInt(a);this.render()};this.AddPoint=function(a,b){var d=new c(a),e=this.X_Axis.getPosition(d),f=document.createElementNS(g,"circle");f.classList.add("CTATNumberLine--point");f.setAttributeNS(null,"cx",e.x);f.setAttributeNS(null,"cy",e.y);f.setAttributeNS(null,"r",p);f.value=d;[].slice.call(this._point_group.children).some(function(a){return d.equals(a.value)})||this._point_group.appendChild(f)};this.Points=function(a,b){this._point_group.innerHTML=
"";var c=a.split(";"),d;for(d in c)this.AddPoint(c[d],b)};var Q=function(a,b,c,d){switch(d.getAction()){case "ButtonPressed":a.call(this,d.getInput());break;case "Update":case "UpdateTextField":case "UpdateTextArea":b.call(this,d.getInput())}c.call();this.processAction(!1,!0)};a=function(a){return(a=$(this.getDivWrap()).attr(a))?a.split(/\s*;\s*/).map(function(a){return a.trim()}):[]};var M=a.bind(this,"data-ctat-ctrl-max"),P=a.bind(this,"data-ctat-ctrl-min"),K=a.bind(this,"data-ctat-ctrl-large-tick"),
R=a.bind(this,"data-ctat-ctrl-small-tick"),T=a.bind(this,"data-ctat-ctrl-denominator"),O=function(a){return a.map(function(a){return $("#"+a).data("CTATComponent")})},Z=function(a){var b=null;if(a instanceof CTAT.Component.Base.Tutorable)a!=this&&(b=a.getName());else if(a instanceof CTATSAI)a.getSelection()!=pointer.getName()&&(b=a.getSelection());else if(a instanceof String)a!=pointer.getName()&&(b=a);else if(a instanceof Element)a!=pointer.getComponent()&&(b=a.id);else return null;if(b){if(U(b))return Q.bind(this,
this.change_denominator,this.set_denominator,L);if(V(b))return Q.bind(this,this.change_small_step,this.set_small_step,N);if(W(b))return Q.bind(this,this.change_large_step,this.set_large_step,J);if(X(b))return Q.bind(this,this.change_minimum,this.set_minimum,H);if(Y(b))return Q.bind(this,this.change_maximum,this.set_maximum,G)}return null}.bind(this);document.addEventListener(CTAT.Component.Base.Tutorable.EventType.action,function(a){var b=a.detail.sai;a=Z(a.detail.component);b&&null!==a&&a(b)},!1);
...
function(a){$(this.getDivWrap()).attr("data-ctat-ctrl-small-tick",a)};this.setParameterHandler("SmallTickmarkControllers",this.setSmallTickControllers);this.setDenominatorControllers=function(a){$(this.getDivWrap()).attr("data-ctat-ctrl-denominator",a)};this.setParameterHandler("DenominatorTickmarkControllers",this.setDenominatorControllers);a=function(a,b){return 0<=a().indexOf(b)};var Y=a.bind(null,M),X=a.bind(null,P),W=a.bind(null,K),V=a.bind(null,R),U=a.bind(null,T);this.grade=function(a){a=a.getDivWrap().id;
Y(a)?(this.setAction("set_maximum"),this.setInput(this.Maximum.toString())):X(a)?(this.setAction("set_minimum"),this.setInput(this.Minimum.toString())):W(a)?(this.setAction("set_large_step"),this.setInput(h.step.toString())):V(a)?(this.setAction("set_small_step"),this.setInput(m.step.toString())):U(a)?(this.setAction("set_denominator"),this.setInput(n.step.reciprocal().toString())):this.updateSAI();this.processAction(!0)};this.updateSAI=function(){for(var a=this._point_group.children,b=[],c=0;c<a.length;c++)b.push(a[c].value);
...
a.attr(c);d&&b.attr(c,d)});this.getDivWrap().innerHTML="";this.getDivWrap().appendChild(c);this.component.addEventListener("focus",this.processFocus);this.component.addEventListener("input",function(a){var b=Number(this.min);isNaN(b)&&(b=0);a=Number(this.value);if(isNaN(a))this.value=b;else if(""!==this.min&&a<b)this.value=b;else if(""!==this.max&&!isNaN(Number(this.max))&&a>Number(this.max))this.value=this.max;else{var c=Number(this.step);if(isNaN(c)||0>=c)c=1;b=(a-b)%c;0!==b&&(this.value=a-b)}})};
this.getConfigurationActions=function(){var a=[],b,c=$(this.getDivWrap());c.attr("min")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_minimum"),b.setInput(c.attr("min")),a.push(b));c.attr("max")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_maximum"),b.setInput(c.attr("max")),a.push(b));c.attr("step")&&(b=new CTATSAI,b.setSelection(this.getName()),b.setAction("set_step"),b.setInput(c.attr("step")),a.push(b));c.attr("value")&&(b=new CTATSAI,b.setSelection(this.getName()),
b.setAction("Update"),b.setInput(c.attr("value")),a.push(b));return a}};CTATNumericStepper.prototype=Object.create(CTAT.Component.Base.Tutorable.prototype);CTATNumericStepper.prototype.constructor=CTATNumericStepper;CTAT.ComponentRegistry.addComponentType("CTATNumericStepper",CTATNumericStepper);var CTATPieChart=function(a,b,e,f,d){CTAT.Component.Base.UnitDisplay.call(this,"CTATPieChart","aPieChart",a,b,e,f,d);var c=3,g=3,h=this,m,n,q,p=null,x=CTATGlobals.NameSpace.svg;this.init=function(){this.initSVG();this.baseGroup=document.createElementNS(x,"g");this.getComponent().appendChild(this.baseGroup);this.getComponent().classList.add("CTATPieChart--container");m=document.createElementNS(x,"filter");m.id=this.genName("Shadow");n="#"+m.id;q="url("+n+")";m.setAttributeNS(null,"width","200%");m.setAttributeNS(null,
"height","200%");p=document.createElementNS(x,"feOffset");p.setAttributeNS(null,"in","SourceAlpha");p.setAttributeNS(null,"result","offOut");p.setAttributeNS(null,"dx",g);p.setAttributeNS(null,"dy",g);m.appendChild(p);var a=document.createElementNS(x,"feGaussianBlur");a.setAttributeNS(null,"in","offOut");a.setAttributeNS(null,"result","blurOut");a.setAttributeNS(null,"stdDeviation",4);m.appendChild(a);a=document.createElementNS(x,"feBlend");a.setAttributeNS(null,"in","SourceGraphic");a.setAttributeNS(null,
"in2","blurOut");a.setAttributeNS(null,"mode","normal");m.appendChild(a);this.getComponent().getElementsByTagName("defs")[0].appendChild(m);0<g&&this.baseGroup.setAttributeNS(null,"filter",q);this.drawPieces();this.addComponentReference(this,this.getDivWrap());this.component.addEventListener("focus",this.processFocus);this.setStyles()};this.render=function(){this.drawPieces()};this.drawPieces=function(){if(this.baseGroup){this.clear();var a=window.getComputedStyle(this.getComponent()),a=parseFloat(a.getPropertyValue("stroke-width")),
b=this.getBoundingBox(),d=Math.min(b.width/2,b.height/2)-(a+g+4),e=new DOMPoint(b.width/2,b.height/2),a=this.parseValue(),f=document.createDocumentFragment();a.reduce(function(a,b,g,m){if(1<=b.valueOf())g=document.createElementNS(x,"circle"),g.classList.add("CTATPieChart--piece"),g.cx.baseVal.value=e.x,g.cy.baseVal.value=e.y,g.r.baseVal.value=d,this.addPieceElem(g,b,b.selected),f.appendChild(g);else{g=document.createElementNS(x,"path");g.classList.add("CTATPieChart--piece");f.appendChild(g);window.getComputedStyle(g);
var l=2*Math.PI*a.valueOf();m=e.add(CTAT.Geom.Point.polar(d,l));b.reduce();var n=e.add(CTAT.Geom.Point.polar(d,2*Math.PI*b.valueOf()+l)),p=e.clone();if(0<c&&c<d){l=CTAT.Geom.Point.polar(c,l+Math.PI*b.valueOf());p=p.add(l);m=m.add(l);var u=function(a,b,c){return a.distance(b)<a.distance(c)?b:c};m=CTAT.Geom.Point.circle_intersection(p,m,e,d).reduce(u.bind(this,m));n=n.add(l);n=CTAT.Geom.Point.circle_intersection(p,n,e,d).reduce(u.bind(this,n))}l=CTAT.Geom.Point.to2DString;p="M "+l(p);u=new DOMPoint(d,
d);p+=" L "+l(m);p+=" A "+l(u)+" 0 "+(.5<b.valueOf()?1:0)+",1 "+l(n);g.setAttributeNS(null,"d",p+" Z");h.addPieceElem(g,b,b.selected)}return a.add(b)},new CTAT.Math.Fraction);this.baseGroup.innerHTML="";this.baseGroup.appendChild(f);this.setColor(this.color);this.setDeselectedColor(this.deselectedColor);this.setDeselectedColorAlpha(this.deselectedColorAlpha)}};this.getExplode=function(){return c};this.getDropShadowDistance=function(){return g};this.setExplode=function(a){a=Number(a);if(!isNaN(a)){var b=
a!==c;c=a;b&&this.drawPieces()}return this};this.setStyleHandler("explode",this.setExplode);this.data_ctat_handlers.explode=function(a){this.setExplode(a)};this.setDropShadowDistance=function(a){g=parseInt(a);g=isNaN(g)?0:g;p&&(p.setAttributeNS(null,"dx",g),p.setAttributeNS(null,"dy",g),0>=g&&this.baseGroup?this.baseGroup.removeAttributeNS(null,"filter"):this.baseGroup.hasAttributeNS(null,"filter")||this.baseGroup.setAttributeNS(null,"filter",q))};this.data_ctat_handlers["shadow-distance"]=function(a){this.setDropShadowDistance(a)}};
CTATPieChart.prototype=Object.create(CTAT.Component.Base.UnitDisplay.prototype);CTATPieChart.prototype.constructor=CTATPieChart;CTAT.ComponentRegistry.addComponentType("CTATPieChart",CTATPieChart);var CTATRadioButton=function(a,b,e,f,d){CTAT.Component.Base.Clickable.call(this,"CTATRadioButton","__undefined__",a,b,e,f,d);var c=CTATConfiguration.get("previewMode"),g=this,h=null,m=null,n="#000000";this.setSelection(this.getComponentGroup());this.setAction("UpdateRadioButton");this.setStyleHandler("BackgroundColor",null);this.init=function(){g.setInitialized(!0);h=document.createElement("input");h.type="radio";h.id=this.getName()+"_radio";h.value=g.getName();this.getComponentGroup()?h.name=g.getComponentGroup():
this.getDivWrap()&&$(this.getDivWrap()).attr("name")?h.name=$(this.getDivWrap()).attr("name"):h.name="radioButtonGroup";!0===g.getEnabled()?h.disabled=!1:h.disabled=!0;g.addComponentReference(g,h);var a;c||(a=this.getDivWrap().innerHTML,this.getDivWrap().innerHTML="");g.getDivWrap().appendChild(h);m=document.createElement("label");m.htmlFor=h.id;this.getText()?m.textContent=g.getText():a&&!c?m.innerHTML=a:this.getDivWrap().getAttribute("data-ctat-label")&&(m.textContent=this.getDivWrap().getAttribute("data-ctat-label"));
g.setComponent(h);this.getDivWrap().appendChild(m);h.addEventListener("click",function(a){g.updateSAI();g.processAction()});h.addEventListener("focus",this.processFocus);h.onfocus=this.processOnFocus;this.setSelection(this.getComponentGroup());this.component.addEventListener("focus",this.processFocus);this.setStyles()};this.getConfigurationActions=function(){var a=[];if(0<m.innerHTML.trim().length){var b=new CTATSAI;b.setSelection(this.getName());b.setInput(m.innerHTML.toString());b.setAction("setText");
a.push(b)}return a};this.setFontColor=function(a){n=a;$(m).css("color",a)};this.getFontColor=function(){return n};this.resize=function(){var a=$(this.getDivWrap()).height();$(m).css("font-size",a-5+"px");$(this.getComponent()).css("height",a-10+"px");$(this.getComponent()).css("width",a-10+"px")};var q=this.setText;this.setText=function(a){q(a);null!==m&&(m.innerHTML=this.getText())};this.setStyleHandler("buttonLabel",this.setText);var p=this.setEnabled;this.setEnabled=function(a){p(a);null!==h&&
(h.disabled=!this.getEnabled())};this.setChecked=function(a){null!==h&&(h.checked=a)};this.getChecked=function(){return h.checked};this.getRadioInput=function(){return h.checked?h.value+": "+m.textContent:""};this.setStyleHandler("labelPlacement",null);this.reset=function(){g.ctatdebug(" reset ( "+g.getName()+")");h.checked=!1;g.setEnabled(!0)};this.UpdateRadioButton=function(a){0<=a.indexOf(h.value)&&g.setChecked(!0);g.ctatdebug("UpdateRadioButton ()")};this.updateSAI=function(){var a=$('div[data-ctat-component]:has(input[type="radio"][name="'+
h.name+'"]:checked)'),b="";1===a.length&&(b=$(a[0]).data("CTATComponent").getRadioInput());g.setSelection(h.name);g.setInput(b)};var x=function(a){m&&m.classList.add(a);h&&h.classList.add(a)},l=function(a){m&&m.classList.remove(a);h&&h.classList.remove(a)};this.showCorrect=function(a){l("CTAT--hint");l("CTAT--incorrect");(a?0===a.getInput().indexOf(h.value):1)?x("CTAT--correct"):l("CTAT-correct")};this.removeCorrect=function(){l("CTAT--correct")};this.showInCorrect=function(a){l("CTAT--hint");l("CTAT--correct");
(a?0===a.getInput().indexOf(h.value):1)?x("CTAT--incorrect"):l("CTAT-incorrect")};this.removeInCorrect=l.bind(this,"CTAT--incorrect");this.showHintHighlight=function(a){this.removeCorrect();this.removeInCorrect();a?x("CTAT--hint"):l("CTAT--hint")}};CTATRadioButton.prototype=Object.create(CTAT.Component.Base.Clickable.prototype);CTATRadioButton.prototype.constructor=CTATRadioButton;CTAT.ComponentRegistry.addComponentType("CTATRadioButton",CTATRadioButton);var CTATScrollPaneComponent=function(a,b,e,f,d){CTAT.Component.Base.Tutorable.call(this,"CTATScrollPaneComponent","__undefined__",a,b,e,f,d);var c=0,g=this;g.isTabIndexable=!1;this.getAlpha=function(){return c};this.setAlpha=function(a){c=a};this.init=function(){g.ctatdebug("init ("+g.getName()+")");g.ctatdebug("Final location: "+g.getX()+","+g.getY()+" with text: "+g.getText());g.setInitialized(!0)};this.processCommShellEvent=function(a,b){g.ctatdebug("processCommShellEvent ("+a+")")};this.processSerialization=
...
f.getLevel()+" ...");var x=document.createElement("div");x.classList.add("CTATSkillWindow--skill");var l=document.createElement("div");l.classList.add("CTATSkillWindow--bar");var v=document.createElement("div"),u=f.getLevel();u<d?v.classList.add("CTATSkillWindow--bar--nonmastered"):v.classList.add("CTATSkillWindow--bar--mastery");v.style.width=u>d?"100%":100*u+"%";l.appendChild(v);x.appendChild(l);b.appendChild(x);l=document.createElement("div");l.textContent=f.getDisplayName()||"no-name";l.classList.add("CTATSkillWindow--label");
x.appendChild(l)}g.innerHTML="";g.appendChild(b)}}}};CTATSkillWindow.prototype=Object.create(CTAT.Component.Base.Graphical.prototype);CTATSkillWindow.prototype.constructor=CTATSkillWindow;CTAT.ComponentRegistry.addComponentType("CTATSkillWindow",CTATSkillWindow);var CTATSubmitButton=function(a,b,e,f,d){CTATButton.call(this,a,b,e,f,d);this.setClassName("CTATSubmitButton");CTATConfiguration.get("previewMode");var c=this;this.setParameterHandler("target_components",function(a){this.getDivWrap().setAttribute("data-ctat-target",a);return this});var g=this.init;this.init=function(){g();this.setParameter("tutorComponent",CTAT.Component.Base.Tutorable.Options.DO_NOT_TUTOR);this.component.addEventListener("focus",this.processFocus);this.setStyles()};var h=function(a){var b=
...
CTATTextBasedComponent.prototype.constructor=CTATTextBasedComponent;var CTATTextArea=function(a,b,e,f,d){CTATTextBasedComponent.call(this,"CTATTextArea","__undefined__",a,b,e,f,d);this.setDefaultWidth(100);this.setDefaultHeight(44);var c=this,g=null,h=null,m=CTATConfiguration.get("previewMode");this.setAction("UpdateTextArea");this.init=function(){g=document.createElement("textarea");a&&(g.name=a.name);g.setAttribute("id",CTATGlobalFunctions.gensym.div_id());g.classList.add("CTAT-text");var b=this.getDivWrap();b&&$(b).attr("maxlength")&&(g.maxlength=$(b).attr("maxlength"));
b&&$(b).attr("rows")&&(g.rows=$(b).attr("rows"));b&&$(b).attr("cols")&&(g.cols=$(b).attr("cols"));c.setComponent(g);b&&$(b).attr("value")?this.setText($(b).attr("value")):g.value=this.getText();c.setInitialized(!0);c.addComponentReference(c,g);b.appendChild(g);this.setStyles();$(g).keypress(c.processKeypress);g.addEventListener("focus",c.processFocus);$(g).on("input",function(a){c.setNotGraded()});m&&this.addDblClickListener()};this.processBlur=function(a){c.processAction()};this.setCellContainer=
function(a){h=a};this.getCellContainer=function(){return h};this.setText=function(a){c.ctatdebug("setText ("+a+")");c.assignText(a);g.value=a};this.getValue=function(){return g.value};this.reset=function(){c.configFromDescription();c.processSerialization();g.value=""}};CTATTextArea.prototype=Object.create(CTATTextBasedComponent.prototype);CTATTextArea.prototype.constructor=CTATTextArea;CTAT.ComponentRegistry.addComponentType("CTATTextArea",CTATTextArea);var CTATTable=function(a,b,e,f,d){CTAT.Component.Base.Tutorable.call(this,"CTATTable","__undefined__",a,b,e,f,d);var c=this;c.isTabIndexable=!1;var g=CTATConfiguration.get("previewMode"),h=[],m=[];this.get_first_row_is_header=function(){return CTATGlobalFunctions.toBoolean($(this.getDivWrap()).attr("data-ctat-has-header"))};this.setParameterHandler("FirstRowIsHeader",function(a){$(this.getDivWrap()).attr("data-ctat-has-header",a)});var n=0;this.setParameterHandler("PasteSingleSAI",function(a){CTATGlobalFunctions.stringToBoolean(a)});
...
(x(),n=1):n=0;this.setStyles()};var x=function(){$(this.getDivWrap()).children().first().addClass("CTATTable--headers").children().addClass("CTATTable--header")}.bind(this),l=function(a,b){var c=document.createElement("div"),d=this.getName()+".R"+a+"C"+b;c.id=d;c.classList.add("CTATTable--cell");c.classList.add("CTATTextArea");$(c).css("height","100%");var e=new CTATTextArea;e.setName(d);e.setDivWrapper(c);e.processAttributes();e.init();e.processTabOrder();g?e.setEnabled(!1):e.setEnabled(this.getEnabled());
$(c).data("CTATComponent",e);return c}.bind(this);this.addRow=function(){var a=document.createElement("div");a.classList.add("CTATTable--row");var b=q();parseInt(b,10);h[b]=[];for(var c=0;c<p();c++){var d=l(b,c);h[b].push(d);a.appendChild(d)}$(this.getDivWrap()).append(a);m.push(a);this.set_row_count(b+1);this.resize()};this.deleteRow=function(){var a=this.getDivWrap();a.removeChild(a.lastChild);m.pop();h.pop();this.set_row_count(this.get_row_count()-1);this.resize()};this.addColumn=function(){var a=
p(),b=0;m.forEach(function(c){var d=l(b,a);h[b].push(d);b<n&&d.classList.add("CTATTable--header");c.appendChild(d);b++});this.set_col_count(a+1);this.resize()};this.deleteColumn=function(){this.getDivWrap();for(var a=m.length,b=0;b<a;b++)m[b].removeChild(m[b].lastChild),h[b].pop();this.set_col_count(this.get_col_count()-1);this.resize()};this.resizeWidth=function(){if(h&&h[0])for(var a=h.length,b=h[0].length,c=Math.floor($(this.getDivWrap()).width()/b),d=0;d<a;d++)for(var e=0;e<b;e++)$(h[d][e]).css("width",
c+"px")};this.resizeHeight=function(){if(m)for(var a=m.length,b=0;b<a;b++)$(m[b]).css("height",Math.floor($(this.getDivWrap()).height()/a)+"px")};this.resize=function(a){a?"width"==a?this.resizeWidth():this.resizeHeight():(this.resizeWidth(),this.resizeHeight())};var v=function(a){var b=document.createElement("div");a=this.getName()+".R0C"+a;b.id=a;b.classList.add("CTATTable--header");b.classList.add("CTATTextField");var c=new CTATTextField;c.setName(a);c.setDivWrapper(b);c.processAttributes();c.init();
c.processTabOrder();$(b).data("CTATComponent",c);return b}.bind(this);(function(){var a=document.createElement("div");a.classList.add("CTATTable--headers");a.classList.add("CTATTable--row");$(this.getDivWrap()).prepend(a);for(var b=0;b<p();b++){var c=v(b);a.appendChild(c)}n=1}).bind(this);this.adjustTableContents=function(){c.ctatdebug("adjustTableContents()");for(var a=q(),b=0;b<a;b++){var d=document.createElement("div");d.classList.add("CTATTable--row");$(this.getDivWrap()).append(d);m.push(d);
for(var e=0;e<p();e++){var g=c.getName()+".R"+b+"C"+e,f=CTATShellTools.findComponent(g);f&&0!==f.length&&f[0].getName()===g?(g=f[0].getDivWrap(),g.classList.add("CTATTable--cell")):g=l(b,e);d.appendChild(g);h[b]||(h[b]=[]);h[b].push(g)}}this.resize()}};CTATTable.prototype=Object.create(CTAT.Component.Base.Graphical.prototype);CTATTable.prototype.constructor=CTATTable;CTAT.ComponentRegistry.addComponentType("CTATTable",CTATTable);var CTATTextField=function(a,b,e,f,d){CTATTextBasedComponent.call(this,"CTATTextBasedComponent","__undefined__",a,b,e,f,d);var c=this,g=null;this.setAction("UpdateTextArea");this.init=function(){g=this.getDivWrap();c.setComponent(g);this.getText()&&(g.innerHTML=c.getText());c.setInitialized(!0);c.addComponentReference(c,g);c.setEditable(!1);c.setEnabled(!1);c.render();c.addSafeEventListener("focus",c.processFocus,g)};this.getConfigurationActions=function(){return 0<g.innerHTML.trim().length?(console.log(g.innerHTML),
...
h.autoplay=!0;g.ctatdebug("Auto play: "+h.autoplay);h.name=g.getName();h.setAttribute("id",CTATGlobalFunctions.gensym.div_id());h.setAttribute("onkeypress","return noenter(event)");g.addComponentReference(g,h);g.ctatdebug("Final location: "+g.getX()+","+g.getY()+" with text: "+g.getText());g.setInitialized(!0);g.getDivWrap().appendChild(h);g.ctatdebug("Resizing component to: "+$(g.getDivWrap()).width()+","+$(g.getDivWrap()).height());h.addEventListener("focus",this.processFocus);h.addEventListener("canplay",
function(){g.ctatdebug("Video loaded and ready for play")},!0);h.addEventListener("play",function(){g.ctatdebug("Video loaded and ready for play");g.logVideoEvent("play")},!0);h.addEventListener("pause",function(){g.ctatdebug("Video loaded and ready for play");g.logVideoEvent("pause")},!0);h.setAttribute("width",$(g.getDivWrap()).width());h.setAttribute("height",$(g.getDivWrap()).height())};this.logVideoEvent=function(a){g.ctatdebug("logVideoEvent ("+a+")");if(void 0!==h.duration)if(null!==CTATCommShell.commShell){a=
new CTATSAI(g.getName(),a,g.toHHMMSS(h.currentTime)+".000","");a.addSelection(encodeURIComponent(h.currentSrc),"media_file");a.addSelection(g.toHHMMSS(h.duration)+".000","clip_length");var b=a.getInputObject();null!==b&&b.setType("time");CTATCommShell.commShell.processComponentAction(a,g.getTutorComponent,!0,g,"VIDEO_ACTION","USER")}else g.ctatdebug("Error: commShell is null, can't send untutored tool message");else g.ctatdebug("Error: audio file not loaded yet, can't obtain duration")};this.PlayMedia=
function(a){h.src=a};this.showControls=function(a){h.controls=a};this.play=function(a){g.ctatdebug("play ()");var b="0";a&&(b="number"===typeof a?String(a):"string"===typeof a?a:"0");h.currentTime=b;h.play()};this.pause=function(a){g.ctatdebug("pause ()");h.pause();var b="0";a&&(b="number"===typeof a?String(a):"string"===typeof a?a:"0");h.currentTime=b};this.stop=function(){g.ctatdebug("stop ()");g.pause()}};CTATVideo.prototype=Object.create(CTAT.Component.Base.Tutorable.prototype);
...
f.type=a.getClassName();f.name=a.getName();f.setComponentPointer(a);CTATShellTools.registerComponentDescription(f)}$(this).data("CTATComponent",a);CTATConfiguration.get("previewMode")&&((f=ctatEnabledInPreview[a.getClassName()])||(f=!1),a.setEnabled(f),a.getDivWrap().setAttribute("data-ctat-enabled","true"))}})}CTATShellTools.listComponents();console.log("initializeHTMLComponents () done")};
CTATTutor.callComponentFunction=function(a,b,e){var f=CTATShellTools.findComponent(a.id);if(f&&0<f.length)return a=f[0],f=null,b&&(f=b(a,e)),f;console.log("Couldn't find CTATComponent registered to div "+a.id)};function assignNameTranslator(a){nameTranslator=a}CTATTutor.drawTutor=function(){if(!0!==this.drawing){this.drawing=!0;for(var a in CTATShellTools.component_descriptions){var b=CTATShellTools.component_descriptions[a].getComponentPointer();null!==b&&b.drawComponent()}this.drawing=!1}};
...
e&&(ctatdebug("Registering existence of CTAT component on MovieClip container: "+c),e.addComponent(c))}var g,h,m,n;"shape"==this.parser.getElementName(d)&&(g=this.parser.getElementAttr(d,"x"),h=this.parser.getElementAttr(d,"y"),m=this.parser.getElementAttr(d,"width"),n=this.parser.getElementAttr(d,"height"),c=this.parser.getElementAttr(d,"instance"),ctatdebug("Creating shape: "+c+" at: "+g+","+h+","+m+","+n),m="data:image/png;base64, "+this.parser.getNodeTextValue(d),n=new Image,n.setAttribute("style",
"position: absolute; top: "+h+"px; left:"+g+"px; z-index:"+CTATGlobalFunctions.gensym.z_index()+";"),n.setAttribute("id",c),n.setAttribute("src",m),f.appendChild(n));"statictext"==this.parser.getElementName(d)&&(g=this.parser.getElementAttr(d,"x"),h=this.parser.getElementAttr(d,"y"),m=this.parser.getElementAttr(d,"width"),n=this.parser.getElementAttr(d,"height"),c=this.parser.getElementAttr(d,"instance"),ctatdebug("Creating static text: "+c+" at: "+g+","+h+","+m+","+n),m="data:image/png;base64, "+
this.parser.getNodeTextValue(d),n=new Image,n.setAttribute("style","position: absolute; top: "+h+"px; left:"+g+"px; z-index:"+CTATGlobalFunctions.gensym.z_index()+";"),n.setAttribute("id",c),n.setAttribute("src",m),f.appendChild(n));"statictext"==this.parser.getElementName(d)&&(c=this.parser.getElementAttr("instance"),ctatdebug("Creating movieclip: "+c),g=this.parser.getElementAttr(d,"x"),h=this.parser.getElementAttr(d,"y"),m=this.parser.getElementAttr(d,"width"),n=this.parser.getElementAttr(d,"height"),
g=new CTATMovieClip(c,g,h,m,n),h=g.wrapComponent(f),ctatdebug("Created movieclip: "+c+" at: "+g.x+","+g.y+","+g.width+","+g.height),movieclips.push(g),d=this.parser.getElementChildren(d),this.createStaticInterface(h,d,g))}};
CTATTutor.runTutor=function(a){console.log("runTutor ()");!0===CTATGlobals.tutorRunning?ctatdebug("The tutor is already running"):(null==CTATSkillSet.skills&&(CTATSkillSet.skills=new CTATSkillSet),window.onerror=function(a,e,f){var b=new CTATHTMLManager;ctatdebug(b.htmlEncode(a)+" in "+e+", line "+f)},centerTutorContainer(),CTATTutor.initialize(),CTATGlobals.tutorRunning=!0,ctatdebug("runTutor () ... all set"))};
CTATTutor.initTutor=function(a,b,e,f){console.log("initTutor() #aFlashVars "+(a?a.length:null)+", usingFlash "+f);1==CTATTutor.tutorInitialized?(console.log("Tutor already initialized, probably in author mode"),a.previewMode&&(CTATScrim.scrim.scrimDown(),console.log("In preview mode..."))):(CTATConfiguration.generateDefaultConfigurationObject(),CTATConfiguration.setParams(a),"true"==CTATConfiguration.get("show_debug_traces")&&(useDebuggingBasic=!0),null==f&&(f=CTATConfiguration.usingFlash()),f&&CTATScrim.scrim.scrimDown(),
CTATCommLibrary.setAuthenticityToken(CTATConfiguration.get("authenticity_token")),b&&(ctatcontainer=b),(a=document.getElementById(ctatcontainer))&&a.classList.add("CTATTutorContainer"),a=getSafeElementById("debugtraces"),null!==a&&(useDebugging=!0===a.checked?!0:!1),a=CTATConfiguration.getRawFlashVars(),console.log("initTutor() tempFlashVars[mode] "+a.mode+", window.sendToTutor "+window.sendToTutor),a.swf_name&&!window.sendToTutor&&(window.sendToTutor=function(a){ctatdebug("window.sendToTutor("+a+
") CTAT.ToolTutor.tutor "+CTAT.ToolTutor.tutor);return CTAT.ToolTutor.tutor?CTAT.ToolTutor.tutor.receiveFromInterface(a):CTAT.ToolTutor.tutorMessages.push(a)},window.registerInterface=function(a){CTAT.ToolTutor.registerInterfaceMessageHandler(a)}),"javascript"==String(a.tutoring_service_communication).toLowerCase()&&("undefined"!=typeof CTATExampleTracer&&CTATExampleTracer?CTAT.ToolTutor.registerTutor(new CTATExampleTracer):CTATScrim.scrim.warningScrimUp('Tutoring service communication parameter is "JavaScript" but class\nCTATExampleTracer is missing. Use a different ctat-*.js script.')),
console.log("initTutor ()"),"applet"==a.tutoring_service_communication&&deployJava.runApplet({id:"TSApplet",width:150,height:10},{jnlp_href:"/ctat_applet/TSApplet.jnlp"},"1.6"),f||CTATTutor.runTutor(a),CTATTutor.tutorInitialized=!0)};window.hasOwnProperty("initTutor")||(window.initTutor=CTATTutor.initTutor);function receiveFromTutor(){ctatdebug("receiveFromTutor ()")}function saveAndQuit(){ctatdebug("saveAndQuit ()")}function prepTutorArea(){initTutor()}window.prepTutorArea=prepTutorArea;
...
b=document.createElement("canvas"),b.id="main-canvas",b.innerHTML="Your browser does not support CTAT. Please update or use another browser.",ctatdebug("Setting canvas to: 0,0,"+f+" , "+d),getSafeElementById(ctatcontainer).appendChild(b)):(ctatdebug("Setting canvas to: 0 , 0, "+f+" , "+d),b.style.top="0",b.style.left="0");b.style.width=f+"px";b.style.height=d+"px";return b};CTATIFrameManager=function(){var a={},b=this;this.initFrame=function(b,f,d){var c=b?b.getAttribute("id"):null;c?a[c]={domNode:b,initialDom:f,initialMode:d}:console.error("iFrames managed by CTATIFrameManager must exist and have unique ids");b.contentWindow.CTATTarget=d;this.writeData(b,f)};this.refresh=function(b){var e=a[b];e.domNode?(e.domNode.setAttribute("src","about:blank"),this.writeData(e.domNode,e.initialDom)):console.warn("CTATIFrameManager: iFrame id "+b+" not found")};this.writeData=function(a,
b){if(a){var d=a.contentDocument||a.contentWindow.document;d.open();d.write(b);d.close()}};document.addEventListener("refreshIframe",function(a){a=a.detail;console.log("refresh event for iframe "+a);b.refresh(a)})};(function(a){function b(){var a=arguments[0],c=b.cache;c[a]&&c.hasOwnProperty(a)||(c[a]=b.parse(a));return b.format.call(null,c[a],arguments)}function e(a){return Object.prototype.toString.call(a).slice(8,-1).toLowerCase()}var f=/[^s]/,d=/[def]/,c=/^[^\x25]+/,g=/^\x25{2}/,h=/^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/,m=/^([a-z_][a-z_\d]*)/i,n=/^\.([a-z_][a-z_\d]*)/i,q=/^\[(\d+)\]/,p=/^[\+\-]/;b.format=function(a,c){var g=1,h=a.length,l,m=[],n,q,v,x,D=!0,
r="";for(n=0;n<h;n++)if(l=e(a[n]),"string"===l)m[m.length]=a[n];else if("array"===l){v=a[n];if(v[2])for(l=c[g],q=0;q<v[2].length;q++){if(!l.hasOwnProperty(v[2][q]))throw Error(b("[sprintf] property '%s' does not exist",v[2][q]));l=l[v[2][q]]}else l=v[1]?c[v[1]]:c[g++];"function"==e(l)&&(l=l());if(f.test(v[8])&&"number"!=e(l)&&isNaN(l))throw new TypeError(b("[sprintf] expecting number but found %s",e(l)));d.test(v[8])&&(D=0<=l);switch(v[8]){case "b":l=l.toString(2);break;case "c":l=String.fromCharCode(l);
break;case "d":l=parseInt(l,10);break;case "e":l=v[7]?l.toExponential(v[7]):l.toExponential();break;case "f":l=v[7]?parseFloat(l).toFixed(v[7]):parseFloat(l);break;case "o":l=l.toString(8);break;case "s":l=(l=String(l))&&v[7]?l.substring(0,v[7]):l;break;case "u":l>>>=0;break;case "x":l=l.toString(16);break;case "X":l=l.toString(16).toUpperCase()}if(!D||d.test(v[8])&&v[3])r=D?"+":"-",l=l.toString().replace(p,"");q=v[4]?"0"==v[4]?"0":v[4].charAt(1):" ";x=v[6]-(r+l).length;x=v[6]?Array(x+1).join(q):
"";m[m.length]=v[5]?r+l+x:0==q?r+x+l:x+r+l}return m.join("")};b.cache={};b.parse=function(a){for(var b,d=[],e=0;a;){if(null!==(b=c.exec(a)))d[d.length]=b[0];else if(null!==(b=g.exec(a)))d[d.length]="%";else if(null!==(b=h.exec(a))){if(b[2]){var e=e|1,f=[],l=b[2],p;if(null!==(p=m.exec(l)))for(f[f.length]=p[1];""!==(l=l.substring(p[0].length));)if(null!==(p=n.exec(l)))f[f.length]=p[1];else if(null!==(p=q.exec(l)))f[f.length]=p[1];else throw new SyntaxError("[sprintf] failed to parse named argument key");
...
(function(){var a,b=function(a,b){function c(){this.constructor=a}for(var d in b)e.call(b,d)&&(a[d]=b[d]);c.prototype=b.prototype;a.prototype=new c;a.__super__=b.prototype;return a},e={}.hasOwnProperty;a=function(a){function d(a,b,d,e,f,q){this.operator=a;this.left=b;this.right=d;this.parens=null!=e?e:0;this.sign=null!=f?f:1;this.exp=null!=q?q:1}b(d,a);d.prototype.clone=function(){return new d(this.operator,this.left.clone(),this.right.clone(),this.parens,this.sign,this.exp)};d.prototype.toString=
...
d,e,f;f=b.constant()?[null,b]:b.power()?b.exponent.constant()?(b.pushInversion(),[b.base,b.exponent]):(b.exponent=b.exponent.multiplyOne(),[b,b.exponent.factors.shift()]):(b=b.powerOne(),[b.base,b.exponent]);return(c=a.find(function(a){var b;return null!=(b=a[0])?b.equals(f[0]):void 0}))?c[1]+=(null!=(d=f[1])?d.evaluate():void 0)||1:a.push([f[0],(null!=(e=f[1])?e.evaluate():void 0)||1])});this.factors=a.reduce(function(a,b){0!==b[1]&&(b[1]=(new CTATConstantNode(b[1])).popNegation(),b[0]?b[1].constant(1)?
...
(function(){var a,b=function(a,b){function c(){this.constructor=a}for(var d in b)e.call(b,d)&&(a[d]=b[d]);c.prototype=b.prototype;a.prototype=new c;a.__super__=b.prototype;return a},e={}.hasOwnProperty;a=function(a){function d(a,b,d,e,f,q){this.operator=a;this.dividend=b;this.divisor=d;this.parens=null!=e?e:0;this.sign=null!=f?f:1;this.exp=null!=q?q:1}b(d,a);d.prototype.clone=function(){return new d(this.operator,this.dividend.clone(),this.divisor.clone(),this.parens,this.sign,this.exp)};d.prototype.toString=
...
(function(){var a,b=function(a,b){function c(){this.constructor=a}for(var d in b)e.call(b,d)&&(a[d]=b[d]);c.prototype=b.prototype;a.prototype=new c;a.__super__=b.prototype;return a},e={}.hasOwnProperty;a=function(a){function d(a,b,d,e,f,q){this.operator=a;this.base=b;this.exponent=d;this.parens=null!=e?e:0;this.sign=null!=f?f:1;this.exp=null!=q?q:1}b(d,a);d.prototype.clone=function(){return new d(this.operator,this.base.clone(),this.exponent.clone(),this.parens,this.sign,this.exp)};d.prototype.toString=
...
a);break;case 26:this.$=new d.CTATConstantNode(Number(a))}},table:[{3:1,4:2,6:3,13:e,14:4,15:f,17:5,19:8,22:9,24:d,25:c,27:g,28:h},{1:[3]},{5:[1,14]},{5:[2,8],7:[1,15],8:[1,16],9:[1,17],10:[1,18],11:[1,19],12:[1,20],13:m,15:n},b(q,[2,11],{22:9,19:25,16:p,18:x,20:l,21:v,24:d,25:c,27:g,28:h}),b(u,[2,17]),{13:e,15:f,17:28,19:8,22:9,24:d,25:c,27:g,28:h},{13:e,15:f,17:29,19:8,22:9,24:d,25:c,27:g,28:h},b(u,[2,20]),b(u,[2,23],{23:[1,30]}),{13:e,15:f,17:31,19:8,22:9,24:d,25:c,27:g,28:h},{6:32,13:e,14:4,15:f,
...
25:c,27:g,28:h},{13:e,15:f,17:41,19:8,22:9,24:d,25:c,27:g,28:h},{13:e,15:f,17:42,19:8,22:9,24:d,25:c,27:g,28:h},b(u,[2,14]),{13:e,15:f,17:43,19:8,22:9,24:d,25:c,27:g,28:h},{13:e,15:f,17:44,19:8,22:9,24:d,25:c,27:g,28:h},b(u,[2,18]),b(u,[2,19]),{13:e,15:f,17:45,19:8,22:9,24:d,25:c,27:g,28:h},b(u,[2,22]),{13:m,15:n,26:[1,46]},{5:[2,2],13:m,15:n},{5:[2,3],13:m,15:n},{5:[2,4],13:m,15:n},{5:[2,5],13:m,15:n},{5:[2,6],13:m,15:n},{5:[2,7],13:m,15:n},b(q,[2,9],{22:9,19:25,16:p,18:x,20:l,21:v,24:d,25:c,27:g,
28:h}),b(q,[2,10],{22:9,19:25,16:p,18:x,20:l,21:v,24:d,25:c,27:g,28:h}),b(u,[2,12]),b(u,[2,13]),b(u,[2,15]),b(u,[2,16]),b(u,[2,21]),b(B,[2,24])],defaultActions:{14:[2,1]},parseError:function(a,b){if(b.recoverable)this.trace(a);else{var c=function(a,b){this.message=a;this.hash=b};c.prototype=Error;throw new c(a,b);}},parse:function(a){var b=[0],c=[null],d=[],e=this.table,f="",g=0,h=0,l=0,n=d.slice.call(arguments,1),m=Object.create(this.lexer),p={},q;for(q in this.yy)Object.prototype.hasOwnProperty.call(this.yy,
q)&&(p[q]=this.yy[q]);m.setInput(a,p);p.lexer=m;p.parser=this;"undefined"==typeof m.yylloc&&(m.yylloc={});q=m.yylloc;d.push(q);var v=m.options&&m.options.ranges;this.parseError="function"===typeof p.parseError?p.parseError:Object.getPrototypeOf(this).parseError;for(var u,x,t,B,M={},P,K;;){t=b[b.length-1];if(this.defaultActions[t])B=this.defaultActions[t];else{if(null===u||"undefined"==typeof u)u=m.lex()||1,"number"!==typeof u&&(u=this.symbols_[u]||u);B=e[t]&&e[t][u]}if("undefined"===typeof B||!B.length||
!B[0]){var R;K=[];for(P in e[t])this.terminals_[P]&&2<P&&K.push("'"+this.terminals_[P]+"'");R=m.showPosition?"Parse error on line "+(g+1)+":\n"+m.showPosition()+"\nExpecting "+K.join(", ")+", got '"+(this.terminals_[u]||u)+"'":"Parse error on line "+(g+1)+": Unexpected "+(1==u?"end of input":"'"+(this.terminals_[u]||u)+"'");this.parseError(R,{text:m.match,token:this.terminals_[u]||u,line:m.yylineno,loc:q,expected:K})}if(B[0]instanceof Array&&1<B.length)throw Error("Parse Error: multiple actions possible at state: "+
t+", token: "+u);switch(B[0]){case 1:b.push(u);c.push(m.yytext);d.push(m.yylloc);b.push(B[1]);u=null;x?(u=x,x=null):(h=m.yyleng,f=m.yytext,g=m.yylineno,q=m.yylloc,0<l&&l--);break;case 2:K=this.productions_[B[1]][1];M.$=c[c.length-K];M._$={first_line:d[d.length-(K||1)].first_line,last_line:d[d.length-1].last_line,first_column:d[d.length-(K||1)].first_column,last_column:d[d.length-1].last_column};v&&(M._$.range=[d[d.length-(K||1)].range[0],d[d.length-1].range[1]]);t=this.performAction.apply(M,[f,h,
g,p,B[1],c,d].concat(n));if("undefined"!==typeof t)return t;K&&(b=b.slice(0,-2*K),c=c.slice(0,-1*K),d=d.slice(0,-1*K));b.push(this.productions_[B[1]][0]);c.push(M.$);d.push(M._$);B=e[b[b.length-2]][b[b.length-1]];b.push(B);break;case 3:return!0}}}},e=function(){return{EOF:1,parseError:function(a,b){if(this.yy.parser)this.yy.parser.parseError(a,b);else throw Error(a);},setInput:function(a,b){this.yy=b||this.yy||{};this._input=a;this._more=this._backtrack=this.done=!1;this.yylineno=this.yyleng=0;this.yytext=
...
(function(){var a,b,e,f,d,c,g,h,m,n,q,p=[].slice;d=/^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;f=/^\d+(\.\d\d)?$/;c=RegExp("((\\d+)\\.?(\\d+)?|\\.(\\d+))([Ee]([+-]?\\d+))?","g");n=/^[+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?$/;m=/^\s*\(\s*([+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?)\s*\,\s*([+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?)\s*\)\s*$/;h=/([bcdfghjklmnpqrstvwxz]|qu)y$/;g=/([bcdfghjklmnpqrstvwxz]o|[sc]h|s)$/;q=function(a,b){var c;null==b&&(b=!1);var d,e,f,g;f=null!=(c=a[4])?c:a[2]+(a[3]||
...
p.call(arguments,1):[];a=this.fmtDollar(a,"i");return b.some(function(b){return function(c){return a===b.fmtDollar(c,"i")}}(this))};a.matchWithPrecision=function(a,c){var d,e;return(d=String(a).match(n))&&(e=String(c).match(n))&&q(d)===q(e)&&b(a,c,function(a,b){return a===b})};a.matchWithoutPrecision=function(a,c){var d,f;return(d=String(a).match(n))&&(f=String(c).match(n))&&(a=q(d)>q(f)?(+a).toFixed(e(f)):String(a))&&b(a,c,function(a,b){return a===b})};a.constantsConform=function(){var a,b;a=arguments[0];
...
e(a))};this.setSingle(b);this.simpleSinglePattern=b};CTATWildcardMatcher.prototype=Object.create(CTATRegexMatcher.prototype);CTATWildcardMatcher.prototype.constructor=CTATWildcardMatcher;"undefined"!==typeof module&&(module.exports=CTATWildcardMatcher);var CTATVectorMatcher=function(a,b,e,f){function d(a,b,d,e,f){n.ctatdebug("CTATVectorMatcher --\x3e in _match("+a+", "+b+", "+d+", "+e+")");if(0===c.length||0===g.length||0===h.length)c.push(new CTATExactMatcher(CTATMatcher.SELECTION,n.array2ConcatString(n.getDefaultSelectionArray()))),g.push(new CTATExactMatcher(CTATMatcher.ACTION,n.array2ConcatString(n.getDefaultActionArray()))),h.push(new CTATExactMatcher(CTATMatcher.INPUT,n.array2ConcatString(n.getDefaultInputArray())));var l=[];l[CTATMatcher.SELECTION]=
a;l[CTATMatcher.ACTION]=b;l[CTATMatcher.INPUT]=d;for(var p=0;3>p;p++){var q=m[p][0],u=q instanceof CTATExpressionMatcher?q.matchConcatenation(a,b,d,e):q.matchConcatenation(l[p]);n.ctatdebug("CTATVectorMatcher --\x3e in _match["+p+"] after "+q+".concat returns: "+u);if(f)f.push(u);else if(!1===u)return!1}if(f)for(a=0;a<f.length;++a)if(!f[a])return!1;return!0}CTATMatcher.call(this,!0,CTATMatcher.VECTOR,!0);var c=a instanceof Array?a:[],g=b instanceof Array?b:[],h=e instanceof Array?e:[],m=[];m[CTATMatcher.SELECTION]=
c;m[CTATMatcher.ACTION]=g;m[CTATMatcher.INPUT]=h;var n=this;this.match=function(a,b,c,e,f){return!1!==d(a,b,c,f)&&n.matchActor(e)?!0:!1};this.getMatchers=function(a){return m[a]};this.getTutorSAI=function(a,b,c){n.ctatdebug("CTATVectorMatcher.getTutorSAI("+a+", vt, "+c+")");if(c&&CTATExampleTracerLink.CORRECT_ACTION.toLowerCase()==c.toLowerCase())return a;var e=[];if(d(a.getSelectionArray(),a.getActionArray(),a.getInputArray(),b,e))return c=a.clone(),a=n.evaluateReplacement(a,b,null),null!=a&&c.setInput("object"==
typeof a?a.toString():a),c;c=a.clone();for(a=0;a<e.length;a++)switch(a){case CTATMatcher.SELECTION:if(e[a])continue;c.setSelection(n.getDefaultSelection());c.setSelectionArray(n.getDefaultSelectionArray());break;case CTATMatcher.ACTION:if(e[a])continue;c.setAction(n.getDefaultAction());c.setActionArray(n.getDefaultActionArray());break;case CTATMatcher.INPUT:if(e[a])continue;c.setInput(n.getDefaultInput());c.setInputArray(n.getDefaultInputArray());break;default:console.log("CTATVectorMatcher.getTutorSAI() unexpected no. of details: "+
a)}return c};this.getInputMatcher=function(){var a=h[0];return a instanceof CTATExactMatcher&&a.toString()==="".toString()?n.getDefaultInput():a.toString()};this.getActionMatcher=function(){var a=g[0];return a instanceof CTATExactMatcher&&a.toString()==="".toString()?n.getDefaultAction():a.toString()};this.getSelectionMatcher=function(){var a=c[0];return a instanceof CTATExactMatcher&&a.toString()==="".toString()?n.getDefaultSelection():a.toString()};this.getSingleMatcher=function(a){return"selection".toString().toUpperCase()===
a.toString().toUpperCase()?c[0]:"action".toString().toUpperCase()===a.toString().toUpperCase()?g[0]:h[0]};var q=n.getDefaultSAI;this.getDefaultSAI=function(){var a=q.apply(n),b=0<c.length&&c[0]instanceof CTATExactMatcher?c[0].getSingle():a.getSelection(),d=0<g.length&&g[0]instanceof CTATExactMatcher?g[0].getSingle():a.getAction(),a=0<h.length&&h[0]instanceof CTATExactMatcher?h[0].getSingle():a.getInput();return new CTATSAI(b,d,a)};this.getSelection=function(){return 0===c.length?n.getDefaultSelection():
c[0].toString()};this.getAction=function(){return 0===g.length?n.getDefaultAction():g[0].getAction()};this.setDefaultSelection=function(a){return 0===c.length?n.internalSetDefaultSelection(a):c[0].setDefaultSelection(a)};this.setDefaultAction=function(a){return 0===g.length?n.internalSetDefaultAction(a):g[0].setDefaultAction(a)};this.setDefaultInput=function(a){return 0===h.length?n.internalSetDefaultInput(a):h[0].setDefaultInput(a)};this.getEvaluatedInput=function(a,b){if(0===h.length)return n.getInput();
var c=h[0];return!1===c instanceof CTATExpressionMatcher?n.getInput():!0===c.isEqualRelation()?c.getEvaluatedInput(a,b):n.getInput()};this.matchForHint=function(a,b,d,e){ctatdebug("CTATVectorMatcher.matchForHint("+a+", "+b+", "+d+", vt)");if(!n.matchActor(d))return!1;b=c[0];return Array.isArray(a)?b.matchConcatenation(a,n.getDefaultActionArray(),n.getDefaultInputArray(),e):b.matchConcatenation([a],n.getDefaultActionArray(),n.getDefaultInputArray(),e)};this.setCaseInsensitive=function(a){ctatdebug("CTATVectorMatcher.setCaseInsensitive("+
...
CTATVectorMatcher.prototype.constructor=CTATVectorMatcher;"undefined"!==typeof module&&(module.exports=CTATVectorMatcher);var CTATExampleTracerNode=function(a,b){CTATBase.call(this,"CTATExampleTracerNode",a);var e=null,f="",d=b?b:new Set,c=new Set;d.forEach(function(a,b,d){b.isCorrect()&&c.add(b)});var g=new Set,h=this;this.toString=function(){return"node"+a};this.getNodeID=function(){return a};this.getNodeName=function(){return f};this.setNodeName=function(a){h.ctatdebug("CTATExampleTracerGraph --\x3e in setNodeName("+a+")");f=a};this.getOutLinks=function(){ctatdebug("CTATExampleTracerNode --\x3e getOutLinks");return d};
...
CTATExampleTracerNode.prototype.constructor=CTATExampleTracerNode;"undefined"!==typeof module&&(module.exports=CTATExampleTracerNode);var CTATExampleTracerLink=function(a,b,e){CTATBase.call(this,"CTATExampleTracerLink","("+b+"-"+e+")");var f="undefined"===typeof a||null===a?null:a,d=null,c="undefined"===typeof b||null===b?null:b,g="undefined"===typeof e||null===e?null:e,h=null,m=1,n=1,q="CORRECT_ACTION",p=[],x=!1,l=null,v="",u=null,B=null,t=this;this.getUniqueID=function(){return f};this.getMatcher=function(){t.ctatdebug("CTATExampleTracerLink --\x3e in getMatcher");return h};this.isCorrect=function(){return q==CTATExampleTracerLink.CORRECT_ACTION};
this.matchesSAI=function(a,b,c){var d=t.getMatcher();t.ctatdebug("CTATExampleTracerLink --\x3e in matchesSAI(); matcher "+d+", typeof "+typeof d+", sai "+a);a=d.match(a.getSelectionArray(),a.getActionArray(),a.getInputArray(),b,c);t.ctatdebug("CTATExampleTracerLink --\x3e out of matchesSAI: result = "+a);return a};this.matchesSAIforHint=function(a,b,c,d){t.ctatdebug("CTATExampleTracerLink --\x3e in matchesSAIforHint("+a+", "+b+") selectionArray "+a.getSelectionArray());if(!1===t.getMatcher().matchForHint(a.getSelectionArray(),
a.getActionArray(),b,d))return t.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning false because no match"),!1;if(null!==c&&"undefined"!==typeof c&&!0===c.getWantReportableHints()&&(a=null===t.getAllHints()||"undefined"===typeof t.getAllHints()?0:t.getAllHints().length,1>a))return t.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning false nStaticHints "+a+"< 1"),!1;t.ctatdebug("CTATExampleTracerLink --\x3e matchesSAIforHint() returning true");return!0};this.getDepth=
function(){return d};this.getBuggyMsg=function(){return v};this.getSuccessMsg=function(){return l};this.getType=function(){return q};this.getPrevNode=function(){return c};this.getNextNode=function(){return g};this.setPrevNode=function(a){c=a};this.setNextNode=function(a){g=a};this.toString=function(){var a;a="[link "+t.getUniqueID();a+=" ("+t.getPrevNode()+"-"+t.getNextNode();a+=") "+t.getType();return a+"]"};this.getTutorSAI=function(a,b){return t.getMatcher().getTutorSAI(a,b,t.getActionType())};
this.getEvaluatedInput=function(a,b){return t.getMatcher().getEvaluatedInput(a,b)};this.setDepth=function(a){d=a};this.getMaxTraversals=function(){return m};this.isDone=function(){var a=String(t.getDefaultSAI().getSelection()).toLowerCase(),b=String(t.getDefaultSAI().getAction()).toLowerCase(),a=CTATMsgType.DONE.toLowerCase()==a&&CTATMsgType.BUTTON_PRESSED.toLowerCase()==b;t.ctatdebug("CTATExampleTracerLink.isDone() returns "+a);return a};this.interpolateHints=function(a){t.ctatdebug("CTATExampleTracerLink --\x3e interpolateHints("+
a+")");var b=[];if(null===p||"undefined"===typeof p||0===p.length)return b;null==a&&(a=new CTATVariableTable);var c=new CTATFormulaParser(a);p.forEach(function(a){if(!(1>String(a).trim().length)){var d=t.getDefaultSAI().getSelection(),e=t.getDefaultSAI().getAction(),f=CTATVariableTable.standardizeType(t.getDefaultSAI().getInput());t.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate("+a+", "+d+", "+e+", "+f+")");a=c.interpolate(a,d,e,f);t.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate() returns "+
a);b.push(a)}});t.ctatdebug("CTATExampleTracerLink --\x3e out of interpolateHints "+b);return b};this.getHints=function(){t.ctatdebug("CTATExampleTracerLink --\x3e in getHints");var a=[];t.interpolateHints(null).forEach(function(b){t.ctatdebug("CTATExampleTracerLink --\x3e in getHints loop");b.toString()!=="".toString()&&a.push(b)});t.ctatdebug("CTATExampleTracerLink --\x3e out of getHints");return a};this.getAllNonEmptyHints=function(){var a=[];p.forEach(function(b){b.trim().toString()!=="".toString()&&
a.push(b)});return a};this.isTraversable=function(){return 1>t.getMaxTraversals()?!1:CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase()==t.getActionType().toString().toUpperCase()||CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase()==t.getActionType().toString().toUpperCase()?!0:!1};this.replaceInput=function(){return CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase()!==t.getActionType().toString().toUpperCase()&&CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase()!==
t.getActionType().toString().toUpperCase()?!1:t.getMatcher().replaceInput()};this.evaluateReplacement=function(a,b,c){return t.getMatcher().evaluateReplacement(a,b,c)};this.getActor=function(){return t.getMatcher().getActor()};this.getDefaultSAI=function(){t.ctatdebug(t.toString()+".getSAI(): "+(h?h.getDefaultSAI():"(matcher null)"));return h.getDefaultSAI()};this.getActionType=function(){return q};this.getMinTraversals=function(){return n};this.getIsPreferredLink=function(){return x};this.getAllHints=
function(){return p};this.setMatcher=function(a){h=a};this.addHint=function(a){null!==a&&"undefined"!==typeof a&&a.toString()!=="".toString()&&p.push(a)};this.setSelection=function(a){t.getMatcher().setDefaultSelection(null===a[0]||"undefined"===typeof a[0]?"":a[0].toString())};this.setAction=function(a){t.getMatcher().setDefaultAction(null===a[0]||"undefined"===typeof a[0]?"":a[0].toString())};this.setActionType=function(a){if(null===a||"undefined"===typeof a||a.toString()!==CTATExampleTracerLink.CORRECT_ACTION.toString()&&
a.toString()!==CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()&&a.toString()!==CTATExampleTracerLink.BUGGY_ACTION.toString()&&a.toString()!==CTATExampleTracerLink.HINT_ACTION.toString()&&a.toString()!==CTATExampleTracerLink.UNTRACEABLE_ERROR.toString()&&a.toString()!==CTATExampleTracerLink.CLT_ERROR_ACTION.toString()&&a.toString()!==CTATExampleTracerLink.GIVEN_ACTION.toString())throw new CTATExampleTracerException("invalid action type "+q);q=a};this.setBuggyMsg=function(a){v=a};this.setSuccessMsg=
function(a){l=a};this.setMinTraversalsStr=function(a){if(null===a||"undefined"===typeof a||1>a.length)n=1;else try{n=parseInt(a.trim()),isNaN(n)&&(n=1)}catch(A){n=1}};this.setMaxTraversalsStr=function(a){if(null===a||"undefined"===typeof a||1>a.length)m=n;else try{m=parseInt(a.trim()),isNaN(m)&&(m=1)}catch(A){m=n}};this.setUniqueID=function(a){f=a};this.addSkillName=function(a){t.ctatdebug("ETLink["+f+"].addSkillName("+a+")");if("unnamed"!==a){if(null===B||"undefined"===typeof B)B=[];-1<B.indexOf(a)||
(B.push(a),t.ctatdebug("ETLink.addSkillName() return with skillNames "+B))}};this.getSkillNames=function(){if(null===B||"undefined"===typeof B)B=[];return B};this.isTutorPerformed=function(a){if(CTATExampleTracerLink.CORRECT_ACTION.toUpperCase()!==t.getActionType().toUpperCase())return!1;var b=t.getMatcher();if(null===b||"undefined"===typeof b||null!==a&&"undefined"!==typeof a&&a!==b.isLinkTriggered())return!1;a=t.getActor();return CTATMatcher.isTutorActor(a,!0)?!0:!1};this.setIsPreferredLink=function(a){t.ctatdebug("ETLink.setIsPreferredLink() was "+
...
d);if(f<d)return-1;if(f>d)return 1;a.ctatdebug("CTATExampleTracerPathComparator --\x3e out of comapre, about to call breakByLowerLinkID");return a.breakByLowerLinkID(b,e)};this.breakByLowerLinkID=function(b,e){a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID");var f=b.getSortedLinks(),d=e.getSortedLinks(),c=null,g=null,h=0,m=0;do a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID in do while"),m>=f.length?(a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 1 is shorter"),
h=-1):m>=d.length?(a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 2 is shorter"),h=1):(a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path are same, compare IDS"),c=f[m],g=d[m]),m++;while(0===h&&c.getUniqueID()===g.getUniqueID());0===h&&(a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID result is zero: "+c.getUniqueID()),a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID result is zero: "+g.getUniqueID()),
h=c.getUniqueID()<g.getUniqueID()?-1:1);return h}};CTATExampleTracerPathComparator.prototype=Object.create(CTATBase.prototype);CTATExampleTracerPathComparator.prototype.constructor=CTATExampleTracerPathComparator;"undefined"!==typeof module&&(module.exports=CTATExampleTracerPathComparator);var CTATExampleTracerPath=function(a){CTATBase.call(this,"CTATExampleTracerPath","");var b=new Set;"undefined"!==typeof a&&null!==a&&a.forEach(function(a){ctatdebug("CTATExampleTracerPath --\x3e in constructor building links with "+a);b.add(a)});var e=null,f=null,d=null,c=null,g=null,h=null,m=this;this.isIncorrectPath=function(){ctatdebug("CTATExampleTracerPath --\x3e in isIncorrectPath");if(null!==h&&"undefined"!==typeof h)return h;var a=!1;m.getLinks().forEach(function(b){!0!==a&&b.getType().toString()===
...
a};this.getHintRequest=function(){return g};this.setResult=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setResult( "+a+" )");c=a};this.isSolverResult=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in isSolverResult");return!1};this.getResult=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getResult() returning "+c);return c};this.setReportableLink=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableLink("+a+")");q=a};this.setReportableInterpretation=
function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableInterpretation("+a+")");p=a};this.setStepID=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setStepID("+a+")");x=a?a.toString():""};this.setReportableVariableTable=function(a){B=a.clone()};this.setSuccessOrBuggyMsg=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setSuccessOrBuggyMsg("+a+")");t=a};this.setReportableHints=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableHints("+a+")");z=
Array.isArray(a)&&0<a.length?a:[]};this.getWantReportableHints=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning "+A);return A};this.setOutOfOrder=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setOutOfOrder("+a+")");l=a};this.isOutOfOrder=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning "+l);return l};this.setEvaluatedInput=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setEvaluatedInput("+a+")");if(null===
u||"undefined"===typeof u)u=[];u.push(a)};this.addPreloadedLinkMatch=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in addPreloadedLinkMatch("+a+")");if(null===v||"undefined"===typeof v)v=[];v.push(a)};this.setInterpolatedSAI=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedSAI("+a+")");a&&(E=a)};this.getInterpolatedSAI=function(){return E?E:w.getStudentSAI()};this.setInterpolatedHints=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedHints("+
a+")");null!==I&&"undefined"!==typeof I&&(I.length=0);null!==a&&"undefined"!==typeof a&&(I=a.slice(0));w.ctatdebug("CTATExampleTracerEvent --\x3e out of setInterpolatedHints")};this.setWantReportableHints=function(a){w.ctatdebug("CTATExampleTracerEvent --\x3e in setWantReportableHints("+a+")");A=a};this.getSuccessOrBuggyMsg=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning "+t);return t};this.getReportableHints=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning "+
z);return z};this.getReportableLink=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning "+q);return q};this.getReportableVariableTable=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning "+B);return B};this.getReportableInterpretation=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning "+p);return p};this.getStepID=function(){w.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning "+
x);return x};this.getTutorSelection=function(){return null===m||"undefined"===typeof m?null:m.getSelectionArray()};this.getTutorAction=function(){return null===m||"undefined"===typeof m?null:m.getActionArray()};this.getTutorInput=function(){return null!==u&&"undefined"!==typeof u?w.getEvaluatedInputArray():null!==m&&"undefined"!==typeof m?m.getInputArray():null};this.getEvaluatedInputArray=function(){return u};this.toString=function(){var a;a="["+w.getResult();null!==w.getStudentSAI()&&"undefined"!==
...
return c.toString()!==CTATExampleTracerLink.BUGGY_ACTION.toString()}function d(a,b,c,d){r.ctatdebug("checkDoneStep() hintTrace "+b+", sai "+a.getStudentSAI()+", exitOnIncorrectDone "+E.exitOnIncorrectDone()+", hideButRequireSteps "+E.hideButRequireSteps()+", nInterps "+d.size);if(!a.getStudentSAI().isDone())return r.ctatdebug("checkDoneStep() not isDone(), so setDoneStepFailed(false) & return null "),null;if(E.exitOnIncorrectDone())return a.setDoneStepFailed(!1),r.ctatdebug("checkDoneStep() exitOnIncorrectDone() with setDoneStepFailed(false), so return null "),
null;if(!b&&E.hideButRequireSteps()){b=E.getDoneLinks();r.ctatdebug("checkDoneStep getDoneLinks().size "+b.size);b=b.values();for(var e;!(e=b.next()).done;)if(E.pathToLinkIsSubset(e.value,D))return a.setDoneStepFailed(!1),1>d.size?f(a,c,CTATExampleTracerLink.CORRECT_ACTION,e.value,r.getBestInterpretation(),r.getInterpretationsInternal()):f(a,c,CTATExampleTracerLink.CORRECT_ACTION,e.value,q(d),d)}1>d.size&&a.setDoneStepFailed(!0);return null}function c(a,b,c){r.ctatdebug("CTATExampleTracerTracer --\x3e _evaluate("+
a+", "+b+", "+c+")");I=a;var e=new Set,l=a.getPreloadedLinkMatches();r.ctatdebug("interps # : "+t.length);r.ctatdebug("interps: "+t);t.forEach(function(d){r.ctatdebug("In evaluate -- entered the interpretations loop");if("undefined"===typeof l||null===l)r.ctatdebug("In evaluate -- entered if check for saiLinkMatches"),l=h(a.getStudentSAI(),a.getActor(),b,d.getVariableTable(),a),r.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");else for(var f=0;f<l.length;++f)g(a.getStudentSAI(),!0,
l[f],l[f].getActor(),d.getVariableTable());r.ctatdebug("Link matches # : "+l.length);l.forEach(function(b){r.ctatdebug("In evaluate -- entered the saiLinkMatches loop + "+b);if(!E.relaxOrderConstraints()&&d.getTraversalCount(b)>=b.getMaxTraversals())return r.ctatdebug("In evaluate -- skipped a saiLinkMatches loop \n Skipped due to max traversals"+b.getMaxTraversals()),!1;var f=d.clone();r.ctatdebug("In evaluate size of getPaths "+f.getPaths().size);f.getPaths().forEach(function(c){r.ctatdebug("In evaluate -- looping through the newInterp.getPaths()\n Examining path: "+
...
var g=n(b,a.getStudentSAI(),f);r.ctatdebug("In evaluate -- updatingVariable table");a.setInterpolatedSAI(f.updateVariableTable(a.getStudentSAI(),g,b));r.ctatdebug("In evaluate -- done updatingVariable table: "+f.getVariableTable())}e.add(f);r.ctatdebug("In evaluate -- added new interp")}r.ctatdebug("In evaluate -- out of saiLinkMatches loop")});r.ctatdebug("In evaluate -- out of interpretation loops")});a.setNumberOfInterpretations(e.size);r.ctatdebug("In evaluate -- number of interpretations "+e.size+
" set");var p=d(a,b,c,e);if(null!==p)return p;if(0===e.size)return r.ctatdebug("In evaluate -- if condition no new interpretations"),0!==l.length&&!0===l[0].isDone()&&a.setDoneStepFailed(!0),a.setResult(CTATExampleTracerLink.NO_MODEL),r.ctatdebug("In evaluate -- if condition no new interpretations returning false"),!1;p=q(e);r.ctatdebug("In evaluate -- just found bestInterp");var u=null;!0===a.isSolverResult()?(r.ctatdebug("In evaluate -- in if branch of isSolverResult"),u=CTATExampleTracerLink.NO_MODEL.toString().toUpperCase()===
a.getResult().toString().toUpperCase()?CTATExampleTracerLink.BUGGY_ACTION.toString():a.getResult().toString()):(r.ctatdebug("In evaluate -- in else branch of isSolverResult"),u=p.getLastMatchedLink().getType());return f(a,c,u,null,p,e)}function g(a,b,c,d,e){var f=b&&c.isCorrect();if("undefined"!=typeof D[c.getUniqueID()]||c.matchesSAIforHint(a,d,null,e))D[c.getUniqueID()]=f;r.ctatdebug("updateMatchedSelections(): link "+c.getUniqueID()+", matched "+b+", newResult "+f+", matchedSelections[link] "+
D[c.getUniqueID()])}function h(a,b,c,d,e){r.ctatdebug("CTATExampleTracerTracer --\x3e in findSAIMatchingLinks("+a+", "+b+", "+c+")");var f=[];E.getLinks().forEach(function(h){if(!1===c){r.ctatdebug("Calling link.matchesSAI() on link "+h+", sai "+a);var l=h.matchesSAI(a,b,d);r.ctatdebug("Result from link.matchesSAI() on link "+h+": "+l+", typeof "+typeof l);!0===l&&f.push(h);E.hideButRequireSteps()&&g(a,l,h,b,d)}else!0===h.matchesSAIforHint(a,b,e,d)&&f.push(h)});r.ctatdebug("CTATExampleTracerTracer --\x3e out of findSAIMatchingLinks: #matchingLinks "+
f.length);return f}function m(a,b,c,d,e){r.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK");var f=null;if(!0===d){r.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK in demonstrate mode");var g=b.getMatchedLinks().slice();g.push(a);f=c.getLinksRestricted(g)}else r.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK NOT in demonstrate mode"),f=c.getLinks();r.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK path.getLinks() "+c.getLinks().size);r.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK pathLinks "+
f.size);if(!0===d){var h=[],m=!0;b.getMatchedLinks().forEach(function(a){!1!==m&&(!1===E.observesOrderingConstraints(h,a,f,e)||!1===l(b,a,f)?(r.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"),m=!1):h.push(a))});if(!1===m)return r.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false2"),!1}if(a.getType().toString()===CTATExampleTracerLink.BUGGY_ACTION.toString()){if(!1===E.isIncorrectLinkOK(b.getMatchedLinks(),a,f,b))return r.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false3"),
!1}else{if(!1===E.observesOrderingConstraints(b.getMatchedLinks(),a,f,e))return r.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false4"),!1;if(!1===l(b,a,f))return r.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false5"),!1}r.ctatdebug("CTATExampleTracerTracer --\x3e out of isPathOK returning true");return!0}function n(a,b,c){r.ctatdebug("CTATExampleTracerTracer.replaceInput("+a+", "+b+", ...)");if(null===a||"undefined"===typeof a||!1===a.replaceInput())return r.ctatdebug("replaceInput false, returning null"),
...
c=a):(r.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation else of first if condition"),0<b.compare(a,c)&&(r.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation second if condition"),c=a))});r.ctatdebug("CTATExampleTracerTracer --\x3e out of findBestInterpretation");return c}function p(a){r.ctatdebug("CTATExampleTracerTracer --\x3e in setInterpretations");t.length=0;0===a.size?r.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations"):(r.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: "+
a.size),a.forEach(function(a){t.push(a)}),w=null,r.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"))}function x(){r.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths");var a=E.findAllPaths();r.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths: #paths "+a.size);a.forEach(function(a){r.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths loopring through paths");r.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths size of path"+a.getLinks().size)});return a}
function l(a,b,c){r.ctatdebug("CTATExampleTracerTracer --\x3e in doneStepOK: link "+b+", isDone() "+b.isDone());if(null===b||"undefined"===typeof b||!1===b.isDone())return r.ctatdebug("doneStepOK in first if condition"),!0;if(b.isDone()&&E.exitOnIncorrectDone())return!0;if(b.getType().toString()===CTATExampleTracerLink.BUGGY_ACTION.toString())return r.ctatdebug("doneStepOK in second if condition"),!0;r.ctatdebug("doneStepOK before loop");var d=!0;c.forEach(function(c){if(!1===d)r.ctatdebug("CTATExampleTracerTracer --\x3e we are breaking from the loop");
else if(c.getUniqueID()===b.getUniqueID())r.ctatdebug("CTATExampleTracerTracer --\x3e inside second if condition");else{var e=a.getTraversalCount(c);E.hideButRequireSteps()&&(0<e||1>c.getMinTraversals())||!(e<c.getMinTraversals())||(r.ctatdebug("CTATExampleTracerTracer --\x3e we should return false from the second if condition"),d=!1)}});if(!1===d)return r.ctatdebug("CTATExampleTracerTracer --\x3e out of doneStepOK returning false"),!1;r.ctatdebug("CTATExampleTracerTracer --\x3e out of doneStepOK returning true");
return!0}function v(a,b){r.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink");var c=null!==b&&"undefined"!==typeof b&&null!==b[0]&&"undefined"!==typeof b[0]?b[0]:null;if(null===c||"undefined"===typeof c)r.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink first if condition"),c=r.getBestInterpretation();null!==b&&"undefined"!==typeof b&&(b[0]=c);r.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink interp.getPaths(): "+c.getPaths().size);var d=CTATExampleTracerPath.getBestPath(c.getPaths());
...
c,h=!0)))}))});if(!0===h)return r.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink returning: "+l.getUniqueID()),l;r.ctatdebug("CTATExampleTracerTracer --\x3e out of getHighestUntraversedLink");return null}function B(a){return null===a||"undefined"===typeof a?!1:1>a.getMinTraversals()&&1>a.getMaxTraversals()}CTATBase.call(this,"CTATExampleTracerTracer",a);var t=null,z=null,A=null,E=a,I=null;CTATExampleTracerTracer_count++;var w=null,D={},r=this;this.goToState=function(a,b){if(!a)return!1;
var c="done"==a.toString().toLowerCase(),d="start"==a.toString().toLowerCase(),e=null;if(!c&&!d&&!(e=E.findNode(a)))return!1;if(d=d||e==E.getStartNode())throw c=location.href.replace(/problem_state_status=[^&]*/,"problem_state_status=empty"),1>c.search(/problem_state_status=empty/)&&(c+=c.search(/[?&]/g)?"&":"?",c+="problem_state_status=empty"),console.log("CTATExampleTracerTracer.goToState("+a+") to call location.replace("+c+")"),location.replace(c),c;if((d=r.getBestInterpretation())&&(c?r.goToDone(d,
E,b):r.advanceToNode(e,E,b)))return!0;for(var f=0;f<t.length;++f){var g=t[f];if(g!=d&&(c?r.goToDone(g,E,b):r.advanceToNode(e,E,b)))return!0}return!1};this.goToDone=function(a,b,c){return(a=a.getPathToDone(b))?c.traceLinks(a.getSortedLinks()):!1};this.advanceToNode=function(a,b,c){a=b.getBestSubpath(b.getStartNode(),a);r.ctatdebug("advanceToNode() path "+a);a&&(a=a.getSortedLinks(),results=c.traceLinks(a),r.ctatdebug("advanceToNode() results "+results))};this.getMatchedSelections=function(){return D};
this.getLastResult=function(){r.ctatdebug("CTATExampleTracerTracer --\x3e in getResult");return I};this.resetTracer=function(){r.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer entering");null===t||"undefined"===typeof t?(r.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"),t=[]):(r.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"),t.length=0);var a=new CTATExampleTracerInterpretation(x());r.ctatdebug("CTATExampleTracerTracer tempInterp--\x3e in resetTracer tempInterp "+
a);null!==b&&"undefined"!==typeof b&&(r.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer startStateVT if condition"),a.setVariableTable(b));t.push(a);w=a;if(null===z||"undefined"===typeof z)r.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"),z={};else{r.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of incorrectActionMatches if condition");for(var c in z)z.hasOwnProperty(c)&&delete z[c]}D={};null===A||"undefined"===typeof A?
(r.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer last if condition"),A=[]):(r.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of last if condition"),A.length=0);r.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer before iterating over all the links in the graphs");E.getLinks().forEach(function(a){a.getMatcher().resetMatcher()});r.ctatdebug("CTATExampleTracerTracer --\x3e out of resetTracer")};this.evaluate=function(a){r.ctatdebug("CTATExampleTracerTracer --\x3e in public evaluate(), calling private _evaluate; given event "+
...
h.length);y.ctatdebug("CTATETGraph --\x3e in isReentrableOK: traversedLinks: "+a+", path: "+d);var l=!0;h.forEach(function(b){!1!==l&&d.forEach(function(c){!1!==l&&m(a,c)<c.getMinTraversals()&&!0===C.isLinkInGroup(b,c)&&(l=!1)})});if(!1===l)return!1}y.ctatdebug("CTATExampleTracerGraph --\x3e out of isReenteringOK");return!0}function c(a){y.ctatdebug("in findGroupsOfLink(link "+a+"): typeof(groupModel) "+typeof C);a=C.getGroupsContainingLink(a);y.ctatdebug("in findGroupsOfLink groupsSet.size "+a.size);
var b=[];a.forEach(function(a){y.ctatdebug("in findGroupsOfLink group element "+a.getName());b.push(a)});b.sort(function(a,b){return C.getGroupLinkCount(b)-C.getGroupLinkCount(a)});return b}function g(a,b,c,d){var e=-1,f=null,g=Number.MAX_VALUE,l=null;C.getGroupSubgroups(a).forEach(function(a){if(!1===C.isLinkInGroup(a,b)&&0!==C.getGroupLinkCount(a)){var m=h(a,d);null!==m&&"undefined"!==typeof m&&(m=m.getDepth(),m<b.getDepth()&&m>e&&(!1===q(a)||!0===p(a,c))&&(e=m,f=a),m>b.getDepth()&&m<g&&(!1===q(a)||
!0===p(a,c))&&(g=m,l=a))}});C.getUniqueLinks(a).forEach(function(a){if(!0===d.has(a)){var h=a.getDepth();h<b.getDepth()&&h>e&&(0<a.getMinTraversals()||-1<c.indexOf(a))&&(e=h,f=a);h>b.getDepth()&&h<g&&(0<a.getMinTraversals()||-1<c.indexOf(a))&&(g=h,l=a)}});if(null!==f&&"undefined"!==typeof f)if(f instanceof CTATExampleTracerLink){if(m(c,f)<f.getMinTraversals())return!1}else if(f instanceof CTATLinkGroup&&!1===x(f,c,d))return!1;return null!==l&&"undefined"!==typeof l&&(l instanceof CTATExampleTracerLink&&
-1<c.indexOf(l)||l instanceof CTATLinkGroup&&!0===p(l,c))?!1:!0}function h(a,b){var c=Number.MAX_VALUE,d=null;C.getGroupLinks(a).forEach(function(a){a.getDepth()<c&&!0===b.has(a)&&(c=a.getDepth(),d=a)});return d}function m(a,b){for(var c=0,d=0;d<a.length;d++)b===a[d]&&c++;y.ctatdebug("CTATETGraph.getTraversalCount("+b+"): "+c);return c}function n(a,b,c){var d=!1,e=!0,f=!1;(new CTATExampleTracerPath(b)).getSortedLinks().forEach(function(b){if(!1!==e&&!0!==f){if(!1===d)!0===C.isLinkInGroup(a,b)&&(d=
!0);else if(!1===C.isLinkInGroup(a,b)){f=!0;return}c.getTraversalCount(b)<b.getMaxTraversals()&&(e=!1)}});return!1===e?!1:!0}function q(a){var b=!0;C.getGroupLinks(a).forEach(function(a){!1!==b&&0!==a.getMinTraversals()&&(b=!1)});return!1===b?!1:!0}function p(a,b){for(var c=0;c<b.length;c++)if(!0===C.isLinkInGroup(a,b[c]))return!0;return!1}function x(a,b,c){var d=!0;C.getGroupLinks(a).forEach(function(a){!1!==d&&!0===c.has(a)&&m(b,a)<a.getMinTraversals()&&(d=!1)});return!1===d?!1:!0}function l(){for(var a=
0;a<t.length;a++)t[a].clearInLinks();var b=y.getStartNode();null!==b&&"undefined"!==typeof b&&null!==b.getOutLinks()&&"undefined"!==typeof b.getOutLinks()&&(a=0,b.getOutLinks().forEach(function(b){v(b,a++)}))}function v(a,b){ctatdebug("updateInLinkSubGraph("+a+", "+b+")");var c=y.getNode(a.getNextNode());if(null!==c&&"undefined"!==typeof c){c.addInLink(a);var d=0;c.getOutLinks().forEach(function(a){v(a,d++)})}}function u(a){var b=y.getNode(a.getPrevNode());if(null!==b&&"undefined"!==typeof b){var c=
-1;b.getInLinks().forEach(function(a){-1===a.getDepth()&&u(a);a.getDepth()>c&&(c=a.getDepth())});a.setDepth(c+1)}}CTATBase.call(this,"CTATExampleTracerGraph","visualdata");var B=null,t=null,z=null,A=null,E=null,I=null,w=new Set,D=new Set,r=null,C=null,F=CTATMsgType.SHOW_ALL_FEEDBACK,y=this;this.getFeedbackPolicy=function(){return F};this.setFeedbackPolicy=function(a){y.ctatdebug("Graph.setFeedbackPolicy("+a+") old policy "+F);F="false"===a?CTATMsgType.SHOW_ALL_FEEDBACK:"true"===a?CTATMsgType.HIDE_ALL_FEEDBACK:
a};this.hideButRequireSteps=function(){return F==CTATMsgType.HIDE_BUT_COMPLETE};this.hideAllFeedback=function(){return F==CTATMsgType.HIDE_ALL_FEEDBACK};this.relaxOrderConstraints=function(){return y.hideAllFeedback()||y.hideButRequireSteps()||F==CTATMsgType.DELAY_FEEDBACK};this.exitOnIncorrectDone=function(){switch(F){case CTATMsgType.HIDE_ALL_FEEDBACK:case CTATMsgType.HIDE_BUT_ENFORCE:return!0;default:return!1}};this.getDefaultBuggyMsg=function(){return C.getTopLevelGroup()?C.getTopLevelGroup().getDefaultBuggyMsg():
null};this.getLinks=function(){y.ctatdebug("CTATExampleTracerGraph --\x3e in getLinks");return z};this.addLink=function(a,b){y.ctatdebug("CTATExampleTracerGraph --\x3e in addLink");z.push(a);a.isDone()?D.add(a):D["delete"](a);null===b||"undefined"===typeof b?C.addLinkToGroup(C.getTopLevelGroup(),a):C.addLinkToGroup(b,a);y.ctatdebug("CTATExampleTracerGraph --\x3e out of addLink")};this.addNode=function(a){y.ctatdebug("CTATExampleTracerGraph --\x3e in addNode");t.push(a);A[a.getNodeID()]=a;y.ctatdebug("CTATExampleTracerGraph --\x3e out of addNode")};
...
a+")");E=a};this.getStudentStartsHereNode=function(){y.ctatdebug("CTATExampleTracerGraph --\x3e getStudentStartsHereNode() returns "+I);return I};this.setStudentStartsHereNode=function(a){y.ctatdebug("CTATExampleTracerGraph --\x3e in setStudentStartsHereNode("+a+")");I=a};this.getExampleTracer=function(){y.ctatdebug("CTATExampleTracerGraph --\x3e in getExampleTracer() returning "+B);return B};this.forDebugging=function(){y.ctatdebug("CTATExampleTracerGraph --\x3e in forDebugging");y.ctatdebug("Nodes in the graph -- ids");
t.forEach(function(a){y.ctatdebug(a.getNodeID())});y.ctatdebug("Links in the graph -- ids, from, to");z.forEach(function(a){y.ctatdebug(a)})};this.getSmallestContainingGroup=function(a){return C.getLowestLevelGroupOfLink(a)};this.redoLinkDepths=function(){l();y.getLinks().forEach(function(a){a.setDepth(-1)});y.getLinks().forEach(function(a){-1===a.getDepth()&&u(a)})};this.getGroupModel=function(){return C};this.setVisualData=function(a){y.ctatdebug("CTATExampleTracerGraph --\x3e in setVisualData");
r=a};this.getVisualData=function(){y.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning "+r);return r};this.getDoneLinks=function(){return D};(function(a,b){y.ctatdebug("CTATExampleTracerGraph --\x3e in initGraph ("+a+" , "+b);z=[];t=[];A={};if(null===C||"undefined"===typeof C)C=new CTATDefaultGroupModel,y.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");C.clear();C.setDefaultReenterable(!b);C.setGroupOrdered(C.getTopLevelGroup(),a);C.setGroupName(C.getTopLevelGroup(),
CTATExampleTracerGraph.TOP_LEVEL);B=new CTATExampleTracerTracer(y,e);y.ctatdebug("CTATExampleTracerGraph --\x3e out of initGraph")})(!a,b)};Object.defineProperty(CTATExampleTracerGraph,"TOP_LEVEL",{enumerable:!1,configurable:!1,writable:!1,value:"Top Level"});CTATExampleTracerGraph.prototype=Object.create(CTATBase.prototype);CTATExampleTracerGraph.prototype.constructor=CTATExampleTracerGraph;"undefined"!==typeof module&&(module.exports=CTATExampleTracerGraph);var CTATGraphParser=function(){function a(a){ctatdebug("processEdge()");for(var d=new CTATExampleTracerLink(null,null,null),e=g.getElementChildren(a),f,h,l,m,n,p=a=-1,w=CTATMsgType.DEFAULT_ACTOR,x=!1,r=0;r<e.length;r++){"sourceID"===g.getElementName(e[r])&&(a=parseInt(g.getNodeTextValue(e[r])),d.setPrevNode(a));"destID"===g.getElementName(e[r])&&(p=parseInt(g.getNodeTextValue(e[r])),d.setNextNode(p));if("rule"===g.getElementName(e[r]))for(var C=g.getElementChildren(e[r]),F=0;F<C.length;F++)"text"===
g.getElementName(C[F])&&d.addSkillName(g.getNodeTextValue(C[F]).toString());if("actionLabel"===g.getElementName(e[r]))for(d.setIsPreferredLink("false"!=g.getElementAttr(e[r],"preferPathMark")),d.setMinTraversalsStr(g.getElementAttr(e[r],"minTraversals")),d.setMaxTraversalsStr(g.getElementAttr(e[r],"maxTraversals")),C=g.getElementChildren(e[r]),F=0;F<C.length;F++){"uniqueID"===g.getElementName(C[F])&&(n=g.getNodeTextValue(C[F]),d.setUniqueID(parseInt(g.getNodeTextValue(C[F]))));"message"===g.getElementName(C[F])&&
(m=new CTATMessage(C[F]));"actionType"===g.getElementName(C[F])&&d.setActionType(g.getNodeTextValue(C[F]));"buggyMessage"===g.getElementName(C[F])&&d.setBuggyMsg(g.getNodeTextValue(C[F]));"successMessage"===g.getElementName(C[F])&&d.setSuccessMsg(g.getNodeTextValue(C[F]));"hintMessage"===g.getElementName(C[F])&&d.addHint(g.getNodeTextValue(C[F]));if("matchers"===g.getElementName(C[F]))for(var y=g.getElementChildren(C[F]),H=0;H<y.length;H++)"Selection"===g.getElementName(y[H])&&(f=b(y[H],0)),"Action"===
g.getElementName(y[H])&&(h=b(y[H],1)),"Input"===g.getElementName(y[H])&&(l=b(y[H],2)),"Actor"===g.getElementName(y[H])&&(w=g.getNodeTextValue(y[H]),x=(x=g.getElementAttr(y[H],"linkTriggered"))&&"false"!=x.toLowerCase().trim()?!0:!1);if("matcher"===g.getElementName(C[F])){h=C[F];f=g.getElementAttr(h,"replacementFormula");h=g.getElementChildren(h);var H=y=void 0,G,J=void 0,N=CTATMsgType.DEFAULT_ACTOR;l=new CTATExactMatcher(CTATMatcher.SELECTION,null);for(var w=new CTATExactMatcher(CTATMatcher.ACTION,
null),L=0;L<h.length;L++)"matcherType"===g.getElementName(h[L])&&(G=g.getNodeTextValue(h[L]),"ExactMatcher"===G&&(H=CTATExactMatcher),"RegexMatcher"===G&&(H=CTATRegexMatcher),"AnyMatcher"===G&&(H=CTATAnyMatcher),"RangeMatcher"===G&&(H=CTATRangeMatcher),"WildcardMatcher"===G&&(H=CTATWildcardMatcher),"ExpressionMatcher"===G&&(H=CTATExpressionMatcher)),"matcherParameter"===g.getElementName(h[L])&&(G=g.getElementAttr(h[L],"name"),J=g.getNodeTextValue(h[L]),"selection"==G&&l.setParameter(J),"action"==
G&&w.setParameter(J),"input"==G&&(y=y?y:new H(CTATMatcher.INPUT,null),y.setParameter(J)),"actor"==G&&(N=J),"minimum"==G&&(y=y?y:new H(CTATMatcher.INPUT,null),y.setParameter(J,"minimum")),"maximum"==G&&(y=y?y:new H(CTATMatcher.INPUT,null),y.setParameter(J,"maximum")),"InputExpression"==G&&(y=y?y:new H(CTATMatcher.INPUT,null),y.setParameter(h[L],G,g)),"relation"==G&&(y=y?y:new H(CTATMatcher.INPUT,null),y.setParameter(h[L],G,g)));y||(y=H?new H(CTATMatcher.INPUT,null):new CTATExactMatcher(CTATMatcher.INPUT,
null),y.setParameter(J?J:""));y.setReplacementFormula(f);w=[[l],[w],[y],N];f=w[0];h=w[1];l=w[2];w=w[3]}}}c.getStartNode()&&p==c.getStartNode().getNodeID()&&console.log("***WARNING*** edge "+n+" destination is graph startNode "+c.getStartNode());n=new CTATVectorMatcher(f,h,l,w);n.setDefaultSAI(m.getSAI());n.setCaseInsensitive(q);n.setLinkTriggered(x);d.setMatcher(n);ctatdebug("GraphParser.processEdge() "+a+"->"+p+", edge "+d);c.getNode(a).addOutLink(d);c.checkForDoneState(d);return d}function b(a,
b){f.ctatdebug("processMatchers()");for(var c=g.getElementChildren(a),d=[],e=0;e<c.length;e++)if("matcher"===g.getElementName(c[e])){for(var h=null,l=g.getElementAttr(c[e],"replacementFormula"),m=g.getElementChildren(c[e]),n=0;n<m.length;n++){if("matcherType"===g.getElementName(m[n]))switch(h=g.getNodeTextValue(m[n]),f.ctatdebug("CTATGraphParser.processMatchers() matcherType["+n+"] = "+h),h){case "ExactMatcher":h=new CTATExactMatcher(b,null);break;case "RegexMatcher":h=new CTATRegexMatcher(b,null);
break;case "AnyMatcher":h=new CTATAnyMatcher(b,null);break;case "RangeMatcher":h=new CTATRangeMatcher(b,null);break;case "WildcardMatcher":h=new CTATWildcardMatcher(b,null);break;case "ExpressionMatcher":h=new CTATExpressionMatcher(b,null);break;default:console.log("CTATGraphParser.processMatchers() unknown matcherType["+n+"] = "+h+"; using CTATExactMatcher"),h=new CTATExactMatcher(b,null)}if("matcherParameter"===g.getElementName(m[n])){var p=g.getElementAttr(m[n],"name");"single"===p?h.setParameter(g.getNodeTextValue(m[n])):
"minimum"===p?h.setParameter(g.getNodeTextValue(m[n]),"minimum"):"maximum"===p?h.setParameter(g.getNodeTextValue(m[n]),"maximum"):h.setParameter(m[n],p,g)}}h&&h.setReplacementFormula(l);d.push(h)}return d}function e(a,b){var c=new Set;if("group"!==g.getElementName(a))return c;var d=g.getElementAttr(a,"name");ctatdebug("readGroupFromXML group name: "+d);var f="true"===g.getElementAttr(a,"ordered"),h="true"===g.getElementAttr(a,"reenterable");ctatdebug("readGroupFromXML group isOrdered typeof: "+typeof f);
ctatdebug("readGroupFromXML group isOrdered: "+f);for(var l=function(a){c.add(a)},m=g.getElementChildren(a),p=0;p<m.length;p++){if("link"===g.getElementName(m[p])){var q=Number(g.getElementAttr(m[p],"id")),v=b[q];if(null!==v||void 0!==v)ctatdebug("Added link ID : "+q),c.add(v)}"group"===g.getElementName(m[p])&&(ctatdebug("encountered a subgroup"),e(m[p],b).forEach(l))}n.addGroup(d,f,c);n.setGroupReenterable(n.getGroupByName(d),h);return c}CTATBase.call(this,"CTATGraphParser","__undefined__");var f=
this,d,c,g=new CTATXML,h=null,m=[];new XMLSerializer;var n,q=!0,p=!0,x=[];this.getLockWidget=function(){return p};this.parseGraph=function(b,f){ctatdebug("parseBRD()");var l=0,v=g.getElementAttr(b,"startStateNodeName"),t="true"===g.getElementAttr(b,"unordered");q="false"!=String(g.getElementAttr(b,"caseInsensitive")).toLowerCase();p=g.getElementAttr(b,"lockWidget");var z=new CTATVariableTable;c=new CTATExampleTracerGraph(t,!1,z);var A=g.getElementChildren(b),z=g.getElementAttr(b,"suppressStudentFeedback");
if(null===z||void 0===z)z=CTATMsgType.SHOW_ALL_FEEDBACK;c.setFeedbackPolicy(z);f.setFeedbackSuppressed(z);z=g.getElementAttr(b,"highlightRightSelection");f.setHighlightRightSelection("false"!=z);var E=g.getElementAttr(b,"confirmDone");"true"!==E&&"false"!==E&&(E=c.getFeedbackPolicy()===CTATMsgType.HIDE_ALL_FEEDBACK?"true":"false");f.setHintPolicy(g.getElementAttr(b,"hintPolicy"));f.setOutOfOrderMessage(g.getElementAttr(b,"outOfOrderMessage"));for(var I=null,w=0;w<A.length;w++)switch(g.getElementName(A[w])){case "startNodeMessages":m=
g.getElementChildren(A[w]);break;case "node":l++;var D;D=A[w];ctatdebug("processNode("+D+")");var r=g.getElementChildren(D),C=-1;D="";for(var F=0;F<r.length;F++)switch(g.getElementName(r[F])){case "uniqueID":C=parseInt(g.getNodeTextValue(r[F]));break;case "text":D=g.getNodeTextValue(r[F])}r=new CTATExampleTracerNode(C,new Set);""!==D&&r.setNodeName(D);D=r;c.addNode(D);1==l&&(c.setStartNode(D),c.setStudentStartsHereNode(D));D.getNodeName()==v&&c.setStudentStartsHereNode(D);break;case "edge":c.addLink(a(A[w]));
break;case "EdgesGroups":I=A[w];break;case "productionRule":var y=A[w];ctatdebug("processSkill()");for(var r=D="",F=C=null,y=g.getElementChildren(y),H=0;H<y.length;H++){var G=g.getElementName(y[H]);"ruleName"==G&&(D=g.getNodeTextValue(y[H]),ctatdebug("ruleName="+D));"productionSet"==G&&(r=g.getNodeTextValue(y[H]),ctatdebug("productionSet="+r));"label"==G&&(C=g.getNodeTextValue(y[H]),ctatdebug("label="+C));"description"==G&&(F=g.getNodeTextValue(y[H]),ctatdebug("description="+F))}D&&(y=new CTATExampleTracerSkill(r,
D,CTATExampleTracerSkill.DEFAULT_P_GUESS,CTATExampleTracerSkill.DEFAULT_P_KNOWN,CTATExampleTracerSkill.DEFAULT_P_SLIP,CTATExampleTracerSkill.DEFAULT_P_LEARN,CTATExampleTracerSkill.DEFAULT_HISTORY),null!=C?y.setLabel(C):y.setLabel(D),null!=F?y.setDescription(F):y.setDescription(D+(r?" "+r:"")),x.push(y))}if(I){l=g.getElementAttr(I,"ordered");if(null===l||"undefined"==typeof isordered)l=!t;ctatdebug("parseGraph() value of isOrdered = "+l);ctatdebug("parseGraph() value of isUnordered = "+t);ctatdebug("parseGraph() typeof isOrdered: "+
typeof l);ctatdebug("parseGraph()typeof isUnordered: "+typeof t);v=I;A=l;ctatdebug("processGroup()");n=c.getGroupModel();l=n.createIdToLinkMap();n.setGroupOrdered(n.getTopLevelGroup(),A);ctatdebug("processGroup() name of group: "+n.getGroupName(n.getTopLevelGroup()));ctatdebug("processGroup() group isOrdered?: "+n.isGroupOrdered(n.getTopLevelGroup()));ctatdebug("processGroup() order of group: isOrdered= "+A);ctatdebug("processGroup() order of group: isOrdered typeof= "+typeof A);v=g.getElementChildren(v);
for(A=0;A<v.length;A++)switch(g.getElementName(v[A])){case "group":e(v[A],l);break;case "outOfOrderMessage":n.getTopLevelGroup().setDefaultBuggyMsg(g.getNodeTextValue(v[A]))}}l=f.getSkillBarVector(!1,!0);if(!l||1>l.length)ctatdebug("No existing skills. Add skills from BRD."),f.addGraphSkills(x),l=f.getSkillBarVector();h=(new CTATTutorMessageBuilder).createStateGraphMessage(q,t,p,f.isSourceFlash()?c.exitOnIncorrectDone():f.isFeedbackSuppressed(),z,E,l);c.redoLinkDepths();d=c.getExampleTracer();d.resetTracer();
...
a);return!0;case CTATMsgType.HIDE_ALL_FEEDBACK:return!0;case CTATMsgType.HIDE_BUT_COMPLETE:return!0;case CTATMsgType.HIDE_BUT_ENFORCE:return!0;default:return!1}}function d(a,b){for(var c=new CTATMessageTank(a,null),d=0;d<b.length;++d){var e=b[d];p.ctatdebug("sendNewTankful() mto["+d+"] msgType "+e.msgType);c.addToMessageTank(e.msgType,e.msg,e.evt,null)}c.flushMessageTank(null,!0)}CTATBase.call(this,"CTATMessageTank",b);var c=a,g=null,h=null,m=null,n=new Set;n.add("SuccessMessage");n.add("BuggyMessage");
n.add("HighlightMsg");n.add("NotDoneMessage");var q=b,p=this,x=/^([^:]+):([0-9]+)$/;this.toString=function(){p.ctatdebug("toString tank "+g);if(!g||1>g.length)return"MessageTank empty";var a="";g.forEach(function(b){a+=b.msgType+", "});return"MessageTank["+a.substr(0,a.length-2)+"]"};this.setTransaction_id=function(a){q=a};this.enqueueToolActionToStudent=function(a,b,d,e){p.ctatdebug("Entering enqueueToolActionToStudent("+a+", "+b+", "+d+", "+e+")");var f=CTATMsgType.INTERFACE_ACTION;p.ctatdebug("entering enqueueMessageToStudent()");
...
b,c,d){p.ctatdebug("Entering addToMessageTank("+a+", "+b+", "+c+")");if(b){g||(g=[],h={},m={});var e={};e.msgType=a;e.msg=b;e.evt=c;e.sai=d;g.push(e);h[a]=h[a]?h[a]+1:1;a=c.getResult();c.getHintRequest()&&(a=CTATExampleTracerLink.HINT_ACTION);m[a]=m[a]?m[a]+1:1;p.ctatdebug("Exiting addToMessageTank() this "+p.toString())}};this.flushMessageTank=function(a,b){p.ctatdebug("Entering flushMessageTank("+a+", "+b+")");if(g&&!(1>g.length)){e(a);p.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length "+
g.length+", transaction_id "+q);for(var l=[],n=[],t=0;t<g.length;++t){var v=g[t];if(v.msg){var A=v.msgType,E=v.evt;p.ctatdebug("entering processInterfaceVariables() msgType "+A+", evt "+E);A&&(p.ctatdebug("entering processInterfaceVariables() et "+c+", tracer "+(c?c.getTracer():null)),A=A.toLowerCase(),0!==A.indexOf("correct")&&0!==A.indexOf("interfaceaction")||c.getTracer().addInterfaceVariablesFromEvent(E));if(!(A=f(v)))if(A=v,E=n,CTATConfiguration.usingFlash()){var I=void 0,w=void 0;if(!(A&&A.sai&&
(I=A.sai.getAction())&&(w=x.exec(I)))||3>w.length||1>=w[2])A=!1;else{var D=E.length-1,D=0>D?null:E[D];A.msg=A.msg.replace(I,w[1]);D&&D.timeout==w[2]?D.msgTuples.push(A):E.push({timeout:Number(w[2]),msgTuples:[A]});A=!0}}else A=!1;A||l.push(v.msg)}}p.ctatdebug("flushMessageTank(): msgBundle.length "+l.length+", delayedMsgsBundle.length "+n.length);for(t=0;t<n.length;++t)v=n[t],p.ctatdebug("processDelayedMsgs() delayedMsgs.timeout "+v.timeout+", .msgTuples.length "+v.msgTuples.length),setTimeout(d,
v.timeout,c,v.msgTuples);0<l.length&&(p.ctatdebug("Bottom of flushMessageTank(); to send bundle of length "+l.length+" via "+c),c.sendBundle(l)&&(p.ctatdebug("CTATMessageTank.shouldSaveNow() resultTypes "+m+", msgTypes "+h),(m[CTATExampleTracerLink.CORRECT_ACTION]||m[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION]||h.CorrectAction||h.InterfaceAction||h.UntutoredAction||c.isFeedbackSuppressed()&&h.AssociatedRules)&&c.isSendingSavedMsgsForRestore()&&(CTATGlobalFunctions.isInstructorMode()?p.ctatdebug("We're in reviewer mode: we shouldn't save as we go"):
c.getProblemStateSaver().saveAsYouGo(a))),p.ctatdebug("Exiting flushMessageTank() #CorrectAction "+h.CorrectAction+", #InterfaceAction "+h.InterfaceAction+", #UntutoredAction "+h.UntutoredAction));h=g=q=null}};this.flushDelayedFeedback=function(){p.ctatdebug("Entering flushDelayedFeedback()");var a=c.getDelayedFeedback(),b;for(b in a)a.hasOwnProperty(b)&&CTAT.ToolTutor.sendToInterface(a[b]);c.clearDelayedFeedback()};this.suppressFeedback=function(a,b){p.ctatdebug("CTATMessageTank.suppressFeedback("+
...
"undefined"!==typeof module&&(module.exports=CTATStep);var CTATProblemSummary=function(a,b,e){CTATBase.call(this,"CTATProblemSummary","");if(null===a||"undefined"===typeof a||1>a.length)throw new CTATExampleTracerException("problemName null or empty");var f=!0,d=Number.MAX_VALUE,c=b,g=e,h=0,m=new Date,n={},q=0,p=0,x=0,l=0,v=0,u=0,B=0,t=CTATMsgType.CompletionValue[0],z=this;this.getCountOnlyLastResults=function(){return g};this.setCountOnlyLastResults=function(a){g=a};this.getTimeElapsed=function(){return h};this.getUniqueErrors=function(){if(!z.getCountOnlyLastResults())return B;
var a=0,b;for(b in n)n[b].getLastResult()==CTATStep.StepResult[1]&&a++;return a};this.getUniqueCorrect=function(){if(!z.getCountOnlyLastResults())return v;var a=0,b;for(b in n)n[b].getLastResult()==CTATStep.StepResult[3]&&a++;return a};this.getUniqueCorrectUnassisted=function(){return u};this.getHintsOnly=function(){var a=0,b;for(b in n)CTATStep.StepResult[2]==n[b].getResult()&&1>n[b].getNErrors()&&++a;return a};this.getErrorsOnly=function(){var a=0,b;for(b in n)CTATStep.StepResult[1]==n[b].getResult()&&
1>n[b].getNFirstHints()&&++a;return a};this.getUniqueSteps=function(){var a=0,b;for(b in n)a++;return a};this.getRequiredSteps=function(){return d==Number.MAX_VALUE?0:d};this.setRequiredSteps=function(a){d=a};this.getCorrect=function(){return q};this.toXML=function(b){var c,d="";c=""+(' ProblemName="'+a+'"');c+=' CompletionStatus="'+t+'"';f&&(c+=' Correct="'+q+'"',c+=' UniqueCorrect="'+z.getUniqueCorrect()+'"',c+=' UniqueCorrectUnassisted="'+u+'"',c+=' Hints="'+p+'"',c+=' UniqueHints="'+l+'"',c+=
...
function(){var a=new Date;h+=a.getTime()-m.getTime();return a};this.restartTimer=function(){m=z.stopTimer();return h};this.addHint=function(a){z.ctatdebug("addHint("+a+")");var b=n[a];null!==b&&"undefined"!==typeof b?(1>b.getNFirstHints()&&++l,b.incrementFirstHints()):(b=new CTATStep(a,CTATStep.StepResult[2]),n[a]=b,l++);p++;b.setLastResult(CTATStep.StepResult[2]);z.ctatdebug("exiting addHint() hint count "+p+", trial "+b)};this.addError=function(a){z.ctatdebug("addError("+a+")");var b=n[a];null!==
b&&"undefined"!==typeof b?(1>b.getNCorrect()&&1>b.getNErrors()&&++B,b.incrementErrors()):(b=new CTATStep(a,CTATStep.StepResult[1]),n[a]=b,B++);x++;b.setLastResult(CTATStep.StepResult[1]);z.ctatdebug("exiting addError() error count "+x+", trial "+b)};this.addCorrect=function(a){var b=n[a];z.ctatdebug("entering addCorrect("+a+") trial "+b);b?(1>b.getNCorrect()&&1>b.getNErrors()&&(++v,1>b.getNFirstHints()&&u++),b.incrementNCorrect()):(z.ctatdebug("to call CTATStep("+a+", StepResult "+CTATStep.StepResult[3]),
b=new CTATStep(a,CTATStep.StepResult[3]),n[a]=b,v++,u++);q++;b.setLastResult(CTATStep.StepResult[3]);z.ctatdebug("exiting addCorrect() correct count "+q+", trial "+b)};this.setShowCounts=function(a){f=a};this.setCompletionStatus=function(a,b){z.ctatdebug("setCompletionStatus("+a+", "+b+")");if(CTATMsgType.CompletionValue[1]!=t||b)t=a};this.getCompletionStatus=function(){return t}};CTATProblemSummary.prototype=Object.create(CTATBase.prototype);CTATProblemSummary.prototype.constructor=CTATProblemSummary;
...
e.slice(0,20));a.enqueueForRestore([]);return}}d=[];if("string"==typeof e&&(e=e.split(/<\/?messages>/),b.ctatdebug("msgsArr.length "+e.length+", msgsArr[1].length "+(e[1]?e[1].length:-1)),!(2>e.length))){e=e[1].split("<message>");b.ctatdebug("problemStateArr.length "+e.length);for(var c=0,f=!1,h=1;h<e.length;++h){var m="<message>"+e[h],n=CTATMsgType.getMessageType(m);CTATMsgType.STATE_GRAPH==n?f=!0:CTATMsgType.START_STATE_END==n?f=!1:f?c++:CTATMsgType.INTERFACE_ACTION==n&&h==e.length-1&&CTATMsgType.isDoneMessage(m)&&
a.getOutputStatus().isComplete()||(a.getProblemStateSaver().appendToProblemState(m,null,!0),d.push(m));b.ctatdebug("problemStateArr["+h+"] "+(f?"omit ":"keep ")+n+" omitted "+c+" kept "+d.length)}}a.enqueueForRestore(d)}}};ProblemStateRestorer.prototype=Object.create(CTATBase.prototype);ProblemStateRestorer.prototype.constructor=ProblemStateRestorer;var SCORMProblemSummary=function(){CTATBase.call(this,"SCORMProblemSummary","")};Object.defineProperty(SCORMProblemSummary,"LESSON_STATUS",{enumerable:!1,configurable:!1,writable:!1,value:"cmi.core.lesson_status"});Object.defineProperty(SCORMProblemSummary,"RAW_SCORE",{enumerable:!1,configurable:!1,writable:!1,value:"cmi.core.score.raw"});Object.defineProperty(SCORMProblemSummary,"EXIT",{enumerable:!1,configurable:!1,writable:!1,value:"cmi.core.exit"});
...
SCORMProblemSummary.SESSION_TIME);return b+e+f+a};CTATMsgType.prototype=Object.create(CTATBase.prototype);CTATMsgType.prototype.constructor=SCORMProblemSummary;"undefined"!==typeof module&&(module.exports=SCORMProblemSummary);var CTATExampleTracer=function(){function a(a,c){c?N|=1<<a:(N&=-65537>>16-a,b())}function b(){l.ctatdebug("workTheQueue() working "+N+", workQueue.length "+J.length+", restoreQueue.length "+G.length);if(0==N)for(;0!=(N=0<J.length|(0<G.length)<<1);){var a,b=!1;0<G.length?(a=G.shift(),b=!0):a=J.shift();if(!e(a,b)){l.ctatdebug("workTheQueue() suspending workQueue.length "+J.length+", restoreQueue.length "+G.length);l.stopWorking(b?1:0);break}l.ctatdebug("workTheQueue() bottom workQueue.length "+J.length+
", restoreQueue.length "+G.length)}}function e(a,b){l.lastMessageAsString=a;var e=l.lastMessageAsXML=(new CTATXML).parseXML(a),g=l.lastMessage=new CTATMessage(e),h=g.getMessageType();l.ctatdebug("CTATExampleTracer.handleMessageFromInterface(msgType "+h+")");switch(h){case CTATMsgType.SET_PREFERENCES:return f(a,g,z,e),!1;case CTATMsgType.INTERFACE_IDENTIFICATION:return!0;case CTATMsgType.UNTUTORED_ACTION:return b&&l.sendBundle([a]),d(a,g,z,e),!0;case CTATMsgType.INTERFACE_ACTION:return b&&l.sendBundle([a]),
c(a,g,z,e),!0;case CTATMsgType.PROBLEM_SUMMARY_REQUEST:return setTimeout(function(a){a=l.getProblemSummary();l.ctatdebug("CTATExampleTracer.ProblemSummaryRequest getProblemSummary() "+l.getProblemSummary());var c="<message><verb>NotePropertySet</verb><properties><MessageType>"+CTATMsgType.PROBLEM_SUMMARY_RESPONSE+"</MessageType>",c=c+SCORMProblemSummary.getProblemSummaryElements(a),c=c+("<ProblemSummary>"+a.toXML(!0)+"</ProblemSummary>"),c=c+"<end_of_transaction>true</end_of_transaction></properties></message>",
d=[];d.push(c);l.sendBundle(d);H.transition(CTATMsgType.PROBLEM_SUMMARY_RESPONSE,a.getCompletionStatus());l.ctatdebug("CTATExampleTracer.handleProblemSummaryRequest() sent result '"+c+"';");l.startWorking(b?1:0)},4E3),!1;case CTATMsgType.START_STATE_END:return H.transition(CTATMsgType.START_STATE_END),!0;case CTATMsgType.PROBLEM_RESTORE_END:return x(),!0;default:return console.log("CTATExampleTracer.handleMessageFromInterface(restoring "+b+") "+(b?"sending":"unprocessed")+" message, type "+h+"\n  "+
a),b&&l.sendBundle([a]),!0}}function f(a,b,c,d){l.ctatdebug("handleSetPreferences ()");L=!1;r=b.getProperty("problem_name");l.ctatdebug("SetPreferences.problem_name = "+r);a=c.getElementChildren(c.getElementChildren(d)[1]);for(b=0;b<a.length;b++)if(d=c.getElementName(a[b]),l.ctatdebug("SetPreferences eltName "+d),d)switch(d.toLowerCase()){case "source_id":C=c.getNodeTextValue(a[b]);break;case "question_file":v=c.getNodeTextValue(a[b]);break;case "skills":l.ctatdebug(" parseSkills("+a[b]+")");d=[];
for(var e=z.getElementChildren(a[b]),f=0;f<e.length;f++){var g=z.getElementName(e[f]);if(g&&"skill"==g.toLowerCase()){var h=z.getElementAttr(e[f],"name");if(h&&""!=h.trim()){var g=z.getElementAttr(e[f],"label"),m=z.getElementAttr(e[f],"pSlip"),n=z.getElementAttr(e[f],"description"),p=z.getElementAttr(e[f],"pKnown"),q=z.getElementAttr(e[f],"category"),u=z.getElementAttr(e[f],"pLearn"),t=z.getElementAttr(e[f],"pGuess"),P=z.getElementAttr(e[f],"history"),h=new CTATExampleTracerSkill(q,h,t,p,m,u,P);h.setLabel(g);
h.setDescription(n);d.push(h)}}}l.getProblemSummary().setSkills(new CTATSkills(d));break;case "problem_state_status":H.transition(CTATMsgType.SET_PREFERENCES,c.getNodeTextValue(a[b]));y||(y=new ProblemStateRestorer(l));l.ctatdebug("SetPreferences problemStateRestorer "+y);break;case "curriculum_service_url":CTATConfiguration.set("curriculum_service_url",c.getNodeTextValue(a[b]));break;case "restore_problem_url":y||(y=new ProblemStateRestorer(l));l.ctatdebug("SetPreferences problemStateRestorer "+
y);CTATConfiguration.set("restoreProblemUrl",c.getNodeTextValue(a[b]));break;case "session_id":S=c.getNodeTextValue(a[b]);break;case "authenticity_token":F.setAuthenticityToken(c.getNodeTextValue(a[b]))}l.ctatdebug("outputStatus "+H+", problemStateRestorer "+y);a=v;l.ctatdebug("retrieveBRD ("+a.indexOf("data:file/brd;base64,")+")");l.ctatdebug("Using network retrieval to obtain BRD ..."+a);M.retrieveXMLFile(a,c,l);y&&y.retrieveMessages(H)}function d(a,b,c,d){b=b.getTransactionID();l.ctatdebug("UntutoredAction ("+
a+"), getTransactionID "+b);F.appendToProblemState(a,l.getOutputStatus(),!1);if(!L)return!1;l.setVariablesFromSAI(d,c);return!0}function c(a,b,c,d){l.ctatdebug("Interface action received.");c=b.getTransactionID();if(!L)return!1;l.messageTank=new CTATMessageTank(l,c);l.ctatdebug("MessageTank "+l.messageTank);l.ctatdebug("InterfaceAction ("+a+"), getTransactionID "+c);var e=b.getSelectionArray().slice(0);d=b.getActionArray().slice(0);l.ctatdebug("selectionArray "+e+", message.getSelectionArray() "+
b.getSelectionArray());if(e[0]&&"_tutor"==e[0].toLowerCase())return l.ctatdebug("handleInterfaceAction tutor cmd SAI "+b.getSAI()+";"),d[0]&&"function"===typeof l[d[0]]&&(c=b.getSAI().getInput(),l[d[0]](c)),!0;!e[0]||"hint"!=e[0].toLowerCase()&&"help"!=e[0].toLowerCase()?(l.ctatdebug("calling doNewExampleTrace(null, "+b.getSAI()+") sai.selectionArray "+b.getSAI().getSelectionArray()+" msg.selectionArray "+b.getSelectionArray()),n(null,b.getSAI(),"student",!0,c,a)):(l.ctatdebug("handleInterfaceAction() hint request: hintPolicy "+
E+", errorSAI "+A),E===CTATHintPolicyEnum.HINTS_UNBIASED?(1<e.length&&(e[1]=""),1<d.length&&(d[1]="")):E!==CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY&&(E===CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY?A&&A.getSelection()?(e.splice(1,0,A.getSelection()),d.splice(1,0,"PreviousFocus")):(e[1]="",d[1]=""):E===CTATHintPolicyEnum.HINTS_BIASED_BY_ALL&&A&&A.getSelection()&&(e.splice(1,0,A.getSelection()),d[1]=CTATMsgType.PREVIOUS_FOCUS.toString())),l.startSkillTransaction(),a=[],d=u.doHint(e,
d,b.getInputArray(),"student",a,!0),b=a[0],a=b.getReportableHints(),e=d?""+d.getUniqueID():"",b.setStepID(e),l.updateSkills(CTATExampleTracerSkill.HINT,d?d.getSkillNames():[],e),l.ctatdebug("Before building hint message: tutorSAI "+b.getTutorSAI()+", hints "+a+", edge # "+e),d=(new CTATTutorMessageBuilder).createHintMessage(a,b.getTutorSAI(),e,c),l.messageTank.addToMessageTank(CTATMsgType.SHOW_HINTS_MESSAGE,d,b,null),c=(new CTATTutorMessageBuilder).createAssociatedRulesMessageForHint(a,b.getTutorSAI(),
q(CTATMsgType.DEFAULT_STUDENT_ACTOR),l.getSkillBarVector(!0),e,c),l.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,c,b,null),c=l.getProblemSummary(b.getReportableInterpretation()),l.messageTank.flushMessageTank(c,!0),l.ctatdebug("handleInterfaceAction() sent hint result "+b),A=null);return!0}function g(a,b,c){var d={tutorAdvice:null,msg:null,msgType:null};if(a.getReportableLink())return d.tutorAdvice=a.getSuccessOrBuggyMsg(),d.tutorAdvice&&d.tutorAdvice.trim()?(d.msg=c.createBuggyMessage(a.getTransactionID(),
d.tutorAdvice),d.msgType="BuggyMessage"):d.tutorAdvice=null,d;l.ctatdebug("CTATET.createBuggyMessage() past getReportableLink()");if(a.isDoneStepFailed())return d.tutorAdvice=CTATMsgType.NOT_DONE_MSG,d.msg=c.createBuggyMessage(a.getTransactionID(),d.tutorAdvice),d.msgType="BuggyMessage",d;l.ctatdebug("CTATET.createBuggyMessage() past isDoneStepFailed()");var e=b&&b.getTutorSAI()?b.getTutorSAI().getSelection():null,e=e&&""!==e.trim()?e:null,f=a.getStudentSAI()?a.getStudentSAI().getSelection():null,
f=f&&""!==f.trim()?f:null;l.ctatdebug("CTATET.createBuggyMessage() past hintSelection0 "+e+", studentSelection0 "+f);if(a.getResult()==CTATExampleTracerLink.NO_MODEL&&a.isOutOfOrder()&&e&&e!=f)return l.ctatdebug("CTATET.createBuggyMessage() to create out of order"),l.isHighlightRightSelection()?(d.tutorAdvice=l.getOutOfOrderMessage(),d.msg=c.createHighlightWidgetMessage(e,b.getTutorSAI().getAction(),d.tutorAdvice,a.getTransactionID()),d.msgType="HighlightMsg",l.ctatdebug("createBuggyMessage() out of order with highlight; rtn: "+
d)):(d.tutorAdvice=CTATGlobals.languageManager.getString("OUTOFORDER"),d.msg=c.createBuggyMessage(a.getTransactionID,d.tutorAdvice),d.msgType="BuggyMessage",l.ctatdebug("createBuggyMessage() out of order without highlight; rtn: "+d)),d;if(b=t.getDefaultBuggyMsg())return d.tutorAdvice=b,d.msg=c.createBuggyMessage(a.getTransactionID,d.tutorAdvice),d.msgType="BuggyMessage",l.ctatdebug("createBuggyMessage() default buggy msg: "+d),d;l.ctatdebug("createBuggyMessage() no buggy msg: "+d);return d}function h(a,
b,c,d){l.ctatdebug("checkForTutorAction("+a+", "+b+", "+c+", "+d+")");var e=[];e[0]=m(t.getNode(a),!0);e[1]=m(t.getNode(b),!1);l.ctatdebug("checkForTutorAction() links[0] "+e[0]+", links[1] "+e[1]+";");a=0;if(e[0]===e[1])e[1]=null;else if(null===e[0]||"undefined"===typeof e[0])a=1;b=null;l.messageTank||(l.messageTank=new CTATMessageTank(l,null));for(;a<e.length&&null!==e[a]&&"undefined"!==typeof e[a];++a)if(null==c||"undefined"==typeof c)b=n(e[a],e[a].getDefaultSAI(),e[a].getActor(),!0,null);else{b=
e[a].getEvaluatedInput(c,d.getReportableVariableTable());var f=e[a].getDefaultSAI().clone();f.setInput(b);b=n(e[a],f,e[a].getActor(),!0,null)}l.ctatdebug("checkForTutorAction() returning "+b+";");return b}function m(a,b){if(null===a||"undefined"===typeof a||1!==a.getCorrectOutDegree())return null;var c=null;a.getCorrectOutLinks().forEach(function(a){null===c&&a.isTutorPerformed(b)&&0<a.getMaxTraversals()&&(c=a)});return c}function n(a,b,c,d,e,f){l.ctatdebug("doNewExampleTrace (link "+a+", sai "+b+
", actor "+c+", doTutorPerformedSteps "+d+", transactionID "+e+", origMsgTxt "+f);var g=e;e=new CTATExampleTracerEvent(l,b,c);if(l.getOutputStatus().isComplete()&&b.isDone())return e.setResult(CTATExampleTracerLink.CORRECT_ACTION),e.setTutorSAI(b),e.setTransactionID(g),e=p(e,b,c,!1),l.ctatdebug("doNewExampleTrace("+a+", "+b+", "+c+", "+d+", "+g+") returns "+e),e;l.startSkillTransaction();a&&e.addPreloadedLinkMatch(a);var h=u.evaluate(e);l.ctatdebug("Evaluate returned : "+h+", given link "+a+", result "+
e);a?(l.ctatdebug("result.getTutorSelection() "+e.getTutorSelection()),l.ctatdebug("result.getTutorAction() "+e.getTutorAction()),l.ctatdebug("result.getTutorInput() "+e.getTutorInput()),l.ctatdebug("typeof(messageTank) "+typeof messageTank),f=e.getTutorSelection(),g=e.getTutorAction(),h=e.getTutorInput(),(g=l.messageTank.enqueueToolActionToStudent(f,g,h,CTATTutorMessageBuilder.TUTOR_PERFORMED))&&l.messageTank.setTransaction_id(g)):l.isFeedbackSuppressed()?F.replaceInProblemState(f,l.getOutputStatus(),
e.getStudentSAI(),t.getFeedbackPolicy()==CTATMsgType.HIDE_BUT_ENFORCE):e.getResult()!=CTATExampleTracerLink.CORRECT_ACTION&&e.getResult()!=CTATExampleTracerLink.FIREABLE_BUGGY_ACTION||F.appendToProblemState(f,l.getOutputStatus(),!1);e.setTransactionID(g);e=p(e,b,c,d);l.ctatdebug("doNewExampleTrace("+a+", "+b+", "+c+", "+d+", "+g+") returns "+e);return e}function q(a){return"undefined"!=typeof a&&a&&0<=a.toString().toLowerCase().indexOf("tutor")?"Tutor":"Student"}function p(a,b,c,d){l.ctatdebug("finishNewExampleTrace("+
a+", "+b+", "+c+", "+d+")");b=a.getStudentSAI();var e=a.getTutorSAI(),f=a.getTransactionID(),m=new CTATTutorMessageBuilder,n="",p=[];null!==a.getReportableLink()&&"undefined"!==typeof a.getReportableLink()?p[0]=a.getReportableLink():p[0]=null;p=p[0];if(a.isSolverResult())a.getResult();else if(a.getResult()===CTATExampleTracerLink.CORRECT_ACTION)n=p?""+p.getUniqueID():"",a.setStepID(n),CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase()!=c.toUpperCase()&&l.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION,
m.createCorrectActionMessage(f,e),a,e),null!==p&&"undefined"!==typeof p&&l.updateSkills(CTATExampleTracerSkill.CORRECT,p.getSkillNames(),p.getUniqueID()),n=a.getSuccessOrBuggyMsg(),l.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,m.createAssociatedRulesMessageForAction(a.getResult(),e,q(c),b,l.getSkillBarVector(!0,c),p?p.getUniqueID():-1,f,n),a,e),l.ctatdebug("finishNewExampleTrace() successMsg "+n),n&&l.messageTank.addToMessageTank("SuccessMessage",m.createSuccessMessage(f,n),a,null),
A=null,d&&(c=h(p?p.getNextNode():null,u.findCurrentState(!1,!1),l.lastMessage?l.lastMessage.getSAI():null,a))&&(a=c);else{l.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION,m.createInCorrectActionMessage(f,a.getInterpolatedSAI()),a,null);l.ctatdebug("about to do silent traceForHint("+b+"), selectionArray "+b.getSelectionArray());var r=l.lastSilentHintResult=new CTATExampleTracerEvent(l,b,c);r.setHintRequest(!0);var t=u.traceForHint(r);l.ctatdebug("silent hint result: "+r+"; hintLink "+t);
t||(t=u.getBestNextLink(!1,r),l.ctatdebug("getBestNextLink result: "+r+"; hintLink "+t));e=null;t&&((e=r.getTutorSAI())&&e.getSelection()&&a.setTutorSAI(e),n=""+t.getUniqueID(),a.setStepID(n));r=g(a,r,m);l.ctatdebug("createBuggyMessage() tutorAdvice: "+r.tutorAdvice+";\n  msg "+r.msg);l.updateSkills(CTATExampleTracerSkill.INCORRECT,t?t.getSkillNames():[],n);l.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,m.createAssociatedRulesMessageForAction(a.getResult(),e&&e.getSelection()?e:b,q(c),
b,l.getSkillBarVector(!0,c),n,f,r.tutorAdvice),a,null);r.msg&&l.messageTank.addToMessageTank(r.msgType,r.msg,a);A=b;d&&CTATExampleTracerLink.FIREABLE_BUGGY_ACTION==a.getResult()?(c=h(p?p.getNextNode():null,u.findCurrentState(!1,!1),l.lastMessage?l.lastMessage.getSAI():null,a))&&(a=c):a.isDoneStepFailed()&&l.messageTank.flushDelayedFeedback()}l.lastResult=a;c=l.getProblemSummary(a.getReportableInterpretation());l.ctatdebug("finishNewExampleTrace() to flushMessageTank");l.messageTank.flushMessageTank(c,
!0);l.ctatdebug("finishNewExampleTrace() sent result "+a.getResult()+", studentSAI "+b);return a}function x(){H.transition(CTATMsgType.PROBLEM_RESTORE_END);var a=l.getSkillBarVector(),b=[],c=new CTATTutorMessageBuilder;b.push(c.createMessage(CTATMsgType.PROBLEM_RESTORE_END,a?{Skills:a}:null));l.sendBundle(b)}CTATBase.call(this,"CTATExampleTracer","tracer");var l=this,v=null,u,B,t,z=new CTATXML;new XMLSerializer;var A=null,E,I=!0,w=!1,D=null,r=null,C=null,F=new ProblemStateSaver(l);F.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());
var y=null,H=new CTATProblemStateStatus,G=[],J=[],N=0,L=!1,S="",Q=null;l.ctatdebug("CTATExampleTracer constructor outputStatus="+H);this.messageTank=this.lastSilentHintResult=this.lastResult=this.lastMessage=this.lastMessageAsXML=this.lastMessageAsString=null;var M=new CTATCommLibrary;this.receiveFromInterface=function(a){l.ctatdebug("CTATExampleTracer.receiveFromInterface() \n  "+a);J.push(a);b()};this.setVariablesFromSAI=function(a,b){var c=CTATMsgType.getSAIArraysFromElement(a,b);l.getTracer()&&
l.getTracer().addInterfaceVariables(c.selection,c.input)};this.traceLinks=function(a){for(var b=[],c=l.getTracer().getBestInterpretation(),d=0;d<a.length&&null!==a[d];++d)c.getTraversalCount(a[d])<a[d].getMinTraversals()&&(l.messageTank=new CTATMessageTank(l,null),b.push(n(a[d],a[d].getDefaultSAI(),a[d].getActor(),!1,null)),l.ctatdebug("traceLinks["+d+"] result "+b[d]));return b};this.enqueueForRestore=function(a){l.ctatdebug("enqueueForRestore: got "+a.length+" message elements");G=G.concat(a);a=
(new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null);G.push(a);l.startWorking(1)};this.startWorking=function(b){a(b,!1)};this.stopWorking=function(b){a(b,!0)};this.goToState=function(a){u.resetTracer();return u.goToState(a,l)};this.goToStartState=function(){return l.goToState("start")};this.processXML=function(a){l.ctatdebug("processXML ()");if(null!=a){l.ctatdebug("No of children"+z.getElementChildren(a).length);var b=new CTATGraphParser,c=b.parseGraph(a,l);t=c.gr;u=
c.tracer;a=c.ssm;c=c.sgMsg;l.ctatdebug("sendStartStateMessages() nMsgs "+a.length+", outputStatus "+H);for(var d=[],e=new XMLSerializer,f=null,g=0;g<a.length;g++)if("message"==z.getElementName(a[g])){var m=e.serializeToString(a[g]),n=CTATMsgType.getMessageType(m);CTATMsgType.UNTUTORED_ACTION!=n&&CTATMsgType.INTERFACE_ACTION!=n||l.setVariablesFromSAI(a[g],z);CTATMsgType.START_STATE_END==n?(f=d,t.getFeedbackPolicy()!=CTATMsgType.SHOW_ALL_FEEDBACK&&(n=new CTATSAI("hint","SetVisible","false"),n=(new CTATTutoringServiceMessageBuilder).createInterfaceActionMessage("dummyTransactionID",
n),f.push(n)),f=m,d.push((new CTATTutoringServiceMessageBuilder).createInterfaceConfigurationEnd()),d.push((new CTATTutorMessageBuilder).createLockWidgetMsg(b.getLockWidget()))):d.push(m)}d.unshift(c);l.ctatdebug("sendStartStateMessages(): "+a.length+" elts, "+d.length+" strings, "+H);l.sendBundle(d);b=f;a:{a=[];c=t.getStartNode();d=t.getStudentStartsHereNode();if(null!==c&&null!==d&&c.getNodeID()!=d.getNodeID()){a=t.getBestSubpath(c,d);l.ctatdebug("advanceToStudentStartsHere() path "+a);if(!a)break a;
a=a.getSortedLinks();a=l.traceLinks(a);l.ctatdebug("advanceToStudentStartsHere() results "+a)}d=c=null;0<a.length&&(d=a[a.length-1],a=d.getReportableLink(),null!==a&&(c=a.getNextNode()));l.ctatdebug("advanceToStudentStartsHere() to check for TPA "+c+", "+d);h(c,u.findCurrentState(!1,!1),null,d)}a=[];b&&a.push(b);H.canRestore()||a.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null));0<a.length&&l.sendBundle(a);L=!0}l.startWorking(0)};this.addGraphSkills=function(a){l.ctatdebug("adding graph skills: "+
a.length);0<a.length&&(a=new CTATSkills(a),a.setExternallyDefined(!1),l.getProblemSummary().setSkills(a))};this.sendBundle=function(a){l.ctatdebug("sending bundle #msgs = "+a.length+", outputStatus "+H);for(var b=0,c=0;c<a.length;c++){l.ctatdebug("Sending message #"+c);var d=a[c];0>=c&&(d='<?xml version="1.0" encoding="UTF-8"?>'+d);F.forwardToInterface(d,c>=a.length-1,H)&&++b}return 0<b};this.setHintPolicy=function(a){E=CTATHintPolicyEnum.lookup(a)};this.isHighlightRightSelection=function(){return I};
this.setHighlightRightSelection=function(a){I=a};this.updateSkills=function(a,b,c){var d=[];l.ctatdebug("in updateSkills("+b+") with step ID = "+c+", transaction result = "+a);var e=l.getProblemSummary().getSkills();if(null===e||"undefined"===typeof e)return d;b.forEach(function(b){b=e.updateSkill(a,b,c);null!==b&&"undefined"!==typeof b&&d.push(b)});return d};this.getSessionID=function(){return S};this.getProblemSummary=function(a){l.ctatdebug("Entering getProblemSummary() problemSummary "+D);if(null===
D||"undefined"===typeof D){var b=l.getProblemName();D=null===b||"undefined"===typeof b||1>b.length?new CTATProblemSummary("NoProblemDefined",null,l.isFeedbackSuppressed()):new CTATProblemSummary(b,null,l.isFeedbackSuppressed())}a&&D.setRequiredSteps(a.countStepsForScore(t));return D};this.getProblemName=function(){return r};this.getSourceID=function(){return C};this.isSourceFlash=function(){return"string"==typeof C&&C.match(/flash/i)};this.isFeedbackSuppressed=function(){return w};this.setFeedbackSuppressed=
function(a){w="false"===a?!1:"true"===a?!0:a===CTATMsgType.SHOW_ALL_FEEDBACK?!1:a===CTATMsgType.HIDE_ALL_FEEDBACK?!0:a===CTATMsgType.HIDE_BUT_ENFORCE?!0:a===CTATMsgType.HIDE_BUT_COMPLETE?!0:!1;l.ctatdebug("setFeedbackSuppressed("+a+"): "+w);D&&D.setCountOnlyLastResults(w)};this.getSkillBarVector=function(a,b){var c=l.getProblemSummary().getSkills();return null===c||"undefined"===typeof c?null:"Student"!=q(b)?null:"undefined"!=typeof a&&a?c.getSkillBarVector(!1,!1):c.getSkillBarVector(!0,!0)};this.startSkillTransaction=
function(){var a=l.getProblemSummary().getSkills();a&&a.startTransaction()};this.getProblemStateSaver=function(){return F};this.isSendingSavedMsgsForRestore=function(){return l.getOutputStatus().isSendingSavedMsgsForRestore()};this.getOutputStatus=function(){return H};this.setOutputStatus=function(a){var b=H.getStatus();l.ctatdebug("setOutputStatus() old "+b+", new "+a);CTATProblemStateStatus[a]?H.setStatus(CTATProblemStateStatus[a]):(console.error("CTATExampleTracer.setOutputStatus() unexpected argument "+
a),H.setStatus(CTATProblemStateStatus.empty))};this.getFeedbackPolicy=function(){return t?t.getFeedbackPolicy():CTATMsgType.SHOW_ALL_FEEDBACK};this.getGraph=function(){return t};this.getTracer=function(){return u};this.getOutOfOrderMessage=function(){return B?B:CTATMsgType.DEFAULT_OUT_OF_ORDER_MESSAGE};this.setOutOfOrderMessage=function(a){B=a};this.getDelayedFeedback=function(){null==Q&&(Q={});return Q};this.clearDelayedFeedback=function(){Q=null};this.getQuestionFile=function(a){if(!v||a)return v;
a=v.split("/");return a[a.length-1]}};CTATExampleTracer.prototype=Object.create(CTATBase.prototype);CTATExampleTracer.prototype.constructor=CTATExampleTracer;"undefined"!==typeof module&&(module.exports=CTATExampleTracer);
