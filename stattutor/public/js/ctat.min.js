...
CTAT.Math.Fraction.prototype = Object.create(CTAT.Math.Fraction.prototype, {numerator:{get:function() {
  ...
  b ? (this._numerator = +b[1], this._denominator = +b[2]) : this.fromValue(a);
}}, fromValue:{value:function(a) {
  this._numerator = +a.valueOf();
  this._denominator = 1;
  ...
  this._numerator = 0;
  this._denominator = 1;
  "undefined" !== typeof a && b ? (this.numerator = "number" === typeof a ? a : "string" === typeof a ? +a : a ? a.valueOf() : 0, this.denominator = "number" === typeof b ? b : "string" === typeof b ? +b : b.valueOf()) : a && (a instanceof CTAT.Math.Fraction ? (this.numerator = a.numerator, this.denominator = a.denominator) : "number" === typeof a ? (this.numerator = a, this.denominator = 1) : "string" === typeof a ? this.fromString(a) : (this.numerator = a ? a.valueOf() : 0, this.denominator = 1));
...
;var CTATGlobalFunctions = {stringToBoolean:function(a) {
...
}, generateDefaultConfigurationObject:function() {
  ...
  CTATGlobalFunctions.isCTATObject(a) ? a.setTutorDimensions(b, c) : (a.width = b, a.height = c);
}, setTutorValue:function(a, b, c) {
  CTATGlobalFunctions.isCTATObject(a) ? a.setTutorValue(b, c) : a[b] = c;
...
var CTATConfiguration = function() {
  ...
  this.setTutorDimensions = function(a, b, d) {
  };
  this.setTutorValue = function(a, b, d) {
  };
...
var CTATGraphicsTools = function(a, b, c, e, g, d) {
  ...
  this.drawTextFormatted = function(a, b, d, e, f, c, g, m, k, h) {
    if (null != l) {
      a += p;
      b += p;
      e = "";
...
var CTATWSConnection = function(a) {
  ...
  var b = "", c = !1, e = this, g = null, d = [], f = !1, h = 0, k = 0, m = null;
  e.setSocketType("ws");
  this.setConsumed = function(a) {
    c = a;
  ...
  this.send = function() {
    e.ctatdebug("send ()");
    e.init();
    !1 === f ? (e.ctatdebug("Connection not ready yet, storing ..."), d.push(b)) : (e.ctatdebug("Connection ready, sending data ..."), h = (new Date).getTime(), g.send(b));
  };
};
...
var CTATSAI = function(a, b, c, e) {
  ...
  this.getArgumentsTyped = function() {
    ...
    for (var a = 0, b = [], a = 0;a < k.length;a++) {
      var d = k[a];
      "Boolean" === d.getType() ? (this.ctatdebug("Adding Boolean argument (" + d.getValue() + ") ..."), b.push(h.String2Boolean(d.getValue()))) : "Number" === d.getType() ? (this.ctatdebug("Adding Number argument (" + d.getValue() + ") ..."), b.push(+d.getValue())) : "String" === d.getType() ? "No_Value" === d.getValue() ? (this.ctatdebug("Detected default argument (" + d.getValue() + "), setting contents to null instead"), b.push(null)) : b.push(String(d.getValue())) : this.ctatdebug("Unrecognized argument type: " + 
  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("internalArguments" == r.getElementName(c) || "value" == r.getElementName(c) || "Input" == r.getElementName(c)) {
        var b = r.getElementChildren(c), m = null;
        k = [];
        ...
        for (var h = 0;h < b.length;h++) {
          var l = b[h];
          "value" == r.getElementName(l) && (m = r.getElementChildren(l), null !== m ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + m.length), 1 === m.length ? (m = f.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + m), e.setValue(m)) : (m = f.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + m), e.setValue(m), e.setName(l.attributes.getNamedItem("name").value), e.setType(l.attributes.getNamedItem("type").value), 
          e.setFormat(l.attributes.getNamedItem("format").value), g++), 1 > h ? this.setInputArray(m) : this.appendToInputArray(m)) : (l = f.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), e.setValue(l), 1 > h ? this.setInputArray(l) : this.appendToInputArray(l)));
        }
      }
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("internalArguments" == r.getElementName(c) || "Input" == r.getElementName(c)) {
        b = c.childNodes;
        k = [];
        var f = new CTATHTMLManager, e = new CTATArgument, g = 0, m = null;
        k.push(e);
        for (var h = 0;h < b.length;h++) {
          if (m = b[h], "value" == r.getElementName(m)) {
            var l = r.getElementChildren(m);
            null !== l ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + l.length), 1 === l.length ? (m = f.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), e.setValue(m)) : (m = f.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), e.setValue(m), e.setName(r.getElementAttr("name")), e.setType(r.getElementAttr("type")), e.setFormat(r.getElementAttr("format")), g++)) : (m = f.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + 
            m), e.setValue(m));
  ...
  this.isDone = function() {
    var a = t.getSelection(), b = t.getAction();
...
CTAT.Component.Base.UnitDisplay = function(a, b, c, e, g, d, f) {
  ...
  this.change_denominator = function(a) {
    return this.set_denominator(this.get_denominator() + +a);
  };
...
var CTATJumble = function(a, b, c, e, g) {
  ...
  this.init_items = function(a) {
    if (l) {
      ...
      for (var d = a.length, c = 0;c < d;c++) {
        ...
        f.addEventListener("dragstart", v, !1);
  ...
  this.getOrder = function() {
    for (var a = l.children, b = [], c = 0;c < a.length;c++) {
      var f = a[c];
...
var CTATNumberLine = function(a, b, c, e, g) {
  ...
  this.X_Axis = new function(a, b, d, c) {
    var f = {};
    this.svg_group = null;
    var e = a;
      ...
      a.reduce(function(a, b, f, m) {
        if (1 <= b.valueOf()) {
          ...
          if (0 < d && d < c) {
            ...
            l = l.add(k);
            l = CTAT.Geom.Point.circle_intersection(v, l, e, c).reduce(n.bind(this, l));
          }
          k = CTAT.Geom.Point.to2DString;
          v = "M " + k(v);
          n = new DOMPoint(c, c);
          v += " L " + k(m);
          v += " A " + k(n) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + k(l);
...
var scrimIsUp = !1, errorScrim = !1, waitScrim = !0, warnScrim = !1, connectionScrim = !1, authorTimeSet = !0, inAuthorTime = !0, CTATScrim = function() {
  ...
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (t.ctatdebug("scrimUp ()"), b = CTATGlobals.languageManager.filterString(b), t.ctatdebug("Message: " + b), 1 == scrimIsUp ? (e = 1 == waitScrim ? b : e + (" \n " + b), m.removeComponent()) : (e = b, scrimIsUp = !0), t.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
  ...
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && t.scrimDownForced(), t.ctatdebug("OKScrimUp (" + a + "," + b + ")"), d = g = f = warnScrim = errorScrim = !1, t.scrimUp(a), r = c(b, "OK"), $(r).appendTo("#scrimpanel"));
  };
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  this.logTutorResponse = function(a, d, c, f, e, g, m, h, k) {
...
var OLIDriver = function(a) {
  ...
  this.oliBeganSession = function(a, b) {
    ...
    +a ? oliComm.loadContentFile(b) : oliComm.startAttempt();
  };
  ...
  this.translateURL = function(a) {
    ...
    for (var d = flashVars.getRawFlashVars(), f = getIndicesOf("<img", a, !1), e = getIndicesOf("<a", a, !1), k = -1, m = k = -1, n = !1, l = "", k = "";!1 === n;) {
      n = !0;
...
var currentOLIModule = "", OLIMessageHandler = function() {
  ...
  this.parseBeginSession = function(b) {
    ...
    if (void 0 == f) {
      ...
      f = c.getElementAttr(f, "guid");
      g.resource_file_id = f;
      if (k = b.getElementsByTagName("section")[0]) {
        g.class_name = c.getElementAttr(k, "admit_code"), g.class_description = c.getElementAttr(k, "title"), g.school_name = c.getElementAttr(k, "institution");
      }
      (k = b.getElementsByTagName("instructors")[0]) && (k = c.getElementChildren(k)) && (g.instructor = c.getElementAttr(k[0], "guid"));
      (k = b.getElementsByTagName("user")[0]) && "review" != g.activity_mode && (g.user_guid = c.getElementAttr(k, "guid"));
      if (k = b.getElementsByTagName("activity")[0]) {
        if (g.activity_guid = c.getElementAttr(k, "guid"), k = k.getElementsByTagName("item_info")[0]) {
          if (k = k.getElementsByTagName("resource_info")[0]) {
            if (k = k.getElementsByTagName("file")[0]) {
              if (k = c.getElementAttr(k, "href")) {
                var m = k.indexOf("/x-cmu");
                this.setCurrentModule(k.substr(0, m));
              }
            }
          }
        }
      ...
      if (k = b.getElementsByTagName("file_record")[0]) {
        for (g.file_record_file_name = c.getElementAttr(k, "file_name"), k = c.getElementChildren(k), m = 0;m < k.length;m++) {
          var n = k[m];
  ...
  this.parseFileRecord = function(a) {
    ...
    var b = +c.getElementAttr(a, "date_created"), g = c.getElementAttr(a, "file_size");
  ...
  this.translateFromCTAT = function(c, e) {
    ...
    if (-1 != g.indexOf(".r")) {
      ...
      if (0 >= d.length) {
        ...
        return f = d[1], d = d[0].substr(1), b.ctatdebug("Original row (1st format): " + d + " original col: " + f), f = !0 === e ? colName(f, !1) + d : h[0] + "." + colName(f, !1) + d, b.ctatdebug("Translated: " + f), f;
      }
    } else {
      if (0 === g.indexOf("r")) {
...
var CTATCheckBox = function(a, b, c, e, g) {
  ...
  this.data_ctat_handler["label-placement"] = this.setLabelPlacement;
  var n = function(a) {
    this.updateSAI();
    this.processClick(a);
  };
...
var CTATTable = function(a, b, c, e, g) {
  ...
  this.adjustTableContents = function() {
    ...
    for (var a = f.createTBody(), e = b;e < k;e++) {
...
var CTATCommShell = function() {
  ...
  this.showFeedback = function(a) {
    ...
    "" == a ? b.ctatdebug("False alarm: empty message") : (CTATShellTools.showFeedback(a), null != f && f(a));
  };
...
CTATTutor.getSingleParameterValues = function(a) {
  ...
  c.forEach(function(c, g) {
    a.forEach(function(a) {
      ...
      c[a] && b.push(c[a]);
      c[a.toUpperCase()] && b.push(c[a.toUpperCase()]);
    });
  }, b);
...
function centerTutorContainer() {
  ...
  if (null == a) {
    ...
    if (flashVars) {
      ...
      b.centerTutor ? 1 == b.centerTutor && (ctatdebug("Moving tutor over by: " + ("-" + c / 2 + "px 0 0 -" + e / 2 + "px;")), a.style.position = "absolute", a.style.top = "0", a.style.left = "0", a.style.right = "0", a.style.bottom = "0", a.style.margin = "auto") : ctatdebug("The tutor is not configured to center the container, bump");
    } else {
...
Math.clz32 || (Math.clz32 = function(a) {
  return (a = +a >>> 0) ? 32 - a.toString(2).length : 32;
});
...
Array.prototype.lastIndexOf || (Array.prototype.lastIndexOf = function(a) {
  ...
  b = e - 1;
  1 < arguments.length && (b = +arguments[1], b != b ? b = 0 : 0 != b && b != 1 / 0 && b != -(1 / 0) && (b = (0 < b || -1) * Math.floor(Math.abs(b))));
...
String.prototype.codePointAt || function() {
  var a = function(a) {
    ...
    var c = String(this), e = c.length, g = a ? +a : 0;
    g != g && (g = 0);
    if (!(0 > g || g >= e)) {
...
(function(a) {
  ...
  b.format = function(a, d) {
    var f = 1, k = a.length, h = "", m = [], n, p, B, u, D = !0, q = "";
    for (n = 0;n < k;n++) {
      if (h = c(a[n]), "string" === h) {
        m[m.length] = a[n];
      } else {
        if ("array" === h) {
          B = a[n];
          if (B[2]) {
            for (h = d[f], p = 0;p < B[2].length;p++) {
              if (!h.hasOwnProperty(B[2][p])) {
          ...
          "function" == c(h) && (h = h());
          if (e.test(B[8]) && "number" != c(h) && isNaN(h)) {
          ...
          switch(B[8]) {
            ...
            case "d":
              ...
              break;
            case "e":
              h = B[7] ? h.toExponential(B[7]) : h.toExponential();
              break;
            case "f":
              h = B[7] ? parseFloat(h).toFixed(B[7]) : parseFloat(h);
              break;
            case "o":
              h = h.toString(8);
              break;
            case "s":
              h = (h = String(h)) && B[7] ? h.substring(0, B[7]) : h;
              break;
            case "u":
              h >>>= 0;
              break;
          ...
          if (!D || g.test(B[8]) && B[3]) {
            q = D ? "+" : "-", h = h.toString().replace(l, "");
          }
          p = B[4] ? "0" == B[4] ? "0" : B[4].charAt(1) : " ";
          u = B[6] - (q + h).length;
          u = B[6] ? Array(u + 1).join(p) : "";
          m[m.length] = B[5] ? q + h + u : 0 == p ? q + u + h : u + q + h;
        }
      }
    }
    return m.join("");
...
var CTATWildcardMatcher = function(a, b) {
  function c(a) {
    ...
    var b = (new String(a)).replace(RegExp("\\?", "g"), "."), c = b.replace(RegExp("\\*", "g"), ".*"), h = c.replace(RegExp("\\[\\!", "g"), "[^");
        ...
        if (A.msg) {
          ...
          if (!(C = e(A))) {
            ...
            if (!(C && C.sai && (B = C.sai.getAction()) && (u = p.exec(B))) || 3 > u.length || 1 >= u[2]) {
              ...
              D && D.timeout == u[2] ? D.msgTuples.push(C) : z.push({timeout:+u[2], msgTuples:[C]});
              C = !0;
            }
          }
          C || m.push(A.msg);
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var c = new CTATExampleTracerLink(null, null, null), e = f.getElementChildren(a), g, h, l, k, m, p = a = -1, u = CTATMsgType.DEFAULT_ACTOR, D = !1, q = 0;q < e.length;q++) {
      ...
      if ("actionLabel" === f.getElementName(e[q])) {
        for (c.setIsPreferredLink("false" != f.getElementAttr(e[q], "preferPathMark")), c.setMinTraversalsStr(f.getElementAttr(e[q], "minTraversals")), c.setMaxTraversalsStr(f.getElementAttr(e[q], "maxTraversals")), E = f.getElementChildren(e[q]), F = 0;F < E.length;F++) {
          ...
          "message" === f.getElementName(E[F]) && (k = new CTATMessage(E[F]));
          ...
          if ("matchers" === f.getElementName(E[F])) {
            for (var y = f.getElementChildren(E[F]), G = 0;G < y.length;G++) {
              "Selection" === f.getElementName(y[G]) && (g = b(y[G], 0)), "Action" === f.getElementName(y[G]) && (h = b(y[G], 1)), "Input" === f.getElementName(y[G]) && (l = b(y[G], 2)), "Actor" === f.getElementName(y[G]) && (u = f.getNodeTextValue(y[G]), D = (D = f.getElementAttr(y[G], "linkTriggered")) && "false" != D.toLowerCase().trim() ? !0 : !1);
            }
          }
  ...
  function c(a, b) {
    ...
    for (var h = function(a) {
      ...
      if ("link" === f.getElementName(l[k])) {
        var n = +f.getElementAttr(l[k], "id"), p = b[n];
        if (null !== p || void 0 !== p) {
