...
(function(a, b) {
  ...
  d(h.prototype, {spin:function(b) {
    ...
    d.lines(e, d.opts);
    if (!n) {
      var c = 0, h = (f.lines - 1) * (1 - f.direction) / 2, l, k = f.fps, m = k / f.speed, r = (1 - f.opacity) / (m * f.trail / 100), u = m / f.lines;
      (function F() {
        c++;
        for (var a = 0;a < f.lines;a++) {
          l = Math.max(1 - (c + (f.lines - a) * u) % m * r, f.opacity), d.opacity(e, a * f.direction + h, l, f);
        }
...
CTAT.Component.Base.UnitDisplay = function(a, b, c, e, g, d, f) {
  ...
  this.set_denominator = function(a) {
    ...
    if (!isNaN(b) && (b = y(b), this.get_denominator() != a)) {
      ...
      b.equals(0) || (a.push(B(b, !0)), a.push(B(f.subtract(b), !1)), e--);
      for (b = 0;b < e;b++) {
        a.push(B(f, !1));
      }
  ...
  this.init_items = function(a) {
    if (n) {
      ...
      for (var d = a.length, f = 0;f < d;f++) {
        ...
        c.addEventListener("dragend", B, !1);
        b.appendChild(c);
        C.push(c);
      }
      n.innerHTML = "";
...
var CTATNumberLine = function(a, b, c, e, g) {
  ...
  this.setPointSize = function(a) {
    n = Number(a);
    t && (t.setAttributeNS(null, "r", n), $(this._point_group).find("circle").each(function() {
      $(this).attr("r", n);
    }));
  };
  ...
  var u = function() {
    if (null != this.X_Axis && null != this.X_Axis.svg_group) {
      ...
      0 < Math.abs(CTAT.Math.round(t)) && (t = new DOMPoint((m - g * a.top) / e, a.top), e = new DOMPoint((m - g * a.bottom) / e, a.bottom), a.containsPoint(t) || a.containsPoint(e)) && (c.distance(t) < c.distance(e) ? (b = e, d = t) : (b = t, d = e));
  ...
  }.bind(this), r = 0, t = null, w = new DOMPoint(-30, -30), x = !1, C = function(a) {
    w.x = a.clientX;
    w.y = a.clientY;
  }, B = function(a) {
    ...
    if (!0 === this.getEnabled()) {
      this.setHintHighlight(!1);
      var b;
      p ? (a = D(a.clientX, a.clientY), b = a.location, a = a.data) : (a = y(a.clientX, a.clientY), b = this.X_Axis.getProjectedPoint(a), a = this.X_Axis.getAxisValue(a));
  ...
  this.init = function() {
    ...
    this.component.addEventListener("mouseenter", function() {
      !0 === a() && (x = !0, t.style.visibility = null, r = requestAnimationFrame(A));
    });
    this.addSafeEventListener("click", q);
    this.component.addEventListener("focus", this.processFocus);
  };
  var y = function(a, b) {
  ...
  }.bind(this), v = function(a, b) {
    return this.getProjectedPoint(y(a, b));
  }.bind(this.X_Axis), D = function(a, b) {
    for (var d = v(a, b), c = null, f = Number.POSITIVE_INFINITY, e, g, l = 0;l < this._tickmarks.length;l++) {
    ...
    if (x && !0 === this.getEnabled()) {
      if (p) {
        ...
        t.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(v(w.x, w.y), !0));
      }
  ...
  this.saveAsYouGo = function(h) {
    ...
    if (e && a) {
      ...
      if (CTATBase.inOLI()) {
        ...
        CTATBase.inXBlock() ? (k.score = h.getCorrect(), k.max_score = h.getRequiredSteps()) : (k.session_id = encodeURIComponent(a.getSessionID()), k.authenticity_token = encodeURIComponent(g), k.summary = encodeURIComponent(h.toXML(!1)));
      }
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  15:l, 26:[1, 46]}, {5:[2, 2], 13:k, 15:l}, {5:[2, 3], 13:k, 15:l}, {5:[2, 4], 13:k, 15:l}, {5:[2, 5], 13:k, 15:l}, {5:[2, 6], 13:k, 15:l}, {5:[2, 7], 13:k, 15:l}, b(m, [2, 9], {22:9, 19:25, 16:n, 18:p, 20:u, 21:r, 24:g, 25:d, 27:f, 28:h}), b(m, [2, 10], {22:9, 19:25, 16:n, 18:p, 20:u, 21:r, 24:g, 25:d, 27:f, 28:h}), b(t, [2, 12]), b(t, [2, 13]), b(t, [2, 15]), b(t, [2, 16]), b(t, [2, 21]), b(w, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    ...
    var b = [0], c = [null], d = [], f = this.table, e = "", g = 0, k = 0, h = 0, m = d.slice.call(arguments, 1), l = Object.create(this.lexer), n = {}, p;
    for (p in this.yy) {
    ...
    for (var t, u, w, I, M = {}, N, J;;) {
      w = b[b.length - 1];
      if (this.defaultActions[w]) {
        I = this.defaultActions[w];
      } else {
        if (null === t || "undefined" == typeof t) {
          t = void 0, t = l.lex() || 1, "number" !== typeof t && (t = this.symbols_[t] || t);
        }
        I = f[w] && f[w][t];
      }
      if ("undefined" === typeof I || !I.length || !I[0]) {
        ...
        O = l.showPosition ? "Parse error on line " + (g + 1) + ":\n" + l.showPosition() + "\nExpecting " + J.join(", ") + ", got '" + (this.terminals_[t] || t) + "'" : "Parse error on line " + (g + 1) + ": Unexpected " + (1 == t ? "end of input" : "'" + (this.terminals_[t] || t) + "'");
        this.parseError(O, {text:l.match, token:this.terminals_[t] || t, line:l.yylineno, loc:p, expected:J});
      }
      ...
      switch(I[0]) {
        case 1:
          ...
          b.push(I[1]);
          t = null;
          u ? (t = u, u = null) : (k = l.yyleng, e = l.yytext, g = l.yylineno, p = l.yylloc, 0 < h && h--);
          break;
        case 2:
          ...
          r && (M._$.range = [d[d.length - (J || 1)].range[0], d[d.length - 1].range[1]]);
          w = this.performAction.apply(M, [e, k, g, n, I[1], c, d].concat(m));
  ...
  this.interpolateHints = function(a) {
    ...
    n.forEach(function(a) {
      if (!(1 > String(a).trim().length)) {
        var d = x.getDefaultSAI().getSelection(), f = x.getDefaultSAI().getAction(), e = CTATVariableTable.standardizeType(x.getDefaultSAI().getInput());
        x.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate(" + a + ", " + d + ", " + f + ", " + e + ")");
        a = c.interpolate(a, d, f, e);
...
var CTATExpressionMatcher = function(a, b) {
  ...
  this.interpolate = function(a, b, c, d) {
    try {
      ...
      return (new CTATFormulaParser(f)).interpolate(a, b, c, d);
    } catch (e) {
      return null;
    }
  };
  this.evaluate = function(a, b, c, d) {
    ...
    try {
      ...
      return h.ctatdebug("CTATExpressionMatcher --\x3e " + f.name + ": " + f.message), null;
    }
  };
  ...
  this.match = function(a, b, c, d, f) {
    return h.matchConcatenation(a, b, c, f);
  };
...
var CTATVectorMatcher = function(a, b, c, e) {
  ...
  var l = this;
  this.match = function(a, b, c, d, f) {
    return !1 !== g(a, b, c, f) && l.matchActor(d) ? !0 : !1;
  };
  ...
  this.matchForHint = function(a, b, c, f) {
    ...
    b = !1;
    b = d[0];
    return b = Array.isArray(a) ? b.matchConcatenation(a, l.getDefaultActionArray(), l.getDefaultInputArray(), f) : b.matchConcatenation([a], l.getDefaultActionArray(), l.getDefaultInputArray(), f);
  };
  this.setCaseInsensitive = function(a) {
...
var CTATExampleTracer = function() {
  ...
  function k(a, b, c, e, g, h) {
    ...
    h = k.getStudentSAI();
    var l = k.getTutorSAI(), q = k.getTransactionID(), r = new CTATTutorMessageBuilder, t = [];
    ...
    if (k.isSolverResult()) {
      ...
      if (k.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        n = t ? "" + t.getUniqueID() : "", k.setStepID(n), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && m.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, r.createCorrectActionMessage(q, l), k, l), null !== t && "undefined" !== typeof t && m.updateSkills(CTATExampleTracerSkill.CORRECT, t.getSkillNames(), t.getUniqueID()), n = k.getSuccessOrBuggyMsg(), m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, r.createAssociatedRulesMessageForAction(k.getResult(), 
        l, h, m.getSkillBarVector(), t.getUniqueID(), q, n), k, l), m.ctatdebug("finishNewExampleTrace() successMsg " + n), n && m.messageTank.addToMessageTank("SuccessMessage", r.createSuccessMessage(q, n), k, null), w = null, e && (u = f(t ? t.getNextNode() : null, p.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = u);
      } else {
        m.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION, r.createInCorrectActionMessage(q, h), k, null);
        ...
        m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, r.createAssociatedRulesMessageForAction(k.getResult(), l && l.getSelection() ? l : h, h, m.getSkillBarVector(), n, q, v.tutorAdvice), k, null);
        v.msg && m.messageTank.addToMessageTank(v.msgType, v.msg, k);
        w = h;
        e && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == k.getResult() && (u = f(t ? t.getNextNode() : null, p.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = u);
      }
    }
    m.lastResult = k;
  ...
  new XMLSerializer;
  var w = null, x, C = CTATMsgType.SHOW_ALL_FEEDBACK, B = !0, q = !1, y = null, v = null, D = new ProblemStateSaver(m), A = null, z = new CTATProblemStateStatus, E = [], F = [], G = 0, K = !1, H = "";
