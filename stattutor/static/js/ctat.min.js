  ...
  var b = function() {
    ...
    "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, e = function(a) {
      ...
      for (var e = {}, g = b.olson.dst_rules.zones, l = g.length, k = a[f], x = 0;x < l;x++) {
        var C = g[x], B;
        B = g[x];
        for (var q = 0, y = 0;y < d.length;y++) {
          if (B.rules[y] && d[y]) {
            if (d[y].s >= B.rules[y].s && d[y].e <= B.rules[y].e) {
              q = 0, q += Math.abs(d[y].s - B.rules[y].s), q += Math.abs(B.rules[y].e - d[y].e);
            } else {
              q = "N/A";
              break;
            }
...
;var CTATShape = function(a, b, c, e, g, d) {
  ...
  var h = [], k = [], l = g, m = d, n = b, p = void 0, u = "black", r = "black", t = "Arial", w = 12, x = [], C = 1, B = 5, q = document.createElement("canvas");
  q.id = n;
  q.width = l;
  q.height = m;
  var y = new CTATCSS;
  ...
  q.setAttribute("style", y.toCSSString());
  getSafeElementById(a).appendChild(q);
  var v = new CTATGraphicsTools(q.getContext("2d"));
  v.setGraphicBorderWidth(C);
  v.setLineColor(u);
  v.setFillColor(r);
  ...
  this.setWidth = function(b) {
    l = b;
    "main-canvas" != a && (q.width = l);
  };
  this.setHeight = function(b) {
    m = b;
    "main-canvas" != a && (q.height = m);
  };
  this.setName = function(a) {
    n = a;
  };
  ...
  this.drawLine = function() {
    v.drawLine(h[0] + C, k[0] + C, h[1], k[1], u, C);
  };
  this.drawCircle = function() {
    v.drawCircle(h[0] + B, k[0] + B, B);
  };
  this.drawCircleFilled = function() {
    v.drawCircleFilled(h[0] + B, k[0] + B, B - 1);
  };
  this.drawRectangle = function(a, b, d, e) {
    v.drawRectangle(a[0] + C, b[0] + C, l - C, m - C);
  };
  this.drawRectangleFilled = function() {
    v.drawRectangleFilled(h[0], k[0], l, m);
  };
  this.drawRoundedRect = function() {
    v.drawRoundedRect(h[0] + C, k[0] + C, l - B - C, m - B - C, B);
  };
  this.drawRoundedRectFilled = function() {
    v.drawRoundedRectFilled(h[0] + C, k[0] + C, l - B - C, m - B - C, B);
  };
  this.drawText = function() {
    v.drawText(w / 2, w / 2, p);
  };
  this.drawTriangle = function() {
    v.drawTriangle(h[0] + C, k[0] + C, h[1], k[1], h[2], k[2]);
  };
  ...
  this.erase = function() {
    ...
    for (var b = 0;b < x.length;b++) {
      q.addEventListener(x[b][0], x[b][1]);
    }
  };
};
...
var CTATCompBase = function(a, b, c, e, g, d) {
  ...
  var f = c || 0, h = e || 0, k = g || -2, l = d || -2, m = 50, n = 25, p = !1, u = "", r = !1, t = !0, w = null, x = "", C = -1;
  this.isTabIndexable = !0;
  var B = 0, q = null, y = null, v = this, D = null, A = "hidden", z = CTATGlobalFunctions.gensym.z_index(), E = CTATGlobalFunctions.gensym.div_id(), F = CTATGlobalFunctions.gensym.z_index(), G = CTATGlobalFunctions.gensym.div_id();
  ...
  this.getWidth = function() {
    if (0 >= k) {
      var a;
      q ? a = window.getComputedStyle(q) : w && (a = window.getComputedStyle(w));
      if (a) {
  ...
  this.setEnabled = function(a) {
    ...
    v.assignEnabled(a);
    q ? q.disabled = !t : v.ctatdebug("Error: component pointer is null");
  };
  ...
  this.addSafeEventListener = function(a, b, d) {
    ...
    d ? d.addEventListener(a, b) : (q ? (v.ctatdebug("Adding eventlistener to component instead of target"), q.addEventListener(a, b)) : v.ctatdebug("Error: pointer to component is null, can't add event listener"), v.ctatdebug("addSafeEventListener () done"));
  };
  ...
  this.processTabOrder = function() {
    v.ctatdebug("processTabOrder (" + C + ")");
    !0 === p ? v.ctatdebug("Component is an abstract component, bump") : q ? (v.ctatdebug("We have a component, actually assigning to html component ..."), q.tabIndex = C, q.onfocus = v.processOnFocus) : v.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
  this.hideKeyboard = function() {
    document.activeElement.blur();
    $("input").blur();
...
CTAT.Component.Base.Graphical = function(a, b, c, e, g, d, f) {
  ...
  var k = CTATGlobals.Visual.BackgroundColor, l = "white", m = 1, n = CTATGlobals.Visual.BorderColor, p = !1, u = "solid", r = 0, t = "1px", w = 0, x = CTATGlobals.Font.color, C = "black", B = CTATGlobals.Font.family, q = CTATGlobals.Font.size, y = !1, v = !1, D = !1;
  ...
  this.setShowBorder = function(a) {
    ...
    this.component && this.getShowBorder() !== p && (p ? (this.setBorderStyle(u), this.setBorderWidth(t)) : this.setBorderStyle("none"));
    return this;
  };
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), c = 0;c < a.length;c++) {
            ...
            var g = document.createElement("div"), r = f.getLevel();
...
var CTATSAI = function(a, b, c, e) {
  function g(a, b, d, c) {
    c = String(r.getElementName(b)).toLowerCase();
    if (c == a || "value" == c) {
      if (c = r.getElementChildren(b), !Array.isArray(c) || 1 > c.length) {
  ...
  var d = "undefined", f = "undefined", h = new CTATStringUtil, k = [], l = [], m = [], n = [], p = [], u = [], r;
  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      var c = a[d];
      if ("selection" == r.getElementName(c) || "Selection" == r.getElementName(c)) {
        for (var f = r.getElementChildren(c), e = !1, g = 0;g < f.length;g++) {
          b = f[g], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > g ? this.setSelectionArray(b) : this.appendToSelectionArray(b), e = !0, this.setSelection(b));
        }
        !1 === e && (b = r.getNodeTextValue(c), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == r.getElementName(c) || "Action" == r.getElementName(c)) {
        f = r.getElementChildren(c);
        e = !1;
        for (g = 0;g < f.length;g++) {
          b = f[g], "value" == r.getElementName(b) && (b = r.getNodeTextValue(b), 1 > g ? this.setActionArray(b) : this.appendToActionArray(b), e = !0, this.setAction(b));
        }
        !1 === e && (b = r.getNodeTextValue(c), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == r.getElementName(c) || "value" == r.getElementName(c) || "Input" == r.getElementName(c)) {
        var b = r.getElementChildren(c), l = null;
        k = [];
        ...
        for (var h = 0;h < b.length;h++) {
          var m = b[h];
          "value" == r.getElementName(m) && (l = r.getElementChildren(m), null !== l ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + l.length), 1 === l.length ? (l = f.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + l), e.setValue(l)) : (l = f.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + l), e.setValue(l), e.setName(m.attributes.getNamedItem("name").value), e.setType(m.attributes.getNamedItem("type").value), 
          e.setFormat(m.attributes.getNamedItem("format").value), g++), 1 > h ? this.setInputArray(l) : this.appendToInputArray(l)) : (m = f.htmlDecode(r.getNodeTextValue(m)), this.ctatdebug("Setting new value to: " + m), e.setValue(m), 1 > h ? this.setInputArray(m) : this.appendToInputArray(m)));
        }
      }
      if ("prompt" == r.getElementName(c) || "Prompt" == r.getElementName(c)) {
        this.ctatdebug("Parsing prompt ..."), this.setPrompt(r.getNodeTextValue(c));
      }
    }
    this.checkDefaultArgument();
  };
  ...
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("internalArguments" == r.getElementName(c) || "Input" == r.getElementName(c)) {
        b = c.childNodes;
        k = [];
        var f = new CTATHTMLManager, e = new CTATArgument, g = 0, l = null;
        k.push(e);
        for (var h = 0;h < b.length;h++) {
          if (l = b[h], "value" == r.getElementName(l)) {
            var m = r.getElementChildren(l);
            null !== m ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + m.length), 1 === m.length ? (l = f.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), e.setValue(l)) : (l = f.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), e.setValue(l), e.setName(r.getElementAttr("name")), e.setType(r.getElementAttr("type")), e.setFormat(r.getElementAttr("format")), g++)) : (l = f.htmlDecode(r.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + 
            l), e.setValue(l));
...
var CTATMessage = function(a) {
  ...
  var g = "ungraded", d = !1, f = !1, h = new CTATSkillSet, k = "", l = "", m = "", n = "", p = "", u = null, r = !1;
  ...
  this.parseSAI = function() {
    ...
    if ("tool_message" == k) {
      ...
      if (d) {
        ...
        for (var v = e.getElementChildren(b), D = 0;D < v.length;D++) {
          var A = v[D];
          if ("event_descriptor" == e.getElementName(A)) {
            for (var A = e.getElementChildren(A), z = 0;z < A.length;z++) {
              var E = A[z];
              "selection" == e.getElementName(E) && (a = e.getNodeTextValue(E), r.push(E));
        ...
        for (this.ctatdebug("!isLogMessage ..."), v = e.getElementChildren(b), D = 0;D < v.length;D++) {
          if (A = v[D], "properties" == e.getElementName(A)) {
            for (A = e.getElementChildren(A), z = 0;z < A.length;z++) {
              E = A[z], this.ctatdebug("Nodename: " + e.getElementName(E)), "Skills" == e.getElementName(E) && h.parseByValue(E), "SuccessMsg" == e.getElementName(E) && (m = a = e.getNodeTextValue(E)), "BuggyMsg" == e.getElementName(E) && (n = e.getNodeTextValue(E)), "Selection" == e.getElementName(E) && (a = e.getNodeTextValue(E), r.push(E)), "Action" == e.getElementName(E) && (c = e.getNodeTextValue(E), q.push(E)), "Input" == e.getElementName(E) && (g = e.getNodeTextValue(E), y.push(E)), "prompt" == 
              e.getElementName(E) && (l = e.getNodeTextValue(E)), "HighlightMsgText" == e.getElementName(E) && (p = e.getNodeTextValue(E));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + c + "," + g);
      "" !== a && null !== a ? (u = new CTATSAI(a, c, g, l), u.setArrayFromElements(r), u.setArrayFromElements(q), u.setArrayFromElements(y), f = !0) : (this.ctatdebug("No SAI found"), f = !1);
...
CTAT.Component.Base.Tutorable = function(a, b, c, e, g, d, f) {
  ...
  this.setHintHighlight = function(a, b) {
    ...
    0 != a && (CTATGlobals.Tab.previousFocus = CTATGlobals.Tab.Focus, CTATGlobals.Tab.Focus = p, p.component.focus ? CTATGlobals.Tab.Focus.getComponent().focus() : CTATGlobals.Tab.Focus.getDivWrap().focus());
    if (r) {
...
CTAT.Component.Base.SVG = function(a, b, c, e, g, d, f) {
  ...
  this.getBoundingBox = function() {
    var a = new DOMRect(0, 0, this.getWidth(), this.getHeight()), b = this.getComponent(), d = window.getComputedStyle(b), b = parseInt(d.getPropertyValue("padding-left")), c = parseInt(d.getPropertyValue("padding-right")), f = parseInt(d.getPropertyValue("padding-bottom")), e = parseInt(d.getPropertyValue("padding-right")), g = parseInt(d.getPropertyValue("border-left-width")), h = parseInt(d.getPropertyValue("border-right-width")), w = parseInt(d.getPropertyValue("border-bottom-width")), d = parseInt(d.getPropertyValue("border-right-width"));
    a.width -= b + e + g + d;
    a.height -= c + f + h + w;
    return a;
  };
...
CTAT.Component.Base.UnitDisplay = function(a, b, c, e, g, d, f) {
  ...
  this.set_denominator = function(a) {
    ...
    if (!isNaN(b) && (b = y(b), this.get_denominator() != a)) {
      ...
      b.equals(0) || (a.push(B(b, !0)), a.push(B(c.subtract(b), !1)), e--);
      for (b = 0;b < e;b++) {
        a.push(B(c, !1));
      }
  ...
  this.get_denominator = function() {
    return r.reduce(function(a, b, d, c) {
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      for (var a = h.parseValue(), b = 0, d = document.createDocumentFragment(), c = 0;c < a.length;c++) {
        var f = a[c], e = 100 * f, g = document.createElementNS(k, "rect");
      ...
      Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a) {
        if ("rect" == a.nodeName) {
          ...
          1 > b.x ? c -= d / 2 : (f += d / 2, c = b.x + b.width >= w ? c - d / 2 : c - d);
...
var CTATJumble = function(a, b, c, e, g) {
  ...
  this.init_items = function(a) {
    if (n) {
      ...
      for (var d = a.length, c = 0;c < d;c++) {
        ...
        f.addEventListener("dragenter", t, !1);
        f.addEventListener("dragover", r, !1);
        f.addEventListener("dragleave", w, !1);
        f.addEventListener("drop", x, !1);
        f.addEventListener("dragend", B, !1);
        b.appendChild(f);
        C.push(f);
      }
      n.innerHTML = "";
  ...
  this.getOrder = function() {
    for (var a = n.children, b = [], c = 0;c < a.length;c++) {
      var f = a[c];
...
var CTATNumberLine = function(a, b, c, e, g) {
  ...
  var C = function(a) {
    ...
    return l;
  }.bind(this), q = null, y = function() {
    var a = this.getBoundingBox(), a = CTAT.Geom.Rectangle.inflate(a, -2, -2), b = new DOMPoint(a.width / 2, a.height / 2), d = b.add(CTAT.Geom.Point.polar(Math.min(40, a.height, a.width) / 4, t.theta)), c = Math.sin(t.theta), e = -Math.cos(t.theta), g = c * b.x + e * b.y, l = -a.height * e, r = -c * a.width, p = new DOMPoint(a.left, b.y), b = new DOMPoint(a.right, b.y);
    if (0 < Math.abs(CTAT.Math.round(l))) {
      ...
      if (a.contains(l) || a.contains(y)) {
        d.distance(l) < d.distance(y) ? (p = y, b = l) : (p = l, b = y);
      }
    }
    0 < Math.abs(CTAT.Math.round(r)) && (r = new DOMPoint((g - e * a.top) / c, a.top), c = new DOMPoint((g - e * a.bottom) / c, a.bottom), a.containsPoint(r) || a.containsPoint(c)) && (d.distance(r) < d.distance(c) ? (p = c, b = r) : (p = r, b = c));
    a = document.createDocumentFragment();
    d = document.createElementNS(f, "g");
    d.classList.add("CTAT-number-line--axis");
    a.appendChild(d);
    c = document.createElementNS(f, "line");
    c.setAttributeNS(null, "x1", p.x);
    c.setAttributeNS(null, "y1", p.y);
    ...
    c.setAttributeNS(null, "transform", "translate(" + CTAT.Geom.Point.to2DString(p) + ") rotate(" + t.getOrientation() + ")");
    d.appendChild(c);
    p = document.createElementNS(f, "path");
    p.setAttributeNS(null, "d", "M -10,6 L 0,0 L -10,-6");
    p.setAttributeNS(null, "transform", "translate(" + CTAT.Geom.Point.to2DString(b) + ") rotate(" + t.getOrientation() + ")");
    d.appendChild(p);
    this._tickmarks = [];
    a.appendChild(C(h));
    a.appendChild(C(k));
    q = document.createElementNS(f, "circle");
    q.classList.add("CTAT-number-line--cursor");
    q.setAttributeNS(null, "r", u);
    q.setAttributeNS(null, "transform", "translate(-30,-30)");
    a.appendChild(q);
    t.baseGroup.innerHTML = "";
    t.baseGroup.appendChild(a);
    p = this.theta + Math.PI / 2;
    CTAT.Geom.Point.polar(3, p);
    CTAT.Math.round(Math.cos(p));
    CTAT.Math.round(Math.sin(p));
  ...
  }.bind(this), v = null, D = 0, A = new DOMPoint(-30, -30), z = !1, E = function(a) {
    A.x = a.clientX;
    A.y = a.clientY;
  }, F = function(a) {
    ...
    if (!0 === t.getEnabled()) {
      t.setHintHighlight(!1);
      var b;
      r ? (b = H(a.clientX, a.clientY), a = b.location, b = b.data) : (b = J(a.clientX, a.clientY), a = w.getProjectedPoint(b), b = w.getAxisValue(b));
      var d = document.createDocumentFragment(), c = document.createElementNS(f, "circle");
      c.setAttributeNS(null, "r", u);
  ...
  this.init = function() {
    ...
    t.addSafeEventListener("mouseenter", function() {
      !0 === t.getEnabled() && (z = !0, q.style.fillOpacity = null, D = requestAnimationFrame(L));
    });
  ...
  var J = function(a, b) {
    ...
    for (var d = w.getProjectedPoint(J(a, b)), c = null, f = Number.POSITIVE_INFINITY, e, g, l = 0;l < t._tickmarks.length;l++) {
      e = t._tickmarks[l], g = d.distance(e.location), g < f && (c = e, f = g);
    }
    return c;
  }, L = function() {
    if (z && !0 === t.getEnabled()) {
      if (r) {
        var a = H(A.x, A.y);
        q.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(a.location, !0));
      } else {
        q.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(w.getProjectedPoint(J(A.x, A.y)), !0));
      }
  ...
  this.calcXCoordinate = function(a) {
    a = new d(a);
    var b = t.getWidth() - 30, b = Math.abs(b - 30), c = m.subtract(n);
    return 30 + a.subtract(n).divide(c) / b;
  };
...
var CTATPieChart = function(a, b, c, e, g) {
  ...
  var d = 3, f = 3, h = 3, k = this, l, m, n, p = null, u = CTATGlobals.NameSpace.svg;
  this.init = function() {
    k.initSVG();
    this.baseGroup = document.createElementNS(u, "g");
    this.getComponent().appendChild(this.baseGroup);
    this.getComponent().classList.add("CTAT-pie-chart");
    l = document.createElementNS(u, "filter");
    l.id = this.genName("Shadow");
    m = "#" + l.id;
    n = "url(" + m + ")";
    l.setAttributeNS(null, "width", "200%");
    l.setAttributeNS(null, "height", "200%");
    p = document.createElementNS(u, "feOffset");
    p.setAttributeNS(null, "in", "SourceAlpha");
    p.setAttributeNS(null, "result", "offOut");
    p.setAttributeNS(null, "dx", h);
    p.setAttributeNS(null, "dy", h);
    l.appendChild(p);
    var a = document.createElementNS(u, "feGaussianBlur");
    a.setAttributeNS(null, "in", "offOut");
    a.setAttributeNS(null, "result", "blurOut");
    a.setAttributeNS(null, "stdDeviation", 4);
    l.appendChild(a);
    a = document.createElementNS(u, "feBlend");
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      ...
      a.reduce(function(a, b, g, l) {
        if (1 <= b.valueOf()) {
          g = document.createElementNS(u, "circle"), g.classList.add("CTAT-pie-chart--piece"), g.cx.baseVal.value = f.x, g.cy.baseVal.value = f.y, g.r.baseVal.value = c, k.addPieceElem(g, b, b.selected), e.appendChild(g);
        } else {
          g = document.createElementNS(u, "path");
          ...
          b.reduce();
          var m = f.add(CTAT.Geom.Point.polar(c, 2 * Math.PI * b.valueOf() + h)), r = f.clone();
          if (0 < d && d < c) {
            ...
            l = CTAT.Geom.Point.circle_intersection(r, l, f, c).reduce(t.bind(this, l));
            m = m.add(h);
            m = CTAT.Geom.Point.circle_intersection(r, m, f, c).reduce(t.bind(this, m));
          }
          h = CTAT.Geom.Point.to2DString;
          r = "M " + h(r);
          t = new DOMPoint(c, c);
          r += " L " + h(l);
          r += " A " + h(t) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + h(m);
          g.setAttributeNS(null, "d", r + " Z");
  ...
  this.setDropShadowDistance = function(a) {
    h = parseInt(a);
    h = isNaN(h) ? 0 : h;
    p && (p.setAttributeNS(null, "dx", h), p.setAttributeNS(null, "dy", h), 0 >= h && this.baseGroup && this.baseGroup.removeAttributeNS(null, "filter"));
  };
};
...
var CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (v.ctatdebug("errScrimUp (" + a + ")"), 1 == g ? 1 == u && (u = !1, getSafeElementById(ctatcontainer).removeChild(q)) : 1 == f && (u = !0), v.scrimUp(a));
  }
  function c(a, b) {
  ...
  var e = !1, g = !1, d = !0, f = !1, h = !1, k = !0, l = !0, m = "", n = !1, p = !1, u = !1, r = null, t = null, w = new CTATCanvasComponent("CTAT Scrim"), x = [], C = null, B = null, q = null, y = null, v = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (v.ctatdebug("scrimUp ()"), v.ctatdebug("Message: " + b), 1 == e ? (m = 1 == d ? b : m + (" \n " + b), w.removeComponent()) : (m = b, e = !0), v.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        ...
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + m + "<br><br></div></div></div>\t\t"), !0 === u && (q = c(a, "close"), $(q).appendTo("#scrimpanel")), !0 === n && (C = c(r, "yes"), $(C).appendTo("#scrimpanel")), !0 === p && (B = c(t, "no"), $(B).appendTo("#scrimpanel")), 
        1 == d)) {
  ...
  this.confirmScrimUp = function(a, b, d) {
    "google" != CTATConfig.platform && (v.ctatdebug("confirmScrimUp (" + a + "," + b + "," + d + ")"), p = n = !0, t = d, r = b, v.scrimUp(a));
  };
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b, c) {
  ...
  var e = "", g = 0, d = [], f = a ? a : null, h = null == b ? !0 : b, k = !0, l = null, m = c ? c : {}, n = this, p = "http";
  ...
  this.send_post = function(a, b) {
    ...
    !0 === globalCommDisabled ? n.ctatdebug("Communications globally disabled, please check your settings") : (n.ctatdebug("Outoing on wire: " + b), flashVars.getRawFlashVars(), d = a, "websocket" == n.getSocketType() ? (d = a.replace("http:", "ws:"), d = n.createConnection(m, d), d.setData(b), n.ctatdebug(b)) : (d = n.createConnection(m, d), d.setData(b)), null != l && l.processOutgoing(b), d.send(), useDebugging = !1);
  };
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, c = !0, e = !1, g = !1, d = [], f = "undefined", h = "undefined", k = "undefined", l = "undefined", m = "undefined", n = "undefined", p = "undefined", u = "undefined", r = "UnassignedDataset", t = "UnassignedLevelName", w = "UnassignedLevelType", u = (new CTATGuid).guid();
          ...
          if ("MessageType" == e.getElementName(n)) {
            ...
            if ("ShowHintsMessage" == n) {
              ...
              for (r = 0;r < l.length;r++) {
                if (t = l[r], "HintsMessage" == e.getElementName(t)) {
        ...
        if ("Parameters" == e.getElementName(l)) {
          for (this.ctatdebug("Processing component parameters ..."), m = e.getElementChildren(l)[0], m = e.getElementChildren(m), n = 0;n < m.length;n++) {
            ...
            if ("CTATComponentParameter" == e.getElementName(t)) {
              ...
              for (var u = p = void 0, t = e.getElementChildren(t), w = 0;w < t.length;w++) {
                var x = t[w];
              ...
              void 0 !== p && (r.params[p] = u, "group" == p && (r.groupName = u));
            }
          }
        }
          ...
          for (this.ctatdebug("Processing component styles ..."), l = e.getElementChildren(l)[0], l = e.getElementChildren(l), m = 0;m < l.length;m++) {
            if (u = l[m], "CTATStyleProperty" == e.getElementName(u)) {
              ...
              for (t = 0;t < u.length;t++) {
                w = u[t], "name" == e.getElementName(w) && (n = e.getNodeTextValue(w)), "value" == e.getElementName(w) && (p = e.getNodeTextValue(w).trim());
              }
...
(function(a) {
  ...
  b.format = function(a, d) {
    var f = 1, h = a.length, k = "", l = [], m, p, y, v, D = !0, A = "";
    for (m = 0;m < h;m++) {
      if (k = c(a[m]), "string" === k) {
        l[l.length] = a[m];
      } else {
        if ("array" === k) {
          y = a[m];
          if (y[2]) {
            for (k = d[f], p = 0;p < y[2].length;p++) {
              if (!k.hasOwnProperty(y[2][p])) {
                throw Error(b("[sprintf] property '%s' does not exist", y[2][p]));
              }
              k = k[y[2][p]];
            }
          } else {
          ...
          if (!D || g.test(y[8]) && y[3]) {
            A = D ? "+" : "-", k = k.toString().replace(n, "");
          }
          p = y[4] ? "0" == y[4] ? "0" : y[4].charAt(1) : " ";
          v = y[6] - (A + k).length;
          v = y[6] ? Array(v + 1).join(p) : "";
          l[l.length] = y[5] ? A + k + v : 0 == p ? A + v + k : v + A + k;
        }
      }
    }
    return l.join("");
...
var CTATProblemSummary = function(a, b, c) {
  ...
  var e = Number.MAX_VALUE, g = b, d = 0, f = new Date, h = {}, k = 0, l = 0, m = 0, n = 0, p = 0, u = 0, r = 0, t = CTATMsgType.CompletionValue[0], w = this;
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, c = [1, 6], e = [1, 7], g = [1, 10], d = [1, 11], f = [1, 12], h = [1, 13], k = [1, 21], l = [1, 22], m = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], n = [1, 23], p = [1, 24], u = [1, 26], r = [1, 27], t = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], w = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:c, 14:4, 15:e, 17:5, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:k, 15:l}, b(m, [2, 11], {22:9, 19:25, 16:n, 18:p, 20:u, 21:r, 24:g, 25:d, 27:f, 28:h}), b(t, [2, 17]), {13:c, 15:e, 17:28, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, {13:c, 15:e, 17:29, 19:8, 22:9, 24:g, 25:d, 27:f, 28:h}, b(t, [2, 20]), b(t, [2, 23], {23:[1, 30]}), {13:c, 15:e, 17:31, 19:8, 22:9, 24:g, 25:d, 27:f, 
  ...
  15:l, 26:[1, 46]}, {5:[2, 2], 13:k, 15:l}, {5:[2, 3], 13:k, 15:l}, {5:[2, 4], 13:k, 15:l}, {5:[2, 5], 13:k, 15:l}, {5:[2, 6], 13:k, 15:l}, {5:[2, 7], 13:k, 15:l}, b(m, [2, 9], {22:9, 19:25, 16:n, 18:p, 20:u, 21:r, 24:g, 25:d, 27:f, 28:h}), b(m, [2, 10], {22:9, 19:25, 16:n, 18:p, 20:u, 21:r, 24:g, 25:d, 27:f, 28:h}), b(t, [2, 12]), b(t, [2, 13]), b(t, [2, 15]), b(t, [2, 16]), b(t, [2, 21]), b(w, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      throw Error(a);
    ...
    var b = [0], c = [null], d = [], f = this.table, e = "", g = 0, h = 0, k = 0, l = d.slice.call(arguments, 1), m = Object.create(this.lexer), n = {}, p;
    for (p in this.yy) {
    ...
    for (var t, u, w, I, M = {}, N, K;;) {
      ...
      if ("undefined" === typeof I || !I.length || !I[0]) {
        ...
        O = m.showPosition ? "Parse error on line " + (g + 1) + ":\n" + m.showPosition() + "\nExpecting " + K.join(", ") + ", got '" + (this.terminals_[t] || t) + "'" : "Parse error on line " + (g + 1) + ": Unexpected " + (1 == t ? "end of input" : "'" + (this.terminals_[t] || t) + "'");
        this.parseError(O, {text:m.match, token:this.terminals_[t] || t, line:m.yylineno, loc:p, expected:K});
      }
      if (I[0] instanceof Array && 1 < I.length) {
        throw Error("Parse Error: multiple actions possible at state: " + w + ", token: " + t);
      }
      switch(I[0]) {
        case 1:
          b.push(t);
          ...
          b.push(I[1]);
          t = null;
          u ? (t = u, u = null) : (h = m.yyleng, e = m.yytext, g = m.yylineno, p = m.yylloc, 0 < k && k--);
          break;
        case 2:
          ...
          r && (M._$.range = [d[d.length - (K || 1)].range[0], d[d.length - 1].range[1]]);
          w = this.performAction.apply(M, [e, h, g, n, I[1], c, d].concat(l));
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, d, k, l) {
      ...
      try {
        ...
        for (p in r) {
          null != p && 0 > g.call(m, p) && (x[p] = r[p], delete r[p]);
        }
      }
    };
...
var CTATExampleTracerLink = function(a, b, c) {
  ...
  var e = "undefined" === typeof a || null === a ? null : a, g = null, d = "undefined" === typeof b || null === b ? null : b, f = "undefined" === typeof c || null === c ? null : c, h = null, k = 1, l = 1, m = "CORRECT_ACTION", n = [], p = !1, u = null, r = "", t = null, w = null, x = this;
...
var CTATExampleTracerEvent = function(a, b, c) {
  ...
  var e = "", g = !1, d = CTATExampleTracerLink.NO_MODEL, f = !1, h = null, k = null, l = "student", m = null, n = null, p = "", u = null, r = null, t = null, w = null, x = null, C = [], B = !1, q = null, y = this;
  this.getActor = function() {
    return l;
  };
  this.setActor = function(a) {
  ...
  this.getWantReportableHints = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning " + B);
    return B;
  };
  ...
  this.isOutOfOrder = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + u);
    return u;
  };
  ...
  this.getReportableHints = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning " + C);
    return C;
  };
  ...
  this.getStepID = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning " + p);
    return p;
  };
...
var CTATVectorMatcher = function(a, b, c, e) {
  function g(a, b, c, e, g) {
    ...
    for (var w = 0;3 > w;w++) {
      var x = k[w][0], C = x instanceof CTATExpressionMatcher ? x.matchConcatenation(a, b, c, e) : x.matchConcatenation(t[w]);
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function e(a, b, e) {
    ...
    q.ctatdebug("In evaluate -- number of interpretations " + l.size + " set");
    if (0 === l.size) {
    ...
    if (!0 === e) {
      ...
      if (p.toString() === CTATExampleTracerLink.CORRECT_ACTION.toString() || p.toString() === CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()) {
        ...
        l.forEach(function(a) {
          a.getLastMatchedLink().getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && (q.ctatdebug("In evaluate -- deleting an incorrect interp"), l.delete(a));
        });
        q.ctatdebug("In evaluate -- after iterating over interpretations");
        k(l);
        q.ctatdebug("In evaluate -- after setting new interps");
        for (var u in t) {
          t.hasOwnProperty(u) && delete t[u];
        }
      ...
      p.toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && w.splice(w.length - 1, 1);
    }
    u = n.getLastMatchedLink();
    ...
    a.setReportableLink(u);
    a.setReportableInterpretation(n);
    a.setReportableVariableTable(n.getVariableTable());
    a.setHintRequest(b);
    b || (x = u.getTutorSAI(a.getStudentSAI(), n.getVariableTable()), q.ctatdebug("In evaluate -- TUTORSAI object: " + x + ", getInput() " + x.getInput() + ";"), a.setTutorSAI(x));
    x = p == CTATExampleTracerLink.CORRECT_ACTION ? u.getSuccessMsg() : u.getBuggyMsg();
    ...
    b && (n = u.interpolateHints(n.getVariableTable()), a.setInterpolatedHints(n), q.ctatdebug("In evaluate after calling setInterpolatedHints"), Array.isArray(n) && 0 < n.length ? a.setReportableHints(n) : a.setReportableHints(u.getHints()), q.ctatdebug("In evaluate --\x3e after setReportableHints"));
  ...
  function d(a, b, c, d, e) {
    ...
    if (!0 === d) {
      ...
      b.getMatchedLinks().forEach(function(a) {
        !1 !== k && (!1 === x.observesOrderingConstraints(h, a, f, e) || !1 === m(b, a, f) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), k = !1) : h.push(a));
      });
      if (!1 === k) {
  ...
  function k(a) {
    ...
    0 === a.size ? q.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations") : (q.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: " + a.size), a.forEach(function(a) {
      r.push(a);
    }), B = null, q.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"));
  }
  function l() {
  ...
  function n(a, b) {
    ...
    d.getSortedLinks().forEach(function(b) {
      !0 !== g && (q.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in for loop" + b), f = b, c.getTraversalCount(b) < b.getMaxTraversals() && (!1 === a || 0 < q.nonEmptyHints(b, c.getVariableTable())) && x.observesOrderingConstraints(c.getMatchedLinks(), b, d.getLinks(), null) && m(c, b, d.getLinks()) && (q.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in link: " + b), h = b, g = !0));
    });
    if (!0 === g) {
      return h;
    }
  ...
  function p(a, b, c, e) {
    ...
    b.getSortedLinks().forEach(function(b) {
      ...
      q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop isNoOp(link): " + u(b));
      !0 === a.isTraversed(b, e) || !0 === u(b) ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in if condition"), g = !0) : (!0 === g && (q.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in second if condition"), x.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
  ...
  var r = null, t = null, w = null, x = a, C = null;
  ...
  this.resetTracer = function() {
    ...
    B = a;
    if (null === t || "undefined" === typeof t) {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"), t = {};
    } else {
    ...
    null === w || "undefined" === typeof w ? (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer last if condition"), w = []) : (q.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of last if condition"), w.length = 0);
  ...
  this.getBestInterpretation = function() {
    ...
    if (null === B || "undefined" === typeof B) {
      q.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"), B = h(q.getInterpretationsInternal());
    }
    q.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation " + (null === B || void 0 === B));
    return B;
  };
...
var CTATExampleTracerGraph = function(a, b, c) {
  ...
  var w = null, x = null, C = null, B = null, q = null, y = null, v = new Set, D = null, A = null, z = this;
  this.getDefaultBuggyMsg = function() {
  ...
  this.getNode = function(a) {
    z.ctatdebug("CTATExampleTracerGraph --\x3e in getNode(" + a + ") returning " + B[a]);
    return B[a];
  };
...
var CTATMessageTank = function(a, b) {
    ...
    a && h.forEach(function(b) {
      if (b.msgType == CTATMsgType.ASSOCIATED_RULES) {
        ...
        if (c) {
          ...
          p.ctatdebug("updateProblemSummmary() Completion status " + e + ", doneStep " + g + ", correct " + f);
  ...
  this.flushMessageTank = function(a, b) {
    ...
    if (h && !(1 > h.length)) {
      ...
      for (var f = [], m = [], C = 0;C < h.length;++C) {
        var B = h[C];
        if (B.msg) {
          var q = B.msgType, y = B.evt;
          p.ctatdebug("entering processInterfaceVariables() msgType " + q + ", evt " + y);
          q && (p.ctatdebug("entering processInterfaceVariables() et " + d + ", tracer " + (d ? d.getTracer() : null)), q = q.toLowerCase(), 0 !== q.indexOf("correct") && 0 !== q.indexOf("interfaceaction") || d.getTracer().addInterfaceVariablesFromEvent(y));
          if (!(q = e(B))) {
            var q = B, y = m, v = void 0, D = void 0;
            if (!(q && q.sai && (v = q.sai.getAction()) && (D = u.exec(v))) || 3 > D.length || 1 >= D[2]) {
              q = !1;
            } else {
              var A = y.length - 1, A = 0 > A ? null : y[A];
              q.msg = q.msg.replace(v, D[1]);
              A && A.timeout == D[2] ? A.msgTuples.push(q) : y.push({timeout:Number(D[2]), msgTuples:[q]});
              q = !0;
            }
          }
          q || f.push(B.msg);
      ...
      for (C = 0;C < m.length;++C) {
        B = m[C], p.ctatdebug("processDelayedMsgs() delayedMsgs.timeout " + B.timeout + ", .msgTuples.length " + B.msgTuples.length), setTimeout(g, B.timeout, d, B.msgTuples);
      }
      0 < f.length && (p.ctatdebug("Bottom of flushMessageTank(); to send bundle of length " + f.length + " via " + d), d.sendBundle(f) && (l[CTATExampleTracerLink.CORRECT_ACTION] || l[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION] || k.CorrectAction || k.InterfaceAction || k.UntutoredAction) && d.getOutputStatus().isSendingSavedMsgsForRestore() && (f = flashVars.getRawFlashVars(), f.deliverymode ? "delivery" == f.deliverymode ? d.getProblemStateSaver().saveAsYouGo(a) : p.ctatdebug("We're in reviewer mode in OLI, we shouldn't save as we go") : 
  ...
  this.suppressFeedback = function(a, b) {
    ...
    var c = null;
    b == CTATMsgType.SHOW_ALL_FEEDBACK ? (p.ctatdebug("if.1"), c = b) : CTATMsgType.hasTextFeedback(a.msgType) ? (p.ctatdebug("if.2"), b == CTATMsgType.HIDE_ALL_FEEDBACK || b == CTATMsgType.HIDE_BUT_ENFORCE ? (p.ctatdebug("if.2.1"), c = b) : (p.ctatdebug("if.2.2"), (c = CTATMsgType.getProperty(a.msg, CTATMsgType.BUGGY_MSG)) && CTATMsgType.NOT_DONE_MSG.toLowerCase() == c.toLowerCase() ? (p.ctatdebug("if.2.2.1"), c = CTATMsgType.SHOW_ALL_FEEDBACK) : (p.ctatdebug("if.2.2.2"), c = CTATMsgType.HIDE_ALL_FEEDBACK))) : 
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var c = new CTATExampleTracerLink(null, null, null), e = f.getElementChildren(a), g, h, k, l, n, p = a = -1, v = CTATMsgType.DEFAULT_ACTOR, D = !1, A = 0;A < e.length;A++) {
      "sourceID" === f.getElementName(e[A]) && (a = parseInt(f.getNodeTextValue(e[A])), c.setPrevNode(a));
      "destID" === f.getElementName(e[A]) && (p = parseInt(f.getNodeTextValue(e[A])), c.setNextNode(p));
        ...
        for (c.setIsPreferredLink("false" != f.getElementAttr(e[A], "preferPathMark")), c.setMinTraversalsStr(f.getElementAttr(e[A], "minTraversals")), c.setMaxTraversalsStr(f.getElementAttr(e[A], "maxTraversals")), z = f.getElementChildren(e[A]), E = 0;E < z.length;E++) {
          ...
          if ("matchers" === f.getElementName(z[E])) {
            for (var F = f.getElementChildren(z[E]), G = 0;G < F.length;G++) {
              "Selection" === f.getElementName(F[G]) && (g = b(F[G], 0)), "Action" === f.getElementName(F[G]) && (h = b(F[G], 1)), "Input" === f.getElementName(F[G]) && (k = b(F[G], 2)), "Actor" === f.getElementName(F[G]) && (v = f.getNodeTextValue(F[G]), D = (D = f.getElementAttr(F[G], "linkTriggered")) && "false" != D.toLowerCase().trim() ? !0 : !1);
            }
          }
  ...
  new XMLSerializer;
  var l, m = !0, n = CTATMsgType.SHOW_ALL_FEEDBACK, p = !0;
  ...
  this.parseGraph = function(b, e) {
    ...
    p = f.getElementAttr(b, "lockWidget");
    var C = new CTATVariableTable;
    d = new CTATExampleTracerGraph(x, !1, C);
    var B = f.getElementChildren(b);
    ...
    for (var C = null, v = 0;v < B.length;v++) {
      switch(f.getElementName(B[v])) {
        case "startNodeMessages":
          k = f.getElementChildren(B[v]);
          var D = new CTATTutorMessageBuilder;
          "true" !== y && "false" !== y && n === CTATMsgType.HIDE_ALL_FEEDBACK && (y = "true");
          h = D.createStateGraphMessage(m, x, p, n === CTATMsgType.HIDE_ALL_FEEDBACK, q, confirmDone, e.getSkillBarVector());
          break;
        case "node":
          t++;
          D = B[v];
...
var CTATExampleTracer = function() {
          ...
          case "skills":
            ...
            for (var e = t.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              ...
              if (g && "skill" == g.toLowerCase()) {
                ...
                if (h && "" != h.trim()) {
                  var g = t.getElementAttr(e[f], "label"), k = t.getElementAttr(e[f], "pSlip"), l = t.getElementAttr(e[f], "description"), p = t.getElementAttr(e[f], "pKnown"), q = t.getElementAttr(e[f], "category"), r = t.getElementAttr(e[f], "pLearn"), u = t.getElementAttr(e[f], "pGuess"), h = new CTATExampleTracerSkill(q, h, u, p, k, r);
                  h.setLabel(g);
                  h.setDescription(l);
                  d.push(h);
                }
  ...
  function e(a, b, c, d) {
    ...
    D.appendToProblemState(a, m.getOutputStatus(), !1);
    if (!J) {
      return !1;
    }
  ...
  function k(a, b, c, e, g, h) {
    ...
    k.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || D.appendToProblemState(h, m.getOutputStatus(), !1);
    k.setTransactionID(g);
    var n;
    m.ctatdebug("finishNewExampleTrace(" + k + ", " + b + ", " + c + ", " + e + ")");
    h = k.getStudentSAI();
    var l = k.getTutorSAI(), q = k.getTransactionID(), t = new CTATTutorMessageBuilder, r = [];
    ...
    if (k.isSolverResult()) {
      ...
      if (k.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        n = r ? "" + r.getUniqueID() : "", k.setStepID(n), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && m.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, t.createCorrectActionMessage(q, l), k, l), null !== r && "undefined" !== typeof r && m.updateSkills(CTATExampleTracerSkill.CORRECT, r.getSkillNames(), r.getUniqueID()), n = k.getSuccessOrBuggyMsg(), m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, t.createAssociatedRulesMessageForAction(k.getResult(), 
        l, h, m.getSkillBarVector(), r.getUniqueID(), q, n), k, l), m.ctatdebug("finishNewExampleTrace() successMsg " + n), n && m.messageTank.addToMessageTank("SuccessMessage", t.createSuccessMessage(q, n), k, null), w = null, e && (u = f(r ? r.getNextNode() : null, p.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = u);
      } else {
        ...
        var v = m.lastSilentHintResult = new CTATExampleTracerEvent(m, h, c), u = p.traceForHint(v);
        m.ctatdebug("silent hint result: " + v + "; hintLink " + u);
        u || (u = p.getBestNextLink(!1, v), m.ctatdebug("getBestNextLink result: " + v + "; hintLink " + u));
        l = v ? v.getTutorSAI() : null;
        u && (n = "" + u.getUniqueID(), k.setStepID(n));
        v = d(k, v, t);
        m.ctatdebug("createBuggyMessage() tutorAdvice: " + v.tutorAdvice + ";\n  msg " + v.msg);
        m.updateSkills(CTATExampleTracerSkill.INCORRECT, u.getSkillNames(), u.getUniqueID());
        m.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, t.createAssociatedRulesMessageForAction(k.getResult(), l && l.getSelection() ? l : h, h, m.getSkillBarVector(), n, q, v.tutorAdvice), k, null);
        v.msg && m.messageTank.addToMessageTank(v.msgType, v.msg, k);
        w = h;
        e && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == k.getResult() && (u = f(r ? r.getNextNode() : null, p.findCurrentState(!1, !1), m.lastMessage ? m.lastMessage.getSAI() : null, k)) && (k = u);
      }
    }
    m.lastResult = k;
  ...
  var m = this, n = null, p, u, r, t = new CTATXML;
  new XMLSerializer;
  var w = null, x, C = CTATMsgType.SHOW_ALL_FEEDBACK, B = !0, q = !1, y = null, v = null, D = new ProblemStateSaver(m), A = null, z = new CTATProblemStateStatus, E = [], F = [], G = 0, J = !1, H = "";
  ...
  this.processXML = function(a) {
    ...
    if (null != a) {
      ...
      r = c.gr;
      p = c.tracer;
      q = b.getSuppressStudentFeedback() === CTATMsgType.HIDE_ALL_FEEDBACK;
      a = c.ssm;
      var d = c.sgMsg;
