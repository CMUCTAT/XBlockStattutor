...
(function(a) {
  var b = function() {
    ...
    "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, f = function(a) {
      ...
      var a = f(new Date(2014, 0, 2)), b = f(new Date(2014, 5, 2)), d = a - b;
      ...
      a = a.getTime() + b;
      for (var f = (new Date(e)).getTimezoneOffset(), c = null;e < a - d;) {
        var g = new Date(e);
      ...
      for (var f = {}, g = b.olson.dst_rules.zones, l = g.length, k = a[e], x = 0;x < l;x++) {
        var B = g[x], C;
        C = g[x];
        for (var p = 0, y = 0;y < d.length;y++) {
          if (C.rules[y] && d[y]) {
            if (d[y].s >= C.rules[y].s && d[y].e <= C.rules[y].e) {
              p = 0, p += Math.abs(d[y].s - C.rules[y].s), p += Math.abs(C.rules[y].e - d[y].e);
            } else {
              p = "N/A";
              break;
            }
      ...
      for (var v in f) {
        if (f.hasOwnProperty(v) && -1 != k.indexOf(v)) {
          return v;
        }
      }
      return e;
      ...
      var d = function() {
        for (var a = [], d = 0;d < b.olson.dst_rules.years.length;d++) {
          var f;
          f = b.olson.dst_rules.years[d];
          var c = (new Date(f, 0, 1, 0, 0, 1, 0)).getTime();
          f = (new Date(f, 12, 31, 23, 59, 59)).getTime();
          for (var g = (new Date(c)).getTimezoneOffset(), h = null, l = null;c < f - 864E5;) {
            var k = new Date(c), m = k.getTimezoneOffset();
            m !== g && (m < g && (h = k), m > g && (l = k), g = m);
            c += 864E5;
          }
    ...
    return {determine:function() {
      var e = d();
      e || (e = b.olson.timezones[g()], "undefined" !== typeof a[e] && (e = l(e)));
...
(function(a, b) {
  ...
  function c(a, b, d, e) {
    var f = ["opacity", b, ~~(100 * a), d, e].join("-");
    d = .01 + d / e * 100;
    e = Math.max(1 - (1 - a) / b * (100 - d), a);
    var c = m.substring(0, m.indexOf("Animation")).toLowerCase();
    n[f] || (t.insertRule("@" + (c && "-" + c + "-" || "") + "keyframes " + f + "{0%{opacity:" + e + "}" + d + "%{opacity:" + a + "}" + (d + .01) + "%{opacity:1}" + (d + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + e + "}}", t.cssRules.length), n[f] = 1);
    return f;
  }
  function f(a, b) {
    var d = a.style, e, f;
  ...
  function k() {
    ...
    h.prototype.lines = function(a, f) {
      ...
      function h(a, k, n) {
        b(q, b(g(c(), {rotation:360 / f.lines * a + "deg", left:~~k}), b(g(d("roundrect", {arcsize:f.corners}), {width:l, height:f.scale * f.width, left:f.scale * f.radius, top:-f.scale * f.width >> 1, filter:n}), d("fill", {color:e(f.color, a), opacity:f.opacity}), d("stroke", {opacity:0}))));
      }
      var l = f.scale * (f.length + f.width), k = 2 * f.scale * l, n = -(f.width + f.length) * f.scale * 2 + "px", q = g(c(), {position:"absolute", top:n, left:n});
      if (f.shadow) {
        for (n = 1;n <= f.lines;n++) {
    ...
    h.prototype.opacity = function(a, b, d, e) {
      a = a.firstChild;
      e = e.shadow && e.lines || 0;
      a && b + e < a.childNodes.length && (a = (a = (a = a.childNodes[b + e]) && a.firstChild) && a.firstChild) && (a.opacity = d);
    };
  }
  var l = ["webkit", "Moz", "ms", "O"], n = {}, m, t, r = {lines:12, length:7, width:5, radius:10, scale:1, corners:1, color:"#000", opacity:.25, rotate:0, direction:1, speed:1, trail:100, fps:20, zIndex:2E9, className:"spinner", top:"50%", left:"50%", shadow:!1, hwaccel:!1, position:"absolute"};
  h.defaults = {};
  d(h.prototype, {spin:function(b) {
    this.stop();
    var d = this, e = d.opts, f = d.el = a(null, {className:e.className});
    ...
    d.lines(f, d.opts);
    if (!m) {
      var c = 0, h = (e.lines - 1) * (1 - e.direction) / 2, l, k = e.fps, n = k / e.speed, q = (1 - e.opacity) / (n * e.trail / 100), r = n / e.lines;
      (function F() {
        c++;
        for (var a = 0;a < e.lines;a++) {
          l = Math.max(1 - (c + (e.lines - a) * r) % n * q, e.opacity), d.opacity(f, a * e.direction + h, l, e);
        }
    ...
    function h(b, d) {
      return g(a(), {position:"absolute", width:f.scale * (f.length + f.width) + "px", height:f.scale * f.width + "px", background:b, boxShadow:d, transformOrigin:"left", transform:"rotate(" + ~~(360 / f.lines * l + f.rotate) + "deg) translate(" + f.scale * f.radius + "px,0)", borderRadius:(f.corners * f.scale * f.width >> 1) + "px"});
    }
    for (var l = 0, k = (f.lines - 1) * (1 - f.direction) / 2, n;l < f.lines;l++) {
      n = g(a(), {position:"absolute", top:1 + ~(f.scale * f.width / 2) + "px", transform:f.hwaccel ? "translate3d(0,0,0)" : "", opacity:f.opacity, animation:m && c(f.opacity, f.trail, k + l * f.direction, f.lines) + " " + 1 / f.speed + "s linear infinite"}), f.shadow && b(n, g(h("#000", "0 0 4px #000"), {top:"2px"})), b(d, b(n, h(e(f.color, l), "0 0 1px rgba(0,0,0,.1)")));
    }
    return d;
  ...
  if ("undefined" !== typeof document) {
    ...
    var q = g(a("group"), {behavior:"url(#default#VML)"});
    !f(q, "transform") && q.adj ? k() : m = f(q, "animation");
  }
  return h;
});
var CTATCanvasComponent = function(a) {
  ...
  this.moveShape = function(a, b, d) {
    for (var e = 0;e < c.length;e++) {
      if (c[e].getName() == a) {
        c[e].modifyCanvasCSS("left", b + "px");
        c[e].modifyCanvasCSS("top", d + "px");
        break;
      }
    }
  };
...
var CTATCSS = function() {
  ...
  this.addCSSAttribute = function(d, f) {
    b[a] = d;
    b[a + 1] = f;
    a += 2;
  };
  ...
  this.modifyCSSAttribute = function(a, d) {
    var f = b.indexOf(a);
    -1 == f ? this.addCSSAttribute(a, d) : b[f + 1] = d;
  };
  ...
  this.addSelectorAttribute = function(a, b, d) {
    ...
    a: {
      if (0 === c) {
        ...
        for (var n = 0;n < f.length && null !== f[n][0];n++) {
          if (f[n][0] == a) {
            a = n;
            break a;
          }
  ...
  this.toCSSString = function() {
    for (var a = "", c = 0;c < f.length;c++) {
      for (var a = a + (f[c][0] + " { "), g = 1;g < f[c].length;g++) {
        a += f[c][g], a = 0 === g % 2 ? a + "; " : a + ": ";
      }
      a += " }; ";
    }
...
var CTATConfig = {Options:{}, addProperty:function(a, b, c, f) {
  c = c || b[0];
  Object.defineProperty(CTATConfig, a, {enumerable:!0, configurable:!1, writable:!f, value:c.toLowerCase()});
  var g = {};
...
CTAT.Math.Fraction.prototype = Object.create(CTAT.Math.Fraction.prototype, {numerator:{get:function() {
  ...
  if (1 == this.denominator) {
    ...
    var c = document.createElementNS("http://www.w3.org/1998/Math/MathML", "mfrac"), f = document.createElementNS("http://www.w3.org/1998/Math/MathML", "mrow");
    f.appendChild(b);
    c.appendChild(f);
  ...
  if (console.log("error on new DOMPoint():", a, typeof a), a instanceof ReferenceError || a instanceof TypeError) {
    DOMPoint = function(b, c, f, g) {
      ...
      if (b instanceof DOMPoint) {
        ...
        this.x = b || 0, this.y = c || 0, this.z = f || 0, this.w = g || 1;
      }
    };
  }
}
...
CTAT.Geom.Point.equals = function(a, b) {
  var c = !0, f;
  for (f in a) {
    if (f in b ? "w" != f && (c &= a[f] / a.w == b[f] / b.w) : c = !1, !c) {
      break;
    }
  }
  return c;
...
CTAT.Geom.Point.scale = function(a, b) {
  ...
  var c = new DOMPoint(a), f;
  for (f in c) {
    "w" != f && (c[f] = CTAT.Math.round(a[f] * b));
  }
  return c;
};
...
CTAT.Geom.Point.circle_intersection = function(a, b, c, f) {
  b = b.add(a.scale(-1)).normalize();
  var g = CTAT.Geom.Point.dot(b, c.add(a.scale(-1))), d = a.add(b.scale(g));
  c = CTAT.Geom.Point.distance(c, d);
  return c < f ? (f = Math.sqrt(f * f - c * c), [a.add(b.scale(g - f)), a.add(b.scale(g + f))]) : c == f ? [d] : [];
};
...
CTAT.Geom.Rectangle.contains = function(a, b, c) {
  ...
  if (b instanceof DOMPoint) {
    ...
    if (c instanceof DOMPoint) {
      g = f(a, c.x / c.w, c.y / c.w);
    } else {
      if ("number" == typeof c) {
        return f(a, b.x - c, b.y - c) & f(a, b.x + c, b.y + c);
      }
    }
...
CTAT.Geom.Rectangle.setTo = function(a, b, c, f, g) {
  a.x = b;
  a.y = c;
  a.width = f;
  a.height = g;
...
function parseQueryString() {
  ...
  if (b) {
    for (var b = b.split("&"), c = 0;c < b.length;c++) {
      var f = b[c].split("=");
      a[unescape(f[0].replace(/\+/g, " "))] = unescape(f[1].replace(/\+/g, " "));
    }
  }
  return a;
}
...
function tutorPrep(a) {
  ...
  var c = !1, f;
  for (f in b) {
    switch(ctatdebug("Processing external FlashVar " + f + "(" + b[f] + ")"), f) {
      case "GENERATED":
        "on" == b[f] && (c = new CTATGuid, a.session_id = c.guid(), c = !0);
        break;
      case "BRD":
        a.question_file = b[f];
        break;
      case "BRMODE":
        a.BehaviorRecorderMode = b[f];
        break;
      case "PROBLEM":
        a.problem_name = b[f];
        break;
      case "DATASET":
        ...
        break;
      case "LEVEL1":
        a.dataset_level_name1 = b[f];
        break;
      case "TYPE1":
        a.dataset_level_type1 = b[f];
        break;
      case "LEVEL2":
        a.dataset_level_name2 = b[f];
        break;
      case "TYPE2":
        a.dataset_level_type2 = b[f];
        break;
      case "LEVEL3":
        a.dataset_level_name3 = b[f];
        break;
      case "TYPE3":
        a.dataset_level_type3 = b[f];
        break;
      case "LEVEL4":
        a.dataset_level_name4 = b[f];
        break;
      case "TYPE4":
        a.dataset_level_type4 = b[f];
        break;
      case "USER":
        a.user_guid = b[f];
        break;
      case "SESSION":
        !1 === c && (a.session_id = b[f]);
        break;
      case "SOURCE":
        a.source_id = b[f];
        break;
      case "LOGTYPE":
        ...
        break;
      case "PORT":
        a.remoteSocketPort = b[f];
        break;
      case "REMOTEURL":
        a.remoteSocketURL = b[f];
        break;
      case "DISKDIR":
        a.log_to_disk_directory = b[f];
        break;
      case "USEOLI":
        a.DeliverUsingOLI = b[f];
        break;
      case "log_service_url":
        a.log_service_url = b[f];
        break;
      case "URL":
        a.log_service_url = b[f];
        break;
      case "LOGURL":
        ...
        break;
      case "CONNECTION":
        a.tutoring_service_communication = b[f];
        break;
      case "SUI":
        a.sui = b[f];
        break;
      ...
      case "SessionLog":
        a.SessionLog = b[f];
      case "KEYBOARDGROUP":
        "Disabled" == b[f] && (a.keyboard = "disabled"), "Auto" == b[f] && (a.keyboard = "auto"), "On" == b[f] && (a.keyboard = "on");
    }
  }
  return a;
}
...
function introspect(a, b, c, f) {
  ...
  if ("object" === g) {
    if (0 < f) {
      c = [c, "  "].join("");
      for (var d in b) {
        g = this.introspect(d, b[d], c, f - 1), a = [a, "\n", g].join("");
      }
      return a;
    }
    return [a, " ..."].join("");
...
function getIndicesOf(a, b, c) {
  var f = 0, g = a.length, d = [];
  c || (b = b.toLowerCase(), a = a.toLowerCase());
  for (;-1 < (c = b.indexOf(a, f));) {
    d.push(c), f = c + g;
  }
  return d;
}
...
function tableCreate() {
  ...
  for (var c = 0;3 > c;c++) {
    for (var f = b.insertRow(), g = 0;2 > g && (2 != c || 1 != g);g++) {
      var d = f.insertCell();
...
;var CTATBase = function(a, b) {
  ...
  this.ctatdebugInternal = function(a, b) {
    ...
    if (useDebuggingBasic) {
      f = c("Unknown", "undefined", e), null === customconsole && (customconsole = getSafeElementById("customconsole")), null !== customconsole ? (customconsole.innerHTML += f + "<br>", customconsole.scrollTop = customconsole.scrollHeight) : console.log(f);
    } else {
...
var CTATFlashVars = function() {
  ...
  var a = this, b = [], c = null, f = null, g = null, d = null;
  ...
  this.setTimeZone = function(b) {
    ...
    var f = "";
    null == b || "" == b || void 0 == b ? (b = jstz.determine(), d.ctatdebug("Assigning detected timezone: " + b.name()), f = b.name()) : (50 < b.length && (b = b.substr(0, 50)), 3 != b.length && 4 != b.length || d.ctatdebug("3 and 4 letter time zone abbreviations are deprecated. See list of tz database zone names for better options"), f = b);
    null != a.raw && (a.raw.timezone = f);
  };
  ...
  this.preParse = function() {
    ...
    d = 0;
    for (var f = !0;1 == f;) {
      var f = !1, c = "custom_field_name" + (d + 1), g = "custom_field_value" + (d + 1);
      a.ctatdebug("Trying : " + a.raw[c] + "," + a.raw[g]);
      null != a.raw[c] && (a.ctatdebug("Adding: " + c + "," + a.raw[g]), b[a.raw[c]] = a.raw[g], f = !0, d++);
    }
  };
  this.getDatasetNames = function() {
    ...
    c = [];
    for (var b = 0, d = !0;1 == d;) {
      var d = !1, f = "dataset_level_name" + (b + 1);
      null != a.raw[f] && (a.ctatdebug("Adding: " + f + "," + a.raw[f]), c[b] = a.raw[f], d = !0, b++);
    }
    return c;
  };
  this.getDatasetTypes = function() {
    ...
    for (var b = 0, d = !0;1 == d;) {
      ...
      null != a.raw[c] && (a.ctatdebug("Adding: " + c + "," + a.raw[c]), f[b] = a.raw[c], d = !0, b++);
    }
    return f;
  };
  this.getConditionNames = function() {
    ...
    for (var f = 0, c = !0;1 == c;) {
      var c = !1, g = "study_condition_name" + (f + 1);
      null != a.raw[g] && (a.ctatdebug("Adding: " + g + "," + a.raw[g]), b[f + d] = a.raw[g], c = !0, f++);
    }
    return b;
  };
  this.getConditionTypes = function() {
    ...
    for (var d = 0, f = !0;1 == f;) {
      var f = !1, c = "study_condition_type" + (d + 1);
      null != a.raw[c] && (a.ctatdebug("Adding: " + c + "," + a.raw[c]), g[d + b] = a.raw[c], f = !0, d++);
    }
    return g;
  };
  this.getConditionDescriptions = function() {
    ...
    for (var f = 0, c = !0;1 == c;) {
      var c = !1, g = "study_condition_description" + (f + 1);
      null != a.raw[g] && (a.ctatdebug("Adding: " + g + "," + a.raw[g]), d[f + b] = a.raw[g], c = !0, f++);
    }
    return d;
  };
};
...
var CTATGraphicsTools = function(a, b, c, f, g, d) {
  CTATBase.call(this, "CTATGraphicsTools", "__undefined__");
  var e = b || 1, h = c || "#000000", k = f || "#EEEEEE", l = g || !1, n = "Arial", m = a || null;
  a = d || !1;
  var t = 0, r = this;
  if (null == m) {
  ...
  this.drawRectangle = function(a, b, d, f) {
    ...
    b += t;
    m.lineWidth = e;
    1 == l ? (m.fillStyle = k, m.fillRect(a, b, d, f)) : (m.strokeStyle = h, m.beginPath(), m.rect(a, b, d, f), m.stroke());
  };
  ...
  this.drawRoundedRect = function(a, b, d, f, c) {
    a += t;
    b += t;
    null != m && (m.strokeStyle = h, m.lineWidth = e, m.beginPath(), m.moveTo(a, b + c), m.lineTo(a, b + f - c), m.quadraticCurveTo(a, b + f, a + c, b + f), m.lineTo(a + d - c, b + f), m.quadraticCurveTo(a + d, b + f, a + d, b + f - c), m.lineTo(a + d, b + c), m.quadraticCurveTo(a + d, b, a + d - c, b), m.lineTo(a + c, b), m.quadraticCurveTo(a, b, a, b + c), m.stroke());
  };
  this.drawRoundedRectFilled = function(a, b, d, f, c) {
    a += t;
    b += t;
    null != m && (m.strokeStyle = h, m.lineWidth = e, m.beginPath(), m.moveTo(a, b + c), m.lineTo(a, b + f - c), m.quadraticCurveTo(a, b + f, a + c, b + f), m.lineTo(a + d - c, b + f), m.quadraticCurveTo(a + d, b + f, a + d, b + f - c), m.lineTo(a + d, b + c), m.quadraticCurveTo(a + d, b, a + d - c, b), m.lineTo(a + c, b), m.quadraticCurveTo(a, b, a, b + c), m.stroke(), m.fillStyle = k, m.beginPath(), m.moveTo(a, b + c), m.lineTo(a, b + f - c), m.quadraticCurveTo(a, b + f, a + c, b + f), m.lineTo(a + 
    d - c, b + f), m.quadraticCurveTo(a + d, b + f, a + d, b + f - c), m.lineTo(a + d, b + c), m.quadraticCurveTo(a + d, b, a + d - c, b), m.lineTo(a + c, b), m.quadraticCurveTo(a, b, a, b + c), m.fill());
  };
  ...
  this.drawTextFormatted = function(a, b, d, f, e, c, g, l, h, k) {
    if (null != m) {
      a += t;
      b += t;
      f = "";
      ...
      f += "12pt " + n;
      try {
        m.fillStyle = c, m.font = f, m.fillText(d, a, b);
      } catch (r) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
  };
  this.drawTriangle = function(a, b, d, f, c, g) {
  ...
  this.drawTriangleFilled = function(a, b, d, f, c, g) {
  ...
  this.clearCanvas = function(a, b, d, f) {
    "ctat" == CTATConfig.platform && m.clearRect(a, b, d, f);
  };
};
...
var CTATMobileTutorHandler = function(a, b) {
  ...
  this.processTextFocus = function(a, b, h, k, l) {
    ...
    "disabled" == f || "auto" == f && 0 == g || (c = "", this.manipulateKeyboard());
  };
    ...
    if ("disabled" != f && ("auto" != f || 0 != g)) {
      if (null != CTATGlobals.selectedTextInput) {
        ...
        if (this.ctatdebug("Attempting to call AS3 method ..."), e = getSafeElementById(a), null != e) {
          try {
            c += b, this.ctatdebug(c), e.processExternalKeyboard(c), this.ctatdebug("Successfully called AS3 method");
          } catch (h) {
...
function processTextFocus(a, b, c, f, g) {
  mobileAPI.processTextFocus(a, b, c, f, g);
}
function processFocusOut() {
  closeK();
}
;var CTATShape = function(a, b, c, f, g, d) {
  var e = this;
  if (void 0 == a || null == a) {
    return e.ctatdebug("--- Error: Must pass a valid ID. ---"), null;
  }
  var h = [], k = [], l = g, n = d, m = b, t = void 0, r = "black", q = "black", u = "Arial", w = 12, x = [], B = 1, C = 5, p = document.createElement("canvas");
  p.id = m;
  p.width = l;
  p.height = n;
  var y = new CTATCSS;
  ...
  this.drawCircle = function() {
    v.drawCircle(h[0] + C, k[0] + C, C);
  };
  this.drawCircleFilled = function() {
    v.drawCircleFilled(h[0] + C, k[0] + C, C - 1);
  };
  this.drawRectangle = function(a, b, d, f) {
    v.drawRectangle(a[0] + B, b[0] + B, l - B, n - B);
  };
  this.drawRectangleFilled = function() {
    v.drawRectangleFilled(h[0], k[0], l, n);
  };
  this.drawRoundedRect = function() {
    v.drawRoundedRect(h[0] + B, k[0] + B, l - C - B, n - C - B, C);
  };
  this.drawRoundedRectFilled = function() {
    v.drawRoundedRectFilled(h[0] + B, k[0] + B, l - C - B, n - C - B, C);
  };
  this.drawText = function() {
    v.drawText(w / 2, w / 2, t);
  };
...
var CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (v.ctatdebug("errScrimUp (" + a + ")"), 1 == g ? 1 == r && (r = !1, getSafeElementById(ctatcontainer).removeChild(p)) : 1 == e && (r = !0), v.scrimUp(a));
  }
  function c(a, b) {
  ...
  var f = !1, g = !1, d = !0, e = !1, h = !1, k = !0, l = !0, n = "", m = !1, t = !1, r = !1, q = null, u = null, w = new CTATCanvasComponent("CTAT Scrim"), x = [], B = null, C = null, p = null, y = null, v = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (v.ctatdebug("scrimUp ()"), v.ctatdebug("Message: " + b), 1 == f ? (n = 1 == d ? b : n + (" \n " + b), w.removeComponent()) : (n = b, f = !0), v.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        v.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + n + "<br><br></div></div></div>\t\t"), !0 === r && (p = c(a, "close"), $(p).appendTo("#scrimpanel")), !0 === m && (B = c(q, "yes"), $(B).appendTo("#scrimpanel")), !0 === t && (C = c(u, "no"), $(C).appendTo("#scrimpanel")), 
        1 == d)) {
          ...
          $("#scrimpanel").append(b);
          try {
            var e = (new Spinner({className:"scrim_spinner"})).spin();
            $("#scrim_spin").append(e.el);
          } catch (g) {
  ...
  this.waitScrimUp = function() {
    "google" != CTATConfig.platform && (v.ctatdebug("waitScrimUp ()"), d = !0, v.scrimUp("Please wait while the tutor is being loaded"));
  };
  this.nextProblemScrimUp = function() {
    "google" != CTATConfig.platform && (v.ctatdebug("nextProblemScrimUp ()"), v.scrimUp("Retrieving the Next Problem..."));
  };
  ...
  this.confirmScrimUp = function(a, b, d) {
    "google" != CTATConfig.platform && (v.ctatdebug("confirmScrimUp (" + a + "," + b + "," + d + ")"), t = m = !0, u = d, q = b, v.scrimUp(a));
  };
  ...
  this.warningScrimUp = function(a) {
    "google" != CTATConfig.platform && (0 == k ? (v.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), x.push("WARNING: " + a), e = !0) : 0 == l ? v.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (e = !0, b("WARNING: " + a)));
  };
  this.handleTSDisconnect = function() {
    h = !0;
    v.scrimUp("The tutor has disconnected. Please refresh the page.");
  };
  this.scrimDown = function() {
    "google" != CTATConfig.platform && (0 == f ? v.ctatdebug("The scrim isn't up, returning") : 1 == g ? v.ctatdebug("The scrim is up to describe errors to the user, leave it up!") : 1 == e ? v.ctatdebug("The scrim is up to display warnings to the user, leave it up!") : 1 == h ? v.ctatdebug("The scrim is up for a connection issue leave it up!") : ($("#scrim").remove(), w.removeComponent(), d = f = !1, n = ""));
  };
...
var CTATConnection = function(a) {
  ...
  var b = -1, c = "", f = null, g = null, d = !1, e = this;
  this.setConsumed = function(a) {
    d = a;
    e.ctatdebug("consumed: " + d);
  };
  ...
  this.createHTTPObject = function() {
    e.ctatdebug("createHTTPObject ()");
    g = new XMLHttpRequest;
    if (window.XMLHttpRequest) {
      e.ctatdebug("Creating regular XMLHttpRequest ..."), g = new XMLHttpRequest, g.overrideMimeType && g.overrideMimeType("text/html");
    } else {
      if (e.ctatdebug("Trying alternative HTTP object creation ..."), window.ActiveXObject) {
        e.ctatdebug("Detected window.ActiveXObject ...");
        try {
          e.ctatdebug("Creating Msxml2.XMLHTTP ..."), g = new ActiveXObject("Msxml2.XMLHTTP");
        } catch (a) {
          try {
            e.ctatdebug("Creating Microsoft.XMLHTTP ..."), g = new ActiveXObject("Microsoft.XMLHTTP");
          } catch (b) {
  ...
  this.init = function() {
    ...
    if (null !== g) {
      ...
      "dummySession" == b && e.ctatdebug("Unable to find CTAT session information from environment, trying OLI ...");
      try {
  ...
  this.send = function() {
    e.ctatdebug("send ()");
    try {
      f ? e.getHTTPObject().send(f) : e.getHTTPObject().send();
    } catch (a) {
...
var transformArray = [], CTATJSON = function() {
  ...
  this.getElementChildren = function(a) {
    ...
    for (d in a) {
      var e = a[d];
      if ("string" == typeof e) {
        b = new CTATJSONObject, b.name = d, b.value = e, g.push(b);
      } else {
        if (null == e[0] || void 0 == e[0]) {
          b = new CTATJSONObject, b.name = d, b.value = e, g.push(b);
        } else {
          for (var h in e) {
            b = new CTATJSONObject, b.name = d, b.value = e[h], g.push(b);
          }
        }
      }
    }
  ...
  this.walk = function(a) {
    ...
    if (!(5 < b)) {
      ...
      for (g in a) {
        var d = a[g];
        this.ctatdebug("(" + f + ") typeof (key): " + typeof g + " -> typeof(value): " + typeof d + "(" + d.length + ")");
...
var CTATWSConnection = function(a) {
  ...
  var b = -1, c = "", f = "", g = !1, d = this, e = null, d = this, h = [], k = !1, l = 0, n = 0, m = null;
  this.setConsumed = function(a) {
    g = a;
  ...
  this.init = function() {
    ...
    e.addEventListener("message", function(a) {
      ...
      d.ctatdebug("Received: " + a.data + " <b>(" + (n - l) + "ms)</b>");
      m ? m() : d.ctatdebug("Error: no processing function provided");
    });
    e.addEventListener("close", function(a) {
  ...
  this.send = function() {
    d.ctatdebug("send ()");
    0 == k ? (d.ctatdebug("Connection not ready yet, storing ..."), h.push(f)) : (d.ctatdebug("Connection ready, sending data ..."), l = (new Date).getTime(), e.send(f));
  };
};
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b, c) {
  ...
  var f = "", g = 0, d = [], e = a ? a : null, h = null == b ? !0 : b, k = !0, l = null, n = c ? c : {}, m = this;
  ...
  this.processReply = function(a) {
    ...
    for (var c = 0, c = 0;c < d.length;c++) {
      var g = d[c], k = g.getHTTPObject();
      m.ctatdebug("Testing connection entry " + c + ", readyState: " + k.readyState + ", testConnection.consumed: " + g.getConsumed());
      4 == k.readyState && 0 == g.getConsumed() ? (m.ctatdebug("Investigating request response: " + b + " -> " + k.status + ", for: " + g.getURL()), f = !1, 0 === k.status && (f = !0, m.ctatdebug("Received message (status 0): " + k.responseText)), 408 == k.status && (f = !0, m.ctatdebug("Received message (status 408): " + k.responseText), h && CTATScrim.scrim.scrimDown()), 502 == k.status && (f = !0, m.ctatdebug("Received message (status 502): " + k.responseText), h && CTATScrim.scrim.errorScrimUp("Error contacting the server, please refresh the page and try again (HTTP status 502: gateway response).")), 
      200 == k.status ? (f = !0, m.ctatdebug("Processing 200 response ..."), null !== e ? (a.push(k.responseText), null != l && l.processIncoming(k.responseText)) : m.ctatdebug("Error: httphandler is null, can't process response!")) : e && e.processError && (f = !0, m.ctatdebug("Processing non-200 response, status " + k.status), e.processError(k.status, k.responseText)), !1 === f && m.ctatdebug("Error: status not handled for: " + k.status), m.ctatdebug("Marking connection as consumed ..."), g.setConsumed(!0)) : 
      (0 === k.readyState && m.ctatdebug("Received message (status 0, request not initialized)"), 1 === k.readyState && m.ctatdebug("Received message (status 1, server connection established)"), 2 === k.readyState && m.ctatdebug("Received message (status 2, request received)"), 3 === k.readyState && m.ctatdebug("Received message (status 3, processing request)"));
      b++;
    }
    m.cleanup();
    for (b = 0;b < a.length;b++) {
      f = a[b], -1 != f.indexOf("status=success") ? m.ctatdebug("Info: logging success message received, not propagating to message handler") : (m.ctatdebug("Processing incoming message: " + f), e.processMessage(f));
    }
  };
...
var CTATLogMessageBuilder = function() {
  ...
  this.createContextMessage = function(b) {
    ...
    var c = new Date, d = flashVars.getRawFlashVars(), e = '<context_message context_message_id="' + this.getContextName() + '" name="START_PROBLEM">';
    b || (e += this.makeMetaElement(c));
    b = "";
    ...
    var e = e + d, d = flashVars.getCustomFields(), l;
    for (l in d) {
      d.hasOwnProperty(l) && (e += "<custom_field>", e += "<name>" + l + "</name>", e += "<value>" + d[l] + "</value>", e += "</custom_field>");
    }
    e += "</context_message>";
    a.ctatdebug("messageString = " + e);
    return e;
  };
  this.createSemanticEventToolMessage = function(f, g, d, e, h) {
  ...
  this.createUIEventToolMessage = function(f, g, d, e) {
  ...
  this.wrapForOLI = function(b) {
    ...
    var e;
    e = '<?xml version="1.0" encoding="UTF-8"?><log_action ' + ('auth_token="' + encodeURIComponent(d.auth_token) + '" ');
    e = void 0 != d.log_session_id && null != d.session_id ? e + ('session_id="' + d.log_session_id + '" ') : e + ('session_id="' + d.session_id + '" ');
    e = e + 'action_id="EVALUATE_QUESTION" ' + ('user_guid="' + d.user_guid + '" ');
    e += 'date_time="' + this.formatTimeStampOLI(c) + '" ';
    e += 'timezone="' + flashVars.getTimeZone() + '" ';
    e += 'source_id="' + d.source_id + '" ';
    e = d.activity_context_guid ? e + ('external_object_id="' + d.activity_context_guid + '" info_type="tutor_message.dtd">') : e + 'external_object_id="" info_type="tutor_message.dtd">';
  ...
  this.createCustomFields = function(b, c) {
    ...
    for (var d = "", e = 0;e < b.length;e++) {
      a.ctatdebug("Adding custom field: [" + b[e] + "],[" + c[e] + "]"), d += "<custom_field>", d += "<name>" + b[e] + "</name>", d += "<value>" + c[e] + "</value>", d += "</custom_field>";
    }
    return d;
  };
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, c = !0, f = !1, g = !1, d = [], e = "undefined", h = "undefined", k = "undefined", l = "undefined", n = "undefined", m = "undefined", t = "undefined", r = "undefined", q = "UnassignedDataset", u = "UnassignedLevelName", w = "UnassignedLevelType", r = (new CTATGuid).guid();
  ...
  this.logSemanticEvent = function(a, d, e, c, f, g) {
    ...
    a = commLogMessageBuilder.createSemanticEventToolMessage(d, a, e, c, !0);
    this.sendMessage(a);
  };
  this.logTutorResponse = function(a, d, e, c, f, g, l, h, k) {
    b.ctatdebug("logTutorResponse ()");
    b.initCheck();
    var n = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(h, k);
    ...
    a = commLogMessageBuilder.createTutorMessage(d, a, e, f, h, c, l, !0);
    this.sendMessage(a);
  };
  ...
  this.logInterfaceAttempt = function(a, d, e, c) {
  ...
  this.logInterfaceAttemptSAI = function(a, d) {
    ...
    var e = (new CTATGuid).guid();
    this.logSemanticEvent(e, a, "ATTEMPT", "");
    return e;
  };
  this.logResponse = function(a, d, e, c, f, g, l, h) {
    b.ctatdebug("logResponse ()");
    d = new CTATSAI(d, e, c);
    d.setInput(c);
    c = new CTATActionEvaluationData("");
    c.setEvaluation(g);
    void 0 == h ? this.logTutorResponse(a, d, f, "", c, l) : this.logTutorResponse(a, d, f, "", c, l, h.getCustomElementNames(), h.getCustomElementTypes());
  };
  this.logResponseSAI = function(a, d, e, c, f, g) {
    b.ctatdebug("logResponse ()");
    var l = new CTATActionEvaluationData("");
    l.setEvaluation(c);
    void 0 == g ? this.logTutorResponse(a, d, e, "", l, f) : this.logTutorResponse(a, d, e, "", l, f, g.getCustomElementNames(), g.getCustomElementTypes());
  };
...
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForHint = function(a, b, c, f, g) {
...
CTATTutorMessageBuilder.prototype.createAssociatedRulesMessageForAction = function(a, b, c, f, g, d, e) {
  ...
  e && (a += "<TutorAdvice><![CDATA[" + e + "]]\x3e</TutorAdvice>");
  a += "<LogAsResult>true</LogAsResult>";
  a += "<end_of_transaction>" + (e ? !1 : !0) + "</end_of_transaction>";
...
CTATTutorMessageBuilder.prototype.isDoneStep = function(a, b) {
  ...
  var g = "done" == f;
  this.ctatdebug("isDoneStep() indicatorObj " + c + ", selectionObj " + f + ", correct[0] " + b[0] + ", result " + g);
  return g;
};
CTATTutorMessageBuilder.prototype.createHintMessage = function(a, b, c, f) {
  ...
  c += "<transaction_id>" + f + "</transaction_id>";
  return c += "</properties></message>";
};
...
CTATTutorMessageBuilder.prototype.createStateGraphMessage = function(a, b, c, f, g, d, e) {
...
CTATTutorMessageBuilder.prototype.createHighlightWidgetMessage = function(a, b, c, f) {
...
var CTATCompBase = function(a, b, c, f, g, d) {
  CTATBase.call(this, a, b);
  var e = c || 0, h = f || 0, k = g || -2, l = d || -2, n = 50, m = 25, t = !1, r = "", q = !1, u = !0, w = null, x = "", B = -1;
  this.isTabIndexable = !0;
  var C = 0, p = null, y = null, v = this, D = null, A = "hidden", z = CTATGlobalFunctions.gensym.z_index(), E = CTATGlobalFunctions.gensym.div_id(), F = CTATGlobalFunctions.gensym.z_index(), G = CTATGlobalFunctions.gensym.div_id();
  ...
  this.createCanvas = function() {
    ...
    D.setAttribute("height", l + canvasCalibrate + "px");
  ...
  this.setEnabled = function(a) {
    ...
    v.assignEnabled(a);
    p ? p.disabled = !u : v.ctatdebug("Error: component pointer is null");
  };
  ...
  this.move = function(a, b) {
    e = a;
    h = b;
    w && (w.style.left = e + "px", w.style.top = h + "px");
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    A = !0 === a ? "block" : "hidden";
    D && D.setAttribute("style", "border: 0px; position: absolute; " + (a ? "" : "visibility:hidden; ") + "; left:" + e + "px; top:" + h + "px; z-index:" + F + ";");
  ...
  this.processTabOrder = function() {
    ...
    !0 === t ? v.ctatdebug("Component is an abstract component, bump") : p ? (v.ctatdebug("We have a component, actually assigning to html component ..."), p.tabIndex = B, p.onfocus = v.processOnFocus) : v.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
  this.hideKeyboard = function() {
    document.activeElement.blur();
    $("input").blur();
...
var CTATMovieClip = function(a, b, c, f, g) {
  CTATBase.call(this, "CTATMovieClip", a);
  var d = CTATGlobalFunctions.gensym.z_index(), e = CTATGlobalFunctions.gensym.div_id(), h = CTATGlobalFunctions.gensym.z_index();
...
CTAT.Component = {};
CTAT.Component.Base = {};
CTAT.Component.Base.Style = function(a, b, c, f, g, d) {
  CTATCompBase.call(this, a, b, c, f, g, d);
  var e = new CTATCSS;
...
var CTATPlayButton = function() {
  ...
  var f = null, g = null, d = null, e = null, h = null;
  (function() {
...
var CTATSkill = function() {
  ...
  var a = "", b = "", c = "", f = "", g = 0, d = "", e = !1, h = "", k = "", l = "", n = "", m = "";
  ...
  this.toSetPreferencesXMLString = function() {
    var e = '<skill label="' + b + '" pSlip="' + k + '" description="' + d;
    return e += '" pKnown="' + l + '" category="' + c + '" pLearn="' + n + '" name="' + a + '" pGuess="' + h + '" history="' + m + '" />';
  };
...
var CTATSkillSet = function() {
  ...
  this.parseByValue = function(b) {
    ...
    if (null == b) {
      ...
      b = b.childNodes;
      for (var c = new CTATXML, f = 0;f < b.length;f++) {
        var g = c.getNodeTextValue(b[f]).split("`"), d = g[0].split(" ");
  ...
  this.parseDOM = function(a) {
    ...
    for (var f = 0;f < a.length;f++) {
      var g = c.getNodeTextValue(a[f]).split("`"), d = g[0].split(" ");
      4 == g.length ? this.addSkill(d[0], g[1], g[2], g[3], g[3], d[1]) : this.addSkill(d[0], g[1], g[2], g[3], g[4], d[1]);
    }
  };
    ...
    if (null == b) {
      ...
      if (b = b.childNodes, null == b) {
        ...
        for (var c = 0;c < b.length;c++) {
          var f = b[c];
          if ("Skill" == f.nodeName) {
            this.ctatdebug("Parsing node (" + c + "): " + f.nodeName + " -> " + f.nodeValue);
            var g = "";
  ...
  this.addSkill = function(a, c, f, g, d, e, h, k, l, n) {
    this.ctatdebug("addSkill() name = " + a + " level = " + c + " mastery = " + f + " aDescription = " + g + " adisplayName = " + d + " aCategory = " + e + " pguess= " + h + " plearn = " + k + " pslip = " + l + " history = " + n);
    a = this.setSkillLevel(a, c, f);
    this.ctatdebug("Configuring " + a.getDisplayName());
    "" !== g && null != g && a.setDescription(g);
    "" !== d && null != d && a.setDisplayName(d);
    "" !== e && null != e && a.setCategory(e);
    "" !== h && (a.setPGuess(h), a.setPLearn(k), a.setPSlip(l));
    "" != n && a.setSkillHistory(n);
    return a;
  };
  this.setSkillLevel = function(a, c, f) {
    this.ctatdebug("setSkillLevel (" + a + ")");
    var g = this.getSkill(a);
    null == g ? (this.ctatdebug("Skill not found, creating new one ..."), g = new CTATSkill, g.setSkillName(a), 1 == f ? g.setLevel(1) : g.setLevel(c), this.skillSet.push(g)) : (this.ctatdebug("Skill found, adjusting ..."), 1 == f ? g.setLevel(1) : g.setLevel(c));
    g.setTouched(!0);
    return g;
  };
  this.getSkill = function(a) {
    ...
    for (var c = 0;c < this.skillSet.length;c++) {
      var f = this.skillSet[c];
      if (f.getSkillName() == a) {
        return this.ctatdebug("Returning: " + c), f;
      }
    }
    return null;
  };
  ...
  this.toLogString = function() {
    for (var a = "", c = 0;c < this.skillSet.length;c++) {
      var f = this.skillSet[c], a = a + ('<skill probability="' + f.getLevel() + '"><name>' + f.getSkillName() + "</name>");
...
CTAT.Component.Base.Graphical = function(a, b, c, f, g, d, e) {
  CTAT.Component.Base.Style.call(this, a, b, f, g, d, e);
  ...
  var k = CTATGlobals.Visual.BackgroundColor, l = "white", n = 1, m = CTATGlobals.Visual.BorderColor, t = !1, r = "solid", q = 0, u = "1px", w = 0, x = CTATGlobals.Font.color, B = "black", C = CTATGlobals.Font.family, p = CTATGlobals.Font.size, y = !1, v = !1, D = !1;
  ...
  this.getBorderRoundness = function() {
    return this.component ? $(this.component).css("border-radius") : q;
  };
  this.setBorderRoundness = function(a) {
    a = parseInt(a);
    q = isNaN(a) ? 0 : a;
    this.component && this.getBorderRoundness() !== q && (this.component.style.borderRadius = q);
    return this;
  };
  ...
  this.setShowBorder = function(a) {
    ...
    this.component && this.getShowBorder() !== t && (t ? (this.setBorderStyle(r), this.setBorderWidth(u)) : this.setBorderStyle("none"));
    return this;
  };
...
var CTATSkillWindow = function(a, b, c, f, g) {
  CTAT.Component.Base.Graphical.call(this, "CTATSkillWindow", "__undefined__", a, b, c, f, g);
  ...
  this.updateSkillSet = function(a) {
    ...
    if (null == skillSet) {
      ...
      for (var b = 0;b < a.length;b++) {
        var e = a[b];
        d.ctatdebug("Updating skill " + e.getSkillName() + " to level: " + e.getLevel() + " ...");
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), e = 0;e < a.length;e++) {
            var c = a[e];
            d.ctatdebug("Drawing skill " + e + " " + c.getDisplayName() + " level: " + c.getLevel() + " ...");
            var f = document.createElement("div");
            f.classList.add("CTAT-skill-window--bar");
            var g = document.createElement("div"), q = c.getLevel();
            .95 > q ? g.classList.add("CTAT-skill-window--bar--nonmastered") : g.classList.add("CTAT-skill-window--bar--mastery");
            g.style.width = .95 < q ? "100%" : 100 * q + "%";
            f.appendChild(g);
            b.appendChild(f);
            f = document.createElement("div");
            f.textContent = c.getDisplayName() || "no-name";
...
var CTATSAI = function(a, b, c, f) {
  function g(a, b, d, e) {
    e = String(q.getElementName(b)).toLowerCase();
    if (e == a || "value" == e) {
      if (e = q.getElementChildren(b), !Array.isArray(e) || 1 > e.length) {
        d.push(q.getNodeTextValue(b));
      } else {
  ...
  var d = "undefined", e = "undefined", h = new CTATStringUtil, k = [], l = [], n = [], m = [], t = [], r = [], q;
  q = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  ...
  this.setSAI = function(a, b, c, f, g) {
  ...
  this.fromXML = function(a) {
    ...
    k = [];
    a = q.getElementChildren(a);
    for (var b = null, d = 0;d < a.length;d++) {
      var e = a[d];
      if ("selection" == q.getElementName(e) || "Selection" == q.getElementName(e)) {
        for (var c = q.getElementChildren(e), f = !1, g = 0;g < c.length;g++) {
          b = c[g], "value" == q.getElementName(b) && (b = q.getNodeTextValue(b), 1 > g ? this.setSelectionArray(b) : this.appendToSelectionArray(b), f = !0, this.setSelection(b));
        }
        !1 === f && (b = q.getNodeTextValue(e), this.setSelectionArray(b), this.setSelection(b));
      }
      if ("action" == q.getElementName(e) || "Action" == q.getElementName(e)) {
        c = q.getElementChildren(e);
        f = !1;
        for (g = 0;g < c.length;g++) {
          b = c[g], "value" == q.getElementName(b) && (b = q.getNodeTextValue(b), 1 > g ? this.setActionArray(b) : this.appendToActionArray(b), f = !0, this.setAction(b));
        }
        !1 === f && (b = q.getNodeTextValue(e), this.setActionArray(b), this.setAction(b));
      }
      if ("internalArguments" == q.getElementName(e) || "value" == q.getElementName(e) || "Input" == q.getElementName(e)) {
        var b = q.getElementChildren(e), l = null;
        k = [];
        ...
        for (var h = 0;h < b.length;h++) {
          var n = b[h];
          "value" == q.getElementName(n) && (l = q.getElementChildren(n), null !== l ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + l.length), 1 === l.length ? (l = c.htmlDecode(q.getNodeTextValue(n)), this.ctatdebug("Setting new value to: " + l), f.setValue(l)) : (l = c.htmlDecode(q.getNodeTextValue(n)), this.ctatdebug("Setting new value to: " + l), f.setValue(l), f.setName(n.attributes.getNamedItem("name").value), f.setType(n.attributes.getNamedItem("type").value), 
          f.setFormat(n.attributes.getNamedItem("format").value), g++), 1 > h ? this.setInputArray(l) : this.appendToInputArray(l)) : (n = c.htmlDecode(q.getNodeTextValue(n)), this.ctatdebug("Setting new value to: " + n), f.setValue(n), 1 > h ? this.setInputArray(n) : this.appendToInputArray(n)));
        }
      }
      if ("prompt" == q.getElementName(e) || "Prompt" == q.getElementName(e)) {
        this.ctatdebug("Parsing prompt ..."), this.setPrompt(q.getNodeTextValue(e));
      }
    }
    this.checkDefaultArgument();
  };
  this.setArrayFromElements = function(a) {
    if (a && Array.isArray(a) && !(1 > a.length)) {
      var b = null, d = String(q.getElementName(a[0])).toLowerCase();
      switch(d) {
        case "selection":
          b = m = [];
          break;
      ...
      this.ctatdebug("CTATSAI.setArrayFromElements() eltName " + d + ", length " + e + ", selectionArray " + this.getSelectionArray() + ", actionArray " + this.getActionArray() + ", inputArray " + this.getInputArray());
    }
  };
  this.fromXMLInternal = function(a) {
    ...
    for (var b = null, d = 0;d < a.length;d++) {
      ...
      if ("internalArguments" == q.getElementName(e) || "Input" == q.getElementName(e)) {
        b = e.childNodes;
        k = [];
        var c = new CTATHTMLManager, f = new CTATArgument, g = 0, l = null;
        k.push(f);
        for (var h = 0;h < b.length;h++) {
          if (l = b[h], "value" == q.getElementName(l)) {
            var n = q.getElementChildren(l);
            null !== n ? (this.ctatdebug("Parsing SAI input ..."), this.ctatdebug("Childnodes: " + n.length), 1 === n.length ? (l = c.htmlDecode(q.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), f.setValue(l)) : (l = c.htmlDecode(q.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + l), f.setValue(l), f.setName(q.getElementAttr("name")), f.setType(q.getElementAttr("type")), f.setFormat(q.getElementAttr("format")), g++)) : (l = c.htmlDecode(q.getNodeTextValue(l)), this.ctatdebug("Setting new value to: " + 
            l), f.setValue(l));
  ...
  var u = !1;
  if (Array.isArray(a) && Array.isArray(b) && (Array.isArray(c) || null == c) && (this.setSelectionArray(a), this.setActionArray(b), this.setInputArray(c), u = !0, 0 < a.length && 0 < b.length)) {
    this.setSAI(a[0], b[0], null == c ? null : c[0], "String", f);
    return;
  }
  null !== a && "" !== a && this.setSelection(a);
  null !== a && (this.setSAI(a, b, c, "String", f), u || (this.setSelectionArray(Array.isArray(a) ? a : [a]), this.setActionArray(Array.isArray(b) ? b : [b]), this.setInputArray(Array.isArray(c) ? c : [c]), u = !0));
};
...
var CTATMessage = function(a) {
  ...
  var g = "ungraded", d = !1, e = !1, h = new CTATSkillSet, k = "", l = "", n = "", m = "", t = "", r = null, q = !1;
  ...
  this.parse = function() {
    ...
    if (null !== b) {
      ...
      "tool_message" == f.getElementName(b) ? (this.ctatdebug("Detected tool message"), k = "tool_message") : "message" != f.getElementName(b) ? (this.ctatdebug("Detected log message"), d = !0, k = f.getElementName(b)) : (this.ctatdebug("Detected regular message"), d = !1, this.parseMessageType());
      this.parseTransactionID();
      this.parseSAI();
      for (var a = f.getElementChildren(b), e = 0;e < a.length;e++) {
        var g = a[e];
        "properties" == f.getElementName(g) && (ctatdebug("Found a 'properties' element ... "), c = f.getElementChildren(g));
      }
  ...
  this.parseSAI = function() {
    ...
    if ("tool_message" == k) {
      ...
      for (c = 0;c < a.length;c++) {
        if (g = a[c], "tool_message" == f.getElementName(g)) {
          for (g = f.getElementChildren(g), l = 0;l < g.length;l++) {
            q = g[l], "event_descriptor" == f.getElementName(q) && (r = new CTATSAI, r.fromXMLInternal(q));
          }
        }
      }
      e = !0;
      ...
      if (d) {
        ...
        for (var v = f.getElementChildren(b), D = 0;D < v.length;D++) {
          var A = v[D];
          if ("event_descriptor" == f.getElementName(A)) {
            for (var A = f.getElementChildren(A), z = 0;z < A.length;z++) {
              var E = A[z];
              "selection" == f.getElementName(E) && (a = f.getNodeTextValue(E), q.push(E));
              "action" == f.getElementName(E) && (c = f.getNodeTextValue(E), p.push(E));
              "input" == f.getElementName(E) && (g = f.getNodeTextValue(E), y.push(E));
              "prompt" == f.getElementName(E) && (l = f.getNodeTextValue(E));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), v = f.getElementChildren(b), D = 0;D < v.length;D++) {
          if (A = v[D], "properties" == f.getElementName(A)) {
            for (A = f.getElementChildren(A), z = 0;z < A.length;z++) {
              E = A[z], this.ctatdebug("Nodename: " + f.getElementName(E)), "Skills" == f.getElementName(E) && h.parseByValue(E), "SuccessMsg" == f.getElementName(E) && (n = a = f.getNodeTextValue(E)), "BuggyMsg" == f.getElementName(E) && (m = f.getNodeTextValue(E)), "Selection" == f.getElementName(E) && (a = f.getNodeTextValue(E), q.push(E)), "Action" == f.getElementName(E) && (c = f.getNodeTextValue(E), p.push(E)), "Input" == f.getElementName(E) && (g = f.getNodeTextValue(E), y.push(E)), "prompt" == 
              f.getElementName(E) && (l = f.getNodeTextValue(E)), "HighlightMsgText" == f.getElementName(E) && (t = f.getNodeTextValue(E));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + c + "," + g);
      "" !== a && null !== a ? (r = new CTATSAI(a, c, g, l), r.setArrayFromElements(q), r.setArrayFromElements(p), r.setArrayFromElements(y), e = !0) : (this.ctatdebug("No SAI found"), e = !1);
      this.ctatdebug("parseSAI () done, hassai: " + e + ", (" + a + "," + c + "," + g + "," + l + ")");
    }
  };
  this.parseTransactionID = function() {
    ...
    if ("tool_message" != k) {
      if (!d) {
        for (var a = f.getElementChildren(b), e = 0;e < a.length;e++) {
          var c = a[e];
          if ("properties" == f.getElementName(c)) {
            for (var c = f.getElementChildren(c), g = 0;g < c.length;g++) {
              var h = c[g];
  ...
  this.parseMessageType = function() {
    ...
    for (var a = f.getElementChildren(b), d = 0;d < a.length;d++) {
      var e = a[d];
      if ("properties" == f.getElementName(e)) {
        for (var e = f.getElementChildren(e), c = 0;c < e.length;c++) {
          var g = e[c];
  ...
  this.getSAI = function() {
    return e ? r : new CTATSAI;
  };
  this.getSelection = function() {
    return e ? r.getSelection() : "";
  };
  this.getAction = function() {
    return e ? r.getAction() : "";
  };
  this.getInput = function() {
    return e ? r.getInput() : "";
  };
  this.getSelectionArray = function() {
    return e ? r.getSelectionArray() : [];
  };
  this.getActionArray = function() {
    return e ? r.getActionArray() : [];
  };
  this.getInputArray = function() {
    return e ? r.getInputArray() : [];
  };
...
var CTATTutoringServiceMessageBuilder = function() {
  ...
  this.createSetPreferencesMessage = function(a) {
    ...
    c = c + ("<log_to_remote_server>" + f + "</log_to_remote_server><log_to_disk>" + g + "</log_to_disk>") + ("<log_to_disk_directory>" + b.log_to_disk_directory + "</log_to_disk_directory>");
  ...
  this.createAssociatedRulesMessage = function(a, b, c, f, g, d) {
...
CTAT.Component.Base.SAIHandler = function(a, b, c, f, g, d, e) {
  CTAT.Component.Base.Graphical.call(this, a, b, c, f, g, d, e);
...
CTAT.Component.Base.Tutorable = function(a, b, c, f, g, d, e) {
  CTAT.Component.Base.SAIHandler.call(this, a, b, c, f, g, d, e);
  var h = !0, k = !0, l = !0, n = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, m = !0, t = this, r = !1;
  ...
  this.getTutorComponent = function() {
    ...
    return h && k && l ? a.TUTOR : h && k && !l ? a.TUTOR_NO_FEEDBACK : !h && k ? a.DO_NOT_TUTOR : n;
  };
  ...
  this.setHintHighlight = function(a, b) {
    ...
    if (q) {
      ...
      if (this.component) {
        var e = new CustomEvent(CTAT.Component.Base.Tutorable.EventType.highlight, {detail:{isHighlighted:d, component:this}, bubbles:!0, cancelable:!0});
...
CTAT.Component.Base.Clickable = function(a, b, c, f, g, d, e) {
  CTAT.Component.Base.Tutorable.call(this, a, b, c, f, g, d, e);
  var h = this;
...
var CTATButtonBasedComponent = function(a, b, c, f, g, d, e) {
  CTAT.Component.Base.Clickable.call(this, a, b, c, f, g, d, e);
...
var CTATImageButtonComponent = function(a, b, c, f, g, d, e) {
  CTATButtonBasedComponent.call(this, a, b, c, f, g, d, e);
  var h = "", k = "", l = "", n = "", m = !1, t = "Image to Component", r = this;
  ...
  this.assignImages = function(a, b, d, e) {
  ...
  this.processMouseOver = function(a) {
    !0 !== m && (m = !0, !0 === r.getEnabled() ? r.assignActiveImage(l) : r.ctatdebug("Error component is disabled"), m = !1);
  };
...
CTAT.Component.Base.SVG = function(a, b, c, f, g, d, e) {
  CTAT.Component.Base.Clickable.call(this, a, b, c, f, g, d, e);
  var h = null;
  this.initSVG = function() {
    this.setInitialized(!0);
    var a = CTATGlobals.NameSpace.svg, b = CTATGlobals.NameSpace.xml, d = CTATGlobals.NameSpace.xlink, e = CTATGlobals.NameSpace.ev, c = document.createDocumentFragment();
  ...
  this.getBoundingBox = function() {
    var a = new DOMRect(0, 0, this.getWidth(), this.getHeight()), b = this.getComponent(), d = window.getComputedStyle(b), b = parseInt(d.getPropertyValue("padding-left")), e = parseInt(d.getPropertyValue("padding-right")), c = parseInt(d.getPropertyValue("padding-bottom")), f = parseInt(d.getPropertyValue("padding-right")), g = parseInt(d.getPropertyValue("border-left-width")), h = parseInt(d.getPropertyValue("border-right-width")), w = parseInt(d.getPropertyValue("border-bottom-width")), d = parseInt(d.getPropertyValue("border-right-width"));
    a.width -= b + f + g + d;
    a.height -= e + c + h + w;
    return a;
  };
...
var CTATTextBasedComponent = function(a, b, c, f, g, d, e) {
  CTAT.Component.Base.Tutorable.call(this, a, b, c, f, g, d, e);
  var h = this, k = "", l = !0, n = 255, m = !0;
...
CTAT.Component.Base.UnitDisplay = function(a, b, c, f, g, d, e) {
  CTAT.Component.Base.SVG.call(this, a, b, c, f, g, d, e);
  var h = "1/2+1/4+(0*1/8)";
  this.setActionInput("SetPieces", h);
  var k = "#FF00FF", l = 1, n = "#FF00FF", m = .2, t = "black", r = 1;
  ...
  this.getPiecesBySelected = function(a) {
    for (var b = this.getPieces(), d = [], e, c = 0;c < b.length;c++) {
      e = b[c], w(e) === a && d.push(e);
    }
    return d;
  };
  ...
  this.set_denominator = function(a) {
    ...
    if (!isNaN(b) && (b = y(b), this.get_denominator() != a)) {
      ...
      a = [];
      d.set_denominator(b);
      for (var e = new CTAT.Math.Fraction(1, b), c = Math.floor(d.numerator), f = b - c, g = 0;g < c;g++) {
        a.push(C(e, !0));
      }
  ...
  this.get_denominator = function() {
    return q.reduce(function(a, b, d, e) {
  ...
  this.set_number_pieces = function(a) {
    ...
    if (!isNaN(a)) {
      ...
      var b = u.numActive();
      u.clear();
      for (var d = [], e = new CTAT.Math.Fraction(1, a), c = 0;c < a;c++) {
        d.push(C(e, 0 < b)), b--;
      }
  ...
  this.change_number_pieces = function(a) {
    this.set_number_pieces(q.length + a);
  };
    ...
    if (0 !== Object.keys(D).length) {
      if (a instanceof CTAT.Component.Base.Tutorable) {
        ...
        if (a instanceof CTATSAI) {
          if (a.getSelection() != u.getName() && D.hasOwnProperty(a.getSelection())) {
            return D[a.getSelection()];
          }
        } else {
          if (a instanceof String) {
            if (a != u.getName() && D.hasOwnProperty(a)) {
              return D[a];
            }
          } else {
            if (a instanceof Element && a != u.getComponent() && D.hasOwnProperty(a.id)) {
              return D[a.id];
            }
          }
        }
  ...
  this.change_numerator = function(a) {
    0 !== a && (0 < a ? q.every(function(b) {
      !1 === w(b) && (x(b, !0), a--);
      return 0 < a;
    }) : (q.reverse(), q.every(function(b) {
      !0 === w(b) && (x(b, !1), a++);
      return 0 > a;
    }), q.reverse()));
  };
  a = function(a, b, d) {
    var e = parseInt(d.getInput());
    if (!isNaN(e)) {
      switch(d.getAction()) {
        case "ButtonPressed":
          a.call(this, e);
...
var CTATAudioButton = function(a, b, c, f, g) {
  CTATButtonBasedComponent.call(this, "CTATAudioButton", "audiobutton", a, b, c, f, g);
  var d = this;
  ...
  this.processClick = function(a) {
    ...
    !0 === d.getEnabled() ? (d.ctatdebug("Playing audio file: " + h), e.setAttribute("src", h), e.load(), e.play(), d.processAction()) : d.ctatdebug("Component is disabled, not grading");
  };
  this.play = function() {
...
var CTATButton = function(a, b, c, f, g) {
  CTATButtonBasedComponent.call(this, "CTATButton", "aButton", a, b, c, f, g);
  var d = this, e = null;
  this.init = function() {
    d.ctatdebug("init (" + d.getName() + ")");
    ...
    d.setComponent(e);
    d.addComponentReference(d, e);
    d.getDivWrap().appendChild(e);
    d.ctatdebug("Final location: " + d.getX() + "," + d.getY() + " with text: " + d.getText());
    d.addSafeEventListener("click", d.processClick, e);
    d.addSafeEventListener("focus", d.processFocus, e);
  };
  this.render = function() {
  };
  this.reset = function() {
...
var CTATComboBox = function(a, b, c, f, g) {
  CTAT.Component.Base.Clickable.call(this, "CTATComboBox", "__undefined__", a, b, c, f, g);
  ...
  this.init = function() {
    ...
    d.assignEnabled(!0);
    !0 === d.getEnabled() ? e.disabled = !1 : e.disabled = !0;
    d.ctatdebug("Final location: " + d.getX() + "," + d.getY() + " with text: " + d.getText());
    d.addComponentReference(d, e);
    d.setComponent(e);
    d.getDivWrap().appendChild(e);
    d.render();
    e.addEventListener("focus", d.processFocus);
  };
  this.getHTMLComponent = function() {
    return e;
  };
  this.addLabels = function(a, b) {
    for (var d = a.split(b ? b : h), e = 0;e < d.length;e++) {
      this.addItem(d[e]);
    }
  };
  ...
  this.processComboSelection = function() {
    ...
    d.setInput(e.options[e.selectedIndex].value);
...
var CTATFractionBar = function(a, b, c, f, g) {
  CTAT.Component.Base.UnitDisplay.call(this, "CTATFractionBar", "aFractionBar", a, b, c, f, g);
  var d = 50, e = !0, h = this, k = CTATGlobals.NameSpace.svg;
  this.init = function() {
    h.initSVG();
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      for (var a = h.parseValue(), b = 0, d = document.createDocumentFragment(), e = 0;e < a.length;e++) {
        var c = a[e], f = 100 * c, g = document.createElementNS(k, "rect");
        g.classList.add("CTAT-fraction-bar--piece");
        g.setAttributeNS(null, "height", "100%");
        g.setAttributeNS(null, "width", f + "%");
      ...
      Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a) {
        if ("rect" == a.nodeName) {
          var b = window.getComputedStyle(a), d = parseFloat(b.getPropertyValue("padding-left")), e = parseFloat(b.getPropertyValue("stroke-width")), b = a.getBBox();
          a.setAttributeNS(null, "y", b.y + e / 2);
          a.setAttributeNS(null, "height", b.height - e);
          var c = b.x + e / 2, e = b.width - e;
          1 > b.x ? e -= d / 2 : (c += d / 2, e = b.x + b.width >= w ? e - d / 2 : e - d);
...
var CTATGroupingComponent = function(a, b, c, f, g) {
  CTAT.Component.Base.Tutorable.call(this, "CTATGroupingComponent", "__undefined__", a, b, c, f, g);
  var d = this;
  d.isTabIndexable = !1;
  var e = null;
  this.init = function() {
  ...
  this.postProcess = function() {
    ...
    for (b in a) {
      ...
      "TargetMovieClip" == b && (d.ctatdebug("Loading sub element: " + c.trim() + " ..."), c = findMovieClip(c), null !== c && (d.ctatdebug("Found target movieclip, storing for future reference ..."), e = c));
    }
  };
  this.setTempLock = function(a) {
    d.ctatdebug("setTemplock (" + a + ")");
    null === e && d.ctatdebug("Error: no target MovieClip assigned to this grouping component");
    return !0;
  };
  this.move = function(a, b) {
    d.ctatdebug("move (" + a + "," + b + ")");
    null !== e ? (e.getDivWrapper().style.left = a, e.getDivWrapper().style.top = b) : d.ctatdebug("Error: no target MovieClip assigned to this grouping component");
  };
  ...
  this.setSize = function(a, b) {
    ...
    null !== e ? (e.getDivWrapper().style.width = a + "px", e.getDivWrapper().style.height = b + "px") : d.ctatdebug("Error: no target MovieClip assigned to this grouping component");
  };
  this.SetVisible = function(a) {
    a = CTATGlobalFunctions.toBoolean(a);
    d.ctatdebug("SetVisible (" + a + ")", "graphics");
    null !== e ? !0 === a ? e.getDivWrapper().style.display = "block" : e.getDivWrapper().style.display = "none" : d.ctatdebug("Error: no target MovieClip assigned to this grouping component");
    d.ctatdebug("SetVisible () Done");
  };
  this.setVisible = function(a) {
    var b = CTATGlobalFunctions.toBoolean(a);
    d.ctatdebug("setVisible (" + a + ")", "graphics");
    null !== e ? !0 === b ? e.getDivWrapper().style.display = "block" : e.getDivWrapper().style.display = "none" : d.ctatdebug("Error: no target MovieClip assigned to this grouping component");
  };
  this.configFromDescription();
};
...
var CTATImageButton = function(a, b, c, f, g) {
  CTATImageButtonComponent.call(this, "CTATImageButton", "__undefined__", a, b, c, f, g);
  var d = this, e = null, h = null, k = null;
  this.configFromDescription();
  this.init = function() {
    e = new Image;
    e.name = d.getName();
...
var CTATControllerButton = function(a, b, c, f, g) {
  CTATImageButton.call(this, a, b, c, f, g);
...
var CTATJumble = function(a, b, c, f, g) {
  CTAT.Component.Base.Tutorable.call(this, "CTATJumble", "aJumble", a, b, c, f, g);
  var d = "", e = "center", h = 0, k = 10, l = !1, n = this;
  ...
  this.init = function() {
    ...
    a ? (m.innerHTML = a, $(m).children().addClass("CTAT-jumble--item").attr({unselectable:"on", draggable:!0}).each(function() {
      ...
      this.addEventListener("dragenter", u, !1);
      this.addEventListener("dragover", q, !1);
  ...
  this.init_items = function(a) {
    if (m) {
      ...
      for (var d = a.length, e = 0;e < d;e++) {
        ...
        c.addEventListener("dragenter", u, !1);
        c.addEventListener("dragover", q, !1);
  ...
  this.getOrder = function() {
    for (var a = m.children, b = [], e = 0;e < a.length;e++) {
      var c = a[e];
...
var CTATNumberLine = function(a, b, c, f, g) {
  CTAT.Component.Base.SVG.call(this, "CTATNumberLine", "aNumberLine", a, b, c, f, g);
  var d = CTAT.Math.Fraction, e = CTATGlobals.NameSpace.svg;
  a = function(a, b, e, c) {
    this.step = a;
    this.size = b;
    this.color = e;
  ...
  this.genTickmark = function(a, b, d) {
    ...
    if (!this._tickmarks.some(function(b) {
      ...
      var f = document.createElementNS(e, "line"), g = u.getPosition(a), l = CTAT.Geom.Point.polar(d / 2, q.theta + Math.PI / 2).add(g);
      d = CTAT.Geom.Point.polar(-d / 2, q.theta + Math.PI / 2).add(g);
      f.setAttributeNS(null, "x1", l.x);
      f.setAttributeNS(null, "y1", l.y);
      f.setAttributeNS(null, "x2", d.x);
      f.setAttributeNS(null, "y2", d.y);
      f.data = a;
      f.location = g;
      f.label = null;
      ...
      if ("" !== b) {
        ...
        if (null === b || void 0 === b) {
          if (1 == a.denominator) {
            ...
            var h = document.createElementNS(e, "tspan"), k = document.createElementNS(e, "tspan");
  ...
  var x = function(a) {
  ...
  }.bind(this), B = function(a, b, c, f, g) {
    g = new d;
    a = new d(a);
    b = "number" === typeof b ? b : 20;
    var l = document.createDocumentFragment(), h = document.createElementNS(e, "g");
    ...
    if (0 < a) {
      for (g.set(c).reduce();g <= n;) {
        g >= m && h.appendChild(q.genTickmark(g, f, b)), g = g.add(a);
      }
      g.set(c).reduce();
      for (g = g.subtract(a);g >= m;) {
        g <= n && h.appendChild(q.genTickmark(g, f, b)), g = g.subtract(a);
      }
    }
    return l;
  }.bind(this), C = null, p = function() {
    var a = this.getBoundingBox(), a = CTAT.Geom.Rectangle.inflate(a, -2, -2), b = new DOMPoint(a.width / 2, a.height / 2), d = b.add(CTAT.Geom.Point.polar(Math.min(40, a.height, a.width) / 4, q.theta)), c = Math.sin(q.theta), f = -Math.cos(q.theta), g = c * b.x + f * b.y, l = -a.height * f, r = -c * a.width, B = new DOMPoint(a.left, b.y), b = new DOMPoint(a.right, b.y);
    if (0 < Math.abs(CTAT.Math.round(l))) {
      var l = new DOMPoint(a.left, (g - c * a.left) / f), v = new DOMPoint(a.right, (g - c * a.right) / f);
      if (a.contains(l) || a.contains(v)) {
        d.distance(l) < d.distance(v) ? (B = v, b = l) : (B = l, b = v);
      }
    }
    0 < Math.abs(CTAT.Math.round(r)) && (r = new DOMPoint((g - f * a.top) / c, a.top), c = new DOMPoint((g - f * a.bottom) / c, a.bottom), a.containsPoint(r) || a.containsPoint(c)) && (d.distance(r) < d.distance(c) ? (B = c, b = r) : (B = r, b = c));
    a = document.createDocumentFragment();
    d = document.createElementNS(e, "g");
    d.classList.add("CTAT-number-line--axis");
    a.appendChild(d);
    c = document.createElementNS(e, "line");
    ...
    d.appendChild(c);
    u = new w(B, b, m, n);
    c = document.createElementNS(e, "path");
    c.setAttributeNS(null, "d", "M 10,6 L 0,0 L 10,-6");
    c.setAttributeNS(null, "transform", "translate(" + CTAT.Geom.Point.to2DString(B) + ") rotate(" + q.getOrientation() + ")");
    d.appendChild(c);
    B = document.createElementNS(e, "path");
    B.setAttributeNS(null, "d", "M -10,6 L 0,0 L -10,-6");
    B.setAttributeNS(null, "transform", "translate(" + CTAT.Geom.Point.to2DString(b) + ") rotate(" + q.getOrientation() + ")");
    d.appendChild(B);
    this._tickmarks = [];
    a.appendChild(x(h));
    a.appendChild(x(k));
    C = document.createElementNS(e, "circle");
    C.classList.add("CTAT-number-line--cursor");
    C.setAttributeNS(null, "r", t);
    C.setAttributeNS(null, "transform", "translate(-30,-30)");
    a.appendChild(C);
    q.baseGroup.innerHTML = "";
    q.baseGroup.appendChild(a);
    B = this.theta + Math.PI / 2;
    CTAT.Geom.Point.polar(3, B);
    CTAT.Math.round(Math.cos(B));
    CTAT.Math.round(Math.sin(B));
  }.bind(this), y = null, v = 0, D = new DOMPoint(-30, -30), A = !1, z = function(a) {
    D.x = a.clientX;
    D.y = a.clientY;
  }, E = function(a) {
    ...
    if (!0 === q.getEnabled()) {
      q.setHintHighlight(!1);
      var b;
      r ? (b = K(a.clientX, a.clientY), a = b.location, b = b.data) : (b = G(a.clientX, a.clientY), a = u.getProjectedPoint(b), b = u.getAxisValue(b));
      var d = document.createDocumentFragment(), c = document.createElementNS(e, "circle");
      c.setAttributeNS(null, "r", t);
      ...
      y.innerHTML = "";
      y.appendChild(d);
      q.setActionInput("AddPoint", b.toString());
      q.processAction();
    }
  };
  this.init = function() {
    ...
    this.baseGroup = document.createElementNS(e, "g");
    this.getComponent().appendChild(this.baseGroup);
    p();
    y = document.createElementNS(e, "g");
    y.setAttributeNS(null, "fill", "black");
    y.setAttributeNS(null, "stroke-width", 1);
    y.setAttributeNS(null, "stroke", "black");
    this.baseGroup.appendChild(y);
    q.addComponentReference(q, q.getDivWrap());
    q.addSafeEventListener("mousemove", z);
    q.addSafeEventListener("mouseleave", E);
    q.addSafeEventListener("mouseenter", function() {
      !0 === q.getEnabled() && (A = !0, C.style.fillOpacity = null, v = requestAnimationFrame(H));
    });
    q.addSafeEventListener("click", F);
    this.component.addEventListener("focus", this.processFocus);
  };
  var G = function(a, b) {
    this.svgPoint = this.svgPoint ? this.svgPoint : q.getComponent().createSVGPoint();
    this.svgPoint.x = a;
    this.svgPoint.y = b;
    var d = q.getComponent().getScreenCTM().inverse();
    this.svgPoint = this.svgPoint.matrixTransform(d);
    return new DOMPoint(this.svgPoint.x, this.svgPoint.y);
  }, K = function(a, b) {
    for (var d = u.getProjectedPoint(G(a, b)), e = null, c = Number.POSITIVE_INFINITY, f, g, l = 0;l < q._tickmarks.length;l++) {
      f = q._tickmarks[l], g = d.distance(f.location), g < c && (e = f, c = g);
    }
    return e;
  }, H = function() {
    if (A && !0 === q.getEnabled()) {
      if (r) {
        ...
        C.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(u.getProjectedPoint(G(D.x, D.y)), !0));
      }
  ...
  this.placePointByNum = function(a) {
    a = q.calcXCoordinate(a);
    return q.placePointByCoor(a);
  };
  this.calcXCoordinate = function(a) {
    a = new d(a);
    var b = q.getWidth() - 30, b = Math.abs(b - 30), e = n.subtract(m);
    return 30 + a.subtract(m).divide(e) / b;
  };
  this.calcNum = function(a) {
    var b = q.getWidth() - 30, b = Math.abs(b - 30);
  ...
  this.setPointSize = function(a) {
    t = Number(a);
    C && (C.setAttributeNS(null, "r", t), y.setAttributeNS(null, "r", t));
  };
  ...
  this.set_precision = function(a) {
    q.setPrecision(parseInt(a));
    q.render();
  };
  this.Points = function(a) {
    a = a.split(";");
    for (var b = 0;b < a.length;b++) {
      q.placePointByNum(a[b]);
    }
  };
  this.set_denominator = function(a) {
  };
...
var CTATNumericStepper = function(a, b, c, f, g) {
  CTAT.Component.Base.Tutorable.call(this, "CTATNumericStepper", "__undefined__", a, b, c, f, g);
...
var CTATPieChart = function(a, b, c, f, g) {
  CTAT.Component.Base.UnitDisplay.call(this, "CTATPieChart", "aPieChart", a, b, c, f, g);
  var d = 3, e = 3, h = 3, k = this, l, n, m, t = null, r = CTATGlobals.NameSpace.svg;
  this.init = function() {
    k.initSVG();
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      var a = window.getComputedStyle(k.getComponent()), a = parseFloat(a.getPropertyValue("stroke-width")), b = this.getBoundingBox(), e = Math.min(b.width / 2, b.height / 2) - (a + h + 4), c = new DOMPoint(b.width / 2, b.height / 2), a = k.parseValue(), f = document.createDocumentFragment();
      a.reduce(function(a, b, g, l) {
        if (1 <= b.valueOf()) {
          g = document.createElementNS(r, "circle"), g.classList.add("CTAT-pie-chart--piece"), g.cx.baseVal.value = c.x, g.cy.baseVal.value = c.y, g.r.baseVal.value = e, k.addPieceElem(g, b, b.selected), f.appendChild(g);
        } else {
          ...
          l = c.add(CTAT.Geom.Point.polar(e, h));
          b.reduce();
          var n = c.add(CTAT.Geom.Point.polar(e, 2 * Math.PI * b.valueOf() + h)), m = c.clone();
          if (0 < d && d < e) {
            ...
            l = CTAT.Geom.Point.circle_intersection(m, l, c, e).reduce(q.bind(this, l));
            n = n.add(h);
            n = CTAT.Geom.Point.circle_intersection(m, n, c, e).reduce(q.bind(this, n));
          }
          h = CTAT.Geom.Point.to2DString;
          m = "M " + h(m);
          q = new DOMPoint(e, e);
          m += " L " + h(l);
          m += " A " + h(q) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + h(n);
          g.setAttributeNS(null, "d", m + " Z");
  ...
  this.setBorderPadding = function(a) {
    var b = Number(a);
    isNaN(b) || (b = b != e, e = a, b && this.drawPieces());
  };
...
var CTATScrollPaneComponent = function(a, b, c, f, g) {
  CTAT.Component.Base.Tutorable.call(this, "CTATScrollPaneComponent", "__undefined__", a, b, c, f, g);
  var d = 0, e = this;
  e.isTabIndexable = !1;
  this.getAlpha = function() {
    return d;
  ...
  this.postProcess = function() {
    ...
    for (var a in this.parameters) {
      ...
      if ("TargetMovieClip" == a) {
        ...
        if (null !== d) {
          if (e.ctatdebug("Found target movieclip, temporarily removing ..."), null !== d.getDivWrapper().parentNode) {
            try {
            ...
            e.ctatdebug("Adding ...");
            e.getDivWrap().appendChild(d.getDivWrapper());
            b = CTATGlobalFunctions.gensym.z_index();
            b++;
            var f = d.getDivWrapper().style.left, g = d.getDivWrapper().style.top;
...
var CTATSubmitButton = function(a, b, c, f, g) {
  CTATButton.call(this, a, b, c, f, g);
  ...
  var k = function(a) {
    return 0 === Object.keys(e).length ? !1 : a === d ? !1 : a instanceof CTAT.Component.Base.Tutorable ? e.hasOwnProperty(a.getName()) || e.hasOwnProperty(a.getComponentGroup()) : a instanceof CTATSAI ? a.getSelection() != d.getName() && e.hasOwnProperty(a.getSelection()) : a instanceof String ? a != d.getName() && e.hasOwnProperty(a) : a instanceof Element ? a != d.getComponent() && (e.hasOwnProperty(a.id) || e.hasOwnProperty(a.getAttribute("name"))) : !1;
  };
...
var CTATTextArea = function(a, b, c, f, g) {
  CTATTextBasedComponent.call(this, "CTATTextArea", "__undefined__", a, b, c, f, g);
  this.setDefaultWidth(100);
  this.setDefaultHeight(44);
  var d = this, e = null, h = null;
...
var CTATTextField = function(a, b, c, f, g) {
  CTATTextBasedComponent.call(this, "CTATTextBasedComponent", "__undefined__", a, b, c, f, g);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var d = this, e = null;
  this.setAction("UpdateTextArea");
...
var CTATTextInput = function(a, b, c, f, g) {
  CTATTextBasedComponent.call(this, "CTATTextInput", "__undefined__", a, b, c, f, g);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var d = this, e = null, h = null;
  this.ctatdebug(this.getClassName() + " (" + this.getX() + "," + this.getY() + "," + this.getWidth() + "," + this.getHeight() + ")");
  ...
  this.init = function() {
    ...
    e.type = "text";
    a && (e.name = a.name);
    e.setAttribute("maxlength", d.getMaxCharacters());
    e.setAttribute("id", CTATGlobalFunctions.gensym.div_id());
    e.classList.add("CTAT-text");
    d.setComponent(e);
    this.ctatdebug("Final location: " + d.getX() + "," + d.getY() + " with text: " + d.getText());
    ...
    d.getDivWrap().appendChild(e);
    d.render();
    d.addSafeEventListener("keypress", d.processKeypress, e);
    d.addSafeEventListener("focus", d.processFocus, e);
  };
  this.setCellContainer = function(a) {
    h = a;
...
var CTATVideo = function(a, b, c, f, g) {
  CTAT.Component.Base.Tutorable.call(this, "CTATVideo", "__undefined__", a, b, c, f, g);
  var d = 0, e = this, h = null;
  this.getAlpha = function() {
    return d;
  };
  this.setAlpha = function(a) {
...
var OLIComm = function(a) {
  ...
  this.loadFileRecord = function(a, d) {
    ...
    var e = flashVars.getRawFlashVars(), e = [b("commandName", "loadFileRecord"), b("activityContextGuid", e.activity_context_guid), b("activityGuid", e.activity_guid), b("userGuid", e.user_guid), b("authenticationToken", e.oli_auth_token), b("resourceTypeID", e.resource_type_id), b("activityMode", e.activity_mode), b("attemptNumber", d ? d : e.current_attempt), b("fileName", a)];
    c(e, "loadFileRecord");
  };
  this.writeFileRecord = function(a, d, e, h, k) {
    f.ctatdebug("writeFileRecord");
    var l = flashVars.getRawFlashVars();
    a = [b("commandName", "writeFileRecord"), b("activityContextGuid", l.activity_context_guid), b("activityGuid", l.activity_guid), b("userGuid", l.user_guid), b("authenticationToken", l.oli_auth_token), b("resourceTypeID", l.resource_type_id), b("activityMode", l.activity_mode), b("attemptNumber", e ? e : l.current_attempt), b("fileName", a), b("mimeType", h ? h : "text/xml"), b("byteEncoding", k ? k : "urlencoded"), b("fileRecordData", d)];
    c(a, "writeFileRecord");
  };
  this.scoreAttempt = function(a, d) {
    f.ctatdebug("scoreAttempt");
    var e = flashVars.getRawFlashVars(), e = [b("commandName", "scoreAttempt"), b("activityContextGuid", e.activity_context_guid), b("activityGuid", e.activity_guid), b("userGuid", e.user_guid), b("authenticationToken", e.oli_auth_token), b("resourceTypeID", e.resource_type_id), b("activityMode", e.activity_mode), b("scoreId", a), b("scoreValue", d)];
    c(e, "scoreAttempt");
  };
...
var OLIDriver = function(a) {
  ...
  this.translateURL = function(a) {
    ...
    for (var c = flashVars.getRawFlashVars(), d = getIndicesOf("<img", a, !1), e = getIndicesOf("<a", a, !1), h = -1, k = h = -1, l = !1, n = "", h = "";0 == l;) {
      l = !0;
      ...
      for (e = 0;e < d.length;e++) {
        h = d[e], h = a.indexOf("src", h), -1 != h && (h += 5, k = a.indexOf('"', h), -1 != k && (n = a.substr(h, k - h), b.ctatdebug("We have a valid url (img) to replace between: " + h + "," + k + ", with content: " + n), -1 == n.indexOf("http:") ? (l = !1, n = c.web_content_url + "webcontent/" + currentOLIModule + "/" + n, h = a.substr(0, h) + n + a.substr(k), b.ctatdebug("Replaced: " + h), a = h) : b.ctatdebug("The provided url is an absolute url, returning as is, bump")));
      }
      e = getIndicesOf("<a", a, !1);
      for (d = 0;d < e.length;d++) {
        h = e[d], h = a.indexOf("href", h), -1 != h && (h += 6, k = a.indexOf('"', h), -1 != k && (n = a.substr(h, k - h), b.ctatdebug("We have a valid url (href) to replace between: " + h + "," + k + ", with content: " + n), -1 == n.indexOf("http:") ? (l = !1, n = c.web_content_url + "webcontent/" + currentOLIModule + "/" + n, h = a.substr(0, h) + n + a.substr(k), b.ctatdebug("Replaced: " + h), a = h) : b.ctatdebug("The provided url is an absolute url, returning as is, bump")));
      }
      d = getIndicesOf("<img", a, !1);
      e = getIndicesOf("<a", a, !1);
    }
...
var currentOLIModule = "", OLIMessageHandler = function() {
  ...
  var a = null, b = "", c = new CTATXML, f = this, g = [];
  ...
  this.processError = function(d, e) {
    f.ctatdebug("OLIMessageHandler.processError(" + d + ", " + e + ")\n  from command " + b);
    if (a) {
  ...
  this.parseClientConfig = function(b) {
    ...
    for (var g = null, k = 0;k < b.length;k++) {
      var l = b[k], n = c.getElementName(l);
      "resource_type" != n && "base" != n && ("authentication" == n && "review" != e.activity_mode ? e.user_guid = c.getElementAttr(l, "user_guid") : "logging" == n && (e.log_session_id = c.getElementAttr(l, "session_id"), e.source_id = c.getElementAttr(l, "source_id"), g = c.getElementChildren(l), g = c.getNodeTextValue(g[0])));
    }
    a.oliClientConfig(g);
  };
  this.parseBeginSession = function(b) {
    ...
    if (void 0 == e) {
      ...
      k = c.getElementAttr(e, "guid");
      g.resource_file_id = k;
      if (e = b.getElementsByTagName("section")[0]) {
        g.class_name = c.getElementAttr(e, "admit_code"), g.class_description = c.getElementAttr(e, "title"), g.school_name = c.getElementAttr(e, "institution");
      }
      (e = b.getElementsByTagName("instructors")[0]) && (e = c.getElementChildren(e)) && (g.instructor = c.getElementAttr(e[0], "guid"));
      (e = b.getElementsByTagName("user")[0]) && "review" != g.activity_mode && (g.user_guid = c.getElementAttr(e, "guid"));
      if (e = b.getElementsByTagName("activity")[0]) {
        if (g.activity_guid = c.getElementAttr(e, "guid"), e = e.getElementsByTagName("item_info")[0]) {
          if (e = e.getElementsByTagName("resource_info")[0]) {
            if (e = e.getElementsByTagName("file")[0]) {
              if (e = c.getElementAttr(e, "href")) {
                firstSlash = e.indexOf("/"), this.setCurrentModule(e.substr(0, firstSlash));
              }
            }
          }
        }
      }
      if (e = b.getElementsByTagName("file_record")[0]) {
        g.file_record_file_name = c.getElementAttr(e, "file_name");
        for (var e = c.getElementChildren(e), l = 0;l < e.length;l++) {
          var n = e[l];
  ...
  this.parseAttemptHistory = function(d) {
    var e = flashVars.getRawFlashVars();
    d = f.setAttemptFromAttemptHistory(d, "1");
    "startAttempt" == b && a.oliBeganSession(d, e.resource_file_id);
  };
  this.setAttemptFromAttemptHistory = function(a, b) {
    ...
    return 1 > k.length || !(l = k[k.length - 1]) ? (f.ctatdebug("can't find activity_attempt in attempt_history"), null != b ? g.current_attempt = b : "") : g.current_attempt = c.getElementAttr(l, "number");
  };
  this.parseResourceFile = function(a, b) {
    ...
    for (var h = c.getElementChildren(a), k = flashVars.getRawFlashVars(), l = 0;l < h.length;l++) {
      var n = h[l], m = c.getElementName(n);
      "interface" == m ? (n = c.getNodeTextValue(n), m = oliDriver.translateResourceFile(n), f.ctatdebug("Building BRD url from web_content_url: " + k.web_content_url + " and OLI-provided url: " + n + " = " + m), g.push(m)) : "title" == m && (k.problem_name = c.getNodeTextValue(n));
    }
...
var CTATNameTranslator = function() {
  ...
  this.manufactorJSON = function(a, f) {
    ...
    var d = this.getA1Row(g[0]), e = this.getA1Col(g[0]), h = this.getA1Row(g[1]), k = this.getA1Col(g[1]);
    b.ctatdebug("Manufacturing json from: [" + d + "," + e + "] to: [" + h + "," + k + "]");
    g = "[";
    d = parseInt(h) - parseInt(d);
    e = parseInt(k) - parseInt(e);
    d++;
    e++;
    b.ctatdebug("X range: " + d + ", Y range: " + e);
    for (h = 0;h < d;h++) {
      0 < h && (g += ",");
      g += "[";
      for (k = 0;k < e;k++) {
  ...
  this.translateFromCTAT = function(c, f) {
    if (!0 === a) {
      return c;
    }
    var g = c.toLowerCase();
    ...
    if (-1 != g.indexOf(".r")) {
      ...
      if (0 >= d.length) {
        ...
        return e = d[1], d = d[0].substr(1), b.ctatdebug("Original row (1st format): " + d + " original col: " + e), e = 1 == f ? colName(e, !1) + d : h[0] + "." + colName(e, !1) + d, b.ctatdebug("Translated: " + e), e;
      }
    } else {
      if (0 == g.indexOf("r")) {
        var h = g.indexOf("c"), k = parseInt(g.substr(1, h - 1)), g = parseInt(g.substr(h + 1)), d = k + 1, e = g;
        b.ctatdebug("Original row (2nd format) (columnindex: " + h + "): " + k + " -> " + d + ", original col: " + g + " -> " + e);
        e = colName(e, !1) + d;
...
var CTATShellTools = {ctat_base:new CTATBase("CTATShellTools", "shelltools"), components:{}, component_descriptions:{}, registerComponentDescription:function(a) {
...
}, feedback_components:[], registerFeedbackComponent:function(a, b, c, f, g) {
  CTATShellTools.feedback_components.push({component:a, next:b, prev:c, showHints:f, showFeedback:g});
  ...
  var f = CTATShellTools.component_descriptions, g = [], d = null, d = -1 < a.indexOf(".") ? $('[id="' + a + '"]') : $("#" + a);
  if (0 < d.length) {
    var e = [];
    d.each(function() {
  ...
  var c = CTATShellTools.component_descriptions, f;
  for (f in c) {
    var g = c[f];
    if (null === g) {
      return b.ctatdebug("Internal error parsing component at index " + f), null;
    }
...
var CTATMessageHandler = function() {
  ...
  var a = null, b = this, c = [], f = null, f = CTATConfig.parserType_is_XML() ? new CTATXML : new CTATJSON;
  ...
  this.parseElement = function(a) {
    var e = f.getElementName(a);
    b.ctatdebug("parseElement (" + e + ")");
    "CTATResponseMessages" != e && "StartStateMessages" != e && "MessageBundle" != e || this.processMessageBundle(a);
    "message" == e && this.processSingleMessage(a);
  };
  this.processMessageBundle = function(a) {
    var e = f.getElementName(a);
    b.ctatdebug("processMessageBundle (" + e + ")");
    a = f.getElementChildren(a);
    if (null === a) {
      b.ctatdebug("Error parsing bundle");
    } else {
      for (ctatdebug("Processing " + a.length + " objects in bundle"), e = 0;e < a.length;e++) {
        this.parseElement(a[e]);
      }
    }
  };
  this.processSingleMessage = function(d) {
    b.ctatdebug("processSingleMessage (" + f.getElementName(d) + ")");
    var e = new CTATMessage(d);
    d = f.getElementChildren(d);
    b.ctatdebug("Generated CTATMessage, now doing regular processing ...");
    for (var g = 0;g < d.length;g++) {
      var k = d[g];
      if ("properties" == f.getElementName(k)) {
        b.ctatdebug("Parsing properties ...");
        for (var l = f.getElementChildren(k), n = 0;n < l.length;n++) {
          var m = l[n];
          if ("MessageType" == f.getElementName(m)) {
            m = f.getNodeTextValue(m);
            b.ctatdebug("MessageType: " + m);
            "StateGraph" == m && this.processStateGraph(k);
            "StartProblem" == m && (b.ctatdebug("Setting inStartState to true"), inStartState = !0, this.processStartProblem(l));
            "InterfaceIdentification" == m && this.processInterfaceIdentification(l);
            "InterfaceDescription" == m && this.processInterfaceDescription(l);
            ...
            "CorrectAction" == m && (b.ctatdebug("Found: CorrectAction"), !0 === this.getInStartState() ? c.push(e) : a.processCorrectAction(e));
            "InCorrectAction" == m && (b.ctatdebug("Found: InCorrectAction"), !0 === inStartState ? c.push(e) : (b.ctatdebug("Handing incorrect message to messagehandler ..."), a.processInCorrectAction(e)));
            "HighlightMsg" == m && (b.ctatdebug("Found: HighlightMsg"), a.processHighlightMsg(e));
            "UnHighlightMsg" == m && (b.ctatdebug("Found: UnHighlightMsg"), a.processUnHighlightMsg(e));
            if ("AssociatedRules" == m) {
              b.ctatdebug("Found: AssociatedRules (" + l.length + ")");
              for (var t = "", r = "", q = 0;q < l.length;q++) {
                var u = l[q];
                "TutorAdvice" == f.getElementName(u) && (t = f.getNodeTextValue(u));
                "Actor" == f.getElementName(u) && f.getNodeTextValue(u);
                "Indicator" == f.getElementName(u) && (r = f.getNodeTextValue(u));
                "StepID" == f.getElementName(u) && f.getNodeTextValue(u);
                "LogAsResult" == f.getElementName(u) && f.getNodeTextValue(u);
                "tool_selection" == f.getElementName(u) && f.getNodeTextValue(u);
                "Skills" == f.getElementName(u) && (b.ctatdebug("Processing skills ..."), null === skillSet && (b.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."), skillSet = new CTATSkillSet), skillSet.parseByValue(u));
              }
              a.processAssociatedRules(e, r, t);
            }
            "BuggyMessage" == m && (b.ctatdebug("Found: BuggyMessage"), a.processBuggyMessage(e));
            "SuccessMessage" == m && (b.ctatdebug("Found: SuccessMessage"), a.processSuccessMessage(e));
            "InterfaceAction" == m && (b.ctatdebug("Found: InterfaceAction"), !0 === inStartState ? (b.ctatdebug("inStartState==true => storing for later playback ..."), c.push(e)) : a.processInterfaceAction(e));
            ...
            if ("ShowHintsMessage" == m) {
              ...
              for (q = 0;q < l.length;q++) {
                if (u = l[q], "HintsMessage" == f.getElementName(u)) {
                  for (var u = f.getElementChildren(u), w = 0;w < u.length;w++) {
                    var x = u[w];
                    "value" == f.getElementName(x) && (r.push(f.getNodeTextValue(x)), t = !0);
                  }
                }
              }
              !0 === t ? a.processHintResponse(e, r) : b.ctatdebug("Error: incomplete hint message received");
            }
            "ConfirmDone" == m && (b.ctatdebug("Found: ConfirmDone"), a.processConfirmDone(e));
            "VersionInfo" == m && (b.ctatdebug("Found: VersionInfo"), a.processVersionInfo(l));
            "TutoringServiceAlert" == m && (b.ctatdebug("Found: TutoringServiceAlert"), a.processTutoringServiceAlert(l));
            "TutoringServiceError" == m && (b.ctatdebug("Found: TutoringServiceError"), a.processTutoringServiceError(l));
            "ProblemSummaryResponse" == m && (b.ctatdebug("Found: ProblemSummaryResponse"), a.processProblemSummaryResponse(e));
            "ProblemRestoreEnd" == m && (b.ctatdebug("Found: ProblemRestoreEnd"), a.processProblemRestoreEnd(e));
          }
        }
      }
    }
  ...
  this.processStateGraph = function(d) {
    ...
    if (void 0 === d || null === d) {
      ...
      if (b.ctatdebug("Processing node: " + d.nodeName), null === f.getElementChildren(d)) {
        b.ctatdebug("Error: state graph property list is undefined");
      } else {
        d = f.getElementChildren(d);
        for (var e = 0;e < d.length;e++) {
          var c = d[e];
          b.ctatdebug("State graph attribute: " + f.getElementName(c));
          "caseInsensitive" == f.getElementName(c) && (caseInsensitive = "false" == f.getNodeTextValue(c) ? !1 : !0);
          "unordered" == f.getElementName(c) && (unordered = "false" == f.getNodeTextValue(c) ? !1 : !0);
          "lockWidget" == f.getElementName(c) && (lockWidget = "false" == f.getNodeTextValue(c) ? !1 : !0);
          f.getElementName(c);
          "highlightRightSelection" == f.getElementName(c) && (highlightRightSelection = "false" == f.getNodeTextValue(c) ? !1 : !0);
          "confirmDone" == f.getElementName(c) && (b.ctatdebug("Confirm done: " + f.getNodeTextValue(c)), "false" == f.getNodeTextValue(c) && (confirmDone = !1), "true" == f.getNodeTextValue(c) && (confirmDone = !0));
          "Skills" == f.getElementName(c) && (b.ctatdebug("Processing skills ..."), null === skillSet && (skillSet = new CTATSkillSet), skillSet.parseByValue(c), a.updateSkillWindow());
        }
      }
    }
  };
  ...
  this.processInterfaceDescription = function(a) {
    ...
    for (var e = "Unknown", c = "Unknown", g = null, l = 0;l < a.length;l++) {
      var n = a[l];
      b.ctatdebug("Inspecting element: " + f.getElementName(n));
      "WidgetType" == f.getElementName(n) && (b.ctatdebug("Widget type: " + f.getNodeTextValue(n)), e = f.getNodeTextValue(n));
      "CommName" == f.getElementName(n) && (b.ctatdebug("Instance name: " + f.getNodeTextValue(n)), c = f.getNodeTextValue(n));
      if ("serialized" == f.getElementName(n)) {
        b.ctatdebug("Prepareing to de-serialize component ...");
        for (var m = f.getElementChildren(n), t = 0;t < m.length;t++) {
          var r = m[t];
          -1 != f.getElementName(r).indexOf("CTAT") && (g = r);
        }
      }
    ...
    null !== g ? this.deserializeComponent(e, c, g) : b.ctatdebug("Error: unable to find CTAT serialization point of attachement");
    b.ctatdebug("processInterfaceDescription () done");
  };
  this.deserializeComponent = function(a, e, c) {
    b.ctatdebug("deserializeComponent (" + a + "," + e + ")");
    if (null === f.getElementAttr(c, "x")) {
      b.ctatdebug("Warning: this component does not have x,y information. Probably an older component");
    } else {
      var g = f.getElementAttr(c, "x"), l = f.getElementAttr(c, "y"), n = f.getElementAttr(c, "width"), m = f.getElementAttr(c, "height"), t = f.getElementAttr(c, "tabIndex"), r = f.getElementAttr(c, "zIndex");
      null === t && (t = -1);
      null === r && (r = 0);
      var q = new CTATComponentDescription;
      q.type = a;
      q.name = e;
      q.x = Math.floor(g);
      q.y = Math.floor(l);
      q.tabIndex = t;
      q.zIndex = r;
      q.width = Math.floor(n);
      q.height = Math.floor(m);
      CTATShellTools.registerComponentDescription(q);
      c = f.getElementChildren(c);
      for (g = 0;g < c.length;g++) {
        l = c[g];
        f.getElementName(l);
        if ("Parameters" == f.getElementName(l)) {
          for (this.ctatdebug("Processing component parameters ..."), n = f.getElementChildren(l)[0], n = f.getElementChildren(n), m = 0;m < n.length;m++) {
            var u = n[m];
            if ("CTATComponentParameter" == f.getElementName(u)) {
              this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");
              for (var r = t = void 0, u = f.getElementChildren(u), w = 0;w < u.length;w++) {
                var x = u[w];
                "name" == f.getElementName(x) && (this.ctatdebug("Found parameter name: " + f.getNodeTextValue(x)), t = f.getNodeTextValue(x));
                "value" == f.getElementName(x) && (this.ctatdebug("Found parameter value: " + f.getNodeTextValue(x)), r = f.getNodeTextValue(x).trim());
              }
              this.ctatdebug("Parameter name: " + t + ", value: " + r);
              void 0 !== t && (q.params[t] = r, "group" == t && (q.groupName = r));
            }
          }
        }
        if ("Styles" == f.getElementName(l)) {
          for (this.ctatdebug("Processing component styles ..."), l = f.getElementChildren(l)[0], l = f.getElementChildren(l), n = 0;n < l.length;n++) {
            if (r = l[n], "CTATStyleProperty" == f.getElementName(r)) {
              this.ctatdebug("Processing style property (CTATStyleProperty) ...");
              t = m = "";
              r = f.getElementChildren(r);
              for (u = 0;u < r.length;u++) {
                w = r[u], "name" == f.getElementName(w) && (m = f.getNodeTextValue(w)), "value" == f.getElementName(w) && (t = f.getNodeTextValue(w).trim());
              }
      ...
      b.ctatdebug("deserializeComponent (" + a + "," + e + ") done");
    }
  };
    ...
    if (0 == c.length) {
      ...
      if (0 < startStateHandlers.length) {
        ...
        for (d = 0;d < c.length;d++) {
          var e = c[d];
          b.ctatdebug("Processing startstate message type: " + e.getMessageType());
          "InterfaceAction" == e.getMessageType() && a.processInterfaceAction(e);
          "CorrectAction" == e.getMessageType() && a.processCorrectAction(e);
          "InCorrectAction" == e.getMessageType() && a.processInCorrectAction(e);
          this.sleep(1E3);
        }
        if ("" != scriptElement) {
          try {
...
var CTATCheckBox = function(a, b, c, f, g) {
  CTAT.Component.Base.Clickable.call(this, "CTATCheckBox", "__undefined__", a, b, c, f, g);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var d = null, e = null, h = null, k = "top";
  ...
  this.UpdateCheckBox = function(a) {
    d.checked = 0 <= a.search(new RegExp("(^|;)" + e.innerHTML + "\\s*:\\s*true"));
  };
  ...
  this.removeCorrect = q.bind(this, "CTAT--correct");
  this.showInCorrect = function(a) {
    q("CTAT--correct");
    q("CTAT--hint");
    r("CTAT--incorrect");
  };
  this.removeInCorrect = q.bind(this, "CTAT--incorrect");
  this.showHintHighlight = function(a) {
    q("CTAT--incorrect");
    q("CTAT--correct");
    a ? r("CTAT--hint") : q("CTAT--hint");
  };
};
...
var CTATHintWindow = function(a, b, c, f, g) {
  CTAT.Component.Base.Graphical.call(this, "CTATHintWindow", "__undefined__", a, b, c, f, g);
  this.setDefaultWidth(240);
  this.setDefaultHeight(140);
  var d = this;
  d.isTabIndexable = !1;
  var e = null, h = null, k = null, l = null, n = null;
  ...
  this.init = function() {
    ...
    l.appendChild(h);
    n ? (k = document.createElement("button"), k.classList.add("CTAT-hint-window--next"), k.innerHTML = n) : (t ? (k = document.createElementNS(CTATGlobals.NameSpace.svg, "svg"), k.classList.add("CTAT-hint-window--next"), k.setAttributeNS(null, "viewBox", "0 0 82 20"), a = document.createElementNS(CTATGlobals.NameSpace.svg, "path"), a.style.fill = "none", a.style.strokeWidth = "3px", a.style.strokeLinecap = "round", a.setAttributeNS(null, "d", "M75 10 h-12 M75 10 m-4 -4 l4 4 -4 4"), a.setAttributeNS(null, 
    "pointer-events", "none"), k.appendChild(a), a = document.createElementNS(CTATGlobals.NameSpace.svg, "text"), a.setAttributeNS(null, "pointer-events", "none"), a.textContent = "Next", a.setAttributeNS(null, "text-anchor", "middle"), a.setAttributeNS(null, "x", "34px"), a.setAttributeNS(null, "dominant-baseline", "middle"), a.setAttributeNS(null, "y", "50%")) : (k = document.createElement("button"), k.classList.add("CTAT-hint-window--next"), a = document.createElement("span"), a.style.fontWeight = 
    "bold", a.style.marginRight = "6px", a.textContent = "\u25b6", a.style.cssFloat = "right", k.appendChild(document.createTextNode("Next"))), k.appendChild(a));
  ...
  this.showHint = function(a) {
    ...
    null === a ? (hints = a, hintIndex = 0, e.innerHTML = "", h.setEnabled(!1), k.setEnabled(!1)) : (hints = a, hintIndex = 0, this.setEnabled(!0), h.setEnabled(!1), k.setEnabled(!1), hints ? "" === hints[hintIndex] ? d.ctatdebug("Empty hint in list, bump") : (e.innerHTML = hints[hintIndex], 1 < hints.length ? (d.ctatdebug("We have more than one hint, enabling next button"), k.setEnabled(!0)) : d.ctatdebug("We only have one hint, leaving next button disabled")) : d.ctatdebug("Null hint in list, bump"));
  };
  this.setEnabled = function(a) {
    d.assignEnabled(a);
...
var CTATRadioButton = function(a, b, c, f, g) {
  CTAT.Component.Base.Clickable.call(this, "CTATRadioButton", "__undefined__", a, b, c, f, g);
  this.setDefaultWidth(100);
  this.setDefaultHeight(22);
  var d = this, e = null, h = null, k = null, l = CTATRadioButton.Options.Placement.right;
  this.setSelection(this.getComponentGroup());
...
var CTATTable = function(a, b, c, f, g) {
  CTAT.Component.Base.Graphical.call(this, "CTATTable", "__undefined__", a, b, c, f, g);
  var d = this;
  d.isTabIndexable = !1;
  var e = null, h = !1;
...
var CTATCommShell = function() {
  ...
  var a = null, b = this, c = null, f = null, g = {}, d = null, e = null, h = null, k = [], f = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  this.init = function(d) {
    this.ctatdebug("init ()");
    var c = flashVars.getRawFlashVars(), e = "http://";
    "https" == c.tutoring_service_communication && (e = "https://");
    c.remoteSocketURL && -1 != c.remoteSocketURL.indexOf("http") && (e = "");
    a = d;
    ...
    this.ctatdebug("Connecting to: " + e + c.remoteSocketURL + ":" + c.remoteSocketPort);
    commLibrary.sendXMLURL(commMessageBuilder.createSetPreferencesMessage(version), e + c.remoteSocketURL + ":" + c.remoteSocketPort);
  ...
  this.focusNextComponent = function(a) {
    ...
    for (var c in CTATShellTools.component_descriptions) {
      var e = CTATShellTools.component_descriptions[c].getComponentPointer();
      null != e ? e.getTabIndex() == b && (this.ctatdebug("Found a candidate component for new focus"), d = e) : this.ctatdebug("Error: component pointer is null");
    }
    if (null == d) {
  ...
  this.processComponentAction = function(a, d, c, e) {
    ...
    var f = "", f = !1 !== d ? e.createInterfaceActionMessage(c, a) : e.createUntutoredActionMessage(c, a);
  ...
  this.processCorrectAction = function(a) {
    ...
    if (g[e] && null != d) {
      ...
      if (null != f) {
        ctatdebug("Processing " + f.length + " components ...");
        for (var k = 0;k < f.length;k++) {
          ctatdebug("Check " + f[k].getName()), f[k] ? f[k].setCorrect && f[k].setCorrect(a) : b.ctatdebug("Internal error, component pointer is null");
        }
    ...
    if (g[c] && null != d) {
      ...
      if (null != e) {
        for (c = 0;c < e.length;c++) {
          ctatdebug("Calling setIncorrect on component (" + e[c].getClassName() + ")..."), e[c].setIncorrect && e[c].setIncorrect(a);
        }
      } else {
  ...
  this.processAssociatedRules = function(a, d, c) {
    ...
    if (0 == commMessageHandler.getInStartState()) {
      ...
      null != commLoggingLibrary ? commLoggingLibrary.logTutorResponse(a.getTransactionID(), logHintSAI, e, "", f, c, k, d, g) : this.ctatdebug("Info: no logging library available!");
    } else {
      b.updateSkillWindow(null);
    }
  ...
  this.processTutoringServiceAlert = function(a) {
    ...
    for (var d = "", c = 0;c < a.length;c++) {
      var e = a[c];
      "ErrorType" == f.getElementName(e) && f.getNodeTextValue(e);
      "Details" == f.getElementName(e) && (d = f.getNodeTextValue(e));
    }
  ...
  this.processTutoringServiceError = function(a) {
    ...
    for (var d = "", c = "", e = 0;e < a.length;e++) {
      var g = a[e];
      "ErrorType" == f.getElementName(g) && (d = f.getNodeTextValue(g));
      "Details" == f.getElementName(g) && (c = f.getNodeTextValue(g));
    }
    CTATScrim.scrim.scrimDown();
    ...
    if (null != c) {
      if (c = c.getSelection(), null != c) {
        if (b.ctatdebug("Highlighting selection for hint: " + c), c = CTATShellTools.findComponent(c), null != c) {
          for (var e = 0;e < c.length;e++) {
            1 == detailedFeedback && c[e].setHintHighlight && c[e].setHintHighlight(!0, null, a);
          }
        } else {
  ...
  this.showHighlightSelection = function(a, d) {
    ...
    if (null != c) {
      for (var e = 0;e < c.length;e++) {
        1 == detailedFeedback && c[e].setHintHighlight(!0, null, d);
      }
    } else {
      b.ctatdebug("Unable to find component name in list: " + c);
    }
...
var CTATDoneButton = function(a, b, c, f, g) {
  CTAT.Component.Base.Clickable.call(this, "done", "CTATDoneButton", a, b, c, f, g);
  this.setName("done");
...
var CTATHintButton = function(a, b, c, f, g) {
  CTAT.Component.Base.Clickable.call(this, "hint", "CTATHintButton", a, b, c, f, g);
  this.setName("hint");
...
CTATTutor.createStaticInterface = function(a, b, c) {
  ...
  for (a = 0;a < b.length;a++) {
    ...
    var e, h, k, l;
    "shape" == this.parser.getElementName(g) && (e = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), k = this.parser.getElementAttr(g, "width"), l = this.parser.getElementAttr(g, "height"), d = this.parser.getElementAttr(g, "instance"), ctatdebug("Creating shape: " + d + " at: " + e + "," + h + "," + k + "," + l), k = "data:image/png;base64, " + this.parser.getNodeTextValue(g), l = new Image, l.setAttribute("style", "position: absolute; top: " + h + "px; left:" + e + "px; z-index:" + 
    CTATGlobalFunctions.gensym.z_index() + ";"), l.setAttribute("id", d), l.setAttribute("src", k), f.appendChild(l));
    "statictext" == this.parser.getElementName(g) && (e = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), k = this.parser.getElementAttr(g, "width"), l = this.parser.getElementAttr(g, "height"), d = this.parser.getElementAttr(g, "instance"), ctatdebug("Creating static text: " + d + " at: " + e + "," + h + "," + k + "," + l), k = "data:image/png;base64, " + this.parser.getNodeTextValue(g), l = new Image, l.setAttribute("style", "position: absolute; top: " + h + "px; left:" + 
    e + "px; z-index:" + CTATGlobalFunctions.gensym.z_index() + ";"), l.setAttribute("id", d), l.setAttribute("src", k), f.appendChild(l));
    "statictext" == this.parser.getElementName(g) && (d = this.parser.getElementAttr("instance"), ctatdebug("Creating movieclip: " + d), e = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), k = this.parser.getElementAttr(g, "width"), l = this.parser.getElementAttr(g, "height"), e = new CTATMovieClip(d, e, h, k, l), h = e.wrapComponent(f), ctatdebug("Created movieclip: " + d + " at: " + e.x + "," + e.y + "," + e.width + "," + e.height), movieclips.push(e), g = this.parser.getElementChildren(g), 
    this.createStaticInterface(h, g, e));
  }
};
CTATTutor.runTutor = function(a) {
  ctatdebug("runTutor ()");
  !0 === CTATGlobals.tutorRunning ? ctatdebug("The tutor is already running") : (skillSet = new CTATSkillSet, null == flashVars && (flashVars = new CTATFlashVars, flashVars.assignRawFlashVars(a)), window.onerror = function(a, c, f) {
    var g = new CTATHTMLManager;
    ctatdebug(g.htmlEncode(a) + " in " + c + ", line " + f);
  }, centerTutorContainer(), CTATTutor.initialize(), CTATGlobals.tutorRunning = !0, ctatdebug("runTutor () ... all set"));
};
function initTutor(a, b, c, f) {
  ctatdebug("initTutor() #FlashVars " + (a ? a.length : null) + ", usingFlash " + f);
...
function centerTutorContainer() {
  ...
  if (null == a) {
    ...
    var b = null;
    if (flashVars) {
      var b = flashVars.getRawFlashVars(), c = "550", f = "450", c = a.offsetWidth, f = a.offsetHeight;
      b && b.width && b.height && (ctatdebug("We have raw width and height variables in our flashvars: " + b.width + "," + b.height), c = b.width, f = b.height);
      b.centerTutor ? 1 == b.centerTutor && (ctatdebug("Moving tutor over by: " + ("-" + Number(c / 2) + "px 0 0 -" + Number(f / 2) + "px;")), a.style.position = "absolute", a.style.top = "0", a.style.left = "0", a.style.right = "0", a.style.bottom = "0", a.style.margin = "auto") : ctatdebug("The tutor is not configured to center the container, bump");
    } else {
...
function checkTutorCanvas() {
  ...
  var a = getSafeElementById(ctatcontainer), b = getSafeElementById("main-canvas"), c = flashVars.getRawFlashVars(), f = "550", g = "450";
  a && (ctatdebug("Recording the actual CSS width and height: " + a.offsetWidth + " , " + a.offsetHeight), f = a.offsetWidth, g = a.offsetHeight);
  c && c.width && c.height && (ctatdebug("We have tutor size flashvars, using those instead: " + c.width + " , " + c.height), f = c.width, g = c.height);
...
Math.imul || (Math.imul = function(a, b) {
  var c = a & 65535, f = b & 65535;
  return c * f + ((a >>> 16 & 65535) * f + c * (b >>> 16 & 65535) << 16 >>> 0) | 0;
});
...
Array.prototype.lastIndexOf || (Array.prototype.lastIndexOf = function(a) {
  ...
  var b, c = Object(this), f = c.length >>> 0;
  if (0 === f) {
    return -1;
  }
  b = f - 1;
...
Array.prototype.every || (Array.prototype.every = function(a, b) {
  ...
  for (f = 0;f < d;) {
    var e;
    if (f in g && (e = g[f], !a.call(c, e, f, g))) {
      return !1;
    }
    f++;
  }
...
Array.prototype.some || (Array.prototype.some = function(a) {
  ...
  for (var f = 2 <= arguments.length ? arguments[1] : void 0, g = 0;g < c;g++) {
...
Array.prototype.filter || (Array.prototype.filter = function(a) {
  ...
  for (var f = [], g = 2 <= arguments.length ? arguments[1] : void 0, d = 0;d < c;d++) {
    if (d in b) {
      var e = b[d];
      a.call(g, e, d, b) && f.push(e);
    }
  }
  return f;
});
...
Array.prototype.map || (Array.prototype.map = function(a, b) {
  ...
  for (g = 0;g < e;) {
    var h;
    g in d && (h = d[g], h = a.call(c, h, g, d), f[g] = h);
    g++;
  }
  return f;
});
Array.prototype.reduce || (Array.prototype.reduce = function(a) {
  ...
  var b = Object(this), c = b.length >>> 0, f = 0, g;
...
Array.prototype.reduceRight || (Array.prototype.reduceRight = function(a) {
  ...
  var b = Object(this), c = (b.length >>> 0) - 1, f;
  if (2 <= arguments.length) {
    f = arguments[1];
  } else {
    for (;0 <= c && !c in b;) {
...
Array.from || (Array.from = function() {
  ...
  return function(a) {
    ...
    for (var k = b(this) ? Object(new this(h)) : Array(h), l = 0, n;l < h;) {
      n = g[l], k[l] = d ? "undefined" === typeof e ? d(n, l) : d.call(e, n, l) : n, l += 1;
    }
    k.length = h;
    return k;
  };
...
Array.prototype.copyWithin || (Array.prototype.copyWithin = function(a, b, c) {
  ...
  for (;0 < g;) {
    b in f ? f[a] = f[b] : delete f[a], b += c, a += c, g--;
  }
  return f;
});
...
Array.prototype.find || (Array.prototype.find = function(a, b) {
  ...
  for (var c = Object(this), f = c.length >>> 0, g, d = 0;d < f;d++) {
...
Array.prototype.includes || (Array.prototype.includes = function(a, b) {
  var c = Object(this), f = parseInt(c.length) || 0;
  if (0 === f) {
    return !1;
  }
  var g = parseInt(b) || 0;
...
String.fromCodePoint || function() {
  var a = function() {
    ...
    return c;
  }(), b = String.fromCharCode, c = Math.floor, f = function() {
    var a = [], d, e, f = -1, k = arguments.length;
    if (!k) {
      return "";
    }
    for (var l = "";++f < k;) {
      e = Number(arguments[f]);
      if (!isFinite(e) || 0 > e || 1114111 < e || c(e) != e) {
        throw RangeError("Invalid code point: " + e);
      }
      65535 >= e ? a.push(e) : (e -= 65536, d = (e >> 10) + 55296, e = e % 1024 + 56320, a.push(d, e));
...
String.prototype.codePointAt || function() {
  var a = function(a) {
    ...
    var c = String(this), f = c.length, g = a ? Number(a) : 0;
    g != g && (g = 0);
    if (!(0 > g || g >= f)) {
      return a = c.charCodeAt(g), 55296 <= a && 56319 >= a && f > g + 1 && (c = c.charCodeAt(g + 1), 56320 <= c && 57343 >= c) ? 1024 * (a - 55296) + c - 56320 + 65536 : a;
    }
  };
...
(function(a) {
  ...
  var f = /[^s]/, g = /[def]/, d = /^[^\x25]+/, e = /^\x25{2}/, h = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/, k = /^([a-z_][a-z_\d]*)/i, l = /^\.([a-z_][a-z_\d]*)/i, n = /^\[(\d+)\]/, m = /^[\+\-]/;
  b.format = function(a, d) {
    var e = 1, h = a.length, k = "", l = [], n, t, y, v, D = !0, A = "";
    for (n = 0;n < h;n++) {
      if (k = c(a[n]), "string" === k) {
        l[l.length] = a[n];
      } else {
        if ("array" === k) {
          y = a[n];
          if (y[2]) {
            for (k = d[e], t = 0;t < y[2].length;t++) {
              if (!k.hasOwnProperty(y[2][t])) {
                throw Error(b("[sprintf] property '%s' does not exist", y[2][t]));
              }
              k = k[y[2][t]];
            }
          } else {
          ...
          "function" == c(k) && (k = k());
          if (f.test(y[8]) && "number" != c(k) && isNaN(k)) {
          ...
          if (!D || g.test(y[8]) && y[3]) {
            A = D ? "+" : "-", k = k.toString().replace(m, "");
          }
          t = y[4] ? "0" == y[4] ? "0" : y[4].charAt(1) : " ";
          v = y[6] - (A + k).length;
          v = y[6] ? Array(v + 1).join(t) : "";
          l[l.length] = y[5] ? A + k + v : 0 == t ? A + v + k : v + A + k;
        }
      }
    }
    return l.join("");
...
CTATMsgType.findProperty = function(a, b) {
  var c = a.toLowerCase(), f = "<" + b.toLowerCase() + ">", g = c.indexOf(f) + f.length, c = c.indexOf("</" + b.toLowerCase() + ">");
  if (g < f.length || 0 > c) {
    return null;
  }
  f = {};
...
CTATMsgType.makeValues = function(a) {
  ...
  if (a.constructor && "Array" == a.constructor.name) {
    ...
    for (var b = 0, c, f = "<value>" + (null == (c = a[b++]) ? "" : c.toString());b < a.length;) {
      f += "</value><value>" + (null == (c = a[b++]) ? "" : c.toString());
    }
    return f + "</value>";
  }
...
CTATMsgType.setProperty = function(a, b, c) {
  ...
  f ? (g = a.slice(0, f.start), g += CTATMsgType.makeValues(c), g += a.slice(f.end, a.length)) : (f = a.indexOf("</properties>"), g = a.slice(0, f), g += "<" + b + ">" + CTATMsgType.makeValues(c) + "</" + b + ">", g += a.slice(f, a.length));
  return g;
};
...
CTATMsgType.getSAIArraysFromElement = function(a, b) {
  for (var c = {selection:[], action:[], input:[]}, f = b.getElementChildren(a), g = 0;g < f.length;g++) {
    var d = f[g];
    switch(b.getElementName(d)) {
      case "Selection":
        for (var d = b.getElementChildren(d), e = 0;e < d.length;e++) {
          c.selection.push(b.getNodeTextValue(d[e]));
        }
        break;
      case "Action":
        d = b.getElementChildren(d);
        for (e = 0;e < d.length;e++) {
          c.action.push(b.getNodeTextValue(d[e]));
        }
        break;
      case "Input":
        d = b.getElementChildren(d);
        for (e = 0;e < d.length;e++) {
          c.input.push(b.getNodeTextValue(d[e]));
        }
        break;
      case "properties":
  ...
  this.put = function(a, g) {
    ...
    if (0 > a.indexOf(".")) {
      ...
      for (var h = 1;h < e.length - 1;h++) {
        if ("object" !== typeof d[e[h]] || null === d[e[h]]) {
          d[e[h]] = {}, d = d[e[h]];
        }
      }
      d[e[h]] = g;
...
var CTATVersionComparator = function() {
  ...
  this.compare = function(a, b) {
    ...
    var c = 0, f = a.split("."), g = b.split("."), d;
    for (d = 0;d < Math.min(f.length, g.length);d++) {
      try {
        var e = parseInt(f[d]), h = parseInt(g[d]), c = e < h ? -1 : e > h ? 1 : 0;
        if (0 !== c) {
          return c;
        }
      } catch (k) {
        if (c = f[d].toString() < g[d].toString() ? -1 : f[d].toString() > g[d].toString() ? 1 : 0, 0 !== c) {
          return c;
        }
      }
    }
    return d < f.length ? 1 : d < g.length ? -1 : a.toString() < b.toString() ? -1 : a.toString() > b.toString() ? 1 : 0;
  };
};
...
var CTATMatcher = function(a, b, c) {
  ...
  var f = new CTATSAI("", "", ""), g = c, d = CTATMsgType.DEFAULT_ACTOR, e = !1, h = this;
...
var CTATExampleTracerSkill = function(a, b, c, f, g, d) {
  CTATBase.call(this, "CTATExampleTracerSkill", b);
  var e = null == a || "" == a.trim() ? b : b + " " + a, h = f, k = 0, l = 0, n = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, m = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, t = null, r = this;
  this.getSkillName = function() {
    return e;
  };
  this.getCategory = function() {
    var a = e.indexOf(" ");
    return 0 > a ? "" : e.substring(a + 1);
  };
  ...
  this.toXML = function(a) {
    var b;
    b = "" + (' name="' + CTATExampleTracerSkill.getName(e) + '"');
  ...
  this.getLabel = function() {
    return null === t || "undefined" === typeof t || 1 > t.length ? CTATExampleTracerSkill.getName(e) : t;
  };
  ...
  CTATExampleTracerSkill.makeStepID = function(a, b) {
    for (var d = "", c = 0, e = a;2 > c++;e = b) {
      if (!(null === e || "undefined" === typeof e || 1 > e.length)) {
        for (var f = !1, g = 0;g < e.length;g++) {
          if (null !== e[g] && "undefined" !== typeof e[g]) {
            var h = e[g].toString();
            1 > h.length || e === a && ("hint".toString().toUpperCase() === h.toString().toUpperCase() || "help".toString().toUpperCase() === h.toString().toUpperCase()) || e === b && CTATMsgType.PREVIOUS_FOCUS.toString().toUpperCase() === h.toString().toUpperCase() || (d = d + (f ? "," : "[") + h, f = !0);
          }
        }
        !0 === f && (d += "]");
      }
  ...
  CTATExampleTracerSkill.updatePKnownStatic = function(a, b, d, c, e) {
    var f = 0;
    if (a.toString().toUpperCase() === CTATExampleTracerSkill.CORRECT.toString().toUpperCase()) {
      b = +(b * (1 - d)).toFixed(2), d = +(d * (1 - c)).toFixed(2), f = +(d / (d + b)).toFixed(2);
    } else {
      if (a.toString().toUpperCase() === CTATExampleTracerSkill.INCORRECT.toString().toUpperCase() || a.toString().toUpperCase() === CTATExampleTracerSkill.HINT.toString().toUpperCase()) {
        c = +(d * c).toFixed(2), d = +((1 - d) * (1 - b)).toFixed(2), f = +(c / (c + d)).toFixed(2);
      }
    }
...
var CTATSkills = function(a) {
  ...
  this.toXML = function(a, c) {
    ...
    for (l in b) {
      b.hasOwnProperty(l) && b[l] && (f += c + b[l].toXML(a));
    }
    f += c && f.length > g ? "\n" : "";
  ...
  this.updateSkill = function(a, b, h) {
    ...
    null !== l && "undefined" !== typeof l && (l.setTransactionNumber(c), b = h + " " + b, f.has(b) || (f.add(b), l.updatePKnown(a), l.changeOpportunityCount(1)), CTATExampleTracerSkill.CORRECT.toString().toUpperCase() === a.toString().toUpperCase() && f.delete(b), k = l);
    return k;
  };
  ...
  this.getSkillBarVector = function(a, e) {
    var f = [], g;
    for (g in b) {
      !0 === b.hasOwnProperty(g) && (!0 !== e && b[g].getTransactionNumber() !== c || f.push(b[g].getSkillBarString(a)));
    }
    return f;
  };
...
var CTATDefaultLinkGroup = function(a, b, c, f) {
  ...
  this.getIsOrdered = function() {
    m.ctatdebug("CTATDefaultLinkGroup --\x3e in getIsOrdered: " + d);
    return d;
  };
...
var CTATExampleTracerNode = function(a, b) {
  ...
  var c = null, f = "", g = b ? b : new Set, d = new Set, e = this;
  this.toString = function() {
    return "node" + a;
  };
  ...
  this.setNodeName = function(a) {
    e.ctatdebug("CTATExampleTracerGraph --\x3e in setNodeName(" + a + ")");
    f = a;
  };
...
var CTATExampleTracerPathComparator = function() {
  ...
  this.compare = function(b, c) {
    ...
    var f = b.getNumberOfPreferredPrefixLinks(), g = c.getNumberOfPreferredPrefixLinks();
    if (f > g) {
      return -1;
    }
    if (f < g) {
  ...
  this.breakByLowerLinkID = function(b, c) {
    ...
    var f = b.getSortedLinks(), g = c.getSortedLinks(), d = null, e = null, h = 0, k = 0;
    do {
      a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID in do while"), k >= f.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 1 is shorter"), h = -1) : k >= g.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 2 is shorter"), h = 1) : (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path are same, compare IDS"), d = f[k], e = g[k]), k++;
    } while (0 === h && d.getUniqueID() === e.getUniqueID());
    0 === h && (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID result is zero: " + d.getUniqueID()), a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID result is zero: " + e.getUniqueID()), h = d.getUniqueID() < e.getUniqueID() ? -1 : 1);
    return h;
  };
};
...
var CTATProblemSummary = function(a, b, c) {
  ...
  var f = Number.MAX_VALUE, g = b, d = 0, e = new Date, h = {}, k = 0, l = 0, n = 0, m = 0, t = 0, r = 0, q = 0, u = CTATMsgType.CompletionValue[0], w = this;
  ...
  this.toXML = function(b) {
    ...
    c += ' TimeElapsed="' + d + '"';
    var e = w.getSkills() ? w.getSkills().toXML(b) : "";
    return b ? "&lt;ProblemSummary" + c + "&gt;" + e + "&lt;/ProblemSummary&gt;" : "<ProblemSummary" + c + ">" + e + "</ProblemSummary>";
  };
  ...
  this.addError = function(a) {
    ...
    var b = h[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && ++q, b.incrementErrors()) : (b = new CTATStep(a, CTATStep.StepResult[1]), h[a] = b, q++);
    n++;
  ...
  this.addCorrect = function(a) {
    ...
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++t, 1 > b.getNFirstHints() && r++), b.incrementNCorrect()) : (w.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), h[a] = b, t++, r++);
    k++;
  ...
  this.setCompletionStatus = function(a, b) {
    ...
    if (CTATMsgType.CompletionValue[1] != u || b) {
      u = a;
    }
  };
...
var CTATDefaultGroupModel = function() {
  ...
  function c(a, b) {
    ...
    var d = null, c = !1, e = null;
    k.getGroupSubgroups(b).forEach(function(b) {
      !0 !== c && !0 === k.isLinkInGroup(b, a) && (d = k.getImmediateGroupOfLink(a, b), e = null !== d && "undefined" !== typeof d ? d : b, c = !0);
    });
    return !0 === c ? e : null;
  }
  function f(a, b) {
    ...
    b.forEach(function(e) {
      if (!0 !== d) {
        ...
        k.getGroupSubgroups(a).forEach(function(g) {
          !0 !== d && !0 === k.isLinkInGroup(g, e) && (k.getGroupLinkCount(g) >= b.size ? (c = f(g, b), d = !0) : k.getGroupLinks(g).forEach(function(d) {
            if (!1 === b.has(d)) {
              throw new CTATExampleTracerException("Invalid link selection: Partial overlap with existing group: " + a);
            }
          }));
  ...
  function g(a, b) {
    ...
    k.getGroupSubgroups(a).forEach(function(c) {
      ...
      if (0 === e.size) {
        ...
        !0 === k.isLinkInGroup(b, f) && (k.getGroupSubgroups(a).delete(c), d(b, c));
      }
    });
    d(a, b);
  }
  ...
  this.getGroupsContainingLink = function(a) {
    ...
    var b = new Set, d = new CTATGroupIterator(e);
  ...
  this.getGroupByName = function(a) {
    ...
    for (var b = new CTATGroupIterator(e), d = b.next();!d.done;d = b.next()) {
...
var ProblemStateSaver = function(a) {
  ...
  this.tracer = a;
  var b = this, c = [], f = "", g = "", d = null, e = 0;
  this.saveAsYouGo = function(h) {
    b.ctatdebug("saveAsYouGo() curriculum_service_url " + f + ", tracer " + a);
    if (f && a) {
      var k = {};
      if (CTATBase.inOLI()) {
        var l = h.getRequiredSteps(), n = h.getCorrect();
        0 == l ? (console.log("WARNING problem summary number of required steps is 0\n" + h.toXML(!1)), k.percentScore = 100, k.completed = !0) : (k.percentScore = Math.round(100 * n / l), k.completed = n >= l);
      } else {
      ...
      ++e;
      b.ctatdebug("saveAsYouGo[" + e + "] to send problem_state length " + k.problem_state.length);
      if (CTATBase.inXBlock()) {
        ...
        if (CTATBase.inOLI()) {
          ...
          k = h.join("&");
          d.send_post(f, k);
          b.ctatdebug("saveAsYouGo[" + e + "] sent problemState.length " + c.length);
        }
      }
    }
  };
...
ProblemStateSaver.prototype.editForProblemState = function(a) {
  for (var b = a.split(ProblemStateSaver.XML_PROLOGUE), c = b[0], f = 1;f < b.length;++f) {
    c += b[f];
  }
  b = c.split(ProblemStateSaver.LEADING_WHITE_SPACE);
  c = b[0];
  for (f = 1;f < b.length;++f) {
    c.endsWith("\n") && (c = c.slice(0, -1)), c.endsWith("\r") && (c = c.slice(0, -1)), c += "<" + b[f];
  }
...
ProblemStateSaver.prototype.forwardToInterface = function(a, b, c) {
  ...
  this.ctatdebug("PSS.forwardToInterface(" + f + ") problemState.length " + this.getProblemState().length + ", outputStatus " + c);
...
var ProblemStateRestorer = function(a) {
  ...
  this.retrieveMessages = function(f) {
    b.ctatdebug("TODO ProblemStateRestorer.retrieveMessages(" + f + ", ...)");
    if (f.mustRetrieveProblemState()) {
      if (a.setWorking(1, !0), CTATBase.inOLI()) {
        oliDriver.registerClientHandler(b), oliComm.loadFileRecord(a.getQuestionFile());
      } else {
        if (CTATBase.inXBlock()) {
          f = getVariable("saveandrestore"), process(f);
        } else {
    ...
    if ("string" != typeof c) {
      ...
      if (c.slice(0, ProblemStateSaver.MESSAGES_TAG.length) != ProblemStateSaver.MESSAGES_TAG) {
        ...
        if ("string" == typeof c && (c = c.split(/<\/?messages>/), b.ctatdebug("msgsArr.length " + c.length + ", msgsArr[1].length " + (c[1] ? c[1].length : -1)), !(2 > c.length))) {
          ...
          for (var d = 0, e = !1, h = 1;h < c.length;++h) {
            var k = "<message>" + c[h], l = CTATMsgType.getMessageType(k);
            CTATMsgType.STATE_GRAPH == l ? e = !0 : CTATMsgType.START_STATE_END == l ? e = !1 : e ? d++ : (a.getProblemStateSaver().appendToProblemState(k, null, !0), g.push(k));
            b.ctatdebug("problemStateArr[" + h + "] " + (e ? "omit " : "keep ") + l + " omitted " + d + " kept " + g.length);
          }
        }
...
(function() {
  var a, b, c, f, g, d, e, h, k, l, n, m = [].slice;
  g = /^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;
  f = /^\d+(\.\d\d)?$/;
  d = /((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?/g;
  l = /^[+-]?((\d+)\.?(\d+)?|\.(\d+))([Ee]([+-]?\d+))?$/;
  ...
  n = function(a, b) {
    ...
    null == b && (b = !1);
    var c, e, f, g;
    f = null != (d = a[4]) ? d : a[2] + (a[3] || "");
    g = [];
    c = 0;
    for (e = f.length;c < e;c++) {
      d = f[c], (b || (b = "0" !== d)) && g.push(d);
    }
    return g.length;
  };
  c = function(a) {
  ...
  b = function(a, b, d) {
    var c, e;
    return isNaN(c = +a) || isNaN(e = +b) ? d(String(a).toLowerCase(), String(b).toLowerCase()) : d(c, e);
  };
  a = function() {
    function a() {
    }
    ...
    a.matchWithPrecision = function(a, d) {
      var c, e;
      return (c = String(a).match(l)) && (e = String(d).match(l)) && n(c) === n(e) && b(a, d, function(a, b) {
        return a === b;
      });
    };
    a.matchWithoutPrecision = function(a, d) {
      var e, f;
      return (e = String(a).match(l)) && (f = String(d).match(l)) && (a = n(e) > n(f) ? (+a).toFixed(c(f)) : String(a)) && b(a, d, function(a, b) {
        return a === b;
      });
    };
    ...
    a.pointInRange = function(a, b, d, c, e) {
      var f, g, h;
      if (f = null != b ? "function" === typeof b.match ? b.match(k) : void 0 : void 0) {
        e = [f[1], f[8], d, c], b = e[0], d = e[1], c = e[2], e = e[3];
      }
      null == c && (c = 0);
      null == e && (e = c);
      return (f = a.match(k)) && b - c <= (g = f[1]) && g <= +b + +c && d - e <= (h = f[8]) && h <= +d + +e;
    };
    a.plural = function(a, b, d, c) {
      ...
      null == d && (d = h.test(f = b.toLowerCase()) ? "y" : "");
      if (!b.endsWith(d)) {
        return b;
      }
      null == c && (c = h.test(f) ? "ies" : e.test(f) ? "es" : "s");
    ...
    a.columnCell = function(a, b, d, c, e, f, g, h, k, l) {
      switch(k) {
        case "r1c1":
        ;
        case "r2c1":
    ...
    a.assign = function(a, b) {
      ...
      c = a.split(".");
      e = 2 <= c.length ? m.call(c, 0, d = c.length - 1) : (d = 0, []);
      f = c[d++];
      d = 0;
      for (g = e.length;d < g;d++) {
        c = e[d], h = null != h[c] ? h[c] : h[c] = {};
      }
      return h[f] = b;
    };
    return a;
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.setParens = function(c, f) {
      var g;
      null == f && (f = !1);
    ...
    a.prototype.simplifyNode = function(a) {
      ...
      for (b = d.length;a < b;a++) {
        g = d[a], e = e[g].call(e), e.methods = this.methods;
      }
      delete e.methods;
      return e;
    };
    ...
    a.prototype.compare = function(c, f) {
  ...
  a = function(a) {
    ...
    c.prototype.combineSimilar = function() {
      ...
      this.terms.forEach(function(b) {
        ...
        })) ? c[1] += f[1].evaluate() : a.push([f[0], f[1].evaluate()]);
      });
    ...
    c.prototype.compare = function(a, b) {
      var f;
      return (f = c.__super__.compare.apply(this, arguments)) || this.countVariables() - a.countVariables() || this.terms.some(function(c, g) {
        return f = c.compare(a.terms[g], b);
  ...
  a = function(a) {
    ...
    c.prototype.toString = function() {
      return c.__super__.toString.call(this, this.factors.reduce(function(a) {
        return function(b, c) {
          var f;
          c.setParens(a.operator);
          f = c.inverted() ? (c.invert(), "/") : /^\d/.test(c = c.toString()) && /\d$/.test(b) ? "*" : "";
          return "" + b + f + c;
        };
    ...
    c.prototype.combineSimilar = function() {
      ...
      this.factors.forEach(function(b) {
        ...
        })) ? c[1] += (null != (f = n[1]) ? f.evaluate() : void 0) || 1 : a.push([n[0], (null != (g = n[1]) ? g.evaluate() : void 0) || 1]);
      });
    ...
    c.prototype.distributeFactors = function(a) {
      ...
      a.slice(1).forEach(function(a) {
        ...
        return a.addition() ? 1 === b.length ? b = a.terms.map(function(a) {
          ...
          var f;
          return a.multiplication() ? (f = b[c]).push.apply(f, a.pushNegation().factors.map(function(a) {
            return a.clone();
          })) : b[c].push(a.clone());
        });
      });
    ...
    c.prototype.compare = function(a, b) {
      var f, k;
      return (k = c.__super__.compare.apply(this, arguments)) || this.countVariables() - a.countVariables() || (f = a.factors.slice(0).reverse()) && this.factors.slice(0).reverse().some(function(a, d) {
        return k = a.compare(f[d], b);
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, c = [1, 6], f = [1, 7], g = [1, 10], d = [1, 11], e = [1, 12], h = [1, 13], k = [1, 21], l = [1, 22], n = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], m = [1, 23], t = [1, 24], r = [1, 26], q = [1, 27], u = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], w = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:c, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:k, 15:l}, b(n, [2, 11], {22:9, 19:25, 16:m, 18:t, 20:r, 21:q, 24:g, 25:d, 27:e, 28:h}), b(u, [2, 17]), {13:c, 15:f, 17:28, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, {13:c, 15:f, 17:29, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, b(u, [2, 20]), b(u, [2, 23], {23:[1, 30]}), {13:c, 15:f, 17:31, 19:8, 22:9, 24:g, 25:d, 27:e, 
  28:h}, {6:32, 13:c, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, b(w, [2, 25]), b(w, [2, 26]), {1:[2, 1]}, {6:33, 13:c, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, {6:34, 13:c, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, {6:35, 13:c, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, {6:36, 13:c, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, {6:37, 13:c, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, {6:38, 13:c, 14:4, 15:f, 17:5, 19:8, 22:9, 
  24:g, 25:d, 27:e, 28:h}, {13:c, 14:39, 15:f, 17:5, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, {13:c, 14:40, 15:f, 17:5, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, {13:c, 15:f, 17:41, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, {13:c, 15:f, 17:42, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, b(u, [2, 14]), {13:c, 15:f, 17:43, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, {13:c, 15:f, 17:44, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, b(u, [2, 18]), b(u, [2, 19]), {13:c, 15:f, 17:45, 19:8, 22:9, 24:g, 25:d, 27:e, 28:h}, b(u, [2, 22]), {13:k, 
  15:l, 26:[1, 46]}, {5:[2, 2], 13:k, 15:l}, {5:[2, 3], 13:k, 15:l}, {5:[2, 4], 13:k, 15:l}, {5:[2, 5], 13:k, 15:l}, {5:[2, 6], 13:k, 15:l}, {5:[2, 7], 13:k, 15:l}, b(n, [2, 9], {22:9, 19:25, 16:m, 18:t, 20:r, 21:q, 24:g, 25:d, 27:e, 28:h}), b(n, [2, 10], {22:9, 19:25, 16:m, 18:t, 20:r, 21:q, 24:g, 25:d, 27:e, 28:h}), b(u, [2, 12]), b(u, [2, 13]), b(u, [2, 15]), b(u, [2, 16]), b(u, [2, 21]), b(w, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      throw Error(a);
    ...
    var b = [0], c = [null], d = [], e = this.table, f = "", g = 0, h = 0, k = 0, l = d.slice.call(arguments, 1), n = Object.create(this.lexer), m = {}, t;
    for (t in this.yy) {
      Object.prototype.hasOwnProperty.call(this.yy, t) && (m[t] = this.yy[t]);
    }
    n.setInput(a, m);
    m.lexer = n;
    m.parser = this;
    ...
    for (var r, u, w, I, M = {}, N, J;;) {
      ...
      if ("undefined" === typeof I || !I.length || !I[0]) {
        ...
        O = n.showPosition ? "Parse error on line " + (g + 1) + ":\n" + n.showPosition() + "\nExpecting " + J.join(", ") + ", got '" + (this.terminals_[r] || r) + "'" : "Parse error on line " + (g + 1) + ": Unexpected " + (1 == r ? "end of input" : "'" + (this.terminals_[r] || r) + "'");
        this.parseError(O, {text:n.match, token:this.terminals_[r] || r, line:n.yylineno, loc:t, expected:J});
      }
      ...
      switch(I[0]) {
        case 1:
          ...
          b.push(I[1]);
          r = null;
          u ? (r = u, u = null) : (h = n.yyleng, f = n.yytext, g = n.yylineno, t = n.yylloc, 0 < k && k--);
          break;
        case 2:
          ...
          q && (M._$.range = [d[d.length - (J || 1)].range[0], d[d.length - 1].range[1]]);
          w = this.performAction.apply(M, [f, h, g, m, I[1], c, d].concat(l));
...
(function() {
  ...
  a = function() {
    ...
    a.prototype.algPartialEquivalent = function(c, f) {
      var g, d, e, h;
      if (null == (null != (g = e = this.algParse(c)) ? g.simplify(a.partial) : void 0) || null == (null != (d = h = this.algParse(f)) ? d.simplify(a.partial) : void 0) || !e.equals(h)) {
        return null;
      }
    };
    a.prototype.algEquivalent = function(c, f) {
      var g, d, e, h;
      if (!(null != (g = e = this.algParse(c)) && g.simplify(a.partial) && null != (d = h = this.algSimplify(f)) && d.simplify(a.partial) && e.equals(h))) {
        return null;
      }
    };
    ...
    a.prototype.polyTermsEqual = function(c, f) {
      return this.parser.parse(c).simplify(a.partial).equals(this.parser.parse(f).simplify(a.partial));
    };
...
(function() {
  var a, b, c, f = [].slice, g = [].indexOf || function(a) {
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, d, k, l) {
      var n, m, t, r, q, u, w, x;
      try {
        q = "undefined" !== typeof window && null !== window ? window : global;
        n = function() {
          var a;
          a = [];
          for (t in q) {
        ...
        w = null != (u = a.match(b)) ? u : [];
        m = 0;
        for (r = w.length;m < r;m++) {
          t = w[m], 0 > g.call(c, t) && CTATFormulaFunctions.assign(t, void 0);
        }
        for (t in x = this.variableTable.getTable()) {
          q[t] = x[t];
        }
        ...
        }).apply(q, [d, k, l].concat(f.call(this.values)));
      } catch (B) {
        return console.log(B), null;
      } finally {
        for (t in q) {
          null != t && 0 > g.call(n, t) && (x[t] = q[t], delete q[t]);
        }
      }
    };
    ...
    a.prototype.interpolate = function(a, b, c, d) {
      ...
      for (t = r.length;g < t;a = ++g) {
        f = r[a], q.push(a % 2 ? this.evaluate(f, b, c, d) : f);
      }
      return q.join("");
    };
    return a;
...
var CTATExampleTracerLink = function(a, b, c) {
  ...
  var f = "undefined" === typeof a || null === a ? null : a, g = null, d = "undefined" === typeof b || null === b ? null : b, e = "undefined" === typeof c || null === c ? null : c, h = null, k = 1, l = 1, n = "CORRECT_ACTION", m = [], t = !1, r = null, q = "", u = null, w = null, x = this;
  ...
  this.setIsPreferredLink = function(a) {
    x.ctatdebug("ETLink.setIsPreferredLink() was " + t + ", now " + a);
    t = a;
  };
  this.setVisualData = function(a) {
    u = a;
...
var CTATSingleMatcher = function(a, b) {
  ...
  this.setSingle = function(a) {
    null === a || "undefined" === typeof a ? c.ctatdebug('CTATSingleMatcher --\x3e bad argument "' + a + '" to setSingle()') : f = a;
  };
  this.toString = function() {
  ...
  this.evaluateReplacement = function(a, b, f) {
    ...
    try {
      ...
      c.ctatdebug("CTATSingleMatcher error from CTATFormulaParser.evaluate(" + g + ") " + n.name + ": " + n.message), f = null;
    }
    c.ctatdebug("CTATSingleMatcher.evaluateReplacement() returns " + f + ", type " + typeof f);
    return f;
  };
};
...
CTATSingleMatcher.prototype.match = function(a, b, c, f) {
...
var CTATRegexMatcher = function(a, b) {
  CTATSingleMatcher.call(this, a, !0);
  var c = null, f = null, g = this;
  this.toString = function() {
    return c;
  };
  this.setSinglePattern = function(a) {
    "undefined" === typeof a || null === a ? console.log("CTATRegexMatcher: null or undefined pattern") : (c = a, f = g.getCaseInsensitive() ? new RegExp(a, "i") : new RegExp(a));
  };
  this.setSingle = function(a) {
...
var CTATExampleTracerEvent = function(a, b, c) {
  ...
  var f = "", g = !1, d = CTATExampleTracerLink.NO_MODEL, e = !1, h = null, k = null, l = "student", n = null, m = null, t = "", r = null, q = null, u = null, w = null, x = null, B = [], C = !1, p = null, y = this;
  this.getActor = function() {
    return l;
  };
  this.setActor = function(a) {
  ...
  this.getReportableLink = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning " + n);
    return n;
  };
  ...
  this.getStepID = function() {
    y.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning " + t);
    return t;
  };
  ...
  this.getTutorInput = function() {
    return null !== u && "undefined" !== typeof u ? y.getEvaluatedInputArray() : null !== k && "undefined" !== typeof k ? k.getInputArray() : null;
  };
...
var CTATExpressionMatcher = function(a, b) {
  function c(a, b, c, e, g) {
    h.ctatdebug("CTATExpressionMatcher.testVector[" + e + "](" + a + ", " + b + ", " + c + ", " + g + ") to call evaluate");
    ...
    try {
      switch(f) {
        ...
        case CTATExpressionMatcher.EQ_RELATION:
          ...
          return h.compareNumberOrString(g, c, f);
        case CTATExpressionMatcher.NOT_EQ_RELATION:
          return null == g ? null != c : null == c ? !0 : h.compareNumberOrString(g, c, f);
  ...
  var f = CTATExpressionMatcher.EQ_RELATION, g = b, d = null, e = !1, h = this;
  ...
  this.matchConcatenation = function(b, d, f, g) {
    b = h.array2ConcatString(b);
    null === d || "undefined" === typeof d || null === f || "undefined" === typeof f ? e = c(b, null, null, a, g) : (d = h.array2ConcatString(d), f = h.array2ConcatString(f), e = c(b, d, f, a, g));
    return e;
  };
...
CTATRangeMatcher.prototype.match = function(a, b, c, f) {
  return this.matchSingle(a, b, c, f);
};
...
var CTATExampleTracerPath = function(a) {
  ...
  var c = null, f = null, g = null, d = null, e = null, h = null, k = this;
...
var CTATWildcardMatcher = function(a, b) {
  function c(a) {
    ...
    f.ctatdebug("CTATWildcardMatcher.convertToFullRegex(" + a + ") after qm: " + b + "; after aster: " + c + "; after negate: " + h + ";");
    return h;
  }
...
var CTATVectorMatcher = function(a, b, c, f) {
  function g(a, b, c, f, g) {
    l.ctatdebug("CTATVectorMatcher --\x3e in _match(" + a + ", " + b + ", " + c + ", " + f + ")");
    if (0 === d.length || 0 === e.length || 0 === h.length) {
      d.push(new CTATExactMatcher(CTATMatcher.SELECTION, l.array2ConcatString(l.getDefaultSelectionArray()))), e.push(new CTATExactMatcher(CTATMatcher.ACTION, l.array2ConcatString(l.getDefaultActionArray()))), h.push(new CTATExactMatcher(CTATMatcher.INPUT, l.array2ConcatString(l.getDefaultInputArray())));
    }
    var u = [];
    u[CTATMatcher.SELECTION] = a;
    u[CTATMatcher.ACTION] = b;
    u[CTATMatcher.INPUT] = c;
    for (var w = 0;3 > w;w++) {
      var x = k[w][0], B = x instanceof CTATExpressionMatcher ? x.matchConcatenation(a, b, c, f) : x.matchConcatenation(u[w]);
  ...
  var d = a instanceof Array ? a : [], e = b instanceof Array ? b : [], h = c instanceof Array ? c : [], k = [];
  ...
  this.getSingleMatcher = function(a) {
    return "selection".toString().toUpperCase() === a.toString().toUpperCase() ? d[0] : "action".toString().toUpperCase() === a.toString().toUpperCase() ? e[0] : h[0];
  };
  this.getSelection = function() {
...
var CTATExampleTracerInterpretationComparator = function() {
  ...
  this.compare = function(b, c) {
    ...
    var f = b.getType(), g = CTATExampleTracerLink.compareLinkTypes(f, c.getType());
    ...
    if (CTATExampleTracerLink.BUGGY_ACTION.toString().toUpperCase() === f.toString().toUpperCase() && (ctatdebug("CTATExampleTracerInterpretationComparator checking for buggy actions"), f = b.getLastMatchedLink(), g = c.getLastMatchedLink(), f = CTATMatcherComparator.compare(f.getMatcher(), g.getMatcher()), 0 !== f)) {
      return f;
    }
    var g = CTATExampleTracerPath.getBestPath(b.getPaths()), f = CTATExampleTracerPath.getBestPath(c.getPaths()), d = new Set;
    d.add(g);
    d.add(f);
...
var CTATExampleTracerLinkComparator = function(a, b) {
  ...
  this.compare = function(c, f) {
    ...
    var g = c.getType(), d = f.getType(), g = CTATExampleTracerLink.compareLinkTypes(g, d);
    if (0 !== g) {
    ...
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l1.getDepth(), l2.getDepth(): " + c.getDepth() + ", " + f.getDepth());
    if (c.getDepth() < f.getDepth()) {
      return -1;
    }
    if (c.getDepth() > f.getDepth()) {
      return 1;
    ...
    if (0 !== (g = CTATMatcherComparator.compare(c.getMatcher(), f.getMatcher()))) {
      return g;
    }
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l1.getUniqueID(): " + c.getUniqueID());
    ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l2.getUniqueID(): " + f.getUniqueID());
    return c.getUniqueID() < f.getUniqueID() ? -1 : 1;
  };
};
...
var CTATExampleTracerInterpretation = function(a) {
  ...
  var b = [], c = {}, f = new CTATVariableTable, g = new Set;
  a.forEach(function(a) {
    g.add(a);
  });
  var d = CTATExampleTracerLink.CORRECT_ACTION, e = null, h = this;
  ...
  this.addLink = function(a) {
    ...
    b.push(a);
    var f = a.getMatcher(), f = null === f || "undefined" === typeof f ? 1 : f.getTraversalIncrement(), g = c[a.getUniqueID()];
    null !== g && "undefined" !== typeof g ? g[0] += f : (g = [], g.push(f), c[a.getUniqueID()] = g);
    a = a.getType();
  ...
  this.updateVariableTable = function(a, b, c) {
    ...
    f.put("link" + c.getUniqueID() + ".input", d);
    if (CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase() === c.getActionType().toString().toUpperCase() || CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase() === c.getActionType().toString().toUpperCase()) {
      a = a.getSelection(), null !== a && "undefined" !== typeof a && 0 < a.length && f.put(a, d);
    }
  };
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  ...
  function f(a, b, f) {
    p.ctatdebug("CTATExampleTracerTracer --\x3e _evaluate(" + a + ", " + b + ", " + f + ")");
    B = a;
    var l = new Set, n = a.getPreloadedLinkMatches();
    p.ctatdebug("interps # : " + q.length);
    p.ctatdebug("interps: " + q);
    q.forEach(function(c) {
      p.ctatdebug("In evaluate -- entered the interpretations loop");
      if ("undefined" === typeof n || null === n) {
        p.ctatdebug("In evaluate -- entered if check for saiLinkMatches"), n = g(a.getStudentSAI(), a.getActor(), b, c.getVariableTable(), a), p.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");
      }
      p.ctatdebug("Link matches # : " + n.length);
    ...
    if (0 === l.size) {
      return p.ctatdebug("In evaluate -- if condition no new interpretations"), 0 !== n.length && !0 === n[0].isDone() && a.setDoneStepFailed(!0), a.setResult(CTATExampleTracerLink.NO_MODEL), p.ctatdebug("In evaluate -- if condition no new interpretations returning false"), !1;
    }
    var m = h(l);
    p.ctatdebug("In evaluate -- just found bestInterp");
    var r = null;
    !0 === a.isSolverResult() ? (p.ctatdebug("In evaluate -- in if branch of isSolverResult"), r = CTATExampleTracerLink.NO_MODEL.toString().toUpperCase() === a.getResult().toString().toUpperCase() ? CTATExampleTracerLink.BUGGY_ACTION.toString() : a.getResult().toString()) : (p.ctatdebug("In evaluate -- in else branch of isSolverResult"), r = m.getLastMatchedLink().getType());
    if (!0 === f) {
      p.ctatdebug("In evaluate -- in if Branch doUpdate()");
      w.push(a.getStudentSAI());
      if (r.toString() === CTATExampleTracerLink.CORRECT_ACTION.toString() || r.toString() === CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()) {
        ...
        for (var x in u) {
          u.hasOwnProperty(x) && delete u[x];
        }
        l.forEach(function(a) {
          u[a.getLastMatchedLink().getUniqueID()] = a.getLastMatchedLink();
        });
      }
      r.toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && w.splice(w.length - 1, 1);
    }
    t = m.getLastMatchedLink();
    a.isSolverResult() || (p.ctatdebug("In evaluate inside the solver result if condition + " + r), a.setResult(r));
    p.ctatdebug("In evaluate out the solver result if condition");
    a.setReportableLink(t);
    a.setReportableInterpretation(m);
    a.setReportableVariableTable(m.getVariableTable());
    a.setHintRequest(b);
    b || (x = t.getTutorSAI(a.getStudentSAI(), m.getVariableTable()), p.ctatdebug("In evaluate -- TUTORSAI object: " + x + ", getInput() " + x.getInput() + ";"), a.setTutorSAI(x));
    x = r == CTATExampleTracerLink.CORRECT_ACTION ? t.getSuccessMsg() : t.getBuggyMsg();
    a.setSuccessOrBuggyMsg(c(x, m.getVariableTable(), a.getStudentSAI()));
    x = a.getStudentSAI();
    a.setInterpolateSAI(x.getSelection(), x.getAction(), x.getInput());
    p.ctatdebug("In evaluate after calling setInterpolatesSAI");
    b && (m = t.interpolateHints(m.getVariableTable()), a.setInterpolatedHints(m), p.ctatdebug("In evaluate after calling setInterpolatedHints"), Array.isArray(m) && 0 < m.length ? a.setReportableHints(m) : a.setReportableHints(t.getHints()), p.ctatdebug("In evaluate --\x3e after setReportableHints"));
    p.ctatdebug("In evaluate after fireExampleTracerEvent");
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of _evaluate");
    return r.toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString();
  }
  ...
  function d(a, b, c, d, e) {
    ...
    if (!0 === d) {
      ...
      b.getMatchedLinks().forEach(function(a) {
        !1 !== k && (!1 === x.observesOrderingConstraints(h, a, f, e) || !1 === n(b, a, f) ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), k = !1) : h.push(a));
      });
      if (!1 === k) {
  ...
  function k(a) {
    ...
    0 === a.size ? p.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations") : (p.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: " + a.size), a.forEach(function(a) {
      q.push(a);
    }), C = null, p.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"));
  }
  function l() {
  ...
  var q = null, u = null, w = null, x = a, B = null;
  ...
  this.resetTracer = function() {
    ...
    null === q || "undefined" === typeof q ? (p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"), q = []) : (p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"), q.length = 0);
    ...
    C = a;
    if (null === u || "undefined" === typeof u) {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"), u = {};
    } else {
  ...
  this.getBestInterpretation = function() {
    ...
    if (null === C || "undefined" === typeof C) {
      p.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"), C = h(p.getInterpretationsInternal());
    }
    p.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation " + (null === C || void 0 === C));
    return C;
  };
  ...
  this.findCurrentState = function() {
    ...
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = m(!1, [a])) ? a.getPrevNode() : x ? x.getStartNode() : null;
  };
};
...
var CTATExampleTracerGraph = function(a, b, c) {
  function f(a, b, c) {
    ...
    for (var f = d(b), g = 0;g < f.length;g++) {
      var k = f[g];
      if (!0 === A.isGroupOrdered(k)) {
        if (g !== f.length - 1) {
          if (!1 === e(k, h(f[g + 1], c), a, c)) {
            return !1;
          }
        } else {
          if (!1 === e(k, b, a, c)) {
  ...
  function e(a, b, c, d) {
    ...
    A.getGroupSubgroups(a).forEach(function(a) {
      if (!1 === A.isLinkInGroup(a, b) && 0 !== A.getGroupLinkCount(a)) {
        var k = h(a, d);
        null !== k && "undefined" !== typeof k && (k = k.getDepth(), k < b.getDepth() && k > e && (!1 === n(a) || !0 === m(a, c)) && (e = k, f = a), k > b.getDepth() && k < g && (!1 === n(a) || !0 === m(a, c)) && (g = k, l = a));
      }
    });
    ...
    return null !== l && "undefined" !== typeof l && (l instanceof CTATExampleTracerLink && -1 < c.indexOf(l) || l instanceof CTATLinkGroup && !0 === m(l, c)) ? !1 : !0;
  }
  function h(a, b) {
  ...
  var w = null, x = null, B = null, C = null, p = null, y = null, v = new Set, D = null, A = null, z = this;
  this.getDefaultBuggyMsg = function() {
  ...
  this.isIncorrectLinkOK = function(a, b, c, d) {
    ...
    if (!0 === e && (b = z.getSmallestContainingGroup(b), !0 === A.isLinkInGroup(b, g) && !1 === A.isGroupOrdered(b) && !0 === l(b, c, d))) {
      return !1;
    }
...
var CTATMessageTank = function(a, b) {
  ...
  var g = a, d = null, e = null, h = null, k = null, l = new Set;
  ...
  this.flushMessageTank = function(a, b) {
    ...
    if (e && !(1 > e.length)) {
      c(a);
      m.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length " + e.length + ", transaction_id " + n);
      for (var d = [], l = 0;l < e.length;++l) {
        var w = e[l];
        if (w.msg) {
          var x = w.msgType, B = w.evt;
          m.ctatdebug("entering processInterfaceVariables() msgType " + x + ", evt " + B);
          x && (m.ctatdebug("entering processInterfaceVariables() et " + g + ", tracer " + (g ? g.getTracer() : null)), x = x.toLowerCase(), 0 !== x.indexOf("correct") && 0 !== x.indexOf("interfaceaction") || g.getTracer().addInterfaceVariablesFromEvent(B));
          f(w) || d.push(w.msg);
        }
      }
      0 < d.length && (m.ctatdebug("Bottom of flushMessageTank(); to send bundle of length " + d.length + " via " + g), g.sendBundle(d) && (k[CTATExampleTracerLink.CORRECT_ACTION] || k[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION] || h.CorrectAction || h.InterfaceAction || h.UntutoredAction) && g.getOutputStatus().isSendingSavedMsgsForRestore() && (d = flashVars.getRawFlashVars(), d.deliverymode ? "delivery" == d.deliverymode ? g.getProblemStateSaver().saveAsYouGo(a) : m.ctatdebug("We're in reviewer mode in OLI, we shouldn't save as we go") : 
      g.getProblemStateSaver().saveAsYouGo(a)), m.ctatdebug("Exiting flushMessageTank() #CorrectAction " + h.CorrectAction + ", #InterfaceAction " + h.InterfaceAction + ", #UntutoredAction " + h.UntutoredAction));
      h = e = n = null;
    }
  };
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var c = new CTATExampleTracerLink(null, null, null), f = e.getElementChildren(a), g, h, k, l, m, t = a = -1, v = CTATMsgType.DEFAULT_ACTOR, D = !1, A = 0;A < f.length;A++) {
      "sourceID" === e.getElementName(f[A]) && (a = parseInt(e.getNodeTextValue(f[A])), c.setPrevNode(a));
      "destID" === e.getElementName(f[A]) && (t = parseInt(e.getNodeTextValue(f[A])), c.setNextNode(t));
      if ("rule" === e.getElementName(f[A])) {
        for (var z = e.getElementChildren(f[A]), E = 0;E < z.length;E++) {
          "text" === e.getElementName(z[E]) && c.addSkillName(e.getNodeTextValue(z[E]).toString());
        }
      }
      if ("actionLabel" === e.getElementName(f[A])) {
        for (c.setIsPreferredLink("false" != e.getElementAttr(f[A], "preferPathMark")), c.setMinTraversalsStr(e.getElementAttr(f[A], "minTraversals")), c.setMaxTraversalsStr(e.getElementAttr(f[A], "maxTraversals")), z = e.getElementChildren(f[A]), E = 0;E < z.length;E++) {
          "uniqueID" === e.getElementName(z[E]) && (m = e.getNodeTextValue(z[E]), c.setUniqueID(parseInt(e.getNodeTextValue(z[E]))));
          "message" === e.getElementName(z[E]) && (l = new CTATMessage(z[E]));
          "actionType" === e.getElementName(z[E]) && c.setActionType(e.getNodeTextValue(z[E]));
          "buggyMessage" === e.getElementName(z[E]) && c.setBuggyMsg(e.getNodeTextValue(z[E]));
          "successMessage" === e.getElementName(z[E]) && c.setSuccessMsg(e.getNodeTextValue(z[E]));
          "hintMessage" === e.getElementName(z[E]) && c.addHint(e.getNodeTextValue(z[E]));
          if ("matchers" === e.getElementName(z[E])) {
            for (var F = e.getElementChildren(z[E]), G = 0;G < F.length;G++) {
              "Selection" === e.getElementName(F[G]) && (g = b(F[G], 0)), "Action" === e.getElementName(F[G]) && (h = b(F[G], 1)), "Input" === e.getElementName(F[G]) && (k = b(F[G], 2)), "Actor" === e.getElementName(F[G]) && (v = e.getNodeTextValue(F[G]), D = (D = e.getElementAttr(F[G], "linkTriggered")) && "false" != D.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === e.getElementName(z[E])) {
            h = z[E];
            g = e.getElementAttr(h, "replacementFormula");
            h = e.getElementChildren(h);
            var G = F = v = k = void 0, K = CTATMsgType.DEFAULT_ACTOR;
            k = new CTATExactMatcher(CTATMatcher.SELECTION, null);
            for (var v = new CTATExactMatcher(CTATMatcher.ACTION, null), H = 0;H < h.length;H++) {
              if ("matcherType" === e.getElementName(h[H]) && ("ExactMatcher" === e.getNodeTextValue(h[H]) && (G = CTATExactMatcher), "RegexMatcher" === e.getNodeTextValue(h[H]) && (G = CTATRegexMatcher), "AnyMatcher" === e.getNodeTextValue(h[H]) && (G = CTATAnyMatcher), "RangeMatcher" === e.getNodeTextValue(h[H]) && (G = CTATRangeMatcher), "WildcardMatcher" === e.getNodeTextValue(h[H]) && (G = CTATWildcardMatcher), "ExpressionMatcher" === e.getNodeTextValue(h[H]) && (G = CTATExpressionMatcher)), 
              "matcherParameter" === e.getElementName(h[H])) {
                var L = e.getElementAttr(h[H], "name");
                "selection" == L && k.setParameter(e.getNodeTextValue(h[H]));
                "action" == L && v.setParameter(e.getNodeTextValue(h[H]));
                "input" == L && (F = F ? F : new G(CTATMatcher.INPUT, null), F.setParameter(e.getNodeTextValue(h[H])));
                "actor" == L && (K = e.getNodeTextValue(h[H]));
                "minimum" == L && (F = F ? F : new G(CTATMatcher.INPUT, null), F.setParameter(e.getNodeTextValue(h[H]), "minimum"));
                "maximum" == L && (F = F ? F : new G(CTATMatcher.INPUT, null), F.setParameter(e.getNodeTextValue(h[H]), "maximum"));
              }
            }
    ...
    m = new CTATVectorMatcher(g, h, k, v);
      ...
      if ("matcher" === e.getElementName(c[g])) {
        for (var h = null, k = e.getElementAttr(c[g], "replacementFormula"), l = e.getElementChildren(c[g]), m = 0;m < l.length;m++) {
          ...
          if ("matcherParameter" === e.getElementName(l[m])) {
            var n = e.getElementAttr(l[m], "name");
            "single" === n ? h.setParameter(e.getNodeTextValue(l[m])) : "minimum" === n ? h.setParameter(e.getNodeTextValue(l[m]), "minimum") : "maximum" === n ? h.setParameter(e.getNodeTextValue(l[m]), "maximum") : h.setParameter(l[m], n, e);
          }
        }
  ...
  function c(a, b) {
    ...
    for (var h = function(a) {
      ...
      if ("link" === e.getElementName(k[m])) {
        var n = Number(e.getElementAttr(k[m], "id")), t = b[n];
        if (null !== t || void 0 !== t) {
          ctatdebug("Added link ID : " + n), d.add(t);
        }
      }
      "group" === e.getElementName(k[m]) && (ctatdebug("encountered a subgroup"), c(k[m], b).forEach(h));
    }
    l.addGroup(f, g, d);
  ...
  var f = this, g, d, e = new CTATXML, h = null, k = [];
  new XMLSerializer;
  var l, n = !0, m = CTATMsgType.SHOW_ALL_FEEDBACK, t = !0;
  ...
  this.parseGraph = function(b, f) {
    ctatdebug("parseBRD()");
    var u = 0, w = e.getElementAttr(b, "startStateNodeName"), x = "true" === e.getElementAttr(b, "unordered");
    n = "false" != String(e.getElementAttr(b, "caseInsensitive")).toLowerCase();
    t = e.getElementAttr(b, "lockWidget");
    var B = new CTATVariableTable;
    d = new CTATExampleTracerGraph(x, !1, B);
    var C = e.getElementChildren(b);
    m = e.getElementAttr(b, "suppressStudentFeedback");
    if (null === m || void 0 === m) {
      m = CTATMsgType.SHOW_ALL_FEEDBACK;
    }
    f.setFeedbackPolicy(m);
    var p = e.getElementAttr(b, "highlightRightSelection");
    f.setHighlightRightSelection("false" != p);
    var y = e.getElementAttr(b, "confirmDone");
    f.setHintPolicy(e.getElementAttr(b, "hintPolicy"));
    f.setOutOfOrderMessage(e.getElementAttr(b, "outOfOrderMessage"));
    for (var B = null, v = 0;v < C.length;v++) {
      switch(e.getElementName(C[v])) {
        case "startNodeMessages":
          k = e.getElementChildren(C[v]);
          var D = new CTATTutorMessageBuilder;
          "true" !== y && "false" !== y && m === CTATMsgType.HIDE_ALL_FEEDBACK && (y = "true");
          h = D.createStateGraphMessage(n, x, t, m === CTATMsgType.HIDE_ALL_FEEDBACK, p, confirmDone, f.getSkillBarVector());
          break;
        case "node":
          u++;
          D = C[v];
          ctatdebug("processNode(" + D + ")");
          for (var A = e.getElementChildren(D), z = -1, D = "", E = 0;E < A.length;E++) {
            switch(e.getElementName(A[E])) {
              case "uniqueID":
                z = parseInt(e.getNodeTextValue(A[E]));
                break;
              case "text":
                D = e.getNodeTextValue(A[E]);
            }
          }
          ...
          D = A;
          d.addNode(D);
          1 == u && (d.setStartNode(D), d.setStudentStartsHereNode(D));
    ...
    if (B) {
      ...
      l.setGroupOrdered(l.getTopLevelGroup(), u);
      ...
      ctatdebug("processGroup() order of group: isOrdered= " + u);
      ctatdebug("processGroup() order of group: isOrdered typeof= " + typeof u);
      u = e.getElementChildren(w);
      for (w = 0;w < u.length;w++) {
        switch(e.getElementName(u[w])) {
          case "group":
            c(u[w], x);
            break;
          case "outOfOrderMessage":
            l.getTopLevelGroup().setDefaultBuggyMsg(e.getNodeTextValue(u[w]));
        }
      }
    }
    d.redoLinkDepths();
...
var CTATExampleTracer = function() {
  function a() {
    n.ctatdebug("workTheQueue() working " + G + ", workQueue.length " + F.length + ", restoreQueue.length " + E.length);
    if (0 == G) {
      for (;0 != (G = 0 < F.length | (0 < E.length) << 1);) {
        var a = null, c = !1;
        0 < E.length ? (a = E.shift(), c = !0) : a = F.shift();
        if (!b(a, c)) {
          n.ctatdebug("workTheQueue() suspending workQueue.length " + F.length + ", restoreQueue.length " + E.length);
          n.setWorking(c ? 1 : 0, !0);
          break;
        }
        n.ctatdebug("workTheQueue() bottom workQueue.length " + F.length + ", restoreQueue.length " + E.length);
      }
    }
  }
  function b(a, b) {
    n.lastMessageAsString = a;
    var d = n.lastMessageAsXML = (new CTATXML).parseXML(a), e = n.lastMessage = new CTATMessage(d), h = e.getMessageType();
    ...
    switch(h) {
      ...
      case CTATMsgType.UNTUTORED_ACTION:
        return b && n.sendBundle([a]), f(a, e, u, d), !0;
      case CTATMsgType.INTERFACE_ACTION:
        return b && n.sendBundle([a]), g(a, e, u, d), !0;
  ...
  function c(a, b, c, d) {
    n.ctatdebug("SetPreferences received: " + a);
    K = !1;
    v = b.getProperty("problem_name");
    n.ctatdebug("SetPreferences.problem_name = " + v);
      ...
      if (d = c.getElementName(a[b]), n.ctatdebug("SetPreferences eltName " + d), d) {
        switch(d.toLowerCase()) {
          ...
          case "skills":
            ...
            d = [];
            for (var e = u.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              var g = u.getElementName(e[f]);
              if (g && "skill" == g.toLowerCase()) {
                var h = u.getElementAttr(e[f], "name");
                if (h && "" != h.trim()) {
                  var g = u.getElementAttr(e[f], "label"), k = u.getElementAttr(e[f], "pSlip"), l = u.getElementAttr(e[f], "description"), q = u.getElementAttr(e[f], "pKnown"), p = u.getElementAttr(e[f], "category"), t = u.getElementAttr(e[f], "pLearn"), r = u.getElementAttr(e[f], "pGuess"), h = new CTATExampleTracerSkill(p, h, r, q, k, t);
                  h.setLabel(g);
                  h.setDescription(l);
                  d.push(h);
                }
          ...
          case "problem_state_status":
            ...
            A || (A = new ProblemStateRestorer(n));
            n.ctatdebug("SetPreferences problemStateRestorer " + A);
            break;
    ...
    n.ctatdebug("questionFile " + m + ", outputStatus " + z + ", problemStateRestorer " + A);
    a = m;
    n.ctatdebug("retrieveBRD (" + a + ")");
    L.retrieveXMLFile(a, c, n);
    A && A.retrieveMessages(z);
  }
  function f(a, b, c, d) {
    b = b.getTransactionID();
    n.ctatdebug("UntutoredAction (" + a + "), getTransactionID " + b);
    D.appendToProblemState(a, n.getOutputStatus(), !1);
    if (!K) {
      return !1;
    }
  ...
  function g(a, b, c, d) {
    ...
    n.ctatdebug("selectionArray " + d + ", message.getSelectionArray() " + b.getSelectionArray());
    !d[0] || "hint" != d[0].toLowerCase() && "help" != d[0].toLowerCase() ? (n.ctatdebug("calling doNewExampleTrace(null, " + b.getSAI() + ") sai.selectionArray " + b.getSAI().getSelectionArray() + " msg.selectionArray " + b.getSelectionArray()), k(null, b.getSAI(), "student", !0, c, a)) : (n.ctatdebug("handleInterfaceAction() hint request: hintPolicy " + x + ", errorSAI " + w), x === CTATHintPolicyEnum.HINTS_UNBIASED ? (1 < d.length && (d[1] = ""), 1 < e.length && (e[1] = "")) : x !== CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY && 
    (x === CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY ? w && w.getSelection() ? (d.splice(1, 0, w.getSelection()), e.splice(1, 0, "PreviousFocus")) : (d[1] = "", e[1] = "") : x === CTATHintPolicyEnum.HINTS_BIASED_BY_ALL && w && w.getSelection() && (d.splice(1, 0, w.getSelection()), e[1] = CTATMsgType.PREVIOUS_FOCUS.toString())), n.startSkillTransaction(), a = [], d = t.doHint(d, e, b.getInputArray(), "student", a, !0), b = a[0], a = b.getReportableHints(), b.setStepID(d.getUniqueID()), n.updateSkills(CTATExampleTracerSkill.HINT, 
    d.getSkillNames(), d.getUniqueID()), n.ctatdebug("Before building hint message: tutorSAI " + b.getTutorSAI() + ", hints " + a + ", edge # " + d.getUniqueID()), e = (new CTATTutorMessageBuilder).createHintMessage(a, b.getTutorSAI(), d.getUniqueID(), c), n.messageTank.addToMessageTank(CTATMsgType.SHOW_HINTS_MESSAGE, e, b), c = (new CTATTutorMessageBuilder).createAssociatedRulesMessageForHint(d, a, b.getTutorSAI(), n.getSkillBarVector(), c), n.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, 
    c, b), c = n.getProblemSummary(b.getReportableInterpretation()), n.messageTank.flushMessageTank(c, !0), n.ctatdebug("handleInterfaceAction() sent hint result " + b), w = null);
    return !0;
  }
  function d(a, b, c) {
  ...
  function k(a, b, c, f, g, h) {
    n.ctatdebug("doNewExampleTrace (link " + a + ", sai " + b + ", actor " + c + ", doTutorPerformedSteps " + f + ", transactionID " + g + ", origMsgTxt " + h);
    n.startSkillTransaction();
    var k = new CTATExampleTracerEvent(n, b, c);
    a && k.addPreloadedLinkMatch(a);
    var l = t.evaluate(k);
    n.ctatdebug("Evaluate returned : " + l + ", given link " + a + ", result " + k);
    a ? (n.ctatdebug("result.getTutorSelection() " + k.getTutorSelection()), n.ctatdebug("result.getTutorAction() " + k.getTutorAction()), n.ctatdebug("result.getTutorInput() " + k.getTutorInput()), n.ctatdebug("typeof(messageTank) " + typeof messageTank), g = k.getTutorSelection(), h = k.getTutorAction(), l = k.getTutorInput(), (g = n.messageTank.enqueueToolActionToStudent(g, h, l, CTATTutorMessageBuilder.TUTOR_PERFORMED)) && n.messageTank.setTransaction_id(g)) : k.getResult() != CTATExampleTracerLink.CORRECT_ACTION && 
    k.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || D.appendToProblemState(h, n.getOutputStatus(), !1);
    k.setTransactionID(g);
    n.ctatdebug("finishNewExampleTrace(" + k + ", " + b + ", " + c + ", " + f + ")");
    h = k.getStudentSAI();
    var l = k.getTutorSAI(), m = k.getTransactionID(), q = new CTATTutorMessageBuilder, p, r = [];
    ...
    if (k.isSolverResult()) {
      ...
      if (k.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        p = r ? "" + r.getUniqueID() : "", k.setStepID(p), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && n.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, q.createCorrectActionMessage(m, l), k), null !== r && "undefined" !== typeof r && n.updateSkills(CTATExampleTracerSkill.CORRECT, r.getSkillNames(), r.getUniqueID()), p = k.getSuccessOrBuggyMsg(), n.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, q.createAssociatedRulesMessageForAction(k.getResult(), l, 
        h, n.getSkillBarVector(), r.getUniqueID(), m, p), k), n.ctatdebug("finishNewExampleTrace() successMsg " + p), p && n.messageTank.addToMessageTank("SuccessMessage", q.createSuccessMessage(m, p), k), w = null, f && (u = e(r ? r.getNextNode() : null, t.findCurrentState(!1, !1), n.lastMessage ? n.lastMessage.getSAI() : null, k)) && (k = u);
      } else {
        n.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION, q.createInCorrectActionMessage(m, h), k);
        n.ctatdebug("about to do silent traceForHint(" + h + "), selectionArray " + h.getSelectionArray());
        var v = n.lastSilentHintResult = new CTATExampleTracerEvent(n, h, c), u = t.traceForHint(v);
        n.ctatdebug("silent hint result: " + v + "; hintLink " + u);
        u || (u = t.getBestNextLink(!1, v), n.ctatdebug("getBestNextLink result: " + v + "; hintLink " + u));
        l = v ? v.getTutorSAI() : null;
        u && (p = "" + u.getUniqueID(), k.setStepID(p));
        v = d(k, v, q);
        n.ctatdebug("createBuggyMessage() tutorAdvice: " + v.tutorAdvice + ";\n  msg " + v.msg);
        n.updateSkills(CTATExampleTracerSkill.INCORRECT, u.getSkillNames(), u.getUniqueID());
        n.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, q.createAssociatedRulesMessageForAction(k.getResult(), l && l.getSelection() ? l : h, h, n.getSkillBarVector(), p, m, v.tutorAdvice), k);
        v.msg && n.messageTank.addToMessageTank(v.msgType, v.msg, k);
        w = h;
        f && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == k.getResult() && e(r ? r.getNextNode() : null, t.findCurrentState(!1, !1), n.lastMessage ? n.lastMessage.getSAI() : null, k);
      }
    }
    n.lastResult = k;
    p = n.getProblemSummary(k.getReportableInterpretation());
    n.ctatdebug("finishNewExampleTrace() to flushMessageTank");
    n.messageTank.flushMessageTank(p, !0);
    n.ctatdebug("finishNewExampleTrace() sent result " + k.getResult() + ", studentSAI " + h);
    n.ctatdebug("doNewExampleTrace(" + a + ", " + b + ", " + c + ", " + f + ", " + g + ") returns undefined");
  }
  function l() {
  ...
  var n = this, m = null, t, r, q, u = new CTATXML;
  new XMLSerializer;
  var w = null, x, B = CTATMsgType.SHOW_ALL_FEEDBACK, C = !0, p = !1, y = null, v = null, D = new ProblemStateSaver(n), A = null, z = new CTATProblemStateStatus, E = [], F = [], G = 0, K = !1, H = "";
  n.ctatdebug("CTATExampleTracer constructor outputStatus=" + z);
  ...
  this.receiveFromInterface = function(b) {
    n.ctatdebug("CTATExampleTracer.receiveFromInterface(" + b + ")");
    F.push(b);
    a();
  };
  ...
  this.traceLinks = function(a) {
    for (var b = [], c = 0;c < a.length && null != a[c];++c) {
      n.messageTank = new CTATMessageTank(n, null), b.push(k(a[c], a[c].getDefaultSAI(), a[c].getActor(), !1, null)), n.ctatdebug("traceLinks[" + c + "] result " + b[c]);
    }
    return b;
  };
  ...
  this.processXML = function(a) {
    ...
    if (null != a) {
      n.ctatdebug("No of children" + u.getElementChildren(a).length);
      ...
      a = c.ssm;
      var d = c.sgMsg;
      n.ctatdebug("sendStartStateMessages() nMsgs " + a.length + ", outputStatus " + z);
      for (var c = [], e = new XMLSerializer, f = -1, g = 0;g < a.length;g++) {
        if ("message" == u.getElementName(a[g])) {
          var h = e.serializeToString(a[g]), k = CTATMsgType.getMessageType(h);
          CTATMsgType.UNTUTORED_ACTION != k && CTATMsgType.INTERFACE_ACTION != k || n.setVariablesFromSAI(a[g], u);
          z.isIncomplete() && CTATMsgType.START_STATE_END == k ? f = 0 : c.push(h);
        }
      }
      d = c.unshift(d);
      e = new CTATTutorMessageBuilder;
      c.splice(d - f, 0, e.createLockWidgetMsg(b.getLockWidget()));
      n.ctatdebug("sendStartStateMessages(): " + a.length + " elts, " + c.length + " strings, " + z);
      n.sendBundle(c);
      b = q.getStartNode();
      a = q.getStudentStartsHereNode();
      null != b && null != a && b.getNodeID() != a.getNodeID() && (b = q.getBestSubpath(b, a), n.ctatdebug("advanceToStudentStartsHere() path " + b), b = n.traceLinks(b.getSortedLinks()), n.ctatdebug("advanceToStudentStartsHere() results " + b));
      K = !0;
    }
    n.setWorking(0, !1);
  };
  this.sendBundle = function(a) {
    n.ctatdebug("sending bundle #msgs = " + a.length + ", outputStatus " + z);
    for (var b = 0, c = 0;c < a.length;c++) {
      n.ctatdebug("Sending message #" + c);
      var d = a[c];
      0 >= c && (d = '<?xml version="1.0" encoding="UTF-8"?>' + d);
      D.forwardToInterface(d, c >= a.length - 1, z) && ++b;
    }
    return 0 < b;
  };
  ...
  this.getProblemSummary = function(a) {
    n.ctatdebug("Entering getProblemSummary() problemSummary " + y);
    if (null === y || "undefined" === typeof y) {
      var b = n.getProblemName();
      if (null === b || "undefined" === typeof b || 1 > b.length) {
        b = "NoProblemDefined";
      }
      y = new CTATProblemSummary(b, null, n.isFeedbackSuppressed());
    }
    a && y.setRequiredSteps(a.countStepsForScore(q));
    return y;
  };
